...
pub contract ADHDToken: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "ADHD DAO",
                    symbol: "ADHD",
                    description: "A DAO for those that suffer with ADHD.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: ADHDToken.VaultStoragePath,
                    receiverPath: ADHDToken.ReceiverPublicPath,
                    metadataPath: ADHDToken.VaultPublicPath,
                    providerPath: /private/ADHDTokenVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("ADHDToken", self.account.address, "ADHD", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
