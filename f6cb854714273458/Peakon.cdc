...
pub contract Peakon: FungibleToken {
    ...
    // Total supply of Peakons in existence
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            let vault <- from as! @Peakon.Vault
        ...
        destroy() {
            Peakon.totalSupply = Peakon.totalSupply - self.balance
            if(self.balance > 0.0) {
    ...
    pub resource Minter {
        ...
        //
        pub fun mintTokens(amount: UFix64): @Peakon.Vault {
            pre {
                amount > 0.0: "Amount minted must be greater than zero"
                amount <= self.allowedAmount: "Amount minted must be less than the allowed amount"
            }
            Peakon.totalSupply = Peakon.totalSupply + amount
