...
pub contract TouchstoneHalloweencreatedbyAi: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneHalloweencreatedbyAi.CollectionStoragePath,
						publicPath: TouchstoneHalloweencreatedbyAi.CollectionPublicPath,
						providerPath: TouchstoneHalloweencreatedbyAi.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneHalloweencreatedbyAi"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneHalloweencreatedbyAi.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneHalloweencreatedbyAi.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneHalloweencreatedbyAi.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneHalloweencreatedbyAi")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneHalloweencreatedbyAi.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneHalloweencreatedbyAi.metadatas[TouchstoneHalloweencreatedbyAi.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			pre {
				EmeraldPass.isActive(user: TouchstoneHalloweencreatedbyAi.account.address): "You must have an active Emerald Pass subscription to airdrop NFTs. You can purchase Emerald Pass at https://pass.ecdao.org/"
			}
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneHalloweencreatedbyAi.CollectionPublicPath).borrow<&TouchstoneHalloweencreatedbyAi.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneHalloweencreatedbyAi.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
