...
pub contract Cadence: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Cadence",
                    symbol: "CADNC",
                    description: "Cadence for everyone",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Cadence.VaultStoragePath,
                    receiverPath: Cadence.ReceiverPublicPath,
                    metadataPath: Cadence.VaultPublicPath,
                    providerPath: /private/CadenceVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Cadence", self.account.address, "CADNC", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
