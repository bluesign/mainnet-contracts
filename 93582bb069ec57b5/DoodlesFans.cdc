...
pub contract DoodlesFans: FungibleToken, ViewResolver {
        ...
        pub fun mint(amount: UFix64): @Vault {
            post {
                DoodlesFans.maxSupply == nil || DoodlesFans.totalSupply <= DoodlesFans.maxSupply!: 
                    "Excedeu o fornecimento máximo de tokens permitido."
            }
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Doodles Fans",
                    symbol: "DOODLES",
                    description: "Doodle Fans Coin",
                    externalURL: MetadataViews.ExternalURL("www.doodles.app"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("doodles"),
                        "discord": MetadataViews.ExternalURL("doodles")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: DoodlesFans.VaultStoragePath,
                    receiverPath: DoodlesFans.ReceiverPublicPath,
                    metadataPath: DoodlesFans.VaultPublicPath,
                    providerPath: /private/DoodlesFansVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("DoodlesFans", self.account.address, "DOODLES", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
