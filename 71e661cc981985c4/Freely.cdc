...
pub contract Freely: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Freely",
                    symbol: "FRLY",
                    description: "A DAO for Christians",
                    externalURL: MetadataViews.ExternalURL("freely.com"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("freely"),
                        "discord": MetadataViews.ExternalURL("q2maASKC")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Freely.VaultStoragePath,
                    receiverPath: Freely.ReceiverPublicPath,
                    metadataPath: Freely.VaultPublicPath,
                    providerPath: /private/FreelyVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Freely", self.account.address, "FRLY", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
