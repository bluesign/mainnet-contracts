...
pub contract FarmLand: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeieufzru32cxku727m7daevlyxj5ry33jgijjzrygj7pcxlqmxtvdu"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeiavezct2525f3khhmqj4g6yjl7gou3eii3r4vtmphvdnz6fxjwi2i"
                    ),
                    mediaType: "image"
                )
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: FarmLand.VaultStoragePath,
                    receiverPath: FarmLand.ReceiverPublicPath,
                    metadataPath: FarmLand.VaultPublicPath,
                    providerPath: /private/FarmLandVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("FarmLand", self.account.address, "CORN", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
