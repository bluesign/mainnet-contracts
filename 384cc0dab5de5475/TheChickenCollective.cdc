...
pub contract TheChickenCollective: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeiepxnyi42l67jh4mcl3eodh2clrqrk44xys5aoyewzfeyoukvtv6e"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "The Chicken Collective",
                    symbol: "EGG",
                    description: "A Farm Land Collective.For the $EGG",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: TheChickenCollective.VaultStoragePath,
                    receiverPath: TheChickenCollective.ReceiverPublicPath,
                    metadataPath: TheChickenCollective.VaultPublicPath,
                    providerPath: /private/TheChickenCollectiveVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("TheChickenCollective", self.account.address, "EGG", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
