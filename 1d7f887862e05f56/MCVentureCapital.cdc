...
pub contract MCVentureCapital: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "MC Venture Capital",
                    symbol: "MCVT",
                    description: "Support MC Venture Capital Flow Incubator, a project that will create and launch several apps on the Flow blockchain, a fast, scalable, and user-friendly platform. Join us and help us make the web more open, decentralized, and accessible!",
                    externalURL: MetadataViews.ExternalURL("www.mcventurecapital.com/incubator.php"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("MCventureCap"),
                        "discord": MetadataViews.ExternalURL("6skTVaZk3G")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: MCVentureCapital.VaultStoragePath,
                    receiverPath: MCVentureCapital.ReceiverPublicPath,
                    metadataPath: MCVentureCapital.VaultPublicPath,
                    providerPath: /private/MCVentureCapitalVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("MCVentureCapital", self.account.address, "MCVT", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
