...
pub contract GODCoin: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "GOD Coin",
                    symbol: "GOD",
                    description: "🚀 Dive into the cosmic hilarity with $GOD Coin on Flow Blockchain 🌐 – Your gateway to decentralized laughter and interstellar fun! 🔮 Join the memevolution – grab $GOD now for a universe of good vibes! 🌌",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("FlowGOD23"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: GODCoin.VaultStoragePath,
                    receiverPath: GODCoin.ReceiverPublicPath,
                    metadataPath: GODCoin.VaultPublicPath,
                    providerPath: /private/GODCoinVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("GODCoin", self.account.address, "GOD", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
