...
pub contract R1CKY: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "R1CKY",
                    symbol: "RISP",
                    description: "Each of the participants will have the right to a drawing of tokens or NFTs of my digital account on the flow",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL(""),
                        "discord": MetadataViews.ExternalURL("FpP46nM8")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: R1CKY.VaultStoragePath,
                    receiverPath: R1CKY.ReceiverPublicPath,
                    metadataPath: R1CKY.VaultPublicPath,
                    providerPath: /private/R1CKYVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("R1CKY", self.account.address, "RISP", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
