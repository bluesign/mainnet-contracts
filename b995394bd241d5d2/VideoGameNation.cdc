...
pub contract VideoGameNation: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "VideoGameNation",
                    symbol: "VGN",
                    description: "DAO for Video Game Nation, a sub-community of NBA Top Shot.",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL(""),
                        "discord": MetadataViews.ExternalURL("t5d6pQ9g")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: VideoGameNation.VaultStoragePath,
                    receiverPath: VideoGameNation.ReceiverPublicPath,
                    metadataPath: VideoGameNation.VaultPublicPath,
                    providerPath: /private/VideoGameNationVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("VideoGameNation", self.account.address, "VGN", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
