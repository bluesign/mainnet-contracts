...
pub contract ToucansUSDCoin: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Toucans USD Coin",
                    symbol: "TUSDC",
                    description: "Toucans USD Coin",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: ToucansUSDCoin.VaultStoragePath,
                    receiverPath: ToucansUSDCoin.ReceiverPublicPath,
                    metadataPath: ToucansUSDCoin.VaultPublicPath,
                    providerPath: /private/ToucansUSDCoinVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("ToucansUSDCoin", self.account.address, "TUSDC", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
