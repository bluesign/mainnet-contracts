...
pub contract CryptoUnderManagement: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeiedx2kw6n546lei2x5lcqg5547uq4gnpgjxsuhqlntvwzlh3ijxci"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreibt5mhlpy3xd2shifc7eevza24pcyihbbe26pbwnci76vkxteaade"
                    ),
                    mediaType: "image"
                )
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Crypto Under Management",
                    symbol: "CUM",
                    description: "CUM (Crypto Under Management) is a Decentralized Autonomous Organization (DAO) revolutionizing asset management in the cryptocurrency space. Through transparent, community-driven governance, CUM empowers token holders to collectively manage digital assets and make informed investment decisions.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: CryptoUnderManagement.VaultStoragePath,
                    receiverPath: CryptoUnderManagement.ReceiverPublicPath,
                    metadataPath: CryptoUnderManagement.VaultPublicPath,
                    providerPath: /private/CryptoUnderManagementVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("CryptoUnderManagement", self.account.address, "CUM", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
