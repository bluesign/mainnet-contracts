...
pub contract Vampire: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreidbnf5tonl24v6akeryw23vvqxsepuv3csmmzwdeafdph6nk5vtuu"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Vampire",
                    symbol: "SUCK",
                    description: "Stake it to make it!",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Vampire.VaultStoragePath,
                    receiverPath: Vampire.ReceiverPublicPath,
                    metadataPath: Vampire.VaultPublicPath,
                    providerPath: /private/VampireVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Vampire", self.account.address, "SUCK", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
