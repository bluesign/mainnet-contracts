      ...
      switch view {
        ...
        case Type<MetadataViews.NFTCollectionData>():
          return MetadataViews.NFTCollectionData(
            storagePath: MetabiliaNFT.CollectionStoragePath,
            publicPath: MetabiliaNFT.CollectionPublicPath,
            providerPath: MetabiliaNFT.CollectionPrivatePath,
            publicCollection: Type<@MetabiliaNFT.Collection>(),
            publicLinkedType: Type<&MetabiliaNFT.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(),
            providerLinkedType: Type<&MetabiliaNFT.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
        ...
        case Type<MetadataViews.NFTCollectionDisplay>():
          return MetadataViews.NFTCollectionDisplay(
            name: "Metabilia",
            description: "Metabilia NFTs are tied to their specified physical memorabilia item which provides underlying value protection to the digital collectible.",
            externalURL: MetabiliaNFT.externalURL(),
            squareImage:
              MetadataViews.Media(
                file: MetadataViews.IPFSFile(cid: MetabiliaNFT.squareImageCID(), path: nil),
                mediaType: "image/png"
              ),
            bannerImage:
              MetadataViews.Media(
                file: MetadataViews.IPFSFile(cid: MetabiliaNFT.bannerImageCID(), path: nil),
                mediaType: "image/png"
              ),
            socials: {
            }
