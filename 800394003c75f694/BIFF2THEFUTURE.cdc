...
pub contract BIFF2THEFUTURE: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreiaarpv4kblnlzapj4dmgvdv2zxorwcajn4iwnzabplzipfpuyf4pa"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreiawrb37pnq2vayycgnilkrwg3sgmt6v56qtl4ajby5zw6ktaqq3ua"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "BIFF2THEFUTURE",
                    symbol: "BIFF",
                    description: "Since you're new here, I'm gonna cut you a break, today. So, why don't you make like a tree and get outta here? ",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: BIFF2THEFUTURE.VaultStoragePath,
                    receiverPath: BIFF2THEFUTURE.ReceiverPublicPath,
                    metadataPath: BIFF2THEFUTURE.VaultPublicPath,
                    providerPath: /private/BIFF2THEFUTUREVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("BIFF2THEFUTURE", self.account.address, "BIFF", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
