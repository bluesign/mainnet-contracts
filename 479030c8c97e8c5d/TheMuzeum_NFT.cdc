...
pub contract TheMuzeum_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            TheMuzeum_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintTheMuzeum_NFT(
			...
			recipient.deposit(token: <-create TheMuzeum_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionTheMuzeum_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
		...
		pub fun batchMintTheMuzeum_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: TheMuzeum_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: TheMuzeum_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: TheMuzeum_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: TheMuzeum_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: TheMuzeum_NFT.CollectionStoragePath,
                        publicPath: TheMuzeum_NFT.CollectionPublicPath,
                        providerPath: /private/TheMuzeum_NFT,
                        publicCollection: Type<&TheMuzeum_NFT.Collection{TheMuzeum_NFT.TheMuzeum_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&TheMuzeum_NFT.Collection{TheMuzeum_NFT.TheMuzeum_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&TheMuzeum_NFT.Collection{TheMuzeum_NFT.TheMuzeum_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "undefined/themuzeum/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "undefined/themuzeum/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: TheMuzeum_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: TheMuzeum_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(TheMuzeum_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: TheMuzeum_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &TheMuzeum_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(TheMuzeum_NFT.CollectionPublicPath)
            .borrow<&TheMuzeum_NFT.Collection{TheMuzeum_NFT.TheMuzeum_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&TheMuzeum_NFT.Admin>(
