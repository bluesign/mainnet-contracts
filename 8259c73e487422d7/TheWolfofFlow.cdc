...
pub contract TheWolfofFlow: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeig3vjkn2xxqxm4f24jmyrfuahzj35pxiticfaqlzbznjjggcnzwdi"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeih4bwu6rmntnsenlxlsjtmioeblvdn7ujcs4tz45u3vwy4mul46u4"
                    ),
                    mediaType: "image"
                )
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "The Wolf of Flow",
                    symbol: "WOLF",
                    description: "$WOLF a fair launch meme coin on @flow_blockchain",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("thewolfofflow"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: TheWolfofFlow.VaultStoragePath,
                    receiverPath: TheWolfofFlow.ReceiverPublicPath,
                    metadataPath: TheWolfofFlow.VaultPublicPath,
                    providerPath: /private/TheWolfofFlowVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("TheWolfofFlow", self.account.address, "WOLF", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
