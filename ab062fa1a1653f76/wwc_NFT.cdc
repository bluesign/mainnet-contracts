...
pub contract wwc_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            wwc_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintwwc_NFT(
			...
			recipient.deposit(token: <-create wwc_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: wwc_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: wwc_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: wwc_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: wwc_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: wwc_NFT.CollectionStoragePath,
                        publicPath: wwc_NFT.CollectionPublicPath,
                        providerPath: /private/wwc_NFT,
                        publicCollection: Type<&wwc_NFT.Collection{wwc_NFT.wwc_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&wwc_NFT.Collection{wwc_NFT.wwc_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&wwc_NFT.Collection{wwc_NFT.wwc_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "undefined/wwc/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "undefined/wwc/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: wwc_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: wwc_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(wwc_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: wwc_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &wwc_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(wwc_NFT.CollectionPublicPath)
            .borrow<&wwc_NFT.Collection{wwc_NFT.wwc_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&wwc_NFT.Admin>(
