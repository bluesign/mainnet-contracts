...
pub contract Baminerry: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Baminerry",
                    symbol: "BAMI",
                    description: "This is a community project that is building based on community opinion",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Baminerry.VaultStoragePath,
                    receiverPath: Baminerry.ReceiverPublicPath,
                    metadataPath: Baminerry.VaultPublicPath,
                    providerPath: /private/BaminerryVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Baminerry", self.account.address, "BAMI", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
