...
pub contract Portal: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Portal",
                    symbol: "PORT",
                    description: "A Flow DAO for the people",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Portal.VaultStoragePath,
                    receiverPath: Portal.ReceiverPublicPath,
                    metadataPath: Portal.VaultPublicPath,
                    providerPath: /private/PortalVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Portal", self.account.address, "PORT", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
