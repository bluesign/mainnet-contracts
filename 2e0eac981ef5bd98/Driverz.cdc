...
pub contract Driverz: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Driverz World",
                    symbol: "VROOM",
                    description: "Our token is hosted outside of Toucans.Check out $VROOM token on https://driverz.world/.",
                    externalURL: MetadataViews.ExternalURL("driverz.world/"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("Driverz.World"),
                        "discord": MetadataViews.ExternalURL("driverz")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Driverz.VaultStoragePath,
                    receiverPath: Driverz.ReceiverPublicPath,
                    metadataPath: Driverz.VaultPublicPath,
                    providerPath: /private/DriverzVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Driverz", self.account.address, "VROOM", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
