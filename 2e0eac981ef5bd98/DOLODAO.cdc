...
pub contract DOLODAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "DOLO DAO",
                    symbol: "DOLO",
                    description: "Maybe something. Probably nothing.",
                    externalURL: MetadataViews.ExternalURL("https://twitter.com/dolodood"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("dolodood"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: DOLODAO.VaultStoragePath,
                    receiverPath: DOLODAO.ReceiverPublicPath,
                    metadataPath: DOLODAO.VaultPublicPath,
                    providerPath: /private/DOLODAOVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("DOLODAO", self.account.address, "DOLO", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
