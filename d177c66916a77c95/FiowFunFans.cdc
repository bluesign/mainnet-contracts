...
pub contract FiowFunFans: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Fiow Fun Fans",
                    symbol: "FFF",
                    description: "Soooooooooooon.",
                    externalURL: MetadataViews.ExternalURL("x.com/freedomrum"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("freedomrum"),
                        "discord": MetadataViews.ExternalURL("Irin4394")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: FiowFunFans.VaultStoragePath,
                    receiverPath: FiowFunFans.ReceiverPublicPath,
                    metadataPath: FiowFunFans.VaultPublicPath,
                    providerPath: /private/FiowFunFansVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("FiowFunFans", self.account.address, "FFF", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
