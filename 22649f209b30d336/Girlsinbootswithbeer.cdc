...
pub contract Girlsinbootswithbeer: NonFungibleToken, ViewResolver {
    ...
    NiftoryNonFungibleToken.NFTPublic
  {
    ...
    init(setId: Int, templateId: Int, serial: UInt64) {
      ...
      Girlsinbootswithbeer.totalSupply =
        Girlsinbootswithbeer.totalSupply + 1
      self.setId = setId
    ...
    NiftoryNonFungibleToken.ManagerPrivate
  {
      ...
      &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public}
    {
      return NiftoryNFTRegistry
        .getSetManagerPublic(
          Girlsinbootswithbeer.REGISTRY_ADDRESS,
          Girlsinbootswithbeer.REGISTRY_BRAND
        )
    }
  ...
  init(
    ...
    let record = NiftoryNFTRegistry.generateRecord(
      ...
      project: "clg8k5ynk0000jm0w2mv5o2a3_Girlsinbootswithbeer"
    )
    ...
    self
      ...
      .save<@MutableMetadataSetManager.Manager>(
        <-MutableMetadataSetManager.create(
          name: "Girlsinbootswithbeer",
          description: "The set manager for Girlsinbootswithbeer."
        ),
