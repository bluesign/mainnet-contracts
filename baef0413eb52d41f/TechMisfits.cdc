...
pub contract TechMisfits: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String) {
            ...
            TechMisfits.totalSupply = TechMisfits.totalSupply + (1 as UInt64)
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return  MetadataViews.NFTCollectionData(
                        storagePath: TechMisfits.CollectionStoragePath,
                        publicPath: TechMisfits.CollectionPublicPath,
                        providerPath: /private/TechMisfitsCollection,
                        publicCollection: Type<&TechMisfits.Collection{TechMisfits.TechMisfitsCollectionPublic}>(),
                        publicLinkedType: Type<&TechMisfits.Collection{TechMisfitsCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&TechMisfits.Collection{TechMisfitsCollectionPublic,NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: "TechMisfits",
                        description: TechMisfits.Description,
                        externalURL: TechMisfits.ExternalURL,
                        squareImage: TechMisfits.SquareImage,
                        bannerImage: TechMisfits.BannerImage,
                        socials: TechMisfits.Socials
                    )
    ...
    pub resource Mutator {
        ...
        pub fun mutatePFP(tokenID: UInt64, name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String){
           ...
           pre{
                tokenID <= TechMisfits.totalSupply: "the tokenID does not exist"
           }
    ...
    pub resource Admin {
        ...
        pub fun setSquareImage(url: String, mediaType: String) {
            TechMisfits.SquareImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun setBannerImage(url: String, mediaType: String) {
            TechMisfits.BannerImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun addDefaultRoyalty(name: String, royalty: MetadataViews.Royalty, rate: UFix64){
            ...
            pre {
                TechMisfits.defaultRoyalties[name] == nil: "The royalty with that name already exists"
        ...
        pub fun changeDefaultRoyaltyRate(name: String, rate: UFix64) {
            pre {
                TechMisfits.defaultRoyalties[name] != nil: "The royalty with that name does not exist"
                rate > 0.0: "Cannot set rate to less than 0%"
                rate <= 1.0: "Cannot set rate to more than 100%"
            }
    ...
    init() {
        ...
        self.SquareImage = MetadataViews.Media(
            file: MetadataViews.HTTPFile(
                url: "https://dkuxa1i6sgo8h.cloudfront.net/umbadaima/TechMisfitsBanner.png"
            ),
            mediaType: "image/png"
        )
