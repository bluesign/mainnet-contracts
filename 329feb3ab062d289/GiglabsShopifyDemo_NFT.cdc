...
pub contract GiglabsShopifyDemo_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        //
	    pub fun mintGiglabsShopifyDemo_NFT(
			...
			recipient.deposit(token: <-create GiglabsShopifyDemo_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionGiglabsShopifyDemo_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
		...
		pub fun batchMintGiglabsShopifyDemo_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
            ...
            for tokenId in tokenIds {
                self.mintGiglabsShopifyDemo_NFT(
                    recipient: recipient,
                    tokenId: tokenId,
                    setId: setId
                )
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: GiglabsShopifyDemo_NFT.CollectionStoragePath,
                        publicPath: GiglabsShopifyDemo_NFT.CollectionPublicPath,
                        providerPath: /private/GiglabsShopifyDemo_NFT,
                        publicCollection: Type<&GiglabsShopifyDemo_NFT.Collection{GiglabsShopifyDemo_NFT.GiglabsShopifyDemo_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&GiglabsShopifyDemo_NFT.Collection{GiglabsShopifyDemo_NFT.GiglabsShopifyDemo_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&GiglabsShopifyDemo_NFT.Collection{GiglabsShopifyDemo_NFT.GiglabsShopifyDemo_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/giglabsshopifydemo/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/giglabsshopifydemo/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &GiglabsShopifyDemo_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(GiglabsShopifyDemo_NFT.CollectionPublicPath)
            .borrow<&GiglabsShopifyDemo_NFT.Collection{GiglabsShopifyDemo_NFT.GiglabsShopifyDemo_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&GiglabsShopifyDemo_NFT.Admin>(
