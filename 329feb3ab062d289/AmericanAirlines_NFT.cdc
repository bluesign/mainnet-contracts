...
pub contract AmericanAirlines_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        //
	    pub fun mintAmericanAirlines_NFT(
			...
			recipient.deposit(token: <-create AmericanAirlines_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionAmericanAirlines_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
		...
		pub fun batchMintAmericanAirlines_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/americanairlines/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/americanairlines/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: AmericanAirlines_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: AmericanAirlines_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(AmericanAirlines_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: AmericanAirlines_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &AmericanAirlines_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(AmericanAirlines_NFT.CollectionPublicPath)
            .borrow<&AmericanAirlines_NFT.Collection{AmericanAirlines_NFT.AmericanAirlines_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&AmericanAirlines_NFT.Admin>(
