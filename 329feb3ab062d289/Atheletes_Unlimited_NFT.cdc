...
pub contract Atheletes_Unlimited_NFT: NonFungibleToken {
	...
	pub resource Series {
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionAtheletes_Unlimited_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: Atheletes_Unlimited_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: Atheletes_Unlimited_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: Atheletes_Unlimited_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: Atheletes_Unlimited_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: Atheletes_Unlimited_NFT.CollectionStoragePath,
                        publicPath: Atheletes_Unlimited_NFT.CollectionPublicPath,
                        providerPath: /private/Atheletes_Unlimited_NFT,
                        publicCollection: Type<&Atheletes_Unlimited_NFT.Collection{Atheletes_Unlimited_NFT.Atheletes_Unlimited_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&Atheletes_Unlimited_NFT.Collection{Atheletes_Unlimited_NFT.Atheletes_Unlimited_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&Atheletes_Unlimited_NFT.Collection{Atheletes_Unlimited_NFT.Atheletes_Unlimited_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/atheletes_unlimited/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/atheletes_unlimited/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: Atheletes_Unlimited_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: Atheletes_Unlimited_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(Atheletes_Unlimited_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: Atheletes_Unlimited_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
