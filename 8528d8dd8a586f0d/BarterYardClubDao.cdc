...
pub contract BarterYardClubDao: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreiaurtq3hlqp5covqafm43ibknrft27blwb3xaep4u7clag4ywiuka"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeia33yz2rawsswuw4ysctjj2zo3hjbp6kjus7u4d2hnbc7jxhpanoq"
                    ),
                    mediaType: "image"
                )
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Barter Yard Club",
                    symbol: "BYC",
                    description: "Barter Yard Club is a DAO creating the next generation of internet tools.",
                    externalURL: MetadataViews.ExternalURL("www.barteryard.club"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("barteryard"),
                        "discord": MetadataViews.ExternalURL("cq7YsnE6Dt")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: BarterYardClubDao.VaultStoragePath,
                    receiverPath: BarterYardClubDao.ReceiverPublicPath,
                    metadataPath: BarterYardClubDao.VaultPublicPath,
                    providerPath: /private/BarterYardClubDaoVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("BarterYardClubDao", self.account.address, "BYC", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
