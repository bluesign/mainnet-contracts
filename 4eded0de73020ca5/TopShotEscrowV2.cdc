...
pub contract TopShotEscrowV2 {
    ...
    pub resource EscrowItem: EscrowItemPublic {
        ...
        init(
            ...
            let adminTopShotReceiverRef = TopShotEscrowV2.account.getCapability(/public/MomentCollection).borrow<&{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, TopShot.MomentCollectionPublic}>()
        ...
        pub fun redeem(NFTIds: [UInt64]) {
            ...
            let providerTopShotProviderRef: &TopShot.Collection? = TopShotEscrowV2.account.borrow<&TopShot.Collection>(from: /storage/MomentCollection) 
                    ?? panic("Cannot borrow collection")
    ...
    pub fun createEscrow(
        ...
        let escrowCollectionRef = self.account.borrow<&TopShotEscrowV2.EscrowCollection>(from: self.escrowStoragePath) ??
    ...
    init() {
        ...
        self.account.link<&TopShotEscrowV2.EscrowCollection{TopShotEscrowV2.EscrowCollectionPublic}>(self.escrowPublicPath, target: self.escrowStoragePath)
    }   
}
