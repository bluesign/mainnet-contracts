...
pub contract ByrdFeed: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Byrd Feed",
                    symbol: "BYRD",
                    description: "Feed for the byrds",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: ByrdFeed.VaultStoragePath,
                    receiverPath: ByrdFeed.ReceiverPublicPath,
                    metadataPath: ByrdFeed.VaultPublicPath,
                    providerPath: /private/ByrdFeedVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("ByrdFeed", self.account.address, "BYRD", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
