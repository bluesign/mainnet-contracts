...
pub contract FlowOG: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Flow OG",
                    symbol: "OGF",
                    description: "Empowering Early Flow Pioneers",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: FlowOG.VaultStoragePath,
                    receiverPath: FlowOG.ReceiverPublicPath,
                    metadataPath: FlowOG.VaultPublicPath,
                    providerPath: /private/FlowOGVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("FlowOG", self.account.address, "OGF", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
