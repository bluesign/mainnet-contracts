...
pub contract Ron_Kamonohashi_Deranged_Detective: NonFungibleToken, Anique {
    // -----------------------------------------------------------------------
    // Ron_Kamonohashi_Deranged_Detective contract Events
    // -----------------------------------------------------------------------

    // Events for Contract-Related actions
    //
    // Emitted when the Ron_Kamonohashi_Deranged_Detective contract is created
    ...
    // -----------------------------------------------------------------------
    // Ron_Kamonohashi_Deranged_Detective contract-level fields.
    ...
    // -----------------------------------------------------------------------
    // Ron_Kamonohashi_Deranged_Detective contract-level Composite Type definitions
    // -----------------------------------------------------------------------

    // The structure that represents Item
    // each digital content which Ron_Kamonohashi_Deranged_Detective deal with on Flow
    //
    pub struct ItemData {
        ...
        init(itemID: UInt32) {
            let item = (&Ron_Kamonohashi_Deranged_Detective.items[itemID] as &Item?)!
    ...
    pub resource Item {
        ...
        init(metadata: {String: String}) {
            ...
            self.itemID = Ron_Kamonohashi_Deranged_Detective.nextItemID
            self.metadata = metadata
            self.numberMintedPerItem = 0

            // increment the nextItemID so that it isn't used again
            Ron_Kamonohashi_Deranged_Detective.nextItemID = Ron_Kamonohashi_Deranged_Detective.nextItemID + 1
    ...
    pub resource NFT: NonFungibleToken.INFT, Anique.INFT {
        ...
        init(serialNumber: UInt32, itemID: UInt32) {
            ...
            Ron_Kamonohashi_Deranged_Detective.totalSupply = Ron_Kamonohashi_Deranged_Detective.totalSupply + 1

            // set id
            self.id = Ron_Kamonohashi_Deranged_Detective.totalSupply
    ...
    // interface that represents Ron_Kamonohashi_Deranged_Detective collections to public
    ...
    pub resource interface CollectionPublic {
        ...
        // borrow NFT as Ron_Kamonohashi_Deranged_Detective token
        pub fun borrowRon_Kamonohashi_Deranged_DetectiveCollectible(id: UInt64): auth &NFT
    }
    ...
    pub resource Collection: CollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic {
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            ...
            // Cast the deposited token as an Ron_Kamonohashi_Deranged_Detective NFT to make sure
            // it is the correct type
            let token <- token as! @Ron_Kamonohashi_Deranged_Detective.NFT
        ...
        // not any Ron_Kamonohashi_Deranged_Detective specific data. Please use borrowCollectible to
        ...
        // borrowRon_Kamonohashi_Deranged_DetectiveCollectible returns a borrowed reference
        // to an Ron_Kamonohashi_Deranged_Detective Collectible
        pub fun borrowRon_Kamonohashi_Deranged_DetectiveCollectible(id: UInt64): auth &NFT {
            pre {
    ...
    pub resource Admin {
        ...
        // and stores it in the Items dictionary field in the Ron_Kamonohashi_Deranged_Detective smart contract
        //
        ...
        pub fun createItem(metadata: {String: String}): UInt32 {
            ...
            Ron_Kamonohashi_Deranged_Detective.items[newItem.itemID] <-! newItem

            return itemId
        }

        // borrowItem returns a reference to a Item in the Ron_Kamonohashi_Deranged_Detective
        ...
        pub fun borrowItem(itemID: UInt32): &Item {
            pre {
                Ron_Kamonohashi_Deranged_Detective.items[itemID] != nil: "Cannot borrow Item: The Item doesn't exist"
            }

            return (&Ron_Kamonohashi_Deranged_Detective.items[itemID] as &Item?)!
        }
    ...
    // -----------------------------------------------------------------------
    // Ron_Kamonohashi_Deranged_Detective contract-level function definitions
    // -----------------------------------------------------------------------
    ...
    pub fun createEmptyCollection(): @NonFungibleToken.Collection {
        return <-create Ron_Kamonohashi_Deranged_Detective.Collection()
    }
    ...
    // -----------------------------------------------------------------------
    // Ron_Kamonohashi_Deranged_Detective initialization function
    // -----------------------------------------------------------------------
    //
    init() {
        ...
        self.collectionStoragePath     = /storage/Ron_Kamonohashi_Deranged_DetectiveCollection
        self.collectionPublicPath      =  /public/Ron_Kamonohashi_Deranged_DetectiveCollection
        self.collectionPrivatePath     = /private/Ron_Kamonohashi_Deranged_DetectiveCollection
        self.adminStoragePath          = /storage/Ron_Kamonohashi_Deranged_DetectiveAdmin
        self.saleCollectionStoragePath = /storage/Ron_Kamonohashi_Deranged_DetectiveSaleCollection
        self.saleCollectionPublicPath  =  /public/Ron_Kamonohashi_Deranged_DetectiveSaleCollection
