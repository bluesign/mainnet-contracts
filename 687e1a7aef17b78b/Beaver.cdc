...
pub contract Beaver: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeid4icgfrn46k3ze2f6vbus53zk7mnkofjpqgs3oyrdiispr5hfe7e"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeiblasflqd3geg7eribz7vshayqkay2drlhgr3zg4slndum4i6ernm"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Beaver",
                    symbol: "PUSS",
                    description: "Hey, nice beaver",
                    externalURL: MetadataViews.ExternalURL("beavercoin.io"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("beavercoinflow"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Beaver.VaultStoragePath,
                    receiverPath: Beaver.ReceiverPublicPath,
                    metadataPath: Beaver.VaultPublicPath,
                    providerPath: /private/BeaverVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Beaver", self.account.address, "PUSS", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
