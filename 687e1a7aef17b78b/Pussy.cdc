...
pub contract Pussy: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreidf6272p52ry3j2fu4ab77j4f3mjokamugqcryrtwvw5mv7njxvnm"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Pussy",
                    symbol: "PUSSY",
                    description: "$Pussy on Flow ",
                    externalURL: MetadataViews.ExternalURL("pussyonflow.com"),
                    logos: medias,
                    socials: {
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Pussy.VaultStoragePath,
                    receiverPath: Pussy.ReceiverPublicPath,
                    metadataPath: Pussy.VaultPublicPath,
                    providerPath: /private/PussyVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Pussy", self.account.address, "PUSSY", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
