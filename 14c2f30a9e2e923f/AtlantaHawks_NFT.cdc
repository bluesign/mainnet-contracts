...
pub contract AtlantaHawks_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            AtlantaHawks_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintAtlantaHawks_NFT(
			...
			recipient.deposit(token: <-create AtlantaHawks_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionAtlantaHawks_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
		...
		pub fun batchMintAtlantaHawks_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: AtlantaHawks_NFT.CollectionStoragePath,
                        publicPath: AtlantaHawks_NFT.CollectionPublicPath,
                        providerPath: /private/AtlantaHawks_NFT,
                        publicCollection: Type<&AtlantaHawks_NFT.Collection{AtlantaHawks_NFT.AtlantaHawks_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&AtlantaHawks_NFT.Collection{AtlantaHawks_NFT.AtlantaHawks_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&AtlantaHawks_NFT.Collection{AtlantaHawks_NFT.AtlantaHawks_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/atlantahawks/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/atlantahawks/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &AtlantaHawks_NFT.NFT? {
        let collection = getAccount(from)
            ...
            .borrow<&AtlantaHawks_NFT.Collection{AtlantaHawks_NFT.AtlantaHawks_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&AtlantaHawks_NFT.Admin>(
