...
pub contract gigdev_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            gigdev_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintgigdev_NFT(
			...
			recipient.deposit(token: <-create gigdev_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: gigdev_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: gigdev_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: gigdev_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: gigdev_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: gigdev_NFT.CollectionStoragePath,
                        publicPath: gigdev_NFT.CollectionPublicPath,
                        providerPath: /private/gigdev_NFT,
                        publicCollection: Type<&gigdev_NFT.Collection{gigdev_NFT.gigdev_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&gigdev_NFT.Collection{gigdev_NFT.gigdev_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&gigdev_NFT.Collection{gigdev_NFT.gigdev_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "undefined/gigdev/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "undefined/gigdev/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: gigdev_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: gigdev_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(gigdev_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: gigdev_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &gigdev_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(gigdev_NFT.CollectionPublicPath)
            .borrow<&gigdev_NFT.Collection{gigdev_NFT.gigdev_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&gigdev_NFT.Admin>(
