...
pub contract Flex: NonFungibleToken {
    ...
    pub resource NFTMinter {
        ...
        pub fun mintNFT(
            ...
            recipient.deposit(token: <-create Flex.NFT(
                id: Flex.totalSupply,
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &Flex.NFT? {
        let collection = getAccount(from)
            .getCapability(Flex.CollectionPublicPath)!
            .borrow<&Flex.Collection{Flex.FlexCollectionPublic}>()
    ...
    init() {
        ...
        self.account.link<&Flex.Collection{NonFungibleToken.CollectionPublic, Flex.FlexCollectionPublic}>(
