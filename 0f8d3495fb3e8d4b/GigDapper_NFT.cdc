...
pub contract GigDapper_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            GigDapper_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintGigDapper_NFT(
			...
			recipient.deposit(token: <-create GigDapper_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionGigDapper_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
		...
		pub fun batchMintGigDapper_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: GigDapper_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: GigDapper_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: GigDapper_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: GigDapper_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: GigDapper_NFT.CollectionStoragePath,
                        publicPath: GigDapper_NFT.CollectionPublicPath,
                        providerPath: /private/GigDapper_NFT,
                        publicCollection: Type<&GigDapper_NFT.Collection{GigDapper_NFT.GigDapper_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&GigDapper_NFT.Collection{GigDapper_NFT.GigDapper_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&GigDapper_NFT.Collection{GigDapper_NFT.GigDapper_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/gigdapper/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/gigdapper/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: GigDapper_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: GigDapper_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(GigDapper_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &GigDapper_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(GigDapper_NFT.CollectionPublicPath)
            .borrow<&GigDapper_NFT.Collection{GigDapper_NFT.GigDapper_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&GigDapper_NFT.Admin>(
