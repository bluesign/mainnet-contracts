...
pub contract Insight: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Insight ",
                    symbol: "INS",
                    description: "Space explorers, are you ready for a new adventure? Then let's start the adventure ",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Insight.VaultStoragePath,
                    receiverPath: Insight.ReceiverPublicPath,
                    metadataPath: Insight.VaultPublicPath,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Insight", self.account.address, "INS", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
