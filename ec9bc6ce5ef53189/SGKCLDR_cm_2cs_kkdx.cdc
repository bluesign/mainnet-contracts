...
pub contract SGKCLDR_cm_2cs_kkdx: NonFungibleToken, Anique {
    // -----------------------------------------------------------------------
    // SGKCLDR_cm_2cs_kkdx contract Events
    // -----------------------------------------------------------------------

    // Events for Contract-Related actions
    //
    // Emitted when the SGKCLDR_cm_2cs_kkdx contract is created
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_cm_2cs_kkdx contract-level fields.
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_cm_2cs_kkdx contract-level Composite Type definitions
    // -----------------------------------------------------------------------

    // The structure that represents Item
    // each digital content which SGKCLDR_cm_2cs_kkdx deal with on Flow
    //
    pub struct ItemData {
        ...
        init(itemID: UInt32) {
            let item = (&SGKCLDR_cm_2cs_kkdx.items[itemID] as &Item?)!
    ...
    pub resource Item {
        ...
        init(metadata: {String: String}) {
            ...
            self.itemID = SGKCLDR_cm_2cs_kkdx.nextItemID
            self.metadata = metadata
            self.numberMintedPerItem = 0

            // increment the nextItemID so that it isn't used again
            SGKCLDR_cm_2cs_kkdx.nextItemID = SGKCLDR_cm_2cs_kkdx.nextItemID + 1
    ...
    pub resource NFT: NonFungibleToken.INFT, Anique.INFT {
        ...
        init(serialNumber: UInt32, itemID: UInt32) {
            ...
            SGKCLDR_cm_2cs_kkdx.totalSupply = SGKCLDR_cm_2cs_kkdx.totalSupply + 1

            // set id
            self.id = SGKCLDR_cm_2cs_kkdx.totalSupply
    ...
    // interface that represents SGKCLDR_cm_2cs_kkdx collections to public
    ...
    pub resource interface CollectionPublic {
        ...
        // borrow NFT as SGKCLDR_cm_2cs_kkdx token
        pub fun borrowSGKCLDR_cm_2cs_kkdxCollectible(id: UInt64): auth &NFT
    }
    ...
    pub resource Collection: CollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic {
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            ...
            // Cast the deposited token as an SGKCLDR_cm_2cs_kkdx NFT to make sure
            // it is the correct type
            let token <- token as! @SGKCLDR_cm_2cs_kkdx.NFT
        ...
        // not any SGKCLDR_cm_2cs_kkdx specific data. Please use borrowCollectible to
        ...
        // borrowSGKCLDR_cm_2cs_kkdxCollectible returns a borrowed reference
        // to an SGKCLDR_cm_2cs_kkdx Collectible
        pub fun borrowSGKCLDR_cm_2cs_kkdxCollectible(id: UInt64): auth &NFT {
            pre {
    ...
    pub resource Admin {
        ...
        // and stores it in the Items dictionary field in the SGKCLDR_cm_2cs_kkdx smart contract
        //
        ...
        pub fun createItem(metadata: {String: String}): UInt32 {
            ...
            SGKCLDR_cm_2cs_kkdx.items[newItem.itemID] <-! newItem

            return itemId
        }

        // borrowItem returns a reference to a Item in the SGKCLDR_cm_2cs_kkdx
        ...
        pub fun borrowItem(itemID: UInt32): &Item {
            pre {
                SGKCLDR_cm_2cs_kkdx.items[itemID] != nil: "Cannot borrow Item: The Item doesn't exist"
            }

            return (&SGKCLDR_cm_2cs_kkdx.items[itemID] as &Item?)!
        }
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_cm_2cs_kkdx contract-level function definitions
    // -----------------------------------------------------------------------
    ...
    pub fun createEmptyCollection(): @NonFungibleToken.Collection {
        return <-create SGKCLDR_cm_2cs_kkdx.Collection()
    }
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_cm_2cs_kkdx initialization function
    // -----------------------------------------------------------------------
    //
    init() {
        ...
        self.collectionStoragePath     = /storage/SGKCLDR_cm_2cs_kkdxCollection
        self.collectionPublicPath      =  /public/SGKCLDR_cm_2cs_kkdxCollection
        self.collectionPrivatePath     = /private/SGKCLDR_cm_2cs_kkdxCollection
        self.adminStoragePath          = /storage/SGKCLDR_cm_2cs_kkdxAdmin
        self.saleCollectionStoragePath = /storage/SGKCLDR_cm_2cs_kkdxSaleCollection
        self.saleCollectionPublicPath  =  /public/SGKCLDR_cm_2cs_kkdxSaleCollection
