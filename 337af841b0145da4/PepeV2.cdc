...
pub contract PepeV2: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "PepeV2",
                    symbol: "PEPEF",
                    description: "PepeV2 or (PEPEF) its the flow people token ,aint gonna be here writing a book so... we're here to make the token scarcer and give a happy ending to our holders. We gonna have a plenty surprises and giveaways ,We're holding Piggos,Pirates ,BYC's and etc we the collectors we the fam ,so i think u know what to expect.",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("Daddy44Block"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: PepeV2.VaultStoragePath,
                    receiverPath: PepeV2.ReceiverPublicPath,
                    metadataPath: PepeV2.VaultPublicPath,
                    providerPath: /private/PepeV2Vault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("PepeV2", self.account.address, "PEPEF", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
