...
pub contract tffactory: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "T. F. F",
                    symbol: "TFF",
                    description: "We are a creative organization that provides digital fashion, avatars, and digital fan goods to support the creative activities of musicians and artists.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: tffactory.VaultStoragePath,
                    receiverPath: tffactory.ReceiverPublicPath,
                    metadataPath: tffactory.VaultPublicPath,
                    providerPath: /private/tffactoryVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("tffactory", self.account.address, "TFF", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
