...
pub contract Fomus: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Fomus",
                    symbol: "FOM",
                    description: "Dao for real holders of the Flow token. The future is in our hands.",
                    externalURL: MetadataViews.ExternalURL("twitter.com/timon4room"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("@timon4room"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Fomus.VaultStoragePath,
                    receiverPath: Fomus.ReceiverPublicPath,
                    metadataPath: Fomus.VaultPublicPath,
                    providerPath: /private/FomusVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Fomus", self.account.address, "FOM", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
