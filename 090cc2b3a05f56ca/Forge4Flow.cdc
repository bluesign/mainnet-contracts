...
pub contract Forge4Flow: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Forge4Flow",
                    symbol: "FORGE",
                    description: "Forge Secure Web3 DApp's On Flow",
                    externalURL: MetadataViews.ExternalURL("forge4flow.com"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("forge4flow"),
                        "discord": MetadataViews.ExternalURL("z7GCDeVhYG")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Forge4Flow.VaultStoragePath,
                    receiverPath: Forge4Flow.ReceiverPublicPath,
                    metadataPath: Forge4Flow.VaultPublicPath,
                    providerPath: /private/Forge4FlowVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Forge4Flow", self.account.address, "FORGE", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
