...
pub contract ethosAIFIIInvestor: NonFungibleToken {
      ...
      switch view {
          ...
          case Type<MetadataViews.NFTCollectionData>():
            return MetadataViews.NFTCollectionData(
                storagePath: ethosAIFIIInvestor.CollectionStoragePath,
                publicPath: ethosAIFIIInvestor.CollectionPublicPath,
                providerPath: ethosAIFIIInvestor.CollectionPrivatePath,
          ...
          case Type<MetadataViews.NFTCollectionDisplay>():
            let squareMedia: MetadataViews.Media = MetadataViews.Media(
              file: ethosAIFIIInvestor.getCollectionAttribute(key: "image") as! MetadataViews.HTTPFile,
              mediaType: "image"
            )
            ...
            return MetadataViews.NFTCollectionDisplay(
              name: ethosAIFIIInvestor.getCollectionAttribute(key: "name") as! String,
              description: ethosAIFIIInvestor.getCollectionAttribute(key: "description") as! String,
              externalURL: MetadataViews.ExternalURL("https://jade.ethosnft.com/collections/".concat(self.owner!.address.toString()).concat("/ethosAIFIIInvestor")),
              squareImage: squareMedia,
              bannerImage: bannerMedia ?? squareMedia,
              socials: ethosAIFIIInvestor.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
            )
  ...
  init() {
    ...
    self.account.link<&ethosAIFIIInvestor.Collection{NonFungibleToken.CollectionPublic, ethosAIFIIInvestor.CollectionPublic, MetadataViews.ResolverCollection}>(
