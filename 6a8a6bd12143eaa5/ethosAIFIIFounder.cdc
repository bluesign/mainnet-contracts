...
pub contract ethosAIFIIFounder: NonFungibleToken {
      ...
      switch view {
          ...
          case Type<MetadataViews.NFTCollectionData>():
            return MetadataViews.NFTCollectionData(
                storagePath: ethosAIFIIFounder.CollectionStoragePath,
                publicPath: ethosAIFIIFounder.CollectionPublicPath,
                providerPath: ethosAIFIIFounder.CollectionPrivatePath,
          ...
          case Type<MetadataViews.NFTCollectionDisplay>():
            let squareMedia: MetadataViews.Media = MetadataViews.Media(
              file: ethosAIFIIFounder.getCollectionAttribute(key: "image") as! MetadataViews.HTTPFile,
              mediaType: "image"
            )
            ...
            return MetadataViews.NFTCollectionDisplay(
              name: ethosAIFIIFounder.getCollectionAttribute(key: "name") as! String,
              description: ethosAIFIIFounder.getCollectionAttribute(key: "description") as! String,
              externalURL: MetadataViews.ExternalURL("https://jade.ethosnft.com/collections/".concat(self.owner!.address.toString()).concat("/ethosAIFIIFounder")),
              squareImage: squareMedia,
              bannerImage: bannerMedia ?? squareMedia,
              socials: ethosAIFIIFounder.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
            )
  ...
  init() {
    ...
    self.account.link<&ethosAIFIIFounder.Collection{NonFungibleToken.CollectionPublic, ethosAIFIIFounder.CollectionPublic, MetadataViews.ResolverCollection}>(
