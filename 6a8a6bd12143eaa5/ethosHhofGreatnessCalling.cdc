...
pub contract ethosHhofGreatnessCalling: NonFungibleToken {
      ...
      switch view {
          ...
          case Type<MetadataViews.NFTCollectionData>():
            return MetadataViews.NFTCollectionData(
                storagePath: ethosHhofGreatnessCalling.CollectionStoragePath,
                publicPath: ethosHhofGreatnessCalling.CollectionPublicPath,
                providerPath: ethosHhofGreatnessCalling.CollectionPrivatePath,
          ...
          case Type<MetadataViews.NFTCollectionDisplay>():
            let squareMedia: MetadataViews.Media = MetadataViews.Media(
              file: ethosHhofGreatnessCalling.getCollectionAttribute(key: "image") as! MetadataViews.HTTPFile,
              mediaType: "image"
            )
            ...
            return MetadataViews.NFTCollectionDisplay(
              name: ethosHhofGreatnessCalling.getCollectionAttribute(key: "name") as! String,
              description: ethosHhofGreatnessCalling.getCollectionAttribute(key: "description") as! String,
              externalURL: MetadataViews.ExternalURL("https://jade.ethosnft.com/collections/".concat(self.owner!.address.toString()).concat("/ethosHhofGreatnessCalling")),
              squareImage: squareMedia,
              bannerImage: bannerMedia ?? squareMedia,
              socials: ethosHhofGreatnessCalling.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
            )
  ...
  init() {
    ...
    self.account.link<&ethosHhofGreatnessCalling.Collection{NonFungibleToken.CollectionPublic, ethosHhofGreatnessCalling.CollectionPublic, MetadataViews.ResolverCollection}>(
