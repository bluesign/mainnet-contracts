...
pub contract OpenEditionV3 {
    ...
    init() {
        ...
        self.account.save(<-openEdition, to: OpenEditionV3.CollectionStoragePath)         
        self.account.link<&{OpenEditionV3.OpenEditionCollectionPublic}>(OpenEditionV3.CollectionPublicPath, target: OpenEditionV3.CollectionStoragePath)
    }   
}
