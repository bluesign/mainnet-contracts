...
pub contract TouchstoneDiamondFistsRetroBlueLogoNFTs: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneDiamondFistsRetroBlueLogoNFTs.CollectionStoragePath,
						publicPath: TouchstoneDiamondFistsRetroBlueLogoNFTs.CollectionPublicPath,
						providerPath: TouchstoneDiamondFistsRetroBlueLogoNFTs.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneDiamondFistsRetroBlueLogoNFTs"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneDiamondFistsRetroBlueLogoNFTs.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneDiamondFistsRetroBlueLogoNFTs.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneDiamondFistsRetroBlueLogoNFTs.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneDiamondFistsRetroBlueLogoNFTs")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneDiamondFistsRetroBlueLogoNFTs.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneDiamondFistsRetroBlueLogoNFTs.metadatas[TouchstoneDiamondFistsRetroBlueLogoNFTs.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			pre {
				EmeraldPass.isActive(user: TouchstoneDiamondFistsRetroBlueLogoNFTs.account.address): "You must have an active Emerald Pass subscription to airdrop NFTs. You can purchase Emerald Pass at https://pass.ecdao.org/"
			}
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneDiamondFistsRetroBlueLogoNFTs.CollectionPublicPath).borrow<&TouchstoneDiamondFistsRetroBlueLogoNFTs.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneDiamondFistsRetroBlueLogoNFTs.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
