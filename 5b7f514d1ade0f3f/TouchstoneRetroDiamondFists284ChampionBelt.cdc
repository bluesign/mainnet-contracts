...
pub contract TouchstoneRetroDiamondFists284ChampionBelt: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneRetroDiamondFists284ChampionBelt.CollectionStoragePath,
						publicPath: TouchstoneRetroDiamondFists284ChampionBelt.CollectionPublicPath,
						providerPath: TouchstoneRetroDiamondFists284ChampionBelt.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneRetroDiamondFists284ChampionBelt"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneRetroDiamondFists284ChampionBelt.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneRetroDiamondFists284ChampionBelt.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneRetroDiamondFists284ChampionBelt.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneRetroDiamondFists284ChampionBelt")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneRetroDiamondFists284ChampionBelt.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneRetroDiamondFists284ChampionBelt.metadatas[TouchstoneRetroDiamondFists284ChampionBelt.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			pre {
				EmeraldPass.isActive(user: TouchstoneRetroDiamondFists284ChampionBelt.account.address): "You must have an active Emerald Pass subscription to airdrop NFTs. You can purchase Emerald Pass at https://pass.ecdao.org/"
			}
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneRetroDiamondFists284ChampionBelt.CollectionPublicPath).borrow<&TouchstoneRetroDiamondFists284ChampionBelt.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneRetroDiamondFists284ChampionBelt.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
