...
pub contract TouchstoneDiamondFistsGoldLogoNFTs: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneDiamondFistsGoldLogoNFTs.CollectionStoragePath,
						publicPath: TouchstoneDiamondFistsGoldLogoNFTs.CollectionPublicPath,
						providerPath: TouchstoneDiamondFistsGoldLogoNFTs.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneDiamondFistsGoldLogoNFTs"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneDiamondFistsGoldLogoNFTs.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneDiamondFistsGoldLogoNFTs.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneDiamondFistsGoldLogoNFTs.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneDiamondFistsGoldLogoNFTs")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneDiamondFistsGoldLogoNFTs.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneDiamondFistsGoldLogoNFTs.metadatas[TouchstoneDiamondFistsGoldLogoNFTs.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			pre {
				EmeraldPass.isActive(user: TouchstoneDiamondFistsGoldLogoNFTs.account.address): "You must have an active Emerald Pass subscription to airdrop NFTs. You can purchase Emerald Pass at https://pass.ecdao.org/"
			}
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneDiamondFistsGoldLogoNFTs.CollectionPublicPath).borrow<&TouchstoneDiamondFistsGoldLogoNFTs.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneDiamondFistsGoldLogoNFTs.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
