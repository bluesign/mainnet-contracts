...
pub contract TouchstoneDiamondFistsBlueLogoNFTs: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneDiamondFistsBlueLogoNFTs.CollectionStoragePath,
						publicPath: TouchstoneDiamondFistsBlueLogoNFTs.CollectionPublicPath,
						providerPath: TouchstoneDiamondFistsBlueLogoNFTs.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneDiamondFistsBlueLogoNFTs"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneDiamondFistsBlueLogoNFTs.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneDiamondFistsBlueLogoNFTs.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneDiamondFistsBlueLogoNFTs.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneDiamondFistsBlueLogoNFTs")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneDiamondFistsBlueLogoNFTs.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneDiamondFistsBlueLogoNFTs.metadatas[TouchstoneDiamondFistsBlueLogoNFTs.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			pre {
				EmeraldPass.isActive(user: TouchstoneDiamondFistsBlueLogoNFTs.account.address): "You must have an active Emerald Pass subscription to airdrop NFTs. You can purchase Emerald Pass at https://pass.ecdao.org/"
			}
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneDiamondFistsBlueLogoNFTs.CollectionPublicPath).borrow<&TouchstoneDiamondFistsBlueLogoNFTs.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneDiamondFistsBlueLogoNFTs.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
