...
pub contract TouchstoneDiamondFistsRetroPixelBlueLogoNFTs: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.CollectionStoragePath,
						publicPath: TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.CollectionPublicPath,
						providerPath: TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneDiamondFistsRetroPixelBlueLogoNFTs"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneDiamondFistsRetroPixelBlueLogoNFTs")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.metadatas[TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			pre {
				EmeraldPass.isActive(user: TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.account.address): "You must have an active Emerald Pass subscription to airdrop NFTs. You can purchase Emerald Pass at https://pass.ecdao.org/"
			}
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.CollectionPublicPath).borrow<&TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneDiamondFistsRetroPixelBlueLogoNFTs.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
