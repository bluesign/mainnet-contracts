...
pub contract SGKCLDR_at_gap_aa24: NonFungibleToken, Anique {
    // -----------------------------------------------------------------------
    // SGKCLDR_at_gap_aa24 contract Events
    // -----------------------------------------------------------------------

    // Events for Contract-Related actions
    //
    // Emitted when the SGKCLDR_at_gap_aa24 contract is created
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_at_gap_aa24 contract-level fields.
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_at_gap_aa24 contract-level Composite Type definitions
    // -----------------------------------------------------------------------

    // The structure that represents Item
    // each digital content which SGKCLDR_at_gap_aa24 deal with on Flow
    //
    pub struct ItemData {
        ...
        init(itemID: UInt32) {
            let item = (&SGKCLDR_at_gap_aa24.items[itemID] as &Item?)!
    ...
    pub resource Item {
        ...
        init(metadata: {String: String}) {
            ...
            self.itemID = SGKCLDR_at_gap_aa24.nextItemID
            self.metadata = metadata
            self.numberMintedPerItem = 0

            // increment the nextItemID so that it isn't used again
            SGKCLDR_at_gap_aa24.nextItemID = SGKCLDR_at_gap_aa24.nextItemID + 1
    ...
    pub resource NFT: NonFungibleToken.INFT, Anique.INFT {
        ...
        init(serialNumber: UInt32, itemID: UInt32) {
            ...
            SGKCLDR_at_gap_aa24.totalSupply = SGKCLDR_at_gap_aa24.totalSupply + 1

            // set id
            self.id = SGKCLDR_at_gap_aa24.totalSupply
    ...
    // interface that represents SGKCLDR_at_gap_aa24 collections to public
    ...
    pub resource interface CollectionPublic {
        ...
        // borrow NFT as SGKCLDR_at_gap_aa24 token
        pub fun borrowSGKCLDR_at_gap_aa24Collectible(id: UInt64): auth &NFT
    }
    ...
    pub resource Collection: CollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic {
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            ...
            // Cast the deposited token as an SGKCLDR_at_gap_aa24 NFT to make sure
            // it is the correct type
            let token <- token as! @SGKCLDR_at_gap_aa24.NFT
        ...
        // not any SGKCLDR_at_gap_aa24 specific data. Please use borrowCollectible to
        ...
        // borrowSGKCLDR_at_gap_aa24Collectible returns a borrowed reference
        // to an SGKCLDR_at_gap_aa24 Collectible
        pub fun borrowSGKCLDR_at_gap_aa24Collectible(id: UInt64): auth &NFT {
            pre {
    ...
    pub resource Admin {
        ...
        // and stores it in the Items dictionary field in the SGKCLDR_at_gap_aa24 smart contract
        //
        ...
        pub fun createItem(metadata: {String: String}): UInt32 {
            ...
            SGKCLDR_at_gap_aa24.items[newItem.itemID] <-! newItem

            return itemId
        }

        // borrowItem returns a reference to a Item in the SGKCLDR_at_gap_aa24
        ...
        pub fun borrowItem(itemID: UInt32): &Item {
            pre {
                SGKCLDR_at_gap_aa24.items[itemID] != nil: "Cannot borrow Item: The Item doesn't exist"
            }

            return (&SGKCLDR_at_gap_aa24.items[itemID] as &Item?)!
        }
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_at_gap_aa24 contract-level function definitions
    // -----------------------------------------------------------------------
    ...
    pub fun createEmptyCollection(): @NonFungibleToken.Collection {
        return <-create SGKCLDR_at_gap_aa24.Collection()
    }
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_at_gap_aa24 initialization function
    // -----------------------------------------------------------------------
    //
    init() {
        ...
        self.collectionStoragePath     = /storage/SGKCLDR_at_gap_aa24Collection
        self.collectionPublicPath      =  /public/SGKCLDR_at_gap_aa24Collection
        self.collectionPrivatePath     = /private/SGKCLDR_at_gap_aa24Collection
        self.adminStoragePath          = /storage/SGKCLDR_at_gap_aa24Admin
        self.saleCollectionStoragePath = /storage/SGKCLDR_at_gap_aa24SaleCollection
        self.saleCollectionPublicPath  =  /public/SGKCLDR_at_gap_aa24SaleCollection
