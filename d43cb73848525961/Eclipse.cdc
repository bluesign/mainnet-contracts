...
pub contract Eclipse: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreiaxmzssokqqovpsf7zsou3yjwzipchyphjnz22cxsymzvzcadt3um"
                    ),
                    mediaType: "image"
                )
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Eclipse.VaultStoragePath,
                    receiverPath: Eclipse.ReceiverPublicPath,
                    metadataPath: Eclipse.VaultPublicPath,
                    providerPath: /private/EclipseVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Eclipse", self.account.address, "ECLPS", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
