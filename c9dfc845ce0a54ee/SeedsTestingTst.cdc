...
pub contract SeedsTestingTst: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: "SeedsTestingTst",
                        description: "This NFT is not yet revealed.",
                        thumbnail: MetadataViews.IPFSFile(
                            cid: SeedsTestingTst.placeholderImage, 
                            path: nil
                        )
                    )
        ...
        pub fun resolveNFTCollectionData(): MetadataViews.NFTCollectionData {
            return MetadataViews.NFTCollectionData(
                storagePath: SeedsTestingTst.CollectionStoragePath,
                publicPath: SeedsTestingTst.CollectionPublicPath,
                providerPath: SeedsTestingTst.CollectionPrivatePath,
                publicCollection: Type<&SeedsTestingTst.Collection{SeedsTestingTst.SeedsTestingTstCollectionPublic}>(),
                publicLinkedType: Type<&SeedsTestingTst.Collection{SeedsTestingTst.SeedsTestingTstCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(),
                providerLinkedType: Type<&SeedsTestingTst.Collection{SeedsTestingTst.SeedsTestingTstCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(),
                createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                    return <-SeedsTestingTst.createEmptyCollection()
                })
            )
        }
    ...
    pub resource interface SeedsTestingTstCollectionPublic {
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT
        pub fun borrowSeedsTestingTst(id: UInt64): &SeedsTestingTst.NFT? {
            post {
    ...
    pub resource Collection: SeedsTestingTstCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection {
    ...
    pub resource Admin {
        ...
        pub fun revealNFT(id: UInt64, metadata: Metadata) {
            pre {
                SeedsTestingTst.metadata[id] == nil : "NFT has already been revealed"
            }
    ...
    priv fun initAdmin(admin: AuthAccount) {
        ...
        let collection <- SeedsTestingTst.createEmptyCollection()
        ...
        admin.link<&SeedsTestingTst.Collection{NonFungibleToken.CollectionPublic, SeedsTestingTst.SeedsTestingTstCollectionPublic, MetadataViews.ResolverCollection}>(SeedsTestingTst.CollectionPublicPath, target: SeedsTestingTst.CollectionStoragePath)
