...
pub contract SwoleDoge: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "SwoleDoge",
                    symbol: "SWOGE",
                    description: "The number 1 dog coin on flow!Forget $DOGE, forget $BONK, foget $WIF, forget $SHIB, now is the time for $SWOGE!Liquidity pool to be created on full funding.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: SwoleDoge.VaultStoragePath,
                    receiverPath: SwoleDoge.ReceiverPublicPath,
                    metadataPath: SwoleDoge.VaultPublicPath,
                    providerPath: /private/SwoleDogeVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("SwoleDoge", self.account.address, "SWOGE", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
