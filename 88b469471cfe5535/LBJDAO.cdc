...
pub contract LBJDAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeiap65dolssr775a366jk4kl63exbxcpeehwo23jccacxndscxccne"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreiad4drc6vsjm3zy34ph6ymgnb5yiwp7gmyojosndjwppzkjfyjssa"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "LBJ DAO",
                    symbol: "LBJ",
                    description: "An unofficial DAO for everyone who saw LBJ's gorgeous play.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: LBJDAO.VaultStoragePath,
                    receiverPath: LBJDAO.ReceiverPublicPath,
                    metadataPath: LBJDAO.VaultPublicPath,
                    providerPath: /private/LBJDAOVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("LBJDAO", self.account.address, "LBJ", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
