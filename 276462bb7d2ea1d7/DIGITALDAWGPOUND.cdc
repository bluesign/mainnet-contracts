...
pub contract DIGITALDAWGPOUND: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeiftplvxejdamrbnv6emqge7tbvetcnl6s5j5kgzpxfdjyp3v6xqgu"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreibf5e7yeo6b4n7j4gzmryt36ba7jquv6s5fobzoojacwrw465oxca"
                    ),
                    mediaType: "image"
                )
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Hamiltyne Bulldogs MFC",
                    symbol: "BYTE",
                    description: "Welcome to the DIGITALDAWGPOUND! Earn $BYTE tokens to unleash your team decision-making powers, one BITE at a time. Join our Toucans DAO for Hamiltyne Bulldogs MFC on Flow blockchain and be a part of revolutionizing sports governance!",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("HamiltyneMFC"),
                        "discord": MetadataViews.ExternalURL("8yAc9F4CFX")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: DIGITALDAWGPOUND.VaultStoragePath,
                    receiverPath: DIGITALDAWGPOUND.ReceiverPublicPath,
                    metadataPath: DIGITALDAWGPOUND.VaultPublicPath,
                    providerPath: /private/DIGITALDAWGPOUNDVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("DIGITALDAWGPOUND", self.account.address, "BYTE", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
