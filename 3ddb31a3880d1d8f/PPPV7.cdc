    ...
    */
    ...
    access(all) resource Admin {
        ...
        access(all) fun setPointsRate_stFlowHoldingTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "stFlowHolding", ori: PPPV7._pointsRate["stFlowHolding"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV7._pointsRate["stFlowHolding"] = tierRate
        }
        access(all) fun setPointsRate_LendingSupplyTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingSupply", ori: PPPV7._pointsRate["LendingSupply"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV7._pointsRate["LendingSupply"] = tierRate
        }
        access(all) fun setPointsRate_LendingBorrowTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingBorrow", ori: PPPV7._pointsRate["LendingBorrow"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV7._pointsRate["LendingBorrow"] = tierRate
        }
        access(all) fun setPointsRate_SwapLPTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "SwapLP", ori: PPPV7._pointsRate["SwapLP"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV7._pointsRate["SwapLP"] = tierRate
        }
        access(all) fun setPointsRate_SwapVolumeTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "SwapVolume", ori: PPPV7._pointsRate["SwapVolume"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV7._pointsRate["SwapVolume"] = tierRate
        }
        access(all) fun setPointsRate_ReferrerUp(rate: UFix64) {
            emit PointsRateChanged(source: "ReferrerUp", ori: PPPV7._pointsRate["ReferrerUp"]! as! UFix64, new: rate)
            PPPV7._pointsRate["ReferrerUp"] = rate
        }
        access(all) fun setPointsRate_RefereeUp(rate: UFix64) {
            emit PointsRateChanged(source: "RefereeUp", ori: PPPV7._pointsRate["RefereeUp"]! as! UFix64, new: rate)
            PPPV7._pointsRate["RefereeUp"] = rate
        }
        access(all) fun setPointsRate_CoreMember(rate: UFix64) {
            emit PointsRateChanged(source: "CoreMember", ori: PPPV7._pointsRate["CoreMember"]! as! UFix64, new: rate)
            PPPV7._pointsRate["CoreMember"] = rate
        }

        // Add Swap Pool in Whiltelist
        access(all) fun addSwapPoolInWhiltelist(poolAddr: Address) {
            PPPV7._swapPoolWhitelist[poolAddr] = true
        }
        // Remove Swap Pool in Whitelist
        access(all) fun removeSwapPoolInWhiltelist(poolAddr: Address) {
            PPPV7._swapPoolWhitelist.remove(key: poolAddr)
        }

        // Set history snapshot points
        access(all) fun setHistorySnapshotPoints(userAddr: Address, newSnapshotBalance: UFix64) {
            if PPPV7._pointsHistorySnapshot.containsKey(userAddr) == false {
                PPPV7._pointsHistorySnapshot[userAddr] = 0.0
            }
            if PPPV7._pointsBase.containsKey(userAddr) == false {
                PPPV7._pointsBase[userAddr] = 0.0
            }
            let preSnapshotBalance = PPPV7._pointsHistorySnapshot[userAddr]!
            ...
            PPPV7._totalSupply = PPPV7._totalSupply - preSnapshotBalance + newSnapshotBalance
            PPPV7._pointsHistorySnapshot[userAddr] = newSnapshotBalance
        }
        access(all) fun setClaimEndTimestamp(endTime: UFix64) {
            PPPV7._claimEndTimestamp = endTime
        }

        // Ban user
        access(all) fun addUserBlackList(userAddr: Address) {
            PPPV7._userBlacklist[userAddr] = true
        }
        access(all) fun removeUserBlackList(userAddr: Address) {
            PPPV7._userBlacklist.remove(key: userAddr)
        }

        access(all) fun addVolumePoints(userAddr: Address, volumePoints: UFix64, volumeUsd: UFix64) {
            PPPV7._mint(targetAddr: userAddr, amount: volumePoints)

            if PPPV7._userStates.containsKey(userAddr) == false {
                PPPV7._userStates[userAddr] = {}
            }
            PPPV7.setUserState_SwapVolume(userAddr: userAddr, volume: PPPV7.getUserState_SwapVolume(userAddr: userAddr) + volumeUsd)
            emit PointsMinted(
                userAddr: userAddr,
                amount: volumePoints,
                source: "SwapVolume", 
            ...
            emit StateUpdated(userAddr: userAddr, state: PPPV7._userStates[userAddr]!)
        }
        ...
        access(all) fun reconcileBasePoints(userAddr: Address, newBasePoints: UFix64) {
            ...
            let preBasePoints = PPPV7._pointsBase[userAddr]!
            ...
            PPPV7._totalSupply = PPPV7._totalSupply - preBasePoints + newBasePoints
            PPPV7._pointsBase[userAddr] = newBasePoints
        }

        access(all) fun updateTopUsers(addrs: [Address]) {
            emit TopUsersChanged(ori: PPPV7._topUsers, new: addrs)
            PPPV7._topUsers = addrs
        }

        // TODO
        access(all) fun testResetIfSnapshot(userAddr: Address) {
            PPPV7._ifClaimHistorySnapshot[userAddr] = false
        }
    }
