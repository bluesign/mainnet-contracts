...
pub contract PPPV4 {
    ...
    */
    ...
    // 
    access(all) view fun calculateNewPointsSinceLastUpdate(userAddr: Address): AnyStruct {
    ...
    access(all) view fun getBasePointsBoostRate(_ userAddr: Address): UFix64 {
        let referrerAddr = RV2.getReferrerByReferee(referee: userAddr)
    ...
    access(all) view fun getPointsRate_SwapVolume(): UFix64 { return self._pointsRate["SwapVolume"]! as! UFix64 }
    ...
    access(all) view fun getUserState_LendingSupply(userAddr: Address): UFix64 { return self._userStates[userAddr]!.containsKey("LendingTotalSupplyUsd")? self._userStates[userAddr]!["LendingTotalSupplyUsd"]! : 0.0 }
    access(all) view fun getUserState_LendingBorrow(userAddr: Address): UFix64 { return self._userStates[userAddr]!.containsKey("LendingTotalBorrowUsd")? self._userStates[userAddr]!["LendingTotalBorrowUsd"]! : 0.0 }
    access(all) view fun getUserState_stFlowHolding(userAddr: Address): UFix64 { return self._userStates[userAddr]!.containsKey("stFlowHolding")? self._userStates[userAddr]!["stFlowHolding"]! : 0.0 }
    access(all) view fun getUserState_SwapLPUsd(userAddr: Address): UFix64 { return self._userStates[userAddr]!.containsKey("SwapLpUsd")? self._userStates[userAddr]!["SwapLpUsd"]! : 0.0 }
    access(all) view fun getUserState_SwapLPAmount(userAddr: Address): UFix64 { return self._userStates[userAddr]!.containsKey("SwapLpAmount")? self._userStates[userAddr]!["SwapLpAmount"]! : 0.0 }
    access(all) view fun getUserState_SwapVolume(userAddr: Address): UFix64 { return self._userStates[userAddr]!.containsKey("SwapVolumeUsd")? self._userStates[userAddr]!["SwapVolumeUsd"]! : 0.0 }
    ...
    access(all) resource Admin {
        ...
        access(all) fun setPointsRate_stFlowHoldingTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "stFlowHolding", ori: PPPV4._pointsRate["stFlowHolding"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV4._pointsRate["stFlowHolding"] = tierRate
        }
        access(all) fun setPointsRate_LendingSupplyTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingSupply", ori: PPPV4._pointsRate["LendingSupply"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV4._pointsRate["LendingSupply"] = tierRate
        }
        access(all) fun setPointsRate_LendingBorrowTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingBorrow", ori: PPPV4._pointsRate["LendingBorrow"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV4._pointsRate["LendingBorrow"] = tierRate
        }
        access(all) fun setPointsRate_SwapLPTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "SwapLP", ori: PPPV4._pointsRate["SwapLP"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV4._pointsRate["SwapLP"] = tierRate
        }
        access(all) fun setPointsRate_SwapVolume(rate: UFix64) {
            emit PointsRateChanged(source: "SwapVolume", ori: PPPV4._pointsRate["SwapVolume"]! as! UFix64, new: rate)
            PPPV4._pointsRate["SwapVolume"] = rate
        }
        access(all) fun setPointsRate_ReferrerUp(rate: UFix64) {
            emit PointsRateChanged(source: "ReferrerUp", ori: PPPV4._pointsRate["ReferrerUp"]! as! UFix64, new: rate)
            PPPV4._pointsRate["ReferrerUp"] = rate
        }
        access(all) fun setPointsRate_RefereeUp(rate: UFix64) {
            emit PointsRateChanged(source: "RefereeUp", ori: PPPV4._pointsRate["RefereeUp"]! as! UFix64, new: rate)
            PPPV4._pointsRate["RefereeUp"] = rate
        }
        access(all) fun setPointsRate_CoreMember(rate: UFix64) {
            emit PointsRateChanged(source: "CoreMember", ori: PPPV4._pointsRate["CoreMember"]! as! UFix64, new: rate)
            PPPV4._pointsRate["CoreMember"] = rate
        }

        // Add Swap Pool in Whiltelist
        access(all) fun addSwapPoolInWhiltelist(poolAddr: Address) {
            PPPV4._swapPoolWhitelist[poolAddr] = true
        }
        // Remove Swap Pool in Whitelist
        access(all) fun removeSwapPoolInWhiltelist(poolAddr: Address) {
            PPPV4._swapPoolWhitelist.remove(key: poolAddr)
        }

        // Set history snapshot points
        access(all) fun setHistorySnapshotPoints(userAddr: Address, newSnapshotBalance: UFix64) {
            if PPPV4._pointsHistorySnapshot.containsKey(userAddr) == false {
                PPPV4._pointsHistorySnapshot[userAddr] = 0.0
            }
            if PPPV4._pointsBase.containsKey(userAddr) == false {
                PPPV4._pointsBase[userAddr] = 0.0
            }
            let preSnapshotBalance = PPPV4._pointsHistorySnapshot[userAddr]!
            ...
            PPPV4._totalSupply = PPPV4._totalSupply - preSnapshotBalance + newSnapshotBalance
            PPPV4._pointsHistorySnapshot[userAddr] = newSnapshotBalance
        }

        // Ban user
        access(all) fun addUserBlackList(userAddr: Address) {
            PPPV4._userBlacklist[userAddr] = true
        }
        access(all) fun removeUserBlackList(userAddr: Address) {
            PPPV4._userBlacklist.remove(key: userAddr)
        }
        access(all) fun reconcileBasePoints(userAddr: Address, newBasePoints: UFix64) {
            ...
            let preBasePoints = PPPV4._pointsBase[userAddr]!
            ...
            PPPV4._totalSupply = PPPV4._totalSupply - preBasePoints + newBasePoints
            PPPV4._pointsBase[userAddr] = newBasePoints
        }

        access(all) fun updateTopUsers(addrs: [Address]) {
            emit TopUsersChanged(ori: PPPV4._topUsers, new: addrs)
            PPPV4._topUsers = addrs
        }     
    }
