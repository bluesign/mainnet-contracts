...
pub contract RV1 {
    ...
    access(self) let _referrerToReferees: {Address: {Address: UFix64}}
    ...
    access(all) view fun getSlicedRefereesByReferrer(referrer: Address, from: Int, to: Int): {Address: UFix64} {
        if self._referrerToReferees.containsKey(referrer) == false {
            return {}
        }
