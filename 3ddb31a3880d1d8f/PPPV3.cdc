    ...
    */
    ...
    access(all) resource Admin {
        ...
        access(all) fun setPointsRate_stFlowHoldingTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "stFlowHolding", ori: PPPV3._pointsRatePerDay["stFlowHolding"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV3._pointsRatePerDay["stFlowHolding"] = tierRate
        }
        access(all) fun setPointsRate_LendingSupplyTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingSupply", ori: PPPV3._pointsRatePerDay["LendingSupply"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV3._pointsRatePerDay["LendingSupply"] = tierRate
        }
        access(all) fun setPointsRate_LendingBorrowTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingBorrow", ori: PPPV3._pointsRatePerDay["LendingBorrow"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV3._pointsRatePerDay["LendingBorrow"] = tierRate
        }
        access(all) fun setPointsRate_SwapLPTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "SwapLP", ori: PPPV3._pointsRatePerDay["SwapLP"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV3._pointsRatePerDay["SwapLP"] = tierRate
        }
        access(all) fun setPointsRate_SwapVolume(rate: UFix64) {
            emit PointsRateChanged(source: "SwapVolume", ori: PPPV3._pointsRatePerDay["SwapVolume"]! as! UFix64, new: rate)
            PPPV3._pointsRatePerDay["SwapVolume"] = rate
        }
        access(all) fun setPointsRate_ReferrerUp(rate: UFix64) {
            emit PointsRateChanged(source: "ReferrerUp", ori: PPPV3._pointsRatePerDay["ReferrerUp"]! as! UFix64, new: rate)
            PPPV3._pointsRatePerDay["ReferrerUp"] = rate
        }
        access(all) fun setPointsRate_RefereeUp(rate: UFix64) {
            emit PointsRateChanged(source: "RefereeUp", ori: PPPV3._pointsRatePerDay["RefereeUp"]! as! UFix64, new: rate)
