    ...
    */
    ...
    access(all) resource Admin {
        ...
        access(all) fun setPointsRate_stFlowHoldingTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "stFlowHolding", ori: PPPV8._pointsRate["stFlowHolding"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV8._pointsRate["stFlowHolding"] = tierRate
        }
        access(all) fun setPointsRate_LendingSupplyTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingSupply", ori: PPPV8._pointsRate["LendingSupply"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV8._pointsRate["LendingSupply"] = tierRate
        }
        access(all) fun setPointsRate_LendingBorrowTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingBorrow", ori: PPPV8._pointsRate["LendingBorrow"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV8._pointsRate["LendingBorrow"] = tierRate
        }
        access(all) fun setPointsRate_SwapLPTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "SwapLP", ori: PPPV8._pointsRate["SwapLP"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV8._pointsRate["SwapLP"] = tierRate
        }
        access(all) fun setPointsRate_SwapVolumeTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "SwapVolume", ori: PPPV8._pointsRate["SwapVolume"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV8._pointsRate["SwapVolume"] = tierRate
        }
        access(all) fun setPointsRate_ReferrerUp(rate: UFix64) {
            emit PointsRateChanged(source: "ReferrerUp", ori: PPPV8._pointsRate["ReferrerUp"]! as! UFix64, new: rate)
            PPPV8._pointsRate["ReferrerUp"] = rate
        }
        access(all) fun setPointsRate_RefereeUp(rate: UFix64) {
            emit PointsRateChanged(source: "RefereeUp", ori: PPPV8._pointsRate["RefereeUp"]! as! UFix64, new: rate)
            PPPV8._pointsRate["RefereeUp"] = rate
        }
        access(all) fun setPointsRate_CoreMember(rate: UFix64) {
            emit PointsRateChanged(source: "CoreMember", ori: PPPV8._pointsRate["CoreMember"]! as! UFix64, new: rate)
        ...
        access(all) fun setHistorySnapshotPoints(userAddr: Address, newSnapshotBalance: UFix64) {
            ...
            PPPV8._totalSupply = PPPV8._totalSupply - preSnapshotBalance + newSnapshotBalance
        ...
        access(all) fun addVolumePoints(userAddr: Address, volumePoints: UFix64, volumeUsd: UFix64) {
            ...
            PPPV8.setUserState_SwapVolume(userAddr: userAddr, volume: PPPV8.getUserState_SwapVolume(userAddr: userAddr) + volumeUsd)
            emit PointsMinted(
                userAddr: userAddr,
                amount: volumePoints,
                source: "SwapVolume", 
            ...
            emit StateUpdated(userAddr: userAddr, state: PPPV8._userStates[userAddr]!)
        }
        ...
        access(all) fun reconcileBasePoints(userAddr: Address, newBasePoints: UFix64) {
            ...
            PPPV8._totalSupply = PPPV8._totalSupply - preBasePoints + newBasePoints
