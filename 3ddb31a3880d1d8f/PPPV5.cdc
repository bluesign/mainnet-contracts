    ...
    */
    ...
    access(all) resource Admin {
        ...
        access(all) fun setPointsRate_stFlowHoldingTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "stFlowHolding", ori: PPPV5._pointsRate["stFlowHolding"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV5._pointsRate["stFlowHolding"] = tierRate
        }
        access(all) fun setPointsRate_LendingSupplyTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingSupply", ori: PPPV5._pointsRate["LendingSupply"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV5._pointsRate["LendingSupply"] = tierRate
        }
        access(all) fun setPointsRate_LendingBorrowTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingBorrow", ori: PPPV5._pointsRate["LendingBorrow"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV5._pointsRate["LendingBorrow"] = tierRate
        }
        access(all) fun setPointsRate_SwapLPTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "SwapLP", ori: PPPV5._pointsRate["SwapLP"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV5._pointsRate["SwapLP"] = tierRate
        }
        access(all) fun setPointsRate_SwapVolumeTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "SwapVolume", ori: PPPV5._pointsRate["SwapVolume"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV5._pointsRate["SwapVolume"] = tierRate
        }
        access(all) fun setPointsRate_ReferrerUp(rate: UFix64) {
            emit PointsRateChanged(source: "ReferrerUp", ori: PPPV5._pointsRate["ReferrerUp"]! as! UFix64, new: rate)
            PPPV5._pointsRate["ReferrerUp"] = rate
        }
        access(all) fun setPointsRate_RefereeUp(rate: UFix64) {
            emit PointsRateChanged(source: "RefereeUp", ori: PPPV5._pointsRate["RefereeUp"]! as! UFix64, new: rate)
            PPPV5._pointsRate["RefereeUp"] = rate
        }
        access(all) fun setPointsRate_CoreMember(rate: UFix64) {
            emit PointsRateChanged(source: "CoreMember", ori: PPPV5._pointsRate["CoreMember"]! as! UFix64, new: rate)
