...
pub contract PPPV1 {
    ...
    */
    ...
    // Get Points Rate
    access(all) view fun getPointsRatePerDay_LendingSupply(amount: UFix64): UFix64 { return self.calculateTierRateByAmount(amount: amount, tier: self._pointsRatePerDay["LendingSupply"]! as! {UFix64: UFix64}) }
    access(all) view fun getPointsRatePerDay_LendingBorrow(amount: UFix64): UFix64 { return self.calculateTierRateByAmount(amount: amount, tier: self._pointsRatePerDay["LendingBorrow"]! as! {UFix64: UFix64}) }
    access(all) view fun getPointsRatePerDay_stFlowHolding(amount: UFix64): UFix64 { return self.calculateTierRateByAmount(amount: amount, tier: self._pointsRatePerDay["stFlowHolding"]! as! {UFix64: UFix64}) }
    access(all) view fun getPointsRatePerDay_SwapLP(amount: UFix64): UFix64 { return self.calculateTierRateByAmount(amount: amount, tier: self._pointsRatePerDay["SwapLP"]! as! {UFix64: UFix64}) }
    ...
    access(all) resource Admin {
        // Set Points Rate
        access(all) fun setPointsRatePerDay_stFlowHoldingTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "stFlowHolding", ori: PPPV1._pointsRatePerDay["stFlowHolding"]! as! {UFix64: UFix64}, new: tierRate)
        ...
        access(all) fun setPointsRatePerDay_LendingSupplyTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingSupply", ori: PPPV1._pointsRatePerDay["LendingSupply"]! as! {UFix64: UFix64}, new: tierRate)
        ...
        access(all) fun setPointsRatePerDay_LendingBorrowTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "LendingBorrow", ori: PPPV1._pointsRatePerDay["LendingBorrow"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV1._pointsRatePerDay["LendingBorrow"] = tierRate
        }
        access(all) fun setPointsRatePerDay_SwapLPTier(tierRate: {UFix64: UFix64}) {
            emit PointsTierRateChanged(source: "SwapLP", ori: PPPV1._pointsRatePerDay["SwapLP"]! as! {UFix64: UFix64}, new: tierRate)
            PPPV1._pointsRatePerDay["SwapLP"] = tierRate
        }
        access(all) fun setPointsRatePerDay_SwapVolume(rate: UFix64) {
            emit PointsRateChanged(source: "SwapVolume", ori: PPPV1._pointsRatePerDay["SwapVolume"]! as! UFix64, new: rate)
        ...
        access(all) fun setHistorySnapshotPointsBalance(userAddr: Address, newSnapshotBalance: UFix64) {
        ...
        access(all) fun reconcilePoints(userAddr: Address, newBalance: UFix64) {
