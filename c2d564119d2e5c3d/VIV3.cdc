...
pub contract VIV3 {
    ...
    pub event TokenListed(id: UInt64, type: Type, price: UFix64, seller: Address?)
    // emitted when the price of a listed token has changed
    pub event TokenPriceChanged(id: UInt64, type: Type, price: UFix64, seller: Address?)
    // emitted when a token is purchased
    pub event TokenPurchased(id: UInt64, type: Type, price: UFix64, seller: Address?)
