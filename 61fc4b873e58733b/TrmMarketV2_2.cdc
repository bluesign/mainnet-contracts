...
pub contract TrmMarketV2_2 {
    ...
    pub resource SaleCollection: SalePublic {
        ...
        access(self) var ownerCollection: Capability<&TrmAssetV2_2.Collection>
    ...
    pub fun createSaleCollection(ownerCollection: Capability<&TrmAssetV2_2.Collection>): @SaleCollection {
    ...
    pub resource Admin {
        ...
        pub fun listForTransfer(
            ...
            let saleCollectionCapability = getAccount(saleCollectionAddress).getCapability<&TrmMarketV2_2.SaleCollection{TrmMarketV2_2.SalePublic}>(
        ...
        pub fun rent(
            ...
            tokenID: UInt64,
            price: UFix64,
            recipient: Capability<&TrmRentV2_2.Collection{TrmRentV2_2.CollectionPublic}>,
            paymentID: String
        ): UInt64 {
            let saleCollectionCapability = getAccount(saleCollectionAddress).getCapability<&TrmMarketV2_2.SaleCollection{TrmMarketV2_2.SalePublic}>(
                TrmMarketV2_2.marketPublicPath
    ...
    init() {
        ...
        self.minterCapability = self.account.getCapability<&TrmRentV2_2.Minter>(TrmRentV2_2.minterPrivatePath)
