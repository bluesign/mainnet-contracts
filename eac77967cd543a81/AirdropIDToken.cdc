...
pub contract AirdropIDToken: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "AirdropID Token",
                    symbol: "AEIDT",
                    description: "Welcome Crypto AirdropID Bounty Sharing ChannelYou can get free Cryptocurrency Airdrop everyday here Airdrop - Testnet - Retroactive And How to earn money is simple.",
                    externalURL: MetadataViews.ExternalURL("t.me/DropAID"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("AirdropID_ID"),
                        "discord": MetadataViews.ExternalURL("DropAID")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: AirdropIDToken.VaultStoragePath,
                    receiverPath: AirdropIDToken.ReceiverPublicPath,
                    metadataPath: AirdropIDToken.VaultPublicPath,
                    providerPath: /private/AirdropIDTokenVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("AirdropIDToken", self.account.address, "AEIDT", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
