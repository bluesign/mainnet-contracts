...
pub contract bobobobo: FungibleToken, ViewResolver {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver {
        ...
        destroy() {
            if (self.balance > 0.0) {
                ...
                bobobobo.totalSupply = bobobobo.totalSupply - self.balance
            }
        }
    }
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeiakzagnmm7vybsw2xz2ahkmadojljqgtvmfhjryoynvxlarrqr7om"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "bobobobo",
                    symbol: "BOBO",
                    description: "If you don't want to donate to the DAO donate to TS bobobobo",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: bobobobo.VaultStoragePath,
                    receiverPath: bobobobo.ReceiverPublicPath,
                    metadataPath: bobobobo.VaultPublicPath,
                    providerPath: /private/boboboboVault,
                    ...
                    createEmptyVaultFunction: (fun (): @Vault {
                        return <- bobobobo.createEmptyVault()
                    })
                )
        }
        return nil
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("bobobobo", self.account.address, "BOBO", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
