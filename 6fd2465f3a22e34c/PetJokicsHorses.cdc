...
pub contract PetJokicsHorses: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreif54ujjuwa2xewkgy5wje3qos7mk77rjxfdwl3a47qsj6sxv3kzi4"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Pet Jokic's Horses",
                    symbol: "MVP",
                    description: "Nikola Jokic has been the best player in the world for years. As such, he has a lot of moments minted on NBA Top Shot. His horses are sad about the oversupply, which impacts their results. Let's make his horses happy.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: PetJokicsHorses.VaultStoragePath,
                    receiverPath: PetJokicsHorses.ReceiverPublicPath,
                    metadataPath: PetJokicsHorses.VaultPublicPath,
                    providerPath: /private/PetJokicsHorsesVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("PetJokicsHorses", self.account.address, "MVP", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
