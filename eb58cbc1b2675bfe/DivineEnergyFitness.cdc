...
pub contract DivineEnergyFitness: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "DivineEnergyFitness",
                    symbol: "DVINE",
                    description: "A health and wellness dao ",
                    externalURL: MetadataViews.ExternalURL("instagram.com/divineenergyfitness/"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("Divineenergy_"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: DivineEnergyFitness.VaultStoragePath,
                    receiverPath: DivineEnergyFitness.ReceiverPublicPath,
                    metadataPath: DivineEnergyFitness.VaultPublicPath,
                    providerPath: /private/DivineEnergyFitnessVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("DivineEnergyFitness", self.account.address, "DVINE", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
