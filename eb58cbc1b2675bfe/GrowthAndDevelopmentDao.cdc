...
pub contract GrowthAndDevelopmentDao: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Growth And Development Dao",
                    symbol: "GDN",
                    description: "A Generational Dao to bring those of growth and development to help propel web3 into the communities of the people",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: GrowthAndDevelopmentDao.VaultStoragePath,
                    receiverPath: GrowthAndDevelopmentDao.ReceiverPublicPath,
                    metadataPath: GrowthAndDevelopmentDao.VaultPublicPath,
                    providerPath: /private/GrowthAndDevelopmentDaoVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("GrowthAndDevelopmentDao", self.account.address, "GDN", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
