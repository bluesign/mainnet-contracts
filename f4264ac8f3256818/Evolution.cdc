...
pub contract Evolution: NonFungibleToken {
    ...
    pub resource Set {
        ...
        pub fun addItem(itemId: UInt32) {
            pre {
                Evolution.itemDatas[itemId] != nil: "Cannot add the Item to Set: Item doesn't exist."
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        pub fun originalMedia(): MetadataViews.Media {
            ...
            return MetadataViews.Media(
                file: MetadataViews.IPFSFile(cid: self.contentID(), path: self.data.itemId.toString().concat(extension)), 
                mediaType: mediaType
            )
        }
        ...
        pub fun squareImage(): MetadataViews.Media {
            return MetadataViews.Media(
                    file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreiddhegxjpqm4wz3ib6wb4wceploarw5otnvox43hqnfb6ou2376im"),
                    mediaType: "image/png"
                )
        }
            ...
            switch view {
                ...
                case Type<MetadataViews.Editions>():
                    let editions: [MetadataViews.Edition] = [
                        MetadataViews.Edition(
                            name: self.editionName(),
                            number: self.editionNumber(),
                            max: self.maxEditions()
                        )
                    ]
                    ...
                    return MetadataViews.Royalties(
                        cutInfos: [
                            MetadataViews.Royalty(
                                recepient: creator.getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver),
                                cut: 0.10,
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: /storage/f4264ac8f3256818_Evolution_Collection,
                        publicPath: /public/f4264ac8f3256818_Evolution_Collection,
                        providerPath: /private/f4264ac8f3256818_Evolution_Collection,
                        publicCollection: Type<&Evolution.Collection{Evolution.EvolutionCollectionPublic}>(),
                        publicLinkedType: Type<&Evolution.Collection{Evolution.EvolutionCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&Evolution.Collection{Evolution.EvolutionCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <-Evolution.createEmptyCollection()
                        })
                    )
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return MetadataViews.NFTCollectionDisplay(
                        ...
                        externalURL: self.collectionURL(),
                        squareImage: self.squareImage(),
                        bannerImage: self.bannerImage(),
                        socials: {
                            "twitter": MetadataViews.ExternalURL("https://twitter.com/BenMauroArt")
                        }
                    )
    ...
    pub resource interface EvolutionCollectionPublic {
    ...
    pub resource Collection: EvolutionCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection {
    ...
    pub fun getAllItems(): [Evolution.Item] {
    ...
    init() {
        ...
        self.account.save<@Collection>(<- create Collection(), to: /storage/EvolutionCollection)

        // Create a public capability for the Collection
        self.account.link<&{EvolutionCollectionPublic}>(/public/EvolutionCollection, target: /storage/EvolutionCollection)

        // Put the Admin in storage
        self.account.save<@Admin>(<- create Admin(), to: /storage/EvolutionAdmin)
