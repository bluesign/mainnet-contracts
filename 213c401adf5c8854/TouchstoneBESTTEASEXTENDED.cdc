...
pub contract TouchstoneBESTTEASEXTENDED: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneBESTTEASEXTENDED.CollectionStoragePath,
						publicPath: TouchstoneBESTTEASEXTENDED.CollectionPublicPath,
						providerPath: TouchstoneBESTTEASEXTENDED.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneBESTTEASEXTENDED"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneBESTTEASEXTENDED.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneBESTTEASEXTENDED.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneBESTTEASEXTENDED.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneBESTTEASEXTENDED")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneBESTTEASEXTENDED.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneBESTTEASEXTENDED.metadatas[TouchstoneBESTTEASEXTENDED.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			pre {
				EmeraldPass.isActive(user: TouchstoneBESTTEASEXTENDED.account.address): "You must have an active Emerald Pass subscription to airdrop NFTs. You can purchase Emerald Pass at https://pass.ecdao.org/"
			}
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneBESTTEASEXTENDED.CollectionPublicPath).borrow<&TouchstoneBESTTEASEXTENDED.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneBESTTEASEXTENDED.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
