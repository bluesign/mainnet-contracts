...
pub contract TouchstoneProfessorMetasAcademyHackathon2023: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneProfessorMetasAcademyHackathon2023.CollectionStoragePath,
						publicPath: TouchstoneProfessorMetasAcademyHackathon2023.CollectionPublicPath,
						providerPath: TouchstoneProfessorMetasAcademyHackathon2023.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneProfessorMetasAcademyHackathon2023"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneProfessorMetasAcademyHackathon2023.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneProfessorMetasAcademyHackathon2023.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneProfessorMetasAcademyHackathon2023.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneProfessorMetasAcademyHackathon2023")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneProfessorMetasAcademyHackathon2023.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneProfessorMetasAcademyHackathon2023.metadatas[TouchstoneProfessorMetasAcademyHackathon2023.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			pre {
				EmeraldPass.isActive(user: TouchstoneProfessorMetasAcademyHackathon2023.account.address): "You must have an active Emerald Pass subscription to airdrop NFTs. You can purchase Emerald Pass at https://pass.ecdao.org/"
			}
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneProfessorMetasAcademyHackathon2023.CollectionPublicPath).borrow<&TouchstoneProfessorMetasAcademyHackathon2023.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneProfessorMetasAcademyHackathon2023.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
