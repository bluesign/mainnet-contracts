...
pub contract ethsamba: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeiccp2t2gyldxunfzbr7qtp5dpu3fuakwdcwbs23ocga53ka2p3qbm"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeid2cwhtjp7hn4okpbwvam6llmblweggkxvrpyo7thub3y7zowdzyq"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "ethsamba",
                    symbol: "SAMBA",
                    description: "ETHSamba dá as boas-vindas a entusiastas e visionários do Ethereum de todo o Brasil para experimentar a magia da tecnologia blockchain através de eventos emocionantes.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: ethsamba.VaultStoragePath,
                    receiverPath: ethsamba.ReceiverPublicPath,
                    metadataPath: ethsamba.VaultPublicPath,
                    providerPath: /private/ethsambaVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("ethsamba", self.account.address, "SAMBA", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
