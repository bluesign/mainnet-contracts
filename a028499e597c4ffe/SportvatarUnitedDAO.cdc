...
pub contract SportvatarUnitedDAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeidz6cdofpqjjmtvlod4olmf5pzuyob7ianscbj7nyyistfo7f7lri"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreicwrruushz5t5pjy5jlf7eqvovexbzhna43l4v2iuu3iyinzme5z4"
                    ),
                    mediaType: "image"
                )
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Sportvatar United DAO",
                    symbol: "SUD",
                    description: "A DAO for Sportvatar holders to test their managerial wits through joint ownership in the Metaverse Football League",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: SportvatarUnitedDAO.VaultStoragePath,
                    receiverPath: SportvatarUnitedDAO.ReceiverPublicPath,
                    metadataPath: SportvatarUnitedDAO.VaultPublicPath,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("SportvatarUnitedDAO", self.account.address, "SUD", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
