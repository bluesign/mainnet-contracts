...
pub contract ArturTestOrg: NonFungibleToken {
    ...
    pub struct SetData {
        ...
        init(setID: UInt32) {
            pre {
                ArturTestOrg.sets[setID] != nil: "Cannot borrow Set: The Set doesn't exist"
            }
    ...
    pub resource Set {
        ...
        pub fun addCollectibleItem(collectibleItemID: UInt32) {
            pre {
                ArturTestOrg.collectibleItemDatas[collectibleItemID] != nil: "Cannot add the CollectibleItem to Set: CollectibleItem doesn't exist."
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: ArturTestOrg.CollectionStoragePath,
                        publicPath: ArturTestOrg.CollectionPublicPath,
                        providerPath: /private/ArturTestOrgCollection001,
                        publicCollection: Type<&ArturTestOrg.Collection{ArturTestOrg.ArturTestOrgCollectionPublic}>(),
                        publicLinkedType: Type<&ArturTestOrg.Collection{ArturTestOrg.ArturTestOrgCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&ArturTestOrg.Collection{ArturTestOrg.ArturTestOrgCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
