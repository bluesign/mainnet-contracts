...
pub contract breakingttest_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            breakingttest_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintbreakingttest_NFT(
			...
			recipient.deposit(token: <-create breakingttest_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		pub fun batchMintbreakingttest_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
    ...
    pub fun fetch(_ from: Address, id: UInt64): &breakingttest_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(breakingttest_NFT.CollectionPublicPath)
            .borrow<&breakingttest_NFT.Collection{breakingttest_NFT.breakingttest_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&breakingttest_NFT.Admin>(
