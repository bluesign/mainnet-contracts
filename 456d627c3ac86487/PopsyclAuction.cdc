...
pub contract PopsyclAuction {
    ...
    pub resource AuctionItem {
        ...
        priv var recipientCollectionCap: Capability<&{Popsycl.PopsyclCollectionPublic}>
        priv var recipientVaultCap: Capability<&{FungibleToken.Receiver}>?

        // Owner's Receiver Capabilities
        priv let ownerCollectionCap: Capability<&{Popsycl.PopsyclCollectionPublic}>
        ...
        access(contract) fun sendNFT(_ capability: Capability<&{Popsycl.PopsyclCollectionPublic}>) {
        ...
        pub fun placeBid(bidTokens: @FungibleToken.Vault, vaultCap: Capability<&{FungibleToken.Receiver}>, collectionCap: Capability<&{Popsycl.PopsyclCollectionPublic}>)  {
            pre {
                !self.auctionCompleted : "The auction is already settled"
                self.NFT != nil: "NFT in auction does not exist"
