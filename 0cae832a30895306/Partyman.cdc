...
pub contract Partyman: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreif27isitasik7iafmv6d6x2vhhponxsfogp5h45kprnl53ote3aei"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreifvxiggm6jbajbfttptaqnyzgdoijjq56jmv7nhe7bdsmm4xe6lqu"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Partyman",
                    symbol: "DANCE",
                    description: "All hail, the new king in town.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Partyman.VaultStoragePath,
                    receiverPath: Partyman.ReceiverPublicPath,
                    metadataPath: Partyman.VaultPublicPath,
                    providerPath: /private/PartymanVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Partyman", self.account.address, "DANCE", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
