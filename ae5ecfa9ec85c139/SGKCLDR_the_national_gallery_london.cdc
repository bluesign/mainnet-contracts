...
pub contract SGKCLDR_the_national_gallery_london: NonFungibleToken, Anique {
    // -----------------------------------------------------------------------
    // SGKCLDR_the_national_gallery_london contract Events
    // -----------------------------------------------------------------------

    // Events for Contract-Related actions
    //
    // Emitted when the SGKCLDR_the_national_gallery_london contract is created
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_the_national_gallery_london contract-level fields.
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_the_national_gallery_london contract-level Composite Type definitions
    // -----------------------------------------------------------------------

    // The structure that represents Item
    // each digital content which SGKCLDR_the_national_gallery_london deal with on Flow
    //
    pub struct ItemData {
        ...
        init(itemID: UInt32) {
            let item = (&SGKCLDR_the_national_gallery_london.items[itemID] as &Item?)!
    ...
    pub resource Item {
        ...
        init(metadata: {String: String}) {
            ...
            self.itemID = SGKCLDR_the_national_gallery_london.nextItemID
            self.metadata = metadata
            self.numberMintedPerItem = 0

            // increment the nextItemID so that it isn't used again
            SGKCLDR_the_national_gallery_london.nextItemID = SGKCLDR_the_national_gallery_london.nextItemID + 1
    ...
    pub resource NFT: NonFungibleToken.INFT, Anique.INFT {
        ...
        init(serialNumber: UInt32, itemID: UInt32) {
            ...
            SGKCLDR_the_national_gallery_london.totalSupply = SGKCLDR_the_national_gallery_london.totalSupply + 1

            // set id
            self.id = SGKCLDR_the_national_gallery_london.totalSupply
    ...
    // interface that represents SGKCLDR_the_national_gallery_london collections to public
    ...
    pub resource interface CollectionPublic {
        ...
        // borrow NFT as SGKCLDR_the_national_gallery_london token
        pub fun borrowSGKCLDR_the_national_gallery_londonCollectible(id: UInt64): auth &NFT
    }
    ...
    pub resource Collection: CollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic {
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            ...
            // Cast the deposited token as an SGKCLDR_the_national_gallery_london NFT to make sure
            // it is the correct type
            let token <- token as! @SGKCLDR_the_national_gallery_london.NFT
        ...
        // not any SGKCLDR_the_national_gallery_london specific data. Please use borrowCollectible to
        ...
        // borrowSGKCLDR_the_national_gallery_londonCollectible returns a borrowed reference
        // to an SGKCLDR_the_national_gallery_london Collectible
        pub fun borrowSGKCLDR_the_national_gallery_londonCollectible(id: UInt64): auth &NFT {
            pre {
    ...
    pub resource Admin {
        ...
        // and stores it in the Items dictionary field in the SGKCLDR_the_national_gallery_london smart contract
        //
        ...
        pub fun createItem(metadata: {String: String}): UInt32 {
            ...
            SGKCLDR_the_national_gallery_london.items[newItem.itemID] <-! newItem

            return itemId
        }

        // borrowItem returns a reference to a Item in the SGKCLDR_the_national_gallery_london
        ...
        pub fun borrowItem(itemID: UInt32): &Item {
            pre {
                SGKCLDR_the_national_gallery_london.items[itemID] != nil: "Cannot borrow Item: The Item doesn't exist"
            }

            return (&SGKCLDR_the_national_gallery_london.items[itemID] as &Item?)!
        }
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_the_national_gallery_london contract-level function definitions
    // -----------------------------------------------------------------------
    ...
    pub fun createEmptyCollection(): @NonFungibleToken.Collection {
        return <-create SGKCLDR_the_national_gallery_london.Collection()
    }
    ...
    // -----------------------------------------------------------------------
    // SGKCLDR_the_national_gallery_london initialization function
    // -----------------------------------------------------------------------
    //
    init() {
        ...
        self.collectionStoragePath     = /storage/SGKCLDR_the_national_gallery_londonCollection
        self.collectionPublicPath      =  /public/SGKCLDR_the_national_gallery_londonCollection
        self.collectionPrivatePath     = /private/SGKCLDR_the_national_gallery_londonCollection
        self.adminStoragePath          = /storage/SGKCLDR_the_national_gallery_londonAdmin
        self.saleCollectionStoragePath = /storage/SGKCLDR_the_national_gallery_londonSaleCollection
        self.saleCollectionPublicPath  =  /public/SGKCLDR_the_national_gallery_londonSaleCollection
