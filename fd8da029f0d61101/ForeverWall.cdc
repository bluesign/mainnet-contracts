...
pub contract ForeverWall: NonFungibleToken {
    ...
    pub event  UpdatedPageSize(tokenID: UInt64, pageSize: PageSize)
    pub event  UpdatedMaxGraffitiSize(tokenID: UInt64, maxGraffitiSize: UInt32)
    pub event UpdateIsEntriesBlocked(tokenID: UInt64, isEntriesBlocked: Bool)
 ...
 // 
   ...
   //   }
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        pub var graffitiTiles: {UInt64 : String}

        pub var pageSize: PageSize

        pub var maxGraffitiSize: UInt32

        pub var isEntriesBlocked : Bool
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String) {
            ...
            ForeverWall.totalSupply = ForeverWall.totalSupply + (1 as UInt64)
        ...
        pub fun writeGraffitiOnBoard(position: Coordinates, graffiti: String){
            ...
            pre{   
                position.x >= self.pageSize.xmin &&
                position.x <= self.pageSize.xmax &&
                position.y >= self.pageSize.ymin &&
                position.y <= self.pageSize.ymax : "The tile is out of bounds";

                UInt32(graffiti.length) <= self.maxGraffitiSize: "The string is too long";
                self.isEntriesBlocked == false : "Cannot graffiti on the wall"
            }
        ...
        pub fun getTileCoordinates(): [Coordinates] {
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return  MetadataViews.NFTCollectionData(
                        storagePath: ForeverWall.CollectionStoragePath,
                        publicPath: ForeverWall.CollectionPublicPath,
                        providerPath: /private/ForeverWallCollection,
                        publicCollection: Type<&ForeverWall.Collection{ForeverWall.ForeverWallCollectionPublic}>(),
                        publicLinkedType: Type<&ForeverWall.Collection{ForeverWallCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&ForeverWall.Collection{ForeverWallCollectionPublic,NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <-ForeverWall.createEmptyCollection()
                        })
                    )
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: "ForeverWall",
                        description: ForeverWall.Description,
                        externalURL: ForeverWall.ExternalURL,
                        squareImage: ForeverWall.SquareImage,
                        bannerImage: ForeverWall.BannerImage,
                        socials: ForeverWall.Socials
                    )
    ...
    pub resource Mutator {
        ...
        pub fun mutatePFP(tokenID: UInt64, name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String){
           ...
           pre{
                tokenID <= ForeverWall.totalSupply: "the tokenID does not exist"
           }
    ...
    pub resource Admin {
        ...
        pub fun setSquareImage(url: String, mediaType: String) {
            ForeverWall.SquareImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun setBannerImage(url: String, mediaType: String) {
            ForeverWall.BannerImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun addDefaultRoyalty(name: String, royalty: MetadataViews.Royalty, rate: UFix64){
            ...
            pre {
                ForeverWall.defaultRoyalties[name] == nil: "The royalty with that name already exists"
        ...
        pub fun changeDefaultRoyaltyRate(name: String, rate: UFix64) {
            pre {
                ForeverWall.defaultRoyalties[name] != nil: "The royalty with that name does not exist"
                rate > 0.0: "Cannot set rate to less than 0%"
                rate <= 1.0: "Cannot set rate to more than 100%"
            }
            ...
            ForeverWall.defaultRoyalties[name] = MetadataViews.Royalty(recipientAddress: previousRecipientAddress, cut: UFix64(rate), description: "ForeverWall Royalties")
        ...
        pub fun changeRoyaltyRateForPFP(tokenID: UInt64, name: String, rate: UFix64){
            ...
            let newRoyalty = MetadataViews.Royalty(recipientAddress: previousRoyalty.receiver, cut: UFix64(rate), description: "ForeverWall Royalties")
    ...
    pub resource interface ForeverWallCollectionPublic {
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun batchDeposit(tokens: @NonFungibleToken.Collection)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT
        pub fun borrowForeverWall(id: UInt64): &ForeverWall.NFT? {
    ...
    //
    pub resource Collection: ForeverWallCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection { 
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver} {
            ...
            return ForeverWallNFT as &AnyResource{MetadataViews.Resolver}
        }

        pub fun setPageSize(id: UInt64, pageSize: PageSize) {
            let itemRef = self.borrowForeverWall(id: id)!
            itemRef.setPageSize(pageSize: pageSize)
        }

        pub fun setMaxGraffitiSize(id: UInt64, maxGraffitiSize: UInt32) {
            let itemRef = self.borrowForeverWall(id: id)!
            itemRef.setMaxGraffitiSize(maxGraffitiSize: maxGraffitiSize)
        }

        pub fun setisEntriesBlocked(id: UInt64, isEntriesBlocked: Bool) {
            let itemRef = self.borrowForeverWall(id: id)!
    ...
    pub fun createEmptyMintPFPsCollection(): @ForeverWall.Collection {
        return <-create ForeverWall.Collection()
    }
    ...
    pub fun convertCoordinatesToCantorNumber(coords: Coordinates): UInt64 {
    ...
    pub fun convertCantorNumberToCoordinates(num: UInt64): Coordinates {
    ...
    init() {
        ...
        self.SquareImage = MetadataViews.Media(
            file: MetadataViews.HTTPFile(
                url: "https://assets.website-files.com/60e2d81804d21546b930cf4e/6282368335c3a352cef0677c_mint-white-tm-p-500.png"
            ),
            mediaType: "image/png"
        )
        ...
        self.account.link<&{ForeverWallCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
