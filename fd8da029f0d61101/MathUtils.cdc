...
pub contract MathUtils: NonFungibleToken {
    ...
    pub struct ItemData {
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String) {
            self.merchantID = MathUtils.merchantID
            self.name = name
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String) {
            ...
            MathUtils.totalSupply = MathUtils.totalSupply + (1 as UInt64)

            self.id = MathUtils.totalSupply
        ...
        pub fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.Royalties>():
                    let royaltiesDictionary = MathUtils.royaltiesForSpecificPFP[self.id] ?? MathUtils.defaultRoyalties 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return  MetadataViews.NFTCollectionData(
                        storagePath: MathUtils.CollectionStoragePath,
                        publicPath: MathUtils.CollectionPublicPath,
                        providerPath: /private/MathUtilsCollection,
                        publicCollection: Type<&MathUtils.Collection{MathUtils.MathUtilsCollectionPublic}>(),
                        publicLinkedType: Type<&MathUtils.Collection{MathUtilsCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&MathUtils.Collection{MathUtilsCollectionPublic,NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <-MathUtils.createEmptyCollection()
                        })
                    )
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: "MathUtils",
                        description: MathUtils.Description,
                        externalURL: MathUtils.ExternalURL,
                        squareImage: MathUtils.SquareImage,
                        bannerImage: MathUtils.BannerImage,
                        socials: MathUtils.Socials
                    )
    ...
    pub resource Mutator {
        ...
        pub fun mutatePFP(tokenID: UInt64, name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String){
           ...
           pre{
                tokenID <= MathUtils.totalSupply: "the tokenID does not exist"
           }
                if (MathUtils.lockedMutators[self.id] != true) {
                    ...
                    MathUtils.mutations[tokenID] = mutation
    ...
    pub resource Admin {
        ...
        pub fun setSquareImage(url: String, mediaType: String) {
            MathUtils.SquareImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun setBannerImage(url: String, mediaType: String) {
            MathUtils.BannerImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun createNewAdmin(): @Admin {
            ...
            MathUtils.nextAdminID = MathUtils.nextAdminID + (1 as UInt32)
        ...
        pub fun createNewMutator(): @Mutator {
            ...
            let newID = MathUtils.nextMutatorID
             // Increment the ID so that it isn't used again
            MathUtils.nextMutatorID = MathUtils.nextMutatorID + (1 as UInt32)
        ...
        pub fun addDefaultRoyalty(name: String, royalty: MetadataViews.Royalty, rate: UFix64){
            ...
            pre {
                MathUtils.defaultRoyalties[name] == nil: "The royalty with that name already exists"
                rate > 0.0: "Cannot set rate to less than 0%"
                rate <= 1.0: "Cannot set rate to more than 100%"
            }
            MathUtils.defaultRoyalties[name] = royalty
        ...
        pub fun changeDefaultRoyaltyRate(name: String, rate: UFix64) {
            pre {
                MathUtils.defaultRoyalties[name] != nil: "The royalty with that name does not exist"
                rate > 0.0: "Cannot set rate to less than 0%"
                rate <= 1.0: "Cannot set rate to more than 100%"
            }
            let royalty = MathUtils.defaultRoyalties[name]!
            let previousRate = royalty.cut
            let previousRecipientAddress  = royalty.receiver
            MathUtils.defaultRoyalties[name] = MetadataViews.Royalty(recipientAddress: previousRecipientAddress, cut: UFix64(rate), description: "MathUtils Royalties")
        ...
        pub fun removeDefaultRoyalty(name: String) {
            ...
            MathUtils.defaultRoyalties.remove(key: name)
        ...
        pub fun addRoyaltyForPFP(tokenID: UInt64, name: String, royalty: MetadataViews.Royalty, rate: UFix64){
            ...
            if  MathUtils.royaltiesForSpecificPFP.containsKey(tokenID) == false{

                let newEntry: {String: MetadataViews.Royalty}= {}
                newEntry.insert(key: name, royalty)
                MathUtils.royaltiesForSpecificPFP!.insert(key: tokenID, newEntry)
            ...
            // the TokenID already has an entry
             ...
             if  MathUtils.royaltiesForSpecificPFP[tokenID]!.containsKey(name) {
                 // the entry already exists
                 panic("The royalty with that name already exists")

             }
            MathUtils.royaltiesForSpecificPFP[tokenID]!.insert(key: name, royalty)
        ...
        pub fun changeRoyaltyRateForPFP(tokenID: UInt64, name: String, rate: UFix64){
            ...
            let previousRoyalty: MetadataViews.Royalty = MathUtils.royaltiesForSpecificPFP[tokenID]![name]!

            let newRoyalty = MetadataViews.Royalty(recipientAddress: previousRoyalty.receiver, cut: UFix64(rate), description: "MathUtils Royalties")
            MathUtils.royaltiesForSpecificPFP[tokenID]!.insert(key: name,  newRoyalty);
    ...
    pub resource interface MathUtilsCollectionPublic {
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun batchDeposit(tokens: @NonFungibleToken.Collection)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT
        pub fun borrowMathUtils(id: UInt64): &MathUtils.NFT? {
    ...
    //
    pub resource Collection: MathUtilsCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection { 
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            ...
            let token <- token as! @MathUtils.NFT
        ...
        // not any MintPFPs specific data. Please use borrowMathUtilss to 
        // read MintPFPs data.
        //
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT {
        ...
        // borrowMathUtils returns a borrowed reference to a MintPFPs
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver} {
            ...
            let MathUtilsNFT = nft as! &MathUtils.NFT
            return MathUtilsNFT as &AnyResource{MetadataViews.Resolver}
        }
    ...
    pub fun createEmptyMintPFPsCollection(): @MathUtils.Collection {
        return <-create MathUtils.Collection()
    }
    ...
    init() {
        ...
        self.CollectionStoragePath = /storage/MathUtilsCollection
        self.CollectionPublicPath = /public/MathUtilsCollection
        self.AdminStoragePath = /storage/MathUtilsAdmin
        self.MutatorStoragePath = /storage/MathUtilsMutator

        // Put a new Collection in storage
        self.account.save<@Collection>(<- create Collection(), to: self.CollectionStoragePath)

        // Create a public capability for the Collection
        self.account.link<&{MathUtilsCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
