...
pub contract TimonsVegaz: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreieqlnkl65lbxowd766yvkm5xdgqkeswmexrr4xui5ynkxadvh3h6a"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreiafkl4cjlbak3oqu4hmtwnahjfkjebsl52ptinbzcinlxsxqjzc6a"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Timon's Vegaz",
                    symbol: "VEGAZ",
                    description: "Vegaz - memecoin for flow community.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: TimonsVegaz.VaultStoragePath,
                    receiverPath: TimonsVegaz.ReceiverPublicPath,
                    metadataPath: TimonsVegaz.VaultPublicPath,
                    providerPath: /private/TimonsVegazVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("TimonsVegaz", self.account.address, "VEGAZ", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
