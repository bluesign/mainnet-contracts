...
pub contract NuclearDAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreiac4eyy6squsq7er2qib24pwnrpefe37is5vu75g7in6a5kmhmnpq"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreihbulqvjxp3s5c5v5nqwj2awbpoqumtmuwf73jdhmjkdfwwbr5p4y"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Nuclear DAO",
                    symbol: "NUKE",
                    description: "Welcome to the Wasteland.",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("https://twitter.com/NuclearDA0"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: NuclearDAO.VaultStoragePath,
                    receiverPath: NuclearDAO.ReceiverPublicPath,
                    metadataPath: NuclearDAO.VaultPublicPath,
                    providerPath: /private/NuclearDAOVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("NuclearDAO", self.account.address, "NUKE", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
