...
pub contract Trianons: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Trianons",
                    symbol: "FIDE",
                    description: "Trianons DAO: Revolutionizing Marketing in the Web3 Era",
                    externalURL: MetadataViews.ExternalURL("www.trianons.com.br"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("julianokimura"),
                        "discord": MetadataViews.ExternalURL("xPAeS77uXa")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Trianons.VaultStoragePath,
                    receiverPath: Trianons.ReceiverPublicPath,
                    metadataPath: Trianons.VaultPublicPath,
                    providerPath: /private/TrianonsVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Trianons", self.account.address, "FIDE", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
