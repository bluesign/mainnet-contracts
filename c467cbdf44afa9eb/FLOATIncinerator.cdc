...
pub contract FLOATIncinerator {
  ...
  init() {
    self.IncineratorStoragePath = /storage/MusicPeaksAttendanceTokenIncineratorStoragePath
    self.IncineratorPublicPath = /public/MusicPeaksAttendanceTokenIncineratorPublicPath
