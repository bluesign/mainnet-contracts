...
pub contract Gweela: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Gweela",
                    symbol: "GWE",
                    description: "A decentralized community of kids telling their own story, in their own words.",
                    externalURL: MetadataViews.ExternalURL("gweela.com"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("gweelakids"),
                        "discord": MetadataViews.ExternalURL("gweela")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Gweela.VaultStoragePath,
                    receiverPath: Gweela.ReceiverPublicPath,
                    metadataPath: Gweela.VaultPublicPath,
                    providerPath: /private/GweelaVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Gweela", self.account.address, "GWE", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
