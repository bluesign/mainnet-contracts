...
pub contract StudentsofTheGame: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreie37b56et5kweaztkahef5iqkxuvniaskuldfh2fppbbdpmwhshje"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeido5dy5yhxl6qi2vajgwstbnqjwiy3ntu3p3gl4fbjaw67xu2mzhu"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    ...
                    symbol: "GAME",
                    description: "The Students of The Game",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: StudentsofTheGame.VaultStoragePath,
                    receiverPath: StudentsofTheGame.ReceiverPublicPath,
                    metadataPath: StudentsofTheGame.VaultPublicPath,
                    providerPath: /private/StudentsofTheGameVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("StudentsofTheGame", self.account.address, "GAME", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
