...
pub contract NiftoryIsAwesome: NonFungibleToken {
    ...
    NiftoryNonFungibleToken.NFTPublic
  {
    ...
    init(setId: Int, templateId: Int, serial: UInt64) {
      ...
      NiftoryIsAwesome.totalSupply =
        NiftoryIsAwesome.totalSupply + 1
      self.setId = setId
    ...
    NiftoryNonFungibleToken.ManagerPrivate 
  {
      ...
      &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public}
    {
      return NiftoryNFTRegistry
        .getSetManagerPublic(
          NiftoryIsAwesome.REGISTRY_ADDRESS,
          NiftoryIsAwesome.REGISTRY_BRAND
        )
    }
  ...
  init() {
    ...
    let record = NiftoryNFTRegistry.generateRecord(
      ...
      project: "cl98uicmo00010hjp859ymyrl_NiftoryIsAwesome"
    )
    ...
    self
      ...
      .save<@MutableMetadataSetManager.Manager>(
        <-MutableMetadataSetManager.create(
          name: "NiftoryIsAwesome",
          description: "The set manager for NiftoryIsAwesome."
        ),
