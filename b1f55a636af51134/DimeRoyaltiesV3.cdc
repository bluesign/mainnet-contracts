...
pub contract DimeRoyaltiesV3 {
    ...
    pub resource Release: ReleasePublic {
        ...
        pub fun updateOwner(id: UInt64, newOwner: Address) {
            let collection = getAccount(newOwner).getCapability
                <&DimeCollectibleV5.Collection{DimeCollectibleV5.DimeCollectionPublic}>
                (DimeCollectibleV5.CollectionPublicPath).borrow()
    ...
    pub resource ReleaseCollection: ReleaseCollectionPublic {
        ...
        pub fun createRelease(collection: &DimeCollectibleV5.Collection{NonFungibleToken.CollectionPublic},
            ...
            let minterRef = getAccount(minterAddress)
                .getCapability<&DimeCollectibleV5.NFTMinter>(DimeCollectibleV5.MinterPublicPath)
                .borrow()!
            let release <- create Release(id: DimeRoyaltiesV3.nextReleaseId, royaltiesPerShare: totalRoyalties / UFix64(numRoyaltyNFTs),
        ...
        pub fun deleteRelease(releaseId: UInt64,
            collection: Capability<&DimeCollectibleV5.Collection>) {
