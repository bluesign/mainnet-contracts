...
pub contract TouchstoneUtahJazzLegendsClubDAOProfitSharing: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneUtahJazzLegendsClubDAOProfitSharing.CollectionStoragePath,
						publicPath: TouchstoneUtahJazzLegendsClubDAOProfitSharing.CollectionPublicPath,
						providerPath: TouchstoneUtahJazzLegendsClubDAOProfitSharing.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneUtahJazzLegendsClubDAOProfitSharing"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneUtahJazzLegendsClubDAOProfitSharing.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneUtahJazzLegendsClubDAOProfitSharing.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneUtahJazzLegendsClubDAOProfitSharing.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneUtahJazzLegendsClubDAOProfitSharing")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneUtahJazzLegendsClubDAOProfitSharing.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneUtahJazzLegendsClubDAOProfitSharing.metadatas[TouchstoneUtahJazzLegendsClubDAOProfitSharing.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneUtahJazzLegendsClubDAOProfitSharing.CollectionPublicPath).borrow<&TouchstoneUtahJazzLegendsClubDAOProfitSharing.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneUtahJazzLegendsClubDAOProfitSharing.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
