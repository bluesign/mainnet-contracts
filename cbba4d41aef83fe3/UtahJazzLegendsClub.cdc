...
pub contract UtahJazzLegendsClub: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreigf26fjxatw4zhf5m36l63sg2ruvdzdujyxhtibfbnphfgmn245mq"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreie3dpob2lg3bi2rtfhyycrdr5svkqaa2n2fskczejn7q2bm24echy"
                    ),
                    mediaType: "image"
                )
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Utah Jazz Legends Club",
                    symbol: "UJLC",
                    description: "Utah Jazz Legnends Club DAO",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("UtahJazzLegends"),
                        "discord": MetadataViews.ExternalURL("wGjBcsGjcG")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: UtahJazzLegendsClub.VaultStoragePath,
                    receiverPath: UtahJazzLegendsClub.ReceiverPublicPath,
                    metadataPath: UtahJazzLegendsClub.VaultPublicPath,
                    providerPath: /private/UtahJazzLegendsClubVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("UtahJazzLegendsClub", self.account.address, "UJLC", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
