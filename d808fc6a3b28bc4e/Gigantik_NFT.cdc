...
pub contract Gigantik_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            Gigantik_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintGigantik_NFT(
			...
			recipient.deposit(token: <-create Gigantik_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionGigantik_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: Gigantik_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: Gigantik_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: Gigantik_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: Gigantik_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: Gigantik_NFT.CollectionStoragePath,
                        publicPath: Gigantik_NFT.CollectionPublicPath,
                        providerPath: /private/Gigantik_NFT,
                        publicCollection: Type<&Gigantik_NFT.Collection{Gigantik_NFT.Gigantik_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&Gigantik_NFT.Collection{Gigantik_NFT.Gigantik_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&Gigantik_NFT.Collection{Gigantik_NFT.Gigantik_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "undefined/gigantik/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "undefined/gigantik/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: Gigantik_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: Gigantik_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(Gigantik_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: Gigantik_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &Gigantik_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(Gigantik_NFT.CollectionPublicPath)
            .borrow<&Gigantik_NFT.Collection{Gigantik_NFT.Gigantik_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&Gigantik_NFT.Admin>(
