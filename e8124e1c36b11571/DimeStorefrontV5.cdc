...
pub contract DimeStorefrontV5 {
	...
	pub resource SaleOffer: SaleOfferPublic {
		...
		access(self) let sellerItemProvider: Capability<&DimeCollectibleV5.Collection{NonFungibleToken.Provider}>
		...
		init(nft: &DimeCollectibleV5.NFT,
			sellerItemProvider: Capability<&DimeCollectibleV5.Collection{NonFungibleToken.Provider}>,
	...
	pub resource interface StorefrontManager {
		pub fun createSaleOffers(
			itemProvider: Capability<&DimeCollectibleV5.Collection{DimeCollectibleV5.DimeCollectionPublic, NonFungibleToken.Provider}>,
			items: [UInt64],
			price: UFix64,
