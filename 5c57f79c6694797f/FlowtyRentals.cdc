...
pub contract FlowtyRentals {
    ...
    pub resource Listing: ListingPublic, FlowtyListingCallback.Listing {
        ...
        pub fun rent(
            ...
            let rental = marketplace.createRental(
    ...
    pub resource Rental: RentalPublic, FlowtyListingCallback.Listing {
        ...
        destroy() {
            pre {
                ...
                self.depositedFungibleTokens == nil || self.depositedFungibleTokens?.balance == 0.0: "deposit balance is not 0"
            }          
   ...
   pub resource FlowtyRentalsStorefront : FlowtyRentalsStorefrontManager, FlowtyRentalsStorefrontPublic {
    ...
    pub fun borrowMarketplacePublic(): &FlowtyRentalsMarketplace{FlowtyRentalsMarketplacePublic} {
        let mp = self.account.borrow<&FlowtyRentalsMarketplace{FlowtyRentalsMarketplacePublic}>(from: FlowtyRentals.FlowtyRentalsMarketplaceStoragePath)!
        return mp
    }

    pub fun borrowStorefrontPublic(addr: Address): &FlowtyRentalsStorefront{FlowtyRentalsStorefrontPublic}? {
        return getAccount(addr).getCapability<&FlowtyRentalsStorefront{FlowtyRentalsStorefrontPublic}>(FlowtyRentals.FlowtyRentalsStorefrontPublicPath).borrow()
    }
