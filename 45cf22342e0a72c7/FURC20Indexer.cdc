    ...
    access(all) resource InscriptionIndexer: IndexerPublic {
        ...
        fun getTokenDisplay(tick: String): FungibleTokenMetadataViews.FTDisplay? {
            ...
            let svgStr = "data:image/svg+xml;utf8,"
                ...
                .concat("<text style=\"dominant-baseline: middle; fill: rgb(80, 213, 155); font-family: system-ui, sans-serif; text-anchor: middle;\" fill-opacity=\"0.2\" y=\"-12\" font-size=\"420\">ð</text>")
        ...
        fun mint(ins: &FlowUp.Inscription, flowToCreator: @FlowToken.Vault, flowToInviter: @FlowToken.Vault, inviterAddress: Address) {
            ...
            assert(
                flowToCreatorAmount >= 25.0,
                message: "The flowToCreatorAmount should be greater than 25.0"
            )

            let flowToInviterAmount = flowToInviter.balance
            assert(
                flowToInviterAmount >= 25.0,
                message: "The flowToInviterAmount should be greater than 25.0"
            )
