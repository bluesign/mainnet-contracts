...
pub contract KRYPTOGANG: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "KRYPTO GANG",
                    symbol: "KPG",
                    description: "OUR VALUES WILL NEVER DIMINISH",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("BABAKRYPTO__"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: KRYPTOGANG.VaultStoragePath,
                    receiverPath: KRYPTOGANG.ReceiverPublicPath,
                    metadataPath: KRYPTOGANG.VaultPublicPath,
                    providerPath: /private/KRYPTOGANGVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("KRYPTOGANG", self.account.address, "KPG", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
