...
pub contract FLOATIncinerator {
  ...
  init() {
    self.IncineratorStoragePath = /storage/MusicPeaksMembershipTokenIncineratorStoragePath
    self.IncineratorPublicPath = /public/MusicPeaksMembershipTokenIncineratorPublicPath
