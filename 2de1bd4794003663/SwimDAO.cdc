...
pub contract SwimDAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreidv75hz6sabfmne6mxjptqzim4sl2jehknawmnp7rrjt4gbts4hqi"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreifug52jcqbnqbwkie4clixb45jbrgwb6kpetw5dlvb6hbn5mhiw24"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "SwimDAO",
                    symbol: "SWIM",
                    description: "A  Scalable Entrepreneurship Ecosystem ",
                    externalURL: MetadataViews.ExternalURL("swimdao.org"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("swimdao"),
                        "discord": MetadataViews.ExternalURL("swimdao")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: SwimDAO.VaultStoragePath,
                    receiverPath: SwimDAO.ReceiverPublicPath,
                    metadataPath: SwimDAO.VaultPublicPath,
                    providerPath: /private/SwimDAOVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("SwimDAO", self.account.address, "SWIM", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
