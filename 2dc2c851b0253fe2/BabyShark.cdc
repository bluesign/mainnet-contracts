...
pub contract BabyShark: NonFungibleToken {
    ...
    pub resource Series {
        ...
        pub fun updateSetStats(
            ...
            let newSetMetadata = NFTSetMetadata(
                setId: setId,
                name: BabyShark.getSetMetadata(setId: setId).name,
                edition: BabyShark.getSetMetadata(setId: setId).edition,
                thumbnail: BabyShark.getSetMetadata(setId: setId).thumbnail,
                description: BabyShark.getSetMetadata(setId: setId).description,
                httpFile: BabyShark.getSetMetadata(setId: setId).httpFile,
                maxEditions: BabyShark.getSetMetadata(setId: setId).maxEditions,
                mediaFile: BabyShark.getSetMetadata(setId: setId).mediaFile,
                externalUrl: BabyShark.getSetMetadata(setId: setId).externalUrl,
                twitterLink: BabyShark.getSetMetadata(setId: setId).twitterLink,
                toyStats: toyStats,
                toyProperties: BabyShark.getSetMetadata(setId: setId).toyProperties
            )
            BabyShark.setMetadata[setId] = newSetMetadata
        ...
        pub fun updateSetTraits(
            ...
            let newSetMetadata = NFTSetMetadata(
                ...
                externalUrl: BabyShark.getSetMetadata(setId: setId).externalUrl,
                twitterLink: BabyShark.getSetMetadata(setId: setId).twitterLink,
                toyStats: BabyShark.getSetMetadata(setId: setId).toyStats,
                toyProperties: toyProperties
            )
            BabyShark.setMetadata[setId] = newSetMetadata
	    ...
	    pub fun mintFlickplaySeriesNFT(
			...
			recipient.deposit(token: <-create BabyShark.NFT(
                tokenId: tokenId,
                setId: setId,
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: BabyShark.getSetMetadata(setId: self.setId).name,
                        description: BabyShark.getSetMetadata(setId: self.setId).description,
                        thumbnail: MetadataViews.HTTPFile(
                            url: BabyShark.getSetMetadata(setId: self.setId).thumbnail,
                        )
                    )
                case Type<MetadataViews.Editions>():
                    let editionInfo = MetadataViews.Edition(
                     name: BabyShark.getSetMetadata(setId: self.setId).edition,
                     number: self.editionNum,
                     max: BabyShark.getSetMetadata(setId: self.setId).maxEditions)
                ...
                case Type<MetadataViews.HTTPFile>():
                    return MetadataViews.HTTPFile(
                        BabyShark.getSetMetadata(setId: self.setId).httpFile
                    )
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: BabyShark.CollectionStoragePath,
                        publicPath: BabyShark.CollectionPublicPath,
                        providerPath: /private/BabySharkCollection,
                        publicCollection: Type<&BabyShark.Collection{BabyShark.FlickplaySeriesCollectionPublic}>(),
                        publicLinkedType: Type<&BabyShark.Collection{BabyShark.FlickplaySeriesCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&BabyShark.Collection{BabyShark.FlickplaySeriesCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let media = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: BabyShark.getSetMetadata(setId: self.setId).mediaFile
                        ),
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: BabyShark.getSetMetadata(setId: self.setId).name,
                        description:  BabyShark.getSetMetadata(setId: self.setId).description,
                        externalURL: MetadataViews.ExternalURL(BabyShark.getSetMetadata(setId: self.setId).externalUrl),
                        squareImage: media,
                        bannerImage: media,
                        socials: {
                            "twitter": MetadataViews.ExternalURL(BabyShark.getSetMetadata(setId: self.setId).twitterLink)
                        }
                    )
                case Type<MetadataViews.Royalties>():
                    let royaltyReceiver: Capability<&{FungibleToken.Receiver}> =
                        getAccount(BabyShark.royaltyAddress).getCapability<&AnyResource{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath())
                    return MetadataViews.Royalties(
                        royalties: [
                            MetadataViews.Royalty(
                                receiver: royaltyReceiver,
                                cut: BabyShark.royaltyCut,
    ...
    pub fun fetch(_ from: Address, id: UInt64): &BabyShark.NFT? {
        let collection = getAccount(from)
            .getCapability(BabyShark.CollectionPublicPath)
            .borrow<&BabyShark.Collection{BabyShark.FlickplaySeriesCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&BabyShark.Admin>(
