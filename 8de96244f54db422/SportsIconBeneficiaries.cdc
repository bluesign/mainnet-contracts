...
pub contract SportsIconBeneficiaries {
    ...
    access(account) fun setMintBeneficiaries(setID: UInt64, beneficiaries: Beneficiaries) {
        self.mintBeneficiaries[setID] = beneficiaries
    }

    access(account) fun setMarketBeneficiaries(setID: UInt64, beneficiaries: Beneficiaries) {
