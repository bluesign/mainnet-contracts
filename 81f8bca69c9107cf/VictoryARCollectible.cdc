...
pub contract VictoryARCollectible: NonFungibleToken {
	...
	pub resource NFTMinter {
                        ...
                        totalIssueNum: UInt32) 
        {
            ...
            while i < maxIssueNum {
                ...
                recipient.deposit(token: <-create VictoryARCollectible.NFT(initOwner:owner,
                                                                initID: VictoryARCollectible.totalSupply, 
                                                                initTypeID: typeID, 
                                                                initBrandID: brandID,
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &VictoryARCollectible.NFT? {
        let collection = getAccount(from)
            .getCapability(VictoryARCollectible.CollectionPublicPath)!
            .borrow<&VictoryARCollectible.Collection{VictoryARCollectible.VictoryARCollectibleCollectionPublic}>()
