...
pub contract VictoryARCollectibleSaleOffer {
    ...
    pub resource SaleOffer: SaleOfferPublicView {
        ...
        access(self) let sellerItemProvider: Capability<&VictoryARCollectible.Collection{NonFungibleToken.Provider}>
        ...
        //
        pub fun accept(
            buyerCollection: &VictoryARCollectible.Collection{NonFungibleToken.Receiver},
        ...
        //
        init(
            sellerItemProvider: Capability<&VictoryARCollectible.Collection{NonFungibleToken.Provider, VictoryARCollectible.VictoryARCollectibleCollectionPublic}>,
            bundleID: UInt64,
