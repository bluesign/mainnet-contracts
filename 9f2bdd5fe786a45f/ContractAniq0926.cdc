...
pub contract ContractAniq0926: NonFungibleToken, Anique {
    // -----------------------------------------------------------------------
    ...
    pub resource interface CollectionPublic {
        ...
        pub fun borrowContractAniq0926Collectible(id: UInt64): auth &NFT
    }
    ...
    pub resource Admin {
        ...
        pub fun borrowItem(itemID: UInt32): &Item {
            pre {
                ContractAniq0926.items[itemID] != nil: "Cannot borrow Item: The Item doesn't exist"
            }
