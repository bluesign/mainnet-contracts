...
pub contract SkyLabsMintPotion : NonFungibleToken {
    ...
    pub resource NFTMinter {
        ...
        pub fun mintNFT(
            ...
            var newNFT <- create NFT(
                id: SkyLabsMintPotion.totalSupply,
                creator: creator,
                metadata: metadata
            )
    ...
    init() {
        ...
        self.account.link<&SkyLabsMintPotion.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, SkyLabsMintPotion._NFT_NAME_CollectionPublic, MetadataViews.ResolverCollection}>(
