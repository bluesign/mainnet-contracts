...
pub contract FlowBlockchainhitCoin: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreihgkcx73e444ehgfwdwthhs7ghvhwv7hnb65csuwsvskk7v6fhsu4"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreifniuyvoqtjwi3jnwnmwbo7vfvwzqkyxcet27dahu2mbp2qjvejye"
                    ),
                    mediaType: "image"
                )
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Flow Blockchain $hit Coin",
                    symbol: "HIT",
                    description: "Just an original shitcoin, powered by the FLOW blockchain",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: FlowBlockchainhitCoin.VaultStoragePath,
                    receiverPath: FlowBlockchainhitCoin.ReceiverPublicPath,
                    metadataPath: FlowBlockchainhitCoin.VaultPublicPath,
                    providerPath: /private/FlowBlockchainhitCoinVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("FlowBlockchainhitCoin", self.account.address, "HIT", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
