...
pub contract Nanbuckeroos: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Nanbuckeroos",
                    symbol: "NBUCK",
                    description: "A DAO of meaningless Nanbuckeroos holders",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Nanbuckeroos.VaultStoragePath,
                    receiverPath: Nanbuckeroos.ReceiverPublicPath,
                    metadataPath: Nanbuckeroos.VaultPublicPath,
                    providerPath: /private/NanbuckeroosVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Nanbuckeroos", self.account.address, "NBUCK", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
