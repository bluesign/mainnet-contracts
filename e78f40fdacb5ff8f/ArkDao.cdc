...
pub contract ArkDao: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreicsbhxw2nijqtyi4xxy66a7cwhkv6qdu6ddjlc67mblfouzewfgxq"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreid2o6jvbteh7y66an5e6h4nqh4vwwczoatpl2nqwel3ul3mw6qr5u"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Ark Dao",
                    symbol: "ARK",
                    description: "Board the 'Ark' 🚀 - Let's sail past the moon p.s. Noah ate the animals",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: ArkDao.VaultStoragePath,
                    receiverPath: ArkDao.ReceiverPublicPath,
                    metadataPath: ArkDao.VaultPublicPath,
                    providerPath: /private/ArkDaoVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("ArkDao", self.account.address, "ARK", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
