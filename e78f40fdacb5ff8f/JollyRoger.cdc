...
pub contract JollyRoger: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreiesj3rzq4wvflxi5u7effyrcwe6tqct2nxdc44hutgwz6kewqaccy"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreicwr6jvrvdcgl7k7ryeosamwcyfjwb4g2z6wbbeo37cbcsup6psjq"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Jolly Roger",
                    symbol: "JOLLY",
                    description: "Hoist the flag! Doubloons for all... ",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: JollyRoger.VaultStoragePath,
                    receiverPath: JollyRoger.ReceiverPublicPath,
                    metadataPath: JollyRoger.VaultPublicPath,
                    providerPath: /private/JollyRogerVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("JollyRoger", self.account.address, "JOLLY", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
