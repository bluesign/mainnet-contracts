...
pub contract Touchstonedoodle1st: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: Touchstonedoodle1st.CollectionStoragePath,
						publicPath: Touchstonedoodle1st.CollectionPublicPath,
						providerPath: Touchstonedoodle1st.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/Touchstonedoodle1st"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: Touchstonedoodle1st.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: Touchstonedoodle1st.getCollectionAttribute(key: "name") as! String,
						description: Touchstonedoodle1st.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/Touchstonedoodle1st")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: Touchstonedoodle1st.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			Touchstonedoodle1st.metadatas[Touchstonedoodle1st.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			...
			if let recipientCollection = getAccount(recipient).getCapability(Touchstonedoodle1st.CollectionPublicPath).borrow<&Touchstonedoodle1st.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &Touchstonedoodle1st.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
