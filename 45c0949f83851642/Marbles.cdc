  ...
  pub resource NFT: NonFungibleToken.INFT, TiblesNFT.INFT, MetadataViews.Resolver {
    ...
    pub fun displayData(): {String: String} {
      ...
      if (metadata.containsKey("pack")) {
        return {
          "name": "Marbles pack",
          "description": "A Marbles pack",
          "imageUrl": "https://i.tibles.com/m/marbles-flow-icon.png"
        }
      }
    ...
    pub fun nftCollectionData(): MetadataViews.NFTCollectionData {
      return MetadataViews.NFTCollectionData(
        storagePath: Marbles.CollectionStoragePath,
        publicPath: Marbles.PublicCollectionPath,
        providerPath: /private/MarblesCollection,
        publicCollection: Type<&Marbles.Collection{TiblesNFT.CollectionPublic}>(),
        publicLinkedType:   Type<&Marbles.Collection{TiblesNFT.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
        providerLinkedType: Type<&Marbles.Collection{TiblesNFT.CollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,MetadataViews.ResolverCollection}>(),
    ...
    pub fun nftCollectionDisplay(): MetadataViews.NFTCollectionDisplay {
      let squareMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/marbles-flow-icon.png"),
        mediaType: "image/svg+xml"
      )
      let bannerMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/marbles-flow-collection-banner.png"),
        mediaType: "image/png"
      )
      ...
      return MetadataViews.NFTCollectionDisplay(
        name: "Marbles Collection",
        description: "Marble collecting by Tibles",
        externalURL: MetadataViews.ExternalURL("https://app.marbles.com/"),
