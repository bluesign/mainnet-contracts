...
pub contract Ticket: NonFungibleToken, ViewResolver {
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: Ticket.CollectionStoragePath,
                        publicPath: Ticket.CollectionPublicPath,
                        providerPath: /private/ticketCollection,
                        publicCollection: Type<&Ticket.Collection{Ticket.TicketCollectionPublic}>(),
                        publicLinkedType: Type<&Ticket.Collection{Ticket.TicketCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&Ticket.Collection{Ticket.TicketCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let media: MetadataViews.Media = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://image.bayeasy.cn/images-datas/nft/mnm.jpg"
                        ),
                        mediaType: "image/png"
                    )
                    return MetadataViews.NFTCollectionDisplay(
                        name: "METAnMEMORY",
                        description: "METAnMEMORY数字藏品SaaS技术服务，提供以数字藏品及区块链技术的SaaS赋能服务，打造富有娱乐性、收藏性及实际业务价值的NFT产品形态，为企业市场增加新的营销触点。通过区块链技术实现了IP商业价值的多元开发，进一步拓展了场景应用的商业边界，赋予了市场更大的想象空间。",
                        externalURL: MetadataViews.ExternalURL("http://www.metanmemory.com:11880/"),
                        squareImage: media,
                        bannerImage: media,
                        socials: {
    ...
    init() {
        ...
        self.account.link<&Ticket.Collection{NonFungibleToken.CollectionPublic, Ticket.TicketCollectionPublic, MetadataViews.ResolverCollection}>(
