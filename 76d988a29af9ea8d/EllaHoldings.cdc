...
pub contract EllaHoldings: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Ella Holdings DAO LLC",
                    symbol: "ELLAH",
                    description: "Investing in a decentralized future, one project at a time.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: EllaHoldings.VaultStoragePath,
                    receiverPath: EllaHoldings.ReceiverPublicPath,
                    metadataPath: EllaHoldings.VaultPublicPath,
                    providerPath: /private/EllaHoldingsVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("EllaHoldings", self.account.address, "ELLAH", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
