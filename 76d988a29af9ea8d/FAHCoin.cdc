...
pub contract FAHCoin: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Flow Against Humanity",
                    symbol: "FAH",
                    description: "Flow Against Humanity is a Web3 card game based on Cards Against Humanity. Play now at http://fah.boiseitguru.com",
                    externalURL: MetadataViews.ExternalURL("fah.boiseitguru.com"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("boise_it_guru"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: FAHCoin.VaultStoragePath,
                    receiverPath: FAHCoin.ReceiverPublicPath,
                    metadataPath: FAHCoin.VaultPublicPath,
                    providerPath: /private/FAHCoinVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("FAHCoin", self.account.address, "FAH", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
