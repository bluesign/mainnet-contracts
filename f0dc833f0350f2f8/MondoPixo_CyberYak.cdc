...
pub contract MondoPixo_CyberYak : NonFungibleToken {
    ...
    pub resource NFTMinter {
        ...
        pub fun mintNFT(
            ...
            var newNFT <- create NFT(
                id: MondoPixo_CyberYak.totalSupply,
                creator: creator,
                metadata: metadata
            )
    ...
    init() {
        ...
        self.account.link<&MondoPixo_CyberYak.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MondoPixo_CyberYak._NFT_NAME_CollectionPublic, MetadataViews.ResolverCollection}>(
