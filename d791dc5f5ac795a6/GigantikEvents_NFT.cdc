...
pub contract GigantikEvents_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            GigantikEvents_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
        ...
        //
	    pub fun mintGigantikEvents_NFT(
			...
			recipient.deposit(token: <-create GigantikEvents_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionGigantikEvents_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
		...
		pub fun batchMintGigantikEvents_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: GigantikEvents_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: GigantikEvents_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: GigantikEvents_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: GigantikEvents_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: GigantikEvents_NFT.CollectionStoragePath,
                        publicPath: GigantikEvents_NFT.CollectionPublicPath,
                        providerPath: /private/GigantikEvents_NFT,
                        publicCollection: Type<&GigantikEvents_NFT.Collection{GigantikEvents_NFT.GigantikEvents_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&GigantikEvents_NFT.Collection{GigantikEvents_NFT.GigantikEvents_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&GigantikEvents_NFT.Collection{GigantikEvents_NFT.GigantikEvents_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/gigantikevents/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/gigantikevents/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: GigantikEvents_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: GigantikEvents_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(GigantikEvents_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: GigantikEvents_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &GigantikEvents_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(GigantikEvents_NFT.CollectionPublicPath)
            .borrow<&GigantikEvents_NFT.Collection{GigantikEvents_NFT.GigantikEvents_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&GigantikEvents_NFT.Admin>(
