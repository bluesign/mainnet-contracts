...
pub contract YDYNFTs: NonFungibleToken {
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: YDYNFTs.CollectionStoragePath,
                        publicPath: YDYNFTs.CollectionPublicPath,
                        providerPath: /private/ydyNFTCollection,
                        publicCollection: Type<&YDYNFTs.Collection{YDYNFTs.YDYNFTCollectionPublic}>(),
                        publicLinkedType: Type<&YDYNFTs.Collection{YDYNFTs.YDYNFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&YDYNFTs.Collection{YDYNFTs.YDYNFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties(
                        [MetadataViews.Royalty(recepient: getAccount(YDYNFTs.account.address).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: 0.075, description: "This is the royalty receiver for YDY NFTs")]
                    )  
            }
            return nil
        }
    ...
    pub fun buy(collectionCapability: Capability<&Collection{YDYNFTs.YDYNFTCollectionPublic}>, payment: @FlowToken.Vault, quantity: UInt64) {
        pre {
            YDYNFTs.isMintingEnabled == true: "Minting is not enabled."
            payment.balance == YDYNFTs.price * UFix64(quantity): "Payment does not match the price."
		}
        ...
        let ydyCollection = self.account.getCapability(YDYNFTs.CollectionPublicPath)
                                .borrow<&Collection{YDYNFTs.YDYNFTCollectionPublic, YDYNFTs.YDYNFTCollectionPrivate}>()
    ...
    pub resource Admin {
        ...
        pub fun transferNFT(collectionCapability: Capability<&Collection{YDYNFTs.YDYNFTCollectionPublic}>): UInt64 {
            let ydyCollection = YDYNFTs.account.getCapability(YDYNFTs.CollectionPublicPath)
                                    .borrow<&Collection{YDYNFTs.YDYNFTCollectionPublic, YDYNFTs.YDYNFTCollectionPrivate}>()
                                    ?? panic("Can't get YDY's collection.")
