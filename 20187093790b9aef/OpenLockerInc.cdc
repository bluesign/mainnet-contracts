...
pub contract OpenLockerInc: NonFungibleToken {
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return  MetadataViews.NFTCollectionData(
                        storagePath: OpenLockerInc.CollectionStoragePath,
                        publicPath: OpenLockerInc.CollectionPublicPath,
                        providerPath: /private/OpenLockerIncCollection,
                        publicCollection: Type<&OpenLockerInc.Collection{OpenLockerInc.OpenLockerIncCollectionPublic}>(),
                        publicLinkedType: Type<&OpenLockerInc.Collection{OpenLockerIncCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&OpenLockerInc.Collection{OpenLockerIncCollectionPublic,NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
    ...
    pub resource Admin {
        ...
        pub fun borrowEdition(editionID: UInt32): &Edition {
            pre {
                OpenLockerInc.editions[editionID] != nil: "Cannot borrow Edition: it does not exist"
            }
    ...
    pub resource Collection: OpenLockerIncCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection { 
        ...
        pub fun withdraw(withdrawID: UInt64): @NonFungibleToken.NFT {
            ...
            let token <- self.ownedNFTs.remove(key: withdrawID) 
                ?? panic("Cannot withdraw: OpenLockerInc does not exist in the collection")
