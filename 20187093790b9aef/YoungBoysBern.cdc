...
pub contract YoungBoysBern: NonFungibleToken {
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    let mediaSquare = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://dkuxa1i6sgo8h.cloudfront.net/BSC-Young-Boys/BSC_Young_Boys_logo.png"
                        ),
                        mediaType: "image/png"
                    )
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return  MetadataViews.NFTCollectionData(
                        storagePath: YoungBoysBern.CollectionStoragePath,
                        publicPath: YoungBoysBern.CollectionPublicPath,
                        providerPath: /private/YoungBoysBernCollection,
                        publicCollection: Type<&YoungBoysBern.Collection{YoungBoysBern.YoungBoysBernCollectionPublic}>(),
                        publicLinkedType: Type<&YoungBoysBern.Collection{YoungBoysBernCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&YoungBoysBern.Collection{YoungBoysBernCollectionPublic,NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
    ...
    pub resource Admin {
        ...
        pub fun borrowEdition(editionID: UInt32): &Edition {
            pre {
                YoungBoysBern.editions[editionID] != nil: "Cannot borrow Edition: it does not exist"
            }
    ...
    pub resource Collection: YoungBoysBernCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection { 
        ...
        pub fun withdraw(withdrawID: UInt64): @NonFungibleToken.NFT {
            ...
            let token <- self.ownedNFTs.remove(key: withdrawID) 
                ?? panic("Cannot withdraw: YoungBoysBern does not exist in the collection")
