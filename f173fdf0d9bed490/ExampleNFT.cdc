...
pub contract ExampleNFT : NonFungibleToken {
    ...
    init() {
        ...
        self.account.link<&ExampleNFT.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, ExampleNFT.ExampleNFTCollectionPublic, MetadataViews.ResolverCollection}>(
