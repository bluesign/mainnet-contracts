...
pub contract wfqerwgqergqerg: NonFungibleToken, ViewResolver {
    ...
    NiftoryNonFungibleToken.NFTPublic
  {
    ...
    init(setId: Int, templateId: Int, serial: UInt64) {
      ...
      wfqerwgqergqerg.totalSupply =
        wfqerwgqergqerg.totalSupply + 1
      self.setId = setId
    ...
    NiftoryNonFungibleToken.ManagerPrivate
  {
      ...
      &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public}
    {
      return NiftoryNFTRegistry
        .getSetManagerPublic(
          wfqerwgqergqerg.REGISTRY_ADDRESS,
          wfqerwgqergqerg.REGISTRY_BRAND
        )
    }
  ...
  init(
    ...
    let record = NiftoryNFTRegistry.generateRecord(
      ...
      project: "clt9ctxiz0001lb0vd5242r4t_wfqerwgqergqerg"
    )
    ...
    self
      ...
      .save<@MutableMetadataSetManager.Manager>(
        <-MutableMetadataSetManager.create(
          name: "wfqerwgqergqerg",
          description: "The set manager for wfqerwgqergqerg."
        ),
