...
pub contract NonboringDAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreihgq3gga2s3cnlw4mvvfc6cqbrpq5y4qoxsjeg6nd2noc3xjngb24"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreieq4ukswd77ho5yi55k6krlncl2tlhkuor5jsq54d6y37myvuzrry"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Nonboring DAO",
                    symbol: "NONBO",
                    description: "A non-boring DAO for non-ordinal people",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: NonboringDAO.VaultStoragePath,
                    receiverPath: NonboringDAO.ReceiverPublicPath,
                    metadataPath: NonboringDAO.VaultPublicPath,
                    providerPath: /private/NonboringDAOVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("NonboringDAO", self.account.address, "NONBO", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
