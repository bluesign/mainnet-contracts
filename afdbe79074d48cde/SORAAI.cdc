...
pub contract SORAAI: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: SORAAI.VaultStoragePath,
                    receiverPath: SORAAI.ReceiverPublicPath,
                    metadataPath: SORAAI.VaultPublicPath,
                    providerPath: /private/SORAAIVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("SORAAI", self.account.address, "SORA", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
