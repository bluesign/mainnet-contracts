...
pub contract SORAOnFlow: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeia52yey437r2bigtsc7jv4rx52arv6ckf3fw5ejusb6lfwzbff72e"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreiaefdlsnqdqn5hf4n4ua5xtrbbxdageu7w2ht5jvdruhwuwtqlxtm"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "SORA On Flow",
                    symbol: "SORA",
                    description: "SORA On Flow Blockchain",
                    externalURL: MetadataViews.ExternalURL("sora.ai "),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("sora"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: SORAOnFlow.VaultStoragePath,
                    receiverPath: SORAOnFlow.ReceiverPublicPath,
                    metadataPath: SORAOnFlow.VaultPublicPath,
                    providerPath: /private/SORAOnFlowVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("SORAOnFlow", self.account.address, "SORA", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
