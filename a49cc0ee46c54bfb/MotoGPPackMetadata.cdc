   ...
   //////////////////////////////////
    ...
    access(contract) fun resolveNFTCollectionDisplayView(): MetadataViews.NFTCollectionDisplay {
        ...
        let squareMedia = MetadataViews.Media(
            file: MetadataViews.HTTPFile(url: "https://ipfs-assets.animocabrands.com/MGPI-pack-Square.jpg"),
            mediaType: "image/jpeg"
        )
        let bannerMedia = MetadataViews.Media(
            file: MetadataViews.HTTPFile(url: "https://ipfs-assets.animocabrands.com/MGPI-pack-Banner.jpg"),
            mediaType: "image/jpeg"
        ) 
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData( 
                        storagePath: StoragePath(identifier: "motogpPackCollection")!,
    ...
    //
    access(self) let metadatas: {UInt64: MotoGPPackMetadata.Metadata} 
