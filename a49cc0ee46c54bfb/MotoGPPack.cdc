...
pub contract MotoGPPack: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
       ...
       pub fun getViews(): [Type] {
         ...
         pub fun resolveView(_ view: Type): AnyStruct? {
             return MotoGPPackMetadata.resolveView(
                view: view,
                id: self.id,
                packID: self.packInfo.packType,
                serial: self.packInfo.packNumber,
                // Below four arguments are passed to MotoGPPackMetadata (as opposed being hardcoded there) to avoid cyclic dependencies MotoGPPack <-> MotoGPPackMetadata
                publicCollectionType: Type<&MotoGPPack.Collection{MotoGPPack.IPackCollectionPublic}>(),
                publicLinkedType: Type<&MotoGPPack.Collection{MotoGPPack.IPackCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(),
                providerLinkedType: Type<&MotoGPPack.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                    return <- MotoGPPack.createEmptyCollection()
                })
            )
         }
    }
    ...
    //
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, IPackCollectionPublic, IPackCollectionAdminAccessible, MetadataViews.ResolverCollection  {
