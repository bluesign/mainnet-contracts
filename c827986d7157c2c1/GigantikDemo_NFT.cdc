...
pub contract GigantikDemo_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            GigantikDemo_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintGigantikDemo_NFT(
			...
			recipient.deposit(token: <-create GigantikDemo_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionGigantikDemo_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
		...
		pub fun batchMintGigantikDemo_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: GigantikDemo_NFT.CollectionStoragePath,
                        publicPath: GigantikDemo_NFT.CollectionPublicPath,
                        providerPath: /private/GigantikDemo_NFT,
                        publicCollection: Type<&GigantikDemo_NFT.Collection{GigantikDemo_NFT.GigantikDemo_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&GigantikDemo_NFT.Collection{GigantikDemo_NFT.GigantikDemo_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&GigantikDemo_NFT.Collection{GigantikDemo_NFT.GigantikDemo_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "undefined/gigantikdemo/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "undefined/gigantikdemo/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &GigantikDemo_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(GigantikDemo_NFT.CollectionPublicPath)
            .borrow<&GigantikDemo_NFT.Collection{GigantikDemo_NFT.GigantikDemo_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&GigantikDemo_NFT.Admin>(
