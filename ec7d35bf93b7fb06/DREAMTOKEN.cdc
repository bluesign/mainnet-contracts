...
pub contract DREAMTOKEN: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "DREAM TOKEN",
                    symbol: "DREAM",
                    description: "NATIVE TOKEN FOR THE DREAM DAO COMMUNITY",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("dreamdaofnd"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: DREAMTOKEN.VaultStoragePath,
                    receiverPath: DREAMTOKEN.ReceiverPublicPath,
                    metadataPath: DREAMTOKEN.VaultPublicPath,
                    providerPath: /private/DREAMTOKENVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("DREAMTOKEN", self.account.address, "DREAM", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
