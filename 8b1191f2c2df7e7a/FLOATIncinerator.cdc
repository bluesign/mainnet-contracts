...
pub contract FLOATIncinerator {
  ...
  init() {
    self.IncineratorStoragePath = /storage/MusicPeaksSocialTokenIncineratorStoragePath
    self.IncineratorPublicPath = /public/MusicPeaksSocialTokenIncineratorPublicPath
