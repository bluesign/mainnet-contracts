...
pub contract TouchstoneMylittlemonsterscollection: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneMylittlemonsterscollection.CollectionStoragePath,
						publicPath: TouchstoneMylittlemonsterscollection.CollectionPublicPath,
						providerPath: TouchstoneMylittlemonsterscollection.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneMylittlemonsterscollection"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneMylittlemonsterscollection.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneMylittlemonsterscollection.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneMylittlemonsterscollection.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneMylittlemonsterscollection")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneMylittlemonsterscollection.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneMylittlemonsterscollection.metadatas[TouchstoneMylittlemonsterscollection.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			pre {
				EmeraldPass.isActive(user: TouchstoneMylittlemonsterscollection.account.address): "You must have an active Emerald Pass subscription to airdrop NFTs. You can purchase Emerald Pass at https://pass.ecdao.org/"
			}
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneMylittlemonsterscollection.CollectionPublicPath).borrow<&TouchstoneMylittlemonsterscollection.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneMylittlemonsterscollection.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
