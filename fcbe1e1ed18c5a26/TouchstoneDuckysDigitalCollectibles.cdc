...
pub contract TouchstoneDuckysDigitalCollectibles: NonFungibleToken {
			...
			switch view {
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(
						storagePath: TouchstoneDuckysDigitalCollectibles.CollectionStoragePath,
						publicPath: TouchstoneDuckysDigitalCollectibles.CollectionPublicPath,
						providerPath: TouchstoneDuckysDigitalCollectibles.CollectionPrivatePath,
          ...
          return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneDuckysDigitalCollectibles"))
				case Type<MetadataViews.NFTCollectionDisplay>():
					let squareMedia = MetadataViews.Media(
						file: TouchstoneDuckysDigitalCollectibles.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile,
						mediaType: "image"
					)
					...
					return MetadataViews.NFTCollectionDisplay(
						name: TouchstoneDuckysDigitalCollectibles.getCollectionAttribute(key: "name") as! String,
						description: TouchstoneDuckysDigitalCollectibles.getCollectionAttribute(key: "description") as! String,
						externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat(self.owner!.address.toString()).concat("/TouchstoneDuckysDigitalCollectibles")),
						squareImage: squareMedia,
						bannerImage: bannerMedia ?? squareMedia,
						socials: TouchstoneDuckysDigitalCollectibles.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
					)
	...
	pub resource Administrator {
		pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra: {String: AnyStruct}, supply: UInt64) {
			TouchstoneDuckysDigitalCollectibles.metadatas[TouchstoneDuckysDigitalCollectibles.nextMetadataId] = NFTMetadata(
				_name: name,
		...
		pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address) {
			pre {
				EmeraldPass.isActive(user: TouchstoneDuckysDigitalCollectibles.account.address): "You must have an active Emerald Pass subscription to airdrop NFTs. You can purchase Emerald Pass at https://pass.ecdao.org/"
			}
			...
			if let recipientCollection = getAccount(recipient).getCapability(TouchstoneDuckysDigitalCollectibles.CollectionPublicPath).borrow<&TouchstoneDuckysDigitalCollectibles.Collection{NonFungibleToken.CollectionPublic}>() {
				...
				if let storage = &TouchstoneDuckysDigitalCollectibles.nftStorage[recipient] as &{UInt64: NFT}? {
					storage[nft.id] <-! nft
				} else {
