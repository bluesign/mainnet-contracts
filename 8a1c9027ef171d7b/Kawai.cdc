...
pub contract Kawai: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Kawai",
                    symbol: "KAT",
                    description: "Anime fan lovers",
                    externalURL: MetadataViews.ExternalURL("tiktok.com/@kawaiianimemix"),
                    logos: medias,
                    socials: {
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Kawai.VaultStoragePath,
                    receiverPath: Kawai.ReceiverPublicPath,
                    metadataPath: Kawai.VaultPublicPath,
                    providerPath: /private/KawaiVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Kawai", self.account.address, "KAT", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
