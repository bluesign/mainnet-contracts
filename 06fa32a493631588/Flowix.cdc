...
pub contract Flowix: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Flowix",
                    symbol: "FOX",
                    description: "Flowix - token created for the Flow community.",
                    externalURL: MetadataViews.ExternalURL("twitter.com/roomsterteam"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("roomsterteam"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Flowix.VaultStoragePath,
                    receiverPath: Flowix.ReceiverPublicPath,
                    metadataPath: Flowix.VaultPublicPath,
                    providerPath: /private/FlowixVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Flowix", self.account.address, "FOX", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
