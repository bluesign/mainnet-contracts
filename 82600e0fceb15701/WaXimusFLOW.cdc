...
pub contract WaXimusFLOW: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreics7ybtjxdv23khf64dypq5qld6gszl26dc5ndkc5exowutui3rju"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "WaXimus FLOW",
                    symbol: "WAX",
                    description: "Living every week like its #SharkWeek...NFA",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("@WaximusW"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: WaXimusFLOW.VaultStoragePath,
                    receiverPath: WaXimusFLOW.ReceiverPublicPath,
                    metadataPath: WaXimusFLOW.VaultPublicPath,
                    providerPath: /private/WaXimusFLOWVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("WaXimusFLOW", self.account.address, "WAX", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
