...
pub contract Collectible: NonFungibleToken {
    ...
    pub resource Set {
        ...
        pub fun addItem(itemId: UInt32) {
            pre {
                Collectible.itemDatas[itemId] != nil: "Cannot add the Item to Set: Item doesn't exist."
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: /storage/_2096cb04c18e4a42_Collectible_Collection,
                        publicPath: /public/_2096cb04c18e4a42_Collectible_Collection,
                        providerPath: /private/_2096cb04c18e4a42_Collectible_Collection,
                        publicCollection: Type<&Collectible.Collection{Collectible.CollectibleCollectionPublic}>(),
                        publicLinkedType: Type<&Collectible.Collection{Collectible.CollectibleCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&Collectible.Collection{Collectible.CollectibleCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
    ...
    pub resource Admin {
        ...
        pub fun borrowSet(setId: UInt32): &Set {
            pre {
                Collectible.sets[setId] != nil: "Cannot borrow set: The set doesn't exist."
            }
