...
pub contract ADUToken: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    ...
                    symbol: "ADU",
                    description: "All Day Unlimited community DAO.",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL(""),
                        "discord": MetadataViews.ExternalURL("alldayunlimited")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: ADUToken.VaultStoragePath,
                    receiverPath: ADUToken.ReceiverPublicPath,
                    metadataPath: ADUToken.VaultPublicPath,
                    providerPath: /private/ADUTokenVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("ADUToken", self.account.address, "ADU", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
