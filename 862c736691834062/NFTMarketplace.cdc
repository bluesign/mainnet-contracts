...
import MyNFT from ../0xebaebb510bfedecd/MyNFT.cdc
import FungibleToken from ../0xf233dcee88fe0abe/FungibleToken.cdc
import FlowToken from ../0x1654653399040a61/FlowToken.cdc

pub contract NFTMarketplace {

  pub event ListForSale (id: UInt64, from: Address?, price: UFix64, publicId: String)
  ...
  pub resource SaleCollection: SaleCollectionPublic {
    ...
    pub fun listForSale(id: UInt64, price: UFix64, data: String) {
      pre {
