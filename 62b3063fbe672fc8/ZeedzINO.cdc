...
pub contract ZeedzINO: NonFungibleToken {
    ...
    pub resource Administrator {
        ...
        pub fun evolve(zeedle: @ZeedzINO.NFT?, nextEvolutionMetadata: {String: String}): @ZeedzINO.NFT {
            let evolvedZeedle  <-create ZeedzINO.NFT(
                initID: ZeedzINO.totalSupply,
                initName: nextEvolutionMetadata["name"]!,
                initDescription:  nextEvolutionMetadata["description"]!,
                initTypeID: UInt32.fromString(nextEvolutionMetadata["typeID"]!)!,
                initSerialNumber: zeedle?.serialNumber != nil ? zeedle?.serialNumber! : nextEvolutionMetadata["serialNumber"]!,
                initEdition: zeedle?.edition != nil ? zeedle?.edition! : 99,
                initEditionCap: zeedle?.editionCap != nil ? zeedle?.editionCap! : 0,
                initEvolutionStage: UInt32.fromString(nextEvolutionMetadata["evolutionStage"]!)!,
                initRarity: nextEvolutionMetadata["rarity"]!,
                initImageURI:nextEvolutionMetadata["imageURI"]!,
                initCarbonOffset: zeedle?.carbonOffset != nil ? zeedle?.carbonOffset! : 0)
