...
pub contract Bobblz_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            Bobblz_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintBobblz_NFT(
			...
			recipient.deposit(token: <-create Bobblz_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: Bobblz_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: Bobblz_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: Bobblz_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: Bobblz_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: Bobblz_NFT.CollectionStoragePath,
                        publicPath: Bobblz_NFT.CollectionPublicPath,
                        providerPath: /private/Bobblz_NFT,
                        publicCollection: Type<&Bobblz_NFT.Collection{Bobblz_NFT.Bobblz_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&Bobblz_NFT.Collection{Bobblz_NFT.Bobblz_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&Bobblz_NFT.Collection{Bobblz_NFT.Bobblz_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/bobblz/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/bobblz/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: Bobblz_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: Bobblz_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(Bobblz_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: Bobblz_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &Bobblz_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(Bobblz_NFT.CollectionPublicPath)
            .borrow<&Bobblz_NFT.Collection{Bobblz_NFT.Bobblz_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&Bobblz_NFT.Admin>(
