...
pub contract TopShotMarketV3{ 
    ...
    pub resource SaleCollection: Market.SalePublic{ 
        ...
        priv var ownerCollection: Capability<&TopShot.Collection>
        
        /// Capability to point at the V1 sale collection
        priv var marketV1Capability: Capability<&Market.SaleCollection>?
        ...
        priv var beneficiaryCapability: Capability<&{FungibleToken.Receiver}>
