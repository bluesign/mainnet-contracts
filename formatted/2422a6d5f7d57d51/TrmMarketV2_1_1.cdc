...
pub contract TrmMarketV2_1_1{ 
    ...
    pub resource SaleCollection: SalePublic{ 
        ...
        priv var ownerCollection: Capability<&TrmAssetV2_1.Collection>
        ...
        pub fun listForTransfer(
            ...
            let saleCollectionCapability =
                getAccount(saleCollectionAddress).getCapability<
                    &TrmMarketV2_1_1.SaleCollection{TrmMarketV2_1_1.SalePublic}
                >(TrmMarketV2_1_1.marketPublicPath).borrow()
                ?? panic(
    ...
    init(){ 
        ...
        self.minterCapability = self.account.getCapability<&TrmRentV2_1.Minter>(
