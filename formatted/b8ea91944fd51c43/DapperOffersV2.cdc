...
pub contract DapperOffersV2{ 
    ...
    pub resource interface DapperOfferPublic{ 
        ...
        //
        pub fun borrowOffer(offerId: UInt64): &OffersV2.Offer{
            OffersV2.OfferPublic
        }?{} 
        ...
        pub fun addProxyCapability(
            account: Address,
            cap: Capability<
                &DapperOffer{DapperOffersV2.DapperOfferProxyManager}
            >
        ){} 
    }
    ...
    pub resource DapperOffer:
        ...
        priv var offers: @{UInt64: OffersV2.Offer}
        ...
        pub fun cleanup(offerId: UInt64){ 
            ...
            assert(
                offer.getDetails().purchased == true,
                message: "Offer is not purchased, only admin can remove"
            )
            destroy offer
        }
