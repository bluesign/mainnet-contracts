...
pub contract OffersV2{ 
    ...
    pub resource Offer: OfferPublic{ 
        ...
        init(vaultRefCapability: Capability<&{FungibleToken.Provider, FungibleToken.Balance}>, nftReceiverCapability: Capability<&{NonFungibleToken.CollectionPublic}>, nftType: Type, amount: UFix64, royalties: [Royalty], offerParamsString:{ String: String}, offerParamsUFix64:{ String: UFix64}, offerParamsUInt64:{ String: UInt64}, resolverCapability: Capability<&{Resolver.ResolverPublic}>){ 
            pre{ 
            ...
            self.details = OfferDetails(offerId: self.uuid, nftType: nftType, offerAmount: amount, royalties: royalties, offerParamsString: offerParamsString, offerParamsUFix64: offerParamsUFix64, offerParamsUInt64: offerParamsUInt64, paymentVaultType: vaultRefCapability.getType())
            emit OfferAvailable(offerAddress: nftReceiverCapability.address, offerId: self.details.offerId, nftType: self.details.nftType, offerAmount: self.details.offerAmount, royalties: royaltyInfo, offerType: offerParamsString["_type"] ?? "unknown", offerParamsString: self.details.offerParamsString, offerParamsUFix64: self.details.offerParamsUFix64, offerParamsUInt64: self.details.offerParamsUInt64, paymentVaultType: self.details.paymentVaultType)
        }
        ...
        //
        pub fun accept(item: @AnyResource{NonFungibleToken.INFT, MetadataViews.Resolver}, receiverCapability: Capability<&{FungibleToken.Receiver}>): Void{ 
            pre{ 
            ...
            let resolverResult = resolverCapability.checkOfferResolver(item: &item as &AnyResource{NonFungibleToken.INFT, MetadataViews.Resolver}, offerParamsString: self.details.offerParamsString, offerParamsUInt64: self.details.offerParamsUInt64, offerParamsUFix64: self.details.offerParamsUFix64)
            if !resolverResult{ 
            ...
            let isDucVault = self.vaultRefCapability.isInstance(Type<Capability<&DapperUtilityCoin.Vault{FungibleToken.Provider, FungibleToken.Balance}>>())
            if isDucVault{ 
                assert((self.vaultRefCapability.borrow()!).balance == initalDucSupply, message: "DUC is leaking")
            }
            emit OfferCompleted(purchased: self.details.purchased, acceptingAddress: receiverCapability.address, offerAddress: self.nftReceiverCapability.address, offerId: self.details.offerId, nftType: self.details.nftType, offerAmount: self.details.offerAmount, royalties: self.getRoyaltyInfo(), offerType: self.details.offerParamsString["_type"] ?? "unknown", offerParamsString: self.details.offerParamsString, offerParamsUFix64: self.details.offerParamsUFix64, offerParamsUInt64: self.details.offerParamsUInt64, paymentVaultType: self.details.paymentVaultType, nftId: nftId)
        }
        ...
        destroy(){ 
            if !self.details.purchased{ 
                emit OfferCompleted(purchased: self.details.purchased, acceptingAddress: nil, offerAddress: self.nftReceiverCapability.address, offerId: self.details.offerId, nftType: self.details.nftType, offerAmount: self.details.offerAmount, royalties: self.getRoyaltyInfo(), offerType: self.details.offerParamsString["_type"] ?? "unknown", offerParamsString: self.details.offerParamsString, offerParamsUFix64: self.details.offerParamsUFix64, offerParamsUInt64: self.details.offerParamsUInt64, paymentVaultType: self.details.paymentVaultType, nftId: nil)
            }
        }
    }
