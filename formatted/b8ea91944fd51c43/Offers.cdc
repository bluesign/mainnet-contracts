...
pub contract Offers{ 
    ...
    pub resource Offer: OfferPublic{ 
        ...
        //
        pub fun accept(item: @NonFungibleToken.NFT, receiverCapability: Capability<&{FungibleToken.Receiver}>): Void{ 
            pre{ 
        ...
        destroy(){ 
            if !self.details.purchased{ 
                emit OfferCompleted(offerId: self.details.offerId, nftType: self.details.nftType, nftId: self.details.nftId, purchased: self.details.purchased, acceptingAddress: nil)
            }
        }
    }
