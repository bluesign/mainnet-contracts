...
pub contract TheFabricantMysteryBox_FF1: NonFungibleToken{ 
    ...
    //
    pub resource Admin{ 
        pub fun createFabricantData(mainImage: String): UInt32{ 
