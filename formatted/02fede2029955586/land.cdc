...
pub contract land: NonFungibleToken{ 
    ...
    pub resource interface _NFT_NAME_CollectionPublic{ 
        ...
        pub fun borrow_NFT_NAME_(id: UInt64): &land.NFT?{ 
            post{ 
    ...
    init(){ 
        ...
        self.account.link<&land.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, land._NFT_NAME_CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
