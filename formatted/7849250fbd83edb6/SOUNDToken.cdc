...
pub contract SOUNDToken: FungibleToken{ 
    ...
    init(){ 
        ...
        //
        self.account.link<&SOUNDToken.Vault{FungibleToken.Receiver}>(/public/SOUNDTokenReceiver, target: /storage/SOUNDTokenVault)
        
        // Create a public capability to the stored Vault that only exposes
        // the `balance` field through the `Balance` interface
        //
        self.account.link<&SOUNDToken.Vault{FungibleToken.Balance}>(/public/SOUNDTokenBalance, target: /storage/SOUNDTokenVault)
