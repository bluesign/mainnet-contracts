...
pub contract MondoPixo_CyberYak: NonFungibleToken{ 
    ...
    pub resource interface _NFT_NAME_CollectionPublic{ 
        ...
        pub fun borrow_NFT_NAME_(id: UInt64): &MondoPixo_CyberYak.NFT?{ 
            post{ 
    ...
    pub resource Collection: _NFT_NAME_CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let token <- token as! @MondoPixo_CyberYak.NFT
        ...
        pub fun borrow_NFT_NAME_(id: UInt64): &MondoPixo_CyberYak.NFT?{ 
            if self.ownedNFTs[id] != nil{ 
                ...
                return ref as! &MondoPixo_CyberYak.NFT?
            }
            return nil
        }
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            let mlNFT = nft as! &MondoPixo_CyberYak.NFT
            return mlNFT
        }
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, metadata:{ String: String}): &NonFungibleToken.NFT{ 
            ...
            // create a new NFT
            var newNFT <- create NFT(id: MondoPixo_CyberYak.totalSupply, creator: creator, metadata: metadata)
            let tokenRef = &newNFT as &NonFungibleToken.NFT
            // deposit it in the recipient's account using their reference
            recipient.deposit(token: <-newNFT)
            MondoPixo_CyberYak.totalSupply = MondoPixo_CyberYak.totalSupply + 1
    ...
    init(){ 
        ...
        self.account.link<&MondoPixo_CyberYak.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MondoPixo_CyberYak._NFT_NAME_CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
