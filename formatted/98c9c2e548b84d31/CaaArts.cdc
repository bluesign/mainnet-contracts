...
pub contract CaaArts: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: CaaArts.CollectionStoragePath, publicPath: CaaArts.CollectionPublicPath, providerPath: /private/caaArtsCollection, // not exists for now publicCollection: Type<&CaaArts.Collection{CaaArts.CollectionPublic}>(), publicLinkedType: Type<&CaaArts.Collection{CaaArts.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&CaaArts.Collection{CaaArts.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &CaaArts.NFT?{ 
        let collection = (getAccount(from).getCapability(CaaArts.CollectionPublicPath)!).borrow<&CaaArts.Collection>() ?? panic("Couldn't get collection")
