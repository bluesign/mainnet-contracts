...
pub contract ContributionPoint: FungibleToken, Pausable{ 
    ...
    pub resource Minter{ 
        ...
        ///
        pub fun mintTokens(amount: UFix64): @ContributionPoint.Vault{ 
            pre{ 
                amount > 0.0:
    ...
    init(){ 
        ...
        //
        self.account.link<&ContributionPoint.Vault{FungibleToken.Balance}>(self.BalancePublicPath, target: self.VaultStoragePath)
