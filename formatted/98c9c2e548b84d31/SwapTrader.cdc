...
pub contract SwapTrader{ 
    ...
    pub resource interface SwapPairListPublic{ 
        // getSwapPair
        // get swap pair info
        pub fun getSwapPair(_ pairID: UInt64): AnyStruct{
            SwapTrader.SwapPairAttributes
        }?{} 
    ...
    pub resource SwapPairList: SwapPairListPublic{ 
        ...
        // swapNFT - execute swap
        pub fun swapNFT(pairID: UInt64, sourceIDs: [UInt64], sourceProvider: Capability<&{NonFungibleToken.Provider}>, targetReceiver: Capability<&{NonFungibleToken.CollectionPublic}>){ 
            pre{ 
