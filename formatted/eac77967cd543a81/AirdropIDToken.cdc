...
pub contract AirdropIDToken: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                AirdropIDToken.totalSupply = AirdropIDToken.totalSupply - self.balance
            }
        }
    }
