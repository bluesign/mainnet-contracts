...
pub contract MindtrixTemplate{ 
    ...
    pub event MindtrixTemplateCreated(
        templateId: UInt64,
        paymentType: Type,
        strMetadata:{ 
            String: String
    ...
    priv var showGuidToMindtrixTemplateIds:{ String:{ UInt64: Bool}}
    
    priv var MindtrixTemplates:{ UInt64: MindtrixTemplateStruct}
    ...
    pub struct MindtrixTemplateStruct{ 
        ...
        access(account) fun verifyMintingConditions(
            recipient: &Mindtrix.Collection{Mindtrix.MindtrixCollectionPublic},
            ...
            let identifiers =
                self.getMintingRecordsByAddress(address: recipientAddress)
            let recipientMaxMintTimesPerAddress =
                UInt64(identifiers?.length ?? 0)
            params.insert(key: "currentEdition", currentEdition)
            params.insert(key: "recipientAddress", recipientAddress)
            params.insert(
                key: "recipientMaxMintTimesPerAddress",
                recipientMaxMintTimesPerAddress
            )
            params.insert(
        ...
        access(account) fun updateMinters(
        ...
        pub fun getMintingRecordsByAddress(address: Address): [
            MindtrixViews.NFTIdentifier
        ]?{ 
            let identifiers: [MindtrixViews.NFTIdentifier]? =
                self.minters[address]
            if self.minters[address] == nil{ 
                return nil
            }
            return identifiers
        ...
        init(
            ...
            self.minters ={} 
            let showGuid =
                strMetadata["showGuid"]
                ?? panic("Cannot create the template with a nil showGuid.")
            var templateDic:{ UInt64: Bool} =
                MindtrixTemplate.showGuidToMindtrixTemplateIds[showGuid] ??{} 
            templateDic.insert(key: templateId, true)
            MindtrixTemplate.showGuidToMindtrixTemplateIds.insert(
                key: showGuid,
                templateDic
            )
            MindtrixTemplate.nextTemplateId = MindtrixTemplate.nextTemplateId
                + 1
    ...
    pub resource interface AdminPublic{ 
        pub fun createMindtrixTemplateStruct(
            name: String,
            description: String,
            strMetadata:{ 
                String: String
    ...
    pub resource Admin: AdminPublic{ 
        ...
        pub fun createMindtrixTemplateStruct(name: String, description: String, strMetadata:{ String: String}, intMetadata:{ String: UInt64}, maxEdition: UInt64, paymentType: Type, mintPrice:{ String: MindtrixViews.FT}, royalties: [MetadataViews.Royalty], socials:{ String: String}, components:{ String: UInt64}, verifiers: [{MindtrixViews.IVerifier}]){ 
    ...
    pub fun getMindtrixTemplateByTemplateId(
        templateId: UInt64
    ): MindtrixTemplateStruct?{ 
        return self.MindtrixTemplates[templateId]
    }
    
    pub fun getMindtrixTemplatesByShowGuId(
        showGuid: String,
        templateTypes: [
            UInt64
        ],
        ...
        let ids: [UInt64] =
            MindtrixTemplate.showGuidToMindtrixTemplateIds[showGuid]?.keys ?? []
    ...
    pub fun filterTemplateByTypeAndStatus(
    ...
    pub fun freeMintNFT(
        ...
        let templateStruct =
            MindtrixTemplate.getMindtrixTemplateByTemplateId(
                templateId: templateId
            )!
        MindtrixTemplate.mintNFTFromTemplate(
            recipient: recipient,
    ...
    pub fun buyNFT(
        ...
        var merchantReceiverCap: Capability<&{FungibleToken.Receiver}> =
            MindtrixTemplate.account.getCapability<
                &FiatToken.Vault{FungibleToken.Receiver}
    ...
    priv fun updateTemplateEditionAndMinters(
        templateId: UInt64,
        newEdition: UInt64,
        nftIdentifier: MindtrixViews.NFTIdentifier
    ){ 
    ...
    priv fun updateTemplate(template: MindtrixTemplateStruct){ 
        MindtrixTemplate.MindtrixTemplates.insert(
    ...
    priv fun mintNFTFromTemplate(
        ...
        let strMetadata:{ String: String} ={
                ...
                essenceMetadata["collectionDescription"] ?? "",
                // collectionExternalURL is the Podcast link from the hosting platform.
                "collectionExternalURL":
                essenceMetadata["collectionExternalURL"] ?? "",
                "collectionSquareImageUrl":
                essenceMetadata["collectionSquareImageUrl"] ?? "",
                "collectionSquareImageType":
                essenceMetadata["collectionSquareImageType"] ?? "",
                "collectionBannerImageUrl":
                essenceMetadata["collectionBannerImageUrl"] ?? "",
                "collectionBannerImageType":
                essenceMetadata["collectionBannerImageType"] ?? "",
                // essenceExternalURL is the Essence page from Mindtrix Marketplace.
                "essenceExternalURL":
                essenceMetadata["essenceExternalURL"] ?? "",
                ...
                "nftFileIPFSDirectory":
                essenceMetadata["essenceFileIPFSDirectory"] ?? "",
                "nftFilePreviewUrl":
                essenceMetadata["essenceFilePreviewUrl"] ?? "",
                // need to pass nftAudioPreviewUrl
                "nftAudioPreviewUrl":
                essenceMetadata["nftAudioPreviewUrl"] ?? "",
                "nftImagePreviewUrl":
                essenceMetadata["essenceImagePreviewUrl"] ?? "",
                "nftVideoPreviewUrl":
                essenceMetadata["essenceVideoPreviewUrl"] ?? "",
                "essenceRealmSerial":
                essenceMetadata["essenceRealmSerial"] ?? "",
                ...
                "audioEssenceSerial":
                essenceMetadata["audioEssenceSerial"] ?? "",
                ...
                "fullEpisodeDuration":
                essenceMetadata["fullEpisodeDuration"] ?? "",
    ...
    init(){ 
        ...
        ducRoyalties.append(
            MetadataViews.Royalty(
                receiver: self.account.getCapability<
                    &TokenForwarding.Forwarder{FungibleToken.Receiver}
        ...
        self.MindtrixRoyaltyDic.insert(
            key: DapperUtilityCoin.getType().identifier,
            ducRoyalties
        )
        self.MindtrixRoyaltyDic.insert(
            key: FlowUtilityToken.getType().identifier,
            futRoyalties
        )
