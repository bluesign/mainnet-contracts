...
pub contract Mindtrix: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver, INFT{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Mindtrix.MindtrixCollectionStoragePath, publicPath: Mindtrix.MindtrixCollectionPublicPath, providerPath: /private/MindtrixCollection, publicCollection: Type<&Mindtrix.Collection{Mindtrix.MindtrixCollectionPublic}>(), publicLinkedType: Type<&Mindtrix.Collection{Mindtrix.MindtrixCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Mindtrix.Collection{Mindtrix.MindtrixCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MindtrixViews.EssenceIdentifier>():
                    return MindtrixViews.EssenceIdentifier(uuid: self.data.essenceId, serials: MindtrixViews.Serials(self.getSerialDic()).arr, holder: Mindtrix.account.address, showGuid: self.data.metadata["showGuid"] ?? "", episodeGuid: self.data.metadata["episodeGuid"] ?? "", createdTime: self.data.createdTime)
            }
            return nil
        }
        ...
        destroy(){ 
            ...
            emit NFTDestroyed(id: self.id, essenceId: self.data.metadata["essenceId"] ?? "", showGuid: self.data.metadata["showGuid"] ?? "", episodeGuid: self.data.metadata["episodeGuid"] ?? "", nftEdition: self.data.nftEdition ?? 0, name: self.data.metadata["nftName"] ?? "", serial: MindtrixViews.Serials(self.getSerialDic()).str)
        }
    }
    ...
    init(){ 
        ...
        self.account.link<&Mindtrix.Collection{NonFungibleToken.CollectionPublic, Mindtrix.MindtrixCollectionPublic, MetadataViews.ResolverCollection}>(self.MindtrixCollectionPublicPath, target: self.MindtrixCollectionStoragePath)
