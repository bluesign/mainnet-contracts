...
pub contract MindtrixPack: NonFungibleToken{ 
    ...
    priv var beneficiaryAddress: Address
    
    priv var setIDToOwner:{ UInt64: Address}
    
    priv var entityIDToOwner:{ UInt64: Address}
    ...
    pub struct Entity{ 
        ...
        priv let intMetadata:{ String: UInt64}
        
        priv let fixMetadata:{ String: UFix64}
        
        priv let strMetadata:{ String: String}
        ...
        init(intMetadata:{ String: UInt64}, fixMetadata:{ String: UFix64}, strMetadata:{ String: String}, setID: UInt64, nextEntityID: UInt64){ 
            pre{ 
    ...
    pub struct SetVo{ 
        ...
        priv var entities: [UInt64]
        
        priv var retiredEntities:{ UInt64: Bool}
        
        priv var numMintedPerEntity:{ UInt64: UInt64}
    ...
    pub struct PackVo{ 
        ...
        init(setID: UInt64, entityID: UInt64, packID: UInt64, packSerial: UInt64, packMinterAddress: Address, mintedTime: UFix64){ 
            ...
            let setRef = MindtrixPack.borrowSetCollectionPublicRef(setID: setVo.setID).borrowSetPublic(setID: setVo.setID)
    ...
    pub resource Tracker: MindtrixViews.IHashVerifier{ 
        ...
        pub fun updateStatusToDistributed(packID: UInt64, metadataHash: [UInt8]){ 
            pre{ 
                self.status != PackStatus.Opened:
                    "Cannot revert the status from Opened to Distributed."
                self.status != PackStatus.Distributed:
                    "The pack is alredy Distributed."
            }
            self.status = PackStatus.Distributed
        ...
        pub fun updateStatusToOpened(){ 
            pre{ 
                self.status != PackStatus.Sealed:
                    "Cannot open the pack which is yet to be Distributed."
                self.status != PackStatus.Opened:
                    "The pack is alredy Opened."
            }
            self.status = PackStatus.Opened
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver, INFTPublic{ 
        ...
        pub fun getVo(): PackVo{ 
            return PackVo(setID: self.setID, entityID: self.entityID, packID: self.id, packSerial: self.serial, packMinterAddress: self.minterAddress, mintedTime: self.mintedTime)
        }
        
        pub fun getMedia(landmarkName: String, packStatus: PackStatus): MetadataViews.Medias{ 
            let mediaURLDic:{ String:{ PackStatus: [String]}} ={ "bush village":{ PackStatus.Opened: ["https://bafybeie3cdgghiipgaesavnnns4kvqfzqqohbudhpsacqjjdpdz2sha4ly.ipfs.w3s.link/media_bush_village_open_1.jpg", "https://bafybeif62nxjtbfr7innbp5uxsbnj4ehzjzjfdcncgqzhzsn5xzyl2phce.ipfs.w3s.link/media_bush_village_open_2.jpg"], PackStatus.Sealed: ["https://bafybeiakloh64wsnmxiwwxue32yeh3i2pcmaewoynybhjhtd56zfhsqfwm.ipfs.w3s.link/media_bush_village_default_1.jpg", "https://bafybeid2j5pmtehyxjmxzkk4hfjslbtl7m3vw6lbuerwnutl3hej56ec6e.ipfs.w3s.link/media_bush_village_default_2.jpg"]}, "echo cliff":{ PackStatus.Opened: ["https://bafybeifkmy37gvuydlr34a57vmhv3pifuobdurhp4w25iu4gp3ldq4t33i.ipfs.w3s.link/media_echo_cliff_open_1.jpg", "https://bafybeig32nwwxygwyf7gajiaamo5wacz54ikiyxhkgbbs3z27ulbe5usfi.ipfs.w3s.link/media_echo_cliff_open_2.jpg"], PackStatus.Sealed: ["https://bafybeifvo5zgbebnqwba7fkkge4fmy7fbsjpohz3k56am4o5u2upxvqb7y.ipfs.w3s.link/media_echo_cliff_default_1.jpg", "https://bafybeibevrm5abxr36szvjwo3isfotn6czvym7cofbylpggdkcfpt3tc3m.ipfs.w3s.link/media_echo_cliff_default_2.jpg"]}, "podment temple":{ PackStatus.Opened: ["https://bafybeielwealoqjz7cihl3l2lioyevmp4hv6eqgnj2dntagnk7mbwcbddu.ipfs.w3s.link/media_podment_temple_open_1.jpg", "https://bafybeihf6ndpepif4tv77udpp4mnc4edosuj5mtn7nyqdrbskdxwv6u7ey.ipfs.w3s.link/media_podment_temple_open_2.jpg"], PackStatus.Sealed: ["https://bafybeigtjp3kzmrrzcpfymrizdzhdvwg7usecbtbjja4zkubjdscbb5tvm.ipfs.w3s.link/media_podment_temple_default_1.jpg", "https://bafybeidzvzg5aum5hzlnt542hyji3ua5fvjokbdjurlh66vashu4dwcata.ipfs.w3s.link/media_podment_temple_default_2.jpg"]}, "green bazaar":{ PackStatus.Opened: ["https://bafybeiaxabvir6oyp7nfn76zg2tugphwppyhhnx6uw5uhu7bxzezxiimkq.ipfs.w3s.link/media_green_bazaar_open_1.jpg", "https://bafybeigklewgn67knvvj6vgjcccmlrzvto4f5e2fjweoerqfhnqjv74kay.ipfs.w3s.link/media_green_bazaar_open_2.jpg"], PackStatus.Sealed: ["https://bafybeiejrt2iftiqbdxxfqvdrg34kja3p2cut2kfj3d4oq3ga5ejmjhcqe.ipfs.w3s.link/media_green_bazaar_default_1.jpg", "https://bafybeigyjo2z3sdththrz3k32bas2tv6ki7uifte42mtorw6eh3jrq3pyy.ipfs.w3s.link/media_green_bazaar_default_2.jpg"]}, "kabbalah sacred trees":{ PackStatus.Opened: ["https://bafybeicawrbep7tlxm5agmas53dmmspbbm7wis3rroimxmmclzmmbzg5iq.ipfs.w3s.link/media_kabbalah_sacred_trees_open_1.jpg", "https://bafybeih7gbamdfttpkoqwgujyk5avdnxmvv5pfezbmtix6s2vamutctl3y.ipfs.w3s.link/media_kabbalah_sacred_trees_open_2.jpg"], PackStatus.Sealed: ["https://bafybeifkfaltdn2dpokvqrlitadjkssmnbjddonfy4puzcqldkikcz6nsu.ipfs.w3s.link/media_kabbalah_sacred_trees_default_1.jpg", "https://bafybeihnkfa4mrtmst23ghvktrmsillrwbealzaexax3m7sb47ce2iv7cy.ipfs.w3s.link/media_kabbalah_sacred_trees_default_2.jpg"]}, "mimir swamp":{ PackStatus.Opened: ["https://bafybeihizzaimh6a4cdwsq42e4fqmt5u2xlzajaimpebpjp2vcr5ggzxry.ipfs.w3s.link/media_mimir_swamp_open_1.jpg", "https://bafybeia6mjkzxxc2tnwci5koasijtzo6brxcnyicphadoeupxfpsw7d4rq.ipfs.w3s.link/media_mimir_swamp_open_2.jpg"], PackStatus.Sealed: ["https://bafybeigass6kxaretip23m5xbu6n3u5f33aex4wvoqitaqxks767qdhxhm.ipfs.w3s.link/media_mimir_swamp_default_1.jpg", "https://bafybeiadckumpaf4ndvxsrtg3v6fddd5kbdzewewtboquqiya5p2uy3wdm.ipfs.w3s.link/media_mimir_swamp_default_2.jpg"]}}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MindtrixPack.CollectionStoragePath, publicPath: MindtrixPack.CollectionPublicPath, providerPath: /private/MindtrixPackCollection, publicCollection: Type<&MindtrixPack.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MindtrixPack.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&MindtrixPack.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MindtrixPack.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MindtrixPack.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MindtrixPack.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-MindtrixPack.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: data.setVo.thumbnailURL), mediaType: "image")
                    let bannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: data.setVo.bannerURL), mediaType: "image")
                    return MetadataViews.NFTCollectionDisplay(name: "Mindtrix Pack", description: data.setVo.description, externalURL: MetadataViews.ExternalURL(MindtrixPack.getExternalURL()), squareImage: squareImage, bannerImage: bannerImage, socials:{ "discord": MetadataViews.ExternalURL("https://link.mindtrix.xyz/Discord"), "instagram": MetadataViews.ExternalURL("https://www.instagram.com/mindtrix_dao"), "facebook": MetadataViews.ExternalURL("https://www.facebook.com/mindtrix.dao"), "twitter": MetadataViews.ExternalURL("https://twitter.com/mindtrix_dao")})
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: self.name(), description: data.entityVo.description, thumbnail: MetadataViews.HTTPFile(url: data.entityVo.thumbnailURL))
                case Type<MetadataViews.Royalties>():
                    let feeCut: UFix64 = 0.05
                    let royalties: [MetadataViews.Royalty] = [MetadataViews.Royalty(receiver: getAccount(self.minterAddress).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver)!, cut: feeCut, description: "The first minter's royalty cut")]
                    return MetadataViews.Royalties(cutInfos: royalties)
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(self.serial)
                case Type<MetadataViews.Edition>():
                    return MetadataViews.Edition(name: data.setVo.name, number: self.serial, max: data.entityVo.maxSupply)
    ...
    pub resource Collection: CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun getUnopenedIDs(): [UInt64]{ 
            ...
            for id in self.ownedNFTs.keys{ 
                ...
                let packVo = MindtrixPack.PackVo(setID: pack.setID, entityID: pack.entityID, packID: pack.id, packSerial: pack.serial, packMinterAddress: pack.minterAddress, mintedTime: pack.mintedTime)
    ...
    pub resource SetCollection: ISetCollectionPublic, ISetCollectionAdmin, MindtrixViews.IHashProvider{ 
        priv var sets: @{UInt64: Set}
        
        priv var entities:{ UInt64: Entity}
        
        priv var extra:{ String: AnyStruct}
        ...
        pub fun updateEntityMetadata(entityID: UInt64, strMetadata:{ String: String}, intMetadata:{ String: UInt64}){ 
            pre{ 
                self.entities[entityID] != nil:
                    "Cannot update a non-existed entity."
                self.sets[(self.entities[entityID]!).setID]?.locked == false:
                    "Locked set data cannot be updated"
            }
        ...
        pub fun updateEntityPrice(entityID: UInt64, priceUSD: UFix64){ 
            pre{ 
                self.entities.keys.contains(entityID):
                    "Cannot update a non-existed entity's price."
            }
    ...
    pub resource Set: ISetPublic{ 
        ...
        priv var maxSupplyPerEntity:{ UInt64: UInt64}
        
        // {{entityID}: {mintedNum}}
        priv var numMintedPerEntity:{ UInt64: UInt64}
        
        // Minters record the history of each address that creates an entity.
        priv var minters:{ Address:{ UInt64: [MindtrixViews.NFTIdentifier]}}
        ...
        priv var entityMetadataSources:{ UInt32:{ String: String}}
        
        priv var mintedNFTIDToNFTIdentifiers:{ UInt64: MindtrixViews.NFTIdentifier}
        
        priv var minterAddressToNFTID:{ Address: [UInt64]}
        
        priv var entityIDToMinterAddressToNFTIdentifiers:{ UInt64:{ Address: [UInt64]}}
        
        priv var strMetadata:{ String: String}
        
        priv var intMetadata:{ String: UInt64}
        
        priv var fixMetadata:{ String: UFix64}
        
        priv var boolMetadata:{ String: Bool}
        
        priv var trackers: @{UInt64: MindtrixPack.Tracker}
        
        // {MindtrixPack.PackStatus.Distributed: {1(TrackerSerial):143954166(PackID), 2: 143954178,...}, MindtrixPack.PackStatus.Opened: ,,,}
        priv var statusToTrackerSerials:{ MindtrixPack.PackStatus:{ UInt64: UInt64}}
        
        priv var allowList: @{Address: MindtrixPack.Collection}
        ...
        priv var metadataHashesString:{ UInt64:{ String: UInt64}}
        
        priv var metadataHashesStringConsumer: [[String]]
        ...
        destroy(){ 
            pre{ 
                self.allowList.length == 0:
                    "Cannot destroy the set because there are unclaimed allowlist."
                self.trackers.length == 0:
                    "Cannot destroy the set because there are unclaimed packs."
            }
        ...
        pub fun replaceEntityMetadataSources(entityMetadataSources:{ UInt32:{ String: String}}){ 
            pre{ 
                entityMetadataSources.keys.length > 0:
                    "Cannot add an empty source"
                self.entityMetadataSources.keys.length <= 0:
                    "Cannot replace the existing sources"
            }
        ...
        pub fun dropEntitySupply(entityID: UInt64, dropNum: UInt64){ 
            pre{ 
                !self.locked:
                    "Cannot drop the max supply after the set has been locked."
                self.isEnableDropMaxSupply:
                    "Not allow to drop the max supply."
                self.getEntityIDs().contains(entityID):
                    "Cannot find the entity from the given entityID:".concat(entityID.toString())
                self.maxSupplyPerEntity[entityID] != nil:
                    "Cannot find the max supply of the entity from the given entityID:".concat(entityID.toString())
                self.numMintedPerEntity[entityID] != nil:
                    "Cannot find the minted number of the entity from the given entityID:".concat(entityID.toString())
                self.maxSupplyPerEntity[entityID]! - UInt64(dropNum) >= self.numMintedPerEntity[entityID]!:
                    "Cannot drop the entity number which would lower than the minted number."
                dropNum <= 15:
                    "Cannot drop over 15 each time."
            }
            post{ 
                self.maxSupplyPerEntity[entityID]! >= self.numMintedPerEntity[entityID]!:
                    "Cannot drop the entity number which would lower than the minted number."
            }
        ...
        pub fun updateEntitiesPriceAfterRevealUtility(priceUSD: UFix64){ 
            let setCollectionRef = MindtrixPack.account.borrow<&MindtrixPack.SetCollection>(from: MindtrixPack.SetCollectionStoragePath) ?? panic("Cannot borrow the set collection.")
        ...
        pub fun updateMinters(entityID: UInt64, packIdentifier: MindtrixViews.NFTIdentifier){ 
            ...
            } else if (self.minters[address]!)[entityID] == nil{ 
        ...
        pub fun distributePack(patchSize: Int){ 
            pre{ 
                self.distributionTimestamp != nil:
                    "The distribution timestamp is yet to assigned."
                self.distributionBlockHeight != nil:
                    "The distribution block height is yet to assigned."
                self.distributionBlockHeight! <= getCurrentBlock().height:
                    "Cannot distribution Packs until reaching the distribution block height."
            }
            ...
            while count <= patchSize{ 
                ...
                let originalMetadataIndex = (self.metadataHashesString[hashSetIndex]!)[consumedMetadataHashString] ?? panic("The consumedMetadataHashString does not exist.")
        ...
        pub fun openPack(setID: UInt64, entityID: UInt64, packID: UInt64, packCollectionRef: &{NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic}, recvRef: &{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver}, strMetadata:{ String: String}){ 
            pre{ 
                packCollectionRef.getIDs().contains(packID):
                    "Cannot find the packID in holder's collection: ".concat(packID.toString())
                (packCollectionRef.owner!).address == (recvRef.owner!).address:
                    "The Pack owner and the receiver are not identical."
                self.trackers[packID] != nil:
                    "Cannot tract this pack:".concat(packID.toString())
                (self.borrowTracker(packID: packID)!).status == PackStatus.Distributed:
                    "Pack is yet to be Distributed"
                self.isAllowOpen == true:
                    "Not yet for opening the pack."
            }
            let trackerRef = self.borrowTracker(packID: packID)
            let setCollectionPublicCap = getAccount((self.owner!).address).getCapability<&MindtrixPack.SetCollection{ISetCollectionPublic, MindtrixViews.IHashProvider}>(MindtrixPack.SetCollectionPublicPath)
            ...
            let intMetadata ={ "setID": self.setID, "entityID": entityID, "packID": packID}
            ...
            royalties.append(MetadataViews.Royalty(receiver: beneficiaryCapability, cut: 0.05, description: "5% royalty for the first minter."))
            ...
            recvRef.deposit(token: <-MindtrixOtter.mintNFT(minterAddress: (recvRef.owner!).address, metadataHash: metadataHashFromTracker, setCollectionPublicCap: setCollectionPublicCap, strMetadata: strMetadata, intMetadata: intMetadata, fixMetadata:{} , components:{} , royalties: royalties))
        }
        ...
        pub fun copyMetadataHashStrToConsumer(){ 
            pre{ 
                self.intMetadata["metadataHashConsumerLen"] ?? 0 < 9999:
                    "Cannot add hash consumer over 9999!"
            }
        ...
        pub fun getMetadataHashIndexBySetIndex(hashSetIndex: UInt64):{ String: UInt64}{ 
            pre{ 
                self.metadataHashesString[hashSetIndex] != nil:
                    "Cannot find the hashSetIndex: ".concat(hashSetIndex.toString())
            }
        ...
        pub fun getBlockHeightFromTimestamp(targetedTimestamp: UFix64): UInt64{ 
            pre{ 
                targetedTimestamp <= getCurrentBlock().timestamp:
                    "The targeted timestamp should not be a future time."
            }
        ...
        pub fun updateMaxPackSupply(maxPackSupply: UInt64){ 
            pre{ 
                maxPackSupply >= self.getTotalMinted():
                    "Pack supply limit should not lower than total minted number."
            }
        ...
        pub fun verifyMintingConditions(entityID: UInt64, minterAddress: Address?, quantity: UInt64, isAssert: Bool):{ String: Bool}{ 
            ...
            let params:{ String: AnyStruct} ={ "currentEdition": currentEdition, "currentEntityEdition": currentEntityEdition, "recipientAddress": minterAddress, "recipientMaxMintTimesPerAddress": recipientMaxMintTimesPerAddress, "recipientMintQuantityPerTransaction": quantity, "recipientMintQuantityPerEntity": recipientMintQuantityPerEntity}
            let isOnAllowList = minterAddress == nil ? false : self.getIsOnAllowList(minterAddress!)
            let intDic:{ String: UInt64} ={ "maxEdition": self.getMaxSupplySumOfEntities(),                                                                                            // maxSupplyPerRound indicates the supply limit of each Public Sale round.
                                                                                            "maxSupplyPerRound": self.intMetadata["maxPackSupply"] ?? 0, "maxSupplyPerEntity": self.getMaxSupplyFromSingleEntity(entityID: entityID) ?? 0,                                                                                                                                                                                                                                           // each allowlist member can get five free Packs at most for cooperation, so they can still buy the other 3 Packs themselves.
                                                                                                                                                                                                                                           "maxMintTimesPerAddress": isOnAllowList ? 8 : 3, "maxMintQuantityPerTransaction": 1, "maxMintTimesPerEntity": 1}
        ...
        pub fun mint(entityID: UInt64, minterAddress: Address): @NFT{ 
            pre{ 
                ...
                self.intMetadata["maxPackSupply"] ?? 100 >= self.getTotalMinted() + UInt64(1):
                    "Cannot mint over the supply limitation:".concat((self.intMetadata["maxPackSupply"] ?? 100).toString())
            }
            ...
            let pack: @NFT <- create NFT(serial: nextEdition, entityID: entityID, setID: self.setID, minterAddress: minterAddress)
            let packID = pack.id
            // Creating Tracker is to track Pack's status
            let tracker: @Tracker <- create Tracker(issuer: (self.owner!).address, setID: self.setID, entityID: entityID, packID: packID, serial: self.nextTrackerSerial)
            ...
            let packIdentifier = MindtrixViews.NFTIdentifier(uuid: packID, serial: pack.serial, holder: minterAddress)
    ...
    access(account) fun borrowSetCollectionAdminRef(setID: UInt64): &MindtrixPack.SetCollection{ISetCollectionAdmin}{ 
        ...
        return getAccount(setOwnerAddress).getCapability<&MindtrixPack.SetCollection{ISetCollectionAdmin}>(MindtrixPack.SetCollectionPublicPath).borrow() ?? panic("Cannot borrow the set collection")
    }
    ...
    pub fun borrowSetCollectionPublicRefFromSetOwnerAddress(setOwnerAddress: Address): &MindtrixPack.SetCollection{ISetCollectionPublic, MindtrixViews.IHashProvider}{ 
        return getAccount(setOwnerAddress).getCapability<&MindtrixPack.SetCollection{ISetCollectionPublic, MindtrixViews.IHashProvider}>(MindtrixPack.SetCollectionPublicPath).borrow() ?? panic("Cannot borrow the set collection")
    }
    ...
    pub fun buyPack(recipient: &MindtrixPack.Collection{MindtrixPack.CollectionPublic}, paymentVault: @FungibleToken.Vault, setID: UInt64, entityID: UInt64, numberOfPacks: UInt64, merchantAccount: Address?){ 
        pre{ 
            numberOfPacks == 1:
                "Cannot buy more than one Pack in a landmarks."
            UFix64(numberOfPacks) * (MindtrixPack.getEntityVo(entityID: entityID)!).priceUSD == paymentVault.balance:
                "The withdrew balance is not equal to the expected price."
