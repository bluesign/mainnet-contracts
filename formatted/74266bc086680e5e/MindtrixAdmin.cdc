...
pub contract MindtrixAdmin{ 
    ...
    pub resource Admin{ 
        pub fun freeMintNFTFromEssence(
            ...
            pre{ 
                MindtrixEssence.getOneEssenceStruct(essenceId: essenceId)?.getMintPrice() ?? nil == nil:
                    "You have to purchase this essence."
                MindtrixEssence.getOneEssenceStruct(essenceId: essenceId)?.getEssenceClaimable() ?? false == true:
            ...
            let nftMetadata:{ String: String} ={
                    ...
                    "nftDescription":
                    essenceMetadata["essenceDescription"] ?? "",
                    ...
                    "nftFileIPFSCid":
                    essenceMetadata["essenceFileIPFSCid"] ?? "",
                    "nftFileIPFSDirectory":
                    essenceMetadata["essenceFileIPFSDirectory"] ?? "",
                    "nftFilePreviewUrl":
                    strMetadata["nftFilePreviewUrl"] != nil
                        ? strMetadata["nftFilePreviewUrl"]!
                        : essenceMetadata["essenceFilePreviewUrl"] ?? "",
                    "nftAudioPreviewUrl":
                    strMetadata["nftAudioPreviewUrl"] ?? "",
                    "nftImagePreviewUrl":
                    strMetadata["nftImagePreviewUrl"] != nil
                        ? strMetadata["nftImagePreviewUrl"]!
                    ...
                    "essenceTypeSerial":
                    essenceMetadata["essenceTypeSerial"] ?? "",
                    "essenceEpisodeImgLink":
                    essenceMetadata["essenceEpisodeImgLink"] ?? "",
                    ...
                    "licenseIdentifier":
                    essenceMetadata["licenseIdentifier"] ?? "",
        ...
        pub fun replaceShowGuidToRoyalties(
            ...
            MindtrixDonation.replaceShowGuidToRoyalties(
                showGuid: showGuid,
    ...
    init(){ 
        ...
        if self.account.borrow<&MindtrixAdmin.Admin>(
            from: MindtrixAdmin.MindtrixAdminStoragePath
        )
        == nil{ 
            self.account.save<@MindtrixAdmin.Admin>(
                <-create MindtrixAdmin.Admin(),
                to: MindtrixAdmin.MindtrixAdminStoragePath
            )
        }
        self.account.link<&MindtrixAdmin.Admin>(
            MindtrixAdmin.MindtrixAdminPrivatePath,
            target: MindtrixAdmin.MindtrixAdminStoragePath
        )!
    }
}
