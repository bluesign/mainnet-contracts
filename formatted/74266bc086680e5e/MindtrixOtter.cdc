...
pub contract MindtrixOtter: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver, INFTPublic{ 
        ...
        priv let setCollectionPublicCap: Capability<&{MindtrixViews.IHashProvider}>
        ...
        priv var components:{ String: UInt64}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MindtrixOtter.CollectionStoragePath, publicPath: MindtrixOtter.CollectionPublicPath, providerPath: /private/MindtrixOtterNFTCollection, publicCollection: Type<&MindtrixOtter.Collection{MindtrixOtter.CollectionPublic}>(), publicLinkedType: Type<&MindtrixOtter.Collection{MindtrixOtter.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MindtrixOtter.Collection{MindtrixOtter.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    access(account) fun mintNFT(minterAddress: Address, metadataHash: [UInt8], setCollectionPublicCap: Capability<&{MindtrixViews.IHashProvider}>, strMetadata:{ String: String}, intMetadata:{ String: UInt64}, fixMetadata:{ String: UFix64}, components:{ String: UInt64}, royalties: [MetadataViews.Royalty]): @NFT{ 
        pre{ 
    ...
    init(){ 
        ...
        self.account.link<&MindtrixOtter.Collection{NonFungibleToken.CollectionPublic, MindtrixOtter.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
