...
pub contract S1ItemNFT: NonFungibleToken{ 
    ...
    pub struct ItemData{ 
        ...
        // other metadata
        priv let metadatas:{ String: S1ItemNFT.Metadata}
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        priv var garment: @S1GarmentNFT.NFT?
        
        // this is where the material nft is stored, it cannot be moved out
        priv var material: @S1MaterialNFT.NFT?
    ...
    pub resource Admin{ 
        ...
        pub fun createItemDataWithAllocation(garmentDataID: UInt32, materialDataID: UInt32, primaryColor: String, secondaryColor: String, metadatas:{ String: S1ItemNFT.Metadata}, coCreator: Address): UInt32{ 
