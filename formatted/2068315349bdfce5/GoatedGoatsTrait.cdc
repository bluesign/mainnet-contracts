...
pub contract GoatedGoatsTrait: NonFungibleToken{ 
    ...
    priv let idToTraitMetadata:{ UInt64: TraitMetadata}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: GoatedGoatsTrait.CollectionStoragePath, publicPath: GoatedGoatsTrait.CollectionPublicPath, providerPath: /private/GoatTraitCollection, publicCollection: Type<&GoatedGoatsTrait.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, GoatedGoatsTrait.TraitCollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&GoatedGoatsTrait.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, GoatedGoatsTrait.TraitCollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&GoatedGoatsTrait.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, GoatedGoatsTrait.TraitCollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-GoatedGoatsTrait.createEmptyCollection()
                        })
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    return MetadataViews.Royalties([MetadataViews.Royalty(recepient: royaltyReceiver, cut: 0.05, description: "This is the royalty receiver for traits")])
