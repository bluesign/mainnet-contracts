...
pub contract GoatedGoats: NonFungibleToken{ 
    ...
    priv let idToGoatMetadata:{ UInt64: GoatMetadata}
    
    priv let editionIDToGoatID:{ UInt64: UInt64}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: GoatedGoats.CollectionStoragePath, publicPath: GoatedGoats.CollectionPublicPath, providerPath: /private/GoatCollection, publicCollection: Type<&GoatedGoats.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, GoatedGoats.GoatCollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&GoatedGoats.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, GoatedGoats.GoatCollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&GoatedGoats.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, GoatedGoats.GoatCollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-GoatedGoats.createEmptyCollection()
                        })
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    return MetadataViews.Royalties([MetadataViews.Royalty(recepient: royaltyReceiver, cut: 0.05, description: "This is the royalty receiver for goats")])
            }
            return nil
        }
