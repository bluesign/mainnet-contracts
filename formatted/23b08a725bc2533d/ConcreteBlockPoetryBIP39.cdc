...
import
    ConcreteAlphabetsSimplifiedChinese
    from "./ConcreteAlphabetsSimplifiedChinese.cdc"

import
    ConcreteAlphabetsTraditionalChinese
    from "./ConcreteAlphabetsTraditionalChinese.cdc"
