...
pub contract SoulMadeMarketplace{ 
    ...
    pub event SoulMadeComponentForSale(
        id: UInt64,
        price: UFix64,
        address: Address
    )
    
    pub event SoulMadeForSale(
        id: UInt64,
        nftType: String,
        address: Address,
        saleData: SoulMadeSaleData
    )
    
    // Event that is emitted when the price of an NFT changes
    pub event SoulMadeMainPriceChanged(
        id: UInt64,
        newPrice: UFix64,
        address: Address
    )
    
    pub event SoulMadeComponentPriceChanged(
        id: UInt64,
        newPrice: UFix64,
        address: Address
    )
    ...
    pub event SoulMadeMainPurchased(
        id: UInt64,
        price: UFix64,
        from: Address,
        to: Address
    ...
    pub event SoulMadeComponentPurchased(
        id: UInt64,
        price: UFix64,
        from: Address,
        to: Address
    ...
    pub resource interface SalePublic{ 
        ...
        pub fun getSoulMadeComponent(tokenId: UInt64): &{
            SoulMadeComponent.ComponentPublic
        }{} 
    }
    ...
    pub fun getSoulMadeMainSale(
        address: Address,
        id: UInt64
    ): SoulMadeMainSaleData{ 
        let account = getAccount(address)
        let saleCollection =
            account.getCapability(self.CollectionPublicPath).borrow<
                &{SoulMadeMarketplace.SalePublic}
            >()!
    ...
    pub fun getSoulMadeComponentSale(
        address: Address,
        id: UInt64
    ): SoulMadeComponentSaleData{ 
        let account = getAccount(address)
        let saleCollection =
            account.getCapability(self.CollectionPublicPath).borrow<
                &{SoulMadeMarketplace.SalePublic}
    ...
    pub fun getSoulMadeComponentSales(address: Address): [
        SoulMadeComponentSaleData
    ]{ 
    ...
    pub fun convertSoulMadeMainSaleToSoulMadeSale(
        mainSale: SoulMadeMainSaleData
    ): SoulMadeSaleData{ 
    ...
    pub fun convertSoulMadeComponentSaleToSoulMadeSale(
    ...
    access(account) fun updatePlatformCut(platformCut: UFix64){ 
    ...
    pub init(){ 
        ...
        self.marketplaceWallet = self.account.getCapability<
                &FlowToken.Vault{FungibleToken.Receiver}
