...
pub contract Collectible: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun contentID(): String{ 
            return "bafybeieqfamgb2zalyjyl6cd6mhsi4caaheya2f3xylo2s3aimnr3gk75y"
        }
        ...
        pub fun original(): MetadataViews.IPFSFile{ 
            return MetadataViews.IPFSFile(cid: self.contentID(), path: self.data.itemId.toString().concat(".png"))
        }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: self.original(), mediaType: "image/png")])
