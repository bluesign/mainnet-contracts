...
pub contract Bakesale_NFT_V1: NonFungibleToken{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &Bakesale_NFT_V1.NFT?{ 
        let collection = getAccount(from).getCapability(Bakesale_NFT_V1.CollectionPublicPath).borrow<&{Bakesale_NFT_V1.Bakesale_NFT_V1CollectionPublic}>() ?? panic("Couldn't get collection")
