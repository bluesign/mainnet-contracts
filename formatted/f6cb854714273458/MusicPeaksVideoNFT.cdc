...
pub contract MusicPeaksVideoNFT: NonFungibleToken{ 
    ...
    priv let collectionByID: @{String: CollectionNode}
    
    priv let editionByID: @{String: EditionNode}
    
    priv let nodeByID: @{String: Node}
    
    priv let proofByID: @{String: ProofNode}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MusicPeaksVideoNFT.CollectionStoragePath, publicPath: MusicPeaksVideoNFT.CollectionPublicPath, providerPath: /private/MusicPeaksVideoCollection, publicCollection: Type<&MusicPeaksVideoNFT.Collection{MusicPeaksVideoNFT.MusicPeaksVideoNFTCollectionPublic}>(), publicLinkedType: Type<&MusicPeaksVideoNFT.Collection{MusicPeaksVideoNFT.MusicPeaksVideoNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MusicPeaksVideoNFT.Collection{MusicPeaksVideoNFT.MusicPeaksVideoNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, nodeID: String, canonicalNodeID: String, name: String, description: String, thumbnail: String, royalties: [MetadataViews.Royalty], nodeMetadata:{ String: AnyStruct}){ 
    ...
    init(){ 
        ...
        self.account.link<&MusicPeaksVideoNFT.Collection{NonFungibleToken.CollectionPublic, MusicPeaksVideoNFT.MusicPeaksVideoNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
