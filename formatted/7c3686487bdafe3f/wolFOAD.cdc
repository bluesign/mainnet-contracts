...
pub contract wolFOAD: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                wolFOAD.totalSupply = wolFOAD.totalSupply - self.balance
            }
        }
    }
