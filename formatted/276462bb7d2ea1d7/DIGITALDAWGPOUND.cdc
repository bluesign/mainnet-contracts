...
pub contract DIGITALDAWGPOUND: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                DIGITALDAWGPOUND.totalSupply = DIGITALDAWGPOUND.totalSupply - self.balance
            }
        }
    }
