...
pub contract Mindtrix: NonFungibleToken{ 
    ...
    priv var essenceDic: @{UInt64: Essence}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Mindtrix.CollectionStoragePath, publicPath: Mindtrix.CollectionPublicPath, providerPath: /private/MindtrixCollection, publicCollection: Type<&Mindtrix.Collection{Mindtrix.MindtrixCollectionPublic}>(), publicLinkedType: Type<&Mindtrix.Collection{Mindtrix.MindtrixCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Mindtrix.Collection{Mindtrix.MindtrixCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Essence: EssencePublic, MetadataViews.Resolver{ 
        ...
        pub fun getCurrentHolder(essenceId: UInt64): NFTIdentifier?{ 
            ...
            let collection = getAccount(identifier.holder).getCapability(Mindtrix.MindtrixEssenceCollectionPublicPath).borrow<&Collection{MindtrixCollectionPublic}>()
    ...
    init(){ 
        ...
        self.account.link<&Mindtrix.Collection{NonFungibleToken.CollectionPublic, Mindtrix.MindtrixCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
