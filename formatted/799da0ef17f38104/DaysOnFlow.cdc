...
pub contract DaysOnFlow: NonFungibleToken{ 
    ...
    pub resource DOFSeries: MetadataViews.Resolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: self.name, description: self.description, file: MetadataViews.IPFSFile(cid: self.smallImage, path: nil))
            }
            return nil
        }
        ...
        init(_wlClaimable: Bool, _publicClaimable: Bool, _description: String, _image: String, _smallImage: String, _name: String, _dayNFTwl: [UInt64], // List of DayNFT ids giving right to an item _wl: [Address], // List of WL addresses _wlPrice: UFix64, _publicSupply: UInt64, _publicPrice: UFix64, _metadata:{ String: AnyStruct}){ 
    ...
    pub resource SeriesMinter{ 
        ...
        // Create a new series
        pub fun createSeries(_wlClaimable: Bool, _publicClaimable: Bool, _description: String, _image: String, _smallImage: String, _name: String, _dayNFTwl: [UInt64], _wl: [Address], _wlPrice: UFix64, _publicSupply: UInt64, _publicPrice: UFix64, _metadata:{ String: AnyStruct}){ 
