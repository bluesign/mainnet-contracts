...
pub contract SakutaroPoem: NonFungibleToken{ 
    ...
    pub struct SakutaroPoemMetadataView{ 
        ...
        init(poemID: UInt32?, name: String?, description: String?, thumbnail: AnyStruct{MetadataViews.File}, svg: String?, svgBase64: String?, license: String, creator: String){ 
            self.poemID = poemID
            self.name = name
    ...
    init(){ 
        ...
        self.account.link<&SakutaroPoem.Collection{NonFungibleToken.CollectionPublic, SakutaroPoem.SakutaroPoemCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
