...
pub contract ProjectR: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ProjectR.CollectionStoragePath, publicPath: ProjectR.CollectionPublicPath, providerPath: /private/ProjectRCollection, publicCollection: Type<&ProjectR.Collection{ProjectR.CollectionPublic}>(), publicLinkedType: Type<&ProjectR.Collection{ProjectR.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ProjectR.Collection{ProjectR.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        pub fun mintNFT(nftId: UInt64, nftType: String, name: String, description: String, thumbnail: String, endpoint: String): @NFT{ 
