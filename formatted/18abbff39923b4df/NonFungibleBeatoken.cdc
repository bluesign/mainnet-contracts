...
pub contract NonFungibleBeatoken: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&NonFungibleBeatoken.Collection{BeatokenCollectionPublic, NonFungibleToken.CollectionPublic}>(self.publicReceiver, target: self.storageCollection)
