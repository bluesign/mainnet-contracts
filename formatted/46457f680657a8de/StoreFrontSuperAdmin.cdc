...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x46457f680657a8de
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x46457f680657a8de
