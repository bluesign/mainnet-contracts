...
pub contract ByteNextLaunchpad{ 
    ...
    pub resource Launchpad: LaunchpadPublic{ 
        ...
        priv var _launchpadCount: Int
        
        //Dictionary that stores launchpad information
        priv var _launchpads:{ Int: LaunchpadInfo}
        
        priv var _launchpadTokens: @{Int: FungibleToken.Vault}
        ...
        pub fun createNewLaunchpad(startTime: UFix64, endTime: UFix64, tokenPrice: UFix64, tokenType: Type, paymentType: Type, tokenReceiver: Capability<&{FungibleToken.Receiver}>, claimingTimes: [UFix64], claimingPercents: [UFix64], totalRaise: UFix64){ 
            pre{ 
                startTime < endTime:
    ...
    init(){ 
        ...
        self.account.link<&Launchpad{LaunchpadPublic}>(
            self.LaunchpadPublicPath,
            target: self.LaunchpadStoragePath
        )
    }
    
    pub event NewLauchpadCreated(
        id: Int,
        startTime: UFix64,
        endTime: UFix64,
        tokenType: Type,
    ...
    pub event UserAllocationSetted(
        id: Int,
        account: Address,
        allocation: UFix64
    )
