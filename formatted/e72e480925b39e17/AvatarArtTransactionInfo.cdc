...
pub contract AvatarArtTransactionInfo{ 
    ...
    pub resource TransactionAddress: PublicTransactionAddress{ 
        ...
        pub fun setAddress(tokenId: UInt64, payType: Type, storing: Capability<&{FungibleToken.Receiver}>?, insurance: Capability<&{FungibleToken.Receiver}>?, contractor: Capability<&{FungibleToken.Receiver}>?, platform: Capability<&{FungibleToken.Receiver}>?, author: Capability<&{FungibleToken.Receiver}>?){ 
            pre{ 
                tokenId > 0:
                    "tokenId parameter is zero"
            }
    ...
    init(){ 
        ...
        self
            .TransactionAddressStoragePath = /storage/avatarArtTransactionInfoRecepientAddress04
        self
            .TransactionAddressPublicPath = /public/avatarArtTransactionInfoRecepientAddress04
