...
pub contract SPIN: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&SPIN.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, SPIN.SPINCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
