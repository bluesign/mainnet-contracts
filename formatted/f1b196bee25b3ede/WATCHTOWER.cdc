...
pub contract WATCHTOWER: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&WATCHTOWER.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, WATCHTOWER.WATCHTOWERCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
