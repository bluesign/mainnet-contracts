...
pub contract ScopedFTProviders{ 
    ...
    pub struct AllowanceFilter: FTFilter{ 
        priv let allowance: UFix64
        
        priv var allowanceUsed: UFix64
    ...
    pub resource ScopedFTProvider:
        FungibleToken.Provider,
        ScopedFTProviderPublic{
    
        priv let provider: Capability<
            &{
                FungibleToken.Provider,
        ...
        pub fun withdraw(amount: UFix64): @FungibleToken.Vault{ 
            pre{ 
                self.expiration == nil || self.expiration! >= getCurrentBlock().timestamp:
