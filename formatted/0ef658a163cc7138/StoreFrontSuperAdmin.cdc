...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x0ef658a163cc7138
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x0ef658a163cc7138
