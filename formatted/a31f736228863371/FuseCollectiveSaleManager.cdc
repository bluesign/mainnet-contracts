...
pub contract FuseCollectiveSaleManager{ 
    ...
    pub resource Manager{ 
        ...
        pub fun updateFuseCollectiveCollectionMetadata(
            metadata:{ 
                String: String
            }
        ){ 
        ...
        pub fun updateFuseCollectiveEditionMetadata(
            editionNumber: UInt64,
            metadata:{ 
                String: String
            }
        ){ 
            FuseCollective.setEditionMetadata(
    ...
    priv fun mintSequential(): @NonFungibleToken.NFT{ 
    ...
    pub fun publicBatchMintSequential(
