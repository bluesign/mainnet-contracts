...
pub contract VivlioNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: VivlioNFT.CollectionStoragePath, publicPath: VivlioNFT.CollectionPublicPath, providerPath: /private/vivlioNFTCollection, publicCollection: Type<&VivlioNFT.Collection{VivlioNFT.VivlioNFTCollectionPublic}>(), publicLinkedType: Type<&VivlioNFT.Collection{VivlioNFT.VivlioNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&VivlioNFT.Collection{VivlioNFT.VivlioNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, thumbnail: String, royalties: [MetadataViews.Royalty], ipfsCid: String){ 
    ...
    init(){ 
        ...
        self.account.link<&VivlioNFT.Collection{NonFungibleToken.CollectionPublic, VivlioNFT.VivlioNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
