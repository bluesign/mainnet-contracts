...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x1dae9f6072946097
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x1dae9f6072946097
