...
pub contract FreshmintLockBox{ 
    ...
    pub resource interface LockBoxPublic{ 
        ...
        ///
        pub fun claim(id: UInt64, address: Address, signature: [UInt8]){} 
    ...
    pub resource LockBox: LockBoxPublic{ 
        ...
        ///
        priv let collection: Capability<&AnyResource{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>
        ...
        ///
        priv let receiverPath: PublicPath
        
        /// A map of public keys, indexed by NFT ID,
        /// used to verify claim signatures.
        ///
        priv let publicKeys:{ UInt64: [UInt8]}
        
        init(collection: Capability<&AnyResource{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>, receiverPath: PublicPath){ 
        ...
        pub fun claim(id: UInt64, address: Address, signature: [UInt8]){ 
            ...
            let receiver = getAccount(address).getCapability(self.receiverPath).borrow<&{NonFungibleToken.CollectionPublic}>()!
