...
pub contract LendingPool{ 
    ...
    pub resource PoolAdmin{ 
        ...
        pub fun setInterestRateModel(newInterestRateModelAddress: Address){ 
            ...
            LendingPool.accrueInterest()
            if newInterestRateModelAddress
            != LendingPool.interestRateModelAddress{ 
                let oldInterestRateModelAddress =
                    LendingPool.interestRateModelAddress
                LendingPool
                    .interestRateModelAddress = newInterestRateModelAddress
                LendingPool.interestRateModelCap = getAccount(
        ...
        pub fun setReserveFactor(newReserveFactor: UFix64){ 
            ...
            let oldReserveFactor =
                LendingConfig.ScaledUInt256ToUFix64(
                    LendingPool.scaledReserveFactor
                )
            LendingPool.scaledReserveFactor = LendingConfig
                    .UFix64ToScaledUInt256(newReserveFactor)
        ...
        pub fun setPoolSeizeShare(newPoolSeizeShare: UFix64){ 
            ...
            LendingPool.scaledPoolSeizeShare = LendingConfig
                    .UFix64ToScaledUInt256(newPoolSeizeShare)
        ...
        pub fun initializePool(
            ...
            LendingPool.scaledReserveFactor = LendingConfig
                    .UFix64ToScaledUInt256(reserveFactor)
            LendingPool.scaledPoolSeizeShare = LendingConfig
                    .UFix64ToScaledUInt256(poolSeizeShare)
            LendingPool.interestRateModelAddress = interestRateModelAddress
            LendingPool.interestRateModelCap = getAccount(
                    interestRateModelAddress
                ).getCapability<&{LendingInterfaces.InterestRateModelPublic}>(
                    LendingConfig.InterestRateModelPublicPath
                )
        }
        ...
        pub fun withdrawReserves(reduceAmount: UFix64): @FungibleToken.Vault{ 
            ...
            LendingPool.scaledTotalReserves = LendingPool.scaledTotalReserves
                - reduceAmountScaled
