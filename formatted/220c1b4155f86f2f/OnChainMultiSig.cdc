...
pub contract OnChainMultiSig{ 
    ...
    pub resource Manager: SignatureManager{ 
        ...
        priv let keyList:{ String: PubKeyAttr}
        
        // Map of {txIndex: PayloadDetails}
        priv let payloads: @{UInt64: PayloadDetails}
    ...
    pub fun createMultiSigManager(
        ...
        return <-create Manager(
            ...
            pubKeyAttrs: pubKeyAttrs
        )
    }
    
    pub fun createPayload(
        txIndex: UInt64,
        method: String,
        args: [
            AnyStruct
