...
pub contract FlowNFTDao: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                FlowNFTDao.totalSupply = FlowNFTDao.totalSupply - self.balance
            }
        }
    }
