...
pub contract Flex: NonFungibleToken{ 
    ...
    priv var nameData:{ String: String}
    ...
    pub resource interface FlexCollectionPublic{ 
        ...
        pub fun borrowFlex(id: UInt64): &Flex.NFT?{ 
    ...
    //
    pub resource Collection: FlexCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, description: String, name: String, image: String, projectID: String, projectName: String, attributes:{ String: String}, metadata:{ String: String}, royalties: [MetadataViews.Royalty]){ 
    ...
    //
    pub fun fetch(_ from: Address, itemID: UInt64): &Flex.NFT?{ 
        let collection = (getAccount(from).getCapability(Flex.CollectionPublicPath)!).borrow<&Flex.Collection{Flex.FlexCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&Flex.Collection{NonFungibleToken.CollectionPublic, Flex.FlexCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
