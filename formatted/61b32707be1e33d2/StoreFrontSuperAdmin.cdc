...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x61b32707be1e33d2
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x61b32707be1e33d2
