...
pub contract TwoSegmentsInterestRateModel{ 
    ...
    pub resource InterestRateModel: LendingInterfaces.InterestRateModelPublic{ 
        ...
        access(contract) fun setInterestRateModelParams(_ newBlocksPerYear: UInt256, _ newScaledZeroUtilInterestRatePerYear: UInt256, _ newScaledCriticalUtilInterestRatePerYear: UInt256, _ newScaledFullUtilInterestRatePerYear: UInt256, _ newScaledCriticalUtilPoint: UInt256){ 
            pre{ 
    ...
    init(){ 
        ...
        self.account.save(
            <-create Admin(),
            to: self.InterestRateModelAdminStoragePath
        )
    }
}
