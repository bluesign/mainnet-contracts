...
pub contract Foo: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: Foo.CollectionStoragePath, publicPath: Foo.CollectionPublicPath, providerPath: Foo.CollectionPrivatePath, publicCollection: Type<&Foo.Collection{Foo.FooCollectionPublic}>(), publicLinkedType: Type<&Foo.Collection{Foo.FooCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Foo.Collection{Foo.FooCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Admin{ 
        ...
        ///
        pub fun mintNFT(name: String, description: String, thumbnail: String, foo: String, bar: Int): @Foo.NFT{ 
