...
pub contract ChainIDEShieldNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ChainIDEShieldNFT.CollectionStoragePath, publicPath: ChainIDEShieldNFT.CollectionPublicPath, providerPath: /private/ChainIDEShieldNFTCollection, publicCollection: Type<&ChainIDEShieldNFT.Collection{ChainIDEShieldNFT.ChainIDEShieldNFTCollectionPublic}>(), publicLinkedType: Type<&ChainIDEShieldNFT.Collection{ChainIDEShieldNFT.ChainIDEShieldNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ChainIDEShieldNFT.Collection{ChainIDEShieldNFT.ChainIDEShieldNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        ///
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, type: String){ 
            pre{ 
    ...
    init(_maxSupply: UInt64){ 
        ...
        self.account.link<&ChainIDEShieldNFT.Collection{NonFungibleToken.CollectionPublic, ChainIDEShieldNFT.ChainIDEShieldNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
