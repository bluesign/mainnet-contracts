...
pub contract NFluenceAuction{ 
    ...
    pub struct AuctionData{ 
        ...
        // NFT metadata
        priv let nftData: NFluence.NFluenceNFTData?
    ...
    pub resource AuctionItem: AuctionPublic{ 
        ...
        priv var recipientCollectionCap: Capability<&{NFluence.NFluenceCollectionPublic}>
        ...
        priv let ownerCollectionCap: Capability<&NFluence.Collection>
    ...
    pub resource interface StorefrontPublic{ 
        ...
        pub fun borrowListing(listingResourceID: UInt64): &AuctionItem{
            AuctionPublic
        }?{} 
    }
    
    pub resource Storefront: StorefrontPublic{ 
        priv var listings: @{UInt64: AuctionItem}
        
        pub fun createAuction(token: UInt64, minimumBidIncrement: Int32, auctionLength: UFix64, auctionStartTime: UFix64, startPrice: UFix64, collectionCap: Capability<&NFluence.Collection>, vaultCap: Capability<&{FungibleToken.Receiver}>){ 
    ...
    pub resource Administrator{ 
        priv fun updateCutPercentage(newPercentage: UFix64){ 
            pre{ 
                newPercentage > 1.0:
        ...
        priv fun retrieveCutVault(): @FungibleToken.Vault{ 
    ...
    init(){ 
        self
            .NFluenceAuctionStorefrontStoragePath = /storage/NFluenceAuctionStorefrontStorage
        self
            .NFluenceAuctionStorefrontPublicPath = /public/NFluenceAuctionStorefrontPublic
