...
pub contract Avataaars: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    let cut = MetadataViews.Royalty(receiver: Avataaars.account.getCapability<&{FungibleToken.Receiver}>(/public/somePath), cut: 0.025, // 2.5% royalty description: "Creator Royalty")
    ...
    pub resource interface MinterPublic{ 
        pub fun mintNFT(recipient: &Avataaars.Collection){} 
    }
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            case Type<MetadataViews.NFTCollectionData>():
                return MetadataViews.NFTCollectionData(storagePath: Avataaars.CollectionStoragePath, publicPath: Avataaars.CollectionPublicPath, providerPath: Avataaars.CollectionProviderPath, publicCollection: Type<&Avataaars.Collection{Avataaars.AvataaarsCollectionPublic}>(), publicLinkedType: Type<&Avataaars.Collection{Avataaars.AvataaarsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Avataaars.Collection{Avataaars.AvataaarsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&Avataaars.Collection{NonFungibleToken.CollectionPublic, Avataaars.AvataaarsCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
