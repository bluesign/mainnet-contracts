...
pub contract ShebaHopeGrows: NonFungibleToken{ 
    ...
    pub struct ItemData{ 
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes:{ String: String}, rarity: String){ 
            self.merchantID = ShebaHopeGrows.merchantID
            self.name = name
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes:{ String: String}, rarity: String){ 
            ShebaHopeGrows                          // Increment the global Item IDs
                          .totalSupply = ShebaHopeGrows.totalSupply + 1 as UInt64
            self.id = ShebaHopeGrows.totalSupply
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    let royaltiesDictionary = ShebaHopeGrows.royaltiesForSpecificPFP[self.id] ?? ShebaHopeGrows.defaultRoyalties
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ShebaHopeGrows.CollectionStoragePath, publicPath: ShebaHopeGrows.CollectionPublicPath, providerPath: /private/ShebaHopeGrowsCollection, publicCollection: Type<&ShebaHopeGrows.Collection{ShebaHopeGrows.ShebaHopeGrowsCollectionPublic}>(), publicLinkedType: Type<&ShebaHopeGrows.Collection{ShebaHopeGrowsCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ShebaHopeGrows.Collection{ShebaHopeGrowsCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-ShebaHopeGrows.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let data = self.getData()
                    let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: data.thumbnail), mediaType: data.thumbnailMimeType)
                    return MetadataViews.NFTCollectionDisplay(name: "ShebaHopeGrows", description: ShebaHopeGrows.Description, externalURL: ShebaHopeGrows.ExternalURL, squareImage: ShebaHopeGrows.SquareImage, bannerImage: ShebaHopeGrows.BannerImage, socials: ShebaHopeGrows.Socials)
    ...
    pub resource Mutator{ 
        ...
        pub fun mutatePFP(tokenID: UInt64, name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes:{ String: String}, rarity: String){ 
            ...
            if ShebaHopeGrows.lockedMutators[self.id] != true{ 
                ...
                ShebaHopeGrows.mutations[tokenID] = mutation
    ...
    pub resource Admin{ 
        ...
        pub fun createNewAdmin(): @Admin{ 
            ...
            ShebaHopeGrows.nextAdminID = ShebaHopeGrows.nextAdminID + 1 as UInt32
        ...
        pub fun createNewMutator(): @Mutator{ 
            ...
            // Increment the ID so that it isn't used again
            ShebaHopeGrows.nextMutatorID = ShebaHopeGrows.nextMutatorID + 1 as UInt32
        ...
        pub fun addDefaultRoyalty(name: String, royalty: MetadataViews.Royalty, rate: UFix64){ 
            ...
            ShebaHopeGrows.defaultRoyalties[name] = royalty
        ...
        pub fun changeDefaultRoyaltyRate(name: String, rate: UFix64){ 
            ...
            let royalty = ShebaHopeGrows.defaultRoyalties[name]!
            let previousRate = royalty.cut
            let previousRecipientAddress = royalty.receiver
            ShebaHopeGrows.defaultRoyalties[name] = MetadataViews.Royalty(recipientAddress: previousRecipientAddress, cut: UFix64(rate), description: "ShebaHopeGrows Royalties")
        ...
        pub fun removeDefaultRoyalty(name: String){ 
            ...
            ShebaHopeGrows.defaultRoyalties.remove(key: name)
        ...
        pub fun addRoyaltyForPFP(tokenID: UInt64, name: String, royalty: MetadataViews.Royalty, rate: UFix64){ 
            ...
            if ShebaHopeGrows.royaltiesForSpecificPFP.containsKey(tokenID) == false{ 
                let newEntry:{ String: MetadataViews.Royalty} ={} 
                newEntry.insert(key: name, royalty)
                (ShebaHopeGrows.royaltiesForSpecificPFP!).insert(key: tokenID, newEntry)
                emit RoyaltyForPFPAdded(tokenID: tokenID, name: name, rate: rate)
                return
            }
            
            // the TokenID already has an entry
            if (ShebaHopeGrows.royaltiesForSpecificPFP[tokenID]!).containsKey(name){ 
                // the entry already exists
                panic("The royalty with that name already exists")
            }
            (ShebaHopeGrows.royaltiesForSpecificPFP[tokenID]!).insert(key: name, royalty)
            emit RoyaltyForPFPAdded(tokenID: tokenID, name: name, rate: rate)
        }
        ...
        pub fun changeRoyaltyRateForPFP(tokenID: UInt64, name: String, rate: UFix64){ 
            ...
            let previousRoyalty: MetadataViews.Royalty = (ShebaHopeGrows.royaltiesForSpecificPFP[tokenID]!)[name]!
            let newRoyalty = MetadataViews.Royalty(recipientAddress: previousRoyalty.receiver, cut: UFix64(rate), description: "ShebaHopeGrows Royalties")
            (ShebaHopeGrows.royaltiesForSpecificPFP[tokenID]!).insert(key: name, newRoyalty)
    ...
    pub resource interface ShebaHopeGrowsCollectionPublic{ 
        ...
        pub fun borrowShebaHopeGrows(id: UInt64): &ShebaHopeGrows.NFT?{ 
    ...
    //
    pub resource Collection: ShebaHopeGrowsCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            ...
            let token <- token as! @ShebaHopeGrows.NFT
        ...
        // not any MintPFPs specific data. Please use borrowShebaHopeGrowss to 
        // read MintPFPs data.
        //
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT{ 
        ...
        // borrowShebaHopeGrows returns a borrowed reference to a MintPFPs
        ...
        pub fun borrowShebaHopeGrows(id: UInt64): &ShebaHopeGrows.NFT?{ 
            if self.ownedNFTs[id] != nil{ 
                ...
                return ref as! &ShebaHopeGrows.NFT
            } else{ 
                return nil
            }
        }
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            let ShebaHopeGrowsNFT = nft as! &ShebaHopeGrows.NFT
            return ShebaHopeGrowsNFT as &AnyResource{MetadataViews.Resolver}
        }
    ...
    pub fun createEmptyMintPFPsCollection(): @ShebaHopeGrows.Collection{ 
        return <-create ShebaHopeGrows.Collection()
    }
    ...
    init(){ 
        ...
        self.lockedMutators ={} 
        self.ExternalURL = MetadataViews.ExternalURL("https://www.shebahopegrows.com/")
        self.Socials ={} 
        self.Description = ""
        self.SquareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://dkuxa1i6sgo8h.cloudfront.net/sheba/Shebabanner.png"), mediaType: "image/png")
        self.BannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://dkuxa1i6sgo8h.cloudfront.net/sheba/Shebabanner.png"), mediaType: "image/png")
        self.CollectionStoragePath = /storage/ShebaHopeGrowsCollection
        self.CollectionPublicPath = /public/ShebaHopeGrowsCollection
        self.AdminStoragePath = /storage/ShebaHopeGrowsAdmin
        self.MutatorStoragePath = /storage/ShebaHopeGrowsMutator
        
        // Put a new Collection in storage
        self.account.save<@Collection>(<-create Collection(), to: self.CollectionStoragePath)
        
        // Create a public capability for the Collection
        self.account.link<&{ShebaHopeGrowsCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
