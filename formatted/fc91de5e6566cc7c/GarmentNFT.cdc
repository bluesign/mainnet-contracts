...
pub contract GarmentNFT: NonFungibleToken{ 
    ...
    //
    pub resource Admin{ 
        pub fun createGarmentData(mainImage: String, images: [String], name: String, artist: String, description: String): UInt32{ 
