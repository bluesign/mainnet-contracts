...
pub contract FBRC: FungibleToken{ 
    ...
    init(){ 
        ...
        //
        self.account.link<&FBRC.Vault{FungibleToken.Receiver}>(self.CollectionReceiverPath, target: self.CollectionStoragePath)
        
        // Create a public capability to the stored Vault that only exposes
        // the `balance` field through the `Balance` interface
        //
        self.account.link<&FBRC.Vault{FungibleToken.Balance}>(self.CollectionBalancePath, target: self.CollectionStoragePath)
