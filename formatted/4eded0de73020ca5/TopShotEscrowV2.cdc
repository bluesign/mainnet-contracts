...
pub contract TopShotEscrowV2{ 
    ...
    pub resource EscrowItem: EscrowItemPublic{ 
        ...
        priv let receiverCap: Capability<&{NonFungibleToken.Receiver}>
        ...
        init(_NFTCollection: @TopShot.Collection, _duration: UFix64, _receiverCap: Capability<&{NonFungibleToken.Receiver}>){ 
            ...
            self.redeemed = false
            self.lock = false
            let adminTopShotReceiverRef = TopShotEscrowV2.account.getCapability(/public/MomentCollection).borrow<&{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, TopShot.MomentCollectionPublic}>() ?? panic("Cannot borrow collection")
        ...
        pub fun redeem(NFTIds: [UInt64]){ 
            ...
            let providerTopShotProviderRef: &TopShot.Collection? = TopShotEscrowV2.account.borrow<&TopShot.Collection>(from: /storage/MomentCollection) ?? panic("Cannot borrow collection")
    ...
    pub resource EscrowCollection: EscrowCollectionPublic{ 
        ...
        pub fun withdraw(escrowID: UInt64): @TopShotEscrowV2.EscrowItem{ 
        ...
        pub fun createEscrow(NFTCollection: @TopShot.Collection, duration: UFix64, receiverCap: Capability<&{NonFungibleToken.Receiver}>){ 
    ...
    pub fun createEscrow(
        ...
        let escrowCollectionRef =
            self.account.borrow<&TopShotEscrowV2.EscrowCollection>(
    ...
    pub fun batchRedeem(_ escrowIDs: [UInt64]){ 
        for escrowID in escrowIDs{ 
            let escrowCollectionRef = self.account.borrow<&TopShotEscrowV2.EscrowCollection>(from: self.escrowStoragePath) ?? panic("Couldn't borrow escrow collection")
            let escrowRef = escrowCollectionRef.borrowEscrow(escrowID: escrowID)!
    ...
    init(){ 
        ...
        self.account.link<
            &TopShotEscrowV2.EscrowCollection{
                TopShotEscrowV2.EscrowCollectionPublic
            }
