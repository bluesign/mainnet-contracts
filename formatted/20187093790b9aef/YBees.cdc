        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: YBees.CollectionStoragePath, publicPath: YBees.CollectionPublicPath, providerPath: /private/YBeesCollection, publicCollection: Type<&YBees.Collection{YBees.YBeesCollectionPublic}>(), publicLinkedType: Type<&YBees.Collection{YBeesCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&YBees.Collection{YBeesCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
