        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    var thumbnail: AnyStruct{MetadataViews.File} = MetadataViews.HTTPFile(url: self.data.thumbnail)
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: LOSTiNTurismo.CollectionStoragePath, publicPath: LOSTiNTurismo.CollectionPublicPath, providerPath: /private/LOSTiNTurismoCollection, publicCollection: Type<&LOSTiNTurismo.Collection{LOSTiNTurismo.LOSTiNTurismoCollectionPublic}>(), publicLinkedType: Type<&LOSTiNTurismo.Collection{LOSTiNTurismoCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&LOSTiNTurismo.Collection{LOSTiNTurismoCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
