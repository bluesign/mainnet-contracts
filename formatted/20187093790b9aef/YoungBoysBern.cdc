...
pub contract YoungBoysBern: NonFungibleToken{ 
    ...
    // -----------------------------------------------------------------------
    // YoungBoysBern contract-level fields.
    ...
    // -----------------------------------------------------------------------
    // YoungBoysBern contract-level Composite Type definitions
    // -----------------------------------------------------------------------
    ...
    pub struct EditionData{ 
        ...
        init(editionID: UInt32){ 
            if YoungBoysBern.editions[editionID] == nil{ 
                panic("the editionID was not found")
            }
            let editionToRead = (&YoungBoysBern.editions[editionID] as &Edition?)!
    ...
    pub resource Edition{ 
        ...
        init(merchantID: UInt32, metadata:{ String: String}, name: String, printingLimit: UInt32?){ 
            ...
            self.editionID = YoungBoysBern.nextEditionID
            ...
            YoungBoysBern.nextEditionID = YoungBoysBern.nextEditionID + 1 as UInt32
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(merchantID: UInt32, editionID: UInt32, editionNumber: UInt32){ 
            ...
            YoungBoysBern.totalSupply = YoungBoysBern.totalSupply + 1 as UInt64
            self.id = YoungBoysBern.totalSupply
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL("https://www.bscyb.ch/")
                case Type<MetadataViews.Royalties>():
                    let royaltiesDictionary = YoungBoysBern.royaltiesForSpecificEdition[self.data.editionID] ?? YoungBoysBern.defaultRoyalties
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let mediaSquare = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://dkuxa1i6sgo8h.cloudfront.net/BSC-Young-Boys/BSC_Young_Boys_logo.png"), mediaType: "image/png")
                    let mediaBanner = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://dkuxa1i6sgo8h.cloudfront.net/BSC-Young-Boys/BSC_Young_Boys_logo.png"), mediaType: "image/png")
                    let url = "https://www.bscyb.ch/"
                    let description = ""
                    return MetadataViews.NFTCollectionDisplay(name: "YoungBoysBern", description: description, externalURL: MetadataViews.ExternalURL(url), squareImage: mediaSquare, bannerImage: mediaBanner, socials:{} )
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: YoungBoysBern.CollectionStoragePath, publicPath: YoungBoysBern.CollectionPublicPath, providerPath: /private/YoungBoysBernCollection, publicCollection: Type<&YoungBoysBern.Collection{YoungBoysBern.YoungBoysBernCollectionPublic}>(), publicLinkedType: Type<&YoungBoysBern.Collection{YoungBoysBernCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&YoungBoysBern.Collection{YoungBoysBernCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-YoungBoysBern.createEmptyCollection()
                        })
    ...
    pub resource Admin{ 
        ...
        pub fun createEdition(merchantID: UInt32, metadata:{ String: String}, name: String, printingLimit: UInt32?){ 
            ...
            YoungBoysBern.editions[newID] <-! newEdition
        }
        
        // borrowEdition returns a reference to an edition in the YoungBoysBern
        ...
        pub fun borrowEdition(editionID: UInt32): &Edition{ 
            ...
            return (&YoungBoysBern.editions[editionID] as &Edition?)!
        }
        
        // updateEditionMetadata returns a reference to an edition in the YoungBoysBern
        // contract so that the admin can call methods on it
        //
        // Parameters: 
        ...
        pub fun updateEditionMetadata(editionID: UInt32, updates:{ String: String}, suffix: String): UInt32{ 
            ...
            let editionRef = &YoungBoysBern.editions[editionID] as &Edition?
        ...
        pub fun setDefaultRoyaltyByName(name: String, royalty: MetadataViews.Royalty){ 
            ...
            // verify total
            let totalCut = YoungBoysBern.getDefaultRoyaltyTotalRate()
        ...
        pub fun removeDefaultRoyaltyByName(name: String){ 
            ...
            YoungBoysBern.defaultRoyalties.remove(key: name)
        ...
        pub fun setEditionRoyaltyByName(editionID: UInt32, name: String, royalty: MetadataViews.Royalty){ 
            ...
            (             //let royaltiesForSpecificEdition = YoungBoysBern.royaltiesForSpecificEdition[editionID]!
             //royaltiesForSpecificEdition.insert(key: name, royalty);
             YoungBoysBern.royaltiesForSpecificEdition[editionID]!).insert(key: name, royalty)
            let totalCut = YoungBoysBern.getEditionRoyaltyTotalRate(editionID: editionID)
            assert(totalCut <= 1.0, message: "Sum of cutInfos multipliers should not be greater than 1.0")
        ...
        pub fun removeEditionRoyaltyByName(editionID: UInt32, name: String){ 
            ...
            (YoungBoysBern.royaltiesForSpecificEdition[editionID]!).remove(key: name)
        ...
        pub fun revertRoyaltiesForEditionToDefault(editionID: UInt32){ 
            ...
            YoungBoysBern.royaltiesForSpecificEdition.remove(key: editionID)
        ...
        pub fun createNewAdmin(): @Admin{ 
            ...
            // Increment the ID so that it isn't used again
            YoungBoysBern.nextAdminID = YoungBoysBern.nextAdminID + 1 as UInt32
            return <-create Admin(id: newID)
        }
    }
    
    // This is the interface that users can cast their YoungBoysBern Collection as
    // to allow others to deposit YoungBoysBerns into their Collection. It also allows for reading
    // the IDs of YoungBoysBerns in the Collection.
    pub resource interface YoungBoysBernCollectionPublic{ 
        ...
        pub fun borrowYoungBoysBern(id: UInt64): &YoungBoysBern.NFT?{ 
            // If the result isn't nil, the id of the returned reference
            // should be the same as the argument to the function
            post{ 
                result == nil || result?.id == id:
                    "Cannot borrow YoungBoysBern reference: The ID of the returned reference is incorrect"
            }
        }
    }
    ...
    //
    pub resource Collection: YoungBoysBernCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        // Dictionary of YoungBoysBern conforming tokens
        // NFT is a resource type with a UInt64 ID field
        pub var ownedNFTs: @{UInt64: NonFungibleToken.NFT}
        
        // pub var ownedNFTs: @{UInt64: YoungBoysBern.NFT}
        
        init(){ 
            self.ownedNFTs <-{} 
        }
        
        // withdraw removes a YoungBoysBern from the Collection and moves it to the caller
        //
        ...
        pub fun withdraw(withdrawID: UInt64): @NonFungibleToken.NFT{ 
            ...
            let token <- self.ownedNFTs.remove(key: withdrawID) ?? panic("Cannot withdraw: YoungBoysBern does not exist in the collection")
        ...
        // deposit takes a YoungBoysBern and adds it to the Collections dictionary
        //
        ...
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            ...
            let token <- token as! @YoungBoysBern.NFT
        ...
        // borrowNFT Returns a borrowed reference to a YoungBoysBern in the Collection
        ...
        // not any YoungBoysBern specific data. Please use borrowYoungBoysBern to 
        // read YoungBoysBern data.
        //
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT{ 
            return (&self.ownedNFTs[id] as &NonFungibleToken.NFT?)!
        }
        
        // borrowYoungBoysBern returns a borrowed reference to a YoungBoysBern
        ...
        pub fun borrowYoungBoysBern(id: UInt64): &YoungBoysBern.NFT?{ 
            if self.ownedNFTs[id] != nil{ 
                ...
                return ref as! &YoungBoysBern.NFT
            } else{ 
                return nil
            }
        }
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            let YoungBoysBernNFT = nft as! &YoungBoysBern.NFT
            return YoungBoysBernNFT as &AnyResource{MetadataViews.Resolver}
        }
    ...
    // -----------------------------------------------------------------------
    // YoungBoysBern contract-level function definitions
    // -----------------------------------------------------------------------
    
    // createEmptyCollection creates a new, empty Collection object so that
    // a user can store it in their account storage.
    // Once they have a Collection in their storage, they are able to receive
    // YoungBoysBerns in transactions.
    //
    pub fun createEmptyCollection(): @NonFungibleToken.Collection{ 
        return <-create YoungBoysBern.Collection()
    }
    
    pub fun createEmptyYoungBoysBernCollection(): @YoungBoysBern.Collection{ 
        return <-create YoungBoysBern.Collection()
    }
    ...
    init(){ 
        ...
        self.CollectionStoragePath = /storage/YoungBoysBernCollection
        self.CollectionPublicPath = /public/YoungBoysBernCollection
        self.AdminStoragePath = /storage/YoungBoysBernItemAdmin
        
        // Put a new Collection in storage
        self.account.save<@Collection>(<-create Collection(), to: self.CollectionStoragePath)
        
        // Create a public capability for the Collection
        self.account.link<&{YoungBoysBernCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
