...
pub contract MintStoreItem: NonFungibleToken{ 
    ...
    priv var merchants:{ UInt32: String}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MintStoreItem.CollectionStoragePath, publicPath: MintStoreItem.CollectionPublicPath, providerPath: /private/MintStoreItemCollection, publicCollection: Type<&MintStoreItem.Collection{MintStoreItem.MintStoreItemCollectionPublic}>(), publicLinkedType: Type<&MintStoreItem.Collection{MintStoreItemCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MintStoreItem.Collection{MintStoreItemCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
