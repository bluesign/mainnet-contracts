        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Lufthaus.CollectionStoragePath, publicPath: Lufthaus.CollectionPublicPath, providerPath: /private/LufthausCollection, publicCollection: Type<&Lufthaus.Collection{Lufthaus.LufthausCollectionPublic}>(), publicLinkedType: Type<&Lufthaus.Collection{LufthausCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Lufthaus.Collection{LufthausCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
