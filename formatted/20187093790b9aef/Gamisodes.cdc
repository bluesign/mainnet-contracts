...
pub contract Gamisodes: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Gamisodes.CollectionStoragePath, publicPath: Gamisodes.CollectionPublicPath, providerPath: /private/GamisodesCollection, publicCollection: Type<&Gamisodes.Collection{Gamisodes.GamisodesCollectionPublic}>(), publicLinkedType: Type<&Gamisodes.Collection{GamisodesCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Gamisodes.Collection{GamisodesCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource interface GamisodesCollectionPublic{ 
        ...
        pub fun borrowGamisodes(id: UInt64): &Gamisodes.NFT?{ 
    ...
    //
    pub resource Collection: GamisodesCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            return GamisodesNFT as &AnyResource{MetadataViews.Resolver}
        }
    ...
    pub fun createEmptyGamisodesCollection(): @Gamisodes.Collection{ 
        return <-create Gamisodes.Collection()
    }
    ...
    init(){ 
        ...
        self.account.link<&{GamisodesCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
