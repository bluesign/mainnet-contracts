        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Pickem.CollectionStoragePath, publicPath: Pickem.CollectionPublicPath, providerPath: /private/PickemCollection, publicCollection: Type<&Pickem.Collection{Pickem.PickemCollectionPublic}>(), publicLinkedType: Type<&Pickem.Collection{PickemCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Pickem.Collection{PickemCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
