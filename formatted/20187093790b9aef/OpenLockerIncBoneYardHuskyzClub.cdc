        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: OpenLockerIncBoneYardHuskyzClub.CollectionStoragePath, publicPath: OpenLockerIncBoneYardHuskyzClub.CollectionPublicPath, providerPath: /private/OpenLockerIncBoneYardHuskyzClubCollection, publicCollection: Type<&OpenLockerIncBoneYardHuskyzClub.Collection{OpenLockerIncBoneYardHuskyzClub.OpenLockerIncBoneYardHuskyzClubCollectionPublic}>(), publicLinkedType: Type<&OpenLockerIncBoneYardHuskyzClub.Collection{OpenLockerIncBoneYardHuskyzClubCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&OpenLockerIncBoneYardHuskyzClub.Collection{OpenLockerIncBoneYardHuskyzClubCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
