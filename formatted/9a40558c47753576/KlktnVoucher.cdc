...
pub contract KlktnVoucher: NonFungibleToken{ 
    ...
    priv var KlktnVoucherTemplates:{ UInt64: KlktnVoucherTemplate}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(url: "http://www.mangakollektion.xyz/")
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: KlktnVoucher.CollectionStoragePath, publicPath: KlktnVoucher.CollectionPublicPath, providerPath: /private/KlktnVoucherPrivateProvider, publicCollection: Type<&KlktnVoucher.Collection{NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&KlktnVoucher.Collection{NonFungibleToken.CollectionPublic, KlktnVoucher.KlktnVoucherCollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&KlktnVoucher.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
