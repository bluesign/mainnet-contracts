...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xbc0b1ae1f2d2ae1f
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xbc0b1ae1f2d2ae1f
