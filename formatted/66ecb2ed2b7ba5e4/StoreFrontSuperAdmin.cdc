...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x66ecb2ed2b7ba5e4
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x66ecb2ed2b7ba5e4
