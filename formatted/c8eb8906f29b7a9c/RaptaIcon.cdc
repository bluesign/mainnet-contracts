        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: RaptaIcon.CollectionStoragePath, publicPath: RaptaIcon.CollectionPublicPath, providerPath: /private/RaptaCollection, publicCollection: Type<&RaptaIcon.Collection{RaptaIcon.CollectionPublic}>(), publicLinkedType: Type<&RaptaIcon.Collection{RaptaIcon.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&RaptaIcon.Collection{RaptaIcon.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
