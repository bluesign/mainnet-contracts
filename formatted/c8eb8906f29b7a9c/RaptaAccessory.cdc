...
pub contract RaptaAccessory: NonFungibleToken{ 
    ...
    priv let totalMintedAccessories:{ UInt64: UInt64}
    ...
    pub struct TemplateData{ 
        ...
        init(id: UInt64, name: String, description: String, category: String, png: String, layer: String, mintLimit: UInt64){ 
            self.id = id
            self.name = name
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: RaptaAccessory.CollectionStoragePath, publicPath: RaptaAccessory.CollectionPublicPath, providerPath: /private/RaptaAccessory, publicCollection: Type<&RaptaAccessory.Collection{NonFungibleToken.CollectionPublic, RaptaAccessory.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&RaptaAccessory.Collection{NonFungibleToken.CollectionPublic, RaptaAccessory.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&RaptaAccessory.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, RaptaAccessory.CollectionPublic}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
    ...
    access(contract) fun starterTemplate(name: String, description: String, category: String, mintLimit: UInt64, png: String, layer: String): @RaptaAccessory.Template{ 
    ...
    access(account) fun createAccessoryTemplate(name: String, description: String, category: String, mintLimit: UInt64, png: String, layer: String){ 
        var newTemplate <- create Template(name: name, description: description, category: category, mintLimit: mintLimit, png: png, layer: layer)
        emit TemplateCreated(id: newTemplate.id, name: newTemplate.name, category: newTemplate.category, mintLimit: newTemplate.mintLimit)
        RaptaAccessory.setTotalMintedAccessoriesByTemplate(id: newTemplate.id, value: 0)
