...
pub contract RedSquirrelNFT: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&RedSquirrelNFT.Collection{NonFungibleToken.CollectionPublic, RedSquirrelNFT.RedSquirrelNFTCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
