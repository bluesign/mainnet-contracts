...
pub contract SecondaryMarketplace{ 
    ...
    pub resource TokenSaleCollection: TokenSale{ 
        priv var collection: Capability<&NonFungibleToken.Collection>
        
        priv var items:{ UInt64: ItemMeta}
        
        priv var ownerCapability: Capability<&{FungibleToken.Receiver}>
        
        priv var royaltyCapability: Capability<&{FungibleToken.Receiver}>
        
        priv var beneficiaryCapability: Capability<&{FungibleToken.Receiver}>
        
        priv var storeFrontCapability: Capability<&StoreFrontSuperAdmin.SuperAdmin{StoreFrontSuperAdmin.ISuperAdminStoreFrontPublic}>
    ...
    pub fun createTokenSaleCollection(
