...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x77450c1dbfcf3deb
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x77450c1dbfcf3deb
