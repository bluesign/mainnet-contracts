        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FridgeMagnetV1.CollectionStoragePath, publicPath: FridgeMagnetV1.CollectionPublicPath, providerPath: /private/CollectionPrivatePath, publicCollection: Type<&Collection{NFTCollectionPublic}>(), publicLinkedType: Type<&Collection{NFTCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{NFTCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
