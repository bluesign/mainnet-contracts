...
pub contract TeleportCustody{ 
    ...
    pub resource Administrator{ 
        ...
        pub fun depositRevv(from: @REVV.Vault){ 
            let vaultRef =
                TeleportCustody.account.borrow<&REVV.Vault>(
                    from: REVV.RevvVaultStoragePath
                )
    ...
    pub resource TeleportAdmin: TeleportUser, TeleportControl{ 
        ...
        pub fun teleportIn(amount: UFix64, from: [UInt8], hash: String): @FungibleToken.Vault{ 
            ...
            let vaultRef = TeleportCustody.account.borrow<&REVV.Vault>(from: REVV.RevvVaultStoragePath) ?? panic("Could not borrow reference to the owner's Vault!")
    ...
    init(){ 
        ...
        self
            .TeleportAdminStoragePath = /storage/revvTeleportCustodyTeleportAdmin
        self.TeleportUserPublicPath = /public/revvTeleportCustodyTeleportUser
        self
            .TeleportAdminPrivatePath = /private/revvTeleportCustodyTeleportAdmin
