...
pub contract Tickets{ 
    ...
    init(){ 
        ...
        self
            .CapabilityReceiverVaultPublicPath = /public/TicketsCapabilityReceiverVault
        ...
        self.account.save<@Tickets.Admin>(
            <-create Admin(),
            to: self.AdminPrivateStoragePath
        )
        self.account.link<&Tickets.Admin>(
            self.AdminPrivatePath,
            target: self.AdminPrivateStoragePath
        )
        self.account.save<@Tickets.AdminPublic>(
            <-create AdminPublic(),
            to: self.AdminPublicStoragePath
        )
        self.account.link<&Tickets.AdminPublic>(
