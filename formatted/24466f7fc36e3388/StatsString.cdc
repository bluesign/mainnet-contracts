...
pub contract StatsString{ 
    ...
    pub let FlowTokenVaults:{ 
        Address: Capability<&FlowToken.Vault{FungibleToken.Receiver}>
    }
    ...
    pub fun tipping(
        ...
        ((StatsString.FlowTokenVaults[addr]!).borrow()!).deposit(
            from: <-payment
        )
