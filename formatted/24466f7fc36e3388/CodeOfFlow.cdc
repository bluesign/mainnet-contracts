...
pub contract CodeOfFlow{ 
    ...
    pub let PlayerFlowTokenVault:{ 
        UInt: Capability<&FlowToken.Vault{FungibleToken.Receiver}>
    }
    ...
    pub resource Admin{ 
        ...
        pub fun matching_start(player_id: UInt){ 
            ...
            let blockCreatedAt =
                getCurrentBlock().timestamp.toString().slice(from: 0, upTo: 10)
            ...
            if let playerMatchingInfo =
                CodeOfFlow.playerMatchingInfo[player_id]{ 
        ...
        pub fun attack(
            ...
            if (CodeOfFlow.battleInfo[player_id]!).your_field_unit[attack_unit]
            == nil{ 
    ...
    pub fun createPlayer(
        nickname: String,
        flow_vault_receiver: Capability<
    ...
    init(){ 
        self.FlowTokenVault = self.account.getCapability<
                &FlowToken.Vault{FungibleToken.Receiver}
