...
pub contract SomePlaceCollectible: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        init(setID: UInt64, editionNumber: UInt64){ 
            pre{ 
                !SomePlaceCollectible.collectibleData.containsKey(setID) || !(SomePlaceCollectible.collectibleData[setID]!).containsKey(editionNumber):
