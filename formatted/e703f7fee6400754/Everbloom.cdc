...
pub contract Everbloom: NonFungibleToken{ 
    ...
    pub event PrintNFTMinted(nftID: UInt64, editionID: UInt32, artworkID: UInt32, galleryID: UInt32, serialNumber: UInt32, signature: String)
    
    // Emitted when an NFT (print) is detroyed
    pub event PrintNFTDestroyed(nftID: UInt64)
    
    // Emitted when an Artwork is created
    pub event ArtworkCreated(artworkID: UInt32, galleryID: UInt32, externalPostID: String, creator: ArtworkMetadata.Creator, content: ArtworkMetadata.Content, attributes: [ArtworkMetadata.Attribute])
    ...
    pub resource Minter{ 
        pub fun mintNFT(galleryID: UInt32, artworkID: UInt32, editionID: UInt32, serialNumber: UInt32, signature: String): @Everbloom.NFT{ 
