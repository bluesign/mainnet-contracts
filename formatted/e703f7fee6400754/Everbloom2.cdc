...
pub contract Everbloom2: NonFungibleToken{ 
    ...
    pub event PrintNFTMinted(nftID: UInt64, artworkID: UInt32, galleryID: UInt32, serialNumber: UInt32, externalPrintID: String, signature: String?, metadata:{ String: String})
    
    // Emitted when an NFT (print) is detroyed
    pub event PrintNFTDestroyed(nftID: UInt64)
    
    // Emitted when an Artwork is created
    pub event ArtworkCreated(artworkID: UInt32, galleryID: UInt32, externalPostID: String, metadata:{ String: String})
    ...
    pub struct Artwork{ 
        ...
        priv let perks: [EverbloomMetadata.Perk]
        
        // Additional Metadata
        priv let metadata:{ String: String}
        
        // ids of NFTs in Buildin Block Contract
        priv let buildingBlockIds: [UInt64]
    ...
    pub resource Gallery: GalleryPublic{ 
        ...
        priv let artworks: [UInt32]
        
        // artworksLocked stores the locked status for artwork
        priv let artworksLocked:{ UInt32: Bool}
        ...
        pub fun createArtwork(externalPostID: String, perkDatas: [EverbloomMetadata.PerkData], metadata:{ String: String}, buildingBlockIds: [UInt64]): UInt32{ 
            pre{ 
    ...
    pub resource User: UserPublic{ 
        ...
        priv let galleries: @{UInt32: Gallery}
        ...
        pub fun mintPrint(galleryID: UInt32, artworkID: UInt32, externalPrintID: String, signature: String?, metadata:{ String: String}, royalties: [MetadataViews.Royalty]): @NFT{ 
        ...
        pub fun batchMintPrint(galleryID: UInt32, artworkID: UInt32, externalPrintIDs: [String], signatures: [String?], metadata:{ String: String}, royalties: [MetadataViews.Royalty]): @Collection{ 
            pre{ 
    ...
    pub resource Minter{ 
        pub fun mintNFT(galleryID: UInt32, artworkID: UInt32, serialNumber: UInt32, externalPrintID: String, signature: String?, metadata:{ String: String}, royalties: [MetadataViews.Royalty]): @Everbloom2.NFT{ 
