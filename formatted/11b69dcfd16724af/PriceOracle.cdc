...
pub contract PriceOracle: OracleInterface{ 
    ...
    priv let _FeederWhiteList:{ Address: Bool}
    ...
    pub resource PriceFeeder: OracleInterface.PriceFeederPublic{ 
        priv var _Price: UFix64
        
        priv var _LastPublishBlockHeight: UInt64
        
        /// seconds
        priv var _ExpiredDuration: UInt64
    ...
    access(contract) fun configOracle(priceIdentifier: String, minFeederNumber: Int, feederStoragePath: StoragePath, feederPublicPath: PublicPath, readerStoragePath: StoragePath){ 
