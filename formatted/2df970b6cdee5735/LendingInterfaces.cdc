...
pub contract interface LendingInterfaces{ 
    pub resource interface PoolPublic{ 
        ...
        pub fun getPoolSupplierSlicedList(from: UInt64, to: UInt64): [
            Address
        ]{} 
        
        pub fun getPoolBorrowerSlicedList(from: UInt64, to: UInt64): [
            Address
        ]{} 
    ...
    pub resource interface FlashLoanExecutor{ 
        pub fun executeAndRepay(
            loanedToken: @FungibleToken.Vault,
            params:{ 
                String: AnyStruct
            }
        ): @FungibleToken.Vault{} 
    ...
    pub resource interface ComptrollerPublic{ 
        ...
        pub fun getUserMarketInfo(userAddr: Address, poolAddr: Address):{ 
            String: AnyStruct
        }{} 
    }
}
