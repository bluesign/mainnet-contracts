...
pub contract ChainmonstersRewards: NonFungibleToken{ 
    ...
    priv var rewardDatas:{ UInt32: Reward}
    
    priv var rewardSupplies:{ UInt32: UInt32}
    
    priv var rewardSeasons:{ UInt32: UInt32}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: /storage/ChainmonstersRewardCollection, publicPath: /public/ChainmonstersRewardCollection, providerPath: /private/ChainmonstersRewardsCollectionProvider, publicCollection: Type<&ChainmonstersRewards.Collection{ChainmonstersRewards.ChainmonstersRewardCollectionPublic}>(), publicLinkedType: Type<&ChainmonstersRewards.Collection{ChainmonstersRewards.ChainmonstersRewardCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ChainmonstersRewards.Collection{ChainmonstersRewards.ChainmonstersRewardCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @ChainmonstersRewards.Collection{ 
                            return <-(ChainmonstersRewards.createEmptyCollection() as! @ChainmonstersRewards.Collection)
                        })
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(receiver: ChainmonstersRewards.account.getCapability<&{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath()), cut: 0.05, description: "Chainmonsters Platform Cut")])
