pub contract DapperWalletRestrictions{ 
    ...
    pub fun GetConfigFlags():{ String: String}{ 
        return{ 
            ...
            "CAN_TRADE":
            "Can trade collection with other Dapper Custodial Wallet",
            "CAN_TRADE_EXTERNAL": "Can trade collection with external wallets",
            "CAN_TRADE_DIFF_NFT":
            "Can trade collection with different NFT types"
        }
    }
    ...
    priv let types:{ Type: TypeConfig}
    
    priv let ext:{ String: AnyStruct}
