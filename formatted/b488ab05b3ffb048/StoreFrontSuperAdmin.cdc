...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xb488ab05b3ffb048
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xb488ab05b3ffb048
