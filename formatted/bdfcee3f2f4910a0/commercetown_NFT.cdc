...
pub contract commercetown_NFT: NonFungibleToken{ 
    
    // commercetown_NFT Events
    //
    // Emitted when the commercetown_NFT contract is created
    ...
    // totalSupply
    // The total number of commercetown_NFT that have been minted
    //
    ...
    // A Series is special resource type that contains functions to mint commercetown_NFT NFTs, 
    ...
    pub resource Series{ 
        ...
        init(seriesId: UInt32, metadata:{ String: String}){ 
            ...
            self.setIds = []
            self.setSealedState ={} 
            commercetown_NFT.seriesData[seriesId] = SeriesData(seriesId: seriesId, metadata: metadata)
        ...
        pub fun addNftSet(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            ...
            commercetown_NFT.setData[setId] = newNFTSet
        ...
        pub fun updateSeriesMetadata(metadata:{ String: String}){ 
            ...
            commercetown_NFT.seriesData[self.seriesId] = newSeriesMetadata
        ...
        pub fun updateSetMetadata(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            ...
            commercetown_NFT.setData[setId] = newSetMetadata
            emit SetMetadataUpdated(seriesId: self.seriesId, setId: setId)
        }
        
        // mintcommercetown_NFT
        // Mints a new NFT with a new ID
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintcommercetown_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= commercetown_NFT.getSetMaxEditions(setId: setId)!:
            ...
            recipient.deposit(token: <-create commercetown_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: editionNum))
            
            // Increment the count of global NFTs 
            commercetown_NFT.totalSupply = commercetown_NFT.totalSupply + 1 as UInt64
            
            // Update the count of Editions minted in the set
            self.numberEditionsMintedPerSet[setId] = editionNum
        }
        
        // mintEditioncommercetown_NFT
        // Mints a new NFT with a new ID and specific edition Num (random open edition)
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintEditioncommercetown_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32, edition: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= commercetown_NFT.getSetMaxEditions(setId: setId)!:
            ...
            // deposit it in the recipient's account using their reference
            recipient.deposit(token: <-create commercetown_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: edition))
        ...
        // batchMintcommercetown_NFT
        // Mints multiple new NFTs given and deposits the NFTs
        // into the recipients collection using their collection reference
        pub fun batchMintcommercetown_NFT(recipient: &{NonFungibleToken.CollectionPublic}, setId: UInt32, tokenIds: [UInt64]){ 
            pre{ 
                tokenIds.length > 0:
                    "Number of token Ids must be > 0"
            }
            for tokenId in tokenIds{ 
                self.mintcommercetown_NFT(recipient: recipient, tokenId: tokenId, setId: setId)
            }
        }
    ...
    // A resource that represents the commercetown_NFT NFT
    //
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(tokenId: UInt64, setId: UInt32, editionNum: UInt32){ 
            ...
            let seriesId = commercetown_NFT.getSetSeriesId(setId: setId)!
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "name")!, description: commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "description")!, thumbnail: MetadataViews.HTTPFile(url: commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!))
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(self.id)
                case Type<MetadataViews.Editions>():
                    let maxEditions = commercetown_NFT.setData[self.setId]?.maxEditions ?? 0
                    let editionName = commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "name")!
                ...
                case Type<MetadataViews.ExternalURL>():
                    if let externalBaseURL = commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "external_token_base_url"){ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    for metadataKey in (commercetown_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 13{ 
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_"{ 
                                ...
                                let royaltyAddress = commercetown_NFT.convertStringToAddress(commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_addr_".concat(royaltyName))!)!
                                let royaltyReceiver: PublicPath = PublicPath(identifier: commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_rcv_".concat(royaltyName))!)!
                                let royaltyCut = commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_cut_".concat(royaltyName))!
                                let cutValue: UFix64 = commercetown_NFT.royaltyCutStringToUFix64(royaltyCut)
                                if cutValue != 0.0{ 
                                    royalties.append(MetadataViews.Royalty(receiver: getAccount(royaltyAddress).getCapability<&FungibleToken.Vault{FungibleToken.Receiver}>(royaltyReceiver), cut: cutValue, description: commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!))
                                }
                            }
                        }
                    }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: commercetown_NFT.CollectionStoragePath, publicPath: commercetown_NFT.CollectionPublicPath, providerPath: /private/commercetown_NFT, publicCollection: Type<&commercetown_NFT.Collection{commercetown_NFT.commercetown_NFTCollectionPublic, NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&commercetown_NFT.Collection{commercetown_NFT.commercetown_NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&commercetown_NFT.Collection{commercetown_NFT.commercetown_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-commercetown_NFT.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.gigantik.io/commercetown/square.png"), mediaType: "image/png")
                    let bannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.gigantik.io/commercetown/banner.png"), mediaType: "image/png")
                    ...
                    for metadataKey in (commercetown_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 18{ 
                            if metadataKey.slice(from: 0, upTo: 18) == "collection_social_"{ 
                                ...
                                socials.insert(key: metadataKey.slice(from: 18, upTo: metadataKey.length), MetadataViews.ExternalURL(commercetown_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!))
                            }
                        }
                    }
                    return MetadataViews.NFTCollectionDisplay(name: commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "", description: commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "", externalURL: MetadataViews.ExternalURL(commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""), squareImage: squareImage, bannerImage: bannerImage, socials: socials)
                    ...
                    for metadataKey in (commercetown_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 6{ 
                            if metadataKey.slice(from: 0, upTo: 6) == "trait_"{ 
                                ...
                                traitDictionary.insert(key: metadataKey.slice(from: 6, upTo: metadataKey.length), commercetown_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!)
                            }
                        }
                    }
                    return MetadataViews.dictToTraits(dict: traitDictionary, excludedNames: [])
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: MetadataViews.HTTPFile(url: commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "image")!), mediaType: self.getMimeType())])
            }
            return nil
        }
        
        pub fun getMimeType(): String{ 
            var metadataFileType = (commercetown_NFT.getSetMetadataByField(setId: self.setId, field: "image_file_type")!).toLower()
    ...
    pub resource Admin{ 
        pub fun addSeries(seriesId: UInt32, metadata:{ String: String}){ 
            pre{ 
                commercetown_NFT.series[seriesId] == nil:
            ...
            commercetown_NFT.series[seriesId] <-! newSeries
        }
        ...
        pub fun borrowSeries(seriesId: UInt32): &Series{ 
            ...
            return (&commercetown_NFT.series[seriesId] as &Series?)!
        }
    ...
    // to allow others to deposit commercetown_NFT into their Collection. It also allows for reading
    // the details of commercetown_NFT in the Collection.
    pub resource interface commercetown_NFTCollectionPublic{ 
        ...
        pub fun borrowcommercetown_NFT(id: UInt64): &commercetown_NFT.NFT?{ 
            // If the result isn't nil, the id of the returned reference
            // should be the same as the argument to the function
            post{ 
                result == nil || result?.id == id:
                    "Cannot borrow commercetown_NFT reference: The ID of the returned reference is incorrect"
            }
        }
    }
    
    // Collection
    // A collection of commercetown_NFT NFTs owned by an account
    //
    pub resource Collection: commercetown_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        //
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let token <- token as! @commercetown_NFT.NFT
        ...
        // borrowcommercetown_NFT
        // Gets a reference to an NFT in the collection as a commercetown_NFT,
        // exposing all of its fields.
        // This is safe as there are no functions that can be called on the commercetown_NFT.
        //
        pub fun borrowcommercetown_NFT(id: UInt64): &commercetown_NFT.NFT?{ 
            let ref = &self.ownedNFTs[id] as auth &NonFungibleToken.NFT?
            return ref as! &commercetown_NFT.NFT?
        }
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            let commercetown_NFTNft = nft as! &commercetown_NFT.NFT
            return commercetown_NFTNft as &AnyResource{MetadataViews.Resolver}
        }
    ...
    // fetch
    // Get a reference to a commercetown_NFT from an account's Collection, if available.
    // If an account does not have a commercetown_NFT.Collection, panic.
    ...
    //
    pub fun fetch(_ from: Address, id: UInt64): &commercetown_NFT.NFT?{ 
        let collection = getAccount(from).getCapability(commercetown_NFT.CollectionPublicPath).borrow<&commercetown_NFT.Collection{commercetown_NFT.commercetown_NFTCollectionPublic}>() ?? panic("Couldn't get collection")
        // We trust commercetown_NFT.Collection.borrowcommercetown_NFT to get the correct id
        // (it checks it before returning it).
        return collection.borrowcommercetown_NFT(id: id)
    }
    
    // getAllSeries returns all the sets
    //
    // Returns: An array of all the series that have been created
    pub fun getAllSeries(): [commercetown_NFT.SeriesData]{ 
        return commercetown_NFT.seriesData.values
    }
    
    // getAllSets returns all the sets
    //
    // Returns: An array of all the sets that have been created
    pub fun getAllSets(): [commercetown_NFT.NFTSetData]{ 
        return commercetown_NFT.setData.values
    }
    ...
    pub fun getSeriesMetadata(seriesId: UInt32):{ String: String}?{ 
        return commercetown_NFT.seriesData[seriesId]?.getMetadata()
    }
    ...
    pub fun getSetMaxEditions(setId: UInt32): UInt32?{ 
        return commercetown_NFT.setData[setId]?.maxEditions
    }
    ...
    pub fun getSetMetadata(setId: UInt32):{ String: String}?{ 
        return commercetown_NFT.setData[setId]?.getMetadata()
    }
    ...
    pub fun getSetSeriesId(setId: UInt32): UInt32?{ 
        return commercetown_NFT.setData[setId]?.seriesId
    }
    ...
    pub fun getIpfsMetadataHashByNftEdition(setId: UInt32, editionNum: UInt32): String?{ 
        ...
        if let set = commercetown_NFT.setData[setId]{ 
    ...
    init(){ 
        // Set named paths
        self.CollectionStoragePath = /storage/commercetown_NFTCollection
        self.CollectionPublicPath = /public/commercetown_NFTCollection
        self.AdminStoragePath = /storage/commercetown_NFTAdmin
        self.AdminPrivatePath = /private/commercetown_NFTAdminUpgrade
        ...
        self.account.link<&commercetown_NFT.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
