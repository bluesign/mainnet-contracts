...
pub contract Slush: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&Slush.Collection{NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
    ...
    pub struct SlushDisplay{ 
        ...
        init(name: String, description: String, thumbnail: AnyStruct{MetadataViews.File}, videoURI: String, ipfsVideo: MetadataViews.IPFSFile){ 
            self.name = name
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Slush.CollectionStoragePath, publicPath: Slush.CollectionPublicPath, providerPath: /private/SlushCollection, publicCollection: Type<&Slush.Collection{MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Slush.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Slush.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, thumbnail: String, videoURI: String, videoCID: String){ 
