...
pub contract MuvicaNFT: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&MuvicaNFT.Collection{NonFungibleToken.CollectionPublic, MuvicaNFT.MuvicaNFTCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
