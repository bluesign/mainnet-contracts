...
pub contract TechMisfits: NonFungibleToken{ 
    ...
    pub struct ItemData{ 
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes:{ String: String}, rarity: String){ 
            self.merchantID = TechMisfits.merchantID
            self.name = name
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes:{ String: String}, rarity: String){ 
            TechMisfits                       // Increment the global Item IDs
                       .totalSupply = TechMisfits.totalSupply + 1 as UInt64
            self.id = TechMisfits.totalSupply
            ...
            emit ItemMinted(itemID: self.id, merchantID: TechMisfits.merchantID, name: name)
        }
        ...
        pub fun getMutation(): ItemData?{ 
            return TechMisfits.mutations[self.id]
        }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    ...
                    var thumbnail: AnyStruct{MetadataViews.File} = MetadataViews.HTTPFile(url: data.thumbnail)
                ...
                case Type<MetadataViews.Royalties>():
                    let royaltiesDictionary = TechMisfits.royaltiesForSpecificPFP[self.id] ?? TechMisfits.defaultRoyalties
                ...
                case Type<MetadataViews.ExternalURL>():
                    return TechMisfits.ExternalURL
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TechMisfits.CollectionStoragePath, publicPath: TechMisfits.CollectionPublicPath, providerPath: /private/TechMisfitsCollection, publicCollection: Type<&TechMisfits.Collection{TechMisfits.TechMisfitsCollectionPublic}>(), publicLinkedType: Type<&TechMisfits.Collection{TechMisfitsCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TechMisfits.Collection{TechMisfitsCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-TechMisfits.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let data = self.getData()
                    let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: data.thumbnail), mediaType: data.thumbnailMimeType)
                    return MetadataViews.NFTCollectionDisplay(name: "TechMisfits", description: TechMisfits.Description, externalURL: TechMisfits.ExternalURL, squareImage: TechMisfits.SquareImage, bannerImage: TechMisfits.BannerImage, socials: TechMisfits.Socials)
    ...
    pub resource Mutator{ 
        ...
        pub fun mutatePFP(tokenID: UInt64, name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes:{ String: String}, rarity: String){ 
            pre{ 
                tokenID <= TechMisfits.totalSupply:
                    "the tokenID does not exist"
            }
            if TechMisfits.lockedMutators[self.id] != true{ 
                ...
                TechMisfits.mutations[tokenID] = mutation
    ...
    pub resource Admin{ 
        ...
        pub fun setExternalURL(url: String){ 
            TechMisfits.ExternalURL = MetadataViews.ExternalURL(url)
        }
        
        pub fun addSocial(key: String, url: String):{ String: MetadataViews.ExternalURL}{ 
            TechMisfits.Socials.insert(key: key, MetadataViews.ExternalURL(url))
            return TechMisfits.getSocials()
        }
        
        pub fun removeSocial(key: String):{ String: MetadataViews.ExternalURL}{ 
            TechMisfits.Socials.remove(key: key)
            return TechMisfits.getSocials()
        }
        
        pub fun setDescription(description: String){ 
            TechMisfits.Description = description
        }
        
        pub fun setSquareImage(url: String, mediaType: String){ 
            TechMisfits.SquareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: url), mediaType: mediaType)
        }
        
        pub fun setBannerImage(url: String, mediaType: String){ 
            TechMisfits.BannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: url), mediaType: mediaType)
        }
        
        // createNewAdmin creates a new Admin resource
        //
        pub fun createNewAdmin(): @Admin{ 
            let newID = TechMisfits.nextAdminID
            // Increment the ID so that it isn't used again
            TechMisfits.nextAdminID = TechMisfits.nextAdminID + 1 as UInt32
            return <-create Admin(id: newID)
        }
        
        // createNewMutator creates a new Mutator resource
        pub fun createNewMutator(): @Mutator{ 
            let newID = TechMisfits.nextMutatorID
            // Increment the ID so that it isn't used again
            TechMisfits.nextMutatorID = TechMisfits.nextMutatorID + 1 as UInt32
            return <-create Mutator(id: newID)
        }
        
        // Locks a mutator
        pub fun lockMutator(id: UInt32): Int{ 
            TechMisfits.lockedMutators.insert(key: id, true)
            return TechMisfits.lockedMutators.length
        }
        
        // Unlocks a mutator
        pub fun unlockMutator(id: UInt32): Int{ 
            TechMisfits.lockedMutators.remove(key: id)
            return TechMisfits.lockedMutators.length
        }
        
        pub fun setMerchantID(merchantID: UInt32): UInt32{ 
            TechMisfits.merchantID = merchantID
            return TechMisfits.merchantID
        }
        ...
        pub fun addDefaultRoyalty(name: String, royalty: MetadataViews.Royalty, rate: UFix64){ 
            pre{ 
                TechMisfits.defaultRoyalties[name] == nil:
            ...
            TechMisfits.defaultRoyalties[name] = royalty
        ...
        pub fun changeDefaultRoyaltyRate(name: String, rate: UFix64){ 
            ...
            let royalty = TechMisfits.defaultRoyalties[name]!
            let previousRate = royalty.cut
            let previousRecipientAddress = royalty.receiver
            TechMisfits.defaultRoyalties[name] = MetadataViews.Royalty(recipientAddress: previousRecipientAddress, cut: UFix64(rate), description: "TechMisfits Royalties")
        ...
        pub fun removeDefaultRoyalty(name: String){ 
            ...
            TechMisfits.defaultRoyalties.remove(key: name)
        ...
        pub fun addRoyaltyForPFP(tokenID: UInt64, name: String, royalty: MetadataViews.Royalty, rate: UFix64){ 
            ...
            if TechMisfits.royaltiesForSpecificPFP.containsKey(tokenID) == false{ 
                let newEntry:{ String: MetadataViews.Royalty} ={} 
                newEntry.insert(key: name, royalty)
                (TechMisfits.royaltiesForSpecificPFP!).insert(key: tokenID, newEntry)
                emit RoyaltyForPFPAdded(tokenID: tokenID, name: name, rate: rate)
                return
            }
            
            // the TokenID already has an entry
            if (TechMisfits.royaltiesForSpecificPFP[tokenID]!).containsKey(name){ 
                // the entry already exists
                panic("The royalty with that name already exists")
            }
            (TechMisfits.royaltiesForSpecificPFP[tokenID]!).insert(key: name, royalty)
            emit RoyaltyForPFPAdded(tokenID: tokenID, name: name, rate: rate)
        }
        ...
        pub fun changeRoyaltyRateForPFP(tokenID: UInt64, name: String, rate: UFix64){ 
            ...
            let previousRoyalty: MetadataViews.Royalty = (TechMisfits.royaltiesForSpecificPFP[tokenID]!)[name]!
            let newRoyalty = MetadataViews.Royalty(recipientAddress: previousRoyalty.receiver, cut: UFix64(rate), description: "TechMisfits Royalties")
            (TechMisfits.royaltiesForSpecificPFP[tokenID]!).insert(key: name, newRoyalty)
        ...
        pub fun removeRoyaltyForPFP(tokenID: UInt64, name: String){ 
            (TechMisfits.royaltiesForSpecificPFP[tokenID]!).remove(key: name)
        ...
        pub fun revertRoyaltyForPFPToDefault(tokenID: UInt64){ 
            TechMisfits.royaltiesForSpecificPFP.remove(key: tokenID)
    ...
    pub resource interface TechMisfitsCollectionPublic{ 
        ...
        pub fun borrowTechMisfits(id: UInt64): &TechMisfits.NFT?{ 
    ...
    //
    pub resource Collection: TechMisfitsCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            ...
            let token <- token as! @TechMisfits.NFT
        ...
        // not any MintPFPs specific data. Please use borrowTechMisfitss to 
        // read MintPFPs data.
        //
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT{ 
        ...
        // borrowTechMisfits returns a borrowed reference to a MintPFPs
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            return TechMisfitsNFT as &AnyResource{MetadataViews.Resolver}
        }
    ...
    pub fun createEmptyCollection(): @NonFungibleToken.Collection{ 
        return <-create TechMisfits.Collection()
    }
    
    pub fun createEmptyMintPFPsCollection(): @TechMisfits.Collection{ 
        return <-create TechMisfits.Collection()
    }
    ...
    init(){ 
        ...
        self.lockedMutators ={} 
        self.ExternalURL = MetadataViews.ExternalURL("https://www.umbadaima.com/")
        self.Socials ={} 
        self.Description = ""
        self.SquareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://dkuxa1i6sgo8h.cloudfront.net/umbadaima/TechMisfitsBanner.png"), mediaType: "image/png")
        self.BannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://dkuxa1i6sgo8h.cloudfront.net/umbadaima/TechMisfitsBanner.png"), mediaType: "image/png")
        self.CollectionStoragePath = /storage/TechMisfitsCollection
        self.CollectionPublicPath = /public/TechMisfitsCollection
        self.AdminStoragePath = /storage/TechMisfitsAdmin
        self.MutatorStoragePath = /storage/TechMisfitsMutator
        
        // Put a new Collection in storage
        self.account.save<@Collection>(<-create Collection(), to: self.CollectionStoragePath)
        
        // Create a public capability for the Collection
        self.account.link<&{TechMisfitsCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
