...
pub contract Bl0xPack: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&Bl0xPack.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, Bl0xPack.CollectionPublic, MetadataViews.ResolverCollection}>(Bl0xPack.CollectionPublicPath, target: Bl0xPack.CollectionStoragePath)
