...
import MusicPeaksAttendanceToken from "./MusicPeaksAttendanceToken.cdc"
...
pub contract FLOATVerifiers{ 
    ...
    pub struct Timelock: MusicPeaksAttendanceToken.IVerifier{ 
    ...
    pub struct Secret: MusicPeaksAttendanceToken.IVerifier{ 
        // The secret code, set by the owner of this event.
        priv let secretPhrase: String
    ...
    // delete their FLOATs.
    pub struct Limited: MusicPeaksAttendanceToken.IVerifier{ 
        pub var capacity: UInt64
        
        pub fun verify(_ params:{ String: AnyStruct}){ 
            let event = params["event"]! as! &MusicPeaksAttendanceToken.FLOATEvent{MusicPeaksAttendanceToken.FLOATEventPublic}
    ...
    // from the list.
    pub struct MultipleSecret: MusicPeaksAttendanceToken.IVerifier{ 
        priv let secrets:{ String: Bool}
    ...
    pub struct SecretV2: MusicPeaksAttendanceToken.IVerifier{ 
