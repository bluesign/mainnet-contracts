...
pub contract MusicPeaksAttendanceToken: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MusicPeaksAttendanceToken.FLOATCollectionStoragePath, publicPath: MusicPeaksAttendanceToken.FLOATCollectionPublicPath, providerPath: /private/MusicPeaksAttendanceTokenCollectionPrivatePath, publicCollection: Type<&Collection{CollectionPublic}>(), publicLinkedType: Type<&Collection{CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
        ...
        init(_eventDescription: String, _eventHost: Address, _eventId: UInt64, _eventImage: String, _eventName: String, _originalRecipient: Address, _serial: UInt64){ 
            ...
            self.eventsCap = getAccount(_eventHost).getCapability<&FLOATEvents{FLOATEventsPublic, MetadataViews.ResolverCollection}>(MusicPeaksAttendanceToken.FLOATEventsPublicPath)
    ...
    pub resource FLOATEvents: FLOATEventsPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun borrowSharedRef(fromHost: Address): &FLOATEvents{ 
            ...
            let otherFLOATEvents = getAccount(fromHost).getCapability(MusicPeaksAttendanceToken.FLOATEventsPublicPath).borrow<&FLOATEvents{FLOATEventsPublic}>() ?? panic("Could not borrow the public FLOATEvents.")
