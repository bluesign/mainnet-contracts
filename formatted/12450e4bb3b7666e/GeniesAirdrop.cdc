...
pub contract GeniesAirdrop{ 
    ...
    pub event AirdropCreated(nftId: UInt64, owner: Address?, receiver: Address?)
    ...
    pub event CapabilityAdded(address: Address)
    ...
    pub resource Admin{ 
        priv var claimCapabilities:{ 
            Address: Capability<&{GeniesNFTAirdropVaultClaim}>
        }
        ...
        pub fun addClaimCapability(
            cap: Capability<&{GeniesNFTAirdropVaultClaim}>
        ){ 
        ...
        pub fun getClaimCapability(address: Address): Capability<
            &{GeniesNFTAirdropVaultClaim}
        >?{ 
            pre{ 
    ...
    pub resource GeniesNFTAirdropVault:
        GeniesNFTAirdropVaultPublic,
        GeniesNFTAirdropVaultClaim{
        ...
        pub fun createAirdrop(
            nftProviderCap: Capability<
                &Genies.Collection{
                    NonFungibleToken.Provider,
                    Genies.GeniesNFTCollectionPublic
                }
        ...
        pub fun claim(nftId: UInt64, address: Address){ 
            ...
            let claimerCollection =
                receiverAccount.getCapability(Genies.CollectionPublicPath)
        ...
        pub fun delistingAllAirdrops(
            claimerCollection: &Genies.Collection{NonFungibleToken.Receiver}
        ){ 
    ...
    init(){ 
        // set the named paths
        self
            .GeniesNFTAirdropVaultStoragePath = /storage/GeniesNFTAirdropVaultStoragePath
        self
            .GeniesNFTAirdropVaultPrivatePath = /private/GeniesNFTAirdropVaultPrivatePath
        self
            .GeniesNFTAirdropVaultPublicPath = /public/GeniesNFTAirdropVaultPublicPath
        ...
        self.account.link<
            &GeniesAirdrop.GeniesNFTAirdropVault{
                GeniesAirdrop.GeniesNFTAirdropVaultPublic
            }
        >(
        ...
        self.account.link<
            &GeniesAirdrop.GeniesNFTAirdropVault{
                GeniesAirdrop.GeniesNFTAirdropVaultClaim
            }
        >(
