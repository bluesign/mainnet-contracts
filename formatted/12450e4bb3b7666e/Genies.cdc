...
pub contract Genies: NonFungibleToken{ 
    ...
    pub resource GeniesCollection{ 
        ...
        //
        pub fun updateEdition(editionID: UInt32, editionMetadata:{ String: String}){ 
            pre{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Genies.CollectionStoragePath, publicPath: Genies.CollectionPublicPath, providerPath: /private/GeniesNFTCollection, publicCollection: Type<&Genies.Collection{Genies.GeniesNFTCollectionPublic}>(), publicLinkedType: Type<&Genies.Collection{Genies.GeniesNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Genies.Collection{Genies.GeniesNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    //
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, GeniesNFTCollectionPublic, MetadataViews.ResolverCollection{ 
