...
pub contract TestDAO: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                TestDAO.totalSupply = TestDAO.totalSupply - self.balance
            }
        }
    }
