...
pub contract practiceDAO: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                practiceDAO.totalSupply = practiceDAO.totalSupply - self.balance
            }
        }
    }
