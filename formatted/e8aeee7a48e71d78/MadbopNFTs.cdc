...
pub contract MadbopNFTs: NonFungibleToken{ 
    ...
    priv var allNFTs:{ UInt64: MadbopNFTData}
    ...
    pub resource AdminResource: UserSpecialCapability, NFTMethodsCapability{ 
        ...
        pub fun mintNFT(templateId: UInt64, account: Address){ 
            ...
            let recipientCollection = receiptAccount.getCapability(MadbopNFTs.CollectionPublicPath).borrow<&{MadbopNFTs.MadbopNFTsCollectionPublic}>() ?? panic("Could not get receiver reference to the NFT Collection")
