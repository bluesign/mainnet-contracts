...
pub contract Aggretsuko:
    ...
    pub resource NFT:
        ...
        pub fun externalURL(): MetadataViews.ExternalURL{ 
            return MetadataViews.ExternalURL(
                "https://app.aggretsuko.tibles.com/collection/".concat(
                    self.id.toString()
                )
            )
        }
        ...
        pub fun nftCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(
                storagePath: Aggretsuko.CollectionStoragePath,
                publicPath: Aggretsuko.PublicCollectionPath,
                providerPath: /private/AggretsukoCollection,
                publicCollection: Type<
                    &Aggretsuko.Collection{TiblesNFT.CollectionPublic}
                >(),
                publicLinkedType: Type<
                    &Aggretsuko.Collection{
                ...
                createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                    return <-Aggretsuko.createEmptyCollection()
                }
            )
        }
        ...
        pub fun nftCollectionDisplay(): MetadataViews.NFTCollectionDisplay{ 
            let squareMedia =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(
                        url: "https://i.tibles.com/m/aggretsuko-flow-icon.png"
                    ),
            ...
            let bannerMedia =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(
                        url: "https://i.tibles.com/m/aggretsuko-flow-collection-banner.png"
                    ),
                    mediaType: "image/png"
                )
            let socialsData:{ String: String} ={
                "twitter": "https://twitter.com/aggretsukotible"}
            ...
            return MetadataViews.NFTCollectionDisplay(
                name: "Aggretsuko Collection by Tibles",
                description: "Aggretsuko Tibles is a digital trading card collecting experience by Tibles, made just for Aggretsuko fans, backed by the FLOW blockchain.",
                externalURL: MetadataViews.ExternalURL(
                    "https://aggretsuko.tibles.com"
                ),
    ...
    pub fun createNewPackMinter(
        ...
        assert(
            self.account.address == 0x481914259cb9174e,
