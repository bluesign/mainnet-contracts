...
pub contract DSSCollection: NonFungibleToken{ 
    ...
    // Events
    //
    pub event CollectionGroupCreated(id: UInt64, name: String, description: String, productName: String, endTime: UFix64?, metadata:{ String: String})
    
    pub event CollectionGroupClosed(id: UInt64)
    
    pub event ItemCreatedInSlot(itemID: String, points: UInt64, itemType: String, comparator: String, slotID: UInt64, collectionGroupID: UInt64)
    
    pub event SlotCreated(id: UInt64, collectionGroupID: UInt64, logicalOperator: String, required: Bool, typeName: Type, metadata:{ String: String})
    
    pub event CollectionNFTMinted(id: UInt64, collectionGroupID: UInt64, serialNumber: UInt64, completionAddress: String, completionDate: UFix64, level: UInt8)
    
    pub event CollectionNFTCompletedWith(collectionGroupID: UInt64, completionAddress: String, completionNftIds: [UInt64])
    ...
    // Lists in contract
    //
    priv let collectionGroupByID: @{UInt64: CollectionGroup}
    
    priv let slotByID: @{UInt64: Slot}
    ...
    pub resource Slot{ 
        ...
        // Create item in slot
        //
        access(contract) fun createItemInSlot(itemID: String, points: UInt64, itemType: String, comparator: String){ 
            pre{ 
    ...
    // An NFT Collection
    //
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, DSSCollectionNFTCollectionPublic, MetadataViews.ResolverCollection{ 
    ...
    pub resource Admin: NFTMinter{ 
        ...
        //
        pub fun createCollectionGroup(name: String, description: String, productName: String, endTime: UFix64?, metadata:{ String: String}): UInt64{ 
        ...
        // Create a Slot
        //
        pub fun createSlot(collectionGroupID: UInt64, logicalOperator: String, required: Bool, typeName: Type, metadata:{ String: String}): UInt64{ 
        ...
        //
        pub fun createItemInSlot(itemID: String, points: UInt64, itemType: String, comparator: String, slotID: UInt64){ 
    ...
    init(){ 
        ...
        self.account.link<&DSSCollection.Admin{DSSCollection.NFTMinter}>(self.MinterPrivatePath, target: self.AdminStoragePath)
