...
pub contract TouchstoneProfessorMetasAcademyHackathon2023: NonFungibleToken{ 
    ...
    init(_name: String, _description: String, _imagePath: String, _bannerImagePath: String?, _minting: Bool, _royalty: MetadataViews.Royalty?, _defaultPrice: UFix64, _paymentType: String, _ipfsCID: String, _lotteryBuying: Bool, _socials:{ String: MetadataViews.ExternalURL}, _mintVerifiers: [{MintVerifiers.IVerifier}]){ 
        ...
        self.CollectionStoragePath = /storage/TouchstoneProfessorMetasAcademyHackathon2023Collection_0x213c401adf5c8854
        self.CollectionPublicPath = /public/TouchstoneProfessorMetasAcademyHackathon2023Collection_0x213c401adf5c8854
        self.CollectionPrivatePath = /private/TouchstoneProfessorMetasAcademyHackathon2023Collection_0x213c401adf5c8854
        self.AdministratorStoragePath = /storage/TouchstoneProfessorMetasAcademyHackathon2023Administrator_0x213c401adf5c8854
