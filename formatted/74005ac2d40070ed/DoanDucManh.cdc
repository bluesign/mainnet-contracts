...
pub contract DoanDucManh: NonFungibleToken, NonFungibleTokenMinter{ 
    ...
    init(){ 
        ...
        self.account.link<&DoanDucManh.Collection{NonFungibleToken.CollectionPublic, DoanDucManh.CollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
