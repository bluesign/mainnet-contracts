...
pub contract MCity: NonFungibleToken, NonFungibleTokenMinter{ 
    ...
    init(){ 
        ...
        self.account.link<&MCity.Collection{NonFungibleToken.CollectionPublic, MCity.CollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
