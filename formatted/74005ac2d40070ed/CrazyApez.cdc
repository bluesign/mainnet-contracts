...
pub contract CrazyApez: NonFungibleToken, NonFungibleTokenMinter{ 
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowNFTCrazyApez(id: UInt64): &CrazyApez.NFT?{ 
            post{ 
    ...
    init(){ 
        ...
        self.account.link<&CrazyApez.Collection{NonFungibleToken.CollectionPublic, CrazyApez.CollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
