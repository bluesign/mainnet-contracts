...
pub contract OKG: NonFungibleToken, NonFungibleTokenMinter{ 
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowNFTOKG(id: UInt64): &OKG.NFT?{ 
            post{ 
                result == nil || result?.id == id:
                    "Cannot borrow OKG reference: the ID of the returned reference is incorrect"
            }
        }
    }
    ...
    pub resource NFTMinter: NonFungibleTokenMinter.MinterProvider{ 
        ...
        pub fun mintNFT(id: UInt64, recipient: &{NonFungibleToken.CollectionPublic}, metadata:{ String: String}){ 
            pre{ 
                OKG.mintedNfts[id] == nil || OKG.mintedNfts[id] == false:
            ...
            OKG.mintedNfts[id] = true
            OKG.totalSupply = OKG.totalSupply + 1
    ...
    init(){ 
        ...
        // Set the named paths
        self.CollectionStoragePath = /storage/OKGStoragePath
        self.CollectionPublicPath = /public/OKGPublicPath
        self.MinterStoragePath = /storage/OKGMinterStoragePath
        ...
        self.account.link<&OKG.Collection{NonFungibleToken.CollectionPublic, OKG.CollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
