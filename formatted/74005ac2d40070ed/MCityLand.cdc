...
pub contract MCityLand: NonFungibleToken, NonFungibleTokenMinter{ 
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowNFTMCityLand(id: UInt64): &MCityLand.NFT?{ 
            post{ 
    ...
    init(){ 
        ...
        self.account.link<&MCityLand.Collection{NonFungibleToken.CollectionPublic, MCityLand.CollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
