...
pub contract InterflowCustom: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: InterflowCustom.CollectionStoragePath, publicPath: InterflowCustom.CollectionPublicPath, providerPath: /private/interflowCustomCollection, publicCollection: Type<&InterflowCustom.Collection{InterflowCustom.InterflowCustomCollectionPublic}>(), publicLinkedType: Type<&InterflowCustom.Collection{InterflowCustom.InterflowCustomCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&InterflowCustom.Collection{InterflowCustom.InterflowCustomCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, id: UInt64, name: String, description: String, originalNftUuid: UInt64, originalNftImageLink: String, originalNftCollectionName: String, originalNftType: Type?, originalNftContractAddress: Address?, royalties: [MetadataViews.Royalty]){ 
    ...
    init(){ 
        ...
        self.account.link<&InterflowCustom.Collection{NonFungibleToken.CollectionPublic, InterflowCustom.InterflowCustomCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
