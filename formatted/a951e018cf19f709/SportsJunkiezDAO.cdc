...
pub contract SportsJunkiezDAO: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                SportsJunkiezDAO.totalSupply = SportsJunkiezDAO.totalSupply - self.balance
            }
        }
    }
