...
pub contract JollyJokers: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    let cut = MetadataViews.Royalty(receiver: JollyJokers.account.getCapability<&{FungibleToken.Receiver}>(/public/somePath), cut: 0.05, // 5% royalty description: "Creator Royalty")
                    var royalties: [MetadataViews.Royalty] = [cut]
                    return MetadataViews.Royalties(royalties)
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: JollyJokers.CollectionStoragePath, publicPath: JollyJokers.CollectionPublicPath, providerPath: /private/findCharityCollection, publicCollection: Type<&JollyJokers.Collection{JollyJokers.JollyJokersCollectionPublic}>(), publicLinkedType: Type<&JollyJokers.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, JollyJokers.JollyJokersCollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&JollyJokers.Collection{NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, JollyJokers.JollyJokersCollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun fetch(_ from: Address, jokerId: UInt64): &JollyJokers.NFT?{ 
        let collection = getAccount(from).getCapability(JollyJokers.CollectionPublicPath).borrow<&JollyJokers.Collection{JollyJokers.JollyJokersCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&JollyJokers.Collection{NonFungibleToken.CollectionPublic, JollyJokers.JollyJokersCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
