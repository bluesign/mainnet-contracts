...
pub contract JollyJokersMinter{ 
    ...
    pub fun mintPreOrderNFTWithDUC(
        buyer: Address,
        ...
        let minter =
            self.account.borrow<&JollyJokers.NFTMinter>(
                from: JollyJokers.MinterStoragePath
            )
        ...
        let NFTReceiver =
            recipient.getCapability(JollyJokers.CollectionPublicPath).borrow<
