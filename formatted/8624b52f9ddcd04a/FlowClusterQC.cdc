...
pub contract FlowClusterQC{ 
    ...
    pub struct Cluster{ 
        ...
        access(contract) fun getUniqueVoteMessageTotalWeight(
            vote: String
        ): UInt64?{ 
        ...
        access(contract) fun setUniqueVoteMessageTotalWeight(
            vote: String,
            weight: UInt64
        ){ 
    ...
    pub resource Voter{ 
        ...
        pub fun vote(voteSignature: String, voteMessage: String){ 
            ...
            let totalWeight =
                cluster.getUniqueVoteMessageTotalWeight(vote: voteMessage) ?? 0
            var newWeight = totalWeight + vote.weight
            cluster.setUniqueVoteMessageTotalWeight(
                vote: voteMessage,
                weight: newWeight
            )
