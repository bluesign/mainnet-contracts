...
pub contract NFGv3: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&NFGv3.Collection{NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
