...
pub contract DimensionXPrimarySaleMinter{ 
    ...
    pub resource Minter: GaiaPrimarySale.IMinter{ 
        ...
        init(minter: @DimensionX.NFTMinter, maxMints: Int, escrowCap: Capability<&DimensionX.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Provider}>){ 
    ...
    pub fun createMinter(
        ...
        maxMints: Int,
        escrowCap: Capability<
            &DimensionX.Collection{
    ...
    init(){ 
        self
            .MinterPrivatePath = /private/DimensionXPrimarySaleMinterPrivatePath001
        self
            .MinterStoragePath = /storage/DimensionXPrimarySaleMinterStoragePath001
