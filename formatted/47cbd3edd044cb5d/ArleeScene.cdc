...
pub contract ArleeScene: NonFungibleToken{ 
    ...
    /* Query Function (Can also be done in Arlee Contract) */// return true if the address holds the Scene NFT
    ...
    /* Admin Function */    access(account) fun setMarketplaceCut(cut: UFix64){ 
    ...
    /* Contract functions for updating NFT metadata */    access(account) fun updateCID(arleeSceneNFT: @NonFungibleToken.NFT, newCID: String): @NonFungibleToken.NFT{ 
