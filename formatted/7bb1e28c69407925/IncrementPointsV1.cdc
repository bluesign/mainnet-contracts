...
pub contract IncrementPointsV1{ 
    ...
    priv let _mintPointPerDayFactor:{ String: UFix64}
    
    // 黑名单
    priv fun mintPoint(targetAddr: Address, amount: UFix64){ 
        // mint points
    ...
    pub fun updateUserState(userAddr: Address){ 
        ...
        && currMintTimestamp - lastMintTimestamp > 0.0{ 
            ...
            let mintAmountByLendingSupply =
                ...
                * self._mintPointPerDayFactor["LendingSupply"]!
                / self._secondsPerDay
            let mintAmountbyLendingBorrow =
                currTotalBorrowAmountInUsd
                * self._mintPointPerDayFactor["LendingBorrow"]!
                / self._secondsPerDay
