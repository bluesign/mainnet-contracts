...
pub contract DimeStorefrontV5{ 
    ...
    // A DimeCollectibleV5 NFT being offered to sale for a set fee
    pub resource SaleOffer: SaleOfferPublic{ 
        ...
        priv let sellerItemProvider: Capability<&DimeCollectibleV5.Collection{NonFungibleToken.Provider}>
        ...
        priv var saleShares: MetadataViews.Royalties
        ...
        init(nft: &DimeCollectibleV5.NFT, sellerItemProvider: Capability<&DimeCollectibleV5.Collection{NonFungibleToken.Provider}>, price: UFix64, saleShares: MetadataViews.Royalties){ 
    ...
    pub resource interface StorefrontManager{ 
        pub fun createSaleOffers(
            itemProvider: Capability<
                &DimeCollectibleV5.Collection{
                    DimeCollectibleV5.DimeCollectionPublic,
        ...
        pub fun setSaleShares(
            itemIds: [
                UInt64
            ],
            newShares: MetadataViews.Royalties
        ){} 
    }
    ...
    pub resource Storefront: StorefrontPublic, StorefrontManager{ 
        ...
        pub fun createSaleOffers(itemProvider: Capability<&DimeCollectibleV5.Collection{DimeCollectibleV5.DimeCollectionPublic, NonFungibleToken.Provider}>, items: [UInt64], price: UFix64, saleShares: MetadataViews.Royalties){ 
    ...
    init(){ 
        self.StorefrontStoragePath = /storage/DimeStorefrontV5
        self.StorefrontPrivatePath = /private/DimeStorefrontV5
        self.StorefrontPublicPath = /public/DimeStorefrontV5
    }
}
