...
pub contract DimeStorefrontV3{ 
    ...
    pub resource SaleOffer: SaleOfferPublic{ 
        ...
        priv let sellerItemProvider: Capability<&DimeCollectibleV3.Collection{NonFungibleToken.Provider}>
        ...
        priv var saleShares: SaleShares
        ...
        init(nft: &DimeCollectibleV3.NFT, sellerItemProvider: Capability<&DimeCollectibleV3.Collection{NonFungibleToken.Provider}>, price: UFix64, saleShares: SaleShares){ 
    ...
    pub resource interface StorefrontManager{ 
        pub fun createSaleOffers(
            itemProvider: Capability<
                &DimeCollectibleV3.Collection{
                    DimeCollectibleV3.DimeCollectionPublic,
    ...
    pub resource Storefront: StorefrontPublic, StorefrontManager{ 
        ...
        pub fun createSaleOffers(itemProvider: Capability<&DimeCollectibleV3.Collection{DimeCollectibleV3.DimeCollectionPublic, NonFungibleToken.Provider}>, items: [UInt64], price: UFix64, saleShares: SaleShares){ 
