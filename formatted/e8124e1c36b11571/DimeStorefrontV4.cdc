...
pub contract DimeStorefrontV4{ 
    ...
    pub resource SaleOffer: SaleOfferPublic{ 
        ...
        priv let sellerItemProvider: Capability<&DimeCollectibleV4.Collection{NonFungibleToken.Provider}>
        ...
        init(nft: &DimeCollectibleV4.NFT, sellerItemProvider: Capability<&DimeCollectibleV4.Collection{NonFungibleToken.Provider}>, price: UFix64, saleShares: MetadataViews.Royalties){ 
    ...
    pub resource interface StorefrontManager{ 
        pub fun createSaleOffers(
            itemProvider: Capability<
                &DimeCollectibleV4.Collection{
                    DimeCollectibleV4.DimeCollectionPublic,
    ...
    pub resource Storefront: StorefrontPublic, StorefrontManager{ 
        ...
        pub fun createSaleOffers(itemProvider: Capability<&DimeCollectibleV4.Collection{DimeCollectibleV4.DimeCollectionPublic, NonFungibleToken.Provider}>, items: [UInt64], price: UFix64, saleShares: MetadataViews.Royalties){ 
