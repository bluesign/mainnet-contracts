/* SPDX-License-Identifier: UNLICENSED */import DimeCollectibleV2 from "../0xf5cdaace879e5a79/DimeCollectibleV2.cdc"
...
pub contract DimeStorefrontV2{ 
    ...
    pub resource SaleOffer: SaleOfferPublic{ 
        ...
        priv let sellerItemProvider: Capability<&DimeCollectibleV2.Collection{NonFungibleToken.Provider}>
        ...
        priv let receiver: Capability<&FUSD.Vault{FungibleToken.Receiver}>
        ...
        priv let creatorRoyalties: DimeCollectibleV2.Royalties
        ...
        init(nft: &DimeCollectibleV2.NFT, sellerItemProvider: Capability<&DimeCollectibleV2.Collection{NonFungibleToken.Provider}>, price: UFix64, receiver: Capability<&FUSD.Vault{FungibleToken.Receiver}>, dimeRoyalties: UFix64, creatorRoyalties: DimeCollectibleV2.Royalties){ 
    ...
    pub resource interface StorefrontManager{ 
        pub fun createSaleOffers(
            ...
            itemProvider: Capability<
                &DimeCollectibleV2.Collection{
                    DimeCollectibleV2.DimeCollectionPublic,
    ...
    pub resource Storefront: StorefrontManager, StorefrontPublic{ 
        ...
        pub fun createSaleOffers(seller: Address, itemProvider: Capability<&DimeCollectibleV2.Collection{DimeCollectibleV2.DimeCollectionPublic, NonFungibleToken.Provider}>, itemsAndPrices:{ UInt64: UFix64}, receiver: Capability<&FUSD.Vault{FungibleToken.Receiver}>){ 
