/* SPDX-License-Identifier: UNLICENSED */import DimeCollectible from "../0xf5cdaace879e5a79/DimeCollectible.cdc"
...
pub contract DimeStorefront{ 
    ...
    pub resource SaleOffer: SaleOfferPublic{ 
        ...
        priv let sellerItemProvider: Capability<&DimeCollectible.Collection{NonFungibleToken.Provider}>
        ...
        init(sellerItemProvider: Capability<&DimeCollectible.Collection{NonFungibleToken.Provider}>, itemId: UInt64, creator: Address, content: String, price: UFix64, history: [[AnyStruct]], receiver: Capability<&FUSD.Vault{FungibleToken.Receiver}>){ 
            pre{ 
    ...
    pub resource interface StorefrontManager{ 
        pub fun createSaleOffer(
            sellerItemProvider: Capability<
                &DimeCollectible.Collection{
                    DimeCollectible.DimeCollectionPublic,
    ...
    pub resource Storefront: StorefrontManager, StorefrontPublic{ 
        ...
        pub fun createSaleOffer(sellerItemProvider: Capability<&DimeCollectible.Collection{DimeCollectible.DimeCollectionPublic, NonFungibleToken.Provider}>, itemId: UInt64, creator: Address, content: String, price: UFix64, history: [[AnyStruct]], receiver: Capability<&FUSD.Vault{FungibleToken.Receiver}>){ 
