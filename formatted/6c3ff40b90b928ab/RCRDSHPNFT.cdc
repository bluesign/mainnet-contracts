...
pub contract RCRDSHPNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            fun createTraits(): MetadataViews.Traits{ 
                ...
                if rarity == nil{ 
                    ...
                    let rarityTrait = MetadataViews.Trait(name: "Rarity", value: rarity!, rarity: nil, displayType: nil)
            ...
            fun createCollectionData(): MetadataViews.NFTCollectionData{ 
                return MetadataViews.NFTCollectionData(storagePath: RCRDSHPNFT.collectionStoragePath, publicPath: RCRDSHPNFT.collectionPublicPath, providerPath: /private/RCRDSHPNFTCollection, publicCollection: Type<&RCRDSHPNFT.Collection{RCRDSHPNFT.RCRDSHPNFTCollectionPublic}>(), publicLinkedType: Type<&RCRDSHPNFT.Collection{RCRDSHPNFT.RCRDSHPNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&RCRDSHPNFT.Collection{RCRDSHPNFT.RCRDSHPNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&RCRDSHPNFT.Collection{NonFungibleToken.CollectionPublic, RCRDSHPNFT.RCRDSHPNFTCollectionPublic}>(self.collectionPublicPath, target: self.collectionStoragePath)
