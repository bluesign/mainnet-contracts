...
pub contract LNVCT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: LNVCT.CollectionStoragePath, publicPath: LNVCT.CollectionPublicPath, providerPath: /private/LNVCTCollection, publicCollection: Type<&LNVCT.Collection{LNVCT.LNVCTCollectionPublic}>(), publicLinkedType: Type<&LNVCT.Collection{LNVCT.LNVCTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&LNVCT.Collection{LNVCT.LNVCTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(glink: String, gbatch: UInt32, glimit: UInt16, gsequence: UInt16, name: String, description: String, thumbnail: String, editionNumber: UInt64, metadata:{ String: String}): @NFT{ 
