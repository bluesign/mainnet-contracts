...
pub contract NonboringDAO: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                NonboringDAO.totalSupply = NonboringDAO.totalSupply - self.balance
            }
        }
    }
