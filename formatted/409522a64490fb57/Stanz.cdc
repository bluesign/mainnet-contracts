...
pub contract Stanz: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&{NonFungibleToken.CollectionPublic, Stanz.StanzCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
