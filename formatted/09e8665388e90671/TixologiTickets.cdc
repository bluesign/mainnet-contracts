...
pub contract TixologiTickets: NonFungibleToken{ 
    ...
    priv var ticketTypeDatas:{ UInt32: TicketType}
    
    // Variable size dictionary of Event structs
    priv var eventDatas:{ UInt32: EventData}
    
    // Variable size dictionary of TicketType resources
    priv var events: @{UInt32: Event}
    ...
    pub struct QueryEventData{ 
        ...
        priv var ticketTypes: [UInt32]
        
        priv var retired:{ UInt32: Bool}
        
        pub var locked: Bool
        
        priv var numberMintedPerTicketType:{ UInt32: UInt32}
