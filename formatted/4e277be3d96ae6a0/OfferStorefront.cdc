...
pub contract OfferStorefront{ 
    ...
    pub resource interface ListingPublic{ 
        ...
        ///
        pub fun purchase(
            wallet: Capability<&{NonFungibleToken.Receiver}>
    ...
    pub resource Storefront: StorefrontManager, StorefrontPublic{ 
        ...
        ///
        pub fun createListing(nftProviderCapability: Capability<&{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>, nftType: Type, nftID: UInt64, walletClient: Address): UInt64{ 
