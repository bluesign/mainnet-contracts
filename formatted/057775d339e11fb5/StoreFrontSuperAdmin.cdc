...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x057775d339e11fb5
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x057775d339e11fb5
