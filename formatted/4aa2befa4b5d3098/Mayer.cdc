...
pub contract Mayer: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: Mayer.CollectionStoragePath, publicPath: Mayer.CollectionPublicPath, providerPath: Mayer.CollectionPrivatePath, publicCollection: Type<&Mayer.Collection{Mayer.MayerCollectionPublic}>(), publicLinkedType: Type<&Mayer.Collection{Mayer.MayerCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Mayer.Collection{Mayer.MayerCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Admin{ 
        ...
        ///
        pub fun mintNFT(image: String, serialNumber: UInt64, name: String, description: String): @Mayer.NFT{ 
