...
pub contract ChainmonstersMarketplace{ 
    ...
    pub event CollectionRemovedSaleOffer(
        saleItemID: UInt64,
        saleItemCollection: Address
    )
    ...
    pub resource SaleOffer: SaleOfferPublicView{ 
        ...
        priv let sellerItemProvider: Capability<&ChainmonstersRewards.Collection{NonFungibleToken.Provider, ChainmonstersRewards.ChainmonstersRewardCollectionPublic}>
        
        // The sale payment price.
        pub let salePrice: UFix64
        
        // The FUSD vault that will receive that payment if teh sale completes successfully.
        priv let sellerPaymentReceiver: Capability<&FUSD.Vault{FungibleToken.Receiver}>
        
        priv let marketFeeReceiver: Capability<&FUSD.Vault{FungibleToken.Receiver}>
        ...
        //
        pub fun accept(buyerCollection: &ChainmonstersRewards.Collection{NonFungibleToken.Receiver}, buyerPayment: @FungibleToken.Vault){ 
            pre{ 
        ...
        //
        init(sellerItemProvider: Capability<&ChainmonstersRewards.Collection{NonFungibleToken.Provider, ChainmonstersRewards.ChainmonstersRewardCollectionPublic}>, saleItemID: UInt64, sellerPaymentReceiver: Capability<&FUSD.Vault{FungibleToken.Receiver}>, salePrice: UFix64, marketFeeReceiver: Capability<&FUSD.Vault{FungibleToken.Receiver}>){ 
            pre{ 
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowSaleItem(saleItemID: UInt64): &SaleOffer{
            SaleOfferPublicView
        }?{} 
    ...
    pub resource Collection:
        ...
        pub fun remove(saleItemID: UInt64): @SaleOffer{ 
            ...
            return <-(
                self.saleOffers.remove(key: saleItemID)
    ...
    init(){ 
        self
            .CollectionStoragePath = /storage/chainmonstersRewardsMarketCollection
