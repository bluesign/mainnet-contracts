...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x34f8f67936d14606
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x34f8f67936d14606
