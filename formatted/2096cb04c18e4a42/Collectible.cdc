...
pub contract Collectible: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun contentID(): String{ 
            return "bafybeih76igq7e66d6h7tiiqni2zff4e7ld5tb2fy7wfyp6bzm5hzlh6fm"
        }
        ...
        pub fun originalMedia(): MetadataViews.Media{ 
            var mediaType = "image/png"
            var extension = ".png"
            if self.data.itemId == UInt32(14) || self.data.itemId == UInt32(20){ 
                mediaType = "video/mp4"
                extension = ".mp4"
            }
        ...
        pub fun serialNumber(): UInt64{ 
            return UInt64(self.data.serialNumber)
        }
        
        pub fun creatorAddress(): Address{ 
            return 0xb28ed4ee377761c9
        }
        
        pub fun editionName(): String{ 
            return self.name()
        }
        
        pub fun editionNumber(): UInt64{ 
            return UInt64(self.data.serialNumber)
        }
        
        pub fun maxEditions(): UInt64{ 
        ...
        pub fun collectionName(): String{ 
            return "Tanguy Jestin"
        }
        
        pub fun collectionDescription(): String{ 
            return ""
        }
        
        pub fun collectionURL(): MetadataViews.ExternalURL{ 
            return MetadataViews.ExternalURL("")
        }
        
        pub fun squareImage(): MetadataViews.Media{ 
            return MetadataViews.Media(file: MetadataViews.HTTPFile(url: ""), mediaType: "image/png")
        }
        
        pub fun bannerImage(): MetadataViews.Media{ 
            return MetadataViews.Media(file: MetadataViews.HTTPFile(url: ""), mediaType: "image/png")
        }
        
        pub fun getViews(): [Type]{ 
            return [Type<MetadataViews.Display>(), Type<MetadataViews.Royalties>(), Type<MetadataViews.Editions>(), Type<MetadataViews.Medias>(), Type<MetadataViews.Serial>(), Type<MetadataViews.NFTCollectionData>(), Type<MetadataViews.NFTCollectionDisplay>()]
        }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    return MetadataViews.Royalties(cutInfos: [MetadataViews.Royalty(recepient: creator.getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: 0.10, description: "Creator earnings")])
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: /storage/_2096cb04c18e4a42_Collectible_Collection, publicPath: /public/_2096cb04c18e4a42_Collectible_Collection, providerPath: /private/_2096cb04c18e4a42_Collectible_Collection, publicCollection: Type<&Collectible.Collection{Collectible.CollectibleCollectionPublic}>(), publicLinkedType: Type<&Collectible.Collection{Collectible.CollectibleCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collectible.Collection{Collectible.CollectibleCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-Collectible.createEmptyCollection()
                        })
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [self.originalMedia()])
    ...
    pub resource Collection: CollectibleCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
    ...
    pub fun getAllItems(): [Collectible.Item]{ 
    ...
    init(){ 
        ...
        self.account.save<@Admin>(<-create Admin(), to: /storage/CollectibleAdmin)
