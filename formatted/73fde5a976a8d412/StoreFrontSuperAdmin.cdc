...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x73fde5a976a8d412
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x73fde5a976a8d412
