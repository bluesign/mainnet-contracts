...
pub contract mangguo: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&mangguo.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, mangguo.mangguoCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
