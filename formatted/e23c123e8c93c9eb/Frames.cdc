...
pub contract Frames: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Frames.CollectionStoragePath, publicPath: Frames.CollectionPublicPath, providerPath: /private/FramesCollection, publicCollection: Type<&Frames.Collection{Frames.FramesCollectionPublic}>(), publicLinkedType: Type<&Frames.Collection{Frames.FramesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Frames.Collection{Frames.FramesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &Frames.NFT?{ 
        let collection = (getAccount(from).getCapability(Frames.CollectionPublicPath)!).borrow<&Frames.Collection{Frames.FramesCollectionPublic}>() ?? panic("Couldn't get collection")
