...
pub contract Reels: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(receiver: getAccount(0x17599e9dfd41a150).getCapability<&{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath()), cut: 0.05000000, description: "")])
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Reels.CollectionStoragePath, publicPath: Reels.CollectionPublicPath, providerPath: /private/ReelsCollection, publicCollection: Type<&Reels.Collection{Reels.ReelsCollectionPublic}>(), publicLinkedType: Type<&Reels.Collection{Reels.ReelsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Reels.Collection{Reels.ReelsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &Reels.NFT?{ 
        let collection = (getAccount(from).getCapability(Reels.CollectionPublicPath)!).borrow<&Reels.Collection{Reels.ReelsCollectionPublic}>() ?? panic("Couldn't get collection")
