...
pub contract SakutaroPoemReplica: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&SakutaroPoemReplica.Collection{NonFungibleToken.CollectionPublic, SakutaroPoemReplica.SakutaroPoemReplicaCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
