...
pub contract Stanz: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Stanz.CollectionStoragePath, publicPath: Stanz.CollectionPublicPath, providerPath: /private/StanzCollection, publicCollection: Type<&Stanz.Collection{Stanz.StanzCollectionPublic}>(), publicLinkedType: Type<&Stanz.Collection{Stanz.StanzCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Stanz.Collection{Stanz.StanzCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(name: "Stanz", description: "Stanz", externalURL: MetadataViews.ExternalURL(url: self.link), squareImage: squareImage, bannerImage: bannerImage, socials:{} )
                ...
                case Type<MetadataViews.Medias>():
                    ...
                    return MetadataViews.Medias(items: mediaItems)
            }
            return nil
        }
    }
    ...
    init(){ 
        ...
        self.account.link<&{Stanz.StanzCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
