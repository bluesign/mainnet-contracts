...
pub contract UJNFTAC: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&UJNFTAC.Collection{NonFungibleToken.CollectionPublic, UJNFTAC.UJNFTACCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
