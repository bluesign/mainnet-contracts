...
pub contract Interfaces{ 
    ...
    pub resource interface ProfilePublic{ 
        ...
        access(account) fun updateMissionNewParams(
            missionKey: String,
            step: Int,
            params:{ 
                String: AnyStruct
        ...
        access(account) fun updateMissionVerificationResult(
            missionKey: String,
            step: Int,
            result: Bool
        ){} 
    ...
    pub struct QuestDetail{ 
        ...
        init(
            missions: [
                AnyStruct{BountyEntityIdentifier}
            ],
    ...
    pub resource interface CompetitionServicePublic{ 
        ...
        access(account) fun onBountyCompleted(
            bountyId: UInt64,
            acct: Address
        ){} 
    }
