...
pub contract CompetitionService{ 
    ...
    pub event ProfileBountyCompleted(
        bountyId: UInt64,
        communityId: UInt64,
        key: String,
        category: UInt8,
    ...
    pub event BountyPropertyUpdated(
        bountyId: UInt64,
        property: UInt8,
        value: Bool
    )
    ...
    pub event BountyRewardUpdatedAsPoints(
        bountyId: UInt64,
        points: UInt64,
        referralPoints: UInt64
    )
    
    pub event BountyRewardUpdatedAsFLOAT(
        bountyId: UInt64,
        host: Address,
        eventId: UInt64
    )
    ...
    pub event BountyPreconditionRemoved(
        bountyId: UInt64,
        unlockCondType: UInt8,
        index: Int
    )
    ...
    pub event SeasonPropertyEndDateUpdated(
        seasonId: UInt64,
        key: UInt8,
        value: UFix64
    )
    
    pub event SeasonPropertyReferralThresholdUpdated(
        seasonId: UInt64,
        key: UInt8,
        value: UInt64
    )
    
    pub event SeasonPropertyStringUpdated(
        seasonId: UInt64,
        key: UInt8,
        value: String
    )
    ...
    pub resource BountyInfo: Interfaces.BountyInfoPublic, BountyInfoPublic{ 
        ...
        init(identifier: Community.BountyEntityIdentifier, preconditions: [AnyStruct{Interfaces.UnlockCondition}], reward: AnyStruct{Helper.RewardInfo}){ 
        ...
        access(contract) fun updateBountyProperty(property: BountyProperty, value: Bool){ 
        ...
        access(contract) fun updateRewardInfo(reward: AnyStruct{Helper.RewardInfo}){ 
            self.rewardType = reward.type
            self.rewardInfo = reward
        ...
        access(contract) fun addPrecondition(cond: AnyStruct{Interfaces.UnlockCondition}){ 
    ...
    pub resource CompetitionSeason:
        Interfaces.CompetitionPublic,
        CompetitionPublic{
    
        priv let default: Bool
        ...
        init(isDefault: Bool, endDate: UFix64, referralThreshold: UInt64){ 
            ...
            self.properties[
                CompetitionProperty.ReferralThreshold
            ] = referralThreshold
            // leaderboard
        ...
        pub fun isActive(): Bool{ 
            return self.default
                ? true
                : self.getEndDate() > getCurrentBlock().timestamp
        }
        ...
        pub fun getEndDate(): UFix64{ 
            return self.default
                ? 0.0
                : (self.properties[CompetitionProperty.EndDate] as! UFix64?)!
        }
        ...
        pub fun getReferralThreshold(): UInt64{ 
            return self.default
                ? UInt64.max
                : (
                        self.properties[CompetitionProperty.ReferralThreshold]
                        as!
                        UInt64?
                    )!
        }
        ...
        pub fun getTitle(): String{ 
            return self.default
                ? ""
                : self.properties[CompetitionProperty.Title] as! String? ?? ""
        }
        
        pub fun getRankingRewards(): String{ 
            return self.default
                ? ""
                : self.properties[CompetitionProperty.RankingRewards]
                    as!
                    String?
                    ?? ""
        }
        ...
        pub fun getLeaderboardRanking(limit: Int?):{ UInt64: [Address]}{ 
            ...
            let rankingScores =
                self.leaderboardRanking.slice(
                    from: 0,
                    upTo: maxAmount > totalLen ? totalLen : maxAmount
                )
        ...
        access(contract) fun updateRanking(
            addr: Address,
            newPoint: UInt64,
            oldPoint: UInt64
        ){ 
        ...
        access(contract) fun updatePropertyString(
    ...
    pub resource interface CompetitionServicePublic{ 
        ...
        pub fun claim(
            claimer: &UserProfile.Profile{UserProfile.ProfilePrivate}
        ): @CompetitionAdmin{} 
        
        // Bounty
        pub fun borrowBountyInfoByKey(_ key: String): &BountyInfo{
            BountyInfoPublic,
            Interfaces.BountyInfoPublic
        }{} 
        
        pub fun borrowBountyDetail(_ bountyId: UInt64): &BountyInfo{
            BountyInfoPublic,
            Interfaces.BountyInfoPublic
        }{} 
        
        // season related
        pub fun borrowSeasonDetail(seasonId: UInt64): &CompetitionSeason{
            Interfaces.CompetitionPublic,
            CompetitionPublic
        }{} 
        
        pub fun borrowPermanentSeason(): &CompetitionSeason{
            Interfaces.CompetitionPublic,
            CompetitionPublic
        }{} 
        
        pub fun borrowLastActiveSeason(): &CompetitionSeason{
            Interfaces.CompetitionPublic,
            CompetitionPublic
        }?{} 
    }
    ...
    pub resource CompetitionServiceStore:
        CompetitionServicePublic,
        Interfaces.CompetitionServicePublic{
    
        priv let adminWhitelist:{ Address: Bool}
        
        // all seasons
        priv var latestActiveSeasonId: UInt64
        
        priv var seasons: @{UInt64: CompetitionSeason}
        
        // MissionKey -> BountyID
        priv var keyIdMapping:{ String: UInt64}
        
        priv var bounties: @{UInt64: BountyInfo}
        
        priv var primaryBounties: [UInt64]
        
        // Referral Mapping
        priv var referralCodesToAddrs:{ String: Address}
        
        priv var referralAddrsToCodes:{ Address: String}
        ...
        pub fun borrowBountyInfo(_ bountyId: UInt64): &AnyResource{
            Interfaces.BountyInfoPublic
        }{ 
        ...
        pub fun borrowBountyInfoByKey(_ key: String): &BountyInfo{
            ...
            let bountyId =
                self.keyIdMapping[key] ?? panic("Missing missionKey.")
        ...
        pub fun borrowMissionRef(_ missionKey: String): &AnyStruct{
            Interfaces.BountyEntityPublic,
            Interfaces.MissionInfoPublic
        }{ 
            let bountyId =
                self.keyIdMapping[missionKey] ?? panic("Missing missionKey.")
        ...
        pub fun getActiveSeasonID(): UInt64{ 
            let season =
                &self.seasons[self.latestActiveSeasonId]
                as
                &CompetitionSeason{Interfaces.CompetitionPublic}?
                ?? panic("Failed to get current active season.")
            assert(
                season.isActive(),
                message: "The current season is not active."
            )
            return season.getSeasonId()
        }
        
        pub fun borrowSeason(seasonId: UInt64): &{
            Interfaces.CompetitionPublic
        }{ 
        ...
        access(contract) fun borrowSeasonPrivateRef(
            _ seasonId: UInt64
        ): &CompetitionSeason{ 
        ...
        access(contract) fun addBounty(
            ...
            preconditions: [
                AnyStruct{Interfaces.UnlockCondition}
            ],
        ...
        access(account) fun onBountyCompleted(bountyId: UInt64, acct: Address){ 
            let bounty =
                &self.bounties[bountyId] as &BountyInfo?
                ?? panic("Failed to borrow bounty")
            bounty.onParticipantCompleted(acct: acct)
        }
        
        // ---- internal methods ----
        
        access(contract) fun borrowBountyPrivateRef(
            _ bountyId: UInt64
        ): &BountyInfo{ 
    ...
    pub resource CompetitionAdmin{ 
        ...
        pub fun addBounty(
            ...
            assert(
                serviceIns.isAdminValid(
                    self.owner?.address ?? panic("Missing owner")
                ),
                message: "Not admin"
            )
        ...
        pub fun removeBountyPrecondition(bountyId: UInt64, idx: Int){ 
            let bounty = self.borrowBountyPrivRef(bountyId: bountyId)
        ...
        pub fun startNewSeason(
            ...
            return serviceIns.startNewSeason(
                endDate: endDate,
                referralThreshold: referralThreshold
            )
        }
        ...
        pub fun updateReferralThreshold(seasonId: UInt64, threshold: UInt64){ 
            let serviceIns = CompetitionService.borrowServiceRef()
            assert(
                serviceIns.isAdminValid(
                    self.owner?.address ?? panic("Missing owner")
        ...
        priv fun borrowBountyPrivRef(bountyId: UInt64): &BountyInfo{ 
            let serviceIns = CompetitionService.borrowServiceRef()
            assert(
                serviceIns.isAdminValid(
                    self.owner?.address ?? panic("Missing owner")
    ...
    pub resource SeasonPointsController{ 
        pub fun updateNewParams(
            ...
            // get profile and update points
            let profileRef = UserProfile.borrowUserProfilePublic(acct)
            profileRef.updateMissionNewParams(
        ...
        pub fun completeBounty(acct: Address, bountyId: UInt64){ 
            ...
            let checkCompleted =
                serviceIns.checkBountyCompleteStatus(
                    acct: acct,
                    bountyId: bountyId
                )
        ...
        pub fun setupReferralCode(acct: Address){ 
            ...
            assert(
                oldCode == nil,
                message: "Referral Code is already generated."
            )
            let serviceIns = CompetitionService.borrowServiceRef()
        ...
        priv fun addPoints(acct: Address, seasonId: UInt64, points: UInt64){ 
            // get profile and update points
            let profileRef = UserProfile.borrowUserProfilePublic(acct)
    ...
    pub fun borrowServicePublic(): &CompetitionServiceStore{
        CompetitionServicePublic,
        Interfaces.CompetitionServicePublic
    }{ 
    ...
    pub fun getPublicCapability(): Capability<
        &CompetitionServiceStore{
            CompetitionServicePublic,
            Interfaces.CompetitionServicePublic
        }
    >{ 
    ...
    access(account) fun borrowServiceRef(): &CompetitionServiceStore{ 
        return self.account.borrow<&CompetitionServiceStore>(
            from: self.ServiceStoragePath
        )
    ...
    init(){ 
        ...
        >(self.ServicePublicPath, target: self.ServiceStoragePath)
