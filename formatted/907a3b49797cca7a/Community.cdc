...
pub contract Community{ 
    ...
    pub event QuestAchievementUpdated(
        key: String,
        communityId: UInt64,
        owner: Address,
        achievementHost: Address,
    ...
    pub event CommunityUpdateBasics(
        id: UInt64,
        owner: Address,
        name: String,
        description: String,
    ...
    pub event CommunityUpdateSocial(
        id: UInt64,
        owner: Address,
        key: String,
        value: String
    ...
    pub struct BountyEntityIdentifier: Interfaces.BountyEntityIdentifier{ 
        ...
        priv fun getOwnerCommunity(): &CommunityIns{CommunityPublic}{ 
        ...
        pub fun getStandardDisplay(): MetadataViews.Display{ 
            return MetadataViews.Display(
                ...
                thumbnail: MetadataViews.HTTPFile(
                    url: "https://nftstorage.link/ipfs/".concat(self.image)
                )
            )
        }
    ...
    pub struct CommunityDisplay{ 
        ...
        init(_ ref: &CommunityIns){ 
            ...
            self.imageUrl = "https://nftstorage.link/ipfs/".concat(
                    ref.imageIpfs
                )
    ...
    pub resource CommunityIns: CommunityPublic, MetadataViews.Resolver{ 
        ...
        /************* Internals *************/        access(contract) fun getRef(): &CommunityIns{ 
            return &self as &CommunityIns
        }
        
        /************* Getters (for anyone) *************/        pub fun getID(): UInt64{ 
            return self.uuid
        }
    ...
    pub resource CommunityBuilder: CommunityBuilderPublic{ 
        ...
        pub fun createCommunity(key: String, name: String, description: String, image: String, banner: String?, socials:{ String: String}?): UInt64{ 
            pre{ 
        ...
        /************* Internal *************/        access(contract) fun takeover(ins: @CommunityIns){ 
            let id = ins.getID()
            self.communities[id] <-! ins
            Community.communityIdMapping[id] = (self.owner!).address
        }
        
        /************* Getters (for anyone) *************/        pub fun borrowCommunity(id: UInt64): &CommunityIns{CommunityPublic}{ 
    ...
    pub fun borrowCommunity(host: Address, id: UInt64): &CommunityIns{
        CommunityPublic
    }?{ 
        if let builder =
            getAccount(host).getCapability<
                &CommunityBuilder{CommunityBuilderPublic}
            >(Community.CommunityPublicPath).borrow(){ 
