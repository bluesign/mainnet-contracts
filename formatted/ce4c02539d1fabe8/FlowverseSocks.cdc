...
pub contract FlowverseSocks: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(receiver: getAccount(0x604b63bcbef5974f).getCapability<&AnyResource{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: 0.05, description: "Flowverse artist royalty")])
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FlowverseSocks.CollectionStoragePath, publicPath: FlowverseSocks.CollectionPublicPath, providerPath: /private/FlowverseSocksCollection, publicCollection: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, FlowverseSocks.FlowverseSocksCollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, FlowverseSocks.FlowverseSocksCollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, FlowverseSocks.FlowverseSocksCollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-FlowverseSocks.createEmptyCollection()
                        })
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFTWithID(id: UInt64, recipient: &{NonFungibleToken.CollectionPublic}, metadata:{ String: String}): &NonFungibleToken.NFT{ 
    ...
    init(){ 
        ...
        self.account.link<&FlowverseSocks.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, FlowverseSocks.FlowverseSocksCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
