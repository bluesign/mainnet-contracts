...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x93b0e9a5bc0343af
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x93b0e9a5bc0343af
