...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xdecaa77668d8b0a8
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xdecaa77668d8b0a8
