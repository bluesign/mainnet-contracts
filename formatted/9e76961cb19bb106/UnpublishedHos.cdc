...
pub contract UnpublishedHos: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.HTTPFile>():
                    return MetadataViews.HTTPFile(UnpublishedHos.getSetMetadata(setId: self.setId).httpFile)
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(self.id)
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(UnpublishedHos.getSetMetadata(setId: self.setId).externalUrl)
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: UnpublishedHos.CollectionStoragePath, publicPath: UnpublishedHos.CollectionPublicPath, providerPath: /private/UnpublishedHosCollection, publicCollection: Type<&UnpublishedHos.Collection{UnpublishedHos.FlickplaySeriesCollectionPublic}>(), publicLinkedType: Type<&UnpublishedHos.Collection{UnpublishedHos.FlickplaySeriesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&UnpublishedHos.Collection{UnpublishedHos.FlickplaySeriesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Royalties>():
                    let royaltyReceiver: Capability<&{FungibleToken.Receiver}> = getAccount(UnpublishedHos.royaltyAddress).getCapability<&AnyResource{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath())
                    return MetadataViews.Royalties(royalties: [MetadataViews.Royalty(receiver: royaltyReceiver, cut: UnpublishedHos.royaltyCut, description: "Flickplay Royalty")])
    ...
    pub fun fetch(_ from: Address, id: UInt64): &UnpublishedHos.NFT?{ 
        let collection = getAccount(from).getCapability(UnpublishedHos.CollectionPublicPath).borrow<&UnpublishedHos.Collection{UnpublishedHos.FlickplaySeriesCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&UnpublishedHos.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
