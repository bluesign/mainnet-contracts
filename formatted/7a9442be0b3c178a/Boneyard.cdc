...
pub contract Boneyard: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: self.name, description: self.description, image: MetadataViews.IPFSFile(cid: self.imageCID, path: nil))
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(url: "https://www.boneyard.cloud")
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Boneyard.CollectionStoragePath, publicPath: Boneyard.CollectionPublicPath, providerPath: /private/BoneyardCollection, publicCollection: Type<&Boneyard.Collection{Boneyard.BoneyardCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Boneyard.Collection{Boneyard.BoneyardCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Boneyard.Collection{Boneyard.BoneyardCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-Boneyard.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return MetadataViews.NFTCollectionDisplay(name: self.collectionName, description: self.collectionDescription, externalURL: MetadataViews.ExternalURL(url: "https://www.boneyard.cloud"), squareImage: MetadataViews.Media(file: MetadataViews.IPFSFile(cid: self.collectionSquareImageCID, path: nil), mediaType: "image/png"), bannerImage: MetadataViews.Media(file: MetadataViews.IPFSFile(cid: self.collectionBannerImageCID, path: nil), mediaType: "image/png"), socials:{ "mastodon": MetadataViews.ExternalURL(url: "https://me.dm/@The_Boneyard"), "twitter": MetadataViews.ExternalURL(url: "https://twitter.com/TheBoneyardNFT")})
    ...
    init(){ 
        ...
        self.account.link<&Boneyard.Collection{NonFungibleToken.CollectionPublic, Boneyard.BoneyardCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
