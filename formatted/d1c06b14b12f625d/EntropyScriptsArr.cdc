pub contract EntropyScriptsArr{ 
    ...
    // -----------------------------------------------------------------------
    priv var scripts: @{UInt64: Script}
    
    priv var scriptPaths:{ String: StoragePath}
    ...
    pub resource Admin{ 
        ...
        pub fun createScript(scriptName: String, scriptSignature: String){ 
            ...
            var newScript <-
                create Script(name: scriptName, signature: scriptSignature)
            ...
            EntropyScriptsArr.account.save(
                <-newScript,
        ...
        pub fun addToString(scriptName: String, string: String){ 
            let script =
                EntropyScriptsArr.account.borrow<&EntropyScriptsArr.Script>(
