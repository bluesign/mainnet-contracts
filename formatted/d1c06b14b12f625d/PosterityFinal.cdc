...
pub contract PosterityFinal: NonFungibleToken, ViewResolver{ 
    ...
    pub resource SVGStorage{ 
        ...
        pub fun addToSVG(stringPiece: String){ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(randomID: "metadata.creatorUsername", description: "Posterity description", thumbnail: MetadataViews.HTTPFile(url: " "))
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(recepient: getAccount(self.originalMinter).getCapability<&FlowToken.Vault{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: 0.10, // 10% royalty on secondary sales description: "The creator of the original content gets 10% of every secondary sale.")])
        ...
        init(_randomID: UInt64, _recipient: Address, _signature: String, _extra:{ String: AnyStruct}, _SVGPointer: StoragePath){ 
    ...
    pub resource Administrator{ 
        ...
        pub fun createSVGPath(_randomID: UInt64, _userAddress: Address){ 
        ...
        pub fun mintNFT(recipient: Address, signature: String, traits: String, randomNumber: UInt64){ 
            ...
            } else if let storage = &PosterityFinal.nftStorage[recipient] as &{UInt64: NFT}?{ 
                storage[nft.id] <-! nft
            } else{ 
        ...
        pub fun addToSVG(_randomID: UInt64, _stringPiece: String){ 
            let identifier = "PosteritySVGStorage_".concat(_randomID.toString())
            let path = StoragePath(identifier: identifier)!
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            case Type<MetadataViews.NFTCollectionData>():
                return MetadataViews.NFTCollectionData(storagePath: PosterityFinal.CollectionStoragePath, publicPath: PosterityFinal.CollectionPublicPath, providerPath: PosterityFinal.CollectionPrivatePath, publicCollection: Type<&PosterityFinal.Collection{PosterityFinal.PosterityFinalCollectionPublic}>(), publicLinkedType: Type<&PosterityFinal.Collection{PosterityFinal.PosterityFinalCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&PosterityFinal.Collection{PosterityFinal.PosterityFinalCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
            ...
            case Type<MetadataViews.NFTCollectionDisplay>():
                ...
                return MetadataViews.NFTCollectionDisplay(name: "PosterityFinal", description: "Sell PosterityFinals of any Tweet in seconds.", externalURL: MetadataViews.ExternalURL("https://PosterityFinal.gg/"), squareImage: media, bannerImage: media, socials:{ "twitter": MetadataViews.ExternalURL("https://twitter.com/CreateAPosterityFinal")})
        }
        return nil
    }
    ...
    init(){ 
        ...
        self.collectionInfo["image"] = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.discordapp.net/attachments/1075564743152107530/1149417271597473913/PosterityFinal_collection_image.png?width=1422&height=1422"), mediaType: "image/jpeg")
