/* SPDX-License-Identifier: UNLICENSED */import NonFungibleToken from "../0x1d7e57aa55817448/NonFungibleToken.cdc"
...
pub contract DimeCollectible: NonFungibleToken{ 
    ...
    pub fun fetch(_ from: Address, itemId: UInt64): &DimeCollectible.NFT?{ 
        let collection = (getAccount(from).getCapability(DimeCollectible.CollectionPublicPath)!).borrow<&DimeCollectible.Collection{DimeCollectible.DimeCollectionPublic}>() ?? panic("Couldn't get collection")
