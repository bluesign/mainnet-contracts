            ...
            switch view{ 
                case Type<MetadataViews.Display>():
                    if self.metadata["bonus"] != "0"{ 
                        return MetadataViews.Display(id: self.id.toString(), bonus: self.metadata["bonus"]!, thumbnail: MetadataViews.HTTPFile(url: self.metadata["uri"]!))
                    } else{ 
                        return MetadataViews.Display(id: self.id.toString(), bonus: self.metadata["bonus"]!, thumbnail: MetadataViews.HTTPFile(url: self.metadata["usedUri"]!))
                    }
            }
            return nil
        }
