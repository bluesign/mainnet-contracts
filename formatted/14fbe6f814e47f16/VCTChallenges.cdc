...
pub contract VCTChallenges: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: VCTChallenges.CollectionStoragePath, publicPath: VCTChallenges.CollectionPublicPath, providerPath: /private/VCTChallengesCollection, publicCollection: Type<&VCTChallenges.Collection{VCTChallenges.VCTChallengesCollectionPublic}>(), publicLinkedType: Type<&VCTChallenges.Collection{VCTChallenges.VCTChallengesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&VCTChallenges.Collection{VCTChallenges.VCTChallengesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(name: "VCT Challenges", description: "VCT Challenges", externalURL: MetadataViews.ExternalURL(url: self.link), squareImage: squareImage, bannerImage: bannerImage, socials:{} )
    ...
    init(){ 
        ...
        self.account.link<&{VCTChallenges.VCTChallengesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
