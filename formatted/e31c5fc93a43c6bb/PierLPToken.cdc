...
pub contract PierLPToken: MultiFungibleToken{ 
    ...
    pub resource Collection: MultiFungibleToken.Provider, MultiFungibleToken.Receiver, MultiFungibleToken.CollectionPublic{ 
        ...
        pub fun getPublicVault(tokenId: UInt64): &PierLPToken.Vault{MultiFungibleToken.Receiver, MultiFungibleToken.View}{ 
