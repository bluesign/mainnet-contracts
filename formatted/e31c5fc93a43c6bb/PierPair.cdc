...
pub contract PierPair: IPierPair{ 
    ...
    priv let lpTokenAdmin: @PierLPToken.Admin
    ...
    pub resource Pool: IPierPair.IPool{ 
        ...
        priv let tokenAVault: @FungibleToken.Vault
        
        priv let tokenBVault: @FungibleToken.Vault
        
        priv let lpTokenMaster: @PierLPToken.TokenMaster
        ...
        priv fun makeObservation(reserveA: UFix64, reserveB: UFix64){ 
        ...
        priv fun mintFee(reserveALast: UFix64, reserveBLast: UFix64): Bool{ 
    ...
    access(account) fun createPool(vaultA: @FungibleToken.Vault, vaultB: @FungibleToken.Vault, poolId: UInt64): @Pool{ 
    ...
    init(){ 
        ...
        self.lpTokenAdmin <- self.account.load<@PierLPToken.Admin>(from: /storage/metapierLPTokenAdmin) ?? panic("Metapier PierPair: Cannot load LP token admin")
