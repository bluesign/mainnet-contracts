...
pub contract Inbox{ 
    ...
    pub resource interface Public{ 
        ...
        pub fun borrowPack(wallet: Address, id: UInt64): &Pack.NFT{
            Pack.Public
        }?{} 
    ...
    pub resource CentralizedInbox: Public{ 
        priv var mails: @{Address: Pack.Collection}
        ...
        destroy(){ 
            pre{ 
                self.mails.length == 0:
                    "Can't destroy: mails are left in the inbox"
            }
            destroy self.mails
        }
    }
    ...
    init(){ 
        ...
        self
            .CentralizedInboxPrivatePath = /private/BasicBeastsCentralizedInboxUpgrade
        ...
        self.account.link<&Inbox.CentralizedInbox>(
        ...
        self.account.link<&Inbox.CentralizedInbox{Public}>(
