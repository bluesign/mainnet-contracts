...
pub contract Pack: NonFungibleToken{ 
    ...
    // Pack Fields
    // -----------------------------------------------------------------------
    priv var packTemplates:{ UInt32: PackTemplate}
    
    priv var stockNumbers: [UInt64]
    
    priv var numberMintedPerPackTemplate:{ UInt32: UInt32}
    ...
    pub resource PackManager: PublicPackManager{ 
        ...
        pub fun retrieveBeast(pack: @NFT): @BasicBeasts.Collection{ 
            ...
            let beastRef: &BasicBeasts.NFT = (&pack.beast[keys[0]] as                                                                      
                                                                      // -----------------------------------------------------------------------
