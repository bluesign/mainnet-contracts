...
pub contract Gaia: NonFungibleToken{ 
    ...
    priv var templateDatas:{ UInt64: Template}
    ...
    pub struct SetData{ 
        ...
        priv let allowedAccounts: [Address]
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        access(contract) fun getCollectionSquareImage(setData: SetData): MetadataViews.Media{ 
            return MetadataViews.Media(file: MetadataViews.HTTPFile("https://d3ihoi13u6g9y2.cloudfront.net/metadata/ballerz-square.png"), mediaType: "image/png")
        }
        
        access(contract) fun getCollectionBannerImage(setData: SetData): MetadataViews.Media{ 
            return MetadataViews.Media(file: MetadataViews.HTTPFile("https://d3ihoi13u6g9y2.cloudfront.net/metadata/ballerz-banner.png"), mediaType: "image/png")
        }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Gaia.CollectionStoragePath, publicPath: Gaia.CollectionPublicPath, providerPath: /private/GaiaCollection001, publicCollection: Type<&Gaia.Collection{Gaia.CollectionPublic}>(), publicLinkedType: Type<&Gaia.Collection{Gaia.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Gaia.Collection{Gaia.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    let royaltyReceiverCap = getAccount(Gaia.royaltyAddress()).getCapability<&{FungibleToken.Receiver}>(/public/dapperUtilityCoinReceiver)
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &Gaia.NFT?{ 
        let collection = getAccount(from).getCapability(Gaia.CollectionPublicPath).borrow<&Gaia.Collection{Gaia.CollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    pub fun checkSetup(_ address: Address): Bool{ 
        return getAccount(address).getCapability<&{Gaia.CollectionPublic}>(Gaia.CollectionPublicPath).check()
    }
