...
pub contract OpenEditionV2{ 
    ...
    pub resource OpenEditionItem{ 
        ...
        init(
            ...
            OpenEditionV2.totalOpenEditions = OpenEditionV2.totalOpenEditions
                + 1 as UInt64
            self.price = price
            self.startTime = startTime
        ...
        priv fun sendCommissionPayments(
            ...
            let editionRef =
                OpenEditionV2.account.getCapability<
    ...
    init(){ 
        ...
        let openEdition <-
            OpenEditionV2.createOpenEditionCollection(minterCap: minterCap)
        self.account.save(
            <-openEdition,
            to: OpenEditionV2.CollectionStoragePath
        )
        self.account.link<&{OpenEditionV2.OpenEditionCollectionPublic}>(
            OpenEditionV2.CollectionPublicPath,
            target: OpenEditionV2.CollectionStoragePath
        )
    }
}
