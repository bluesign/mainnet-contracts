...
pub contract Edition{ 
    ...
    pub resource EditionItem{ 
        ...
        // Change commision
        pub fun changeCommission(royalty:{ Address: CommissionStructure}){ 
            self.royalty = royalty
        ...
        pub fun changeMaxEdition(maxEdition: UInt64){ 
            pre{ 
    ...
    pub resource EditionCollection: EditionCollectionPublic{ 
        ...
        // Validate royalty
        priv fun validateRoyalty(royalty:{ Address: CommissionStructure}){ 
        ...
        pub fun createEdition(royalty:{ Address: CommissionStructure}, maxEdition: UInt64): UInt64{ 
        ...
        //Change commission
        pub fun changeCommission(id: UInt64, royalty:{ Address: CommissionStructure}){ 
            pre{ 
        ...
        pub fun changeMaxEdition(id: UInt64, maxEdition: UInt64){ 
            pre{ 
                self.editionItems[id] != nil:
                    "Edition does not exist"
            }
    ...
    init(){ 
        ...
        self.account.link<&{Edition.EditionCollectionPublic}>(
            Edition.CollectionPublicPath,
            target: Edition.CollectionStoragePath
        )
    }
}
