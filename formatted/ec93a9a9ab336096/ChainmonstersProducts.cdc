...
pub contract ChainmonstersProducts{ 
    ...
    priv var products:{ UInt32: Product}
    
    priv var salesPerProduct:{ UInt32: UInt32}
    ...
    pub resource Admin{ 
        ...
        pub fun setProductSaleEnabled(productID: UInt32, saleEnabled: Bool){ 
            var product =
                ChainmonstersProducts.products[productID]
        ...
        pub fun purchase(
            ...
            let product =
                ChainmonstersProducts.getProduct(productID: productID)!
            ...
            ChainmonstersProducts.salesPerProduct[
                productID
            ] = ChainmonstersProducts.salesPerProduct[productID]! + 1
            // Emit purchase event
    ...
    init(){ 
        ...
        self.account.save<@Admin>(
            <-create Admin(),
            to: /storage/chainmonstersProductsAdmin
        )
