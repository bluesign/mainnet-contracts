...
pub contract EpisodeNFT: NonFungibleToken{ 
    ...
    pub struct Metadata{ 
        ...
        pub fun setTotalMinted(_ total: UInt64){ 
    ...
    pub resource Collection: NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, EpisodeNFTCollectionPublic{ 
        ...
        pub fun buy(collectionCapability: Capability<&Collection{EpisodeNFT.EpisodeNFTCollectionPublic}>, episodeID: String){ 
            ...
            let kickbackCollection = EpisodeNFT.account.getCapability(EpisodeNFT.CollectionPublicPath).borrow<&AnyResource{EpisodeNFT.EpisodeNFTCollectionPublic}>() ?? panic("Can't get the EpisodeNFT collection.")
    ...
    init(){ 
        ...
        self.account.link<&EpisodeNFT.Collection{NonFungibleToken.CollectionPublic, EpisodeNFT.EpisodeNFTCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
