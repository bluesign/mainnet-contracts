...
pub contract StarlyTokenStaking: NonFungibleToken{ 
    pub event TokensStaked(id: UInt64, address: Address?, principal: UFix64, stakeTimestamp: UFix64, minStakingSeconds: UFix64, k: UFix64)
    
    pub event TokensUnstaked(id: UInt64, address: Address?, amount: UFix64, principal: UFix64, interest: UFix64, unstakingFees: UFix64, stakeTimestamp: UFix64, unstakeTimestamp: UFix64, k: UFix64)
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver, StakePublic{ 
        ...
        access(contract) fun getUnstakingFeesInternal(unstakingFee: UFix64, unstakingFlatFee: UFix64, unstakingFeesNotAppliedAfterSeconds: UFix64): UFix64{ 
            let timestamp = getCurrentBlock().timestamp
            let seconds = timestamp - self.stakeTimestamp
    ...
    pub resource NFTMinter{ 
        pub fun mintStake(address: Address?, principalVault: @StarlyToken.Vault, stakeTimestamp: UFix64, minStakingSeconds: UFix64, k: UFix64): @StarlyTokenStaking.NFT{ 
            pre{ 
    ...
    pub resource NFTBurner{ 
        pub fun burnStake(stake: @StarlyTokenStaking.NFT, k: UFix64, address: Address?, minStakingSeconds: UFix64, unstakingFee: UFix64, unstakingFlatFee: UFix64, unstakingFeesNotAppliedAfterSeconds: UFix64, unstakingDisabledUntilTimestamp: UFix64): @StarlyToken.Vault{ 
            pre{ 
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, CollectionPublic, CollectionPrivate, MetadataViews.ResolverCollection{ 
        ...
        access(contract) fun refund(id: UInt64, k: UFix64){ 
            if let address = self.owner?.address{ 
                let receiverRef = getAccount(address).getCapability(StarlyToken.TokenPublicReceiverPath).borrow<&{FungibleToken.Receiver}>() ?? panic("Could not borrow StarlyToken receiver reference to the recipient's vault!")
