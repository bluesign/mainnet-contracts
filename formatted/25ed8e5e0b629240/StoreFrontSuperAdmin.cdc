...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x25ed8e5e0b629240
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x25ed8e5e0b629240
