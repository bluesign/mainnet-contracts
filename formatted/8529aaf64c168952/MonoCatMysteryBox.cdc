...
pub contract MonoCatMysteryBox: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MonoCatMysteryBox.CollectionStoragePath, publicPath: MonoCatMysteryBox.CollectionPublicPath, providerPath: /private/MonoCatMysteryBoxCollection, publicCollection: Type<&MonoCatMysteryBox.Collection{MonoCatMysteryBox.MonoCatMysteryBoxCollectionPublic}>(), publicLinkedType: Type<&MonoCatMysteryBox.Collection{MonoCatMysteryBox.MonoCatMysteryBoxCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MonoCatMysteryBox.Collection{MonoCatMysteryBox.MonoCatMysteryBoxCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-MonoCatMysteryBox.createEmptyCollection()
                        })
                // royalties view
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(receiver: getAccount(0xc7246d622d0db9f1).getCapability<&FungibleToken.Vault>(/public/flowTokenReceiver), cut: 0.075, description: "MonoCats Official")])
    ...
    init(){ 
        ...
        self.account.link<&MonoCatMysteryBox.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MonoCatMysteryBox.MonoCatMysteryBoxCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
