...
pub contract MonoGold: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&MonoGold.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MonoGold.MonoGoldCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
