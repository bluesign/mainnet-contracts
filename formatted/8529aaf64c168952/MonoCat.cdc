...
pub contract MonoCat: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MonoCat.CollectionStoragePath, publicPath: MonoCat.CollectionPublicPath, providerPath: /private/MonoCatCollection, publicCollection: Type<&MonoCat.Collection{MonoCat.MonoCatCollectionPublic}>(), publicLinkedType: Type<&MonoCat.Collection{MonoCat.MonoCatCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MonoCat.Collection{MonoCat.MonoCatCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&MonoCat.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MonoCat.MonoCatCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
