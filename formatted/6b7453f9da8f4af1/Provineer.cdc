...
pub contract Provineer: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Provineer.CollectionStoragePath, publicPath: Provineer.CollectionPublicPath, providerPath: /private/ProvineerCollection, publicCollection: Type<&Provineer.Collection{Provineer.ProvineerCollectionPublic}>(), publicLinkedType: Type<&Provineer.Collection{Provineer.ProvineerCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Provineer.Collection{Provineer.ProvineerCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-Provineer.createEmptyCollection()
                        })
                case Type<MetadataViews.Traits>():
                    let traits: [MetadataViews.Trait] = []
                    traits.append(MetadataViews.Trait(trait: "File Version", value: self.fileVersion, displayType: nil, rarity: nil))
    ...
    pub resource ProvineerAdmin{ 
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, fileName: String, thumbnail: String, fileVersion: String, category: String, description: String, proof1: String, proof2: String, proof3: String, signature: String){ 
    ...
    init(){ 
        ...
        self.account.link<&Provineer.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
