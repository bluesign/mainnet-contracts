...
pub contract PLNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: PLNFT.CollectionStoragePath, publicPath: PLNFT.CollectionPublicPath, providerPath: /private/PLNFTCollection, publicCollection: Type<&PLNFT.Collection{PLNFT.PLNFTCollectionPublic}>(), publicLinkedType: Type<&PLNFT.Collection{PLNFT.PLNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&PLNFT.Collection{PLNFT.PLNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&PLNFT.Collection{NonFungibleToken.CollectionPublic, PLNFT.PLNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
