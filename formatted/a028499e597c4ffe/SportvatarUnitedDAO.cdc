...
pub contract SportvatarUnitedDAO: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                SportvatarUnitedDAO.totalSupply = SportvatarUnitedDAO.totalSupply - self.balance
            }
        }
    }
