...
pub contract GaiaElementNFT: NonFungibleToken{ 
    ...
    pub struct Set{ 
        ...
        access(contract) fun addElement(elementID: UInt64, name: String, description: String, color: String, image: AnyStruct{MetadataViews.File}, video: AnyStruct{MetadataViews.File}?, metadata:{ String: AnyStruct}, maxSupply: UInt64){ 
            pre{ 
    ...
    pub struct Element{ 
        ...
        init(id: UInt64, setID: UInt64, name: String, description: String, color: String, image: AnyStruct{MetadataViews.File}, video: AnyStruct{MetadataViews.File}?, metadata:{ String: AnyStruct}, maxSupply: UInt64){ 
            self.id = id
            self.setID = setID
            self.name = name
            self.description = description
    ...
    pub struct ElementNFTView{ 
        ...
        init(id: UInt64, setID: UInt64, setName: String, elementID: UInt64, name: String, description: String, color: String, image: AnyStruct{MetadataViews.File}, video: AnyStruct{MetadataViews.File}?, serialNumber: UInt64){ 
            self.id = id
            self.setID = setID
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: GaiaElementNFT.CollectionStoragePath, publicPath: GaiaElementNFT.CollectionPublicPath, providerPath: /private/exampleNFTCollection, publicCollection: Type<&GaiaElementNFT.Collection{GaiaElementNFT.CollectionPublic}>(), publicLinkedType: Type<&GaiaElementNFT.Collection{GaiaElementNFT.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&GaiaElementNFT.Collection{GaiaElementNFT.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Owner{ 
        ...
        pub fun addElementToSet(elementID: UInt64, setID: UInt64, name: String, description: String, color: String, image: AnyStruct{MetadataViews.File}, video: AnyStruct{MetadataViews.File}?, metadata:{ String: AnyStruct}, maxSupply: UInt64){ 
            let set = GaiaElementNFT.getSetRef(id: setID)
    ...
    init(){ 
        ...
        self.collectionDisplay = MetadataViews.NFTCollectionDisplay(name: "Gaia Elements", description: "Gaia Element NFTs on the Flow Blockchain", externalURL: MetadataViews.ExternalURL("https://ongaia.com/elements"), squareImage: MetadataViews.Media(MetadataViews.IPFSFile(cid: "QmdV7UDXCjTj5hVxrLsETwBbp4cHQwUG1m6GfEpotW7wHf", path: "elements-icon.png"), mediaType: "image/png"), bannerImage: MetadataViews.Media(MetadataViews.IPFSFile(cid: "Qmdd43Z3AjLtirHnLk2XbE8XruBg2fCoHoyYpNWhAhGqMb", path: "elements-banner.png"), mediaType: "image/png"), socials:{ "twitter": MetadataViews.ExternalURL("https://twitter.com/GaiaMarketplace")})
        let collection <- GaiaElementNFT.createEmptyCollection()
        self.account.save(<-collection, to: GaiaElementNFT.CollectionStoragePath)
        self.account.link<&GaiaElementNFT.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, GaiaElementNFT.CollectionPublic, MetadataViews.ResolverCollection}>(GaiaElementNFT.CollectionPublicPath, target: GaiaElementNFT.CollectionStoragePath)
