...
pub contract FrameNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FrameNFT.CollectionStoragePath, publicPath: FrameNFT.CollectionPublicPath, providerPath: /private/FrameNFTCollection, publicCollection: Type<&FrameNFT.Collection{FrameNFT.FrameNFTCollectionPublic}>(), publicLinkedType: Type<&FrameNFT.Collection{FrameNFT.FrameNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FrameNFT.Collection{FrameNFT.FrameNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-FrameNFT.createEmptyCollection()
                        })
    ...
    pub resource interface FrameNFTCollectionPublic{ 
        ...
        pub fun borrowFrameNFT(id: UInt64): &FrameNFT.NFT?{ 
            post{ 
    ...
    pub resource Collection: FrameNFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            return FrameNFT as &AnyResource{MetadataViews.Resolver}
        }
    ...
    init(){ 
        ...
        self.account.link<&FrameNFT.Collection{NonFungibleToken.CollectionPublic, FrameNFT.FrameNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
