...
pub contract PartyMansionDrinksContract: NonFungibleToken{ 
    ...
    pub resource Barkeeper{ 
        ...
        // "Sto lat!"
        //
        pub fun fillFridge(collectionID: UInt64, title: String, description: String, cid: String, rarity: UInt64, metadata:{ String: AnyStruct}){ 
            pre{ 
                cid.length > 0:
        ...
        // "Za nas!"
        //
        pub fun replaceDrinkInFridge(collectionID: UInt64, title: String, description: String, cid: String, rarity: UInt64, metadata:{ String: AnyStruct}, index: Int){ 
            pre{ 
                cid.length > 0:
                    "Could not create Drink: cid is required."
                index >= 0:
        ...
        //
        pub fun throwHouseRound(collectionID: UInt64, title: String, description: String, cid: String, rarity: UInt64, metadata:{ String: AnyStruct}, drinkType: DrinkType, recipient: &{NonFungibleToken.CollectionPublic}, originalOwner: Address){ 
            pre{ 
                cid.length > 0:
                    "Could not create Drink: cid is required."
            }
