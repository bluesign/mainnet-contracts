...
pub contract Bl0x2: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&Bl0x2.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, Bl0x2.Bl0x2CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
