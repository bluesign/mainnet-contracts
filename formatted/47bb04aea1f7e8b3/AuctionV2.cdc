...
pub contract AuctionV2{ 
    ...
    pub resource AuctionCollection: AuctionCollectionPublic{ 
        ...
        pub fun createAuction(minimumBidIncrement: UFix64, auctionLength: UFix64, extendedLength: UFix64, remainLengthToExtend: UFix64, auctionStartTime: UFix64, startPrice: UFix64, startBidTime: UFix64, platformVaultCap: Capability<&FUSD.Vault{FungibleToken.Receiver}>, editionCap: Capability<&{Edition.EditionCollectionPublic}>): UInt64{ 
            pre{ 
                auctionLength > 0.00:
    ...
    init(){ 
        ...
        self.account.link<&{AuctionV2.AuctionCollectionPublic}>(
            AuctionV2.CollectionPublicPath,
            target: AuctionV2.CollectionStoragePath
        )
    }
}
