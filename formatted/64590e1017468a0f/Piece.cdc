...
pub contract Piece: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(recepient: getAccount(metadata.creatorAddress).getCapability<&FlowToken.Vault{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: 0.10, // 10% royalty on secondary sales description: "The creator of the original content get's 10% of every secondary sale.")])
    ...
    pub resource Administrator{ 
        ...
        pub fun createNFTMetadata(channel: String, creatorID: UInt64, creatorAddress: Address, sourceURL: String, textContent: String, pieceCreationDate: String, contentCreationDate: String, imgUrl: String, embededHTML: String){ 
