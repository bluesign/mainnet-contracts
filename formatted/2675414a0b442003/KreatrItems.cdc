...
pub contract KreatrItems: NonFungibleToken{ 
    ...
    pub event Minted(id: UInt64, slug: String, thumbnailUri: String, typeID: UInt64, supply: UInt64, uri: String, creatorRoyalties:{ String: UFix64}?)
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv var creatorRoyalties:{ String: UFix64}?
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: self.slug, description: self.description(), thumbnail: MetadataViews.HTTPFile(self.thumbnailUri))
            }
            return nil
        }
    }
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(typeID: UInt64, slug: String, thumbnailUri: String, supply: UInt64, uri: String, creatorRoyalties:{ String: UFix64}?): @NFT{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &KreatrItems.NFT?{ 
        let collection = (getAccount(from).getCapability(KreatrItems.CollectionPublicPath)!).borrow<&KreatrItems.Collection{KreatrItems.KreatrItemsCollectionPublic}>() ?? panic("Couldn't get collection")
