...
This is the contract for UntoldPerksNFT NFTs!
...
pub contract UntoldPerksNFT: NonFungibleToken, ViewResolver{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver, NiftoryNonFungibleToken.NFTPublic{ 
        ...
        pub fun contract(): &{NiftoryNonFungibleToken.ManagerPublic}{ 
            return UntoldPerksNFT.contract()
        }
        ...
        init(setId: Int, templateId: Int, serial: UInt64){ 
            self.id = UntoldPerksNFT.totalSupply
            UntoldPerksNFT.totalSupply = UntoldPerksNFT.totalSupply + 1
            self.setId = setId
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, NiftoryNonFungibleToken.CollectionPublic, NiftoryNonFungibleToken.CollectionPrivate{ 
        ...
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let token <- token as! @UntoldPerksNFT.NFT
        ...
        pub fun depositBulk(tokens: @[NonFungibleToken.NFT]){ 
            while tokens.length > 0{ 
                let token <- tokens.removeLast() as! @UntoldPerksNFT.NFT
    ...
    pub resource Manager: NiftoryNonFungibleToken.ManagerPublic, NiftoryNonFungibleToken.ManagerPrivate{ 
        ...
        pub fun metadata(): AnyStruct?{ 
            return UntoldPerksNFT.metadata
        }
        
        pub fun getSetManagerPublic(): &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public}{ 
            return NiftoryNFTRegistry.getSetManagerPublic(UntoldPerksNFT.REGISTRY_ADDRESS, UntoldPerksNFT.REGISTRY_BRAND)
        }
        
        pub fun getMetadataViewsManagerPublic(): &MetadataViewsManager.Manager{MetadataViewsManager.Public}{ 
            return NiftoryNFTRegistry.getMetadataViewsManagerPublic(UntoldPerksNFT.REGISTRY_ADDRESS, UntoldPerksNFT.REGISTRY_BRAND)
        }
        
        pub fun getNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return NiftoryNFTRegistry.buildNFTCollectionData(UntoldPerksNFT.REGISTRY_ADDRESS, UntoldPerksNFT.REGISTRY_BRAND, fun (): @NonFungibleToken.Collection{ 
                    return <-UntoldPerksNFT.createEmptyCollection()
                })
        }
        ...
        pub fun modifyContractMetadata(): auth &AnyStruct{ 
            ...
            let maybeMetadata = UntoldPerksNFT.metadata
            if maybeMetadata == nil{ 
                let blankMetadata:{ String: String} ={} 
                UntoldPerksNFT.metadata = blankMetadata
            }
            return (&UntoldPerksNFT.metadata as auth &AnyStruct?)!
        }
        
        pub fun replaceContractMetadata(_ metadata: AnyStruct?){ 
            emit ContractMetadataUpdated()
            UntoldPerksNFT.metadata = metadata
        }
        ...
        priv fun _getMetadataViewsManagerPrivate(): &MetadataViewsManager.Manager{MetadataViewsManager.Private}{ 
            let record = NiftoryNFTRegistry.getRegistryRecord(UntoldPerksNFT.REGISTRY_ADDRESS, UntoldPerksNFT.REGISTRY_BRAND)
            let manager = UntoldPerksNFT.account.getCapability<&MetadataViewsManager.Manager{MetadataViewsManager.Private}>(record.metadataViewsManager.paths.private).borrow()!
            return manager
        }
        ...
        priv fun _getSetManagerPrivate(): &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}{ 
            let record = NiftoryNFTRegistry.getRegistryRecord(UntoldPerksNFT.REGISTRY_ADDRESS, UntoldPerksNFT.REGISTRY_BRAND)
            let setManager = UntoldPerksNFT.account.getCapability<&MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}>(record.setManager.paths.private).borrow()!
            return setManager
        }
    ...
    pub fun contract(): &{NiftoryNonFungibleToken.ManagerPublic}{ 
        return NiftoryNFTRegistry.getNFTManagerPublic(UntoldPerksNFT.REGISTRY_ADDRESS, UntoldPerksNFT.REGISTRY_BRAND)
    }
    ...
    init(nftManagerProxy: &{NiftoryNonFungibleTokenProxy.Public, NiftoryNonFungibleTokenProxy.Private}){ 
        let record = NiftoryNFTRegistry.generateRecord(account: self.account.address, project: "clj2vcxgd0002la0v5tzaibz0_UntoldPerksNFT")
        self.REGISTRY_ADDRESS = 0x32d62d5c43ad1038
        self.REGISTRY_BRAND = "clj2vcxgd0002la0v5tzaibz0_UntoldPerksNFT"
        ...
        self.account.save<@MutableMetadataSetManager.Manager>(<-MutableMetadataSetManager.create(name: "UntoldPerksNFT", description: "The set manager for UntoldPerksNFT."), to: record.setManager.paths.storage)
        ...
        let contractName = "UntoldPerksNFT"
