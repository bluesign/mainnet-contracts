/*
    Description: Central Smart Contract for ethosAIFIIFounder
    
    This smart contract contains the core functionality for 
    ethosAIFIIFounder, created by ethos Multiverse Inc.
    ...
    every ethosAIFIIFounder NFT owner will store in their account
    to manage their NFT collection.
    
    The main ethosAIFIIFounder account operated by ethos Multiverse Inc. 
    will also have its own ethosAIFIIFounder collection it can use to hold its 
...
pub contract ethosAIFIIFounder: NonFungibleToken{ 
    
    // -----------------------------------------------------------------------
    // ethosAIFIIFounder contract Events
    // -----------------------------------------------------------------------
    
    
    // Emited when the ethosAIFIIFounder contract is created
    pub event ContractInitialized()
    
    // Emmited when a user transfers a ethosAIFIIFounder NFT out of their collection
    pub event Withdraw(id: UInt64, from: Address?)
    
    // Emmited when a user recieves a ethosAIFIIFounder NFT into their collection
    pub event Deposit(id: UInt64, to: Address?)
    
    // Emmited when a ethosAIFIIFounder NFT is minted
    pub event Minted(id: UInt64)
    
    // Emmited when a batch of ethosAIFIIFounder NFTs are minted
    pub event BatchMint(metadatas: [{String: String}])
    
    // -----------------------------------------------------------------------
    // ethosAIFIIFounder Named Paths
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // ethosAIFIIFounder contract-level fields.
    ...
    // Array of all existing ethosAIFIIFounder NFTs
    priv var metadatas: [{String: String}]
    
    // The total number of ethosAIFIIFounder NFTs that have been created
    ...
    // -----------------------------------------------------------------------
    // ethosAIFIIFounder contract-level Composite Type definitions
    // -----------------------------------------------------------------------
    
    // The resource that represents the ethosAIFIIFounder NFTs
    //
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(_metadata:{ String: String}){ 
            self.id = ethosAIFIIFounder.totalSupply
            self.metadata = _metadata
            
            // Total Supply
            ethosAIFIIFounder.totalSupply = ethosAIFIIFounder.totalSupply + 1
            
            // Add the metadata to the metadatas array
            ethosAIFIIFounder.metadatas.append(_metadata)
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL("https://jade.ethosnft.com/collections/".concat((self.owner!).address.toString()).concat("/ethosAIFIIFounder"))
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ethosAIFIIFounder.CollectionStoragePath, publicPath: ethosAIFIIFounder.CollectionPublicPath, providerPath: ethosAIFIIFounder.CollectionPrivatePath, publicCollection: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, NonFungibleToken.Provider}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-ethosAIFIIFounder.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareMedia: MetadataViews.Media = MetadataViews.Media(file: ethosAIFIIFounder.getCollectionAttribute(key: "image") as! MetadataViews.HTTPFile, mediaType: "image")
                    
                    // Check if banner image exists
                    var bannerMedia: MetadataViews.Media? = nil
                    if let bannerImage: MetadataViews.IPFSFile = ethosAIFIIFounder.getCollectionAttribute(key: "bannerImage") as! MetadataViews.IPFSFile?{ 
                        bannerMedia = MetadataViews.Media(file: bannerImage, mediaType: "image")
                    }
                    return MetadataViews.NFTCollectionDisplay(name: ethosAIFIIFounder.getCollectionAttribute(key: "name") as! String, description: ethosAIFIIFounder.getCollectionAttribute(key: "description") as! String, externalURL: MetadataViews.ExternalURL("https://jade.ethosnft.com/collections/".concat((self.owner!).address.toString()).concat("/ethosAIFIIFounder")), squareImage: squareMedia, bannerImage: bannerMedia ?? squareMedia, socials: ethosAIFIIFounder.getCollectionAttribute(key: "socials") as!{ String: MetadataViews.ExternalURL})
    ...
    // The interface that users can cast their ethosAIFIIFounder Collection as
    // to allow others to deposit ethosAIFIIFounder into thier Collection. It also
    // allows for the reading of the details of ethosAIFIIFounder
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowEntireNFT(id: UInt64): &ethosAIFIIFounder.NFT?{} 
    }
    ...
    pub resource Collection: NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        //
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let myToken <- token as! @ethosAIFIIFounder.NFT
        ...
        // borrowNFT Returns a borrowed reference to a ethosAIFIIFounder NFT in the Collection
        ...
        // borrowEntireNFT returns a borrowed reference to a ethosAIFIIFounder 
        ...
        pub fun borrowEntireNFT(id: UInt64): &ethosAIFIIFounder.NFT?{ 
            if self.ownedNFTs[id] != nil{ 
                ...
                return reference as! &ethosAIFIIFounder.NFT
            } else{ 
                return nil
            }
        }
    ...
    pub resource Admin{ 
        ...
        // batchMint
        // Batch mints ethosAIFIIFounder NFTs
        ...
        pub fun updateCollectionInfo(key: String, value: AnyStruct){ 
            ethosAIFIIFounder.collectionInfo[key] = value
        }
    ...
    // -----------------------------------------------------------------------
    // ethosAIFIIFounder contract-level function definitions
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // ethosAIFIIFounder initialization function
    // -----------------------------------------------------------------------
    ...
    init(){ 
        ...
        self.collectionInfo ={} 
        self.collectionInfo["name"] = "ethosAIFIIFounder"
        self.collectionInfo["description"] = "Collection of AIF II Founders NFTs"
        ...
        // Set named paths
        self.CollectionStoragePath = /storage/ethosAIFIIFounderCollection
        self.CollectionPublicPath = /public/ethosAIFIIFounderCollection
        self.CollectionPrivatePath = /private/ethosAIFIIFounderCollection
        self.AdminStoragePath = /storage/ethosAIFIIFounderAdmin
        self.AdminPrivatePath = /private/ethosAIFIIFounderAdminUpgrade
        ...
        self.account.link<&ethosAIFIIFounder.Collection{NonFungibleToken.CollectionPublic, ethosAIFIIFounder.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
        
        // Create a private capability for the admin resource
        self.account.link<&ethosAIFIIFounder.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get Admin capability")
