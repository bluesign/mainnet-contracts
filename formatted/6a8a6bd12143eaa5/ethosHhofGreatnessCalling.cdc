...
pub contract ethosHhofGreatnessCalling: NonFungibleToken{ 
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowEntireNFT(id: UInt64): &ethosHhofGreatnessCalling.NFT?{} 
    }
    ...
    init(){ 
        ...
        self.account.link<&ethosHhofGreatnessCalling.Collection{NonFungibleToken.CollectionPublic, ethosHhofGreatnessCalling.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
        
        // Create a private capability for the admin resource
        self.account.link<&ethosHhofGreatnessCalling.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get Admin capability")
