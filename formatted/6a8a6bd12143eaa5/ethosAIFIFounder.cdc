...
pub contract ethosAIFIFounder: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ethosAIFIFounder.CollectionStoragePath, publicPath: ethosAIFIFounder.CollectionPublicPath, providerPath: ethosAIFIFounder.CollectionPrivatePath, publicCollection: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, NonFungibleToken.Provider}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-ethosAIFIFounder.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareMedia: MetadataViews.Media = MetadataViews.Media(file: ethosAIFIFounder.getCollectionAttribute(key: "image") as! MetadataViews.HTTPFile, mediaType: "image")
                    ...
                    return MetadataViews.NFTCollectionDisplay(name: ethosAIFIFounder.getCollectionAttribute(key: "name") as! String, description: ethosAIFIFounder.getCollectionAttribute(key: "description") as! String, externalURL: MetadataViews.ExternalURL("https://jade.ethosnft.com/collections/".concat((self.owner!).address.toString()).concat("/ethosAIFIFounder")), squareImage: squareMedia, bannerImage: bannerMedia ?? squareMedia, socials: ethosAIFIFounder.getCollectionAttribute(key: "socials") as!{ String: MetadataViews.ExternalURL})
    ...
    init(){ 
        ...
        self.account.link<&ethosAIFIFounder.Collection{NonFungibleToken.CollectionPublic, ethosAIFIFounder.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
