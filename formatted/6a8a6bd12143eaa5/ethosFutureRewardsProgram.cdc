...
pub contract ethosFutureRewardsProgram: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&ethosFutureRewardsProgram.Collection{NonFungibleToken.CollectionPublic, ethosFutureRewardsProgram.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
