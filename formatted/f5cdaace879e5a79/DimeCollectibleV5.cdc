...
pub contract DimeCollectibleV5: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: DimeCollectibleV5.CollectionStoragePath, publicPath: DimeCollectibleV5.CollectionPublicPath, providerPath: DimeCollectibleV5.CollectionPrivatePath, publicCollection: Type<&DimeCollectibleV5.Collection{DimeCollectibleV5.DimeCollectionPublic}>(), publicLinkedType: Type<&DimeCollectibleV5.Collection{DimeCollectibleV5.DimeCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&DimeCollectibleV5.Collection{DimeCollectibleV5.DimeCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-DimeCollectibleV5.createEmptyCollection()
                        })
            }
            return nil
        }
    ...
    pub resource interface DimeCollectionPublic{ 
        ...
        pub fun borrowCollectible(id: UInt64): &DimeCollectibleV5.NFT?{ 
    ...
    pub fun createEmptyCollection(): @DimeCollectibleV5.Collection{ 
        return <-create Collection()
    }
    
    pub resource NFTMinter{ 
        // Mint a standard DimeCollectible NFT
        pub fun mintNFTs(collection: &{DimeCollectibleV5.DimeCollectionPublic}, name: String, description: String, blueprintId: UInt64, numCopies: UInt64, creators: [Address], content: String, hiddenContent: String?, tradeable: Bool, previousHistory: [Transaction]?, royalties: MetadataViews.Royalties, initialSale: Transaction?){ 
        ...
        pub fun mintRoyaltyNFTs(collection: &{DimeCollectibleV5.DimeCollectionPublic}, name: String, description: String, blueprintId: UInt64, numCopies: UInt64, creators: [Address], content: String, tradeable: Bool, royalties: MetadataViews.Royalties, initialSale: Transaction?): [UInt64]{ 
            let history: [Transaction] = initialSale != nil ? [initialSale!] : []
            var counter = 1 as UInt64
            let idsUsed: [UInt64] = []
            while counter <= numCopies{ 
        ...
        pub fun mintReleaseNFTs(collection: &{DimeCollectibleV5.DimeCollectionPublic}, name: String, description: String, blueprintId: UInt64, numCopies: UInt64, creators: [Address], content: String, hiddenContent: String?, tradeable: Bool, previousHistory: [Transaction]?, royalties: MetadataViews.Royalties, initialSale: Transaction?){ 
            let history: [Transaction] = initialSale != nil ? [initialSale!] : []
            var counter = 1 as UInt64
            while counter <= numCopies{ 
                let tokenId = DimeCollectibleV5.totalSupply + counter
