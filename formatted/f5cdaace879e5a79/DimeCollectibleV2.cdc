...
pub contract DimeCollectibleV2: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        priv fun addSale(toUser: Address, atPrice: UFix64){ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFTs(collection: &{NonFungibleToken.CollectionPublic}, tokenIds: [UInt64], creators: [Address], content: String, hiddenContent: String?, tradeable: Bool, previousHistory: [[AnyStruct]]?, creatorRoyalties: Royalties){ 
    ...
    pub fun fetch(_ from: Address, itemId: UInt64): &DimeCollectibleV2.NFT?{ 
        let collection = (getAccount(from).getCapability(DimeCollectibleV2.CollectionPublicPath)!).borrow<&DimeCollectibleV2.Collection{DimeCollectibleV2.DimeCollectionPublic}>() ?? panic("Couldn't get collection")
