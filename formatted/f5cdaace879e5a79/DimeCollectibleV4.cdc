/* SPDX-License-Identifier: UNLICENSED */import FungibleToken from "../0xf233dcee88fe0abe/FungibleToken.cdc"
...
pub contract DimeCollectibleV4: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv var history: [Transaction]
        
        pub fun getHistory(): [Transaction]{ 
            return self.history
        }
        
        priv let previousHistory: [Transaction]?
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: DimeCollectibleV4.CollectionStoragePath, publicPath: DimeCollectibleV4.CollectionPublicPath, providerPath: DimeCollectibleV4.CollectionPrivatePath, publicCollection: Type<&DimeCollectibleV4.Collection{DimeCollectibleV4.DimeCollectionPublic}>(), publicLinkedType: Type<&DimeCollectibleV4.Collection{DimeCollectibleV4.DimeCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&DimeCollectibleV4.Collection{DimeCollectibleV4.DimeCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    //
    pub resource Collection: DimeCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFTs(collection: &{NonFungibleToken.CollectionPublic}, name: String, description: String, blueprintId: UInt64, numCopies: UInt64, creators: [Address], content: String, hiddenContent: String?, tradeable: Bool, previousHistory: [Transaction]?, royalties: MetadataViews.Royalties, initialSale: Transaction?){ 
        ...
        pub fun mintRoyaltyNFTs(collection: &{NonFungibleToken.CollectionPublic}, name: String, description: String, blueprintId: UInt64, numCopies: UInt64, creators: [Address], content: String, tradeable: Bool, royalties: MetadataViews.Royalties, initialSale: Transaction?): [UInt64]{ 
            let history: [Transaction] = initialSale != nil ? [initialSale!] : []
            var counter = 1 as UInt64
            let idsUsed: [UInt64] = []
            while counter <= numCopies{ 
                let tokenId = DimeCollectibleV4.totalSupply + counter
                collection.deposit(token: <-create DimeCollectibleV4.NFT(id: tokenId, type: NFTType.royalty, name: name, description: description, creators: creators, content: content, hiddenContent: nil, blueprintId: blueprintId, serialNumber: counter, editions: numCopies, tradeable: tradeable, history: history, previousHistory: nil, royalties: royalties))
                emit Minted(id: tokenId)
        ...
        pub fun mintReleaseNFTs(collection: &{NonFungibleToken.CollectionPublic}, name: String, description: String, blueprintId: UInt64, numCopies: UInt64, creators: [Address], content: String, hiddenContent: String?, tradeable: Bool, previousHistory: [Transaction]?, royalties: MetadataViews.Royalties, initialSale: Transaction?){ 
            let history: [Transaction] = initialSale != nil ? [initialSale!] : []
            var counter = 1 as UInt64
            while counter <= numCopies{ 
                let tokenId = DimeCollectibleV4.totalSupply + counter
                collection.deposit(token: <-create DimeCollectibleV4.NFT(id: tokenId, type: NFTType.release, name: name, description: description, creators: creators, content: content, hiddenContent: hiddenContent, blueprintId: blueprintId, serialNumber: counter, editions: numCopies, tradeable: tradeable, history: history, previousHistory: previousHistory, royalties: royalties))
                emit Minted(id: tokenId)
                counter = counter + 1
            }
            DimeCollectibleV4.totalSupply = DimeCollectibleV4.totalSupply + numCopies
