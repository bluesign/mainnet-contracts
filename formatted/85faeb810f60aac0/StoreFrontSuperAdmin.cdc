...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x85faeb810f60aac0
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x85faeb810f60aac0
