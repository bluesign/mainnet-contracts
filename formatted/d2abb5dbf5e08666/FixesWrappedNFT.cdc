...
pub contract FixesWrappedNFT: NonFungibleToken, ViewResolver{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv var wrappedNFT: @NonFungibleToken.NFT?
        
        priv var wrappedInscription: @Fixes.Inscription?
        ...
        ///
        pub fun hasWrappedNFT(): Bool{ 
            return self.wrappedNFT != nil
        }
        
        /// Check if the NFT has an inscription
        ///
        pub fun hasWrappedInscription(): Bool{ 
            return self.wrappedInscription != nil
        }
        
        /// Borrow the NFT's injected inscription
        ///
        pub fun borrowInscriptionPublic(): &Fixes.Inscription{Fixes.InscriptionPublic, MetadataViews.Resolver}?{ 
            return self.borrowInscription()
        }
        
        /// Borrow the NFT's injected inscription
        ///
        access(account) fun borrowInscription(): &Fixes.Inscription?{ 
            return &self.wrappedInscription as &Fixes.Inscription?
        }
        
        /// Return the NFT's injected inscription
        ///
        access(account) fun unwrapInscription(): @Fixes.Inscription{ 
            pre{ 
    ...
    ///
    pub fun wrap(recipient: &FixesWrappedNFT.Collection{NonFungibleToken.CollectionPublic}, nftToWrap: @NonFungibleToken.NFT, inscription: @Fixes.Inscription?): UInt64{ 
        // info to emit
    ...
    ///
    pub fun unwrap(recipient: &{NonFungibleToken.CollectionPublic}, nftToUnwrap: @FixesWrappedNFT.NFT): @Fixes.Inscription?{ 
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<MetadataViews.NFTCollectionData>():
                return MetadataViews.NFTCollectionData(storagePath: FixesWrappedNFT.CollectionStoragePath, publicPath: FixesWrappedNFT.CollectionPublicPath, providerPath: FixesWrappedNFT.CollectionPrivatePath, publicCollection: Type<&FixesWrappedNFT.Collection{FixesWrappedNFT.FixesWrappedNFTCollectionPublic}>(), publicLinkedType: Type<&FixesWrappedNFT.Collection{FixesWrappedNFT.FixesWrappedNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FixesWrappedNFT.Collection{FixesWrappedNFT.FixesWrappedNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&FixesWrappedNFT.Collection{NonFungibleToken.CollectionPublic, FixesWrappedNFT.FixesWrappedNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
