...
pub contract FindLeaseMarketSale{ 
    ...
    pub resource SaleItemCollection:
        ...
        pub fun delist(_ name: String){ 
            pre{ 
                self.items.containsKey(name):
                    "Unknown name lease=".concat(name)
            }
    ...
    pub fun getSaleItemCapability(
        ...
        &FindLeaseMarketSale.SaleItemCollection{
            FindLeaseMarketSale.SaleItemCollectionPublic,
            FindLeaseMarket.SaleItemCollectionPublic
        }
    >?{ 
        pre{ 
