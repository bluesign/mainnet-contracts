...
pub contract FindUserStatus{ 
    ...
    pub fun getStorefrontV2Listing(
        user: Address,
        id: UInt64,
        type: Type
    ): StorefrontListing?{ 
    ...
    pub fun getFlowtyListing(
        ...
        let flowtyCap =
            account.getCapability<
                &Flowty.FlowtyStorefront{Flowty.FlowtyStorefrontPublic}
    ...
    pub fun getFlowtyRentals(
        ...
        let flowtyRentalCap =
            account.getCapability<
                &FlowtyRentals.FlowtyRentalsStorefront{
                    FlowtyRentals.FlowtyRentalsStorefrontPublic
                }
    ...
    pub fun getFlovatarListing(
        ...
        let flovatar =
            FlovatarMarketplace.getFlovatarSale(address: user, id: id)
        if flovatar == nil{ 
            return nil
        }
        let f = flovatar!
    ...
    pub fun getFlovatarComponentListing(
        user: Address,
        id: UInt64,
        type: Type
        ...
        let flovatar =
            FlovatarMarketplace.getFlovatarComponentSale(address: user, id: id)
        if flovatar == nil{ 
            return nil
        }
        let f = flovatar!
