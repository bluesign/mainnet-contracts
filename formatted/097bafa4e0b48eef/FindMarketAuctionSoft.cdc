...
pub contract FindMarketAuctionSoft{ 
    ...
    pub resource interface SaleItemCollectionPublic{ 
        ...
        access(contract) fun fulfillAuction(
            id: UInt64,
    ...
    pub resource SaleItemCollection:
        ...
        priv fun addBid(
            ...
            let actionResult =
                tenant.allowedAction(
                    listingType: Type<@FindMarketAuctionSoft.SaleItem>(),
                    nftType: nftType,
                    ftType: ftType,
                    action: FindMarket.MarketAction(
                        listing: false,
                        name: "add bit in soft-auction"
                    ),
        ...
        access(contract) fun registerBid(
            ...
            let balance =
                ...
                ?? panic(
                    "Bidder unlinked the bid collection capability. bidder address : "
            ...
            emit EnglishAuction(
                ...
                saleID: saleItem.uuid,
                seller: (self.owner!).address,
                sellerName: FIND.reverseLookup((self.owner!).address),
                amount: balance,
                auctionReservePrice: saleItem.auctionReservePrice,
                status: status,
                vaultType: saleItem.vaultType.identifier,
        ...
        pub fun relist(_ id: UInt64){ 
            ...
            if auctionValidUntil != nil
            && saleItem.auctionValidUntil! <= Clock.time(){ 
        ...
        access(contract) fun fulfillAuction(
            ...
            let actionResult =
                tenant.allowedAction(
                    ...
                    action: FindMarket.MarketAction(
                        listing: false,
                        name: "buy item for soft-auction"
                    ),
                    seller: (self.owner!).address,
        ...
        pub fun listForAuction(
            ...
            let actionResult =
                tenant.allowedAction(
                    listingType: Type<@FindMarketAuctionSoft.SaleItem>(),
                    nftType: pointer.getItemType(),
                    ftType: vaultType,
                    action: FindMarket.MarketAction(
                        listing: true,
                        name: "list item for soft-auction"
                    ),
                    seller: (self.owner!).address,
                    buyer: nil
                )
