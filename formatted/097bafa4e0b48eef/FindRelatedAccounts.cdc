pub contract FindRelatedAccounts{ 
    ...
    pub resource Accounts: Public{ 
        ...
        // { ETH : ETH_Blocto }
        priv let networks:{ String: [String]}
        
        // { ETH_Blocto : [Address] }
        priv let wallets:{ String: [String]}
        
        // { ETH_Blocto_Address : AccountInformation }
        priv let accounts:{ String: AccountInformation}
    ...
    pub fun getCapability(_ addr: Address): Capability<&Accounts{Public}>{ 
        return getAccount(addr).getCapability<&Accounts{Public}>(
            self.publicPath
        )
    }
    ...
    pub fun findRelatedAccounts(address: Address):{ 
        String:{ 
            String: [
                String
            ]
