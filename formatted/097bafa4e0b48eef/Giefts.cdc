...
pub contract Giefts{ /**////////////////////////////////////////////////////////////// 
    ...
    pub resource Gieft: GieftPublic{ 
        ...
        destroy(){ 
            pre{ 
                self.nfts.length == 0:
                    "All NFTs must be claimed before destroying the gieft"
            }
            destroy self.nfts
        }
    }
    ...
    pub resource GieftCollection:
        GieftCollectionPublic,
        GieftCollectionPrivate{
        ...
        pub fun packGieft(
            ...
            let gieft <-
                create Gieft(name: name, password: password, nfts: <-nfts)
