...
pub contract SomePlaceManager{ 
    ...
    pub resource Manager: ManagerPublic{ 
        ...
        priv fun mintSequentialEditionNFT(setID: UInt64): @SomePlaceCollectible.NFT{ 
        ...
        priv fun mintNftFromPublicSale(setID: UInt64, quantity: UInt32, vault: @FungibleToken.Vault, price: UFix64, paymentReceiver: Capability<&{FungibleToken.Receiver}>): @SomePlaceCollectible.Collection{ 
            pre{ 
                quantity >= 1 && quantity <= 2:
                    "May only mint between 1 and 2 collectibles at a time"
    ...
    /* Public Functions */    pub fun getManagerPublic(): Capability<
        &SomePlaceManager.Manager{SomePlaceManager.ManagerPublic}
    >{ 
