...
pub contract SomePlaceCollectible: NonFungibleToken{ 
    ...
    pub struct CollectibleMetadata{ 
        ...
        priv var nftID: UInt64?
        
        priv var metadata:{ String: String}
        
        priv var traits:{ String: String}
    ...
    pub struct SetMetadata{ 
        ...
        priv var maxNumberOfEditions: UInt64
        
        priv var editionCount: UInt64
        
        priv var sequentialMintMin: UInt64
        
        priv var publicFUSDSalePrice: UFix64?
        
        priv var publicFLOWSalePrice: UFix64?
        
        priv var publicSaleStartTime: UFix64?
        
        priv var publicSaleEndTime: UFix64?
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(receiver: getAccount(0x8e2e0ebf3c03aa88).getCapability<&{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath()), cut: 0.10, description: "This is a royalty cut for some.place.")])
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL("https://some.place/")
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: SomePlaceCollectible.CollectionStoragePath, publicPath: SomePlaceCollectible.CollectionPublicPath, providerPath: SomePlaceCollectible.CollectionPrivatePath, publicCollection: Type<&Collection{CollectibleCollectionPublic}>(), publicLinkedType: Type<&Collection{CollectibleCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{CollectibleCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    access(account) fun addNFTSet(maxNumberOfEditions: UInt64, metadata:{ String: String}): UInt64{ 
