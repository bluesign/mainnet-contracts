pub contract FlowMeiumContract{ 
    ...
    pub resource Collection: CollectionPublic{ 
        ...
        pub fun savePost(post: @Post){ 
            ...
            let evetData: PartialPost = PartialPost(_id: post.id, _title: post.title, _description: post.description, _author: post.author, _image: post.image, _price: post.price, _createDate: post.createDate, _metadata: post.metadata, _data: nil)
    ...
    init(){ 
        ...
        self.account.link<&{CollectionPublic}>(
            self.PostCollectionPublicPath,
            target: self.PostCollectionStoragePath
        )
    }
}
