...
pub contract HWGarageTokenV2: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: HWGarageTokenV2.CollectionStoragePath, publicPath: HWGarageTokenV2.CollectionPublicPath, providedPath: /private/HWGarageTokenV2Collection, publicCollection: Type<&HWGarageTokenV2.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, HWGarageTokenV2.TokenCollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&HWGarageTokenV2.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, HWGarageTokenV2.TokenCollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&HWGarageTokenV2.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, HWGarageTokenV2.TokenCollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-HWGarageTokenV2.createEmptyCollection()
                        })
    ...
    access(account) fun mint(nftID: UInt64, packSeriesID: UInt64, metadata:{ String: String}): @NonFungibleToken.NFT{ 
