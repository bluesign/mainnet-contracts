...
pub contract HWGarageCard: NonFungibleToken{ 
    ...
    priv var collectionMetadata:{ String: String}
    
    priv let idToTokenMetadata:{ UInt64: TokenMetadata}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: HWGarageCard.CollectionStoragePath, publicPath: HWGarageCard.CollectionPublicPath, providedPath: /private/HWGarageCardCollection, publicCollection: Type<&HWGarageCard.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, HWGarageCard.HWGarageCardCollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&HWGarageCard.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, HWGarageCard.HWGarageCardCollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&HWGarageCard.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, HWGarageCard.HWGarageCardCollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-HWGarageCard.createEmptyCollection()
                        })
