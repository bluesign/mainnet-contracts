...
pub contract HWGaragePMV2{ 
    ...
    priv var HWGaragePMV2SeriesIdIsLive:{ UInt64: Bool}
    
    /* 
        *   HWGarageTokenV2
        */
    
    priv var HWGarageTokenV2SeriesIdIsLive:{ UInt64: Bool}
    
    /* 
        *   HWGarageCardV2
        */
    
    priv var HWGarageCardV2SeriesIdIsLive:{ UInt64: Bool}
    ...
    priv var HWGaragePackV2SeriesIdIsLive:{ UInt64: Bool}
