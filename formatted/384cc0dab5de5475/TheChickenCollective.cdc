...
pub contract TheChickenCollective: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                TheChickenCollective.totalSupply = TheChickenCollective.totalSupply - self.balance
            }
        }
    }
