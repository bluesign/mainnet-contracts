...
pub contract PonsCertificationContract{ 
    ...
    */
    ...
    /* Smart contracts on the Pons account can create PonsCertification instances using this function */    access(account) fun makePonsCertification(): @PonsCertification{ 
