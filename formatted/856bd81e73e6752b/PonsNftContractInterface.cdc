...
pub contract interface PonsNftContractInterface{ 
    ...
    */
    ...
    pub resource interface PonsCollection{ 
        /* Proof of certification from Pons */        pub ponsCertification: @PonsCertificationContract.PonsCertification
        
        /* Withdraw a NFT from the PonsCollection, given its nftId */        pub fun withdrawNft(nftId: String): @NFT{ 
            post{ 
                result.nftId == nftId:
        ...
        /* Deposit a NFT to the PonsCollection */        pub fun depositNft(_ ponsNft: @NFT): Void{} 
        
        /* Get a list of nftIds stored in the PonsCollection */        pub fun getNftIds(): [String]{} 
        
        /* Borrow a reference to a NFT in the PonsCollection */        pub fun borrowNft(nftId: String): &NFT{ 
            post{ 
                result.nftId == nftId:
    ...
    */
    ...
    pub resource interface PonsNftReceiver{ 
        /* Proof of certification from Pons */        access(account) ponsCertification: @PonsCertificationContract.PonsCertification
        
        /* Deposit a NFT to the PonsCollection */        pub fun depositNft(_ ponsNft: @NFT): Void{} 
    }
    
    /* All implementing contracts must implement the NFT resource, fulfilling requirements of PonsNft and the requirements from the NonFungibleToken contract */    pub resource NFT: PonsNft, NonFungibleToken.INFT{} 
    
    /* All implementing contracts must implement the Collection resource, fulfilling requirements of PonsCollection and the requirements from the NonFungibleToken contract */    pub resource Collection:
        PonsCollection,
        PonsNftReceiver,
