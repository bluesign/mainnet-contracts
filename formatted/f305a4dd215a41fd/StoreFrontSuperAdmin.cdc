...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xf305a4dd215a41fd
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xf305a4dd215a41fd
