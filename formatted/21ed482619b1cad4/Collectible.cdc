...
pub contract Collectible: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun contentID(): String{ 
            return "bafybeidtcsea7vdjzkh26qwyvx4s4yocngiffpyxtwjiqkjugknnnjpsk4"
        }
        ...
        pub fun originalMedia(): MetadataViews.Media{ 
            var mediaType = "model/gltf-binary"
            var extension = ".glb"
