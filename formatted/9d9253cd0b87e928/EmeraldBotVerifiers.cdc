...
pub contract EmeraldBotVerifiers{ 
    ...
    pub resource VerifierCollection: VerifierCollectionPublic{ 
        ...
        pub fun addVerifier(name: String, description: String, image: String, scriptCode: String, guildId: String, roleIds: [String], verificationMode: VerificationMode, extra:{ String: AnyStruct}){ 
            pre{ 
    ...
    init(){ 
        self
            .VerifierCollectionStoragePath = /storage/EmeraldBotVerifierCollection001
        self
            .VerifierCollectionPublicPath = /public/EmeraldBotVerifierCollection001
        self
            .VerifierCollectionPrivatePath = /private/EmeraldBotVerifierCollection001
