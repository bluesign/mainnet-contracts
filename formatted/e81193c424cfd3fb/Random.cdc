pub contract Random{ 
    pub fun generateWithNumberSeed(seed: Number, amount: UInt8): [UFix64]{ 
    ...
    pub fun generateWithBytesSeed(seed: [UInt8], amount: UInt8): [UFix64]{ 
        let randoms: [UFix64] = []
        var i: UInt8 = 0
        while i < amount{ 
    ...
    pub fun generate(seed: [UInt8]): UFix64{ 
