...
pub contract TransactionsRegistry{ 
    ...
    priv let registry:{ String: String}
    ...
    priv fun getKey(name: String, args: [String]): String{ 
        var key: String = name
        for arg in args{ 
    ...
    pub fun getRegistryDoodlesDropsWearablesMint(
        packTypeId: UInt64,
        packId: UInt64
    ): String?{ 
    ...
    access(account) fun registerDoodlesDropsWearablesMint(
        packTypeId: UInt64,
        packId: UInt64,
    ...
    pub fun getRegistryDoodlesDropsRedeemablesMint(
        packTypeId: UInt64,
        packId: UInt64
    ): String?{ 
        return self.getRegistryValue(
    ...
    access(account) fun registerDoodlesDropsRedeemablesMint(
        packTypeId: UInt64,
        packId: UInt64,
        transactionId: String
    ){ 
