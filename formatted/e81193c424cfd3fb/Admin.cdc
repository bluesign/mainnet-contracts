...
pub contract Admin{ 
    ...
    pub resource AdminProxy: AdminProxyClient{ 
        priv var capability: Capability<&Server>?
        ...
        pub fun mintWearable(recipient: &{NonFungibleToken.Receiver}, template: UInt64, context:{ String: String}){ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
        ...
        pub fun mintWearableDirect(recipientAddress: Address, template: UInt64, context:{ String: String}): @Wearables.NFT{ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
        ...
        pub fun mintEditionWearable(recipient: &{NonFungibleToken.Receiver}, data: Wearables.WearableMintData, context:{ String: String}){ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
        ...
        pub fun mintDoodles(recipientAddress: Address, doodleName: String, baseCharacter: UInt64, context:{ String: String}): @Doodles.NFT{ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
        ...
        pub fun createRedeemablesTemplate(setId: UInt64, name: String, description: String, brand: String, royalties: [MetadataViews.Royalty], type: String, thumbnail: MetadataViews.Media, image: MetadataViews.Media, active: Bool, extra:{ String: AnyStruct}){ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
        ...
        pub fun mintPack(recipient: &{NonFungibleToken.Receiver}, typeId: UInt64){ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
        ...
        pub fun addPackType(id: UInt64, name: String, description: String, thumbnail: MetadataViews.Media, image: MetadataViews.Media, amountOfTokens: UInt8, templateDistributions: [DoodlePackTypes.TemplateDistribution], maxSupply: UInt64?): DoodlePackTypes.PackType{ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
    ...
    init(){ 
        ...
        self.account.link<&Server>(
            self.AdminServerPrivatePath,
            target: self.AdminServerStoragePath
        )
    }
}
