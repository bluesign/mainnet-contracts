...
pub contract Redeemables: NonFungibleToken{ 
    ...
    access(account) fun createTemplate(setId: UInt64, name: String, description: String, brand: String, royalties: [MetadataViews.Royalty], type: String, thumbnail: MetadataViews.Media, image: MetadataViews.Media, active: Bool, extra:{ String: AnyStruct}){ 
        pre{ 
            Redeemables.sets.containsKey(setId):
                "Set does not exist. Id: ".concat(setId.toString())
        }
    ...
    access(account) fun burnUnredeemedSet(setId: UInt64){ 
        ...
        for address in addresses{ 
            let collection = getAccount(address).getCapability<&{Redeemables.RedeemablesCollectionPublic}>(Redeemables.CollectionPublicPath).borrow()
            if collection != nil{ 
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<MetadataViews.NFTCollectionData>():
                return MetadataViews.NFTCollectionData(storagePath: Redeemables.CollectionStoragePath, publicPath: Redeemables.CollectionPublicPath, providerPath: Redeemables.CollectionPrivatePath, publicCollection: Type<&Collection{Redeemables.RedeemablesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Collection{Redeemables.RedeemablesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{NonFungibleToken.Provider, Redeemables.RedeemablesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&Redeemables.Collection{Redeemables.RedeemablesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(Redeemables.CollectionPublicPath, target: Redeemables.CollectionStoragePath)
        self.account.link<&Redeemables.Collection{Redeemables.RedeemablesCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(Redeemables.CollectionPrivatePath, target: Redeemables.CollectionStoragePath)
