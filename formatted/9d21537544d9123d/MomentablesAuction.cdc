...
pub contract MomentablesAuction{ 
    ...
    pub struct AuctionStatus{ 
        ...
        pub let metadata:{ String:{ String: String}}?
    ...
    pub struct momentableDetails{ 
        pub var momentableId: String
    ...
    pub resource AuctionItem{ 
        ...
        pub var NFT: @Momentables.NFT?
        
        priv var momentableId: String
        
        priv var itemID: UInt64
        ...
        init(
            ...
            MomentablesAuction.totalAuctions = MomentablesAuction.totalAuctions
                + 1 as UInt64
            self.NFT <- NFT
            self.momentableId = momentableId
            self.itemID = itemID
        ...
        access(contract) fun sendNFT(
            _ capability: Capability<&{NonFungibleToken.CollectionPublic}>
        ){ 
    ...
    pub resource interface AuctionPublic{ 
        ...
        pub fun getAuctionStatuses():{ UInt64: AnyStruct}{} 
        
        pub fun getAuctionStatus(_ id: UInt64): AuctionStatus{} 
        
        pub fun borrowAuctionedMomentable(id: UInt64): &Momentables.NFT?{} 
    ...
    pub resource AuctionCollection: AuctionPublic{ 
        ...
        pub fun createAuction(token: @Momentables.NFT, momentableId: String, itemID: UInt64, minimumBidIncrement: UFix64, auctionLength: UFix64, auctionStartTime: UFix64, startPrice: UFix64, collectionCap: Capability<&{NonFungibleToken.CollectionPublic}>, vaultCap: Capability<&{FungibleToken.Receiver}>){ 
        ...
        pub fun borrowAuctionedMomentable(id: UInt64): &Momentables.NFT?{ 
            ...
            if self.auctionItems[id] != nil{ 
                let itemRef = (&self.auctionItems[id] as &AuctionItem?)!
                let ref = (&itemRef.NFT as auth &NonFungibleToken.NFT?)!
    ...
    pub fun createAuctionCollection(
        ...
        emit CollectionCreated(
            owner: marketplaceVault.address,
            cutPercentage: cutPercentage
        )
