...
pub contract DimeMarket{ 
    ...
    pub resource SaleOffer: SaleOfferPublicView{ 
        ...
        pub fun accept(buyerCollection: &DimeCollectible.Collection{NonFungibleToken.Receiver}){ 
            pre{ 
        ...
        init(sellerItemProvider: Capability<&DimeCollectible.Collection{NonFungibleToken.Provider}>, itemId: UInt64, creator: Address, content: String, price: UFix64){ 
            pre{ 
    ...
    pub fun createSaleOffer(
        sellerItemProvider: Capability<
            &DimeCollectible.Collection{NonFungibleToken.Provider}
        >,
        itemId: UInt64,
        creator: Address,
        content: String,
    ...
    pub resource interface CollectionPurchaser{ 
        pub fun purchase(
            itemId: UInt64,
            buyerCollection: &DimeCollectible.Collection{
