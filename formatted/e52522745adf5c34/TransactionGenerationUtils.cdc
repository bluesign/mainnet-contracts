...
pub contract TransactionGenerationUtils{ 
    ...
    pub struct FTSchema: TokenSchema{ 
        ...
        init(identifier: String, contractName: String, storagePath: String, publicPath: String, privatePath: String, type: Type, publicLinkedType: Type, privateLinkedType: Type){ 
    ...
    pub struct FTSchemaV2: TokenSchema{ 
        ...
        init(identifier: String, contractName: String, storagePath: String, publicPath: String, privatePath: String, type: Type, publicLinkedType: Type, privateLinkedType: Type, receiverStoragePath: String?){ 
            self.identifier = identifier
            self.contractName = contractName
            self.storagePath = storagePath
            self.publicPath = publicPath
        ...
        switch vaultIdentifier{ 
            ...
            case "duc":
                return FTSchemaV2(
                    ...
                    publicLinkedType: Type<
                        @DapperUtilityCoin.Vault{FungibleToken.Receiver}
                    >(),
                    privateLinkedType: Type<
            ...
            case "fut":
                return FTSchemaV2(
                    ...
                    publicLinkedType: Type<
                        @FlowUtilityToken.Vault{FungibleToken.Receiver}
                    >(),
    ...
    pub fun getNftSchema(collectionIdentifier: String): NFTSchema?{ 
        ...
        let privateLinkedType: Type =
            catalogData.collectionData.privateLinkedType
        ...
        let contractName =
            StringUtils.split(catalogData.nftType.identifier, ".")[2]
        return NFTSchema(
    ...
    pub fun createStaticTypeFromType(_ type: Type): String{ 
        ...
        let replaceableType =
            ArrayUtils.mapStrings(types, fun (str: String): String{ 
