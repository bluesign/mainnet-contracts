...
pub contract TransactionTemplates{ 
    ...
    */
    ...
    pub fun NFTInitTemplate(
        ...
        let lines: [[String]] =
            [
                ...
                [
                    "    if signer.borrow<&",
                    (nftSchema!).contractName,
                    ".Collection>(from: ",
                    (nftSchema!).storagePath,
                    ") == nil {"
                ],
                [
                    "      let collection <- ",
    ...
    pub fun StorefrontListItemTemplate(
        ...
        let lines: [[String]] =
            [
                ...
                [
                    "        if acct.borrow<&",
                    (ftSchema!).contractName,
                    ".Vault>(from: ",
                    (ftSchema!).storagePath,
                    ") == nil {"
                ],
                [
                    "            let vault <- ",
                ...
                [
                    "        self.ftReceiver = acct.getCapability<&{FungibleToken.Receiver}>(",
                    (ftSchema!).publicPath,
                    ")!"
                ],
                [
                ...
                [""],
                [
                    "        self.nftProvider = acct.getCapability<&{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>(",
                    (nftSchema!).privatePath,
                    ")!"
                ],
                ...
                [
                    "            self.marketplacesCapability.append(getAccount(marketplace).getCapability<&{FungibleToken.Receiver}>(",
                    (ftSchema!).publicPath,
                    "))"
                ],
                ["        }"],
                ...
                [
                    "            nftType: Type<@",
                    TransactionGenerationUtils.createStaticTypeFromType(
                        (nftSchema!).type
                    ),
                    ">(),"
                ],
    ...
    pub fun StorefrontBuyItemTemplate(
        nftSchema: TransactionGenerationUtils.NFTSchema?,
        ftSchema: TransactionGenerationUtils.FTSchemaV2?,
        params:{ 
            String: String
        ...
        let lines: [[String]] =
            [
                ...
                [
                    "        self.nftCollection = acct.borrow<&",
                    nftPublicLink,
                    ">("
                ],
                ...
                [
                    "            let _commissionRecipientCap = getAccount(commissionRecipient!).getCapability<&{FungibleToken.Receiver}>(",
                    (ftSchema!).publicPath,
                    ")"
                ],
                [
    ...
    pub fun DapperBuyNFTMarketplaceTemplate(
        nftSchema: TransactionGenerationUtils.NFTSchema?,
        ftSchema: TransactionGenerationUtils.FTSchemaV2?,
        params:{ 
            String: String
        ...
        let lines: [[String]] =
            [
                ...
                [
                    "            let collection <- ",
                    (nftSchema!).contractName,
                    ".createEmptyCollection() as! @",
                    (nftSchema!).contractName,
                    ".Collection"
                ],
                [
                    "            buyer.save(<-collection, to: ",
                    (nftSchema!).storagePath,
                    ")"
                ],
                ["        }"],
                ...
                [
                    "        self.mainUtilityCoinVault = dapper.borrow<&",
                    (ftSchema!).contractName,
                    ".Vault>(from: ",
                    (ftSchema!).storagePath,
                    ")"
                ...
                [
                    "        self.nftCollection = buyer.borrow<&",
                    nftPublicLink,
                    ">("
                ],
                ["            from: ", (nftSchema!).storagePath, ""],
    ...
    pub fun StorefrontRemoveItemTemplate(
        nftSchema: TransactionGenerationUtils.NFTSchema?,
        ftSchema: TransactionGenerationUtils.FTSchemaV2?,
        params:{ 
            String: String
    ...
    pub fun DapperCreateListingTemplate(
        nftSchema: TransactionGenerationUtils.NFTSchema?,
        ftSchema: TransactionGenerationUtils.FTSchemaV2?,
        params:{ 
            String: String
        ...
        let lines: [[String]] =
            [
                ...
                [
                    ...
                    (nftSchema!).contractName,
                    ".Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>"
                ],
                ["    let storefront: &NFTStorefrontV2.Storefront"],
                ["    var saleCuts: [NFTStorefrontV2.SaleCut]"],
                [
                ...
                [
                    "        if seller.borrow<&{FungibleToken.Receiver}>(from: ",
                    (ftSchema!).receiverStoragePath ?? "",
                    ") == nil {"
                ],
                [""],
                [
                    "            let dapper = getAccount(",
                    TransactionGenerationUtils.getAddressFromType(
                        (ftSchema!).type
                    ),
                    ")"
                ],
                [
                    "            let dapperFTReceiver = dapper.getCapability<&{FungibleToken.Receiver}>(",
                    (ftSchema!).publicPath,
                    ")!"
                ],
                [""],
                ...
                [
                    "        self.sellerPaymentReceiver = getAccount(seller.address).getCapability<&{FungibleToken.Receiver}>(",
                    (ftSchema!).publicPath,
                    ")"
                ],
                [
                ...
                [
                    "            seller.save(<-collection, to: ",
                    (nftSchema!).storagePath,
                    ")"
                ],
                ["        }"],
                [
                    "        if (seller.getCapability<&",
                    nftPublicLink,
                    ">(",
                    (nftSchema!).publicPath,
                    ").borrow() == nil) {"
                ...
                [""],
                [
                    "        self.nftProvider = seller.getCapability<&",
                    (nftSchema!).contractName,
                    ".Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>(",
                    (nftSchema!).privatePath,
                    ")!"
    ...
    pub fun DapperBuyNFTDirectTemplate(
        nftSchema: TransactionGenerationUtils.NFTSchema?,
        ftSchema: TransactionGenerationUtils.FTSchemaV2?,
        params:{ 
            String: String
    ...
    pub fun DapperGetPrimaryListingMetadataTemplate(
        nftSchema: TransactionGenerationUtils.NFTSchema?,
        ftSchema: TransactionGenerationUtils.FTSchemaV2?,
        params:{ 
            String: String
    ...
    pub fun DapperGetSecondaryListingMetadataTemplate(
        nftSchema: TransactionGenerationUtils.NFTSchema?,
        ftSchema: TransactionGenerationUtils.FTSchemaV2?,
        params:{ 
            String: String
