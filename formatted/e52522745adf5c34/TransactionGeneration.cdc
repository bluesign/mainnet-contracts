...
pub contract TransactionGeneration{ 
    pub fun createTxFromSchemas(
        ...
        let imports =
            TransactionGenerationUtils.createImports(imports: importTypes)
    ...
    pub fun getTx(tx: String, params:{ String: String}): String?{ 
        ...
        switch tx{ 
            ...
            case "StorefrontListItem":
                ...
                importTypes = nftImportTypes.concat(ftImportTypes).concat(
                        storefrontTypes
                    )
            ...
            case "DapperBuyNFTMarketplace":
                createTxCode = fun (
                        ...
                        return TransactionTemplates
                            .DapperBuyNFTMarketplaceTemplate(
                            nftSchema: nftSchema,
                            ftSchema: ftSchema,
                            params: nil
                        )
            ...
            case "DapperGetPrimaryListingMetadata":
                createTxCode = fun (
                        ...
                        return TransactionTemplates
                            .DapperGetPrimaryListingMetadataTemplate(
                            nftSchema: nftSchema,
                            ftSchema: ftSchema,
                            params: nil
                        )
            ...
            case "DapperGetSecondaryListingMetadata":
                createTxCode = fun (
                        ...
                        return TransactionTemplates
                            .DapperGetSecondaryListingMetadataTemplate(
                            nftSchema: nftSchema,
                            ftSchema: ftSchema,
                            params: nil
                        )
