...
pub contract StoreFrontAdmin{ 
    ...
    pub resource interface AdminTokenReceiverPublic{ 
        pub fun receiveAdmin(
            storeFrontId: UInt64,
            adminRef: Capability<&Admin>
        ){} 
        
        pub fun receiveSuperAdmin(
            storeFrontId: UInt64,
            superAdminRef: Capability<&SuperAdmin>
        ){} 
    }
    
    pub resource AdminTokenReceiver: AdminTokenReceiverPublic{ 
        priv var adminRef:{ UInt64: Capability<&Admin>}
        
        priv var superAdminRef:{ UInt64: Capability<&SuperAdmin>}
