...
pub contract LilaiNFT: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: LilaiNFT.CollectionStoragePath, publicPath: LilaiNFT.CollectionPublicPath, providerPath: /private/lilaiNFTCollection, publicCollection: Type<&LilaiNFT.Collection{LilaiNFT.LilaiNFTCollectionPublic}>(), publicLinkedType: Type<&LilaiNFT.Collection{LilaiNFT.LilaiNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&LilaiNFT.Collection{LilaiNFT.LilaiNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&LilaiNFT.Collection{NonFungibleToken.CollectionPublic, LilaiNFT.LilaiNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
