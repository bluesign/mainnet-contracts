...
pub contract beta3LilaiNFT: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: beta3LilaiNFT.CollectionStoragePath, publicPath: beta3LilaiNFT.CollectionPublicPath, providerPath: /private/beta3LilaiNFTCollection, publicCollection: Type<&beta3LilaiNFT.Collection{beta3LilaiNFT.beta3LilaiNFTCollectionPublic}>(), publicLinkedType: Type<&beta3LilaiNFT.Collection{beta3LilaiNFT.beta3LilaiNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&beta3LilaiNFT.Collection{beta3LilaiNFT.beta3LilaiNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource interface NFTMinterPublic{ 
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, thumbnail: String, royalties: [MetadataViews.Royalty], lilaiputiaData: String){} // Note: No return type specified 
    }
    ...
    pub resource NFTMinter: NFTMinterPublic{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, thumbnail: String, royalties: [MetadataViews.Royalty], lilaiputiaData: String){ 
            ...
            var newNFT <- create NFT(id: beta3LilaiNFT.totalSupply, name: name, description: description, thumbnail: thumbnail, royalties: royalties, metadata: metadata, lilaiputia: lilaiputia)
    ...
    init(){ 
        ...
        self.account.link<&beta3LilaiNFT.Collection{NonFungibleToken.CollectionPublic, beta3LilaiNFT.beta3LilaiNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
        // Create and store the minter
        let minter <- create NFTMinter()
        self.account.save(<-minter, to: self.MinterStoragePath)
        // Create a public capability for the minter
        self.account.link<&beta3LilaiNFT.NFTMinter>(self.PublicMinterPath, target: self.MinterStoragePath)
