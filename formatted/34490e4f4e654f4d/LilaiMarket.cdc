...
pub contract LilaiMarket{ 
    ...
    pub resource interface SalePublic{ 
        ...
        pub fun borrowItem(id: UInt64): &LilaiQuest.NFT?{} 
    }
    
    pub resource SaleCollection: SalePublic{ 
        pub var forSale: @LilaiQuest.NFTCollection
        ...
        pub fun listForSale(item: @LilaiQuest.NFT, price: UFix64, caller: Address){ 
        ...
        pub fun withdraw(itemId: UInt64): @LilaiQuest.NFT{ 
        ...
        pub fun purchase(itemId: UInt64, buyTokens: @FungibleToken.Vault): @LilaiQuest.NFT{ 
            pre{ 
