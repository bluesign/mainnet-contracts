...
pub contract beta2LilaiNFT: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: beta2LilaiNFT.CollectionStoragePath, publicPath: beta2LilaiNFT.CollectionPublicPath, providerPath: /private/beta2LilaiNFTCollection, publicCollection: Type<&beta2LilaiNFT.Collection{beta2LilaiNFT.beta2LilaiNFTCollectionPublic}>(), publicLinkedType: Type<&beta2LilaiNFT.Collection{beta2LilaiNFT.beta2LilaiNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&beta2LilaiNFT.Collection{beta2LilaiNFT.beta2LilaiNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&beta2LilaiNFT.Collection{NonFungibleToken.CollectionPublic, beta2LilaiNFT.beta2LilaiNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
        // Create and store the minter
        let minter <- create NFTMinter()
        self.account.save(<-minter, to: self.MinterStoragePath)
        // Create a public capability for the minter
        self.account.link<&beta2LilaiNFT.NFTMinter>(self.PublicMinterPath, target: self.MinterStoragePath)
