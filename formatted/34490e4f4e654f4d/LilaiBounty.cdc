...
pub contract LilaiBounty{ 
    ...
    pub fun approveFulfillment(
        questId: UInt64,
        buyer: Address,
        buyerVaultRef: &FungibleToken.Vault
    ){ 
        ...
        let fulfillerVaultCap =
            getAccount(fulfillment.fulfiller).getCapability<
