...
pub contract beta4LilaiNFT: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: beta4LilaiNFT.CollectionStoragePath, publicPath: beta4LilaiNFT.CollectionPublicPath, providerPath: /private/beta4LilaiNFTCollection, publicCollection: Type<&beta4LilaiNFT.Collection{beta4LilaiNFT.beta4LilaiNFTCollectionPublic}>(), publicLinkedType: Type<&beta4LilaiNFT.Collection{beta4LilaiNFT.beta4LilaiNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&beta4LilaiNFT.Collection{beta4LilaiNFT.beta4LilaiNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun mintNFT(recipientAddress: Address, name: String, description: String, thumbnail: String, royalties: [MetadataViews.Royalty], lilaiputiaData: String){ 
        let recipientAccount = getAccount(recipientAddress)
        let recipientCollection = recipientAccount.getCapability(self.CollectionPublicPath).borrow<&Collection{NonFungibleToken.CollectionPublic}>() ?? panic("Could not borrow a reference to the recipient's collection")
    ...
    init(){ 
        ...
        self.account.link<&beta4LilaiNFT.Collection{NonFungibleToken.CollectionPublic, beta4LilaiNFT.beta4LilaiNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
