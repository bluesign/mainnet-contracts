...
pub contract QRLNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: QRLNFT.CollectionStoragePath, publicPath: QRLNFT.CollectionPublicPath, providerPath: /private/QRLNFTCollection, publicCollection: Type<&QRLNFT.Collection{QRLNFT.QRLNFTCollectionPublic}>(), publicLinkedType: Type<&QRLNFT.Collection{QRLNFT.QRLNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&QRLNFT.Collection{QRLNFT.QRLNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&QRLNFT.Collection{NonFungibleToken.CollectionPublic, QRLNFT.QRLNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
