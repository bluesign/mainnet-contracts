...
pub contract SwaychainNFT: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&SwaychainNFT.Collection{NonFungibleToken.CollectionPublic, SwaychainNFT.SwaychainNFTCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
