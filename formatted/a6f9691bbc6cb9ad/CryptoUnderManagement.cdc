...
pub contract CryptoUnderManagement: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                CryptoUnderManagement.totalSupply = CryptoUnderManagement.totalSupply - self.balance
            }
        }
    }
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(storagePath: CryptoUnderManagement.VaultStoragePath, receiverPath: CryptoUnderManagement.ReceiverPublicPath, metadataPath: CryptoUnderManagement.VaultPublicPath, providerPath: /private/CryptoUnderManagementVault, receiverLinkedType: Type<&Vault{FungibleToken.Receiver}>(), metadataLinkedType: Type<&Vault{FungibleToken.Balance, MetadataViews.Resolver}>(), providerLinkedType: Type<&Vault{FungibleToken.Provider}>(), createEmptyVaultFunction: fun (): @Vault{ 
                        return <-CryptoUnderManagement.createEmptyVault()
                    })
        }
        return nil
    }
