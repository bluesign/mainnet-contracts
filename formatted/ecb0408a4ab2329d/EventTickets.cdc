...
pub contract EventTickets: CapsuleNFT{ 
    ...
    pub event TicketMinted(id: String, ticketId: UInt64, ticketCategory: String, eventName: String, retailPrice: UFix64, mintedTime: String, rarity: String, edition: String, mediaUri: String, resourceId: UInt64)
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintTicket(recipient: &{CapsuleNFT.CollectionPublic}, id: String, ticketId: UInt64, ticketCategory: String, eventName: String, retailPrice: UFix64, mintedTime: String, rarity: String, edition: String, mediaUri: String){ 
    ...
    init(){ 
        ...
        self.account.link<&EventTickets.Collection{CapsuleNFT.CollectionPublic, EventTickets.EventTicketsCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
