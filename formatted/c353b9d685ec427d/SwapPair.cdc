...
pub contract SwapPair: FungibleToken{ 
    ...
    pub event Flashloan(executor: Address, executorType: Type, originator: Address, requestedTokenKey: String, amount: UFix64)
    ...
    priv fun donateInitialMinimumLpToken(donateLpBalance: UFix64){ 
    ...
    priv fun _update(reserve0Last: UFix64, reserve1Last: UFix64){ 
    ...
    pub fun _rootK(balance0: UFix64, balance1: UFix64): UFix64{ 
    ...
    pub resource PairPublic: SwapInterfaces.PairPublic{ 
        ...
        pub fun getPairInfo(): [AnyStruct]{ 
            return [SwapPair.token0Key, // 0 SwapPair.token1Key, SwapPair.token0Vault.balance, SwapPair.token1Vault.balance, SwapPair.account.address, SwapPair.totalSupply, // 5 SwapPair.getSwapFeeBps(), SwapPair.isStableSwap(), SwapPair.getStableCurveP()]
        }
