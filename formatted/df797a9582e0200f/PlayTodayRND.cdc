...
pub contract PlayTodayRND: FungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&PlayTodayRND.Vault{FungibleToken.Balance}>(/public/ptrndBalance, target: /storage/ptrndVault)
        // Create a public capability to the stored Vault that only exposes
        // the `deposit` method through the `Receiver` interface
        self.account.link<&{FungibleToken.Receiver}>(/public/ptrndReceiver, target: /storage/ptrndVault)
