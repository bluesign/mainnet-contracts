...
pub contract PlayTodayRound: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: PlayTodayRound.CollectionStoragePath, publicPath: PlayTodayRound.CollectionPublicPath, providerPath: /private/PlayTodayRoundCollection, publicCollection: Type<&PlayTodayRound.Collection{PlayTodayRound.PlayTodayRoundCollectionPublic}>(), publicLinkedType: Type<&PlayTodayRound.Collection{PlayTodayRound.PlayTodayRoundCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&PlayTodayRound.Collection{PlayTodayRound.PlayTodayRoundCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, game_id: UInt64, user_id: UInt64, creator: Address, hash: String, royalties: [MetadataViews.Royalty]){ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &PlayTodayRound.NFT?{ 
        let collection = (getAccount(from).getCapability(PlayTodayRound.CollectionPublicPath)!).borrow<&PlayTodayRound.Collection{PlayTodayRound.PlayTodayRoundCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&PlayTodayRound.Collection{NonFungibleToken.CollectionPublic, PlayTodayRound.PlayTodayRoundCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
