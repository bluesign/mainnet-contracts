...
pub contract PlayTodayNFTV2: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: PlayTodayNFTV2.CollectionStoragePath, publicPath: PlayTodayNFTV2.CollectionPublicPath, providerPath: /private/playTodayNFTCollection, publicCollection: Type<&PlayTodayNFTV2.Collection{PlayTodayNFTV2.PlayTodayNFTV2CollectionPublic}>(), publicLinkedType: Type<&PlayTodayNFTV2.Collection{PlayTodayNFTV2.PlayTodayNFTV2CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&PlayTodayNFTV2.Collection{PlayTodayNFTV2.PlayTodayNFTV2CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, creator: Address, rarity: Rarity, uri: String, name: String, description: String, badgeUri: String, royalties: [MetadataViews.Royalty]){ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &PlayTodayNFTV2.NFT?{ 
        let collection = (getAccount(from).getCapability(PlayTodayNFTV2.CollectionPublicPath)!).borrow<&PlayTodayNFTV2.Collection{PlayTodayNFTV2.PlayTodayNFTV2CollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&PlayTodayNFTV2.Collection{NonFungibleToken.CollectionPublic, PlayTodayNFTV2.PlayTodayNFTV2CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
