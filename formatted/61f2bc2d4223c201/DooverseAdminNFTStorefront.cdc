...
pub contract DooverseAdminNFTStorefront{ 
    ...
    pub struct PaymentOption{ 
        ...
        init(salePaymentVaultType: Type, saleCuts: [SaleCut]){ 
            ...
            assert(
                salePrice >= 0.0,
                message: "Listing must have nonnegative price"
            )
    ...
    pub resource interface ListingPublic{ 
        ...
        pub fun purchase(
            ...
            nftCollectionCapability: Capability<
    ...
    pub resource Listing: ListingPublic{ 
        ...
        priv fun findValidPaymentOption(vaultType: Type, balance: UFix64): PaymentOption?{ 
        ...
        //
        pub fun purchase(payment: @FungibleToken.Vault, nftCollectionCapability: Capability<&{NonFungibleToken.CollectionPublic}>){ 
            pre{ 
            ...
            let minter = DooverseAdminNFTStorefront.account.borrow<&DooverseItems.NFTMinter>(from: DooverseItems.MinterStoragePath) ?? panic("Could not borrow a reference to the NFT minter")
    ...
    pub resource interface StorefrontPublic{ 
        ...
        pub fun borrowListings(setID: String): &{
            String: Listing{ListingPublic}
        }?{} 
        
        pub fun borrowListing(setID: String, packID: String): &Listing{
            ListingPublic
        }?{} 
    ...
    pub resource Storefront: StorefrontPublic, StorefrontManager{ 
        ...
        priv var listings: @{String:{ String: Listing}}
        ...
        pub fun createListing(setID: String, packID: String, metadatas: [{String: String}], paymentOptions: [PaymentOption]): String{ 
    ...
    init(){ 
        ...
        self.account.link<&Storefront{StorefrontPublic}>(
            self.StorefrontPublicPath,
            target: self.StorefrontStoragePath
        )
