...
pub contract Boulder: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: Boulder.CollectionStoragePath, publicPath: Boulder.CollectionPublicPath, providerPath: Boulder.CollectionPrivatePath, publicCollection: Type<&Boulder.Collection{Boulder.BoulderCollectionPublic}>(), publicLinkedType: Type<&Boulder.Collection{Boulder.BoulderCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Boulder.Collection{Boulder.BoulderCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Admin{ 
        ...
        ///
        pub fun mintNFT(image: String, serialNumber: UInt64, name: String, description: String): @Boulder.NFT{ 
