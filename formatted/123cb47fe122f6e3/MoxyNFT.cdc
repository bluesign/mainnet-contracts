...
pub contract MoxyNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MoxyNFT.CollectionStoragePath, publicPath: MoxyNFT.CollectionPublicPath, providerPath: /private/moxyNFTCollection, publicCollection: Type<&MoxyNFT.Collection{MoxyNFT.MoxyNFTCollectionPublic}>(), publicLinkedType: Type<&MoxyNFT.Collection{MoxyNFT.MoxyNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MoxyNFT.Collection{MoxyNFT.MoxyNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        access(contract) fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, catalogId: UInt64, editionId: UInt64, royalties: [MetadataViews.Royalty], edition: UInt64){ 
            pre{ 
                MoxyNFT.editions[editionId] != nil:
                    "The edition does not exists."
            }
        ...
        pub fun batchMintNFT(recipient: &{NonFungibleToken.CollectionPublic}, catalogId: UInt64, name: String, description: String, thumbnail: String, cid: String, rarityDescription: String, royalties: [MetadataViews.Royalty], maxEdition: UInt64){ 
            pre{ 
        ...
        pub fun processMintRequest(quantity: UInt64){ 
            ...
            let recipientRef = getAccount((MoxyNFT.mintRequest!).recipient).getCapability(MoxyNFT.CollectionPublicPath).borrow<&{NonFungibleToken.CollectionPublic}>() ?? panic("Could not get receiver reference to the NFT Collection")
        ...
        pub fun addCatalog(name: String, description: String, externalURL: String, squareImage: String, bannerImage: String, socials:{ String: MetadataViews.ExternalURL}){ 
    ...
    init(){ 
        ...
        self.account.link<&MoxyNFT.Collection{NonFungibleToken.CollectionPublic, MoxyNFT.MoxyNFTCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
