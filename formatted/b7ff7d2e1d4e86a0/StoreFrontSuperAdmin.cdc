...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xb7ff7d2e1d4e86a0
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xb7ff7d2e1d4e86a0
