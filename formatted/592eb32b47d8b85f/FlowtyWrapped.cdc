...
pub contract FlowtyWrapped: NonFungibleToken, ViewResolver{ 
    ...
    access(account) fun mint(id: UInt64, serial: UInt64, editionName: String, address: Address, data:{ String: AnyStruct}): @NFT{ 
    ...
    init(){ 
        ...
        self.account.link<&FlowtyWrapped.Collection{NonFungibleToken.CollectionPublic, FlowtyWrapped.FlowtyWrappedCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
