...
pub contract JoyrideGameShim{ 
    ...
    pub resource JoyrideGame: JoyrideGameData, JoyridePayments.WalletAdmin{ 
        priv let gameInfo:{ String: AnyStruct}
        
        priv var paymentsAdmin: Capability<&{JoyridePayments.WalletAdmin}>
