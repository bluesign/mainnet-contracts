...
pub contract ExperiaNFTContract: NonFungibleToken{ 
    ...
    pub resource Collection: CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic{ 
        ...
        /*Function borrow Experia View NFT*/        pub fun borrowExperiaNFT(id: UInt64): &ExperiaNFTContract.NFT?{ 
    ...
    pub resource NFTMinter{ 
        pub fun createNFTTemplate(name: String, metadata:{ String: AnyStruct}, thumbnail: String, description: String, amountToCreate: UInt64, maximum: UInt64, collection: Capability<&ExperiaNFTContract.Collection{NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic}>): @NFTTemplate{ 
