...
pub contract FlowtyTestNFT: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FlowtyTestNFT.CollectionStoragePath, publicPath: FlowtyTestNFT.CollectionPublicPath, providerPath: /private/FlowtyTestNFTCollection, publicCollection: Type<&FlowtyTestNFT.Collection{FlowtyTestNFT.FlowtyTestNFTCollectionPublic}>(), publicLinkedType: Type<&FlowtyTestNFT.Collection{FlowtyTestNFT.FlowtyTestNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FlowtyTestNFT.Collection{FlowtyTestNFT.FlowtyTestNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&FlowtyTestNFT.Collection{NonFungibleToken.CollectionPublic, FlowtyTestNFT.FlowtyTestNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
