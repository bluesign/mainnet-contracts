...
pub contract FantastecNFT: NonFungibleToken, ViewResolver{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv fun concatenateStrings(_ strings: [String?]): String{ 
            var res = ""
        ...
        priv fun getCard(): FantastecSwapDataV2.CardData?{ 
            let card = FantastecSwapDataV2.getCardById(id: self.cardId)
            return card
        }
        
        priv fun getCardCollection(): FantastecSwapDataV2.CardCollectionData?{ 
        ...
        priv fun getCardRoyalties(): [MetadataViews.Royalty]{ 
            let card = self.getCard()
        ...
        priv fun getCardMintVolume(): FantastecSwapDataProperties.MintVolume?{ 
            let card = self.getCard()
            let cardMetadata = card?.metadata ??{} 
        ...
        priv fun getCardMediaFile(_ mediaType: String): MetadataViews.HTTPFile{ 
            let card = self.getCard()
            let cardMetadata = card?.metadata ??{} 
        ...
        priv fun getCardCollectionMediaFile(_ mediaType: String): MetadataViews.HTTPFile{ 
        ...
        priv fun getCardCollectionSocials():{ String: MetadataViews.ExternalURL}{ 
            let cardCollection = self.getCardCollection()
            let cardCollectionMetadata = cardCollection?.metadata ??{} 
        ...
        priv fun getCardCollectionPartner(): FantastecSwapDataProperties.Partner?{ 
            let cardCollection = self.getCardCollection()
            let cardCollectionMetadata = cardCollection?.metadata ??{} 
        ...
        priv fun getCardCollectionTeam(): FantastecSwapDataProperties.Team?{ 
            let cardCollection = self.getCardCollection()
            let cardCollectionMetadata = cardCollection?.metadata ??{} 
        ...
        priv fun getCardCollectionSeason(): FantastecSwapDataProperties.Season?{ 
            let cardCollection = self.getCardCollection()
            let cardCollectionMetadata = cardCollection?.metadata ??{} 
        ...
        priv fun getCardCollectionPlayer(): FantastecSwapDataProperties.Player?{ 
            let card = self.getCard()
            let cardMetadata = card?.metadata ??{} 
        ...
        priv fun getCardCollectionRedeemInfo(): FantastecSwapDataProperties.RedeemInfoV2?{ 
            let card = self.getCard()
            let cardMetadata = card?.metadata ??{} 
        ...
        priv fun getNFTCollectionDisplayDescription(): String{ 
            let cardCollection = self.getCardCollection()
        ...
        priv fun extractLevelFromMetadata(metadata:{ String: [AnyStruct{FantastecSwapDataProperties.MetadataElement}]}): FantastecSwapDataProperties.Level?{ 
        ...
        priv fun getNFTLevel(): FantastecSwapDataProperties.Level?{ 
        ...
        priv fun getNFTMintVolume(): UInt64?{ 
        ...
        priv fun getTraits(): MetadataViews.Traits{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Medias>():
                    ...
                    if animation.uri() != ""{ 
                        let animationMedia = MetadataViews.Media(file: animation, type: "video/mp4")
                        items.append(animationMedia)
                    }
                    let frame = self.getCardMediaFile("CARD_FRAME")
                    if frame.uri() != ""{ 
                        let frameMedia = MetadataViews.Media(file: frame, type: "video/mp4")
                        items.append(frameMedia)
                    }
                    let image = self.getCardMediaFile("CARD_IMAGE")
                    if image.uri() != ""{ 
                        let imageMedia = MetadataViews.Media(file: image, type: "image/png") // TODO: get file extensiuon
                        items.append(imageMedia)
                    }
                    let thumbnail = self.getCardMediaFile("CARD_THUMBNAIL")
                    if thumbnail.uri() != ""{ 
                        let thumbnailMedia = MetadataViews.Media(file: thumbnail, type: "image/jpeg")
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FantastecNFT.CollectionStoragePath, publicPath: FantastecNFT.CollectionPublicPath, providerPath: /private/FantastecNFTCollection, publicCollection: Type<&FantastecNFT.Collection{FantastecNFT.FantastecNFTCollectionPublic}>(), publicLinkedType: Type<&FantastecNFT.Collection{FantastecNFT.FantastecNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FantastecNFT.Collection{NonFungibleToken.CollectionPublic, FantastecNFT.FantastecNFTCollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    let squareImageMedia = MetadataViews.Media(file: self.getCardCollectionMediaFile("COLLECTION_LOGO_IMAGE"), type: "image/png")
                    let bannerImageMedia = MetadataViews.Media(file: self.getCardCollectionMediaFile("COLLECTION_HEADER_IMAGE"), type: "image/png")
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintAndReturnNFT(cardId: UInt64, edition: UInt64, mintNumber: UInt64, licence: String, dateMinted: String, metadata:{ String: String}): @FantastecNFT.NFT{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, cardId: UInt64, edition: UInt64, mintNumber: UInt64, licence: String, dateMinted: String, metadata:{ String: String}){ 
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            case Type<MetadataViews.NFTCollectionData>():
                return MetadataViews.NFTCollectionData(storagePath: FantastecNFT.CollectionStoragePath, publicPath: FantastecNFT.CollectionPublicPath, providerPath: /private/FantastecNFTCollection, publicCollection: Type<&FantastecNFT.Collection{FantastecNFT.FantastecNFTCollectionPublic}>(), publicLinkedType: Type<&FantastecNFT.Collection{FantastecNFT.FantastecNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FantastecNFT.Collection{FantastecNFT.FantastecNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                        return <-FantastecNFT.createEmptyCollection()
                    })
            case Type<MetadataViews.NFTCollectionDisplay>():
