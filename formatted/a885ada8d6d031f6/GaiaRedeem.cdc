...
pub contract GaiaRedeem{ 
    ...
    pub resource Redeemer: RedeemerAdmin, RedeemerPublic{ 
        priv let redeemables:{ Type:{ UInt64: RedeemableInfo}}
    ...
    init(){ 
        ...
        self.account.link<&{RedeemerPublic}>(
            self.getRedeemerPublicPath(),
            target: self.getRedeemerStoragePath()
        )
