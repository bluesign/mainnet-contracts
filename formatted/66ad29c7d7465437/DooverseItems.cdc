...
pub contract DooverseItems: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: DooverseItems.CollectionStoragePath, publicPath: DooverseItems.CollectionPublicPath, providerPath: /private/DooverseItemsCollection, publicCollection: Type<&DooverseItems.Collection{DooverseItems.DooverseItemsCollectionPublic, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&DooverseItems.Collection{DooverseItems.DooverseItemsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&DooverseItems.Collection{DooverseItems.DooverseItemsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &DooverseItems.NFT?{ 
        let collection = getAccount(from).getCapability(DooverseItems.CollectionPublicPath).borrow<&DooverseItems.Collection{DooverseItems.DooverseItemsCollectionPublic}>() ?? panic("Couldn't get collection")
