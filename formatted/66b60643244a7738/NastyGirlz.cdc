        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    let royaltyReceiverCap = getAccount(NastyGirlz.royaltyAddress()).getCapability<&{FungibleToken.Receiver}>(/public/dapperUtilityCoinReceiver)
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: NastyGirlz.CollectionStoragePath, publicPath: NastyGirlz.CollectionPublicPath, providerPath: NastyGirlz.CollectionPrivatePath, publicCollection: Type<@NastyGirlz.Collection>(), publicLinkedType: Type<&NastyGirlz.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&NastyGirlz.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-NastyGirlz.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return MetadataViews.NFTCollectionDisplay(name: "Driverz", description: "An exclusive collection of energetic Driverz ready to vroom vroom on FLOW.", externalURL: NastyGirlz.externalURL(), squareImage: MetadataViews.Media(file: MetadataViews.IPFSFile(cid: NastyGirlz.squareImageCID(), path: nil), mediaType: "image/svg+xml"), bannerImage: MetadataViews.Media(file: MetadataViews.IPFSFile(cid: NastyGirlz.bannerImageCID(), path: nil), mediaType: "image/svg+xml"), socials:{ "twitter": MetadataViews.ExternalURL("https://twitter.com/NastyGirlz"), "instagram": MetadataViews.ExternalURL("https://www.instagram.com/NastyGirlz/")})
            }
            return nil
        }
