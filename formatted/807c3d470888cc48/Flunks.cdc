...
pub contract Flunks: NonFungibleToken{ 
    ...
    priv var FlunksTemplates:{ UInt64: FlunksTemplate}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Flunks.CollectionStoragePath, publicPath: Flunks.CollectionPublicPath, providerPath: /private/FlunksPrivateProvider, publicCollection: Type<&Flunks.Collection{NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&Flunks.Collection{NonFungibleToken.CollectionPublic, Flunks.FlunksCollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Flunks.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
