...
pub contract FlunksGraduation{ 
    ...
    priv var GraduatedFlunks:{ UInt64: Bool}
    
    priv var GraduationTime:{ UInt64: UInt64}
    
    priv var tokenIDToUri:{ UInt64: String}
    ...
    pub fun graduateFlunk(owner: AuthAccount, tokenID: UInt64){ 
        ...
        let collection =
            getAccount(owner.address).getCapability<
        ...
        let admin =
            self.account.borrow<&Flunks.Admin>(from: Flunks.AdminStoragePath)
        ...
        adminSet.updateTemplateMetadata(
    ...
    pub resource Admin{ 
        ...
        pub fun alfredGraduatesForYa(
            ...
            // Update the NFT metadata and traits on-chain
            let admin =
                FlunksGraduation.account.borrow<&Flunks.Admin>(
        ...
        pub fun refreshGraduatedMetadata(
            ownerAddress: Address,
            templateID: UInt64,
            tokenID: UInt64
        ){ 
