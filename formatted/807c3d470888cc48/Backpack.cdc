...
pub contract Backpack: NonFungibleToken{ 
    ...
    priv var BackpackTemplates:{ UInt64: BackpackTemplate}
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv let patches: @Patch.Collection
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Backpack.CollectionStoragePath, publicPath: Backpack.CollectionPublicPath, providerPath: /private/BackpackPrivateProvider, publicCollection: Type<&Backpack.Collection{NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&Backpack.Collection{NonFungibleToken.CollectionPublic, Backpack.BackpackCollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Backpack.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    return MetadataViews.Royalties(cutInfos: [MetadataViews.Royalty(recepient: merchant.getCapability<&{FungibleToken.Receiver}>(/public/dapperUtilityCoinReceiver), cut: 0.05, description: "Flunks creator royalty in DUC")])
            }
            return nil
        }
