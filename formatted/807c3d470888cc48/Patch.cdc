...
pub contract Patch: NonFungibleToken{ 
    ...
    priv var PatchTemplates:{ UInt64: PatchTemplate}
    
    priv var tokenMintedPerType:{ UInt64: UInt64}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Patch.CollectionStoragePath, publicPath: Patch.CollectionPublicPath, providerPath: /private/PatchPrivateProvider, publicCollection: Type<&Patch.Collection{NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&Patch.Collection{NonFungibleToken.CollectionPublic, Patch.PatchCollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Patch.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
