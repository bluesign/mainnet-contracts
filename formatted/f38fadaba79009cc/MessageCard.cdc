...
pub contract MessageCard: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MessageCard.CollectionStoragePath, publicPath: MessageCard.CollectionPublicPath, providerPath: MessageCard.CollectionPrivatePath, publicCollection: Type<&Collection{CollectionPublic}>(), publicLinkedType: Type<&Collection{CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
        ...
        init(params:{ String: AnyStruct}, templatesCapability: Capability<&Templates{TemplatesPublic}>, templateId: UInt64){ 
            post{ 
                self.isValidTemplate():
                    "Invalid template"
            }
    ...
    pub resource Templates: TemplatesPublic{ 
        ...
        pub fun createTemplate(name: String, description: String, renderer:{ IRenderer}): UInt64{ 
    ...
    pub fun mint(params:{ String: AnyStruct}, templatesCapability: Capability<&Templates{TemplatesPublic}>, templateId: UInt64): @NFT{ 
