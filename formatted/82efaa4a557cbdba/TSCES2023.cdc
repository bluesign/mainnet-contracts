...
pub contract TSCES2023: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TSCES2023.CollectionStoragePath, publicPath: TSCES2023.CollectionPublicPath, providerPath: /private/exampleNFTCollection, publicCollection: Type<&TSCES2023.Collection{TSCES2023.TSCES2023CollectionPublic}>(), publicLinkedType: Type<&TSCES2023.Collection{TSCES2023.TSCES2023CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TSCES2023.Collection{TSCES2023.TSCES2023CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&TSCES2023.Collection{NonFungibleToken.CollectionPublic, TSCES2023.TSCES2023CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
