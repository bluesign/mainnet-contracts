...
pub contract TSWebinar2022: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TSWebinar2022.CollectionStoragePath, publicPath: TSWebinar2022.CollectionPublicPath, providerPath: /private/exampleNFTCollection, publicCollection: Type<&TSWebinar2022.Collection{TSWebinar2022.TSWebinar2022CollectionPublic}>(), publicLinkedType: Type<&TSWebinar2022.Collection{TSWebinar2022.TSWebinar2022CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TSWebinar2022.Collection{TSWebinar2022.TSWebinar2022CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&TSWebinar2022.Collection{NonFungibleToken.CollectionPublic, TSWebinar2022.TSWebinar2022CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
