...
pub contract Mist{ 
    ...
    pub resource interface IRafflePublic{ 
        ...
        pub fun checkRegistrationEligibility(
            account: Address,
            params:{ 
                String: AnyStruct
            }
        ...
        pub fun getRegistrationVerifiers():{ 
            String: [{
                EligibilityVerifiers.IEligibilityVerifier}
            ]
        }{} 
        
        pub fun getClaimVerifiers():{ 
            String: [{
                EligibilityVerifiers.IEligibilityVerifier}
            ]
        }{} 
    ...
    pub resource Raffle: IRafflePublic{ 
        ...
        priv let rewardDisplays:{ UInt64: NFTDisplay}
        ...
        priv fun isEligible(account: Address, mode: EligibilityVerifiers.VerifyMode, verifiers: &{String: [{EligibilityVerifiers.IEligibilityVerifier}]}, params:{ String: AnyStruct}): Bool{ 
        ...
        destroy(){ 
            pre{ 
                self.collection.getIDs().length == 0:
                    "collection is not empty, please withdraw all NFTs before delete Raffle"
            }
