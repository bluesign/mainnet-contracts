pub contract FlowviewAccountBookmark{ 
    ...
    pub event AccountBookmarkAdded(
        owner: Address,
        address: Address,
        note: String
    )
    ...
    pub resource interface CollectionPublic{ 
        pub fun borrowPublicAccountBookmark(address: Address): &AccountBookmark{
            AccountBookmarkPublic
        }?{} 
        
        pub fun getAccountBookmarks(): &{
            Address: AccountBookmark{AccountBookmarkPublic}
        }{} 
    }
    ...
    init(){ 
        self
            .AccountBookmarkCollectionStoragePath = /storage/flowviewAccountBookmarkCollection
        self
            .AccountBookmarkCollectionPublicPath = /public/flowviewAccountBookmarkCollection
        self
            .AccountBookmarkCollectionPrivatePath = /private/flowviewAccountBookmarkCollection
