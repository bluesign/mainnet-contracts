...
pub contract Cloud{ 
    ...
    pub struct TokenInfo{ 
        ...
        init(
            ...
            self.tokenIdentifier = "A.".concat(addrTrimmed).concat(".").concat(
                    contractName
                )
    ...
    pub resource Drop: IDropPublic{ 
        ...
        priv let dropVault: @FungibleToken.Vault
        ...
        priv fun combinedParams(params:{ String: AnyStruct}):{ String: AnyStruct}{ 
        ...
        destroy(){ 
            pre{ 
                self.dropVault.balance == 0.0:
                    "dropVault is not empty, please withdraw all funds before delete DROP"
            }
