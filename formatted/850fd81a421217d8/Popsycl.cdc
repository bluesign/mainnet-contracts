...
pub contract Popsycl: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv fun genRoyalities(): [MetadataViews.Royalty]{ 
            ...
            // Creator Royalty
            royalties.append(MetadataViews.Royalty(receiver: getAccount(self.creator!).getCapability<&FungibleToken.Vault{FungibleToken.Receiver}>(self.getFlowRoyaltyReceiverPublicPath()), cut: UFix64(self.royality / 100.0), description: "Creator Royalty"))
            
            // DisruptArt Market Fee
            royalties.append(MetadataViews.Royalty(receiver: getAccount(PopsyclRates.PopsyclMarketAddress).getCapability<&FungibleToken.Vault{FungibleToken.Receiver}>(self.getFlowRoyaltyReceiverPublicPath()), cut: UFix64(PopsyclRates.PopsyclMarketplaceFees), description: "Popsycl Market Fee"))
            return royalties
        }
