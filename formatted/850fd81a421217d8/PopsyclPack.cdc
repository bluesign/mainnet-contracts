...
pub contract PopsyclPack: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        // NFTs store 
        priv let packs: @{UInt64: Popsycl.NFT}
    ...
    init(){ 
        ...
        self.account.save(<-create NFT(id: 1, name: "pack name", royalty: 10.0, creator: 0x850fd81a421217d8, influencer: 0x5dc999f0bb011052), to: self.PopsyclPackMinterPath)
