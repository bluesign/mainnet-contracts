...
pub contract BigMinter: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: BigMinter.CollectionStoragePath, publicPath: BigMinter.CollectionPublicPath, providerPath: BigMinter.CollectionPrivatePath, publicCollection: Type<&BigMinter.Collection{BigMinter.BigMinterCollectionPublic}>(), publicLinkedType: Type<&BigMinter.Collection{BigMinter.BigMinterCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&BigMinter.Collection{BigMinter.BigMinterCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
