...
pub contract StarlyUsdtSwapPair: FungibleToken{ 
    ...
    pub fun createEmptyTokenBundle(): @StarlyUsdtSwapPair.TokenBundle{ 
        return <-create TokenBundle(fromToken1: <-(StarlyToken.createEmptyVault() as! @StarlyToken.Vault), fromToken2: <-(TeleportedTetherToken.createEmptyVault() as! @TeleportedTetherToken.Vault))
    }
