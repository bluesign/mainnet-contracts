...
pub contract IconoGraphika: NonFungibleToken{ 
    pub struct IconoGraphikaDisplay{ 
        ...
        init(itemId: UInt64, name: String, collectionName: String, collectionDescription: String, shortDescription: String, fullDescription: String, creatorName: String, mintDateTime: UInt64, mintLocation: String, copyrightHolder: String, minterName: String, fileFormat: String, propertyObjectType: String, propertyColour: String, rightsAndObligationsSummary: String, rightsAndObligationsFullText: String, editionSize: UInt64, editionNumber: UInt64, fileSizeMb: UFix64, imageCID: AnyStruct{MetadataViews.File}){ 
            self.itemId = itemId
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: self.name, description: self.shortDescription, image: MetadataViews.IPFSFile(cid: self.imageCID, path: nil))
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(url: "https://iconographika.com/")
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: IconoGraphika.CollectionStoragePath, publicPath: IconoGraphika.CollectionPublicPath, providerPath: /private/IconoGraphikaCollection, publicCollection: Type<&IconoGraphika.Collection{IconoGraphika.IconoGraphikaCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&IconoGraphika.Collection{IconoGraphika.IconoGraphikaCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&IconoGraphika.Collection{IconoGraphika.IconoGraphikaCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-IconoGraphika.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return MetadataViews.NFTCollectionDisplay(name: self.collectionName, description: self.collectionDescription, externalURL: MetadataViews.ExternalURL(url: "https://iconographika.com/"), squareImage: MetadataViews.Media(file: MetadataViews.IPFSFile(cid: self.collectionSquareImageCID, path: nil), mediaType: "image/png"), bannerImage: MetadataViews.Media(file: MetadataViews.IPFSFile(cid: self.collectionBannerImageCID, path: nil), mediaType: "image/png"), socials:{} )
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties(royalties: self.royalties)
                case Type<MetadataViews.Traits>():
                    return MetadataViews.Traits([MetadataViews.Trait(name: "NFT Creator", value: self.creatorName, displayType: nil, royalty: nil), MetadataViews.Trait(name: "NFT Copyright Holder", value: self.copyrightHolder, displayType: nil, royalty: nil), MetadataViews.Trait(name: "Minter Name", value: self.minterName, displayType: nil, royalty: nil), MetadataViews.Trait(name: "NFT Mint Date", value: self.mintDateTime, displayType: "Date", royalty: nil), MetadataViews.Trait(name: "NFT Mint Location", value: self.mintLocation, displayType: nil, royalty: nil), MetadataViews.Trait(name: "NFT Rights and Obligations Summary", value: self.rightsAndObligationsSummary, displayType: nil, royalty: nil), MetadataViews.Trait(name: "NFT Rights and Obligations Full", value: self.rightsAndObligationsFullText, displayType: nil, royalty: nil), MetadataViews.Trait(name: "NFT Object Type", value: self.propertyObjectType, displayType: nil, royalty: nil), MetadataViews.Trait(name: "NFT Color", value: self.propertyColour, displayType: nil, royalty: nil)])
                case Type<MetadataViews.Editions>():
                    return MetadataViews.Editions(infoList: [MetadataViews.Edition(name: nil, number: self.editionNumber, max: self.editionSize)])
            }
            return nil
        }
    }
    ...
    init(){ 
        ...
        self.account.link<&IconoGraphika.Collection{NonFungibleToken.CollectionPublic, IconoGraphika.IconoGraphikaCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
