...
pub contract SturdyTokens: NonFungibleToken{ 
    ...
    priv var sturdyTokensTemplates:{ UInt64: SturdyTokensTemplate}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: SturdyTokens.CollectionStoragePath, publicPath: SturdyTokens.CollectionPublicPath, providerPath: /private/SturdyTokensCollection, publicCollection: Type<&SturdyTokens.Collection{SturdyTokens.SturdyTokensCollectionPublic}>(), publicLinkedType: Type<&SturdyTokens.Collection{SturdyTokens.SturdyTokensCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&SturdyTokens.Collection{SturdyTokens.SturdyTokensCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    for royalty in setRoyalties{ 
                        royalties.append(MetadataViews.Royalty(receiver: getAccount(royalty.address).getCapability<&{FungibleToken.Receiver}>(/public/dapperUtilityCoinReceiver), cut: 0.05, description: royalty.description))
                    }
