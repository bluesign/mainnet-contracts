...
pub contract Analogs: NonFungibleToken{ 
    ...
    priv var analogsTemplates:{ UInt64: AnalogsTemplate}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Analogs.CollectionStoragePath, publicPath: Analogs.CollectionPublicPath, providerPath: /private/AnalogsCollection, publicCollection: Type<&Analogs.Collection{Analogs.AnalogsCollectionPublic}>(), publicLinkedType: Type<&Analogs.Collection{Analogs.AnalogsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Analogs.Collection{Analogs.AnalogsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    for royalty in setRoyalties{ 
                        royalties.append(MetadataViews.Royalty(receiver: getAccount(royalty.address).getCapability<&{FungibleToken.Receiver}>(/public/flowUtilityTokenReceiver), cut: royalty.secondaryCut, description: royalty.description))
                    }
