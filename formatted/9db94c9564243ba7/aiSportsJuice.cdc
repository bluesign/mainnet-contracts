...
pub contract aiSportsJuice: FungibleToken, ViewResolver{ 
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(storagePath: aiSportsJuice.VaultStoragePath, receiverPath: aiSportsJuice.ReceiverPublicPath, metadataPath: aiSportsJuice.VaultPublicPath, providerPath: /private/aiSportsJuiceVault, receiverLinkedType: Type<&Vault{FungibleToken.Receiver}>(), metadataLinkedType: Type<&Vault{FungibleToken.Balance, MetadataViews.Resolver}>(), providerLinkedType: Type<&Vault{FungibleToken.Provider}>(), createEmptyVaultFunction: fun (): @Vault{ 
                        return <-aiSportsJuice.createEmptyVault()
                    })
        }
        return nil
    }
