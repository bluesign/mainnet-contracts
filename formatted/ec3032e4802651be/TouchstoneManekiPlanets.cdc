...
pub contract TouchstoneManekiPlanets: NonFungibleToken{ 
    ...
    init(_name: String, _description: String, _imagePath: String, _bannerImagePath: String?, _minting: Bool, _royalty: MetadataViews.Royalty?, _defaultPrice: UFix64, _paymentType: String, _ipfsCID: String, _lotteryBuying: Bool, _socials:{ String: MetadataViews.ExternalURL}, _mintVerifiers: [{MintVerifiers.IVerifier}]){ 
        ...
        self.CollectionStoragePath = /storage/TouchstoneManekiPlanetsCollection_0xec3032e4802651be
        self.CollectionPublicPath = /public/TouchstoneManekiPlanetsCollection_0xec3032e4802651be
        self.CollectionPrivatePath = /private/TouchstoneManekiPlanetsCollection_0xec3032e4802651be
        self.AdministratorStoragePath = /storage/TouchstoneManekiPlanetsAdministrator_0xec3032e4802651be
