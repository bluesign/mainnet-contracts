...
pub contract testCollection: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&testCollection.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, testCollection.testCollectionCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
