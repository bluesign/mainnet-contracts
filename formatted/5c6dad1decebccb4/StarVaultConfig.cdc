pub contract StarVaultConfig{ 
    ...
    priv let vaultFees:{ Int: VaultFees}
    
    pub event UpdateGlobalFees(
        mintFee: UFix64,
        randomRedeemFee: UFix64,
        targetRedeemFee: UFix64,
        randomSwapFee: UFix64,
    ...
    pub fun sliceTokenTypeIdentifierFromCollectionType(
    ...
    pub resource Admin{ 
        ...
        pub fun setFeeTo(feeToAddr: Address){ 
            emit FeeToAddressChanged(
                oldFeeTo: StarVaultConfig.feeTo,
                newFeeTo: feeToAddr
            )
        ...
        pub fun setFeeRatio(feeRatio: UFix64){ 
            ...
            emit FeeRatioChanged(
                oldFeeRatio: StarVaultConfig.feeRatio,
                newFeeRatio: feeRatio
            )
    ...
    init(){ 
        ...
        self
            .VaultTokenCollectionPublicPath = /public/star_vault_token_collection
        self
            .VaultTokenCollectionStoragePath = /storage/star_vault_token_collection
        self.PoolPublicPath = /public/star_vault_reward_pool
        self.PoolStoragePath = /storage/star_vault_reward_pool
        self
            .LPStakingCollectionStoragePath = /storage/star_vault_lpstaking_collection
        self
            .LPStakingCollectionPublicPath = /public/star_vault_lpstaking_collection
        ...
        destroy <-self.account.load<@AnyResource>(
            from: self.ConfigAdminStoragePath
        )
