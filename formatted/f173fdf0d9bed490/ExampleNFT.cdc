...
pub contract ExampleNFT: NonFungibleToken{ 
    ...
    pub resource Collection: ExampleNFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            let mlNFT = nft as! &ExampleNFT.NFT
            return mlNFT
        }
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, metadata:{ String: String}): &NonFungibleToken.NFT{ 
            ...
            // create a new NFT
            var newNFT <- create NFT(id: ExampleNFT.totalSupply, creator: creator, metadata: metadata)
    ...
    init(){ 
        ...
        // Set the named paths
        self.CollectionStoragePath = /storage/MatrixMarketExampleNFTCollection
        self.CollectionPublicPath = /public/MatrixMarketExampleNFTCollection
        self.MinterStoragePath = /storage/MatrixMarketExampleNFTMinter
        self.MinterPublicPath = /public/MatrixMarketExampleNFTMinter
        ...
        self.account.link<&ExampleNFT.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, ExampleNFT.ExampleNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
