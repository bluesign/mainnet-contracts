...
pub contract KOTD: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    ...
                    return MetadataViews.Display(name: metadata["title"] ?? "KOTD NFT", description: metadata["description"] ?? "Official KOTD NFT", thumbnail: MetadataViews.HTTPFile(url: metadata["posterUrl"] ?? "ipfs://bafybeidy62mofvdpzr5gujq57kcpm27pciqx33pahxbfuwgzea646k2nay/s1_poster.jpg"))
                case Type<MetadataViews.Royalties>():
                    let receiver = KOTD.account.getCapability<&AnyResource{FungibleToken.Receiver}>(/public/flowTokenReceiver)
                    let royalty = MetadataViews.Royalty(receiver: receiver, cut: 0.05, description: "KOTD / Niftory Fees")
                    return MetadataViews.Royalties([royalty])
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: KOTD.CollectionStoragePath, publicPath: KOTD.CollectionPublicPath, providerPath: /private/NiftoryCollectibleCollection001, publicCollection: Type<&KOTD.Collection{KOTD.NiftoryCollectibleCollectionPublic}>(), publicLinkedType: Type<&KOTD.Collection{KOTD.NiftoryCollectibleCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&KOTD.Collection{KOTD.NiftoryCollectibleCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Collection: NiftoryCollectibleCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
