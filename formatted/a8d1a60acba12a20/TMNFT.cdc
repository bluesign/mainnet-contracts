        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TMNFT.CollectionStoragePath, publicPath: TMNFT.CollectionPublicPath, providerPath: /private/TMNFTCollection, publicCollection: Type<&TMNFT.Collection{TMNFT.TMNFTCollectionPublic}>(), publicLinkedType: Type<&TMNFT.Collection{TMNFT.TMNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TMNFT.Collection{TMNFT.TMNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
