...
pub contract TopShotLocking{ 
    ...
    priv var lockedNFTs:{ UInt64: UFix64}
    
    // Dictionary of NFTs overridden to be unlocked
    priv var unlockableNFTs:{ UInt64: Bool} // nft resource id is the key
    ...
    pub fun lockNFT(
        ...
        let TopShotNFTType: Type =
            CompositeType("A.0b2a3299cc857e29.TopShot.NFT")!
    ...
    pub fun unlockNFT(nft: @NonFungibleToken.NFT): @NonFungibleToken.NFT{ 
        ...
        let isPastExpiry: Bool =
            getCurrentBlock().timestamp >= lockExpiryTimestamp
        let isUnlockableOverridden: Bool =
            self.unlockableNFTs.containsKey(nft.id)
    ...
    pub fun AdminStoragePath(): StoragePath{ 
