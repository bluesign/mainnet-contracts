...
pub contract TopShot: NonFungibleToken{ 
    ...
    pub fun SubeditionAdminStoragePath(): StoragePath{ 
    ...
    priv var playDatas:{ UInt32: Play}
    
    // Variable size dictionary of SetData structs
    priv var setDatas:{ UInt32: SetData}
    
    // Variable size dictionary of Set resources
    priv var sets: @{UInt32: Set}
    ...
    pub resource Set{ 
        ...
        pub fun mintMomentWithSubedition(playID: UInt32, subeditionID: UInt32): @NFT{ 
            ...
            // to use as this Moment's serial number
            let subeditionRef = TopShot.account.borrow<&SubeditionAdmin>(from: TopShot.SubeditionAdminStoragePath()) ?? panic("No subedition admin resource in storage")
    ...
    pub struct QuerySetData{ 
        ...
        priv var plays: [UInt32]
        
        priv var retired:{ UInt32: Bool}
        
        pub var locked: Bool
        
        priv var numberMintedPerPlay:{ UInt32: UInt32}
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv fun buildDescString(): String{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    let royaltyReceiver: Capability<&{FungibleToken.Receiver}> = getAccount(TopShot.RoyaltyAddress()).getCapability<&AnyResource{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath())
                    return MetadataViews.Royalties(royalties: [MetadataViews.Royalty(receiver: royaltyReceiver, cut: 0.05, description: "NBATopShot marketplace royalty")])
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(self.getMomentURL())
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: /storage/MomentCollection, publicPath: /public/MomentCollection, providerPath: /private/MomentCollection, publicCollection: Type<&TopShot.Collection{TopShot.MomentCollectionPublic}>(), publicLinkedType: Type<&TopShot.Collection{TopShot.MomentCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TopShot.Collection{NonFungibleToken.Provider, TopShot.MomentCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Traits>():
                    ...
                    let traitDictionary:{ String: AnyStruct} ={ "SeriesNumber": TopShot.getSetSeries(setID: self.data.setID), "SetName": TopShot.getSetName(setID: self.data.setID), "SerialNumber": self.data.serialNumber, "Locked": TopShotLocking.isLocked(nftRef: &self as                                                                                                                                                                                                                                                                                // add play specific data
                    ...
                    let fullDictionary                                       
                                       ...
                                       = self.mapPlayData(dict: traitDictionary)
                    return MetadataViews.dictToTraits(                                                      
                ...
                case Type<MetadataViews.Medias                                              
                                              ...
                                              //
                                              >():
                    return MetadataViews.Medias(items: [MetadataViews                                                                     
                                                                     ...
                                                                     .Media(file: MetadataViews.HTTPFile(url: self.mediumimage())                                                                                                                                 // If the result isn't nil, the id of the returned reference
                                                                                                                                 // should be the same as the argument to the function
                                                                                                                                 
                                                                                                                                 // Collection is a resource that every user who owns NFTs 
                                                                                                                                 // will store in their account to manage their NFTS
                                                                                                                                 //
                                                                                                                                 , mediaType                                                                                                                                            // Dictionary of Moment conforming tokens
                                                                                                                                            ...
                                                                                                                                            :                                                                                                                                              
                                                                                                                                              ...
                                                                                                                                              "image/jpeg")                                                                                                                                                           
                                                                                                                                                           ...
                                                                                                                                                           , MetadataViews.Media(file                                                                                                                                                                                     
                                                                                                                                                                                     ...
                                                                                                                                                                                     //
                                                                                                                                                                                     : MetadataViews.HTTPFile(                                                                                                                                                                                                              // Create a new empty Collection
                                                                                                                                                                                                              url                                                                                                                                                                                                                 
        ...
        pub fun mapPlayData(dict:{ String                                         // Remove the nft from the Collection
                                         : AnyStruct                                                    
                                                    ...
                                                    // Store it back to the ownedNFTs dictionary
                                                      ...
                                                      :{ String                                                               // Iterate through the ids and unlocks them
                                                               : AnyStruct}{ 
            ...
            let playMetadata = TopShot.getPlayMetaData(playID: self.data                                                                        // Remove the nft from the Collection
                                                                        .playID) ??{} 
            for name in playMetadata                                    
        ...
        pub fun getMomentURL(): String{ 
            return                   
                   ...
                   //
                   //
                   "https://nbatopshot.com/moment/".concat(self.id                                                                  
                                                                  // setMomentsSubedition saves which Subedition the Moment belongs to
                                                                  //
                                                                  // Parameters: nftID: The ID of the NFT
                                                                  //             subeditionID: The ID of the Subedition the Moment belongs to
        ...
        pub fun getEditionName(): String{ 
            let setName: String = TopShot.getSetName(setID                                                          
                                                          // -----------------------------------------------------------------------
    ...
    pub resource Admin{ 
        ...
        pub fun setMomentsSubedition(nftID: UInt64, subeditionID: UInt32, setID: UInt32, playID: UInt32){ 
            let subeditionAdmin = TopShot.account.borrow<&SubeditionAdmin>(from: TopShot.SubeditionAdminStoragePath()) ?? panic("No subedition admin resource in storage")
    ...
    pub resource Collection: MomentCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun destroyMoments(ids: [UInt64]){ 
            let topShotLockingAdmin = TopShot.account.borrow<&TopShotLocking.Admin>(from: TopShotLocking.AdminStoragePath()) ?? panic("No TopShotLocking admin resource in storage")
            for id in ids{ 
    ...
    pub fun getMomentsSubedition(nftID: UInt64): UInt32?{ 
        let subeditionAdmin = self.account.borrow<&SubeditionAdmin>(from: TopShot.SubeditionAdminStoragePath()) ?? panic("No subedition admin resource in storage")
