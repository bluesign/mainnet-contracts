...
pub contract FastBreakV1: NonFungibleToken{ 
    ...
    pub event FastBreakPlayerCreated(id: UInt64, playerName: String)
    
    pub event FastBreakRunCreated(id: String, name: String, runStart: UInt64, runEnd: UInt64, fatigueModeOn: Bool)
    
    pub event FastBreakRunStatusChange(id: String, newRawStatus: UInt8)
    
    pub event FastBreakGameCreated(id: String, name: String, fastBreakRunID: String, submissionDeadline: UInt64, numPlayers: UInt64)
    ...
    pub event FastBreakGameTokenMinted(id: UInt64, fastBreakGameID: String, serialNumber: UInt64, mintingDate: UInt64, topShots: [UInt64], mintedTo: UInt64)
    
    pub event FastBreakGameSubmissionUpdated(playerId: UInt64, fastBreakGameID: String, topShots: [UInt64])
    
    pub event FastBreakGameWinner(playerId: UInt64, submittedAt: UInt64, fastBreakGameID: String, topShots: [UInt64])
    
    pub event FastBreakGameStatAdded(fastBreakGameID: String, name: String, type: UInt8, valueNeeded: UInt64)
    ...
    ///
    priv let fastBreakRunByID:{ String: FastBreakRun}
    
    priv let fastBreakGameByID:{ String: FastBreakGame}
    
    priv let fastBreakPlayerByID:{ UInt64: PlayerData}
    
    priv let playerAccountMapping:{ UInt64: Address}
    
    priv let accountPlayerMapping:{ Address: UInt64}
    ...
    pub struct FastBreakRun{ 
        ...
        ///
        access(contract) fun updateStatus(status: FastBreakV1.RunStatus){ 
            self.status = status
        }
    ...
    pub resource Player: FastBreakPlayer, NonFungibleToken.INFT{ 
        ...
        ///
        pub fun play(fastBreakGameID: String, topShots: [UInt64]): @FastBreakV1.NFT{ 
            pre{ 
            ...
            let collectionRef = acct.getCapability(/public/MomentCollection).borrow<&{TopShot.MomentCollectionPublic}>() ?? panic("Player does not have top shot collection")
        ...
        ///
        pub fun updateSubmission(fastBreakGameID: String, topShots: [UInt64]){ 
            pre{ 
                FastBreakV1.fastBreakGameByID.containsKey(fastBreakGameID):
                    "No such fast break game with gameId: ".concat(fastBreakGameID)
            }
    ...
    ///
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, FastBreakNFTCollectionPublic{ 
    ...
    pub resource interface GameOracle{ 
        ...
        pub fun createFastBreakGame(id: String, name: String, fastBreakRunID: String, submissionDeadline: UInt64, numPlayers: UInt64){} 
