...
pub contract VictoryNFTCollectionStorefront{ 
    ...
    pub resource SaleOffer: SaleOfferPublicView{ 
        ...
        priv let sellerItemProvider: Capability<&VictoryNFTCollectionItem.Collection{NonFungibleToken.Provider}>
        ...
        //
        pub fun accept(buyerCollection: &VictoryNFTCollectionItem.Collection{NonFungibleToken.Receiver}, buyerPayment: @FungibleToken.Vault, ownerPaymentReceiver: Capability<&{FungibleToken.Receiver}>){ 
            pre{ 
        ...
        //
        init(sellerItemProvider: Capability<&VictoryNFTCollectionItem.Collection{NonFungibleToken.Provider, VictoryNFTCollectionItem.VictoryNFTCollectionItemCollectionPublic}>, bundleID: UInt64, sellerPaymentReceiver: Capability<&{FungibleToken.Receiver}>, price: UFix64, saleType: UInt8, startTime: UInt32, endTime: UInt32, targetPrice: UFix64, royaltyPaymentReceiver: Capability<&{FungibleToken.Receiver}>, royaltyFactor: UFix64){ 
            pre{ 
        ...
        pub fun createSaleOffer(
            sellerItemProvider: Capability<
                &VictoryNFTCollectionItem.Collection{
                    ...
                    VictoryNFTCollectionItem.VictoryNFTCollectionItemCollectionPublic
                }
            >,
            bundleID: UInt64,
    ...
    init(){ 
        self
            .CollectionStoragePath = /storage/VictoryNFTCollectionStorefrontCollection
        self
            .CollectionPublicPath = /public/VictoryNFTCollectionStorefrontCollection
    }
}
