...
pub contract VictoryCollectible: NonFungibleToken{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &VictoryCollectible.NFT?{ 
        let collection = (getAccount(from).getCapability(VictoryCollectible.CollectionPublicPath)!).borrow<&VictoryCollectible.Collection{VictoryCollectible.VictoryCollectibleCollectionPublic}>() ?? panic("Couldn't get collection")
