...
This is the contract for RecollectionBinder NFTs!
...
pub contract RecollectionBinder: NonFungibleToken, ViewResolver{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver, NiftoryNonFungibleToken.NFTPublic{ 
        ...
        pub fun contract(): &{NiftoryNonFungibleToken.ManagerPublic}{ 
            return RecollectionBinder.contract()
        }
        ...
        init(setId: Int, templateId: Int, serial: UInt64){ 
            self.id = RecollectionBinder.totalSupply
            RecollectionBinder.totalSupply = RecollectionBinder.totalSupply + 1
            self.setId = setId
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, NiftoryNonFungibleToken.CollectionPublic, NiftoryNonFungibleToken.CollectionPrivate{ 
        ...
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let token <- token as! @RecollectionBinder.NFT
        ...
        pub fun depositBulk(tokens: @[NonFungibleToken.NFT]){ 
            while tokens.length > 0{ 
                let token <- tokens.removeLast() as! @RecollectionBinder.NFT
    ...
    pub resource Manager: NiftoryNonFungibleToken.ManagerPublic, NiftoryNonFungibleToken.ManagerPrivate{ 
        ...
        pub fun metadata(): AnyStruct?{ 
            return RecollectionBinder.metadata
        }
        
        pub fun getSetManagerPublic(): &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public}{ 
            return NiftoryNFTRegistry.getSetManagerPublic(RecollectionBinder.REGISTRY_ADDRESS, RecollectionBinder.REGISTRY_BRAND)
        }
        
        pub fun getMetadataViewsManagerPublic(): &MetadataViewsManager.Manager{MetadataViewsManager.Public}{ 
            return NiftoryNFTRegistry.getMetadataViewsManagerPublic(RecollectionBinder.REGISTRY_ADDRESS, RecollectionBinder.REGISTRY_BRAND)
        }
        
        pub fun getNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return NiftoryNFTRegistry.buildNFTCollectionData(RecollectionBinder.REGISTRY_ADDRESS, RecollectionBinder.REGISTRY_BRAND, fun (): @NonFungibleToken.Collection{ 
                    return <-RecollectionBinder.createEmptyCollection()
                })
        }
        ...
        pub fun modifyContractMetadata(): auth &AnyStruct{ 
            ...
            let maybeMetadata = RecollectionBinder.metadata
            if maybeMetadata == nil{ 
                let blankMetadata:{ String: String} ={} 
                RecollectionBinder.metadata = blankMetadata
            }
            return (&RecollectionBinder.metadata as auth &AnyStruct?)!
        }
        
        pub fun replaceContractMetadata(_ metadata: AnyStruct?){ 
            emit ContractMetadataUpdated()
            RecollectionBinder.metadata = metadata
        }
        ...
        priv fun _getMetadataViewsManagerPrivate(): &MetadataViewsManager.Manager{MetadataViewsManager.Private}{ 
            let record = NiftoryNFTRegistry.getRegistryRecord(RecollectionBinder.REGISTRY_ADDRESS, RecollectionBinder.REGISTRY_BRAND)
            let manager = RecollectionBinder.account.getCapability<&MetadataViewsManager.Manager{MetadataViewsManager.Private}>(record.metadataViewsManager.paths.private).borrow()!
            return manager
        }
        ...
        priv fun _getSetManagerPrivate(): &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}{ 
            let record = NiftoryNFTRegistry.getRegistryRecord(RecollectionBinder.REGISTRY_ADDRESS, RecollectionBinder.REGISTRY_BRAND)
            let setManager = RecollectionBinder.account.getCapability<&MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}>(record.setManager.paths.private).borrow()!
            return setManager
        }
    ...
    pub fun contract(): &{NiftoryNonFungibleToken.ManagerPublic}{ 
        return NiftoryNFTRegistry.getNFTManagerPublic(RecollectionBinder.REGISTRY_ADDRESS, RecollectionBinder.REGISTRY_BRAND)
    }
    ...
    init(nftManagerProxy: &{NiftoryNonFungibleTokenProxy.Public, NiftoryNonFungibleTokenProxy.Private}){ 
        let record = NiftoryNFTRegistry.generateRecord(account: self.account.address, project: "clhcnrqec0000lb0v6gtxxcpa_RecollectionBinder")
        self.REGISTRY_ADDRESS = 0x32d62d5c43ad1038
        self.REGISTRY_BRAND = "clhcnrqec0000lb0v6gtxxcpa_RecollectionBinder"
        ...
        self.account.save<@MutableMetadataSetManager.Manager>(<-MutableMetadataSetManager.create(name: "RecollectionBinder", description: "The set manager for RecollectionBinder."), to: record.setManager.paths.storage)
        ...
        let contractName = "RecollectionBinder"
