...
pub contract FlowverseTreasures: NonFungibleToken{ 
    ...
    priv var entityDatas:{ UInt64: Entity}
    
    priv var setDatas:{ UInt64: SetData}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FlowverseTreasures.CollectionStoragePath, publicPath: FlowverseTreasures.CollectionPublicPath, providerPath: /private/FlowverseTreasuresCollection, publicCollection: Type<&FlowverseTreasures.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, FlowverseTreasures.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&FlowverseTreasures.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, FlowverseTreasures.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FlowverseTreasures.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, FlowverseTreasures.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-FlowverseTreasures.createEmptyCollection()
                        })
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    let royalties: [MetadataViews.Royalty] = [MetadataViews.Royalty(receiver: getAccount(querySetData.royaltyReceiverAddress).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver)!, cut: feeCut, description: "Creator Royalty Fee")]
                ...
                case Type<MetadataViews.Traits>():
                    ...
                    if let artist = FlowverseTreasures.getEntityMetaDataByField(entityID: self.entityID, field: "artist"){ 
                        traits.append(MetadataViews.Trait(type: "Artist", value: artist, displayType: nil, rarity: nil))
                    }
                    if let edition = FlowverseTreasures.getEntityMetaDataByField(entityID: self.entityID, field: "edition"){ 
                        traits.append(MetadataViews.Trait(type: "Edition", value: edition, displayType: nil, rarity: nil))
                    }
                    if let color = FlowverseTreasures.getEntityMetaDataByField(entityID: self.entityID, field: "color"){ 
                        traits.append(MetadataViews.Trait(type: "Color", value: color, displayType: nil, rarity: nil))
                    }
