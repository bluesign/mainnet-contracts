        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FlowversePass.CollectionStoragePath, publicPath: FlowversePass.CollectionPublicPath, providerPath: /private/FlowversePassCollection, publicCollection: Type<&FlowversePass.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, FlowversePass.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&FlowversePass.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, FlowversePass.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FlowversePass.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, FlowversePass.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-FlowversePass.createEmptyCollection()
                        })
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    let royalties: [MetadataViews.Royalty] = [MetadataViews.Royalty(receiver: getAccount(feeReceiverAddress).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver)!, cut: feeCut, description: "Creator Royalty Fee")]
