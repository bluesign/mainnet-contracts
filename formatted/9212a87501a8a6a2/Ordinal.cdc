...
pub contract Ordinal: NonFungibleToken{ 
    // Events
    ...
    pub event OrdinalMinted(id: UInt64, nftUUID: UInt64, creator: Address, type: String)
    
    pub event OrdinalUpdated(id: UInt64, size: Int)
    
    pub event OrdinalDestroyed(id: UInt64)
    ...
    pub struct InscriptionMetadataView{ 
        pub let type: String?
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Ordinal.CollectionStoragePath, publicPath: Ordinal.CollectionPublicPath, providerPath: /private/OrdinalCollection, publicCollection: Type<&Ordinal.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, Ordinal.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Ordinal.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, Ordinal.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Ordinal.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, Ordinal.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-Ordinal.createEmptyCollection()
                        })
                ...
                case Type<MetadataViews.Royalties>():
                    let royalties: [MetadataViews.Royalty] = [MetadataViews.Royalty(receiver: getAccount(0xc7c122b5b811de8e).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver)!, cut: 0.01, description: "Platform Royalty Fee")]
                    return MetadataViews.Royalties(cutInfos: royalties)
                case Type<MetadataViews.Traits>():
                    let traits: [MetadataViews.Trait] = [MetadataViews.Trait(type: "Inscription Number", value: self.id, displayType: "Number", rarity: nil), MetadataViews.Trait(type: "Type", value: self.type, displayType: nil, rarity: nil), MetadataViews.Trait(type: "Size", value: self.data.length, displayType: "Number", rarity: nil), MetadataViews.Trait(type: "Creator", value: self.creator.toString(), displayType: nil, rarity: nil), MetadataViews.Trait(type: "UUID", value: self.uuid.toString(), displayType: nil, rarity: nil)]
    ...
    priv fun mint(creator: Address, type: String, data: String): @NFT{ 
        pre{ 
    ...
    pub resource Minter: OrdinalVendor.IMinter{ 
        init(){} 
        
        pub fun mint(creator: Address, type: String, data: String): @NFT{ 
    ...
    pub resource interface CollectionUpdate{ 
        pub fun updateData(id: UInt64, data: String){} 
    }
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowOrdinalNFT(id: UInt64): &Ordinal.NFT?{ 
    ...
    pub resource Collection: CollectionPublic, CollectionUpdate, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
