        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FlowverseShirt.CollectionStoragePath, publicPath: FlowverseShirt.CollectionPublicPath, providerPath: /private/FlowverseShirtCollection, publicCollection: Type<&FlowverseShirt.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, FlowverseShirt.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&FlowverseShirt.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, FlowverseShirt.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FlowverseShirt.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, FlowverseShirt.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-FlowverseShirt.createEmptyCollection()
                        })
                ...
                case Type<MetadataViews.Royalties>():
                    let royalties: [MetadataViews.Royalty] = [MetadataViews.Royalty(receiver: getAccount(0x604b63bcbef5974f).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver)!, cut: 0.05, description: "Creator Royalty Fee")]
