...
pub contract Royalties{ 
    ...
    pub struct Override{ 
        ...
        pub let receiverOverride: Capability<
    ...
    pub fun getOverridesMapping():{ String: [Override]}{ 
        return Royalties.overrides
    }
    
    pub fun getOverrides(_ identifier: String): [Override]{ 
        return Royalties.overrides[identifier] ?? []
    }
    
    pub fun findMatchingOverride(
        overrides: [
            Override
        ],
    ...
    pub fun getRoyaltySaleCutsForStorefrontV2(
        nft: &NonFungibleToken.NFT,
        salePrice: UFix64,
        ftReceiverPath: PublicPath,
        receiverAddressOverrides: [
