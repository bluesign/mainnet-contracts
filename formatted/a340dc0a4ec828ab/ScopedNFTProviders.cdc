...
pub contract ScopedNFTProviders{ 
    ...
    pub resource ScopedNFTProvider: NonFungibleToken.Provider{ 
        priv let provider: Capability<&{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>
        
        priv let filters: [{NFTFilter}]
