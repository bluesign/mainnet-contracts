...
pub contract AmericanAirlines_NFT: NonFungibleToken{ 
    ...
    pub resource Series{ 
        ...
        //
        pub fun mintAmericanAirlines_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32){ 
            pre{ 
        ...
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintEditionAmericanAirlines_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32, edition: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= AmericanAirlines_NFT.getSetMaxEditions(setId: setId)!:
        ...
        pub fun batchMintAmericanAirlines_NFT(recipient: &{NonFungibleToken.CollectionPublic}, setId: UInt32, tokenIds: [UInt64]){ 
            pre{ 
                tokenIds.length > 0:
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                    ...
                    for metadataKey in (AmericanAirlines_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 13{ 
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_"{ 
                                ...
                                if cutValue != 0.0{ 
                                    royalties.append(MetadataViews.Royalty(receiver: getAccount(royaltyAddress).getCapability<&FungibleToken.Vault{FungibleToken.Receiver}>(royaltyReceiver), cut: cutValue, description: AmericanAirlines_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!))
                                }
                            }
                        }
                    }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: AmericanAirlines_NFT.CollectionStoragePath, publicPath: AmericanAirlines_NFT.CollectionPublicPath, providerPath: /private/AmericanAirlines_NFT, publicCollection: Type<&AmericanAirlines_NFT.Collection{AmericanAirlines_NFT.AmericanAirlines_NFTCollectionPublic, NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&AmericanAirlines_NFT.Collection{AmericanAirlines_NFT.AmericanAirlines_NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&AmericanAirlines_NFT.Collection{AmericanAirlines_NFT.AmericanAirlines_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: MetadataViews.HTTPFile(url: AmericanAirlines_NFT.getSetMetadataByField(setId: self.setId, field: "image")!), mediaType: self.getMimeType())])
            }
            return nil
        }
    ...
    pub resource interface AmericanAirlines_NFTCollectionPublic{ 
    ...
    //
    pub fun fetch(_ from: Address, id: UInt64): &AmericanAirlines_NFT.NFT?{ 
        let collection = getAccount(from).getCapability(AmericanAirlines_NFT.CollectionPublicPath).borrow<&AmericanAirlines_NFT.Collection{AmericanAirlines_NFT.AmericanAirlines_NFTCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    pub fun getAllSeries(): [AmericanAirlines_NFT.SeriesData]{ 
    ...
    pub fun getAllSets(): [AmericanAirlines_NFT.NFTSetData]{ 
    ...
    init(){ 
        ...
        self.account.link<&AmericanAirlines_NFT.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
