...
pub contract GiglabsShopifyDemo_NFT: NonFungibleToken{ 
    ...
    // totalSupply
    // The total number of GiglabsShopifyDemo_NFT that have been minted
    //
    pub var totalSupply: UInt64
    
    // Variable size dictionary of SetData structs
    priv var setData:{ UInt32: NFTSetData}
    
    // Variable size dictionary of SeriesData structs
    priv var seriesData:{ UInt32: SeriesData}
    ...
    pub struct NFTSetData{ 
        ...
        priv var ipfsMetadataHashes:{ UInt32: String}
    ...
    // A Series is special resource type that contains functions to mint GiglabsShopifyDemo_NFT NFTs, 
    ...
    pub resource Series{ 
        ...
        // Set sealed state
        priv var setSealedState:{ UInt32: Bool}
        ...
        init(seriesId: UInt32, metadata:{ String: String}){ 
            ...
            self.setIds = []
            self.setSealedState ={} 
            GiglabsShopifyDemo_NFT.seriesData[seriesId] = SeriesData(seriesId: seriesId, metadata: metadata)
            emit SeriesCreated(seriesId: seriesId)
        }
        
        pub fun addNftSet(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            pre{ 
            ...
            GiglabsShopifyDemo_NFT.setData[setId] = newNFTSet
        ...
        pub fun updateSeriesMetadata(metadata:{ String: String}){ 
            ...
            GiglabsShopifyDemo_NFT.seriesData[self.seriesId] = newSeriesMetadata
        ...
        // is permanent and immutable.
        pub fun updateSetMetadata(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            pre{ 
                self.seriesSealedState == false:
                    "The Series is permanently sealed. No metadata updates can be made."
            ...
            GiglabsShopifyDemo_NFT.setData[setId] = newSetMetadata
            emit SetMetadataUpdated(seriesId: self.seriesId, setId: setId)
        }
        
        // mintGiglabsShopifyDemo_NFT
        // Mints a new NFT with a new ID
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintGiglabsShopifyDemo_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= GiglabsShopifyDemo_NFT.getSetMaxEditions(setId: setId)!:
            ...
            recipient.deposit(token: <-create GiglabsShopifyDemo_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: editionNum))
            
            // Increment the count of global NFTs 
            GiglabsShopifyDemo_NFT.totalSupply = GiglabsShopifyDemo_NFT.totalSupply + 1 as UInt64
            
            // Update the count of Editions minted in the set
            self.numberEditionsMintedPerSet[setId] = editionNum
        }
        
        // mintEditionGiglabsShopifyDemo_NFT
        // Mints a new NFT with a new ID and specific edition Num (random open edition)
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintEditionGiglabsShopifyDemo_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32, edition: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= GiglabsShopifyDemo_NFT.getSetMaxEditions(setId: setId)!:
            ...
            // deposit it in the recipient's account using their reference
            recipient.deposit(token: <-create GiglabsShopifyDemo_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: edition))
        ...
        // batchMintGiglabsShopifyDemo_NFT
        // Mints multiple new NFTs given and deposits the NFTs
        // into the recipients collection using their collection reference
        pub fun batchMintGiglabsShopifyDemo_NFT(recipient: &{NonFungibleToken.CollectionPublic}, setId: UInt32, tokenIds: [UInt64]){ 
            pre{ 
                tokenIds.length > 0:
                    "Number of token Ids must be > 0"
            }
            for tokenId in tokenIds{ 
                self.mintGiglabsShopifyDemo_NFT(recipient: recipient, tokenId: tokenId, setId: setId)
            }
        }
    ...
    // A resource that represents the GiglabsShopifyDemo_NFT NFT
    //
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(tokenId: UInt64, setId: UInt32, editionNum: UInt32){ 
            ...
            let seriesId = GiglabsShopifyDemo_NFT.getSetSeriesId(setId: setId)!
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "name")!, description: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "description")!, thumbnail: MetadataViews.HTTPFile(url: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!))
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(self.id)
                case Type<MetadataViews.Editions>():
                    let maxEditions = GiglabsShopifyDemo_NFT.setData[self.setId]?.maxEditions ?? 0
                    let editionName = GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "name")!
                ...
                case Type<MetadataViews.ExternalURL>():
                    if let externalBaseURL = GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "external_token_base_url"){ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    for metadataKey in (GiglabsShopifyDemo_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 13{ 
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_"{ 
                                ...
                                let royaltyAddress = GiglabsShopifyDemo_NFT.convertStringToAddress(GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_addr_".concat(royaltyName))!)!
                                let royaltyReceiver: PublicPath = PublicPath(identifier: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_rcv_".concat(royaltyName))!)!
                                let royaltyCut = GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_cut_".concat(royaltyName))!
                                let cutValue: UFix64 = GiglabsShopifyDemo_NFT.royaltyCutStringToUFix64(royaltyCut)
                                if cutValue != 0.0{ 
                                    royalties.append(MetadataViews.Royalty(receiver: getAccount(royaltyAddress).getCapability<&FungibleToken.Vault{FungibleToken.Receiver}>(royaltyReceiver), cut: cutValue, description: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!))
                                }
                            }
                        }
                    }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: GiglabsShopifyDemo_NFT.CollectionStoragePath, publicPath: GiglabsShopifyDemo_NFT.CollectionPublicPath, providerPath: /private/GiglabsShopifyDemo_NFT, publicCollection: Type<&GiglabsShopifyDemo_NFT.Collection{GiglabsShopifyDemo_NFT.GiglabsShopifyDemo_NFTCollectionPublic, NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&GiglabsShopifyDemo_NFT.Collection{GiglabsShopifyDemo_NFT.GiglabsShopifyDemo_NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&GiglabsShopifyDemo_NFT.Collection{GiglabsShopifyDemo_NFT.GiglabsShopifyDemo_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-GiglabsShopifyDemo_NFT.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.gigantik.io/giglabsshopifydemo/square.png"), mediaType: "image/png")
                    let bannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.gigantik.io/giglabsshopifydemo/banner.png"), mediaType: "image/png")
                    ...
                    for metadataKey in (GiglabsShopifyDemo_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 18{ 
                            if metadataKey.slice(from: 0, upTo: 18) == "collection_social_"{ 
                                ...
                                socials.insert(key: metadataKey.slice(from: 18, upTo: metadataKey.length), MetadataViews.ExternalURL(GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!))
                            }
                        }
                    }
                    return MetadataViews.NFTCollectionDisplay(name: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "", description: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "", externalURL: MetadataViews.ExternalURL(GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""), squareImage: squareImage, bannerImage: bannerImage, socials: socials)
                    ...
                    for metadataKey in (GiglabsShopifyDemo_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 6{ 
                            if metadataKey.slice(from: 0, upTo: 6) == "trait_"{ 
                                ...
                                traitDictionary.insert(key: metadataKey.slice(from: 6, upTo: metadataKey.length), GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!)
                            }
                        }
                    }
                    return MetadataViews.dictToTraits(dict: traitDictionary, excludedNames: [])
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: MetadataViews.HTTPFile(url: GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "image")!), mediaType: self.getMimeType())])
            }
            return nil
        }
        
        pub fun getMimeType(): String{ 
            var metadataFileType = (GiglabsShopifyDemo_NFT.getSetMetadataByField(setId: self.setId, field: "image_file_type")!).toLower()
    ...
    pub resource Admin{ 
        pub fun addSeries(seriesId: UInt32, metadata:{ String: String}){ 
            pre{ 
                GiglabsShopifyDemo_NFT.series[seriesId] == nil:
            ...
            GiglabsShopifyDemo_NFT.series[seriesId] <-! newSeries
        }
    ...
    // to allow others to deposit GiglabsShopifyDemo_NFT into their Collection. It also allows for reading
    // the details of GiglabsShopifyDemo_NFT in the Collection.
    pub resource interface GiglabsShopifyDemo_NFTCollectionPublic{ 
        ...
        pub fun borrowGiglabsShopifyDemo_NFT(id: UInt64): &GiglabsShopifyDemo_NFT.NFT?{ 
            ...
            post{ 
                result == nil || result?.id == id:
                    "Cannot borrow GiglabsShopifyDemo_NFT reference: The ID of the returned reference is incorrect"
            }
        }
    }
    
    // Collection
    // A collection of GiglabsShopifyDemo_NFT NFTs owned by an account
    //
    pub resource Collection: GiglabsShopifyDemo_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        //
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let token <- token as! @GiglabsShopifyDemo_NFT.NFT
        ...
        // Gets a reference to an NFT in the collection as a GiglabsShopifyDemo_NFT,
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            let GiglabsShopifyDemo_NFTNft = nft as! &GiglabsShopifyDemo_NFT.NFT
            return GiglabsShopifyDemo_NFTNft as &AnyResource{MetadataViews.Resolver}
        }
    ...
    // fetch
    // Get a reference to a GiglabsShopifyDemo_NFT from an account's Collection, if available.
    // If an account does not have a GiglabsShopifyDemo_NFT.Collection, panic.
    ...
    //
    pub fun fetch(_ from: Address, id: UInt64): &GiglabsShopifyDemo_NFT.NFT?{ 
        let collection = getAccount(from).getCapability(GiglabsShopifyDemo_NFT.CollectionPublicPath).borrow<&GiglabsShopifyDemo_NFT.Collection{GiglabsShopifyDemo_NFT.GiglabsShopifyDemo_NFTCollectionPublic}>() ?? panic("Couldn't get collection")
        // We trust GiglabsShopifyDemo_NFT.Collection.borrowGiglabsShopifyDemo_NFT to get the correct id
        // (it checks it before returning it).
        return collection.borrowGiglabsShopifyDemo_NFT(id: id)
    }
    
    // getAllSeries returns all the sets
    //
    // Returns: An array of all the series that have been created
    pub fun getAllSeries(): [GiglabsShopifyDemo_NFT.SeriesData]{ 
        return GiglabsShopifyDemo_NFT.seriesData.values
    }
    
    // getAllSets returns all the sets
    //
    // Returns: An array of all the sets that have been created
    pub fun getAllSets(): [GiglabsShopifyDemo_NFT.NFTSetData]{ 
        return GiglabsShopifyDemo_NFT.setData.values
    }
    ...
    pub fun getSeriesMetadata(seriesId: UInt32):{ String: String}?{ 
        return GiglabsShopifyDemo_NFT.seriesData[seriesId]?.getMetadata()
    }
    ...
    pub fun getSetMaxEditions(setId: UInt32): UInt32?{ 
        return GiglabsShopifyDemo_NFT.setData[setId]?.maxEditions
    }
    ...
    pub fun getSetMetadata(setId: UInt32):{ String: String}?{ 
        return GiglabsShopifyDemo_NFT.setData[setId]?.getMetadata()
    }
    ...
    pub fun getSetSeriesId(setId: UInt32): UInt32?{ 
        return GiglabsShopifyDemo_NFT.setData[setId]?.seriesId
    }
    ...
    pub fun getIpfsMetadataHashByNftEdition(setId: UInt32, editionNum: UInt32): String?{ 
        ...
        if let set = GiglabsShopifyDemo_NFT.setData[setId]{ 
    ...
    init(){ 
        // Set named paths
        self.CollectionStoragePath = /storage/GiglabsShopifyDemo_NFTCollection
        self.CollectionPublicPath = /public/GiglabsShopifyDemo_NFTCollection
        self.AdminStoragePath = /storage/GiglabsShopifyDemo_NFTAdmin
        self.AdminPrivatePath = /private/GiglabsShopifyDemo_NFTAdminUpgrade
        ...
        self.account.link<&GiglabsShopifyDemo_NFT.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
