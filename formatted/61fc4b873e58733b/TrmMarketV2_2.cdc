...
pub contract TrmMarketV2_2{ 
    ...
    pub event SaleCollectionInitialized(userAccountAddress: Address)
    
    /// Emitted when an Asset is listed for transfer
    pub event AssetListedForTransfer(
        assetTokenID: UInt64,
        salePrice: UFix64?,
        auctionPrice: UFix64?,
    ...
    /// Emitted when an Asset is listed for transfer
    pub event AssetBatchListedForTransfer(
        assetTokenIDs: [
            UInt64
        ],
        salePrice: UFix64?,
    ...
    /// Emitted when an Asset is listed for rent
    pub event AssetBatchListedForRent(
        assetTokenIDs: [
            UInt64
        ],
        price: UFix64?,
    ...
    pub event AssetTransferListingChanged(
        assetTokenID: UInt64,
        salePrice: UFix64?,
        auctionPrice: UFix64?,
        auctionStartTimestamp: UFix64?,
    ...
    /// Emitted when the sale price of a listed asset has changed
    pub event AssetBatchTransferListingChanged(
        assetTokenIDs: [
            UInt64
        ],
        salePrice: UFix64?,
    ...
    pub event AssetRentListingChanged(
        assetTokenID: UInt64,
        price: UFix64?,
        rentalPeriodSeconds: UFix64,
        seller: Address?
    ...
    /// Emitted when the rent price of a listed asset has changed
    pub event AssetBatchRentListingChanged(
        assetTokenIDs: [
            UInt64
        ],
        price: UFix64?,
    ...
    /// Emitted when a token has been delisted for sale
    pub event AssetBatchDelistedForTransfer(
        assetTokenIDs: [
            UInt64
        ],
        owner: Address?
    ...
    /// Emitted when a token has been delisted for rent
    pub event AssetBatchDelistedForRent(
        assetTokenIDs: [
            UInt64
        ],
        owner: Address?
    ...
    pub var minterCapability: Capability<&TrmRentV2_2.Minter>
    ...
    pub resource interface SalePublic{ 
        access(contract) fun listForTransfer(
            tokenID: UInt64,
            salePrice: UFix64?,
            auctionPrice: UFix64?,
            auctionStartTimestamp: UFix64?,
        ...
        access(contract) fun listForRent(
            tokenID: UInt64,
            price: UFix64?,
            rentalPeriodSeconds: UFix64?
        ){} 
        
        access(contract) fun batchListForTransfer(
            tokenIDs: [
                UInt64
            ],
            salePrice: UFix64?,
        ...
        access(contract) fun batchListForRent(
            tokenIDs: [
                UInt64
            ],
            price: UFix64?,
        ...
        access(contract) fun rent(
            tokenID: UInt64,
            price: UFix64,
            recipient: Capability<
                &TrmRentV2_2.Collection{TrmRentV2_2.CollectionPublic}
            >,
            paymentID: String
        ): UInt64{} 
        ...
        pub fun borrowAsset(id: UInt64): &TrmAssetV2_2.NFT?{ 
    ...
    pub resource SaleCollection: SalePublic{ 
        ...
        priv var ownerCollection: Capability<&TrmAssetV2_2.Collection>
        
        /// Dictionary of the transfer prices for each NFT by ID
        priv var transferListings: @{UInt64: TransferListing}
        
        /// Dictionary of the rent prices for each NFT by ID
        priv var rentListings: @{UInt64: RentListing}
        ...
        ///             paymentID
        access(contract) fun transfer(tokenID: UInt64, adminAccount: &TrmAssetV2_2.Admin, recipientAddress: Address, price: UFix64, paymentID: String){ 
            pre{ 
        ...
        access(contract) fun rent(tokenID: UInt64, price: UFix64, recipient: Capability<&TrmRentV2_2.Collection{TrmRentV2_2.CollectionPublic}>, paymentID: String): UInt64{ 
            pre{ 
    ...
    pub fun emitCreateSaleCollectionEvent(userAccountAddress: Address){ 
    ...
    pub resource Admin{ 
        pub fun listForTransfer(
            ...
            let saleCollectionCapability =
                getAccount(saleCollectionAddress).getCapability<
                    &TrmMarketV2_2.SaleCollection{TrmMarketV2_2.SalePublic}
                >(TrmMarketV2_2.marketPublicPath).borrow()
                ?? panic(
        ...
        pub fun cancelRent(saleCollectionAddress: Address, tokenID: UInt64){ 
            let saleCollectionCapability =
                getAccount(saleCollectionAddress).getCapability<
                    &TrmMarketV2_2.SaleCollection{TrmMarketV2_2.SalePublic}
                >(TrmMarketV2_2.marketPublicPath).borrow()
    ...
    init(){ 
        ...
        self.minterCapability = self.account.getCapability<&TrmRentV2_2.Minter>(
