...
pub contract TrmAssetV2_2: NonFungibleToken{ 
    // -----------------------------------------------------------------------
    ...
    pub event AssetBatchMinted(startId: UInt64, endId: UInt64, kID: String, totalCount: UInt64, startSerialNumber: UInt64, endSerialNumber: UInt64, assetName: String, assetDescription: String, assetURL: String, assetThumbnailURL: String, assetType: String, assetMetadata:{ String: String}, owner: Address?)
    ...
    pub resource Minter{ 
        ...
        pub fun mintNFT(kID: String, serialNumber: UInt64, assetName: String, assetDescription: String, assetURL: String, assetThumbnailURL: String, assetType: String, assetMetadata:{ String: String}, recipient: &TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic, NonFungibleToken.CollectionPublic}): UInt64{ 
            pre{ 
        ...
        pub fun batchMintNFTs(kID: String, totalCount: UInt64, startSerialNumber: UInt64, assetName: String, assetDescription: String, assetURL: String, assetThumbnailURL: String, assetType: String, assetMetadata:{ String: String}, recipient: &TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic, NonFungibleToken.CollectionPublic}): UInt64{ 
            pre{ 
                assetType == "private" || assetType == "public":
                    "Asset Type must be private or public"
                totalCount > 0:
    ...
    pub resource Admin{ 
        pub fun withdrawAsset(assetCollectionAddress: Address, id: UInt64): @NonFungibleToken.NFT{ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
            return <-assetCollectionCapability.withdrawAsset(id: id)
        }
        
        pub fun depositAsset(assetCollectionAddress: Address, token: @NonFungibleToken.NFT){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
            assetCollectionCapability.depositAsset(token: <-token)
        }
        
        pub fun updateAsset(assetCollectionAddress: Address, id: UInt64, assetName: String?, assetDescription: String?, assetThumbnailURL: String?, assetType: String?, assetMetadata:{ String: String}?){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
        ...
        pub fun batchUpdateAsset(assetCollectionAddress: Address, ids: [UInt64], kID: String, assetName: String?, assetDescription: String?, assetThumbnailURL: String?, assetType: String?, assetMetadata:{ String: String}?){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
        ...
        pub fun addAssetMetadataEntry(assetCollectionAddress: Address, id: UInt64, key: String, value: String){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
            assetCollectionCapability.addAssetMetadataEntry(id: id, key: key, value: value)
        }
        
        pub fun batchAddAssetMetadataEntry(assetCollectionAddress: Address, ids: [UInt64], kID: String, key: String, value: String){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
            assetCollectionCapability.batchAddAssetMetadataEntry(ids: ids, kID: kID, key: key, value: value)
        }
        
        pub fun setAssetMetadataEntry(assetCollectionAddress: Address, id: UInt64, key: String, value: String){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
            assetCollectionCapability.setAssetMetadataEntry(id: id, key: key, value: value)
        }
        
        pub fun batchSetAssetMetadataEntry(assetCollectionAddress: Address, ids: [UInt64], kID: String, key: String, value: String){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
            assetCollectionCapability.batchSetAssetMetadataEntry(ids: ids, kID: kID, key: key, value: value)
        }
        
        pub fun removeAssetMetadataEntry(assetCollectionAddress: Address, id: UInt64, key: String){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
            assetCollectionCapability.removeAssetMetadataEntry(id: id, key: key)
        }
        
        pub fun batchRemoveAssetMetadataEntry(assetCollectionAddress: Address, ids: [UInt64], kID: String, key: String){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
            assetCollectionCapability.batchRemoveAssetMetadataEntry(ids: ids, kID: kID, key: key)
        }
        
        pub fun invite(assetCollectionAddress: Address, id: UInt64, invitee: Address){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
            assetCollectionCapability.invite(id: id, invitee: invitee)
        }
        
        pub fun disinvite(assetCollectionAddress: Address, id: UInt64, invitee: Address){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
            assetCollectionCapability.disinvite(id: id, invitee: invitee)
        }
        
        pub fun destroyToken(assetCollectionAddress: Address, id: UInt64){ 
            let assetCollectionCapability = getAccount(assetCollectionAddress).getCapability<&TrmAssetV2_2.Collection{TrmAssetV2_2.CollectionPublic}>(TrmAssetV2_2.collectionPublicPath).borrow() ?? panic("Could not borrow asset collection capability from provided asset collection address")
