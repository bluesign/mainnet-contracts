...
import
    ...
    from "../0x34f2bf4a80bb0f69/PartyMansionDrinksContract.cdc"
...
pub contract AlchemyMetadataWrapperMainnetShard4{ 
    ...
    pub fun getTicalUniverse(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(TicalUniverse.CollectionPublicPath).borrow<
                &{TicalUniverse.TicalUniverseCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let editionCount =
            TicalUniverse.getNumberCollectiblesInEdition(
                setId: data.setId,
                itemId: data.itemId
            )!
        ...
        return NFTData(
            ...
            token_uri: nil,
            media: [
                NFTMedia(uri: itemMetadata["Asset"]!, mimetype: "video/mp4")
            ],
    ...
    pub fun getQRLNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(QRLNFT.CollectionPublicPath).borrow<
                &{QRLNFT.QRLNFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getMaxarNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(MaxarNFT.CollectionPublicPath).borrow<
                &{MaxarNFT.MaxarNFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getTrartContractNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(TrartContractNFT.CollectionPublicPath).borrow<
                &{TrartContractNFT.ICardCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let metadata =
            (TrartContractNFT.getMetadataForCardID(cardID: (nft!).id)!).data
        let rawMetadata:{ String: String?} ={
        ...
        && self.stringStartsWith(string: metadataUrl, prefix: ipfsScheme){ 
            ipfsURL = "https://trartgateway.mypinata.cloud/ipfs/".concat(
                    metadataUrl.slice(
                        from: ipfsScheme.length,
                        upTo: metadataUrl.length
                    )
                )
    ...
    pub fun getPartyMansionDrinksContractNFT(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(PartyMansionDrinksContract.CollectionPublicPath)
        ...
        rawMetadata.insert(
            key: "collectionID",
            (nft!).data.collectionID.toString()
        )
    ...
    pub fun getEvolutionNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(/public/f4264ac8f3256818_Evolution_Collection)
        ...
        let external_domain_view_url =
            "https://storage.viv3.com/0xf4264ac8f3256818/mv/".concat(
                (nft!).data.itemId.toString()
            )
        return NFTData(
            contract: contract,
            id: (nft!).id,
    ...
    pub fun getMomentsNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Moments.CollectionPublicPath).borrow<
                &{Moments.CollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        rawMetadata.insert(
            key: "serialNumber",
            metadata.serialNumber.toString()
        )
        rawMetadata.insert(key: "contentID", metadata.contentID.toString())
        rawMetadata.insert(
            key: "contentCreator",
            metadata.contentCreator.toString()
        )
        ...
        rawMetadata.insert(
            key: "contentEditionID",
            metadata.contentEditionID.toString()
        )
    ...
    pub fun getMotoGPCardNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(/public/motogpCardCollection).borrow<
                &{MotoGPCard.ICardCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            external_domain_view_url: "https://motogp-ignition.com/nft/card/"
                .concat(id.toString()).concat("?owner=").concat(
                address.toString()
            ),
            token_uri: nil,
    ...
    pub fun getUFCNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(UFC_NFT.CollectionPublicPath).borrow<
    ...
    pub fun getRCRDSHPNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(RCRDSHPNFT.collectionPublicPath).borrow<
                &{RCRDSHPNFT.RCRDSHPNFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getSeussibles(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability<&AnyResource{MetadataViews.ResolverCollection}>(
        ...
        let displayView =
            (nftResolver!).resolveView(Type<MetadataViews.Display>())!
        let display = displayView as! MetadataViews.Display
        let httpFile = display.thumbnail as! MetadataViews.HTTPFile
        return NFTData(
            contract: contract,
    ...
    pub fun getFlunks(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Flunks.CollectionPublicPath).borrow<
                &{Flunks.FlunksCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getNFTIDs(ownerAddress: Address):{ String: [UInt64]}{ 
        ...
        if let col =
            owner.getCapability(Seussibles.PublicCollectionPath).borrow<
                &{NonFungibleToken.CollectionPublic}
            >(){ 
            ids["Seussibles"] = col.getIDs()
        }
        if let col =
            owner.getCapability(MetaPanda.CollectionPublicPath).borrow<
                &{NonFungibleToken.CollectionPublic}
            >(){ 
