...
pub contract AlchemyMetadataWrapperMainnetShard1{ 
    ...
    pub fun getStarlyCard(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        return NFTData(
            ...
            media: [
                NFTMedia(
                    uri: metadata.card.mediaSizes[0].url,
                    mimetype: metadata.card.mediaType
                )
            ],
            metadata:{ 
                "id": (nft!).starlyID,
    ...
    pub fun getTuneGO(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let editionCount =
            TuneGO.getNumberCollectiblesInEdition(
                setId: data.setId,
                itemId: data.itemId
            )!
        ...
        return NFTData(
            ...
            external_domain_view_url: "https://tunegonft.com/collectible/"
                .concat((nft!).uuid.toString()),
            token_uri: nil,
            media: [
                NFTMedia(uri: itemMetadata["Media URL"]!, mimetype: "video/mp4")
            ],
            metadata: rawMetadata
        )
    }
