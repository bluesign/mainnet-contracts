...
pub contract Awoken: NonFungibleToken{ 
    ...
    pub resource interface _NFT_NAME_CollectionPublic{ 
        ...
        pub fun borrow_NFT_NAME_(id: UInt64): &Awoken.NFT?{ 
            post{ 
    ...
    init(){ 
        ...
        self.account.link<&Awoken.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, Awoken._NFT_NAME_CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
