...
pub contract Ticket: NonFungibleToken{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, issuePrice: UFix64, level: Level){ 
    ...
    init(){ 
        ...
        self.account.link<&Ticket.Collection{NonFungibleToken.CollectionPublic, Ticket.TicketCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
