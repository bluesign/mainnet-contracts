...
pub contract VnMiss: NonFungibleToken{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, candidateID: UInt64, level: Level, name: String, thumbnail: String){ 
    ...
    init(){ 
        ...
        self.account.link<&VnMiss.Collection{NonFungibleToken.CollectionPublic, VnMiss.VnMissCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
