...
pub contract SportsIconCollectible: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: SportsIconCollectible.CollectionStoragePath, publicPath: SportsIconCollectible.CollectionPublicPath, providerPath: SportsIconCollectible.CollectionPrivatePath, publicCollection: Type<&SportsIconCollectible.Collection{SportsIconCollectible.CollectibleCollectionPublic}>(), publicLinkedType: Type<&SportsIconCollectible.Collection{SportsIconCollectible.CollectibleCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&SportsIconCollectible.Collection{SportsIconCollectible.CollectibleCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    access(account) fun addNFTSet(mediaURL: String, maxNumberOfEditions: UInt64, data:{ String: String}, mintBeneficiaries: SportsIconBeneficiaries.Beneficiaries, marketBeneficiaries: SportsIconBeneficiaries.Beneficiaries): UInt64{ 
