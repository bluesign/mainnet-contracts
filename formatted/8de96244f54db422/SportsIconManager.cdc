...
import
    SportsIconNFTStorefront
    from "../0x03c8261a06cb1b42/SportsIconNFTStorefront.cdc"
...
pub contract SportsIconManager{ 
    ...
    pub event PublicSalePriceUpdated(
        setID: UInt64,
        fungibleTokenType: String,
        price: UFix64?
    )
    
    pub event PublicSaleTimeUpdated(
        setID: UInt64,
        startTime: UFix64?,
        endTime: UFix64?
    )
    ...
    priv var adminPaymentReceivers:{ 
        String: Capability<&{FungibleToken.Receiver}>
    }
    
    pub resource interface ManagerPublic{ 
        pub fun mintNftFromPublicSaleWithFUSD(
            setID: UInt64,
            quantity: UInt32,
            vault: @FungibleToken.Vault
        ): @SportsIconCollectible.Collection{} 
        
        pub fun mintNftFromPublicSaleWithFLOW(
            setID: UInt64,
            quantity: UInt32,
            vault: @FungibleToken.Vault
        ): @SportsIconCollectible.Collection{} 
        
        pub fun mintNftForPrimarySaleWithICONS(
            setID: UInt64,
            quantity: UInt32,
            vault: @FungibleToken.Vault
        ): @SportsIconCollectible.Collection{} 
        
        pub fun mintNftForPrimarySaleWithDUC(
            setID: UInt64,
            quantity: UInt32,
            vault: @FungibleToken.Vault
        ): @SportsIconCollectible.Collection{} 
    ...
    pub resource Manager: ManagerPublic{ 
        ...
        pub fun addNFTSet(mediaURL: String, maxNumberOfEditions: UInt64, data:{ String: String}, mintBeneficiaries: SportsIconBeneficiaries.Beneficiaries, marketBeneficiaries: SportsIconBeneficiaries.Beneficiaries): UInt64{ 
        ...
        pub fun updateDucPublicSale(setID: UInt64, creatorReceiverCap: Capability<&{FungibleToken.Receiver}>, creatorAmount: UFix64, sportsIconReceiverCap: Capability<&{FungibleToken.Receiver}>, sportsIconAmount: UFix64, totalPrice: UFix64, startTime: UFix64, endTime: UFix64, maxNumberOfEditions: UInt64){ 
        ...
        /* Minting functions */// Mint a single next edition NFT
        priv fun mintSequentialEditionNFT(setID: UInt64): @SportsIconCollectible.NFT{ 
        ...
        priv fun mintNftFromPublicSale(setID: UInt64, quantity: UInt32, vault: @FungibleToken.Vault, price: UFix64, paymentReceiver: Capability<&{FungibleToken.Receiver}>): @SportsIconCollectible.Collection{ 
            pre{ 
                quantity >= 1 && quantity <= 10:
        ...
        priv fun mintNftForPrimarySale(setID: UInt64, quantity: UInt32, paymentVault: @FungibleToken.Vault, primarySaleListing: SportsIconPrimarySalePrices.PrimarySaleListing, paymentReceiver: Capability<&{FungibleToken.Receiver}>): @SportsIconCollectible.Collection{ 
            pre{ 
                quantity >= 1 && quantity <= 10:
                    "May only mint between 1 and 10 collectibles at a time"
                SportsIconCollectible.getMetadataForSetID(setID: setID) != nil:
    ...
    /* Mutating functions */    access(contract) fun setAdminPaymentReceiver(
        fungibleTokenType: String,
    ...
    /* Public Functions */    pub fun getManagerPublic(): Capability<
        &SportsIconManager.Manager{SportsIconManager.ManagerPublic}
    >{ 
        return self.account.getCapability<
            &SportsIconManager.Manager{SportsIconManager.ManagerPublic}
        >(self.ManagerPublicPath)
    }
    ...
    init(){ 
        ...
        self.account.link<
            &SportsIconManager.Manager{SportsIconManager.ManagerPublic}
        >(self.ManagerPublicPath, target: self.ManagerStoragePath)
        ...
        let existingVault =
            self.account.borrow<&FUSD.Vault>(from: /storage/fusdVault)
        ...
        self.adminPaymentReceivers["FUSD"] = self.account.getCapability<
                &FUSD.Vault{FungibleToken.Receiver}
            >(/public/fusdReceiver)
        self.adminPaymentReceivers["FLOW"] = self.account.getCapability<
