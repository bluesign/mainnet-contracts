pub contract ListedPairs{ 
    ...
    /****** Contract Variables ******/    access(contract) var _pairs:{ String: PairInfo}
    
    pub let AdminStoragePath: StoragePath
    
    /****** Composite Type Definitions ******/    pub struct PairInfo{ 
        pub let name: String
    ...
    /****** Methods ******/    pub fun pairExists(key: String): Bool{ 
