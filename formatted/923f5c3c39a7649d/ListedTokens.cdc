pub contract ListedTokens{ 
    ...
    /****** Contract Variables ******/    access(contract) var _tokens:{ String: TokenInfo}
    
    pub let AdminStoragePath: StoragePath
    
    /****** Composite Type Definitions ******/    pub struct TokenInfo{ 
        pub let name: String
    ...
    /****** Methods ******/    pub fun tokenExists(key: String): Bool{ 
