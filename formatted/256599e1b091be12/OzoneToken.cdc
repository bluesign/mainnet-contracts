...
pub contract OzoneToken: FungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&OzoneToken.Vault{FungibleToken.Receiver}>(self.OzoneTokenReceiverPath, target: self.OzoneTokenVaultPath)
        self.account.link<&OzoneToken.Vault{FungibleToken.Balance}>(self.OzoneTokenBalancePath, target: self.OzoneTokenVaultPath)
    }
}
