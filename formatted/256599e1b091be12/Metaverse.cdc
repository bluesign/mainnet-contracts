...
pub contract Metaverse: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Metaverse.CollectionStoragePath, publicPath: Metaverse.CollectionPublicPath, providerPath: /private/ProvenancedCollectionsV9, publicCollection: Type<&Metaverse.Collection{Metaverse.MetaverseCollectionPublic, NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&Metaverse.Collection{Metaverse.MetaverseCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Metaverse.Collection{Metaverse.MetaverseCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Collection: MetaverseCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun borrowNFTSafe(id: UInt64): &NFT?{ 
            ...
            return self.ownedNFTs[id] != nil ? (&self.ownedNFTs[id] as auth &NonFungibleToken.NFT?)! as! &Metaverse.NFT : nil
        }
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &Metaverse.NFT?{ 
        let collection = (getAccount(from).getCapability(Metaverse.CollectionPublicPath)!).borrow<&Metaverse.Collection{Metaverse.MetaverseCollectionPublic}>() ?? panic("Couldn't get collection")
