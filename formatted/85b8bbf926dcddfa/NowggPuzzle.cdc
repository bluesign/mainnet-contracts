...
pub contract NowggPuzzle{ 
    ...
    pub resource PuzzleHelper: PuzzleHelperPublic, PuzzleHelperInterface{ 
        ...
        pub fun registerPuzzle(nftMinter: &NowggNFT.NFTMinter, puzzleId: String, parentNftTypeId: String, childNftTypeIds: [String], maxCount: UInt64){ 
        ...
        pub fun combinePuzzle(nftMinter: &NowggNFT.NFTMinter, nftProvider: &{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NowggNFT.NowggNFTCollectionPublic}, puzzleId: String, parentNftTypeId: String, childNftIds: [UInt64], metadata:{ String: AnyStruct}){ 
    ...
    init(){ 
        ...
        self.account.link<
            &NowggPuzzle.PuzzleHelper{NowggPuzzle.PuzzleHelperPublic}
