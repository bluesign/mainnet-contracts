...
pub contract MatrixMarket: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&MatrixMarket.Collection{NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MatrixMarket.MatrixMarketCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
