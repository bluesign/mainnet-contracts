...
pub contract MatrixMarketOpenOffer{ 
    ...
    pub event OfferCompleted(bidId: UInt64, purchased: Bool)
    ...
    pub resource OpenOffer: OpenOfferManager, OpenOfferPublic{ 
        priv var bids: @{UInt64: Offer}
        
        pub fun createOffer(vaultRefCapability: Capability<&{FungibleToken.Receiver, FungibleToken.Balance, FungibleToken.Provider}>, offerPrice: UFix64, rewardCapability: Capability<&{NonFungibleToken.CollectionPublic}>, nftType: Type, nftId: UInt64, cuts: [Cut], expirationTime: UFix64): UInt64{ 
