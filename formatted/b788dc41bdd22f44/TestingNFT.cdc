...
pub contract TestingNFT: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&TestingNFT.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, TestingNFT.TestingNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
