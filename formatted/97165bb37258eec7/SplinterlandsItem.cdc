...
pub contract SplinterlandsItem: NonFungibleToken{ 
    ...
    pub struct SplinterlandsItemStateData{ 
        ...
        priv let state: SplinterlandsItemState
    ...
    priv var itemIDsMinted:{ String: SplinterlandsItemStateData}
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        destroy(){ 
            post{ 
                (SplinterlandsItem.itemIDsMinted[self.itemID]!).getState() == SplinterlandsItemState.Burned:
                    "Should have state as burned for item id if NFT was destroyed"
            }
    ...
    pub resource Admin: AdminPublic{ 
        priv var adminCollectionPublicCapability: Capability<&SplinterlandsItem.Collection{SplinterlandsItem.ItemCollectionPublic}>
