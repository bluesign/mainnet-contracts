    ...
    pub resource NFT: NonFungibleToken.INFT, Public, MetadataViews.Resolver{ 
        ...
        pub fun resolveView(_ type: Type): AnyStruct?{ 
            ...
            if type == Type<MetadataViews.NFTCollectionData>(){ 
                return MetadataViews.NFTCollectionData(storagePath: Sportbit.CollectionStoragePath, publicPath: Sportbit.CollectionPublicPath, providerPath: /private/SportbitCollection, publicCollection: Type<&Sportbit.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, Sportbit.CollectionPublic}>(), publicLinkedType: Type<&Sportbit.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, Sportbit.CollectionPublic}>(), providerLinkedType: Type<&Sportbit.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, Sportbit.CollectionPublic}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                        return <-Sportbit.createEmptyCollection()
                    })
            }
            return nil
        }
