...
pub contract Wine: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Wine.CollectionStoragePath, publicPath: Wine.CollectionPublicPath, providerPath: /private/WineCollection, publicCollection: Type<&Wine.Collection{Wine.NFTCollectionPublic}>(), publicLinkedType: Type<&Wine.Collection{Wine.NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Wine.Collection{Wine.NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Set{ 
        ...
        priv var templateSupplies:{ UInt64: UInt64}
    ...
    init(){ 
        ...
        self.account.link<&Wine.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
