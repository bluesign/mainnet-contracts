...
pub contract MetayaBeneficiaryCut{ 
    ...
    pub event StoreCutPercentagesUpdated(
        saleID: UInt32,
    ...
    /// If the copyrightOwnerAndCutPercentage is nil, that means it has been removed.
    pub event PackCutPercentagesUpdated(
        packID: UInt32,
        copyrightOwnerAndCutPercentage:{ 
            String: UFix64
        }?
    ...
    /// If the copyrightOwnerAndCutPercentage is nil, that means it has been removed.
    pub event MarketCutPercentagesUpdated(
        playID: UInt32,
        copyrightOwnerAndCutPercentage:{ 
            String: UFix64
        }?
    ...
    priv var copyrightOwnerCapabilities:{ 
    ...
    priv var commonwealCapabilities:{ 
        String: Capability<&{FungibleToken.Receiver}>
    }
    
    /// Commonweal organization cutPercentages
    priv var commonwealCutPercentages:{ String: UFix64}
    ...
    pub resource Admin{ 
        ...
        pub fun setCopyrightOwnerCapability(
            name: String,
        ...
        pub fun setStoreCutPercentages(
            saleID: UInt32,
            copyrightOwnerAndCutPercentage:{ 
                String: UFix64
            }?
        ...
        pub fun setMarketCutPercentages(
            playID: UInt32,
            copyrightOwnerAndCutPercentage:{ 
                String: UFix64
            }?
    ...
    init(){ 
        ...
        self.metayaCapability = self.account.getCapability<
                &{FungibleToken.Receiver}
