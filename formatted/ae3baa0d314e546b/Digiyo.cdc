...
pub contract Digiyo: NonFungibleToken{ 
    ...
    priv var assetDatas:{ UInt32: Asset}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Digiyo.collectionStoragePath, publicPath: Digiyo.collectionPublicPath, providerPath: /private/DigiyoCollection, publicCollection: Type<&Digiyo.Collection{Digiyo.DigiyoNFTCollectionPublic}>(), publicLinkedType: Type<&Digiyo.Collection{Digiyo.DigiyoNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Digiyo.Collection{Digiyo.DigiyoNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-Digiyo.createEmptyCollection()
                        })
