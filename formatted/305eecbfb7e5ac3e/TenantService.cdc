...
pub contract TenantService: NonFungibleToken{ 
    ...
    // paths
    pub let ADMIN_OBJECT_PATH: StoragePath
    
    pub let PRIVATE_NFT_COLLECTION_PATH: StoragePath
    
    pub let PUBLIC_NFT_COLLECTION_PATH: PublicPath
    
    pub let PUBLIC_NFT_COLLECTION_PATH_CUSTOM: PublicPath
    
    // archetypes
    priv let archetypes:{ UInt64: Archetype}
    
    priv let archetypeAdmins: @{UInt64: ArchetypeAdmin}
    
    priv var archetypeSeq: UInt64
    
    priv let artifactsByArchetype:{ UInt64:{ UInt64: Bool}} // archetypeId -> {artifactId: true}
    
    // artifacts
    priv let artifacts:{ UInt64: Artifact}
    
    priv let artifactAdmins: @{UInt64: ArtifactAdmin}
    
    priv var artifactSeq: UInt64
    
    priv var nextNftSerialNumber:{ UInt64: UInt64}
    
    priv let setsByArtifact:{ UInt64:{ UInt64: Bool}} // artifactId -> {setId: true}
    
    priv let faucetsByArtifact:{ UInt64:{ UInt64: Bool}} // artifactId -> {faucetId: true}
    
    // sets
    priv let sets:{ UInt64: Set}
    
    priv let setAdmins: @{UInt64: SetAdmin}
    
    priv var setSeq: UInt64
    
    priv let artifactsBySet:{ UInt64:{ UInt64: Bool}} // setId -> {artifactId: true}
    
    priv let faucetsBySet:{ UInt64:{ UInt64: Bool}} // setId -> {faucetId: true}
    
    // prints
    priv let prints:{ UInt64: Print}
    
    priv let printAdmins: @{UInt64: PrintAdmin}
    
    priv var printSeq: UInt64
    
    // faucets
    priv let faucets:{ UInt64: Faucet}
    
    priv let faucetAdmins: @{UInt64: FaucetAdmin}
    
    priv var faucetSeq: UInt64
    ...
    init(tenantId: String, tenantName: String, tenantDescription: String, ADMIN_OBJECT_PATH: StoragePath, PRIVATE_NFT_COLLECTION_PATH: StoragePath, PUBLIC_NFT_COLLECTION_PATH: PublicPath, PUBLIC_NFT_COLLECTION_PATH_CUSTOM: PublicPath){ 
        self.id = tenantId
    ...
    pub resource TenantAdmin{ 
        ...
        //
        pub fun createArchetype(name: String, description: String, metadata:{ String: TenantService.MetadataField}): UInt64{ 
            pre{ 
                TenantService.closed != true:
        ...
        //
        pub fun createArtifact(archetypeId: UInt64, name: String, description: String, maxMintCount: UInt64, metadata:{ String: TenantService.MetadataField}): UInt64{ 
            pre{ 
                TenantService.closed != true:
                    "The Tenant is closed"
        ...
        //
        pub fun createPrint(artifactId: UInt64, setId: UInt64?, name: String, description: String, maxMintCount: UInt64, metadata:{ String: TenantService.MetadataField}): UInt64{ 
            pre{ 
                TenantService.closed != true:
                    "The Tenant is closed"
        ...
        //
        pub fun createFaucet(artifactId: UInt64, setId: UInt64?, name: String, description: String, maxMintCount: UInt64, metadata:{ String: TenantService.MetadataField}): UInt64{ 
            pre{ 
                TenantService.closed != true:
                    "The Tenant is closed"
                self.borrowArtifactAdmin(artifactId)?.closed != true:
        ...
        // Mints many NFTs
        //
        pub fun batchMintNFTs(count: UInt64, artifactId: UInt64, printId: UInt64?, faucetId: UInt64?, setId: UInt64?, metadata:{ String: TenantService.MetadataField}): @Collection{ 
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        priv let metadata:{ String: TenantService.MetadataField}
