...
pub contract StarlyCardBidV3{ 
    ...
    pub resource Bid: BidPublicView{ 
        ...
        priv let bidderFungibleReceiver: Capability<&{FungibleToken.Receiver}>
        
        priv let beneficiarySaleCutReceiver: StarlyCardMarket.SaleCutReceiverV2
        
        priv let creatorSaleCutReceiver: StarlyCardMarket.SaleCutReceiverV2
        
        priv let additionalSaleCutReceivers: [StarlyCardMarket.SaleCutReceiverV2]
        
        pub fun accept(bidderCardCollection: &StarlyCard.Collection{StarlyCard.StarlyCardCollectionPublic}, sellerFungibleReceiver: Capability<&{FungibleToken.Receiver}>, sellerCardCollection: Capability<&StarlyCard.Collection{NonFungibleToken.Provider}>, sellerStakedCardCollection: &StakedStarlyCard.Collection, sellerMarketCollection: &StarlyCardMarket.Collection, cardStakeId: UInt64?){ 
            pre{ 
        ...
        priv fun removeMarketSaleOfferIfExists(sellerMarketCollection: &StarlyCardMarket.Collection){ 
        ...
        priv fun unstakeCardIfStaked(sellerStakedCardCollection: &StakedStarlyCard.Collection, stakeId: UInt64){ 
        ...
        init(nftID: UInt64, starlyID: String, bidPrice: UFix64, bidVaultType: Type, bidderAddress: Address, bidderFungibleReceiver: Capability<&{FungibleToken.Receiver}>, bidderFungibleProvider: &AnyResource{FungibleToken.Provider}, beneficiarySaleCutReceiver: StarlyCardMarket.SaleCutReceiverV2, creatorSaleCutReceiver: StarlyCardMarket.SaleCutReceiverV2, additionalSaleCutReceivers: [StarlyCardMarket.SaleCutReceiverV2]){ 
            pre{ 
                bidPrice > 0.0:
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun accept(
            ...
            sellerCardCollection: Capability<
                &StarlyCard.Collection{NonFungibleToken.Provider}
            >,
    ...
    pub resource Collection: CollectionManager, CollectionPublic{ 
        ...
        pub fun accept(bidID: UInt64, bidderCardCollection: &StarlyCard.Collection{StarlyCard.StarlyCardCollectionPublic}, sellerFungibleReceiver: Capability<&{FungibleToken.Receiver}>, sellerCardCollection: Capability<&StarlyCard.Collection{NonFungibleToken.Provider}>, sellerStakedCardCollection: &StakedStarlyCard.Collection, sellerMarketCollection: &StarlyCardMarket.Collection, cardStakeId: UInt64?){ 
    ...
    pub fun createBid(
        ...
        let minterRoyalty =
            StarlyRoyalties.getMinterRoyalty(
                collectionID: collectionID,
                starlyID: starlyID
            )
            ?? panic("Could not get minter royalty")
        assert(
            beneficiarySaleCutReceiver.receiver.address
            == starlyRoyalty.address,
            message: "Incorrect Starly royalty address"
        )
        assert(
            creatorSaleCutReceiver.receiver.address
            == collectionRoyalty.address,
