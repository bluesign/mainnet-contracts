...
pub contract StarlyCardBid{ 
    ...
    pub resource Bid: BidPublicView{ 
        ...
        pub fun accept(bidderCardCollection: &StarlyCard.Collection{StarlyCard.StarlyCardCollectionPublic}, sellerFungibleReceiver: Capability<&{FungibleToken.Receiver}>, sellerCardCollection: Capability<&StarlyCard.Collection{NonFungibleToken.Provider}>, sellerStakedCardCollection: &StakedStarlyCard.Collection, sellerMarketCollection: &StarlyCardMarket.Collection){ 
            pre{ 
        ...
        priv fun unstakeCardIfStaked(sellerStakedCardCollection: &StakedStarlyCard.Collection){ 
        ...
        init(nftID: UInt64, starlyID: String, bidPrice: UFix64, bidVaultType: Type, bidderAddress: Address, bidderFungibleReceiver: Capability<&{FungibleToken.Receiver}>, bidderFungibleProvider: &AnyResource{FungibleToken.Provider}){ 
            pre{ 
                bidPrice > 0.0:
