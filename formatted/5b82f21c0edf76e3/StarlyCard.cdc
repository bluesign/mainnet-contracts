...
pub contract StarlyCard: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: StarlyCard.CollectionStoragePath, publicPath: StarlyCard.CollectionPublicPath, providerPath: /private/starlyCardCollection, publicCollection: Type<&StarlyCard.Collection{StarlyCard.StarlyCardCollectionPublic}>(), publicLinkedType: Type<&StarlyCard.Collection{StarlyCard.StarlyCardCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&StarlyCard.Collection{StarlyCard.StarlyCardCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, StarlyCardCollectionPublic{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &StarlyCard.NFT?{ 
        let collection = (getAccount(from).getCapability(StarlyCard.CollectionPublicPath)!).borrow<&StarlyCard.Collection{StarlyCard.StarlyCardCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    pub resource MinterProxy: MinterProxyPublic{ 
        priv var minterCapability: Capability<&NFTMinter>?
