...
pub contract StarlyCardMarket{ 
    ...
    pub fun checkSaleCutReceiver(
        saleCutReceiver: StarlyCardMarket.SaleCutReceiver
    ): Bool{ 
        return saleCutReceiver.receiver.borrow() != nil
    }
    
    pub fun checkSaleCutReceivers(
        saleCutReceivers: [
    ...
    pub fun checkSaleCutReceiverV2(
        saleCutReceiver: StarlyCardMarket.SaleCutReceiverV2
    ): Bool{ 
        return saleCutReceiver.receiver.borrow() != nil
    }
    
    pub fun checkSaleCutReceiversV2(
        saleCutReceivers: [
    ...
    pub resource SaleOffer: SaleOfferPublicView{ 
        ...
        priv let sellerItemProvider: Capability<&StarlyCard.Collection{NonFungibleToken.Provider}>
        
        priv let sellerSaleCutReceiver: SaleCutReceiver
        
        priv let beneficiarySaleCutReceiver: SaleCutReceiver
        
        priv let creatorSaleCutReceiver: SaleCutReceiver
        
        priv let additionalSaleCutReceivers: [SaleCutReceiver]
        ...
        //
        pub fun accept(buyerCollection: &StarlyCard.Collection{NonFungibleToken.Receiver}, buyerPayment: @FungibleToken.Vault, buyerAddress: Address){ 
            pre{ 
        ...
        //
        init(itemID: UInt64, starlyID: String, price: UFix64, sellerItemProvider: Capability<&StarlyCard.Collection{NonFungibleToken.Provider}>, sellerSaleCutReceiver: SaleCutReceiver, beneficiarySaleCutReceiver: SaleCutReceiver, creatorSaleCutReceiver: SaleCutReceiver, additionalSaleCutReceivers: [SaleCutReceiver]){ 
            pre{ 
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowSaleItem(itemID: UInt64): &SaleOffer{
            SaleOfferPublicView
        }?{} 
    ...
    pub resource Collection:
        ...
        pub fun remove(itemID: UInt64): @SaleOffer{ 
            ...
            return <-(
                self.saleOffers.remove(key: itemID)
