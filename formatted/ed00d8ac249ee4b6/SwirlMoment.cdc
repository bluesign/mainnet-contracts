...
pub contract SwirlMoment: NonFungibleToken{ 
    ...
    pub fun mint(proofs: [ProofOfMeeting]){ 
        ...
        for proof in proofs{ 
            ...
            let collectionRef = proof.account.getCapability(SwirlNametag.CollectionPublicPath).borrow<&{SwirlNametag.SwirlNametagCollectionPublic}>() ?? panic("no SwirlNametag.Collection found: ".concat(proof.account.address.toString()))
            ...
            for p in proofs{ 
                ...
                let recipient = p.account.getCapability(SwirlMoment.CollectionPublicPath).borrow<&{NonFungibleToken.CollectionPublic}>() ?? panic("no SwirlMoment.Collection found: ".concat(proof.account.address.toString()))
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: SwirlMoment.CollectionStoragePath, publicPath: SwirlMoment.CollectionPublicPath, providerPath: SwirlMoment.ProviderPrivatePath, publicCollection: Type<&SwirlMoment.Collection{SwirlMoment.SwirlMomentCollectionPublic}>(), publicLinkedType: Type<&SwirlMoment.Collection{SwirlMoment.SwirlMomentCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&SwirlMoment.Collection{SwirlMoment.SwirlMomentCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&SwirlMoment.Collection{NonFungibleToken.CollectionPublic, SwirlMoment.SwirlMomentCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
