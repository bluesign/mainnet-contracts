...
pub contract SwirlNametag: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: SwirlNametag.CollectionStoragePath, publicPath: SwirlNametag.CollectionPublicPath, providerPath: SwirlNametag.ProviderPrivatePath, publicCollection: Type<&SwirlNametag.Collection{SwirlNametag.SwirlNametagCollectionPublic}>(), publicLinkedType: Type<&SwirlNametag.Collection{SwirlNametag.SwirlNametagCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&SwirlNametag.Collection{SwirlNametag.SwirlNametagCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&SwirlNametag.Collection{NonFungibleToken.CollectionPublic, SwirlNametag.SwirlNametagCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
