...
pub contract NFTLockBox{ 
    ...
    pub resource LockBox: LockBoxPublic{ 
        ...
        priv let collection: Capability<&{NonFungibleToken.Provider, NonFungibleToken.Receiver}>
        ...
        init(collection: Capability<&{NonFungibleToken.Provider, NonFungibleToken.Receiver}>, receiverPath: PublicPath){ 
    ...
    pub fun createLockBox(
        collection: Capability<
            &{NonFungibleToken.Provider, NonFungibleToken.Receiver}
        >,
