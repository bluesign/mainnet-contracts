...
pub contract AvatarArtMarketplace{ 
    ...
    pub resource SaleCollection: SalePublic{ 
        ...
        priv var nfts: @{UInt64: NonFungibleToken.NFT}
        ...
        //
        pub fun listForSale(nft: @AvatarArtNFT.NFT, price: UFix64, paymentType: Type, receiver: Capability<&{FungibleToken.Receiver}>){ 
            pre{ 
                price > 0.0:
    ...
    init(){ 
        ...
        self
            .SaleCollectionStoragePath = /storage/avatarArtMarketplaceSaleCollection
        self
            .SaleCollectionPublicPath = /public/avatarArtMarketplaceSaleCollection
