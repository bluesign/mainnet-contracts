...
pub contract AshesV2{ 
    ...
    pub struct AshData{ 
        ...
        init(
            ...
            ashMeta["_burnedAtTimestamp"] = getCurrentBlock().timestamp
                    .toString()
            ashMeta["_burnedAtBlockheight"] = getCurrentBlock().height
                    .toString()
            self.meta = ashMeta
    ...
    pub fun mintFromVanillaAshes(vanillaAshNFT: @Ashes.Ash, msg: String): @Ash{ 
        ...
        ashMeta["vanillaAshTopshotSerial"] = vanillaAshNFT.momentData
                .serialNumber.toString()
        ashMeta["vanillaAshTopshotSetID"] = vanillaAshNFT.momentData.setID
                .toString()
        ashMeta["vanillaAshTopshotPlayID"] = vanillaAshNFT.momentData.playID
                .toString()
        let res <-
            create Ash(
