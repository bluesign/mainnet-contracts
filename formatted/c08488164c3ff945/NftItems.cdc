...
pub contract NftItems: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv var metadataobjs:{ UInt64:{ String: String}}
        
        pub fun getMetadataobjs():{ UInt64:{ String: String}}{ 
            return self.metadataobjs
        }
        
        priv var properties:{ UInt64:{ String: String}}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: NftItems.CollectionStoragePath, publicPath: NftItems.CollectionPublicPath, providerPath: /private/nftItemsCollectionsV9, publicCollection: Type<&NftItems.Collection{NftItems.NftItemsCollectionPublic}>(), publicLinkedType: Type<&NftItems.Collection{NftItems.NftItemsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&NftItems.Collection{NftItems.NftItemsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, thumbnail: String, collectionthumbnail: String, metadataobjs:{ UInt64:{ String: String}}, properties:{ UInt64:{ String: String}}, cid: String, path: String, traitName: String, traitValue: String, metadata:{ String: AnyStruct}){ 
    ...
    init(){ 
        ...
        self.account.link<&NftItems.Collection{NonFungibleToken.CollectionPublic, NftItems.NftItemsCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
