...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xe637521cf3331a30
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xe637521cf3331a30
