...
pub contract MotoGPTransfer: ContractVersion{ 
    ...
    //
    priv var flowVault: @FlowToken.Vault
    
    priv var isPaused: Bool //for future use
    ...
    //
    priv fun topUp(_ toAddress: Address){ 
        post{ 
    ...
    //
    priv fun flowForStorage(_ storage: UInt64): UFix64{ 
