...
pub contract MotoGPCardMetadata: ContractVersion{ 
    ...
    pub fun resolveView(view: Type, id: UInt64, cardID: UInt64, serial: UInt64, publicCollectionType: Type, publicLinkedType: Type, providerLinkedType: Type, createEmptyCollectionFunction: ((): @NonFungibleToken.Collection)): AnyStruct?{ 
        switch view{ 
            ...
            case Type<MetadataViews.NFTCollectionData>():
                return MetadataViews.NFTCollectionData(storagePath: StoragePath(identifier: "motogpCardCollection")!, publicPath: PublicPath(identifier: "motogpCardCollection")!, providerPath: PrivatePath(identifier: "motogpCardCollection")!, publicCollection: publicCollectionType, publicLinkedType: publicLinkedType, providerLinkedType: providerLinkedType, createEmptyCollectionFunction: createEmptyCollectionFunction)
        }
        return nil
    }
    ...
    //
    priv let metadatas:{ UInt64: MotoGPCardMetadata.Metadata}
