...
pub contract NFTSales: ContractVersion{ 
    ...
    pub resource Sales{ 
        ...
        init(maxSHRD: UFix64, shrdPerGrade:{ String: UFix64}, cardsPerPack: UInt64, price: UFix64, startTime: UFix64, endTime: UFix64, maxPerWallet: UInt64, cardTypeWeights: [[UInt32]], // If empty, should be [], not [[],[],[]] cardTypes: [[UInt64]]){ // If empty, should be [], not [[],[],[]] 
            pre{ 
    ...
    pub fun createSales(adminRef: &MotoGPAdmin.Admin, maxSHRD: UFix64, shrdPerGrade:{ String: UFix64}, cardsPerPack: UInt64, price: UFix64, startTime: UFix64, endTime: UFix64, maxPerWallet: UInt64, cardTypeWeights: [[UInt32]], cardTypes: [[UInt64]]): @Sales{ 
        pre{ 
            adminRef != nil:
                "adminRef is nil"
        }
