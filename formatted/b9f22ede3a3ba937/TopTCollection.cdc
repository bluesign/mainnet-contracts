...
pub contract TopTCollection: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TopTCollection.CollectionStoragePath, publicPath: TopTCollection.CollectionPublicPath, providerPath: /private/topTNFTCollection, publicCollection: Type<&TopTCollection.Collection{TopTCollection.TopTCollectionPublic}>(), publicLinkedType: Type<&TopTCollection.Collection{TopTCollection.TopTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TopTCollection.Collection{TopTCollection.TopTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &TopTCollection.NFT?{ 
        let collection = getAccount(from).getCapability(TopTCollection.CollectionPublicPath).borrow<&TopTCollection.Collection{TopTCollection.TopTCollectionPublic}>() ?? panic("Couldn't get collection")
