...
pub contract Collector: NonFungibleToken{ 
    ...
    priv var Templates:{ UInt64: Template}
    
    // Variable size dictionary of SetData structs
    priv var SetsData:{ UInt64: SetData}
    ...
    /* DEPRECATED - DO NOT USE */    pub struct CollectorMetadataView{ 
        pub let id: UInt64
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Collector.CollectionStoragePath, publicPath: Collector.CollectionPublicPath, providerPath: /private/CollectorCollection, publicCollection: Type<&Collector.Collection{Collector.NFTCollectionPublic}>(), publicLinkedType: Type<&Collector.Collection{Collector.NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collector.Collection{Collector.NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Set{ 
        ...
        priv var templateIDs: [UInt64]
        
        priv var availableTemplateIDs: [UInt64]
    ...
    init(){ 
        ...
        self.account.link<&Collector.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
