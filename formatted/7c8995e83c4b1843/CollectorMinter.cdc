...
pub contract CollectorMinter{ 
    ...
    priv var privateSaleAccounts:{ Address: UInt64}
    
    priv var presaleAccounts:{ Address: UInt64}
    
    priv var publicSaleAccounts:{ Address: UInt64}
    ...
    pub fun privateSaleMintNFTWithDUC(
        buyer: Address,
        setID: UInt64,
        ...
        let admin =
            self.account.borrow<&Collector.Admin>(
                from: Collector.AdminStoragePath
            )
        ...
        let merchantDUCReceiverRef =
            getAccount(self.merchantAccount).getCapability<
        ...
        let NFTReceiver =
            recipient.getCapability(Collector.CollectionPublicPath).borrow<
        ...
        self.privateSaleAccounts[buyer] = self.privateSaleAccounts[buyer]!
            - numberOfTokens
    }
    ...
    pub fun presaleMintNFTWithDUC(
        ...
        // Remove utilized spots
        self.presaleAccounts[buyer] = self.presaleAccounts[buyer]!
            - numberOfTokens
    }
    
    pub fun publicSaleMintNFTWithDUC(
        buyer: Address,
        setID: UInt64,
        paymentVault: @FungibleToken.Vault,
        numberOfTokens: UInt64,
        ...
        // Remove utilized spots
        self.publicSaleAccounts[buyer] = self.publicSaleAccounts[buyer]!
            - numberOfTokens
    }
    ...
    pub resource Admin{ 
        ...
        pub fun updatePrivateSaleAccountAmount(
            address: Address,
            amount: UInt64
        ){ 
            pre{ 
