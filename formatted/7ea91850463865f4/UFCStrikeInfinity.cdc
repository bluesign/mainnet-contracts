...
pub contract UFCStrikeInfinity: NonFungibleToken, ViewResolver{ 
    ...
    priv let owners: [Address]
    
    /// Maps each verify ID to its minted status
    priv let minted:{ UInt256: Bool}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: UFCStrikeInfinity.CollectionStoragePath, publicPath: UFCStrikeInfinity.CollectionPublicPath, providerPath: /private/UFCStrikeInfinityCollection, publicCollection: Type<&UFCStrikeInfinity.Collection{UFCStrikeInfinity.UFCStrikeInfinityCollectionPublic, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&UFCStrikeInfinity.Collection{UFCStrikeInfinity.UFCStrikeInfinityCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&UFCStrikeInfinity.Collection{UFCStrikeInfinity.UFCStrikeInfinityCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    ///
    pub fun claim(chain_id: String, campaign_id: UInt256, verify_id: UInt256, cap: UInt256, recipient: Address, signature: String, name: String, description: String, thumbnail: String, metadata:{ String: String}){ 
        ...
        let receiver = getAccount(recipient).getCapability(UFCStrikeInfinity.CollectionPublicPath).borrow<&{NonFungibleToken.CollectionPublic}>() ?? panic("Could not get receiver reference to the NFT Collection")
    ...
    priv fun verifyClaimSignature(address: Address, signature: String, signedData: [UInt8]): Bool{ 
    ...
    init(){ 
        ...
        self.account.link<&UFCStrikeInfinity.Collection{NonFungibleToken.CollectionPublic, UFCStrikeInfinity.UFCStrikeInfinityCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
