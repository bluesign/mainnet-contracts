...
pub contract Syllables: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Syllables.CollectionStoragePath, publicPath: Syllables.CollectionPublicPath, providerPath: /private/SyllablesCollection, publicCollection: Type<&Syllables.Collection{Syllables.SyllablesCollectionPublic}>(), publicLinkedType: Type<&Syllables.Collection{Syllables.SyllablesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Syllables.Collection{Syllables.SyllablesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&Syllables.Collection{NonFungibleToken.CollectionPublic, Syllables.SyllablesCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
