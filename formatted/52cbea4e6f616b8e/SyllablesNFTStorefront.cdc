...
///
pub contract SyllablesNFTStorefront{ 
    /// SyllablesNFTStorefrontInitialized
    /// This contract has been deployed.
    /// Event consumers can now expect events from this contract.
    ///
    pub event SyllablesNFTStorefrontInitialized()
    ...
    /// SyllablesNFTStorefront workflow, so be careful to check when using them.
    ///
    ...
    init(){ 
        self.StorefrontStoragePath = /storage/SyllablesNFTStorefront
        self.StorefrontPublicPath = /public/SyllablesNFTStorefront
        emit SyllablesNFTStorefrontInitialized()
    }
}
