...
pub contract GroundWork29: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: GroundWork29.CollectionStoragePath, publicPath: GroundWork29.CollectionPublicPath, providerPath: /private/GroundWork29Collection, publicCollection: Type<&GroundWork29.Collection{GroundWork29.GroundWork29CollectionPublic}>(), publicLinkedType: Type<&GroundWork29.Collection{GroundWork29.GroundWork29CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&GroundWork29.Collection{GroundWork29.GroundWork29CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&GroundWork29.Collection{NonFungibleToken.CollectionPublic, GroundWork29.GroundWork29CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
