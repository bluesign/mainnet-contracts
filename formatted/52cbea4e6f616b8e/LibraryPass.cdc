...
pub contract LibraryPass: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: LibraryPass.CollectionStoragePath, publicPath: LibraryPass.CollectionPublicPath, providerPath: /private/libraryPassCollection, publicCollection: Type<&LibraryPass.Collection{LibraryPass.LibraryPassCollectionPublic}>(), publicLinkedType: Type<&LibraryPass.Collection{LibraryPass.LibraryPassCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&LibraryPass.Collection{LibraryPass.LibraryPassCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, ipfsLink: String, type: UInt64){ 
