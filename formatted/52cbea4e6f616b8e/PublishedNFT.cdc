...
pub contract PublishedNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: PublishedNFT.CollectionStoragePath, publicPath: PublishedNFT.CollectionPublicPath, providerPath: /private/PublishedNFTCollection, publicCollection: Type<&PublishedNFT.Collection{PublishedNFT.PublishedNFTCollectionPublic}>(), publicLinkedType: Type<&PublishedNFT.Collection{PublishedNFT.PublishedNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&PublishedNFT.Collection{PublishedNFT.PublishedNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&PublishedNFT.Collection{NonFungibleToken.CollectionPublic, PublishedNFT.PublishedNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
