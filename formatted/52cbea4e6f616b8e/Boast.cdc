...
pub contract Boast: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Boast.CollectionStoragePath, publicPath: Boast.CollectionPublicPath, providerPath: /private/BoastCollection, publicCollection: Type<&Boast.Collection{Boast.BoastCollectionPublic}>(), publicLinkedType: Type<&Boast.Collection{Boast.BoastCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Boast.Collection{Boast.BoastCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&Boast.Collection{NonFungibleToken.CollectionPublic, Boast.BoastCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
