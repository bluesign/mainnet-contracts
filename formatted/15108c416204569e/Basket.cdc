...
pub contract Basket: NonFungibleToken, ViewResolver{ 
    ...
    pub fun getDefaultCollectionStoragePath(): StoragePath{ 
        return self.CollectionStoragePath
    }
    
    pub fun getDefaultCollectionPublicPath(): PublicPath{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Basket.CollectionStoragePath, publicPath: Basket.CollectionPublicPath, providerPath: /private/exampleNFTCollection, publicCollection: Type<&Basket.Collection{Basket.BasketCollectionPublic}>(), publicLinkedType: Type<&Basket.Collection{Basket.BasketCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Basket.Collection{Basket.BasketCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            case Type<MetadataViews.NFTCollectionData>():
                return MetadataViews.NFTCollectionData(storagePath: Basket.CollectionStoragePath, publicPath: Basket.CollectionPublicPath, providerPath: /private/BasketCollection, publicCollection: Type<&Basket.Collection{Basket.BasketCollectionPublic}>(), publicLinkedType: Type<&Basket.Collection{Basket.BasketCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Basket.Collection{Basket.BasketCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                        return <-Basket.createEmptyCollection()
                    })
            case Type<MetadataViews.NFTCollectionDisplay>():
                let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://basket-sable.vercel.app/_app/immutable/assets/basket-icon.41a9e902.svg"), mediaType: "image/svg+xml")
    ...
    init(){ 
        ...
        self.account.link<&{BasketCollectionPublic, NonFungibleToken.CollectionPublic}>(Basket.CollectionPublicPath, target: Basket.CollectionStoragePath)
