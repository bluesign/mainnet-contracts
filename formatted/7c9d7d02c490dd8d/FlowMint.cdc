...
pub contract FlowMint: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&FlowMint.Collection{NonFungibleToken.CollectionPublic, FlowMint.FlowMintCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
