...
pub contract MIKOSEANFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    return MetadataViews.Royalties([MetadataViews.Royalty(receiver: getAccount(0x0b80e42aaab305f0).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: MIKOSEANFT.getProjectPlatformFee(projectId: projectId) ?? 0.05, description: "Platform fee"), MetadataViews.Royalty(receiver: getAccount(MIKOSEANFT.getProjectCreatorAddress(projectId: projectId)!).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: MIKOSEANFT.getProjectCreatorFee(projectId: projectId) ?? 0.1, description: "Creater fee")])
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MIKOSEANFT.CollectionStoragePath, publicPath: MIKOSEANFT.CollectionPublicPath, providerPath: /private/MiKoSeaNFTCollection, publicCollection: Type<&MIKOSEANFT.Collection{MIKOSEANFT.MikoSeaCollectionPublic}>(), publicLinkedType: Type<&MIKOSEANFT.Collection{MIKOSEANFT.MikoSeaCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MIKOSEANFT.Collection{MIKOSEANFT.MikoSeaCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun checkCollection(_ address: Address): Bool{ 
        return getAccount(address).getCapability<&{MIKOSEANFT.MikoSeaCollectionPublic}>(MIKOSEANFT.CollectionPublicPath).check()
    }
