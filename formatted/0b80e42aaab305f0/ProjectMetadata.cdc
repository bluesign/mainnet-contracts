pub contract ProjectMetadata{ 
    ...
    pub struct RatioRandomNFT{ 
        ...
        access(contract) fun getRandomByRatio(
            _ items: [
                RatioRandomNFTItem
            ]
        ): RatioRandomNFTItem{ 
            ...
            var i = 0
            var cumSum = 0.0
            let randomNum: UFix64 =
                UFix64(revertibleRandom() % 1000000) / 1000000.0 // get random number from 0.0 to 0.99999
            while i < itemLen{ 
        ...
        pub fun getRaitoRandomItemForMint(_ quantity: UInt64): [
            RatioRandomNFTItem
        ]{ 
    ...
    pub struct LotteryRandomNFT{ 
        ...
        priv fun getLotteryNumberIndex(): Int{ 
            ...
            let randomIndex =
                Int(randomNum * UFix64(self.lotteryNumberNotUse.length)) // get random number from 0 to lotteryNumberNotUse.length - 1
            return randomIndex
        }
