...
pub contract MikoSeaMarketHistoryV2{ 
    ...
    pub event RevenueUpdatedStatus(
        revenueId: UInt64,
        status: String,
        updatedAt: UFix64
    )
    
    pub event RevenueCreated(
        revenueId: UInt64,
        userAddress: Address,
        amount: UFix64,
        transactionIds: [
    ...
    pub resource Transaction{ 
        ...
        init(
            ...
            MikoSeaMarketHistoryV2.nextTransactionId = MikoSeaMarketHistoryV2
                    .nextTransactionId
                + 1
        }
    ...
    pub resource Revenue{ 
        ...
        init(
            ...
            self.amount = amount
            self.userAddress = userAddress
            MikoSeaMarketHistoryV2.nextRevenueId = MikoSeaMarketHistoryV2
                    .nextRevenueId
                + 1
            emit RevenueCreated(
    ...
    pub resource Admin: AdminPublicCollection{ 
        ...
        pub fun addTransaction(owner: Address, amount: UFix64, royalties: MetadataViews.Royalties?, type: String, metadata:{ String: String}, message: String): &Transaction{ 
        ...
        pub fun addTransactionWithoutFee(owner: Address, amount: UFix64, type: String, metadata:{ String: String}, message: String): &Transaction{ 
    ...
    priv fun getAdminRef(): &MikoSeaMarketHistoryV2.Admin{ 
        return self.account.borrow<&MikoSeaMarketHistoryV2.Admin>(
