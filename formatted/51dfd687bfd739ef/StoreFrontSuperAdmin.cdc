...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x51dfd687bfd739ef
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x51dfd687bfd739ef
