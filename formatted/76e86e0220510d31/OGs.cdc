...
pub contract OGs: NonFungibleToken, CollecticoStandardNFT, CollectionResolver{ 
    ...
    // for the future use
    priv var nftViewResolvers: @{String: AnyResource{CollecticoStandardViews.NFTViewResolver}}
    
    priv var itemViewResolvers: @{String: AnyResource{CollecticoStandardViews.ItemViewResolver}}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                case Type<CollecticoStandardViews.NFTView>():
                    return CollecticoStandardViews.NFTView(id: self.id, itemId: self.itemId, itemName: item.name.concat(" #").concat(self.serialNumber.toString()), itemDescription: item.description, itemThumbnail: item.thumbnail, itemMetadata: item.metadata, serialNumber: self.serialNumber, metadata: self.metadata, itemTotalSupply: item.getTotalSupply(), itemMaxSupply: item.maxSupply, isTransferable: self.isTransferable, contractInfo: OGs.getContractInfo(), collectionDisplay: OGs.getCollectionDisplay(), royalties: MetadataViews.getRoyalties(&self as &OGs.NFT{MetadataViews.Resolver}), display: MetadataViews.getDisplay(&self as &OGs.NFT{MetadataViews.Resolver}), traits: MetadataViews.getTraits(&self as &OGs.NFT{MetadataViews.Resolver}), editions: MetadataViews.getEditions(&self as &OGs.NFT{MetadataViews.Resolver}), medias: MetadataViews.getMedias(&self as &OGs.NFT{MetadataViews.Resolver}), license: MetadataViews.getLicense(&self as &OGs.NFT{MetadataViews.Resolver}))
                case Type<CollecticoStandardViews.ContractInfo>():
                    return OGs.getContractInfo()
                case Type<MetadataViews.Display>():
    ...
    pub fun getCollectionData(): MetadataViews.NFTCollectionData{ 
        return MetadataViews.NFTCollectionData(storagePath: self.CollectionStoragePath, publicPath: self.CollectionPublicPath, providerPath: self.CollectionProviderPath, publicCollection: Type<&OGs.Collection{OGs.CollectionPublic}>(), publicLinkedType: Type<&OGs.Collection{OGs.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&OGs.Collection{OGs.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Admin{ 
        ...
        pub fun createItem(name: String, description: String, thumbnail: MetadataViews.Media, metadata:{ String: AnyStruct}?, maxSupply: UInt64?, isTransferable: Bool?, royalties: [MetadataViews.Royalty]?): UInt64{ 
    ...
    init(){ 
        ...
        self.account.link<&OGs.Collection{NonFungibleToken.CollectionPublic, OGs.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
