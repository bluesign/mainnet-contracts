...
pub contract FLOATVerifiers{ 
    ...
    pub struct Timelock: MusicPeaksSocialToken.IVerifier{ 
    ...
    pub struct Secret: MusicPeaksSocialToken.IVerifier{ 
    ...
    // delete their FLOATs.
    pub struct Limited: MusicPeaksSocialToken.IVerifier{ 
        pub var capacity: UInt64
        
        pub fun verify(_ params:{ String: AnyStruct}){ 
            let event = params["event"]! as! &MusicPeaksSocialToken.FLOATEvent{MusicPeaksSocialToken.FLOATEventPublic}
    ...
    // from the list.
    pub struct MultipleSecret: MusicPeaksSocialToken.IVerifier{ 
    ...
    pub struct SecretV2: MusicPeaksSocialToken.IVerifier{ 
