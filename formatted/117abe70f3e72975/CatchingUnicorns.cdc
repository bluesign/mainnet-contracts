...
pub contract CatchingUnicorns: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&CatchingUnicorns.Collection{NonFungibleToken.CollectionPublic, CatchingUnicorns.CatchingUnicornsCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
