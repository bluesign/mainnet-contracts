...
pub contract NBATopShotArena: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: NBATopShotArena.CollectionStoragePath, publicPath: NBATopShotArena.CollectionPublicPath, providerPath: NBATopShotArena.CollectionPrivatePath, publicCollection: Type<&NBATopShotArena.Collection{NBATopShotArena.NBATopShotArenaCollectionPublic}>(), publicLinkedType: Type<&NBATopShotArena.Collection{NBATopShotArena.NBATopShotArenaCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&NBATopShotArena.Collection{NBATopShotArena.NBATopShotArenaCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Admin{ 
        ...
        ///
        pub fun createEdition(mintID: String, limit: UInt64?, name: String, description: String, thumbnail: String, asset: String, assetType: String, eventName: String, eventDate: String, externalURL: String, attributes:{ String: String}): UInt64{ 
