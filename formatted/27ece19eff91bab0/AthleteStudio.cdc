...
pub contract AthleteStudio: NonFungibleToken{ 
    ...
    priv let editions:{ UInt64: Edition}
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: AthleteStudio.CollectionStoragePath, publicPath: AthleteStudio.CollectionPublicPath, providerPath: AthleteStudio.CollectionPrivatePath, publicCollection: Type<&AthleteStudio.Collection{AthleteStudio.AthleteStudioCollectionPublic}>(), publicLinkedType: Type<&AthleteStudio.Collection{AthleteStudio.AthleteStudioCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&AthleteStudio.Collection{AthleteStudio.AthleteStudioCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
        ...
        pub fun resolveSerialView(_ serialNumber: UInt64): MetadataViews.Serial{ 
            return MetadataViews.Serial(number: serialNumber)
        }
        ...
        pub fun resolveMedias(_ metadata: Metadata): MetadataViews.Medias{ 
            return MetadataViews.Medias(items: [MetadataViews.Media(file: MetadataViews.IPFSFile(cid: metadata.asset, path: nil), mediaType: metadata.assetType), MetadataViews.Media(file: MetadataViews.IPFSFile(cid: metadata.thumbnail, path: nil), mediaType: "image/png")])
        }
    ...
    pub resource Admin{ 
        ...
        ///
        pub fun createEdition(mintID: String, size: UInt64, name: String, description: String, thumbnail: String, asset: String, assetType: String, athleteID: Int, athleteName: String, athleteURL: String, itemType: String, itemCategory: String, series: String, eventName: String, eventDate: String, eventType: String, signed: Bool): UInt64{ 
