...
pub contract RaribleOpenBid{ 
    ...
    pub event BidCompleted(bidId: UInt64, purchased: Bool)
    ...
    pub resource OpenBid: OpenBidManager, OpenBidPublic{ 
        ...
        pub fun createBid(vaultRefCapability: Capability<&{FungibleToken.Receiver, FungibleToken.Balance, FungibleToken.Provider}>, offerPrice: UFix64, rewardCapability: Capability<&{NonFungibleToken.CollectionPublic}>, nftType: Type, nftId: UInt64, cuts: [Cut]): UInt64{ 
