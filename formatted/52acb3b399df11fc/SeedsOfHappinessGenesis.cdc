...
pub contract SeedsOfHappinessGenesis: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: SeedsOfHappinessGenesis.CollectionStoragePath, publicPath: SeedsOfHappinessGenesis.CollectionPublicPath, providerPath: SeedsOfHappinessGenesis.CollectionPrivatePath, publicCollection: Type<&SeedsOfHappinessGenesis.Collection{SeedsOfHappinessGenesis.SeedsOfHappinessGenesisCollectionPublic}>(), publicLinkedType: Type<&SeedsOfHappinessGenesis.Collection{SeedsOfHappinessGenesis.SeedsOfHappinessGenesisCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&SeedsOfHappinessGenesis.Collection{SeedsOfHappinessGenesis.SeedsOfHappinessGenesisCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
