...
pub contract BeerayBucks: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                BeerayBucks.totalSupply = BeerayBucks.totalSupply - self.balance
            }
        }
    }
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(storagePath: BeerayBucks.VaultStoragePath, receiverPath: BeerayBucks.ReceiverPublicPath, metadataPath: BeerayBucks.VaultPublicPath, providerPath: /private/BeerayBucksVault, receiverLinkedType: Type<&Vault{FungibleToken.Receiver}>(), metadataLinkedType: Type<&Vault{FungibleToken.Balance, MetadataViews.Resolver}>(), providerLinkedType: Type<&Vault{FungibleToken.Provider}>(), createEmptyVaultFunction: fun (): @Vault{ 
                        return <-BeerayBucks.createEmptyVault()
                    })
        }
        return nil
    }
