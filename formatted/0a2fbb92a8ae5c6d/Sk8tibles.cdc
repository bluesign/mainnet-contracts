...
pub contract Sk8tibles: NonFungibleToken, TiblesApp, TiblesNFT, TiblesProducer{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, TiblesNFT.INFT, MetadataViews.Resolver{ 
        ...
        pub fun nftCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: Sk8tibles.CollectionStoragePath, publicPath: Sk8tibles.PublicCollectionPath, providerPath: /private/Sk8tiblesCollection, publicCollection: Type<&Sk8tibles.Collection{TiblesNFT.CollectionPublic}>(), publicLinkedType: Type<&Sk8tibles.Collection{TiblesNFT.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Sk8tibles.Collection{TiblesNFT.CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
