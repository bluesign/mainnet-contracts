...
pub contract EmeraldIdentityDapper{ 
    ...
    pub resource Administrator{ 
        ...
        pub fun removeByAccount(account: Address){ 
            let discordID =
                EmeraldIdentityDapper.getDiscordFromAccount(account: account)
        ...
        priv fun remove(account: Address, discordID: String){ 
        ...
        pub fun createAdministrator(): Capability<&Administrator>{ 
            return EmeraldIdentityDapper.account.getCapability<&Administrator>(
                EmeraldIdentityDapper.AdministratorPrivatePath
            )
        }
    ...
    /*** USE THE BELOW FUNCTIONS FOR SECURE VERIFICATION OF ID ***/    pub fun getDiscordFromAccount(account: Address): String?{ 
        let admin =
            EmeraldIdentityDapper.account.borrow<&Administrator>(
                from: EmeraldIdentityDapper.AdministratorStoragePath
            )!
    ...
    init(){ 
        ...
        self.account.save(
            ...
            to: EmeraldIdentityDapper.AdministratorStoragePath
        )
        self.account.link<&Administrator>(
            EmeraldIdentityDapper.AdministratorPrivatePath,
            target: EmeraldIdentityDapper.AdministratorStoragePath
        )
    }
}
