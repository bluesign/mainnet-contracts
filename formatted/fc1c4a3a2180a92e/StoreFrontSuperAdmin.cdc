...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xfc1c4a3a2180a92e
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xfc1c4a3a2180a92e
