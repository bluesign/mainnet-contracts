...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xb91d6d1a35de19b9
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xb91d6d1a35de19b9
