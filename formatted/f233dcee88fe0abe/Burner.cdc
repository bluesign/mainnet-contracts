...
pub contract Burner{ 
    pub        /// When Crescendo (Cadence 1.0) is released, custom destructors will be removed from cadece.
        ...
        /// 
        /// NOTE: This is not meant to be used until after the Cadence 1.0 upgrade
        resource interface Burnable{ 
