...
pub contract Monsoon: NonFungibleToken{ 
    ...
    pub resource Collection: MonsoonCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic{ 
        ...
        pub fun listCards():{ UInt64: CardData}{ 
            ...
            for key in self.ownedNFTs.keys{ 
                ...
                let ref = &self.ownedNFTs[key] as auth &NonFungibleToken.NFT? //update secure cadence
        ...
        pub fun borrowMonsoonCard(id: UInt64): &Monsoon.NFT?{ 
            if self.ownedNFTs[id] != nil{ 
                let ref = &self.ownedNFTs[id] as auth &NonFungibleToken.NFT? // update secure cadence
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &Monsoon.NFT?{ 
        let collection = (getAccount(from).getCapability(Monsoon.CollectionPublicPath)!).borrow<&Monsoon.Collection{Monsoon.MonsoonCollectionPublic}>() ?? panic("Couldn't get collection")
