...
pub contract SolarpupsNFT: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, TokenDataAware, MetadataViews.Resolver{ 
        ...
        priv let items: @{String:{ TokenDataAware, NonFungibleToken.INFT}}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: SolarpupsNFT.SolarpupsNFTStoragePath, publicPath: SolarpupsNFT.SolarpupsNFTPublicPath, providerPath: SolarpupsNFT.SolarpupsNFTPrivatePath, publicCollection: Type<&SolarpupsNFT.Collection{SolarpupsNFT.CollectionPublic}>(), publicLinkedType: Type<&SolarpupsNFT.Collection{SolarpupsNFT.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&SolarpupsNFT.Collection{SolarpupsNFT.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&SolarpupsNFT.Collection{NonFungibleToken.CollectionPublic, SolarpupsNFT.CollectionPublic, MetadataViews.ResolverCollection}>(self.SolarpupsNFTPublicPath, target: self.SolarpupsNFTStoragePath)
