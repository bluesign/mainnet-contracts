...
pub contract GigantikDemo_NFT: NonFungibleToken{ 
    
    // GigantikDemo_NFT Events
    //
    // Emitted when the GigantikDemo_NFT contract is created
    ...
    // totalSupply
    // The total number of GigantikDemo_NFT that have been minted
    //
    ...
    // A Series is special resource type that contains functions to mint GigantikDemo_NFT NFTs, 
    ...
    pub resource Series{ 
        ...
        init(seriesId: UInt32, metadata:{ String: String}){ 
            ...
            self.setIds = []
            self.setSealedState ={} 
            GigantikDemo_NFT.seriesData[seriesId] = SeriesData(seriesId: seriesId, metadata: metadata)
        ...
        pub fun addNftSet(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            ...
            GigantikDemo_NFT.setData[setId] = newNFTSet
        ...
        pub fun updateSeriesMetadata(metadata:{ String: String}){ 
            ...
            GigantikDemo_NFT.seriesData[self.seriesId] = newSeriesMetadata
        ...
        pub fun updateSetMetadata(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            ...
            GigantikDemo_NFT.setData[setId] = newSetMetadata
            emit SetMetadataUpdated(seriesId: self.seriesId, setId: setId)
        }
        
        // mintGigantikDemo_NFT
        // Mints a new NFT with a new ID
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintGigantikDemo_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= GigantikDemo_NFT.getSetMaxEditions(setId: setId)!:
            ...
            recipient.deposit(token: <-create GigantikDemo_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: editionNum))
            
            // Increment the count of global NFTs 
            GigantikDemo_NFT.totalSupply = GigantikDemo_NFT.totalSupply + 1 as UInt64
            
            // Update the count of Editions minted in the set
            self.numberEditionsMintedPerSet[setId] = editionNum
        }
        
        // mintEditionGigantikDemo_NFT
        // Mints a new NFT with a new ID and specific edition Num (random open edition)
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintEditionGigantikDemo_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32, edition: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= GigantikDemo_NFT.getSetMaxEditions(setId: setId)!:
            ...
            // deposit it in the recipient's account using their reference
            recipient.deposit(token: <-create GigantikDemo_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: edition))
        ...
        // batchMintGigantikDemo_NFT
        // Mints multiple new NFTs given and deposits the NFTs
        // into the recipients collection using their collection reference
        pub fun batchMintGigantikDemo_NFT(recipient: &{NonFungibleToken.CollectionPublic}, setId: UInt32, tokenIds: [UInt64]){ 
            pre{ 
                tokenIds.length > 0:
                    "Number of token Ids must be > 0"
            }
            for tokenId in tokenIds{ 
                self.mintGigantikDemo_NFT(recipient: recipient, tokenId: tokenId, setId: setId)
            }
        }
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(tokenId: UInt64, setId: UInt32, editionNum: UInt32){ 
            ...
            let seriesId = GigantikDemo_NFT.getSetSeriesId(setId: setId)!
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "name")!, description: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "description")!, thumbnail: MetadataViews.HTTPFile(url: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!))
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(self.id)
                case Type<MetadataViews.Editions>():
                    let maxEditions = GigantikDemo_NFT.setData[self.setId]?.maxEditions ?? 0
                    let editionName = GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "name")!
                ...
                case Type<MetadataViews.ExternalURL>():
                    if let externalBaseURL = GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "external_token_base_url"){ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    for metadataKey in (GigantikDemo_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 13{ 
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_"{ 
                                ...
                                let royaltyAddress = GigantikDemo_NFT.convertStringToAddress(GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_addr_".concat(royaltyName))!)!
                                let royaltyReceiver: PublicPath = PublicPath(identifier: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_rcv_".concat(royaltyName))!)!
                                ...
                                if cutValue != 0.0{ 
                                    royalties.append(MetadataViews.Royalty(receiver: getAccount(royaltyAddress).getCapability<&FungibleToken.Vault{FungibleToken.Receiver}>(royaltyReceiver), cut: cutValue, description: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!))
                                }
                            }
                        }
                    }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: GigantikDemo_NFT.CollectionStoragePath, publicPath: GigantikDemo_NFT.CollectionPublicPath, providerPath: /private/GigantikDemo_NFT, publicCollection: Type<&GigantikDemo_NFT.Collection{GigantikDemo_NFT.GigantikDemo_NFTCollectionPublic, NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&GigantikDemo_NFT.Collection{GigantikDemo_NFT.GigantikDemo_NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&GigantikDemo_NFT.Collection{GigantikDemo_NFT.GigantikDemo_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-GigantikDemo_NFT.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "undefined/gigantikdemo/square.png"), mediaType: "image/png")
                    let bannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "undefined/gigantikdemo/banner.png"), mediaType: "image/png")
                    ...
                    for metadataKey in (GigantikDemo_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 18{ 
                            if metadataKey.slice(from: 0, upTo: 18) == "collection_social_"{ 
                                ...
                                socials.insert(key: metadataKey.slice(from: 18, upTo: metadataKey.length), MetadataViews.ExternalURL(GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!))
                            }
                        }
                    }
                    return MetadataViews.NFTCollectionDisplay(name: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "", description: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "", externalURL: MetadataViews.ExternalURL(GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""), squareImage: squareImage, bannerImage: bannerImage, socials: socials)
                    ...
                    for metadataKey in (GigantikDemo_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 6{ 
                            if metadataKey.slice(from: 0, upTo: 6) == "trait_"{ 
                                ...
                                traitDictionary.insert(key: metadataKey.slice(from: 6, upTo: metadataKey.length), GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!)
                            }
                        }
                    }
                    return MetadataViews.dictToTraits(dict: traitDictionary, excludedNames: [])
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: MetadataViews.HTTPFile(url: GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "image")!), mediaType: self.getMimeType())])
            }
            return nil
        }
        
        pub fun getMimeType(): String{ 
            var metadataFileType = (GigantikDemo_NFT.getSetMetadataByField(setId: self.setId, field: "image_file_type")!).toLower()
    ...
    pub resource Admin{ 
        pub fun addSeries(seriesId: UInt32, metadata:{ String: String}){ 
            pre{ 
                GigantikDemo_NFT.series[seriesId] == nil:
            ...
            GigantikDemo_NFT.series[seriesId] <-! newSeries
        }
        ...
        pub fun borrowSeries(seriesId: UInt32): &Series{ 
            ...
            return (&GigantikDemo_NFT.series[seriesId] as &Series?)!
        }
    ...
    // to allow others to deposit GigantikDemo_NFT into their Collection. It also allows for reading
    // the details of GigantikDemo_NFT in the Collection.
    pub resource interface GigantikDemo_NFTCollectionPublic{ 
        ...
        pub fun borrowGigantikDemo_NFT(id: UInt64): &GigantikDemo_NFT.NFT?{ 
            // If the result isn't nil, the id of the returned reference
            // should be the same as the argument to the function
            post{ 
                result == nil || result?.id == id:
                    "Cannot borrow GigantikDemo_NFT reference: The ID of the returned reference is incorrect"
            }
        }
    }
    
    // Collection
    // A collection of GigantikDemo_NFT NFTs owned by an account
    //
    pub resource Collection: GigantikDemo_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        //
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let token <- token as! @GigantikDemo_NFT.NFT
        ...
        // borrowGigantikDemo_NFT
        // Gets a reference to an NFT in the collection as a GigantikDemo_NFT,
        // exposing all of its fields.
        // This is safe as there are no functions that can be called on the GigantikDemo_NFT.
        //
        pub fun borrowGigantikDemo_NFT(id: UInt64): &GigantikDemo_NFT.NFT?{ 
            if self.ownedNFTs[id] != nil{ 
                let ref = &self.ownedNFTs[id] as auth &NonFungibleToken.NFT?
                return ref as! &GigantikDemo_NFT.NFT?
            } else{ 
                return nil
            }
        }
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            let GigantikDemo_NFTNft = nft as! &GigantikDemo_NFT.NFT
            return GigantikDemo_NFTNft as &AnyResource{MetadataViews.Resolver}
        }
    ...
    // fetch
    // Get a reference to a GigantikDemo_NFT from an account's Collection, if available.
    // If an account does not have a GigantikDemo_NFT.Collection, panic.
    ...
    //
    pub fun fetch(_ from: Address, id: UInt64): &GigantikDemo_NFT.NFT?{ 
        let collection = getAccount(from).getCapability(GigantikDemo_NFT.CollectionPublicPath).borrow<&GigantikDemo_NFT.Collection{GigantikDemo_NFT.GigantikDemo_NFTCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    pub fun getAllSeries(): [GigantikDemo_NFT.SeriesData]{ 
        return GigantikDemo_NFT.seriesData.values
    }
    
    // getAllSets returns all the sets
    //
    // Returns: An array of all the sets that have been created
    pub fun getAllSets(): [GigantikDemo_NFT.NFTSetData]{ 
        return GigantikDemo_NFT.setData.values
    }
    ...
    pub fun getSeriesMetadata(seriesId: UInt32):{ String: String}?{ 
        return GigantikDemo_NFT.seriesData[seriesId]?.getMetadata()
    }
    ...
    pub fun getSetMaxEditions(setId: UInt32): UInt32?{ 
        return GigantikDemo_NFT.setData[setId]?.maxEditions
    }
    ...
    pub fun getSetMetadata(setId: UInt32):{ String: String}?{ 
        return GigantikDemo_NFT.setData[setId]?.getMetadata()
    }
    ...
    pub fun getSetSeriesId(setId: UInt32): UInt32?{ 
        return GigantikDemo_NFT.setData[setId]?.seriesId
    }
    ...
    pub fun getIpfsMetadataHashByNftEdition(setId: UInt32, editionNum: UInt32): String?{ 
        ...
        if let set = GigantikDemo_NFT.setData[setId]{ 
    ...
    init(){ 
        // Set named paths
        self.CollectionStoragePath = /storage/GigantikDemo_NFTCollection
        self.CollectionPublicPath = /public/GigantikDemo_NFTCollection
        self.AdminStoragePath = /storage/GigantikDemo_NFTAdmin
        self.AdminPrivatePath = /private/GigantikDemo_NFTAdminUpgrade
        ...
        self.account.link<&GigantikDemo_NFT.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
