...
pub contract sFlowStakingManagerV3{ 
    ...
    pub resource Manager{ 
        ...
        pub fun setNewDelegator(nodeID: String, delegatorID: UInt32){ 
            ...
            sFlowStakingManagerV3.prevDelegatorID = sFlowStakingManagerV3
                    .delegatorID
        ...
        pub fun registerNewDelegator(id: String, amount: UFix64){ 
            let stakingCollectionRef: &FlowStakingCollection.StakingCollection =
                sFlowStakingManagerV3.account.borrow<
        ...
        pub fun unstakeAll(nodeId: String, delegatorId: UInt32){ 
            ...
            for info in delegatingInfo{ 
                if info.nodeID == nodeId && info.id == delegatorId{ 
                    let stakingCollectionRef: &FlowStakingCollection.StakingCollection = sFlowStakingManagerV3.account.borrow<&FlowStakingCollection.StakingCollection>(from: FlowStakingCollection.StakingCollectionStoragePath) ?? panic("Could not borrow ref to StakingCollection")
    ...
    init(nodeID: String, delegatorID: UInt32){ 
        ...
        self.account.save(
            <-create Manager(),
            to: /storage/sFlowStakingManagerV3
        )
