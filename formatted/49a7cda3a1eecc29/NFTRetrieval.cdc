...
pub contract NFTRetrieval{ 
    ...
    pub fun getNFTIDsFromCap(
        collectionIdentifier: String,
        collectionCap: Capability<
            &AnyResource{MetadataViews.ResolverCollection}
        >
    ): [
        UInt64
    ]{ 
        pre{ 
            NFTCatalog.getCatalogEntry(collectionIdentifier: collectionIdentifier) != nil:
        ...
        let hasMultipleCollections =
            self.hasMultipleCollections(
                nftTypeIdentifier: value.nftType.identifier
            )
    ...
    pub fun getAllMetadataViewsFromCap(
        collectionIdentifier: String,
        collectionCap: Capability<
            &AnyResource{MetadataViews.ResolverCollection}
        >
    ...
    pub fun getNFTViewsFromCap(
        collectionIdentifier: String,
        collectionCap: Capability<
            &AnyResource{MetadataViews.ResolverCollection}
        >
    ): [
        MetadataViews.NFTView
    ]{ 
        pre{ 
            NFTCatalog.getCatalogEntry(collectionIdentifier: collectionIdentifier) != nil:
                "Invalid collection identifier"
    ...
    access(contract) fun hasMultipleCollections(
