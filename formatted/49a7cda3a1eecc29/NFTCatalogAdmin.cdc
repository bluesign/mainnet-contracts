...
pub contract NFTCatalogAdmin{ 
    ...
    pub resource Admin{ 
        ...
        pub fun updateCatalogEntry(
            collectionIdentifier: String,
            metadata: NFTCatalog.NFTCatalogMetadata
        ){ 
            NFTCatalog.updateCatalogEntry(
                collectionIdentifier: collectionIdentifier,
                metadata: metadata
            )
        }
        ...
        pub fun removeCatalogEntry(collectionIdentifier: String){ 
            NFTCatalog.removeCatalogEntry(
                collectionIdentifier: collectionIdentifier
            )
        }
        
        pub fun removeCatalogEntryUnsafe(
            collectionIdentifier: String,
            nftTypeIdentifier: String
        ){ 
            NFTCatalog.removeCatalogEntryUnsafe(
                collectionIdentifier: collectionIdentifier,
        ...
        pub fun approveCatalogProposal(proposalID: UInt64){ 
            pre{ 
                NFTCatalog.getCatalogProposalEntry(proposalID: proposalID) != nil:
                    "Invalid Proposal ID"
                (NFTCatalog.getCatalogProposalEntry(proposalID: proposalID)!).status == "IN_REVIEW":
                    "Invalid Proposal"
            }
            let catalogProposalEntry =
                NFTCatalog.getCatalogProposalEntry(proposalID: proposalID)!
            let newCatalogProposalEntry =
                NFTCatalog.NFTCatalogProposal(
                    collectionIdentifier: catalogProposalEntry
            ...
            NFTCatalog.updateCatalogProposal(
                proposalID: proposalID,
                proposalMetadata: newCatalogProposalEntry
            )
            if NFTCatalog.getCatalogEntry(
                collectionIdentifier: (
                    NFTCatalog.getCatalogProposalEntry(proposalID: proposalID)!
                ).collectionIdentifier
            )
            == nil{ 
                NFTCatalog.addCatalogEntry(
                    collectionIdentifier: newCatalogProposalEntry
                        .collectionIdentifier,
                ...
                emit AddProposalAccepted(
                    ...
                    contractAddress: newCatalogProposalEntry.metadata
                        .contractAddress,
                    displayName: newCatalogProposalEntry.metadata
                        .collectionDisplay.name
                )
            } else{ 
                ...
                emit UpdateProposalAccepted(proposer: newCatalogProposalEntry.proposer, collectionIdentifier: newCatalogProposalEntry.collectionIdentifier, contractName: newCatalogProposalEntry.metadata.contractName, contractAddress: newCatalogProposalEntry.metadata.contractAddress, displayName: newCatalogProposalEntry.metadata.collectionDisplay.name)
            }
        }
        ...
        pub fun rejectCatalogProposal(proposalID: UInt64){ 
            ...
            emit ProposalRejected(
                ...
                contractAddress: newCatalogProposalEntry.metadata
                    .contractAddress,
                displayName: newCatalogProposalEntry.metadata.collectionDisplay
                    .name
            )
        }
    ...
    pub resource AdminProxy: IAdminProxy{ 
        priv var capability: Capability<&Admin>?
