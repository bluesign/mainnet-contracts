...
pub contract Meme: NonFungibleToken{ 
    ...
    pub event NFTCreated(id: UInt64, title: String, description: String, hash: String, owner: Address, tags: String)
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: self.title, description: self.description, hash: MetadataViews.HTTPFile(url: self.hash))
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Meme.CollectionStoragePath, publicPath: Meme.CollectionPublicPath, providerPath: /private/MemeCollection, publicCollection: Type<&Meme.Collection{Meme.NFTCollectionPublic}>(), publicLinkedType: Type<&Meme.Collection{Meme.NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Meme.Collection{Meme.NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Collection: NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, title: String, description: String, hash: String, tags: String, payment: @FungibleToken.Vault?){ 
