...
pub contract MemeToken: FungibleToken{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                MemeToken.totalSupply = MemeToken.totalSupply - self.balance
            }
        }
    }
    ...
    pub resource Minter{ 
        ...
        ///
        pub fun mintTokens(amount: UFix64): @MemeToken.Vault{ 
            pre{ 
                amount > 0.0:
    ...
    init(){ 
        ...
        //
        self.account.link<&MemeToken.Vault{FungibleToken.Balance}>(self.BalancePublicPath, target: self.VaultStoragePath)
