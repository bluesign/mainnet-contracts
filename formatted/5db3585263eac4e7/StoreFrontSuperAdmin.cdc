...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x5db3585263eac4e7
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x5db3585263eac4e7
