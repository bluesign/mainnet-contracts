...
pub contract DelayedTransfer{ 
    ...
    pub struct Info{ 
        ...
        init(
            blockTs: UFix64,
            receiverCap: Capability<&AnyResource{FungibleToken.Receiver}>
        ){ 
    ...
    access(account) fun addDelayXfer(
        id: String,
        receiverCap: Capability<&AnyResource{FungibleToken.Receiver}>,
        ...
        self.infoMap[id] = Info(
                blockTs: getCurrentBlock().timestamp,
