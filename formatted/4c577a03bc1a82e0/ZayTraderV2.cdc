...
pub contract ZayTraderV2{ 
    ...
    pub resource TradeOffer: TradeOfferPublic{ 
        ...
        pub fun acceptTrade(tradeBundle: @TradeBundle, feeCap: Capability<&FlowToken.Vault{FungibleToken.Provider}>, signingAddress: Address?, signedMessage: String?, keyIds: [Int], signatures: [String], signatureBlock: UInt64?): @TradeBundle{ 
    ...
    pub resource TradeCollection:
        ...
        priv var currentApprovingOfferID: UInt64?
        ...
        pub fun createTradeOffer(
            ...
            assert(
                offerFeePayer.address == self.owner?.address!,
                message: "Mismatch between account owner and fee payer."
            )
            assert(
                offerFeePayer.borrow()! != nil,
                message: "Flow vault to pay fee could not be borrowed."
            )
            let tradeOffer <-
                create TradeOffer(
        ...
        pub fun borrowTradeOffer(tradeOfferResourceID: UInt64): &TradeOffer{
            ...
            if self.tradeOffers[tradeOfferResourceID] != nil{ 
                return &self.tradeOffers[tradeOfferResourceID] as                                                                  // getCurrentApprovingOfferID
                                                                  ...
                                                                  &TradeOffer{TradeOfferPublic}                                                                                               // Update the amount received from fees
                                                                                               // Public functions
