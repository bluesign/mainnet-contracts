        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TFCItems.CollectionStoragePath, publicPath: TFCItems.CollectionPublicPath, providerPath: /private/TFCItemsCollection, publicCollection: Type<&TFCItems.Collection{TFCItems.TFCItemsCollectionPublic}>(), publicLinked: Type<&TFCItems.Collection{TFCItems.TFCItemsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TFCItems.Collection{TFCItems.TFCItemsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
