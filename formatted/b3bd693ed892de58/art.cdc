...
pub contract art: NonFungibleToken{ 
    ...
    pub resource interface _NFT_NAME_CollectionPublic{ 
        ...
        pub fun borrow_NFT_NAME_(id: UInt64): &art.NFT?{ 
            post{ 
    ...
    init(){ 
        ...
        self.account.link<&art.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, art._NFT_NAME_CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
