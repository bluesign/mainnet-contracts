...
pub contract CryptoZooNFT: NonFungibleToken{ 
    ...
    priv var CryptoZooNFTTypeDict:{ UInt64: CryptoZooNFTTemplate}
    
    priv var tokenMintedPerTypeID:{ UInt64: UInt64}
    ...
    pub struct CryptoZooNFTTemplate{ 
        ...
        priv var coordMinted:{ UInt64: [UInt64]}
