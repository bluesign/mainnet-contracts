...
pub contract BloomlyNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: BloomlyNFT.CollectionStoragePath, publicPath: BloomlyNFT.CollectionPublicPath, providerPath: /private/BloomlyNFTCollection, publicCollection: Type<&BloomlyNFT.Collection{BloomlyNFT.BloomlyNFTCollectionPublic}>(), publicLinkedType: Type<&BloomlyNFT.Collection{BloomlyNFT.BloomlyNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&BloomlyNFT.Collection{BloomlyNFT.BloomlyNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-BloomlyNFT.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let mediaSquare = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://d1b6upo1s7pshq.cloudfront.net/images/Bloctobay+marketplace+profile+.png") //brandDetails!.externalURL, mediaType: "image/svg+xml")
                    let mediaBanner = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://d1b6upo1s7pshq.cloudfront.net/images/Bloctobay+marketplace+cover.png") //brandDetails!.externalURL, mediaType: "image/svg+xml")
    ...
    pub resource interface NFTMethodsCapability{ 
        ...
        pub fun mintNFT(brandId: UInt64, templateId: UInt64?, receiverRef: &{BloomlyNFT.BloomlyNFTCollectionPublic}, immutableData:{ String: AnyStruct}?, mutableData:{ String: AnyStruct}?, name: String, description: String, thumbnail: String, transferable: Bool, royalties: [MetadataViews.Royalty]){} 
