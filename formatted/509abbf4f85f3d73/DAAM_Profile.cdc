...
pub contract DAAM_Profile{ 
    ...
    pub resource User: Public{ 
        ...
        // Init
        init(name: String, about: String?, description: String?, web: String?, social:{ String: String}?, avatar: AnyStruct{MetadataViews.File}?, heroImage: AnyStruct{MetadataViews.File}?, notes:{ String: String}?){ 
            self.name = name
            self.email = nil
            self.about = about
    ...
    pub fun createProfile(
        ...
        avatar: AnyStruct{MetadataViews.File}?,
        heroImage: AnyStruct{MetadataViews.File}?,
        notes:{ 
            String: String
        }?
    ): @User{ 
    ...
    pub fun check(_ address: Address): Bool{ 
        let ref =
            getAccount(address).getCapability<&User{Public}>(self.publicPath)
                .borrow()
            as
            &User{Public}?
        return ref != nil
