...
import
    ...
    from "../0x329feb3ab062d289/AmericanAirlines_NFT.cdc"
...
import
    ...
    from "../0x329feb3ab062d289/Atheletes_Unlimited_NFT.cdc"
...
import
    ...
    from "../0x93615d25d14fa337/ChainmonstersRewards.cdc"
...
import
    ...
    from "../0xf20df769e658c257/MatrixWorldAssetsNFT.cdc"

import
    MatrixWorldFlowFestNFT
    from "../0x2d2750f240198f91/MatrixWorldFlowFestNFT.cdc"
...
import
    ...
    from "../0x6831760534292098/OneFootballCollectible.cdc"
...
import
    ...
    from "../0x667a16294a089ef8/SomePlaceCollectible.cdc"

import
    SportsIconCollectible
    from "../0x8de96244f54db422/SportsIconCollectible.cdc"
...
import
    ...
    from "../0xa0cbe021821c0965/TheFabricantMysteryBox_FF1.cdc"

import
    TheFabricantS1ItemNFT
    from "../0x9e03b1f871b3513/TheFabricantS1ItemNFT.cdc"

import
    TheFabricantS2ItemNFT
    from "../0x7752ea736384322f/TheFabricantS2ItemNFT.cdc"
...
import
    ...
    from "../0x758252ab932a3416/YahooPartnersCollectible.cdc"
...
pub contract AlchemyMetadataWrapperMainnet{ 
    ...
    pub fun getNFTs(ownerAddress: Address, ids:{ String: [UInt64]}): [
        NFTData?
    ]{ 
        let NFTs: [NFTData?] = []
    ...
    pub fun getCnnNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(CNN_NFT.CollectionPublicPath).borrow<
                &{CNN_NFT.CNN_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let externalTokenViewUrl =
            ((setMeta!)["external_url"]!).concat("tokens/").concat(
                (nft!).id.toString()
            )
        var mimeType = "image"
    ...
    pub fun getChainmonstersRewardNFT(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(/public/ChainmonstersRewardCollection).borrow<
                &{ChainmonstersRewards.ChainmonstersRewardCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getGaia(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Gaia.CollectionPublicPath).borrow<
        ...
        let metadata =
            Gaia.getTemplateMetaData(templateID: (nft!).data.templateID)
        (         
    ...
    pub fun getBeam(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Beam.CollectionPublicPath).borrow<
        ...
        let metadata =
            Beam.getCollectibleItemMetaData(
                collectibleItemID: (nft!).data.collectibleItemID
            )
        let ipfsScheme = "ipfs://"
    ...
    pub fun getBlockleteGames(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(BlockleteGames_NFT.CollectionPublicPath).borrow<
                &{BlockleteGames_NFT.BlockleteGames_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getCrave(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Crave.CollectionPublicPath).borrow<
                &{Crave.CraveCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let metadata =
            Crave.getCollectibleItemMetaData(
                collectibleItemID: (nft!).data.collectibleItemID
            )
        let ipfsScheme = "ipfs://"
        let httpsScheme = "https://"
    ...
    pub fun getCricketMoments(owner: PublicAccount, id: UInt64): NFTData?{ 
        let col =
            owner.getCapability(CricketMoments.CollectionPublicPath).borrow<
        ...
        if let nft = (col!).borrowCricketMoment(id: id){ 
            let contract = NFTContractData(name: "CricketMoments", address: 0xed398881d9bf40fb, storage_path: "CricketMoments.CollectionStoragePath", public_path: "CricketMoments.CollectionPublicPath", public_collection_name: "CricketMoments.CricketMomentsCollectionPublic", external_domain: "")
            let metadata = (nft!).getMetadata()
            let rawMetadata:{ String: String?} ={} 
            for key in (metadata!).keys{ 
                rawMetadata.insert(key: key, (metadata!)[key])
            }
            return NFTData(contract: contract, id: (nft!).id, uuid: (nft!).uuid, title: nil, description: metadata["description"], external_domain_view_url: nil, token_uri: "https://gateway.pinata.cloud/ipfs/".concat(metadata["ipfs"]!), media: [], metadata: rawMetadata)
        }
        return nil
    }
    ...
    pub fun getEverbloom(owner: PublicAccount, id: UInt64): NFTData?{ 
        let col =
            owner.getCapability(Everbloom.CollectionPublicPath).borrow<
                &{Everbloom.PrintCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        if let nft = (col!).borrowPrint(id: id){ 
            ...
            let contract = NFTContractData(name: "Everbloom", address: 0xe703f7fee6400754, storage_path: "Everbloom.CollectionStoragePath", public_path: "Everbloom.CollectionPublicPath", public_collection_name: "Everbloom.PrintCollectionPublic", external_domain: "https://web.everbloom.app/")
            return NFTData(contract: contract, id: (nft!).id, uuid: (nft!).uuid, title: nil, description: nil, external_domain_view_url: nil, token_uri: "https://everbloom-fcl-service.herokuapp.com/v1/nft/".concat((nft!).id.toString()), media: [], metadata:{} )
        }
        return nil
    }
    ...
    pub fun getEternalMoment(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(/public/EternalMomentCollection).borrow<
        ...
        return NFTData(
            ...
            uuid: (nft!).uuid,
            title: (metadata!)["Title"],
            description: ((metadata!)["Game"]!).concat(" - ").concat(
                (metadata!)["Influencer"]!
            ),
            external_domain_view_url: "https://eternal.gg/moments/".concat(
                (nft!).id.toString()
            ),
            token_uri: nil,
            media: [
                NFTMedia(
                    uri: "https://gateway.pinata.cloud/ipfs/".concat(
                        (metadata!)["Hash"]!
                    ),
                    mimetype: "video"
                )
    ...
    pub fun getEternalShard(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(/public/EternalShardCollection).borrow<
                &{Shard.ShardCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            external_domain_view_url: "https://eternal.gg/shards/".concat(
                (nft!).id.toString()
            ),
            token_uri: nil,
            media: [
                NFTMedia(uri: (clipMetadata!)["video_url"], mimetype: "video")
            ],
            metadata:{} 
        )
    }
    ...
    pub fun getFantastecNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        let col =
            owner.getCapability(FantastecNFT.CollectionPublicPath).borrow<
                &{FantastecNFT.FantastecNFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        if let nft = (col!).borrowFantastecNFT(id: id){ 
            ...
            let contract = NFTContractData(name: "FantastecNFT", address: 0x2e1ee1e7a96826ce, storage_path: "FantastecNFT.CollectionStoragePath", public_path: "FantastecNFT.CollectionPublicPath", public_collection_name: "FantastecNFT.FantastecNFTCollectionPublic", external_domain: "")
            let rawMetadata:{ String: String?} ={} 
            for key in nft.metadata.keys{ 
                rawMetadata.insert(key: key, nft.metadata[key])
            }
            return NFTData(contract: contract, id: nft.id, uuid: nft.uuid, title: nft.metadata["title"], description: nft.metadata["description"], external_domain_view_url: nil, token_uri: nil, media: [NFTMedia(uri: nft.metadata["image"], mimetype: "image/png")], metadata: rawMetadata)
        }
        return nil
    }
    ...
    pub fun getVoucher(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Vouchers.CollectionPublicPath).borrow<
                &{Vouchers.CollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getKOTD(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(KOTD.CollectionPublicPath).borrow<
                &{KOTD.NiftoryCollectibleCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let metadata =
            KOTD.getCollectibleItemMetaData(
                collectibleItemID: (nft!).data.collectibleItemID
            )
        let ipfsScheme = "ipfs://"
        let httpsScheme = "https://"
    ...
    pub fun getKlktnNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        let col =
            owner.getCapability(KlktnNFT.CollectionPublicPath).borrow<
                &{KlktnNFT.KlktnNFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        if let nft = (col!).borrowKlktnNFT(id: id){ 
            ...
            let contract = NFTContractData(name: "KlktnNFT", address: 0xabd6e80be7e9682c, storage_path: "KlktnNFT.CollectionStoragePath", public_path: "KlktnNFT.CollectionPublicPath", public_collection_name: "KlktnNFT.KlktnNFTCollectionPublic", external_domain: "")
            let rawMetadata:{ String: String?} ={} 
            for key in (metadata!).keys{ 
                rawMetadata.insert(key: key, (metadata!)[key])
            }
            return NFTData(contract: contract, id: (nft!).id, uuid: (nft!).uuid, title: metadata["name"], description: metadata["description"], external_domain_view_url: nil, token_uri: nil, media: [NFTMedia(uri: metadata["media"], mimetype: metadata["mimeType"])], metadata: rawMetadata)
        }
        return nil
    }
    ...
    pub fun getKlktnNFT2(owner: PublicAccount, id: UInt64): NFTData?{ 
        let col =
            owner.getCapability(KlktnNFT2.CollectionPublicPath).borrow<
                &{KlktnNFT2.KlktnNFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        if let nft = (col!).borrowKlktnNFT(id: id){ 
            ...
            let contract = NFTContractData(name: "KlktnNFT2", address: 0xabd6e80be7e9682c, storage_path: "KlktnNFT2.CollectionStoragePath", public_path: "KlktnNFT2.CollectionPublicPath", public_collection_name: "KlktnNFT2.KlktnNFTCollectionPublic", external_domain: "")
            let rawMetadata:{ String: String?} ={} 
            for key in template.metadata.keys{ 
                rawMetadata.insert(key: key, template.metadata[key])
            }
            return NFTData(contract: contract, id: (nft!).id, uuid: (nft!).uuid, title: template.metadata["name"] ?? "", description: template.metadata["description"] ?? "", external_domain_view_url: nil, token_uri: template.metadata["uri"] ?? "", media: [NFTMedia(uri: template.metadata["media"] ?? "", mimetype: template.metadata["mimeType"] ?? "")], metadata: rawMetadata)
        }
        return nil
    }
    ...
    pub fun getMusicBlock(owner: PublicAccount, id: UInt64): NFTData?{ 
        let col =
            owner.getCapability(MusicBlock.CollectionPublicPath).borrow<
                &{MusicBlock.MusicBlockCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getMynft(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Mynft.CollectionPublicPath).borrow<
                &{Mynft.MynftCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            media: [
                NFTMedia(
                    uri: ((nft!).metadata!).ipfsLink,
                    mimetype: ((nft!).metadata!).type
                )
            ],
            metadata:{ 
    ...
    pub fun getNyatheesOVO(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(NyatheesOVO.CollectionPublicPath).borrow<
                &{NyatheesOVO.NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getRaceDay(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(RaceDay_NFT.CollectionPublicPath).borrow<
                &{RaceDay_NFT.RaceDay_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getAndbox_NFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Andbox_NFT.CollectionPublicPath).borrow<
                &{Andbox_NFT.Andbox_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let externalTokenViewUrl =
            "https://andbox.shops.nftbridge.com/tokens/".concat(
                (nft!).id.toString()
            )
        var mimeType = "image"
        if ((setMeta!)["image_file_type"]!).toLower() == "mp4"{ 
    ...
    pub fun getRareRooms(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(RareRooms_NFT.CollectionPublicPath).borrow<
                &{RareRooms_NFT.RareRooms_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let externalTokenViewUrl =
            "https://rarerooms.io/tokens/".concat((nft!).id.toString())
        var mimeType = "image"
        if ((setMeta!)["image_file_type"]!).toLower() == "mp4"{ 
            mimeType = "video/mp4"
        } else if ((setMeta!)["image_file_type"]!).toLower() == "glb"{ 
    ...
    pub fun getRCRDSHPNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(RCRDSHPNFT.collectionPublicPath).borrow<
    ...
    pub fun getSportsIconCollectible(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(SportsIconCollectible.CollectionPublicPath)
        ...
        let setData =
            SportsIconCollectible.getSetMetadataForNFTByUUID(uuid: (nft!).uuid)!
        let editionData =
            SportsIconCollectible.getCollectibleDataForNftByUUID(
                uuid: (nft!).uuid
            )!
        ...
        return NFTData(
            ...
            external_domain_view_url: "https://app.sportsicon.com/collectible/"
                .concat(editionData.getSetID().toString()).concat("/").concat(
                editionData.getEditionNumber().toString()
            ),
            token_uri: nil,
            media: [
                NFTMedia(
                    uri: (setMetadata!)["contentURL"],
                    mimetype: "video/mp4"
                )
            ],
            metadata: rawMetadata
    ...
    pub fun getStarlyCard(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(StarlyCard.CollectionPublicPath).borrow<
    ...
    pub fun getCaaPass(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(CaaPass.CollectionPublicPath).borrow<
                &{CaaPass.CollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getTuneGO(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(TuneGO.CollectionPublicPath).borrow<
                &{TuneGO.TuneGOCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getMatrixWorldFlowFest(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(MatrixWorldFlowFestNFT.CollectionPublicPath)
                .borrow<
        ...
        return NFTData(
            ...
            token_uri: nil,
            media: [
                NFTMedia(uri: (nft!).metadata.animationUrl, mimetype: "image")
            ],
            metadata:{ 
                "type": (nft!).metadata.type,
    ...
    pub fun getTopShot(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(/public/MomentCollection).borrow<
    ...
    pub fun getFlownsDomain(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Domains.CollectionPublicPath).borrow<
    ...
    pub fun getTFCItems(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            (owner.getCapability(TFCItems.CollectionPublicPath)!).borrow<
                &{TFCItems.TFCItemsCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getGooberz(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(GooberXContract.CollectionPublicPath).borrow<
                &{GooberXContract.GooberCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getMintStoreItem(owner: PublicAccount, id: UInt64): NFTData?{ 
        let col =
            owner.getCapability(MintStoreItem.CollectionPublicPath).borrow<
                &{MintStoreItem.MintStoreItemCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let editionData =
            MintStoreItem.EditionData(editionID: (nft!).data.editionID)!
        let description = (editionData!).metadata["description"]!
        let merchantName =
            MintStoreItem.getMerchant(merchantID: (nft!).data.merchantID)!
        var external_domain = ""
        switch merchantName{ 
            case "Bulls":
        ...
        let rawMetadata:{ String: String?} ={
                ...
                "numberOfItemsMinted":
                (editionData!).numberOfItemsMinted.toString(),
                ...
                "royaltyPercentage":
                (editionData!).metadata["royaltyPercentage"]
            }
        return NFTData(
            contract: contract,
            id: (nft!).id,
    ...
    pub fun getBiscuitsNGroovy(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(BnGNFT.CollectionPublicPath).borrow<
                &{BnGNFT.BnGNFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getGeniaceNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(GeniaceNFT.CollectionPublicPath).borrow<
                &{GeniaceNFT.GeniaceNFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getXtinglesNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Collectible.CollectionPublicPath).borrow<
                &{Collectible.CollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getInceptionAnimals(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(CryptoZooNFT.CollectionPublicPath).borrow<
                &{CryptoZooNFT.CryptoZooNFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            media: [
                NFTMedia(
                    ...
                    mimetype: ((nft!).getNFTTemplate()!).getMetadata()[
                        "mimetype"
                    ]!
                )
            ],
    ...
    pub fun getOneFootballCollectible(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        if let collection =
            owner.getCapability<
                &OneFootballCollectible.Collection{
            ...
            if let nft = collection.borrowOneFootballCollectible(id: id){ 
                if let metadata = nft.getTemplate(){ 
                    return NFTData(contract: contract, id: nft.id, uuid: nft.uuid, title: metadata.name, description: metadata.description, external_domain_view_url: "https://xmas.onefootball.com/".concat(owner.address.toString()), token_uri: nil, media: [                                                                                                                                                                                                                                                                // media
    ...
    pub fun getTheFabricantMysteryBox_FF1(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(/public/FabricantCollection001).borrow<
                &{TheFabricantMysteryBox_FF1.FabricantCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let fabricantData =
            TheFabricantMysteryBox_FF1.getFabricantData(id: dataID)
        return NFTData(
            contract: contract,
            id: (nft!).id,
            uuid: (nft!).uuid,
    ...
    pub fun getDieselNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(/public/DieselCollection001).borrow<
                &{DieselNFT.DieselCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getMiamiNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(/public/MiamiCollection001).borrow<
                &{MiamiNFT.MiamiCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getBitku(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(HaikuNFT.HaikuCollectionPublicPath).borrow<
                &{HaikuNFT.HaikuCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            external_domain_view_url: "https://bitku.art/#".concat(
                owner.address.toString()
            ).concat("/").concat((nft!).id.toString()),
            token_uri: nil,
            media: [],
    ...
    pub fun getFlowFansNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(/public/FlowChinaBadgeCollection).borrow<
                &{FlowChinaBadge.FlowChinaBadgeCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getAllDay(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(AllDay.CollectionPublicPath).borrow<
        ...
        return NFTData(
            ...
            id: (nft!).id,
            uuid: nil,
            title: "Moment".concat((nft!).id.toString()).concat("-Edition")
                .concat((nft!).editionID.toString()).concat("-SerialNumber")
                .concat((nft!).serialNumber.toString()),
            description: nil,
            external_domain_view_url: nil,
            token_uri: nil,
            media: [],
    ...
    pub fun getAllDayPackNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(PackNFT.CollectionPublicPath).borrow<
                &{NonFungibleToken.CollectionPublic}
            >()
        if col == nil{ 
            return nil
    ...
    pub fun getItemNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(ItemNFT.CollectionPublicPath).borrow<
                &{ItemNFT.ItemCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getTheFabricantS1ItemNFT(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(TheFabricantS1ItemNFT.CollectionPublicPath)
        ...
        return NFTData(
            ...
            media: [
                NFTMedia(
                    uri: (itemMetadata["itemVideo"]!).metadataValue,
                    mimetype: "video"
                ),
                NFTMedia(
                    uri: (itemMetadata["itemImage"]!).metadataValue,
                    mimetype: "image"
                )
            ],
            metadata:{ 
                ...
                "secondaryColor":
                (itemMetadata["secondaryColor"]!).metadataValue,
    ...
    pub fun getZeedzINO(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(/public/ZeedzINOCollection).borrow<
                &{ZeedzINO.ZeedzCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            media: [
                NFTMedia(
                    uri: "https://zeedz.mypinata.cloud/ipfs/".concat(
                        (nft!).imageURI
                    ),
                    mimetype: "image"
                )
    ...
    pub fun getKicksSneaker(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Kicks.CollectionPublicPath).borrow<
                &{Kicks.KicksCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let description =
            (nft!).setID == 0
                ? "Union Jordan 4 'Off Noir' x Nike Dunk"
                : (nft!).description()
        ...
        return NFTData(
            ...
            title: (nft!).name(),
            description: description,
            external_domain_view_url: "https://www.nftlx.io/nft/".concat(
                (nft!).id.toString()
            ),
            token_uri: nil,
            media: media,
    ...
    pub fun getBarterYardPack(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let collection =
            owner.getCapability(BarterYardPackNFT.CollectionPublicPath).borrow<
                &{BarterYardPackNFT.BarterYardPackNFTCollectionPublic}
            >()!
        if collection == nil{ 
            return nil
        }
        ...
        let packPartView =
            nft.resolveView(Type<BarterYardPackNFT.PackMetadataDisplay>())!
        let packMetadata =
            packPartView as! BarterYardPackNFT.PackMetadataDisplay
        ...
        return NFTData(
            ...
            external_domain_view_url: "https://barteryard.club/nft/".concat(
                id.toString()
            ),
            token_uri: nil,
            media: [
                NFTMedia(
                    uri: "https://ipfs.io/ipfs/".concat(ipfsFile.cid),
                    mimetype: "image"
                )
            ],
    ...
    pub fun getDayNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(DayNFT.CollectionPublicPath).borrow<
    ...
    pub fun getCostacosNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Costacos_NFT.CollectionPublicPath).borrow<
                &{Costacos_NFT.Costacos_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let externalTokenViewUrl =
            "https://shop.costacoscollection.com/tokens/".concat(
                (nft!).id.toString()
            )
        var mimeType = "image"
        if ((setMeta!)["image_file_type"]!).toLower() == "mp4"{ 
    ...
    pub fun getCanesVaultNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Canes_Vault_NFT.CollectionPublicPath).borrow<
                &{Canes_Vault_NFT.Canes_Vault_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let nftEditions =
            Canes_Vault_NFT.getSetMaxEditions(setId: (nft!).setId)!
        let externalTokenViewUrl =
            ((setMeta!)["external_url"]!).concat("/tokens/").concat(
                (nft!).id.toString()
            )
    ...
    pub fun getAmericanAirlinesNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(AmericanAirlines_NFT.CollectionPublicPath)
                .borrow<
                &{AmericanAirlines_NFT.AmericanAirlines_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let seriesMeta =
            AmericanAirlines_NFT.getSeriesMetadata(
                seriesId: AmericanAirlines_NFT.getSetSeriesId(
                    setId: (nft!).setId
                )!
            )
        let seriesId = AmericanAirlines_NFT.getSetSeriesId(setId: (nft!).setId)!
        let nftEditions =
            AmericanAirlines_NFT.getSetMaxEditions(setId: (nft!).setId)!
        let externalTokenViewUrl =
            "https://americanairlines.nftbridge.com/tokens/".concat(
                (nft!).id.toString()
            )
        return NFTData(
            contract: contract,
            ...
            media: [
                NFTMedia(
                    uri: (setMeta!)["image"],
                    mimetype: (setMeta!)["image_file_type"]
                ),
                NFTMedia(uri: (setMeta!)["preview"], mimetype: "image")
            ],
            metadata:{ 
    ...
    pub fun getTheNextCartelNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(The_Next_Cartel_NFT.CollectionPublicPath)
                .borrow<
                &{The_Next_Cartel_NFT.The_Next_Cartel_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let seriesMeta =
            The_Next_Cartel_NFT.getSeriesMetadata(
                seriesId: The_Next_Cartel_NFT.getSetSeriesId(
                    setId: (nft!).setId
                )!
            )
        let seriesId = The_Next_Cartel_NFT.getSetSeriesId(setId: (nft!).setId)!
        let nftEditions =
            The_Next_Cartel_NFT.getSetMaxEditions(setId: (nft!).setId)!
        let externalTokenViewUrl =
            "https://thenextcartel.shops.nftbridge.com/tokens/".concat(
                (nft!).id.toString()
            )
        var mimeType = "image"
        if ((setMeta!)["image_file_type"]!).toLower() == "mp4"{ 
    ...
    pub fun getAthletesUnlimitedNFT(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(Atheletes_Unlimited_NFT.CollectionPublicPath)
                .borrow<
                &{
        ...
        let setMeta =
            Atheletes_Unlimited_NFT.getSetMetadata(setId: (nft!).setId)!
        let seriesMeta =
            Atheletes_Unlimited_NFT.getSeriesMetadata(
                seriesId: Atheletes_Unlimited_NFT.getSetSeriesId(
                    setId: (nft!).setId
                )!
            )
        let seriesId =
            Atheletes_Unlimited_NFT.getSetSeriesId(setId: (nft!).setId)!
        let nftEditions =
            Atheletes_Unlimited_NFT.getSetMaxEditions(setId: (nft!).setId)!
        let externalTokenViewUrl =
    ...
    pub fun getArtNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Art_NFT.CollectionPublicPath).borrow<
                &{Art_NFT.Art_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let externalTokenViewUrl =
            "https://art.nftbridge.com/tokens/".concat((nft!).id.toString())
        var mimeType = "image"
        if ((setMeta!)["image_file_type"]!).toLower() == "mp4"{ 
            mimeType = "video/mp4"
        } else if ((setMeta!)["image_file_type"]!).toLower() == "glb"{ 
    ...
    pub fun getDGDNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(DGD_NFT.CollectionPublicPath).borrow<
                &{DGD_NFT.DGD_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let externalTokenViewUrl =
            "https://app.theplayerslounge.io/tokens/".concat(
                (nft!).id.toString()
            )
        var mimeType = "image"
        if ((setMeta!)["image_file_type"]!).toLower() == "mp4"{ 
    ...
    pub fun getGogoroCollectibleNFT(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(GogoroCollectible.CollectionPublicPath).borrow<
                &{GogoroCollectible.CollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            title: metadata.name,
            description: metadata.description,
            external_domain_view_url: "https://bay.blocto.app/flow/gogoro/"
                .concat((nft!).id.toString()),
            token_uri: nil,
            media: [
                NFTMedia(
                    uri: additional["mediaUrl"]!,
                    mimetype: metadata.mediaType
                )
            ],
            metadata:{ 
    ...
    pub fun getYahooCollectibleNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(YahooCollectible.CollectionPublicPath).borrow<
                &{YahooCollectible.CollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            title: metadata.name,
            description: metadata.description,
            external_domain_view_url: "https://bay.blocto.app/flow/yahoo/"
                .concat((nft!).id.toString()),
            token_uri: nil,
            media: [
                NFTMedia(
    ...
    pub fun getYahooPartnersCollectibleNFT(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(YahooPartnersCollectible.CollectionPublicPath)
        ...
        return NFTData(
            ...
            title: metadata.name,
            description: metadata.description,
            external_domain_view_url: "https://bay.blocto.app/flow/yahoo-partners/"
                .concat((nft!).id.toString()),
            token_uri: nil,
            media: [
                NFTMedia(
    ...
    pub fun getNowggNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(NowggNFT.CollectionPublicPath).borrow<
    ...
    pub fun getSomePlaceCollectibleNFT(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(SomePlaceCollectible.CollectionPublicPath)
        ...
        let setID = nft.setID
        let setMetadata =
            SomePlaceCollectible.getMetadataForSetID(setID: setID)!
        let editionMetadata =
            SomePlaceCollectible.getMetadataForNFTByUUID(uuid: nft.id)!
        return NFTData(
            contract: contract,
            id: nft.id,
            uuid: nft.uuid,
    ...
    pub fun getARTIFACT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(ARTIFACT.collectionPublicPath).borrow<
                &{ARTIFACT.CollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            title: title,
            description: description,
            external_domain_view_url: "https://artifact.scmp.com/".concat(
                series
            ),
            token_uri: nil,
            media: [
                NFTMedia(
                    uri: metadata["artifactFileUri"],
                    mimetype: "video/mp4"
                )
            ],
            metadata: rawMetadata
    ...
    pub fun getARTIFACTPack(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(ARTIFACTPack.collectionPublicPath).borrow<
                &{ARTIFACTPack.CollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getNftRealityNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(NftReality.CollectionPublicPath).borrow<
                &{NftReality.NftRealityCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            media: [
                NFTMedia(
                    uri: "https://ipfs.io/ipfs/".concat(ipfsFile.cid).concat(
                        "/"
                    ).concat(ipfsFile.path!),
                    mimetype: "image"
                )
            ],
            metadata:{ 
    ...
    pub fun getNftMatrixWorldAssetsNFT(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(MatrixWorldAssetsNFT.collectionPublicPath)
                .borrow<
                &{
                    MatrixWorldAssetsNFT.Metadata,
                    NonFungibleToken.CollectionPublic
                }
            >()
    ...
    pub fun getRacingTimeNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(RacingTime.CollectionPublicPath).borrow<
                &{RacingTime.RacingTimeCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getMomentables(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Momentables.CollectionPublicPath).borrow<
                &{Momentables.MomentablesCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let ipfsURL =
            "https://gateway.pinata.cloud/ipfs/".concat((nft!).imageCID)
    ...
    pub fun getGoatedGoats(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(GoatedGoats.CollectionPublicPath).borrow<
                &{
                    MetadataViews.ResolverCollection,
                    GoatedGoats.GoatCollectionPublic
                }
            >()
        if col == nil{ 
            return nil
        ...
        let nft = optNft!
        let displayView =
            nft.resolveView(Type<MetadataViews.Display>())!
            as!
    ...
    pub fun getGoatedGoatsTrait(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(GoatedGoatsTrait.CollectionPublicPath).borrow<
                &{
                    MetadataViews.ResolverCollection,
                    GoatedGoatsTrait.TraitCollectionPublic
                }
            >()
        if col == nil{ 
            return nil
    ...
    pub fun getDropzToken(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(DropzToken.CollectionPublicPath).borrow<
                &{DropzToken.DropzTokenCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getNecryptolisNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Necryptolis.CollectionPublicPath).borrow<
                &{Necryptolis.NecryptolisCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getFLOAT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(FLOAT.FLOATCollectionPublicPath).borrow<
                &FLOAT.Collection{FLOAT.CollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let display =
            (float!).resolveView(Type<MetadataViews.Display>())!
            as!
            MetadataViews.Display
        return NFTData(
            contract: contract,
    ...
    pub fun getBreakingTNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(BreakingT_NFT.CollectionPublicPath).borrow<
                &{BreakingT_NFT.BreakingT_NFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        let externalTokenViewUrl =
            "https://marketplace.breakingt.com/tokens/".concat(
                (nft!).id.toString()
            )
        var mimeType = "image"
        if ((setMeta!)["image_file_type"]!).toLower() == "mp4"{ 
    ...
    pub fun getOwnersNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Owners.CollectionPublicPath).borrow<
                &{Owners.OwnersCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getOzoneMetaverseNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(Metaverse.CollectionPublicPath).borrow<
                &{Metaverse.MetaverseCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getNFTContract(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(NFTContract.CollectionPublicPath).borrow<
                &{NonFungibleToken.CollectionPublic}
            >()
        if col == nil{ 
            return nil
        ...
        let templateData =
            NFTContract.getTemplateById(templateId: (nft!).templateID)
        let immutableData = templateData.getImmutableData()
        var templateDescription:{ String: AnyStruct} ={} 
        templateDescription = templateData.getImmutableData()
            as!{
        ...
        return NFTData(
            ...
            media: [
                NFTMedia(
                    uri: immutableData["contectValue"]! as? String,
                    mimetype: "image"
                )
            ],
            metadata:{ 
    ...
    pub fun getSwaychainNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(SwaychainNFT.CollectionPublicPath).borrow<
                &{SwaychainNFT.SwaychainNFTCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getTheFabricantS2ItemNFT(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(TheFabricantS2ItemNFT.CollectionPublicPath)
    ...
    pub fun getVnMiss(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(VnMiss.CollectionPublicPath).borrow<
                &{VnMiss.VnMissCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getAvatarArt(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(AADigital.CollectionPublicPath).borrow<
                &{AADigital.AADigitalCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
        ...
        return NFTData(
            ...
            media: [
                NFTMedia(
                    uri: "https://api.avatarart.io/upload".concat(
                        display.thumbnail.uri()
                    ),
                    mimetype: "image"
                )
            ],
    ...
    pub fun getDooverseNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let col =
            owner.getCapability(DooverseItems.CollectionPublicPath).borrow<
                &{DooverseItems.DooverseItemsCollectionPublic}
            >()
        if col == nil{ 
            return nil
        }
    ...
    pub fun getNFTIDs(ownerAddress: Address):{ String: [UInt64]}{ 
        ...
        if let col =
            owner.getCapability(SportsIconCollectible.CollectionPublicPath)
                .borrow<
                &{SportsIconCollectible.CollectibleCollectionPublic}
            >(){ 
        ...
        if let col =
            owner.getCapability(OneFootballCollectible.CollectionPublicPath)
                .borrow<
                &{OneFootballCollectible.OneFootballCollectibleCollectionPublic}
            >(){ 
        ...
        if let col =
            owner.getCapability(TheFabricantMysteryBox_FF1.CollectionPublicPath)
                .borrow<
                &{TheFabricantMysteryBox_FF1.FabricantCollectionPublic}
            >(){ 
        ...
        if let col =
            owner.getCapability(DieselNFT.CollectionPublicPath).borrow<
                &{DieselNFT.DieselCollectionPublic}
            >(){ 
            ids["DieselNFT"] = col.getIDs()
        }
        if let col =
            owner.getCapability(MiamiNFT.CollectionPublicPath).borrow<
                &{MiamiNFT.MiamiCollectionPublic}
            >(){ 
        ...
        if let col =
            owner.getCapability(FlowChinaBadge.CollectionPublicPath).borrow<
                &{FlowChinaBadge.FlowChinaBadgeCollectionPublic}
            >(){ 
        ...
        if let col =
            owner.getCapability(ZeedzINO.CollectionPublicPath).borrow<
                &{ZeedzINO.ZeedzCollectionPublic}
            >(){ 
