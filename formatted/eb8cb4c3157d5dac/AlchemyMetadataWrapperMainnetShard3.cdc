...
import
    ...
    from "../0x910514afa41bfeac/BlindBoxRedeemVoucher.cdc"
...
pub contract AlchemyMetadataWrapperMainnetShard3{ 
    ...
    pub fun getBlindBoxRedeemVoucherNFT(
        owner: PublicAccount,
        id: UInt64
    ): NFTData?{ 
        let contract =
        ...
        let col =
            owner.getCapability(BlindBoxRedeemVoucher.CollectionPublicPath)
        ...
        return NFTData(
            ...
            title: metadata.name,
            description: metadata.description,
            external_domain_view_url: "https://bay.blocto.app/flow/blindbox-voucher/"
                .concat((nft!).id.toString()),
            token_uri: nil,
            media: [
                NFTMedia(
    ...
    pub fun getNftRealityNFT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        let metadataView =
            (nft!).resolveView(Type<NftReality.NftRealityMetadataView>())!
        ...
        return NFTData(
            ...
            media: [
                NFTMedia(
                    uri: "https://ipfs.io/ipfs/".concat(metadata.artwork)
                        .concat("/").concat("artwork"),
                    mimetype: "image"
                )
            ],
            metadata:{ 
    ...
    pub fun getFLOAT(owner: PublicAccount, id: UInt64): NFTData?{ 
        ...
        return NFTData(
            ...
            media: [
                NFTMedia(
                    uri: "https://nftstorage.link/ipfs/".concat(
                        (float!).eventImage
                    ),
                    mimetype: "image"
                )
