...
//
pub contract LimitdNFTStorefront{ 
    ...
    pub resource SaleOffer: SaleOfferPublic{ 
        ...
        pub fun accept(payment: @FungibleToken.Vault): @NonFungibleToken.NFT{ 
            ...
            emit SaleOfferCompleted(saleOfferResourceID: self.uuid, storefrontResourceID: self.details.storefrontID, accepted: self.details.accepted)
            return <-nft
        }
    ...
    pub resource Storefront: StorefrontManager, StorefrontPublic{ 
        ...
        //
        pub fun createSaleOffer(nftProviderCapability: Capability<&{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>, nftType: Type, nftID: UInt64, salePaymentVaultType: Type, saleCuts: [SaleCut]): UInt64{ 
        ...
        pub fun borrowSaleOffer(saleOfferResourceID: UInt64): &SaleOffer{SaleOfferPublic}?{ 
            if self.saleOffers[saleOfferResourceID] != nil{ 
                return &self.saleOffers[saleOfferResourceID] as                                                                
                                                                // cleanup
    ...
    init(){ 
        self.StorefrontStoragePath = /storage/LimitdNFTStorefront
        self.StorefrontPublicPath = /public/LimitdNFTStorefront
