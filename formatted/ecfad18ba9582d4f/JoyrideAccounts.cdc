...
pub contract JoyrideAccounts{ 
    ...
    init(){ 
        ...
        let cap =
            self.account.link<
                &JoyrideAccountsAdmin{
                    GrantsTokenRewards,
                    SharesProfits,
                    PlayerAccounts
                }
            >(
                /private/JoyrideAccountsAdmin,
                target: /storage/JoyrideAccountsAdmin
            )
    }
    ...
    pub fun PlayerRegisterCapability(
        capability: Capability<&JoyrideMultiToken.Vault>
    ){ 
        let playerID =
        ...
        destroy JoyrideAccounts.playerAccounts.insert(
            key: playerID,
            <-playerAccount
        )
    }
    ...
    pub resource interface ReceivesPlayerRewards{ 
        access(contract) fun ReceiveRewards(
            totalRewards: UFix64,
            rewardID: String,
            tokenContext: String
        ): Bool{} 
    ...
    pub resource PlayerAccount: ReceivesPlayerRewards{ 
        ...
        priv var vaultCapability: Capability<&JoyrideMultiToken.Vault>?
    ...
    pub resource interface SharesProfits{ 
        pub fun ShareProfits(
            profits: @FungibleToken.Vault,
            inGameID: String,
            fromPlayerID: String
        ): @FungibleToken.Vault{} 
        
        pub fun ShareProfitsWithDevPercentage(
            profits: @FungibleToken.Vault,
            inGameID: String,
            fromPlayerID: String,
    ...
    pub resource interface PlayerAccounts{ 
        ...
        pub fun AddPlayerAccount(
            playerID: String,
            referralID: String?,
            account: PublicAccount
        ){} 
        
        pub fun EscrowWithdraw(
            playerID: String,
            amount: UFix64,
            tokenContext: String
        ): @FungibleToken.Vault?{} 
        
        pub fun PlayerDeposit(
            playerID: String,
        ...
        pub fun EscrowWithdrawWithTnxId(
            playerID: String,
            txID: String,
            amount: UFix64,
            tokenContext: String
    ...
    pub resource JoyrideAccountsAdmin:
        GrantsTokenRewards,
        SharesProfits,
        PlayerAccounts{
        ...
        pub fun ShareProfits(
            ...
            return <-self.ShareProfitsWithDevPercentage(
                profits: <-profits,
                inGameID: inGameID,
        ...
        pub fun ShareProfitsWithDevPercentage(
            ...
            let developerStaking =
                JoyrideAccounts.gameToDeveloperAccount[inGameID]
        ...
        pub fun EscrowWithdraw(
            ...
            return <-(playerAccount!).WithdrawTokensForPayment(
                playerID: playerID,
                txID: "",
                amount: amount,
