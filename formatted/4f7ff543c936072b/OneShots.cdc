...
pub contract OneShots: NonFungibleToken, TiblesApp, TiblesNFT, TiblesProducer{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, TiblesNFT.INFT, MetadataViews.Resolver{ 
        ...
        pub fun nftCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: OneShots.CollectionStoragePath, publicPath: OneShots.PublicCollectionPath, providerPath: /private/OneShotsCollection, publicCollection: Type<&OneShots.Collection{TiblesNFT.CollectionPublic}>(), publicLinkedType: Type<&OneShots.Collection{TiblesNFT.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&OneShots.Collection{TiblesNFT.CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
