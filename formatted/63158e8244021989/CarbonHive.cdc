...
pub contract CarbonHive: NonFungibleToken{ 
    ...
    pub event ImpactMinted(impactID: UInt64, projectID: UInt32, fundingRoundID: UInt32, serialNumber: UInt32, amount: UInt32, location: String, locationDescriptor: String, vintagePeriod: String)
    ...
    priv var projectDatas:{ UInt32: ProjectData}
    
    priv var fundingRoundDatas:{ UInt32: FundingRoundData}
    
    priv var reportDatas:{ UInt32: ReportData}
    
    priv var projects: @{UInt32: Project}
    ...
    pub resource Project{ 
        ...
        priv var fundingRounds: [UInt32]
        
        priv var fundingRoundCompleted:{ UInt32: Bool}
        ...
        priv var reports: [UInt32]
        
        priv var impactMintedPerFundingRound:{ UInt32: UInt32}
        
        priv var impactAmountPerFundingRound:{ UInt32: UInt32}
        ...
        pub fun mintImpact(fundingRoundID: UInt32, amount: UInt32, location: String, locationDescriptor: String, vintagePeriod: String, content: @AnyResource{CarbonHive.Content}): @NFT{ 
            pre{ 
                CarbonHive.fundingRoundDatas[fundingRoundID] != nil:
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        priv let content: @AnyResource{CarbonHive.Content}
        ...
        init(projectID: UInt32, fundingRoundID: UInt32, serialNumber: UInt32, amount: UInt32, location: String, locationDescriptor: String, vintagePeriod: String, content: @AnyResource{CarbonHive.Content}){ 
    ...
    pub resource interface ProjectAdmin{ 
        pub fun createFundingRound(name: String, description: String, formula: String, formulaType: String, unit: String, vintagePeriod: String, totalAmount: UInt32, roundEnds: Fix64, location: String, locationDescriptor: String, projectID: UInt32, metadata:{ String: String}): UInt32{} 
        
        pub fun createReport(date: String, projectID: UInt32, fundingRoundID: UInt32, description: String, reportContent: String, reportContentType: String, metadata:{ String: String}): UInt32{} 
        
        pub fun createProject(name: String, description: String, url: String, developer: String, type: String, location: String, locationDescriptor: String, metadata:{ String: String}){} 
        
        pub fun borrowProject(projectID: UInt32): &Project?{} 
    }
    
    pub resource interface ContentAdmin{ 
        pub fun createContent(data: String, contentType: String): @AnyResource{CarbonHive.Content}{} 
    }
