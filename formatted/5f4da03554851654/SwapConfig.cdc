pub contract SwapConfig{ 
    ...
    pub fun getAmountOut(
        ...
        let amountInWithFeeScaled =
            SwapConfig.UFix64ToScaledUInt256(0.997) * amountInScaled
    ...
    pub fun getAmountIn(
        ...
        let amountInScaled =
            ...
            * SwapConfig.scaleFactor
            / SwapConfig.UFix64ToScaledUInt256(0.997)
        return SwapConfig.ScaledUInt256ToUFix64(amountInScaled)
        + SwapConfig.ufix64NonZeroMin
    }
    ...
    init(){ 
        self.PairPublicPath = /public/star_vault_swap_pair
        self
            .LpTokenCollectionStoragePath = /storage/star_vault_swap_lptoken_collection
        self
            .LpTokenCollectionPublicPath = /public/star_vault_swap_lptoken_collection
