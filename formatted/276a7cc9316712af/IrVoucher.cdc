...
pub contract IrVoucher: NonFungibleToken{ 
    ...
    // NFT Events
    //
    pub event NFTMinted(id: UInt64, dropID: UInt32, serial: UInt32)
    ...
    //
    access(account) fun mintVoucher(dropID: UInt32, serial: UInt32): @NFT{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(dropID: UInt32, serial: UInt32): @IrVoucher.NFT{ 
    ...
    init(){ 
        ...
        self.account.link<&IrVoucher.Collection{NonFungibleToken.CollectionPublic, IrVoucher.CollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
