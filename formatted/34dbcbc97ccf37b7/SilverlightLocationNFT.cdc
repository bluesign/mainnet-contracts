...
pub contract SilverlightLocationNFT: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&{SilverlightLocationNFT.SilverlightLocationNFTCollectionPublic}>(SilverlightLocationNFT.CollectionPublicPath, target: SilverlightLocationNFT.CollectionStoragePath)
