...
pub contract SilverlightCoin: FungibleToken{ 
    ...
    init(){ 
        ...
        //
        self.account.link<&SilverlightCoin.Vault{FungibleToken.Receiver}>(SilverlightCoin.SilverlightCoinReceiverPublicPath, target: SilverlightCoin.SilverlightCoinStoragePath)
        
        // Create a public capability to the stored Vault that only exposes
        // the `balance` field through the `Balance` interface
        //
        self.account.link<&SilverlightCoin.Vault{FungibleToken.Balance}>(SilverlightCoin.SilverlightCoinBalancePublicPath, target: SilverlightCoin.SilverlightCoinStoragePath)
