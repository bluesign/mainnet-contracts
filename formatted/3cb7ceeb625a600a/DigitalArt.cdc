...
pub contract DigitalArt: NonFungibleToken{ 
    ...
    priv var masters:{ String: Master}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: DigitalArt.CollectionStoragePath, publicPath: DigitalArt.CollectionPublicPath, providerPath: /private/sequelDigitalArtCollection, publicCollection: Type<&DigitalArt.Collection{DigitalArt.CollectionPublic}>(), publicLinkedType: Type<&DigitalArt.Collection{DigitalArt.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&DigitalArt.Collection{DigitalArt.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    //
    pub resource Collection: CollectionPublic, Evergreen.CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
    ...
    pub fun getMetadata(address: Address, tokenId: UInt64): Metadata?{ 
        ...
        let collectionRef = (acct.getCapability(self.CollectionPublicPath)!).borrow<&{DigitalArt.CollectionPublic}>() ?? panic("Could not borrow capability from public collection")
