    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                //     return GaiaNFTPartner.royalties
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL("https://ongaia.com")
                // return MetadataViews.ExternalURL("https://ongaia.com".concat(self.mintID!.toString())) // points to "nft detail page"
