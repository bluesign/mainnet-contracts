...
pub contract Items: NonFungibleToken{ 
    ...
    priv var artistDatas:{ UInt32: Artist}
    
    // Variable size dictionary of piece structs
    priv var pieceDatas:{ UInt32: PieceData}
    
    // Variable size dictionary of Piece resources
    priv var pieces: @{UInt32: Piece}
    ...
    pub struct QueryPieceData{ 
        ...
        priv var artistID: UInt32
        
        pub var locked: Bool
        
        priv var numberMinted: UInt32
