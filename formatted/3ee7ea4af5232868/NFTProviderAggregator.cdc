...
pub contract NFTProviderAggregator{ 
    ...
    pub resource interface SupplierAccess{ 
        ...
        access(contract) fun removeNFTProviderCapability(
            collectionUUID: UInt64
        ){} 
    ...
    ///
    pub resource Aggregator:
        NonFungibleToken.Provider,
        SupplierAccess,
        SupplierFactory{
    
        /// Constant NFT type identifier
        priv let nftTypeIdentifier: String
        ...
        priv let supplierAccessCapability: Capability<
            &Aggregator{SupplierAccess}
        >
        
        /// Dictionary of supplied NFT provider capabilities
        priv var nftProviderCapabilities:{ 
            UInt64: Capability<
                &AnyResource{
                    NonFungibleToken.Provider,
                    NonFungibleToken.CollectionPublic
        ...
        pub fun removeNFTProviderCapability(collectionUUID: UInt64){ 
            ...
            emit NFTProviderCapabilityRemoved(
                nftTypeIdentifier: self.nftTypeIdentifier,
                collectionUUID: collectionUUID
            )
        }
        ...
        ///
        pub fun borrowNFTProvider(id: UInt64): &AnyResource{
            NonFungibleToken.Provider,
            NonFungibleToken.CollectionPublic
        }{ 
        ...
        pub fun withdraw(withdrawID: UInt64): @NonFungibleToken.NFT{ 
            return <-self.borrowNFTProvider(id: withdrawID).withdraw(
        ...
        ///
        priv fun isNFTProviderCapabilityValid(
            nftProviderCapability: Capability<
                &AnyResource{
                    NonFungibleToken.Provider,
                    NonFungibleToken.CollectionPublic
        ...
        init(
            ...
            emit AggregatorResourceInitialized(
    ...
    pub resource Supplier: SupplierPublic{ 
        ...
        priv let supplierAccessCapability: Capability<&Aggregator{SupplierAccess}>
        ...
        ///
        init(supplierAccessCapability: Capability<&Aggregator{SupplierAccess}>, nftTypeIdentifier: String, aggregatorUUID: UInt64, aggregatorAddressAtCreation: Address?){ 
            pre{ 
