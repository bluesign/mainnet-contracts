...
pub contract MintStoreMarketFactory{ 
    ...
    pub struct Royalty{ 
        ...
        init(
            wallet: Capability<&FUSD.Vault{FungibleToken.Receiver}>,
            rate: UFix64
        ){ 
            self.wallet = wallet
            self.rate = rate
    ...
    pub resource SaleCollection: SalePublic{ 
        ...
        priv var ownerCollection: Capability<&MintStoreItem.Collection>
        ...
        // to this Vault
        priv var ownerCapability: Capability<&FUSD.Vault{FungibleToken.Receiver}>
        
        // The market on which the MintStoreItems are to be sold
        priv var marketCapability: Capability<&{MintStoreMarketFactory.MarketPublic}>
    ...
    pub resource interface MarketPublic{ 
        ...
        access(account) fun isItemValidMerchant(
            item: &MintStoreItem.NFT
        ): Bool{} 
        ...
        pub fun getRoyaltyNames(): [String]{} 
        
        pub fun getRoyaltyRate(royaltyName: String): UFix64?{} 
    ...
    pub resource Market: MarketPublic{ 
        ...
        priv var allowedMerchant:{ UInt32: Bool}
        ...
        priv fun istInitializationValid(): Bool{ 
    ...
    pub resource Admin{ 
        ...
        pub fun createNewAdmin(): @Admin{ 
            ...
            MintStoreMarketFactory.nextAdminID = MintStoreMarketFactory
                    .nextAdminID
                + 1 as UInt64
        ...
        pub fun createNewMarket(): @Market{ 
            ...
            // Increment the ID so that it isn't used again
            MintStoreMarketFactory.nextMarketID = MintStoreMarketFactory
                    .nextMarketID
                + 1 as UInt64
    ...
    pub event MintStoreItemForSale(
        marketID: UInt64,
    ...
    pub event MintStoreItemPriceChanged(
        marketID: UInt64,
        marketAddress: Address,
        id: UInt64,
        newPrice: UFix64,
    ...
    pub event MintStoreItemPurchased(
        marketID: UInt64,
        marketAddress: Address,
        id: UInt64,
        price: UFix64,
    ...
    pub event MintStoreItemWithdrawn(
        marketID: UInt64,
        marketAddress: Address,
        id: UInt64,
        seller: Address
    ...
    pub event RoyaltyRemoved(
        marketID: UInt64,
        marketAddress: Address,
        name: String
    )
    
    pub event RoyaltyRateChanged(
        marketID: UInt64,
        marketAddress: Address,
        name: String,
        previousRate: UFix64,
