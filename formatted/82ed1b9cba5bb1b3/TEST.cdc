...
pub contract TEST: FungibleToken{ 
    // TokensInitialized
    //
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance{ 
        ...
        destroy(){ 
            TEST.totalSupply = TEST.totalSupply - self.balance
            if self.balance > 0.0{ 
    ...
    pub resource Minter{ 
        ...
        //
        pub fun mintTokens(amount: UFix64): @TEST.Vault{ 
            pre{ 
                amount > 0.0:
            ...
            TEST.totalSupply = TEST.totalSupply + amount
    ...
    init(){ 
        // Set our named paths.
        self.VaultStoragePath = /storage/TESTVault
        self.ReceiverPublicPath = /public/TESTReceiver
        self.BalancePublicPath = /public/TESTBalance
        self.AdminStoragePath = /storage/TESTAdmin
