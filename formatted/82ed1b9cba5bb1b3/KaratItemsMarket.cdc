...
pub contract KaratItemsMarket{ 
    ...
    pub resource SaleOffer: SaleOfferPublicView{ 
        ...
        priv let sellerItemProvider: Capability<&KaratItems.Collection{NonFungibleToken.Provider}>
        ...
        //
        pub fun accept(buyerCollection: &KaratItems.Collection{NonFungibleToken.Receiver}, buyerPayment: @FungibleToken.Vault, feeReceiver: Capability<&AnyResource{FungibleToken.Receiver}>, feeRate: UFix64){ 
            pre{ 
        ...
        //
        init(sellerItemProvider: Capability<&KaratItems.Collection{NonFungibleToken.Provider}>, itemID: UInt64, typeID: UInt64, sellerPaymentReceiver: Capability<&AnyResource{FungibleToken.Receiver}>, price: UFix64){ 
            pre{ 
    ...
    pub fun createSaleOffer(
        sellerItemProvider: Capability<
            &KaratItems.Collection{NonFungibleToken.Provider}
        >,
        itemID: UInt64,
        typeID: UInt64,
