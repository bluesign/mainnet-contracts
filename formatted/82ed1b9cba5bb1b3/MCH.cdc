...
pub contract MCH: FungibleToken{ 
    // TokensInitialized
    //
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance{ 
        ...
        destroy(){ 
            MCH.totalSupply = MCH.totalSupply - self.balance
            if self.balance > 0.0{ 
    ...
    pub resource Minter{ 
        ...
        //
        pub fun mintTokens(amount: UFix64): @MCH.Vault{ 
            pre{ 
                amount > 0.0:
            ...
            MCH.totalSupply = MCH.totalSupply + amount
    ...
    init(){ 
        // Set our named paths.
        self.VaultStoragePath = /storage/MCHVault
        self.ReceiverPublicPath = /public/MCHReceiver
        self.BalancePublicPath = /public/MCHBalance
        self.AdminStoragePath = /storage/MCHAdmin
