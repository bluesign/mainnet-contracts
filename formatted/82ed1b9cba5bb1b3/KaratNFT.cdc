        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(receiver: getAccount(self.metadata.artistAddress).getCapability<&{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath()), cut: self.metadata.royalty, description: "The Royalty of 24Karat NFT")])
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL("https://market.24karat.io/nfts/".concat(self.id.toString()))
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: KaratNFT.CollectionStoragePath, publicPath: KaratNFT.CollectionPublicPath, providerPath: /private/KaratNFTCollection, publicCollection: Type<&KaratNFT.Collection{KaratNFT.KaratNFTCollectionPublic}>(), publicLinkedType: Type<&KaratNFT.Collection{KaratNFT.KaratNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&KaratNFT.Collection{KaratNFT.KaratNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
