...
pub contract MINTNFTINCV4NonFungibleToken: NonFungibleToken{ 
    ...
    pub resource interface MINTNFTINCV4CollectionPublic{ 
        ...
        pub fun borrowMINTNFT(id: UInt64): &MINTNFTINCV4NonFungibleToken.NFT?{ 
            post{ 
    ...
    pub resource Collection: MINTNFTINCV4CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic{ 
    ...
    pub resource MINTNFTMinter{ 
        pub fun mintNFT(recipient: &{MINTNFTINCV4CollectionPublic}, name: String, symbol: String, description: String, collectionName: String, tokenURI: String, mintNFTId: String, mintNFTStandard: String, mintNFTVideoURI: String, thirdPartyId: String, terms: String): UInt64{ 
        ...
        pub fun mintNFTBatch(count: UInt64, recipients: [&{MINTNFTINCV4CollectionPublic}], names: [String], symbols: [String], descriptions: [String], collectionNames: [String], tokenURIs: [String], mintNFTIds: [String], mintNFTStandards: [String], mintNFTVideoURIs: [String], thirdPartyIds: [String], terms: [String]): [UInt64]{ 
            var nftIDs: [UInt64] = []
            var idx: UInt64 = 0
    ...
    init(){ 
        self.totalSupply = 0
        self.account.save(<-create Collection(), to: /storage/MINTNFTINCV4Collection)
        self.account.link<&{MINTNFTINCV4CollectionPublic}>(/public/MINTNFTINCV4Collection, target: /storage/MINTNFTINCV4Collection)
        self.account.save(<-create MINTNFTMinter(), to: /storage/MINTNFTMinter)
