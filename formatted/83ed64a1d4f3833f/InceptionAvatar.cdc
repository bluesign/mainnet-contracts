...
pub contract InceptionAvatar: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(url: "https://www.inceptionanimals.com/")
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(self.templateID)
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: InceptionAvatar.CollectionStoragePath, publicPath: InceptionAvatar.CollectionPublicPath, providerPath: /private/InceptionAvatarCollection, publicCollection: Type<&InceptionAvatar.Collection{InceptionAvatar.InceptionAvatarCollectionPublic}>(), publicLinkedType: Type<&InceptionAvatar.Collection{InceptionAvatar.InceptionAvatarCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&InceptionAvatar.Collection{InceptionAvatar.InceptionAvatarCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    return MetadataViews.Royalties(cutInfos: [MetadataViews.Royalty(recepient: merchant.getCapability<&{FungibleToken.Receiver}>(/public/dapperUtilityCoinReceiver), cut: 0.1, description: "Creator royalty in DUC")])
            }
            return nil
        }
    ...
    pub resource Set{ 
        ...
        priv var lockedTemplates:{ UInt64: Bool}
