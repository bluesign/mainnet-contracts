...
pub contract ADHDToken: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                ADHDToken.totalSupply = ADHDToken.totalSupply - self.balance
            }
        }
    }
