...
pub contract FlowUtilityToken: FungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&FlowUtilityToken.Vault{FungibleToken.Balance}>(/public/flowUtilityTokenBalance, target: /storage/flowUtilityTokenVault)
        
        // Create a public capability to the stored Vault that only exposes
        // the deposit method through the Receiver interface
        self.account.link<&{FungibleToken.Receiver}>(/public/flowUtilityTokenReceiver, target: /storage/flowUtilityTokenVault)
