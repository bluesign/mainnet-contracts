...
pub contract DropchaseMarket{ 
    ...
    pub resource SaleCollection: SalePublic{ 
        ...
        priv var ownerCollection: Capability<&Dropchase.Collection>
        ...
        init(ownerCollection: Capability<&Dropchase.Collection>, ownerCapability: Capability<&{FungibleToken.Receiver}>, beneficiaryCapability: Capability<&{FungibleToken.Receiver}>, cutPercentage: UFix64){ 
            pre{ 
        ...
        priv fun getCreatorNameFromItem(item: &Dropchase.NFT): String{ 
