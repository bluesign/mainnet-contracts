...
pub contract DropchaseCoin: FungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&DropchaseCoin.Vault{FungibleToken.Balance}>(/public/DropchaseCoinBalance, target: /storage/DropchaseCoinVault)
        
        // Create a public capability to the stored Vault that only exposes
        // the `deposit` method through the `Receiver` interface
        self.account.link<&{FungibleToken.Receiver}>(/public/DropchaseCoinReceiver, target: /storage/DropchaseCoinVault)
