...
pub contract MetaPandaAirdropNFT: NonFungibleToken{ 
    ...
    pub struct MetaPandaAirdropView{ 
        ...
        init(uuid: UInt64, id: UInt64, nftType: String, metadata:{ String: String}, file: AnyStruct{MetadataViews.File}){ 
            self.uuid = uuid
            self.id = id
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(nftType: String, metadata:{ String: String}, file: AnyStruct{MetadataViews.File}, royalties: [MetadataViews.Royalty]){ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MetaPandaAirdropNFT.CollectionStoragePath, publicPath: MetaPandaAirdropNFT.CollectionPublicPath, providerPath: /private/MetaPandaAirdropNFTCollection, publicCollection: Type<&MetaPandaAirdropNFT.Collection{AnchainUtils.ResolverCollection, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&MetaPandaAirdropNFT.Collection{AnchainUtils.ResolverCollection, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MetaPandaAirdropNFT.Collection{AnchainUtils.ResolverCollection, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, nftType: String, metadata:{ String: String}, file: AnyStruct{MetadataViews.File}, royalties: [MetadataViews.Royalty]){ 
            // create a new NFT
    ...
    init(){ 
        ...
        self.account.link<&MetaPandaAirdropNFT.Collection{AnchainUtils.ResolverCollection, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
