        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MetaPanda.CollectionStoragePath, publicPath: MetaPanda.CollectionPublicPath, providerPath: /private/MetaPandaCollection, publicCollection: Type<&MetaPanda.Collection{AnchainUtils.ResolverCollection, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&MetaPanda.Collection{AnchainUtils.ResolverCollection, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MetaPanda.Collection{AnchainUtils.ResolverCollection, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
