...
pub contract MetaPandaVoucher: NonFungibleToken{ 
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, AnchainUtils.ResolverCollection{ 
        ...
        pub fun borrowViewResolverSafe(id: UInt64): &AnyResource{MetadataViews.Resolver}?{ 
            if self.ownedNFTs[id] != nil{ 
                ...
                if nft != nil{ 
                    return nft! as! &MetaPandaVoucher.NFT as &AnyResource{MetadataViews.Resolver}
                }
            }
            return nil
        }
    ...
    pub resource NFTMinter{ 
        ...
        pub fun consume(_ voucherID: UInt64): Address{ 
            ...
            let redeemedCollection = MetaPandaVoucher.account.borrow<&MetaPandaVoucher.Collection>(from: MetaPandaVoucher.RedeemedCollectionStoragePath)!
    ...
    pub fun redeem(collection: &MetaPandaVoucher.Collection, voucherID: UInt64){ 
        ...
        let receiver = MetaPandaVoucher.account.getCapability(MetaPandaVoucher.RedeemedCollectionPublicPath).borrow<&{NonFungibleToken.CollectionPublic}>()!
    ...
    init(){ 
        ...
        self.account.link<&{NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, AnchainUtils.ResolverCollection}>(self.RedeemedCollectionPublicPath, target: self.RedeemedCollectionStoragePath)
        ...
        self.account.link<&{NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, AnchainUtils.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
