...
pub contract OpenEdition{ 
    ...
    pub resource OpenEditionCollection: OpenEditionCollectionPublic{ 
        ...
        pub fun createOpenEdition(price: UFix64, startTime: UFix64, saleLength: UFix64, editionNumber: UInt64, metadata: Collectible.Metadata, platformVaultCap: Capability<&{FungibleToken.Receiver}>){ 
            pre{ 
                saleLength > 0.00:
        ...
        pub fun purchase(id: UInt64, buyerTokens: @FungibleToken.Vault, collectionCap: Capability<&{Collectible.CollectionPublic}>){ 
            pre{ 
                self.openEditionsItems[id] != nil:
                    "Open Edition does not exist"
                collectionCap.check():
    ...
    pub fun createOpenEditionCollection(
        minterCap: Capability<&Collectible.NFTMinter>
