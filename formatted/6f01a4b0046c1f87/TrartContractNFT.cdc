...
pub contract TrartContractNFT: NonFungibleToken{ 
    ...
    priv let metadatas:{ UInt64: Metadata}
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun getRoyalties(): MetadataViews.Royalties?{ 
            let royalties: [MetadataViews.Royalty] = [MetadataViews.Royalty(receiver: getAccount(0x416e01b78d5b45ff).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver)!, cut: 0.025, description: "Royalty (2.5%)")]
        ...
        pub fun getExternalURL(): MetadataViews.ExternalURL?{ 
            if let info = self.getCardMetadata(){ 
                ...
                return MetadataViews.ExternalURL(url: mediaURL)
            }
            return nil
        }
        ...
        pub fun getNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: TrartContractNFT.CollectionStoragePath, publicPath: TrartContractNFT.CollectionPublicPath, providerPath: /private/TrartContractNFTCollection, publicCollection: Type<&TrartContractNFT.Collection{TrartContractNFT.ICardCollectionPublic}>(), publicLinkedType: Type<&TrartContractNFT.Collection{TrartContractNFT.ICardCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TrartContractNFT.Collection{TrartContractNFT.ICardCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                    return <-TrartContractNFT.createEmptyCollection()
                })
        }
        
        priv fun stringStartsWith(string: String, prefix: String): Bool{ 
