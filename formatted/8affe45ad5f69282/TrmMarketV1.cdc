...
pub contract TrmMarketV1{ 
    ...
    pub event AssetSaleListingChanged(
        assetTokenID: UInt64,
        price: UFix64,
        seller: Address?
    )
    ...
    pub resource SaleCollection: SalePublic{ 
        ...
        priv var ownerCollection: Capability<&TrmAssetV1.Collection>
        
        /// Dictionary of the sale prices for each NFT by ID
        priv var saleListings:{ UInt64: SaleListing}
        ...
        priv var ownerCapability: Capability<&{FungibleToken.Receiver}>
    ...
    pub fun setupBeneficiaryFusdVault(): Capability<&{FungibleToken.Receiver}>{ 
        ...
        return self.account.getCapability<&AnyResource{FungibleToken.Receiver}>(
            /public/fusdReceiver
        )
    }
    ...
    pub resource Admin{ 
        ...
        //
        pub fun setBeneficiaryCapability(
    ...
    init(){ 
        ...
        self.minterCapability = self.account.getCapability<&TrmRentV1.Minter>(
