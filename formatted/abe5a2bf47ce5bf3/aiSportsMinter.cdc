...
pub contract aiSportsMinter: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: aiSportsMinter.CollectionStoragePath, publicPath: aiSportsMinter.CollectionPublicPath, providerPath: /private/aiSportsMinterCollection, publicCollection: Type<&aiSportsMinter.Collection{aiSportsMinter.aiSportsMinterCollectionPublic}>(), publicLinkedType: Type<&aiSportsMinter.Collection{aiSportsMinter.aiSportsMinterCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&aiSportsMinter.Collection{aiSportsMinter.aiSportsMinterCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, edition: String, thumbnail: String, royalties: [MetadataViews.Royalty], status: String, player: String, landscape: String, scene: String, style: String, medium: String){ 
    ...
    init(){ 
        ...
        self.account.link<&aiSportsMinter.Collection{NonFungibleToken.CollectionPublic, aiSportsMinter.aiSportsMinterCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
