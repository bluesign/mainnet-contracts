...
pub contract BltUsdtSwapPair: FungibleToken{ 
    ...
    pub fun createEmptyTokenBundle(): @BltUsdtSwapPair.TokenBundle{ 
        return <-create TokenBundle(fromToken1: <-(BloctoToken.createEmptyVault() as! @BloctoToken.Vault), fromToken2: <-(TeleportedTetherToken.createEmptyVault() as! @TeleportedTetherToken.Vault))
    }
