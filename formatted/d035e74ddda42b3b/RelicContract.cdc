...
pub contract RelicContract: NonFungibleToken{ 
    ...
    pub resource RelicMinter{ 
        pub fun mintRelic(recipient: &{NonFungibleToken.CollectionPublic}, _id: UInt64, _creatorId: String, _relicId: String, _rarity: String, _category: String, _type: String, _creatorName: String, _title: String, _description: String, _edition: UInt64, _editionSize: UInt64, _mintDate: String, _assetVideoURL: String, _assetImageURL: String, _musicURL: String, _artworkURL: String, _royalties: [MetadataViews.Royalty]){ 
            switch _rarity{ 
                case "Bronze":
                    recipient.deposit(token: <-create RelicContract.Relic(initID: _id, creatorId: _creatorId, relicId: _relicId, rarity: _rarity, category: _category, type: _type, creatorName: _creatorName, title: _title, description: _description, edition: _edition, editionSize: _editionSize, mintDate: _mintDate, assetVideoURL: _assetVideoURL, assetImageURL: _assetImageURL, musicURL: _musicURL, artworkURL: _artworkURL, royalties: _royalties))
