...
pub contract MetadataViews{ 
    ...
    pub struct Display{ 
        ...
        // Relic-Specific metadata for display
        pub let id: UInt64
    ...
    pub struct Edition{ 
        ...
        ///
        /// For an "24 of 100 0(#24/10)" item, the number is 24. 
        ///
    ...
    /// A view representing a project-defined serfial number for a speciic NFT
    ...
    pub struct Royalty{ 
        ...
        init(
            recepient: Capability<&AnyResource{FungibleToken.Receiver}>,
            cut: UFix64,
            description: String
        ){ 
            pre{ 
