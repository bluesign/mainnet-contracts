...
pub contract PackNFT: NonFungibleToken{ 
    ...
    pub resource interface IOperator{ 
        pub fun setMetadata(distId: UInt64, edition: UInt32?, metadata: Metadata, overwrite: Bool){} 
        
        pub fun setCollectionMetadata(distId: UInt64, edition: UInt32?, metadata: CollectionMetadata, overwrite: Bool){} 
        
        pub fun mint(distId: UInt64, additionalInfo:{ String: String}?, commitHash: String, issuer: Address, nftCount: UInt16?, lockTime: UFix64?): @NFT{} 
    ...
    pub resource Pack{ 
        ...
        priv fun _hashNft(nft: &NonFungibleToken.NFT): String{ 
            return nft.getType().identifier.concat(".").concat(nft.id.toString())
        }
        
        priv fun _verify(nfts: [&NonFungibleToken.NFT], salt: String, commitHash: String): String{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: PackNFT.CollectionStoragePath, publicPath: PackNFT.CollectionPublicPath, providerPath: PackNFT.CollectionPrivatePath, publicCollection: PackNFT.CollectionPublicType, publicLinkedType: PackNFT.CollectionPublicType, providerLinkedType: PackNFT.CollectionPrivateType, createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, IPackNFTCollectionPublic, IPackNFTCollectionPrivate{ 
