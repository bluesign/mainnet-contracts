...
pub contract TuneGONFT: NonFungibleToken{ 
    ...
    pub event Minted(id: UInt64, itemId: String, edition: UInt64, royalties: [RoyaltyData], additionalInfo:{ String: String})
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv let metadata: Metadata
        
        priv let royalties: [MetadataViews.Royalty]
        
        priv let additionalInfo:{ String: String}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TuneGONFT.CollectionStoragePath, publicPath: TuneGONFT.CollectionPublicPath, providerPath: TuneGONFT.CollectionPrivatePath, publicCollection: Type<&TuneGONFT.Collection{TuneGONFT.TuneGONFTCollectionPublic}>(), publicLinkedType: Type<&TuneGONFT.Collection{TuneGONFT.TuneGONFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TuneGONFT.Collection{TuneGONFT.TuneGONFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, itemId: String, metadata: Metadata, royalties: [MetadataViews.Royalty], additionalInfo:{ String: String}){ 
        ...
        pub fun batchMintNFTOld(recipient: &{NonFungibleToken.CollectionPublic}, itemId: String, metadata: Metadata, royalties: [MetadataViews.Royalty], additionalInfo:{ String: String}, quantity: UInt64){ 
            var i: UInt64 = 0
            while i < quantity{ 
                i = i + UInt64(1)
        ...
        pub fun batchMintNFT(recipient: &{NonFungibleToken.CollectionPublic}, itemId: String, metadata: Metadata, royalties: [MetadataViews.Royalty], additionalInfo:{ String: String}, quantity: UInt64){ 
            assert(TuneGONFT.itemEditions[TuneGONFT.editionCirculatingKey(itemId: itemId)] == nil, message: "New NFTs cannot be minted")
            var totalRoyaltiesPercentage: UFix64 = 0.0
            let royaltiesData: [RoyaltyData] = []
            for royalty in royalties{ 
        ...
        pub fun checkIncClaim(id: String, address: Address, max: UInt16): Bool{ 
            return TuneGONFT.loadMetadataStorage().checkIncClaim(id: id, address: address, max: max)
        }
        
        pub fun readClaims(id: String, addresses: [Address]):{ Address: UInt16}{ 
        ...
        pub fun emitClaimedReward(id: String, address: Address){ 
