...
pub contract StrikeNow: NonFungibleToken{ 
    ...
    init(){ 
        ...
        //our stored vault
        self.account.link<&{FungibleToken.Receiver}>(self.VaultPublicPath, target: /storage/dapperUtilityCoinVault) ?? panic("Could not set up capability link for DUC vault")
