...
pub contract NiftoryIsAwesome: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver, NiftoryNonFungibleToken.NFTPublic{ 
        ...
        pub fun contract(): &{NiftoryNonFungibleToken.ManagerPublic}{ 
            return NiftoryIsAwesome.contract()
        }
    ...
    pub resource Manager: NiftoryNonFungibleToken.ManagerPublic, NiftoryNonFungibleToken.ManagerPrivate{ 
        ...
        pub fun getNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return NiftoryNFTRegistry.buildNFTCollectionData(NiftoryIsAwesome.REGISTRY_ADDRESS, NiftoryIsAwesome.REGISTRY_BRAND, fun (): @NonFungibleToken.Collection{ 
                    return <-NiftoryIsAwesome.createEmptyCollection()
                })
        }
        ...
        pub fun modifyContractMetadata(): auth &AnyStruct{ 
            return &NiftoryIsAwesome.metadata as auth &AnyStruct
        }
        ...
        priv fun _getMetadataViewsManagerPrivate(): &MetadataViewsManager.Manager{MetadataViewsManager.Private}{ 
            ...
            let manager = NiftoryIsAwesome.account.getCapability<&MetadataViewsManager.Manager{MetadataViewsManager.Private}>(record.metadataViewsManager.paths.private).borrow()!
            return manager
        }
        ...
        priv fun _getSetManagerPrivate(): &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}{ 
            let record = NiftoryNFTRegistry.getRegistryRecord(NiftoryIsAwesome.REGISTRY_ADDRESS, NiftoryIsAwesome.REGISTRY_BRAND)
            let setManager = NiftoryIsAwesome.account.getCapability<&MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}>(record.setManager.paths.private).borrow()!
            return setManager
        }
    ...
    init(){ 
        ...
        //
        // NFT Manager storage
        self.account.save<@Manager>(<-create Manager(), to: record.nftManager.paths.storage)
        ...
        self.account.save<@MutableMetadataSetManager.Manager>(<-MutableMetadataSetManager.create(name: "NiftoryIsAwesome", description: "The set manager for NiftoryIsAwesome."), to: record.setManager.paths.storage)
