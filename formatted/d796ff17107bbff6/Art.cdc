    ...
    pub resource NFT: NonFungibleToken.INFT, Public, MetadataViews.Resolver{ 
        ...
        pub fun resolveView(_ type: Type): AnyStruct?{ 
            ...
            if type == Type<MetadataViews.NFTCollectionData>(){ 
                return MetadataViews.NFTCollectionData(storagePath: Art.CollectionStoragePath, publicPath: Art.CollectionPublicPath, providerPath: /private/versusArtCollection, publicCollection: Type<&Art.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, Art.CollectionPublic}>(), publicLinkedType: Type<&Art.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, Art.CollectionPublic}>(), providerLinkedType: Type<&Art.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, Art.CollectionPublic}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                        return <-Art.createEmptyCollection()
                    })
            }
