...
pub contract Versus{ 
    ...
    pub resource Drop{ 
        ...
        pub fun placeBid(
            ...
            let currentBidForUser =
                self.currentBidForUser(auctionId: auctionId, address: bidder)
            ...
            let newStatus =
                self.calculateStatus(edition: editionPrice, unique: uniquePrice)
    ...
    pub resource DropCollection: PublicDrop, AdminDrop{ 
        ...
        access(contract) fun getDrop(_ dropId: UInt64):                                                        
            ...
            return (                    
                    ...
                    &self.drops[dropId] as &Drop //TODO: seperate startPrice for unique and edition                                                /* A stored Transaction to mintArt on versus to a given artist */
    ...
    pub fun getArtForDrop(_ dropId: UInt64): String?{ 
        let versusCap =
            Versus.account.getCapability<&{Versus.PublicDrop}>(
    ...
    pub fun getDrops(): [Versus.DropStatus]{ 
        ...
        let versusCap =
            account.getCapability<&{Versus.PublicDrop}>(
                self.CollectionPublicPath
            )!
    ...
    pub resource Admin: AdminPublic{ 
        priv var server: Capability<&Versus.DropCollection>?
    ...
    init(){ 
        ...
        let marketplaceNFTTrash: Capability<&{Art.CollectionPublic}> =
            account.getCapability<&{Art.CollectionPublic}>(
