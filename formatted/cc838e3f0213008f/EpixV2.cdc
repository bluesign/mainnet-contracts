...
pub contract EpixV2: NonFungibleToken{ 
    ...
    pub struct NFTData{ 
        ...
        init(name: String, description: String, royalties: [MetadataViews.Royalty], linkToViewNFTOn: String, linkToViewCollectionOn: String, linkToBannerOfCollection: String, linkToSquareImageOfCollection: String, linkToTwitterOfCollection: String, metadata: String, claims: [NFTData], traits: [Trait]?, metadataOfTraits:{ String: String}){ 
            self.name = name
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: self.data.name, description: self.data.description, thumbnail: MetadataViews.HTTPFile(url: "https://api.thisisepix.com/api/v1/nfts/thumbnail?metadata_hash=".concat(self.data.metadata)))
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: EpixV2.CollectionStoragePath, publicPath: EpixV2.CollectionPublicPath, providerPath: /private/EpixV2Collection, publicCollection: Type<&EpixV2.Collection{EpixV2.EpixCollectionPublic}>(), publicLinkedType: Type<&EpixV2.Collection{EpixV2.EpixCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&EpixV2.Collection{EpixV2.EpixCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-EpixV2.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: self.data.linkToSquareImageOfCollection), mediaType: "image/svg+xml")
                    let media1 = MetadataViews.Media(file: MetadataViews.HTTPFile(url: self.data.linkToBannerOfCollection), mediaType: "image/svg+xml")
                    return MetadataViews.NFTCollectionDisplay(name: "The Epix Collection", description: "", externalURL: MetadataViews.ExternalURL(self.data.linkToViewCollectionOn), squareImage: media, bannerImage: media1, socials:{ "twitter": MetadataViews.ExternalURL(self.data.linkToTwitterOfCollection)})
