/* SPDX-License-Identifier: UNLICENSED */import DimeCollectibleV5 from "../0xf5cdaace879e5a79/DimeCollectibleV5.cdc"
...
pub contract DimeRoyaltiesV3{ 
    ...
    pub resource Release: ReleasePublic{ 
        ...
        pub fun updateOwner(id: UInt64, newOwner: Address){ 
            let collection = getAccount(newOwner).getCapability<&DimeCollectibleV5.Collection{DimeCollectibleV5.DimeCollectionPublic}>(DimeCollectibleV5.CollectionPublicPath).borrow() ?? panic("Couldn't borrow a capability to the new owner's collection")
        ...
        pub init(id: UInt64, royaltiesPerShare: UFix64, numRoyaltyNFTs: UInt64, managerFees: UFix64, artistShares: SaleShares, managerShares: SaleShares, secondarySaleRoyalties: MetadataViews.Royalties){ 
            self.id = id
    ...
    pub resource ReleaseCollection: ReleaseCollectionPublic{ 
        ...
        pub fun createRelease(collection: &DimeCollectibleV5.Collection{NonFungibleToken.CollectionPublic}, totalRoyalties: UFix64, numRoyaltyNFTs: UInt64, tradeable: Bool, managerFees: UFix64, artistShares: SaleShares, managerShares: SaleShares, secondarySaleRoyalties: MetadataViews.Royalties){ 
            let minterAddress: Address = 0x056a9cc93a020fad // 0x056a9cc93a020fad for testnet. 0xf5cdaace879e5a79 for mainnet
            let minterRef = getAccount(minterAddress).getCapability<&DimeCollectibleV5.NFTMinter>(DimeCollectibleV5.MinterPublicPath).borrow()!
        ...
        pub fun deleteRelease(releaseId: UInt64, collection: Capability<&DimeCollectibleV5.Collection>){ 
