/* SPDX-License-Identifier: UNLICENSED */import DimeCollectibleV4 from "../0xf5cdaace879e5a79/DimeCollectibleV4.cdc"
...
pub contract DimeRoyaltiesV2{ 
    ...
    pub resource Release: ReleasePublic{ 
        ...
        pub fun updateOwner(id: UInt64, newOwner: Address){ 
            let collection = getAccount(newOwner).getCapability<&DimeCollectibleV4.Collection{DimeCollectibleV4.DimeCollectionPublic}>(DimeCollectibleV4.CollectionPublicPath).borrow() ?? panic("Couldn't borrow a capability to the new owner's collection")
    ...
    pub resource ReleaseCollection: ReleaseCollectionPublic{ 
        ...
        pub fun createRelease(collection: &DimeCollectibleV4.Collection{NonFungibleToken.CollectionPublic}, totalRoyalties: UFix64, numRoyaltyNFTs: UInt64, tradeable: Bool, managerFees: UFix64, artistShares: SaleShares, managerShares: SaleShares, secondarySaleRoyalties: MetadataViews.Royalties){ 
            let minterAddress: Address = 0x056a9cc93a020fad // 0x056a9cc93a020fad for testnet. 0xf5cdaace879e5a79 for mainnet
            let minterRef = getAccount(minterAddress).getCapability<&DimeCollectibleV4.NFTMinter>(DimeCollectibleV4.MinterPublicPath).borrow()!
        ...
        pub fun deleteRelease(releaseId: UInt64, collection: Capability<&DimeCollectibleV4.Collection>){ 
