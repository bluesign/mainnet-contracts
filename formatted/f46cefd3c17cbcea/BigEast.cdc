...
pub contract BigEast: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: BigEast.CollectionStoragePath, publicPath: BigEast.CollectionPublicPath, providerPath: /private/BigEastCollection, publicCollection: Type<&BigEast.Collection{BigEast.BigEastCollectionPublic}>(), publicLinkedType: Type<&BigEast.Collection{BigEast.BigEastCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&BigEast.Collection{BigEast.BigEastCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(name: "Big East", description: "Big East", externalURL: MetadataViews.ExternalURL(url: self.link), squareImage: squareImage, bannerImage: bannerImage, socials:{} )
    ...
    init(){ 
        ...
        self.account.link<&{BigEast.BigEastCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
