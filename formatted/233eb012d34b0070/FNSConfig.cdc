pub contract FNSConfig{ 
    priv var inboxFTWhitelist:{ String: Bool}
    
    priv var inboxNFTWhitelist:{ String: Bool}
    
    priv let _reservedFields:{ String: AnyStruct}
    
    priv let rootDomainConfig:{ String:{ String: AnyStruct}}
    
    priv let userConfig:{ Address:{ String: AnyStruct}}
    
    priv let domainConfig:{ String:{ String: AnyStruct}}
