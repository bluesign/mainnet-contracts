...
pub contract BlovizeNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: BlovizeNFT.CollectionStoragePath, publicPath: BlovizeNFT.CollectionPublicPath, providerPath: /private/blovizeNFTCollection, publicCollection: Type<&BlovizeNFT.Collection{BlovizeNFT.BlovizeNFTCollectionPublic}>(), publicLinkedType: Type<&BlovizeNFT.Collection{BlovizeNFT.BlovizeNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&BlovizeNFT.Collection{BlovizeNFT.BlovizeNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, thumbnail: String, royalties: [MetadataViews.Royalty], jsonData:{ String: AnyStruct}){ 
    ...
    init(){ 
        ...
        self.account.link<&BlovizeNFT.Collection{NonFungibleToken.CollectionPublic, BlovizeNFT.BlovizeNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
