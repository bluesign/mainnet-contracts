...
pub contract NFTKred: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: NFTKred.CollectionStoragePath, publicPath: NFTKred.CollectionPublicPath, providerPath: /private/NFTKredCollection, publicCollection: Type<&NFTKred.Collection{NFTKred.NFTKredCollectionPublic}>(), publicLinkedType: Type<&NFTKred.Collection{NFTKred.NFTKredCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&NFTKred.Collection{NFTKred.NFTKredCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-NFTKred.createEmptyCollection()
                        })
            }
            return nil
        }
    ...
    pub resource interface NFTKredCollectionPublic{ 
        ...
        pub fun borrowNFTKred(id: UInt64): &NFTKred.NFT?{ 
    ...
    pub resource Collection: NFTKredCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            return nftKredNFT as &AnyResource{MetadataViews.Resolver}
        }
    ...
    init(){ 
        ...
        self.account.link<&{NFTKred.NFTKredCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
