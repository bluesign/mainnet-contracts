...
pub contract TouchstoneSpecialEditionFloFightersxDiamondFists:
    NonFungibleToken{
    ...
    pub struct NFTMetadata{ 
        ...
        init(
            ...
            self.metadataId = TouchstoneSpecialEditionFloFightersxDiamondFists
                    .nextMetadataId
            self.name = _name
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun getMetadata(): NFTMetadata{ 
            return TouchstoneSpecialEditionFloFightersxDiamondFists.getNFTMetadata(self.metadataId)!
        }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TouchstoneSpecialEditionFloFightersxDiamondFists.CollectionStoragePath, publicPath: TouchstoneSpecialEditionFloFightersxDiamondFists.CollectionPublicPath, providerPath: TouchstoneSpecialEditionFloFightersxDiamondFists.CollectionPrivatePath, publicCollection: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, NonFungibleToken.Provider}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-TouchstoneSpecialEditionFloFightersxDiamondFists.createEmptyCollection()
                        })
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat((self.owner!).address.toString()).concat("/TouchstoneSpecialEditionFloFightersxDiamondFists"))
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareMedia = MetadataViews.Media(file: TouchstoneSpecialEditionFloFightersxDiamondFists.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile, mediaType: "image")
                    
                    // If a banner image exists, use it
                    // Otherwise, default to the main square image
                    var bannerMedia: MetadataViews.Media? = nil
                    if let bannerImage = TouchstoneSpecialEditionFloFightersxDiamondFists.getOptionalCollectionAttribute(key: "bannerImage") as! MetadataViews.IPFSFile?{ 
                        bannerMedia = MetadataViews.Media(file: bannerImage, mediaType: "image")
                    }
                    return MetadataViews.NFTCollectionDisplay(name: TouchstoneSpecialEditionFloFightersxDiamondFists.getCollectionAttribute(key: "name") as! String, description: TouchstoneSpecialEditionFloFightersxDiamondFists.getCollectionAttribute(key: "description") as! String, externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat((self.owner!).address.toString()).concat("/TouchstoneSpecialEditionFloFightersxDiamondFists")), squareImage: squareMedia, bannerImage: bannerMedia ?? squareMedia, socials: TouchstoneSpecialEditionFloFightersxDiamondFists.getCollectionAttribute(key: "socials") as!{ String: MetadataViews.ExternalURL})
        ...
        init(_metadataId: UInt64, _serial: UInt64, _recipient: Address){ 
            pre{ 
                TouchstoneSpecialEditionFloFightersxDiamondFists.metadatas[_metadataId] != nil:
                    "This NFT does not exist yet."
                _serial < (TouchstoneSpecialEditionFloFightersxDiamondFists.getNFTMetadata(_metadataId)!).supply:
                    "This serial does not exist for this metadataId."
                !(TouchstoneSpecialEditionFloFightersxDiamondFists.getNFTMetadata(_metadataId)!).purchasers.containsKey(_serial):
            ...
            if let buyersRef = &TouchstoneSpecialEditionFloFightersxDiamondFists.primaryBuyers[_recipient] as &{UInt64: [UInt64]}?{ 
                ...
                TouchstoneSpecialEditionFloFightersxDiamondFists.primaryBuyers[_recipient] ={ _metadataId: [_serial]}
            }
            
            // Update who bought this serial inside NFTMetadata so it cannot be purchased again.
            let metadataRef = (&TouchstoneSpecialEditionFloFightersxDiamondFists.metadatas[_metadataId] as &NFTMetadata?)!
            metadataRef.purchased(serial: _serial, buyer: _recipient)
            TouchstoneSpecialEditionFloFightersxDiamondFists.totalSupply = TouchstoneSpecialEditionFloFightersxDiamondFists.totalSupply + 1
    ...
    pub resource Collection:
        ...
        pub fun withdraw(withdrawID: UInt64): @NonFungibleToken.NFT{ 
            let token <-
                self.ownedNFTs.remove(key: withdrawID) ?? panic("missing NFT")
        ...
        pub fun claim(){ 
            if let storage =
                &TouchstoneSpecialEditionFloFightersxDiamondFists.nftStorage[
                    (self.owner!).address
                ]
                as
                &{
    ...
    pub fun mintNFT(
        ...
        let EmeraldCityTreasury =
            getAccount(0x5643fd47a29770e7).getCapability(
        ...
        if let royalty =
            TouchstoneSpecialEditionFloFightersxDiamondFists
                .getOptionalCollectionAttribute(key: "royalty")
            as!
            MetadataViews.Royalty?{ 
            (royalty.receiver.borrow()!).deposit(
                from: <-payment.withdraw(amount: price * royalty.cut)
            )
        }
        EmeraldCityTreasury.deposit(
            from: <-payment.withdraw(amount: emeraldCityCut)
        )
        
        // Give the rest to the collection owner
        let paymentRecipient =
            self.account.getCapability(/public/flowTokenReceiver).borrow<
        ...
        let nft <-
            create NFT(
                ...
                _serial: serial,
                _recipient: (recipient.owner!).address
            )
        let nftId: UInt64 = nft.id
        let metadata = self.getNFTMetadata(metadataId)!
        self.collectionInfo["profit"] = self.getCollectionAttribute(
                key: "profit"
            )
            as!
            UFix64
    ...
    pub resource Administrator{ 
        pub fun createNFTMetadata(
            ...
            TouchstoneSpecialEditionFloFightersxDiamondFists.metadatas[
                TouchstoneSpecialEditionFloFightersxDiamondFists.nextMetadataId
            ] = NFTMetadata(
                    _name: name,
            ...
            TouchstoneSpecialEditionFloFightersxDiamondFists
                .nextMetadataId = TouchstoneSpecialEditionFloFightersxDiamondFists
                    .nextMetadataId
                + 1
        }
        ...
        pub fun mintNFT(
            ...
            pre{ 
                EmeraldPass.isActive(user: TouchstoneSpecialEditionFloFightersxDiamondFists.account.address):
            ...
            if let recipientCollection =
                getAccount(recipient).getCapability(
                    TouchstoneSpecialEditionFloFightersxDiamondFists
                        .CollectionPublicPath
                ).borrow<
                    &TouchstoneSpecialEditionFloFightersxDiamondFists.Collection{
                        NonFungibleToken.CollectionPublic
                    }
                >(){ 
                ...
                TouchstoneSpecialEditionFloFightersxDiamondFists.nftStorage[recipient] <-!{ nft.id: <-nft}
            }
        }
        ...
        pub fun changeField(key: String, value: AnyStruct){ 
            TouchstoneSpecialEditionFloFightersxDiamondFists.collectionInfo[
                key
            ] = value
        }
    }
    ...
    pub fun getCollectionAttribute(key: String): AnyStruct{ 
        ...
        ?? panic(key.concat(" is not an attribute in this collection."))
    }
    ...
    pub fun getMintVerifiers(): [{MintVerifiers.IVerifier}]{ 
        return self.getCollectionAttribute(key: "mintVerifiers")
        as!
        [{
            MintVerifiers.IVerifier}
        ]
    }
    ...
    pub fun getPriceOfNFT(_ metadataId: UInt64): UFix64?{ 
        if let metadata: TouchstoneSpecialEditionFloFightersxDiamondFists.NFTMetadata =
            self.getNFTMetadata(metadataId){ 
            let defaultPrice: UFix64 =
                self.getCollectionAttribute(key: "price") as! UFix64
    ...
    pub fun getClaimableNFTs(user: Address):{ UInt64: NFTMetadata}{ 
        ...
        if let storage =
            &TouchstoneSpecialEditionFloFightersxDiamondFists.nftStorage[user]
            as
            &{
                UInt64: NFT
            }?{ 
    ...
    init(
        ...
        self
            .CollectionStoragePath = /storage/TouchstoneSpecialEditionFloFightersxDiamondFistsCollection_0x5b7f514d1ade0f3f
        self
            .CollectionPublicPath = /public/TouchstoneSpecialEditionFloFightersxDiamondFistsCollection_0x5b7f514d1ade0f3f
        self
            .CollectionPrivatePath = /private/TouchstoneSpecialEditionFloFightersxDiamondFistsCollection_0x5b7f514d1ade0f3f
        self
            .AdministratorStoragePath = /storage/TouchstoneSpecialEditionFloFightersxDiamondFistsAdministrator_0x5b7f514d1ade0f3f
