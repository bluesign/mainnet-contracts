...
pub contract TeleportCustodyEthereum{ 
    ...
    init(){ 
        ...
        self
            .TeleportAdminStoragePath = /storage/teleportCustodyEthereumTeleportAdmin
        self
            .TeleportAdminTeleportUserPath = /public/teleportCustodyEthereumTeleportUser
        self
            .TeleportAdminTeleportControlPath = /private/teleportCustodyEthereumTeleportControl
        self.isFrozen = false
        self.unlocked ={} 
