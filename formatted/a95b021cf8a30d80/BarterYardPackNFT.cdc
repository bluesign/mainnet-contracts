...
pub contract BarterYardPackNFT: NonFungibleToken{ 
    ...
    pub struct PackPart: SupplyManager{ 
        ...
        pub init(id: Int, name: String, description: String, ipfsThumbnailCid: String, ipfsThumbnailPath: String?, maxSupply: UInt16, totalSupply: UInt16){ 
            self.id = id
            self.name = name
    ...
    pub resource Admin{ 
        ...
        pub fun mintNFT(packPartId: Int): @BarterYardPackNFT.NFT{ 
        ...
        pub fun createNewPack(name: String, description: String, ipfsThumbnailCid: String, ipfsThumbnailPath: String?, maxSupply: UInt16){ 
    ...
    init(){ 
        ...
        self.account.link<&BarterYardPackNFT.Collection{NonFungibleToken.CollectionPublic, BarterYardPackNFT.BarterYardPackNFTCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
