...
pub contract TheFabricantS1ItemNFT: NonFungibleToken{ 
    ...
    pub struct ItemData{ 
        ...
        // other metadata
        priv let metadatas:{ String: TheFabricantS1ItemNFT.Metadata}
        
        init(coCreator: Address, metadatas:{ String: TheFabricantS1ItemNFT.Metadata}){ 
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        priv var garment: @TheFabricantS1GarmentNFT.NFT?
        
        // this is where the material nft is stored, it cannot be moved out
        priv var material: @TheFabricantS1MaterialNFT.NFT?
    ...
    pub fun mintNFT(name: String, royaltyVault: TheFabricantS1ItemNFT.Royalty, garment: @TheFabricantS1GarmentNFT.NFT, material: @TheFabricantS1MaterialNFT.NFT, primaryColor: String, secondaryColor: String): @NFT{ 
        ...
        let itemDataID = TheFabricantS1ItemNFT.itemDataAllocation[key] ?? panic("Cannot mint Item. ItemData not found")
        ...
        let numInItem = TheFabricantS1ItemNFT.numberMintedPerItem[itemDataID] ?? panic("Maximum number of Items with itemDataID minted")
    ...
    pub resource Admin{ 
        ...
        pub fun createItemDataWithAllocation(garmentDataID: UInt32, materialDataID: UInt32, primaryColor: String, secondaryColor: String, metadatas:{ String: TheFabricantS1ItemNFT.Metadata}, coCreator: Address): UInt32{ 
