...
pub contract TheFabricantMarketplace{ 
    ...
    pub resource Listing: ListingPublic{ 
        ...
        priv let paymentCapability: Capability<&{FungibleToken.Receiver}>
    ...
    pub resource Listings: ListingsPublic, ListingsManager{ 
        ...
        priv var listings: @{String: Listing}
        ...
        pub fun createListing(nftProviderCapability: Capability<&{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>, nftType: Type, nftID: UInt64, paymentCapability: Capability<&{FungibleToken.Receiver}>, salePaymentVaultType: Type, price: UFix64, saleCuts: [SaleCut]): String{ 
            pre{ 
        ...
        //
        pub fun borrowListing(listingID: String): &Listing{ListingPublic}?{ 
            return &self.listings[listingID] as                                                
                                                // getListingIDs
    ...
    pub resource Offer: OfferPublic{ 
        priv let offerDetails: OfferDetails
    ...
    pub resource interface OffersManager{ 
        pub fun makeOffer(
            ...
            nftType: Type,
            nftID: UInt64,
            nftReceiverCapability: Capability<
    ...
    pub resource Offers: OffersPublic, OffersManager{ 
        ...
        pub fun makeOffer(initialNFTOwner: Address, ftProviderCapability: Capability<&{FungibleToken.Provider, FungibleToken.Balance}>, offerPaymentVaultType: Type, nftType: Type, nftID: UInt64, nftReceiverCapability: Capability<&{NonFungibleToken.CollectionPublic}>, price: UFix64, saleCuts: [SaleCut]): String{ 
            pre{ 
    ...
    pub resource Admin{ 
        pub fun setChannelFeeCap(
            channelFeeCap: Capability<&{FungibleToken.Receiver}>
        ){ 
            pre{ 
                channelFeeCap.check():
    ...
    pub init(){ 
        self
            .ListingsPublicPath = /public/fabricantPublicTheFabricantMarketplaceListings0021
        self
            .ListingsStoragePath = /storage/fabricantStorageTheFabricantMarketplaceListings0021
        self
            .OffersPublicPath = /public/fabricantPubliceTheFabricantMarketplaceListings0021
        self
            .OffersStoragePath = /storage/fabricantStorageTheFabricantMarketplaceOffers0021
        self
            .AdminStoragePath = /storage/fabricantTheFabricantMarketplaceAdmin0021
