...
import
    ...
    from "../0x9e03b1f871b3513/TheFabricantS1GarmentNFT.cdc"

import
    TheFabricantS1MaterialNFT
    from "../0x9e03b1f871b3513/TheFabricantS1MaterialNFT.cdc"
...
pub contract TheFabricantS1MintTransferClaim{ 
    ...
    pub resource Admin{ 
        ...
        pub fun mintAndTransferItem(
            ...
            if TheFabricantS1MintTransferClaim.addressMintCount[recipientAddr]
            == nil{ 
                TheFabricantS1MintTransferClaim.addressMintCount[
                    recipientAddr
                ] = 1
            } else{ 
    ...
    init(){ 
        ...
        self
            .AdminStoragePath = /storage/TheFabricantS1MintTransferClaimAdmin0019
