...
import
    ...
    from "../0x9212a87501a8a6a2/FlowversePrimarySaleV2.cdc"
...
pub contract HeroesOfTheFlow: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: HeroesOfTheFlow.CollectionStoragePath, publicPath: HeroesOfTheFlow.CollectionPublicPath, providerPath: /private/HeroesOfTheFlowCollection, publicCollection: Type<&HeroesOfTheFlow.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, HeroesOfTheFlow.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&HeroesOfTheFlow.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, HeroesOfTheFlow.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&HeroesOfTheFlow.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, HeroesOfTheFlow.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-HeroesOfTheFlow.createEmptyCollection()
                        })
                ...
                case Type<MetadataViews.Royalties>():
                    let royalties: [MetadataViews.Royalty] = [MetadataViews.Royalty(receiver: getAccount(0xc5857663ca37efbf).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver)!, cut: 0.05, description: "Creator Royalty Fee")]
                ...
                case Type<MetadataViews.Traits>():
                    ...
                    if let background = HeroesOfTheFlow.getEntityMetaDataByField(entityID: self.entityID, field: "background"){ 
                        traits.append(MetadataViews.Trait(type: "Background", value: background, displayType: nil, rarity: nil))
                    }
                    if let rarity = HeroesOfTheFlow.getEntityMetaDataByField(entityID: self.entityID, field: "rarity"){ 
                        traits.append(MetadataViews.Trait(type: "Rarity", value: rarity, displayType: nil, rarity: nil))
                    }
                    if let minion = HeroesOfTheFlow.getEntityMetaDataByField(entityID: self.entityID, field: "minion"){ 
                        traits.append(MetadataViews.Trait(type: "Minion", value: minion, displayType: nil, rarity: nil))
                    }
    ...
    priv fun mint(entityID: UInt64, minterAddress: Address): @NFT{ 
        pre{ 
