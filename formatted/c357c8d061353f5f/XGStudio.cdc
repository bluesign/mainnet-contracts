...
pub contract XGStudio: NonFungibleToken{ 
    ...
    priv var allBrands:{ UInt64: Brand}
    
    priv var allSchemas:{ UInt64: Schema}
    
    priv var allTemplates:{ UInt64: Template}
    
    priv var allNFTs:{ UInt64: NFTData}
    
    // Accounts ability to add capability
    priv var whiteListedAccounts: [Address]
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: XGStudio.CollectionStoragePath, publicPath: XGStudio.CollectionPublicPath, providerPath: /private/XGStudioCollectionProvider, publicCollection: Type<&XGStudio.Collection{XGStudio.XGStudioCollectionPublic}>(), publicLinkedType: Type<&XGStudio.Collection{XGStudio.XGStudioCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&XGStudio.Collection{XGStudio.XGStudioCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @XGStudio.Collection{ 
                ...
                case Type<MetadataViews.Medias>():
                    ...
                    return MetadataViews.Medias([MetadataViews.Media(contentFile!, contentType == "mp4" ? "video/mp4" : contentType)])
        ...
        pub fun getThumbnailFile():{ MetadataViews.File}{ 
            ...
            if templateData["raceName"] as! String? == "Hackney Half Marathon 2022"{ 
                switch templateData["nftType"] as! String? ?? ""{ 
                    case "Finish LE":
                        return MetadataViews.IPFSFile("QmUAoUBy4xPRDqH7BKx5ZpVYcFzums9scZu83ccefLrFkr", "FINISH_LE.png")
                    case "Finish":
                        return MetadataViews.IPFSFile("QmUAoUBy4xPRDqH7BKx5ZpVYcFzums9scZu83ccefLrFkr", "FINISH.png")
                }
                switch templateData["title"] as! String? ?? ""{ 
                    case "1st Place - HACKNEY HALF 2022":
                        return MetadataViews.IPFSFile("QmUAoUBy4xPRDqH7BKx5ZpVYcFzums9scZu83ccefLrFkr", "1ST.png")
                    case "2nd Place - HACKNEY HALF 2022":
                        return MetadataViews.IPFSFile("QmUAoUBy4xPRDqH7BKx5ZpVYcFzums9scZu83ccefLrFkr", "2ND.png")
                    case "3rd Place - HACKNEY HALF 2022":
                        return MetadataViews.IPFSFile("QmUAoUBy4xPRDqH7BKx5ZpVYcFzums9scZu83ccefLrFkr", "3RD.png")
                }
            }
            if templateData["raceName"] as! String? == "ASICS London 10K 2022"{ 
                switch templateData["nftType"] as! String? ?? ""{ 
                    case "Finish LE":
                        return MetadataViews.IPFSFile("Qmdu543z9kvSgX5fS54rpF8sFcX4t5ZbaFBk7YhZFQcn5Y", "FINISH_LE.png")
                    case "Finish":
                        return MetadataViews.IPFSFile("Qmdu543z9kvSgX5fS54rpF8sFcX4t5ZbaFBk7YhZFQcn5Y", "FINISH.png")
                }
                switch templateData["title"] as! String? ?? ""{ 
                    case "1st - ASICS LONDON 10K":
                        return MetadataViews.IPFSFile("Qmdu543z9kvSgX5fS54rpF8sFcX4t5ZbaFBk7YhZFQcn5Y", "1ST.png")
                    case "2nd - ASICS LONDON 10K":
                        return MetadataViews.IPFSFile("Qmdu543z9kvSgX5fS54rpF8sFcX4t5ZbaFBk7YhZFQcn5Y", "2ND.png")
                    case "3rd - ASICS LONDON 10K":
                        return MetadataViews.IPFSFile("Qmdu543z9kvSgX5fS54rpF8sFcX4t5ZbaFBk7YhZFQcn5Y", "3RD.png")
                }
            }
            ...
            if templateData["activityType"] as! String? == "Football"{ 
                switch templateData["xGRewardType"] as! String? ?? ""{ 
                    case "Team Clean Sheet":
                        return MetadataViews.IPFSFile("QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", "TEAM_CLEANSHEET.png")
                    case "Goal Scored":
                        return MetadataViews.IPFSFile("QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", "GOAL_SCORED.png")
                    case "Team Goals":
                        return MetadataViews.IPFSFile("QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", "TEAM_GOAL.png")
                    case "Win":
                        return MetadataViews.IPFSFile("QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", "WIN.png")
                    case "Appearance":
                        return MetadataViews.IPFSFile("QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", "APPEARANCE.png")
                    case "GK Clean Sheet":
                        return MetadataViews.IPFSFile("QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", "CLEANSHEET.png")
                    case "Hat Trick":
                        return MetadataViews.IPFSFile("QmbB8panH4gg4A3WpzVdoawHtYcXySLKbEphrEoYs9rZC6", "HAT_TRICK_THUMB.png")
                }
            }
    ...
    pub resource AdminResource: UserSpecialCapability, NFTMethodsCapability{ 
        ...
        pub fun mintNFT(templateId: UInt64, account: Address, immutableData:{ String: AnyStruct}){ 
            ...
            let recipientCollection = receiptAccount.getCapability(XGStudio.CollectionPublicPath).borrow<&{XGStudio.XGStudioCollectionPublic}>() ?? panic("Could not get receiver reference to the NFT Collection")
