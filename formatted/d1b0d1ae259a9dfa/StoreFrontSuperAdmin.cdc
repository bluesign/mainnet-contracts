...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xd1b0d1ae259a9dfa
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xd1b0d1ae259a9dfa
