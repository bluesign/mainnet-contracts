...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x3206df1262640a25
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x3206df1262640a25
