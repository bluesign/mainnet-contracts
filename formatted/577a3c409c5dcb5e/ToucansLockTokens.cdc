...
pub contract ToucansLockTokens{ 
    ...
    pub resource LockedVault{ 
        ...
        access(contract) fun withdrawVault(
    ...
    pub resource interface ManagerPublic{ 
        ...
        pub fun getLockedVaultInfosForAddress(address: Address): [
            LockedVaultDetails
        ]{} 
    }
    
    pub resource Manager: ManagerPublic{ 
        priv let lockedVaults: @{UInt64: LockedVault}
        
        priv let addressMap:{ Address: [UInt64]}
