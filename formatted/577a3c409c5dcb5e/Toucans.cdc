...
pub contract Toucans{ 
    ...
    pub struct FundingCycleDetails{ 
        ...
        init(
            ...
            assert(
                percentCount <= 1.0,
                message: "Payouts cannot total to more than 100%."
            )
        }
    }
    ...
    pub struct FundingCycle{ 
        ...
        access(contract) fun handlePaymentReceipt(
            projectTokensAcquired: UFix64,
            cost: UFix64,
            payer: Address
        ){ 
            self.projectTokensAcquired = self.projectTokensAcquired
                + projectTokensAcquired
    ...
    pub resource interface ProjectPublic{ 
        ...
        pub fun proposeWithdraw(
            vaultType: Type,
            recipientVault: Capability<&{FungibleToken.Receiver}>,
            amount: UFix64
        ){} 
        
        pub fun proposeBatchWithdraw(
            vaultType: Type,
            recipientVaults:{ 
        ...
        pub fun proposeWithdrawNFTs(
            ...
            message: String,
            _ recipientCollectionBackup: Capability<
        ...
        pub fun proposeStakeFlow(
            flowAmount: UFix64,
            stFlowAmountOutMin: UFix64
        ){} 
        
        pub fun proposeUnstakeFlow(
            stFlowAmount: UFix64,
            flowAmountOutMin: UFix64
        ){} 
        
        // If the action is ready to execute, then allow anyone to do it.
        pub fun finalizeAction(actionUUID: UInt64){} 
        
        pub fun donateToTreasury(
            vault: @FungibleToken.Vault,
            payer: Address,
            message: String
        ){} 
        
        pub fun donateNFTToTreasury(
            collection: @NonFungibleToken.Collection,
            sender: Address,
            message: String
        ){} 
        
        pub fun transferProjectTokenToTreasury(
            vault: @FungibleToken.Vault,
            payer: Address,
            message: String
        ){} 
        ...
        pub fun borrowLockTokensManagerPublic(): &ToucansLockTokens.Manager{
            ToucansLockTokens.ManagerPublic
        }?{} 
        ...
        pub fun getNFTRefsByIDs(collectionType: Type, ids: [UInt64]): [
    ...
    pub resource Project: ProjectPublic{ 
        ...
        priv let fundingCycles: [FundingCycle]
        
        priv let treasury: @{Type: FungibleToken.Vault}
        
        priv let multiSignManager: @Manager
        
        priv let overflow: @FungibleToken.Vault
        
        priv var minter: @{Minter}
        
        priv let funders:{ Address: UFix64}
        
        priv var extra:{ String: AnyStruct}
        
        priv var additions: @{String: AnyResource}
        ...
        pub fun purchase(paymentTokens: @FungibleToken.Vault, projectTokenReceiver: &{FungibleToken.Receiver}, message: String){ 
            ...
            let emeraldCityTreasury = getAccount(0x5643fd47a29770e7).getCapability(self.paymentTokenInfo.receiverPath).borrow<&{FungibleToken.Receiver}>() ?? panic("Emerald City treasury cannot accept this payment. Please contact us in our Discord.")
        ...
        priv fun depositToTreasury(vault: @FungibleToken.Vault){ 
        ...
        priv fun depositToOverflow(vault: @FungibleToken.Vault){ 
            pre{ 
        ...
        priv fun withdrawFromTreasury(vaultType: Type, vault: &{FungibleToken.Receiver}, amount: UFix64, tokenSymbol: String){ 
        ...
        priv fun batchWithdrawFromTreasury(vaultType: Type, vaults:{ Address: Capability<&{FungibleToken.Receiver}>}, amounts:{ Address: UFix64}, tokenSymbol: String){ 
            let failed: [Address] = []
        ...
        priv fun markCompletedAction(actionUUID: UInt64, mark: Bool){ 
        ...
        priv fun withdrawNFTsFromTreasury(collectionType: Type, collectionReceiver: &{NonFungibleToken.Receiver}?, nftIDs: [UInt64], collectionIdentifier: String, collectionName: String, collectionExternalURL: String, recipientAddr: Address, message: String, _ backupReceiver: &{NonFungibleToken.CollectionPublic}?){ 
        ...
        priv fun borrowFundingCycleRef(cycleIndex: UInt64): &FundingCycle{ 
            return &self.fundingCycles[cycleIndex] as &FundingCycle
        }
        
        priv fun borrowCurrentFundingCycleRef(): &FundingCycle?{ 
            let index: Int? = self.getCurrentFundingCycleIndex()
            if index == nil{ 
                return nil
            }
        ...
        priv fun borrowLockTokensManager(): &ToucansLockTokens.Manager?{ 
        ...
        priv fun borrowNFTTreasury(): &{Type: NonFungibleToken.Collection}?{ 
        ...
        priv fun borrowSpecificNFTTreasuryCollection(type: Type): &NonFungibleToken.Collection?{ 
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowProjectPublic(projectId: String): &Project{
            ProjectPublic
        }?{} 
    }
    ...
    pub resource Collection: CollectionPublic{ 
        ...
        pub fun createProjectNoToken(projectId: String, paymentTokenInfo: ToucansTokens.TokenInfo, initialAllowedNFTCollections: [String], extra:{ String: AnyStruct}){ 
            let project: @Project <- create Project(projectId: projectId, projectTokenInfo: paymentTokenInfo, // use the payment token, or "preferred currency", for this  paymentTokenInfo: paymentTokenInfo, minter: <-create DummyMinter(), editDelay: 0.0, initialSigners: [(self.owner!).address], initialThreshold: 1, minting: false, initialTreasurySupply: 0.0, initialAllowedNFTCollections: initialAllowedNFTCollections, extra: extra)
            self.projects[projectId] <-! project
            emit ProjectCreated(projectId: projectId, tokenTypeIdentifier: nil, by: (self.owner!).address)
        }
        
        pub fun createProject(projectTokenInfo: ToucansTokens.TokenInfo, paymentTokenInfo: ToucansTokens.TokenInfo, minter: @{Minter}, editDelay: UFix64, minting: Bool, initialTreasurySupply: UFix64, extra:{ String: AnyStruct}){ 
        ...
        pub fun voteOnProjectAction(projectOwner: Address, projectId: String, actionUUID: UInt64, vote: Bool){ 
            let collection: &Collection{CollectionPublic} = getAccount(projectOwner).getCapability(Toucans.CollectionPublicPath).borrow<&Toucans.Collection{Toucans.CollectionPublic}>() ?? panic("A DAOTreasury doesn't exist here.")
    ...
    pub resource MultiSignAction{ 
        ...
        pub fun getActionState(): ActionState{ 
            ...
            if self.getDeclined()
            > UInt64(self.getSigners().length) - self.threshold{ 
                return ActionState.DECLINED
            }
    ...
    pub resource Manager: ManagerPublic{ 
        ...
        priv let actions: @{UInt64: MultiSignAction}
    ...
    pub fun assertNonConflictingCycles(
