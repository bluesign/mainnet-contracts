...
pub contract DriverzExclusive: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: DriverzExclusive.CollectionStoragePath, publicPath: DriverzExclusive.CollectionPublicPath, providerPath: DriverzExclusive.CollectionPrivatePath, publicCollection: Type<&Collection{NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&Collection{DriverzExclusive.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{DriverzExclusive.CollectionPublic, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, NonFungibleToken.Provider}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<DriverzExclusive.driverzExclusiveMetadata>():
                    return DriverzExclusive.driverzExclusiveMetadata(id: self.id, name: self.name, description: self.description, image: self.image, traits: self.traits)
                ...
                case Type<MetadataViews.Traits>():
                    ...
                    for trait in self.traits.keys{ 
                        traits.append(MetadataViews.Trait(trait: trait, value: self.traits[trait]!, displayType: nil, rarity: nil))
                    }
    ...
    pub resource Admin{ 
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, image: String, traits:{ String: String}){ 
            ...
            recipient.deposit(token: <-create DriverzExclusive.NFT(initID: DriverzExclusive.totalSupply, name: name, description: description, image: image, traits: traits))
        }
    }
    ...
    init(){ 
        ...
        self.account.link<&DriverzExclusive.Collection{NonFungibleToken.CollectionPublic, DriverzExclusive.CollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
