...
pub contract CarClubMainStorefront{ 
    pub event CarClubStorefrontInitialized()
    ...
    pub let StorefrontMainStoragePath: StoragePath
    
    pub let StorefrontMainPublicPath: PublicPath
    ...
    pub resource interface ListingPublic{ 
        ...
        pub fun purchase(
            ...
            collection: &NonFungibleToken.Collection{NonFungibleToken.Receiver}
        ){} 
    ...
    pub resource Listing: ListingPublic{ 
        ...
        destroy(){ 
            if !self.details.purchased{ 
                emit ListingCompleted(listingResourceID: self.uuid, storefrontResourceID: self.details.storefrontID, purchased: self.details.purchased, nftType: self.details.nftType, nftIDs: self.details.nftIDs)
            }
        }
    ...
    pub resource Storefront: StorefrontManager, StorefrontPublic{ 
        ...
        //
        pub fun createListing(nftProviderCapability: Capability<&{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>, nftType: Type, nftIDs: [UInt64], receiver: Capability<&{FungibleToken.Receiver}>, salePaymentVaultType: Type, salePrice: UFix64, discount: UFix64?): UInt64{ 
    ...
    init(){ 
        self.StorefrontMainStoragePath = /storage/CarClubMainStorefront
        self.StorefrontMainPublicPath = /public/CarClubMainStorefront
