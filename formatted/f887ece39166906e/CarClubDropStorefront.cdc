...
pub contract CarClubDropStorefront{ 
    ...
    pub resource Storefront: StorefrontManager, StorefrontPublic{ 
        ...
        //
        pub fun createListing(nftProviderCapability: Capability<&{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>, nftType: Type, nftID: UInt64, receiver: Capability<&{FungibleToken.Receiver}>, salePaymentVaultType: Type, salePrice: UFix64, discount: UFix64?): UInt64{ 
