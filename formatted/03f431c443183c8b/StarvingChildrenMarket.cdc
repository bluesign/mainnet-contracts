...
pub contract StarvingChildrenMarket{ 
    ...
    pub event StarvingChildrenPurchased(
        idBuyer: UInt64,
        idCharity: UInt64,
        templateId: UInt64,
    ...
    pub resource Manager: ManagerPublic{ 
        ...
        priv var adminCapability: Capability<&StarvingChildren.Admin>
        
        /// A receiver capability of fungible token resource used to receive FUSD
        priv var receiverCapability: Capability<&FUSD.Vault{FungibleToken.Receiver}>
        
        /// A buyer's collection to get purchased NFT 
        priv var collectionCapability: Capability<&{StarvingChildren.StarvingChildrenCollectionPublic}>
        
        init(adminCapability: Capability<&StarvingChildren.Admin>, receiverCapability: Capability<&FUSD.Vault{FungibleToken.Receiver}>, collectionCapability: Capability<&{StarvingChildren.StarvingChildrenCollectionPublic}>){ 
            pre{ 
    ...
    pub fun createManager(
        ...
        collectionCapability: Capability<
            &{StarvingChildren.StarvingChildrenCollectionPublic}
        >
    ): @Manager{ 
