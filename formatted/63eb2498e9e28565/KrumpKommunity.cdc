...
pub contract KrumpKommunity: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                KrumpKommunity.totalSupply = KrumpKommunity.totalSupply - self.balance
            }
        }
    }
