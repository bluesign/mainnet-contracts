...
pub contract Crash: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Crash.CollectionStoragePath, publicPath: Crash.CollectionPublicPath, providerPath: /private/CrashCollection, publicCollection: Type<&Crash.Collection{Crash.CrashCollectionPublic}>(), publicLinkedType: Type<&Crash.Collection{Crash.CrashCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Crash.Collection{Crash.CrashCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, component: Crash.CrashComponent, royalties: [MetadataViews.Royalty], id: UInt64){ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &Crash.NFT?{ 
        let collection = (getAccount(from).getCapability(Crash.CollectionPublicPath)!).borrow<&Crash.Collection{Crash.CrashCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&Crash.Collection{NonFungibleToken.CollectionPublic, Crash.CrashCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
