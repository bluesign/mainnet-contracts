...
pub contract TeleportCustodyAptos{ 
    ...
    init(){ 
        ...
        self
            .TeleportAdminStoragePath = /storage/teleportCustodyAptosTeleportAdmin
        self
            .TeleportAdminTeleportUserPath = /public/teleportCustodyAptosTeleportUser
        self
            .TeleportAdminTeleportControlPath = /private/teleportCustodyAptosTeleportControl
        self.isFrozen = false
        self.unlocked ={} 
