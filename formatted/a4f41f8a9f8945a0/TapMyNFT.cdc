...
pub contract TapMyNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TapMyNFT.CollectionStoragePath, publicPath: TapMyNFT.CollectionPublicPath, providerPath: /private/TapMyNFTCollection, publicCollection: Type<&TapMyNFT.Collection{TapMyNFT.TapMyNFTCollectionPublic}>(), publicLinkedType: Type<&TapMyNFT.Collection{TapMyNFT.TapMyNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TapMyNFT.Collection{TapMyNFT.TapMyNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, creatorId: String, creatorName: String, createdDateTime: String, location: String, thumbnail: String, royalties: [MetadataViews.Royalty]){ 
    ...
    init(){ 
        ...
        self.account.link<&TapMyNFT.Collection{NonFungibleToken.CollectionPublic, TapMyNFT.TapMyNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
