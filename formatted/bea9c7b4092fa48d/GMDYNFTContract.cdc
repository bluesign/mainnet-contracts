...
pub contract GMDYNFTContract: NonFungibleToken{ 
    ...
    /* Event that is emitted when new NFTs are cradled*/    pub event NewNFTsminted(amount: UInt64)
    
    /* Event that is emitted when an NFT collection is created */    pub event CreateNFTCollection(amount: UInt64, maxNFTs: UInt64)
    ...
    pub resource Collection: CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        /*Function borrow GMDY NFT*/        pub fun borrowGMDYNFT(id: UInt64): &GMDYNFTContract.NFT?{ 
    ...
    pub fun createNFTTemplate(key: AuthAccount, name: String, nftType: String, metadata:{ String: AnyStruct}, thumbnail: String, description: String, amountToCreate: UInt64, maximum: UInt64, collection: Capability<&GMDYNFTContract.Collection{NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic}>): @NFTTemplate{ 
