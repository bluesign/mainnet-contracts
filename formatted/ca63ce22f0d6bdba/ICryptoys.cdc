...
pub contract interface ICryptoys{ 
    ...
    pub resource interface INFT{ 
        ...
        access(account) fun withdrawBucketItem(
            _ key: String,
            _ itemUuid: UInt64
        ): @AnyResource{ICryptoys.INFT}{ 
            pre{ 
                self.owner != nil:
        ...
        pub fun borrowBucketResourcesByKey(_ key: String): &{
            UInt64: AnyResource{ICryptoys.INFT}
        }?{} 
        
        pub fun borrowBucket(): &{
            String:{ 
                UInt64: AnyResource{ICryptoys.INFT}
            }
        }{} 
        
        pub fun borrowBucketItem(
            _ key: String,
            _ itemUuid: UInt64
        ): &AnyResource{INFT}{ 
            post{ 
