...
pub contract Collectible: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun contentID(): String{ 
            return "bafybeiefjy3mgigelxx7ot5sojkpnr2y4mxadlirdkizbows45auaqlyk4"
        }
        ...
        pub fun original(): MetadataViews.IPFSFile{ 
            return MetadataViews.IPFSFile(cid: self.contentID(), path: self.data.itemId.toString().concat(".mp4"))
        }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: self.original(), mediaType: "video/mp4")])
