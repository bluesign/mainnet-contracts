...
pub contract FlowBlockchainhitCoin: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                FlowBlockchainhitCoin.totalSupply = FlowBlockchainhitCoin.totalSupply - self.balance
            }
        }
    }
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(storagePath: FlowBlockchainhitCoin.VaultStoragePath, receiverPath: FlowBlockchainhitCoin.ReceiverPublicPath, metadataPath: FlowBlockchainhitCoin.VaultPublicPath, providerPath: /private/FlowBlockchainhitCoinVault, receiverLinkedType: Type<&Vault{FungibleToken.Receiver}>(), metadataLinkedType: Type<&Vault{FungibleToken.Balance, MetadataViews.Resolver}>(), providerLinkedType: Type<&Vault{FungibleToken.Provider}>(), createEmptyVaultFunction: fun (): @Vault{ 
                        return <-FlowBlockchainhitCoin.createEmptyVault()
                    })
        }
        return nil
    }
