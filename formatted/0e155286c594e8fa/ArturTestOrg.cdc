/* 
Central Smart Contract for ArturTestOrg x Niftory Collectibles
...
pub contract ArturTestOrg: NonFungibleToken{ 
    ...
    pub struct CurrSeriesData{ 
        ...
        init(){ 
            var referencedSeries = (&ArturTestOrg.seriesDatas[ArturTestOrg.currentSeriesID] as &Series?)!
    ...
    pub struct CollectibleItem{ 
        ...
        init(metadata:{ String: String}, featuredArtists: [String]){ 
            ...
            self.collectibleItemID = ArturTestOrg.nextCollectibleItemID
            self.metadata = metadata
            self.featuredArtists = featuredArtists
            
            // Increment the ID so that it isn't used again
            ArturTestOrg.nextCollectibleItemID = ArturTestOrg.nextCollectibleItemID + UInt32(1)
    ...
    pub struct SetData{ 
        ...
        init(setID: UInt32){ 
            pre{ 
                ArturTestOrg.sets[setID] != nil:
                    "Cannot borrow Set: The Set doesn't exist"
            }
            let referencedSet = (&ArturTestOrg.sets[setID] as &Set?)!
    ...
    pub resource Set{ 
        ...
        init(name: String, setIdentityURL: String?, description: String?){ 
            ...
            self.setID = ArturTestOrg.nextSetID
            self.name = name
            self.setIdentityURL = setIdentityURL
            self.description = description
            self.series = ArturTestOrg.seriesDatas[ArturTestOrg.currentSeriesID]!
            self.collectibleItems = []
            self.retired ={} 
            self.locked = false
            self.numberMintedPerCollectibleItem ={} 
            ArturTestOrg.nextSetID = ArturTestOrg.nextSetID + UInt32(1)
        ...
        pub fun addCollectibleItem(collectibleItemID: UInt32){ 
            pre{ 
                ArturTestOrg.collectibleItemDatas[collectibleItemID] != nil:
    ...
    pub resource Admin{ 
        ...
        // and stores it in the CollectibleItems dictionary in the ArturTestOrg smart contract
        //
        ...
        pub fun createCollectibleItem(metadata:{ String: String}, featuredArtists: [String]): UInt32{ 
            ...
            ArturTestOrg.collectibleItemDatas[newID] = newCollectibleItem
            return newID
        }
        
        // createSet creates a new Set resource and stores it
        // in the sets mapping in the ArturTestOrg contract
        //
        ...
        pub fun createSet(name: String, setIdentityURL: String?, description: String?){ 
            ...
            ArturTestOrg.sets[newSet.setID] <-! newSet
        }
        
        // borrowSet returns a reference to a set in the ArturTestOrg
        ...
        pub fun borrowSet(setID: UInt32): &Set{ 
            ...
            return (&ArturTestOrg.sets[setID] as &Set?)!
        }
        ...
        pub fun startNewSeries(name: String?, identityURL: String?): UInt32{ 
            ...
            // by incrementing the ArturTestOrg series number
            let setIDs = ArturTestOrg.sets.keys
            var i: Int = 0
            while i < setIDs.length{ 
                var currSet = SetData(setID: setIDs[i])
                if currSet.series.seriesID == ArturTestOrg.currentSeriesID{ 
                    self.borrowSet(setID: setIDs[i]).retireAll()
                    self.borrowSet(setID: setIDs[i]).lock()
                }
                i = i + 1
            }
            var newSeries = Series(seriesID: ArturTestOrg.currentSeriesID + UInt32(1), name: name, seriesIdentityURL: identityURL)
            ArturTestOrg.currentSeriesID = newSeries.seriesID
            
            //put it in storage
            ArturTestOrg.seriesDatas[ArturTestOrg.currentSeriesID] = newSeries
            emit NewSeriesStarted(newCurrentSeries: ArturTestOrg.currentSeriesID)
            return ArturTestOrg.currentSeriesID
        }
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun getViews(): [Type]{ 
            return [Type<MetadataViews.Display>(), Type<MetadataViews.Royalties>(), Type<MetadataViews.NFTCollectionData>()]
        }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    let receiver = ArturTestOrg.account.getCapability<&AnyResource{FungibleToken.Receiver}>(/public/flowTokenReceiver)
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ArturTestOrg.CollectionStoragePath, publicPath: ArturTestOrg.CollectionPublicPath, providerPath: /private/ArturTestOrgCollection001, publicCollection: Type<&ArturTestOrg.Collection{ArturTestOrg.ArturTestOrgCollectionPublic}>(), publicLinkedType: Type<&ArturTestOrg.Collection{ArturTestOrg.ArturTestOrgCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ArturTestOrg.Collection{ArturTestOrg.ArturTestOrgCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-ArturTestOrg.createEmptyCollection()
                        })
            }
            return nil
        }
        ...
        init(serialNumber: UInt32, collectibleItemID: UInt32, setID: UInt32){ 
            ...
            ArturTestOrg.totalSupply = ArturTestOrg.totalSupply + UInt64(1)
            self.id = ArturTestOrg.totalSupply
    ...
    pub resource interface ArturTestOrgCollectionPublic{ 
        ...
        pub fun borrowCollectible(id: UInt64): &ArturTestOrg.NFT?{ 
    ...
    pub resource Collection: ArturTestOrgCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            ...
            // Cast the deposited token as a ArturTestOrg NFT to make sure
            // it is the correct type
            let token <- token as! @ArturTestOrg.NFT
        ...
        // not any ArturTestOrg specific data. Please use borrowCollectible to 
        ...
        pub fun borrowCollectible(id: UInt64): &ArturTestOrg.NFT?{ 
            if self.ownedNFTs[id] != nil{ 
                ...
                return ref as! &ArturTestOrg.NFT
            } else{ 
                return nil
            }
        }
    ...
    pub fun createEmptyCollection(): @NonFungibleToken.Collection{ 
        return <-create ArturTestOrg.Collection()
    }
    
    // getAllCollectibleItems returns all the collectibleItems in ArturTestOrg
    //
    // Returns: An array of all the collectibleItems that have been created
    pub fun getAllCollectibleItems(): [ArturTestOrg.CollectibleItem]{ 
        return ArturTestOrg.collectibleItemDatas.values
    }
    ...
    pub fun getCollectibleItemMetaDataByField(collectibleItemID: UInt32, field: String): String?{ 
        ...
        if let collectibleItem = ArturTestOrg.collectibleItemDatas[collectibleItemID]{ 
    ...
    pub fun getCollectibleItemsInSet(setID: UInt32): [UInt32]?{ 
        ...
        return ArturTestOrg.sets[setID]?.collectibleItems
    }
    ...
    pub fun isEditionRetired(setID: UInt32, collectibleItemID: UInt32): Bool?{ 
        ...
        if let setToRead <- ArturTestOrg.sets.remove(key: setID){ 
            ...
            ArturTestOrg.sets[setID] <-! setToRead
    ...
    pub fun isSetLocked(setID: UInt32): Bool?{ 
        // Don't force a revert if the setID is invalid
        return ArturTestOrg.sets[setID]?.locked
    }
    ...
    init(){ 
        ...
        self.seriesDatas ={} 
        self.seriesDatas[self.currentSeriesID] = Series(seriesID: ArturTestOrg.currentSeriesID, name: nil, seriesIdentityURL: nil)
        ...
        // initialize paths
        // Set our named paths
        self.CollectionStoragePath = /storage/ArturTestOrgCollection001
        self.CollectionPublicPath = /public/ArturTestOrgCollection001
        self.AdminStoragePath = /storage/ArturTestOrgAdmin005
        
        // Put a new Collection in storage 
        self.account.save<@Collection>(<-create Collection(), to: self.CollectionStoragePath)
        
        // Create a public capability for the Collection
        self.account.link<&{ArturTestOrgCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
