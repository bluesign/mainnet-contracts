...
pub contract PlayTodayNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: PlayTodayNFT.CollectionStoragePath, publicPath: PlayTodayNFT.CollectionPublicPath, providerPath: /private/playTodayNFTCollection, publicCollection: Type<&PlayTodayNFT.Collection{PlayTodayNFT.PlayTodayNFTCollectionPublic}>(), publicLinkedType: Type<&PlayTodayNFT.Collection{PlayTodayNFT.PlayTodayNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&PlayTodayNFT.Collection{PlayTodayNFT.PlayTodayNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, creator: Address, rarity: Rarity, uri: String, name: String, description: String, royalties: [MetadataViews.Royalty]){ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &PlayTodayNFT.NFT?{ 
        let collection = (getAccount(from).getCapability(PlayTodayNFT.CollectionPublicPath)!).borrow<&PlayTodayNFT.Collection{PlayTodayNFT.PlayTodayNFTCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&PlayTodayNFT.Collection{NonFungibleToken.CollectionPublic, PlayTodayNFT.PlayTodayNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
