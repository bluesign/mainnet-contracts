...
pub contract PlayTodayBadgeNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: PlayTodayBadgeNFT.CollectionStoragePath, publicPath: PlayTodayBadgeNFT.CollectionPublicPath, providerPath: /private/playTodayBadgeNFTCollection, publicCollection: Type<&PlayTodayBadgeNFT.Collection{PlayTodayBadgeNFT.PlayTodayBadgeNFTCollectionPublic}>(), publicLinkedType: Type<&PlayTodayBadgeNFT.Collection{PlayTodayBadgeNFT.PlayTodayBadgeNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&PlayTodayBadgeNFT.Collection{PlayTodayBadgeNFT.PlayTodayBadgeNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, creator: Address, uri: String, name: String, description: String, badgeId: UInt64, royalties: [MetadataViews.Royalty]){ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &PlayTodayBadgeNFT.NFT?{ 
        let collection = (getAccount(from).getCapability(PlayTodayBadgeNFT.CollectionPublicPath)!).borrow<&PlayTodayBadgeNFT.Collection{PlayTodayBadgeNFT.PlayTodayBadgeNFTCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&PlayTodayBadgeNFT.Collection{NonFungibleToken.CollectionPublic, PlayTodayBadgeNFT.PlayTodayBadgeNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
