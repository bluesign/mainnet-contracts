...
pub contract KissoNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: KissoNFT.CollectionStoragePath, publicPath: KissoNFT.CollectionPublicPath, providerPath: /private/kissoNFTCollection, publicCollection: Type<&KissoNFT.Collection{KissoNFT.KissoNFTCollectionPublic}>(), publicLinkedType: Type<&KissoNFT.Collection{KissoNFT.KissoNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&KissoNFT.Collection{KissoNFT.KissoNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, lineItemHash: String, orderInfo: OrderInfo, lineItemInfo: LineItemInfo, lineItemVotingWeight: UInt64, royalties: [MetadataViews.Royalty]){ 
            pre{ 
    ...
    pub fun addUpdateArtLibraryVariant(productID: UInt64, variantID: UInt64, thumbnailImg: String, thumbnailImgMimetype: String, ipfsCID: String, ipfsPath: String?, ref: &AdminToken.Token?){ 
    ...
    pub fun removeArtLibraryVariant(productID: UInt64, variantID: UInt64, ref: &AdminToken.Token?){ 
        pre{ 
        ...
        ( // check for authorized adminKissoNFT.artLibrary[productID]!).removeVariant(variantID: variantID)
    }
    
    pub fun removeArtLibraryProduct(productID: UInt64, ref: &AdminToken.Token?){ 
        pre{ 
            KissoNFT.artLibrary[productID] != nil:
                "product does not exist"
        }
    ...
    init(){ 
        ...
        self.account.link<&KissoNFT.Collection{NonFungibleToken.CollectionPublic, KissoNFT.KissoNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
