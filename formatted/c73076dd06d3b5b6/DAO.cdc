...
pub contract DAO{ 
    ...
    pub struct Votes{ 
        ...
        pub fun castVote(nftUUID: UInt64, weight: UInt64, choice: UInt64){ 
            ...
            self.votes.insert(
                key: nftUUID,
                Vote(weight: weight, choice: choice)
            )
        }
    ...
    pub fun castVote(
        ...
        nftCollectionRef: &KissoNFT.Collection{
            KissoNFT.KissoNFTCollectionPrivate,
        ...
        let collectionOwnerVotingWeights:{ UInt64: UInt64} =
            nftCollectionRef.getVotingWeights()
    ...
    pub fun cancelOpenProposal(proposalID: UInt64, ref: &AdminToken.Token?){ 
        ...
        ( // check for authorized adminDAO.proposals[proposalID]!).markCancelledStatus()
    ...
    pub fun addIneligibleAddress(address: Address, ref: &AdminToken.Token?){ 
        pre{ 
    ...
    pub fun removeIneligibleAddress(address: Address, ref: &AdminToken.Token?){ 
        pre{ 
            DAO.ineligible[address] != nil:
