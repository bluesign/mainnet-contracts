...
pub contract BounceToken: FungibleToken{ 
    ...
    init(){ 
        ...
        //
        self.account.link<&{FungibleToken.Receiver}>(self.bounceTokenReceiverPath, target: self.bounceTokenStoragePath)
        
        // Create a public capability to the stored Vault that only exposes
        // the `balance` field through the `Balance` interface
        //
        self.account.link<&BounceToken.Vault{FungibleToken.Balance}>(self.bounceTokenBalancePath, target: self.bounceTokenStoragePath)
