...
pub contract FLOATVerifiers{ 
    ...
    pub struct Timelock: MusicPeaksMembershipToken.IVerifier{ 
    ...
    pub struct Secret: MusicPeaksMembershipToken.IVerifier{ 
    ...
    // delete their FLOATs.
    pub struct Limited: MusicPeaksMembershipToken.IVerifier{ 
        pub var capacity: UInt64
        
        pub fun verify(_ params:{ String: AnyStruct}){ 
            let event = params["event"]! as! &MusicPeaksMembershipToken.FLOATEvent{MusicPeaksMembershipToken.FLOATEventPublic}
    ...
    // from the list.
    pub struct MultipleSecret: MusicPeaksMembershipToken.IVerifier{ 
    ...
    pub struct SecretV2: MusicPeaksMembershipToken.IVerifier{ 
