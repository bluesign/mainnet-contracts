...
pub contract RelicContract: NonFungibleToken{ 
    ...
    pub resource Relic: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun updateVideoURL(_newAssetVideoURL: String){ 
            self.assetVideoURL = _newAssetVideoURL
        }
        
        pub fun updateAssetURL(_newAssetImageURL: String){ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: RelicContract.CollectionStoragePath, publicPath: RelicContract.CollectionPublicPath, providerPath: /private/RelicContractCollection, publicCollection: Type<&RelicContract.Collection{NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&RelicContract.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&RelicContract.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource RelicMinter{ 
        pub fun mintRelic(recipient: &{NonFungibleToken.CollectionPublic}, _rarity: String, _category: String, _type: String, _artistName: String, _title: String, _description: String, _mintDate: String, _assetVideoURL: String, _assetImageURL: String, _musicURL: String, _artworkURL: String, _royalties: [MetadataViews.Royalty]){ 
            switch _rarity{ 
                case "Bronze":
                    if RelicContract.bronzeSupply < RelicContract.bronzeMaxSupply{ 
                        recipient.deposit(token: <-create RelicContract.Relic(initID: RelicContract.totalSupply, rarity: _rarity, category: _category, type: _type, artistName: _artistName, title: _title, description: _description, serialNumber: RelicContract.serialCounter + 1, edition: RelicContract.bronzeSupply + 1, editionSize: RelicContract.bronzeMaxSupply, mintDate: _mintDate, assetVideoURL: _assetVideoURL, assetImageURL: _assetImageURL, musicURL: _musicURL, artworkURL: _artworkURL, royalties: _royalties))
                ...
                case "Silver":
                    if RelicContract.silverSupply < RelicContract.silverMaxSupply{ 
                        recipient.deposit(token: <-create RelicContract.Relic(initID: RelicContract.totalSupply, rarity: _rarity, category: _category, type: _type, artistName: _artistName, title: _title, description: _description, serialNumber: RelicContract.serialCounter + 1, edition: RelicContract.silverSupply + 1, editionSize: RelicContract.silverMaxSupply, mintDate: _mintDate, assetVideoURL: _assetVideoURL, assetImageURL: _assetImageURL, musicURL: _musicURL, artworkURL: _artworkURL, royalties: _royalties))
                ...
                case "Gold":
                    if RelicContract.goldSupply < RelicContract.goldMaxSupply{ 
                        recipient.deposit(token: <-create RelicContract.Relic(initID: RelicContract.totalSupply, rarity: _rarity, category: _category, type: _type, artistName: _artistName, title: _title, description: _description, serialNumber: RelicContract.serialCounter + 1, edition: RelicContract.goldSupply + 1, editionSize: RelicContract.goldMaxSupply, mintDate: _mintDate, assetVideoURL: _assetVideoURL, assetImageURL: _assetImageURL, musicURL: _musicURL, artworkURL: _artworkURL, royalties: _royalties))
                ...
                case "Platinum":
                    if RelicContract.platinumSupply < RelicContract.platinumMaxSupply{ 
                        recipient.deposit(token: <-create RelicContract.Relic(initID: RelicContract.totalSupply, rarity: _rarity, category: _category, type: _type, artistName: _artistName, title: _title, description: _description, serialNumber: RelicContract.serialCounter + 1, edition: RelicContract.platinumSupply + 1, editionSize: RelicContract.platinumMaxSupply, mintDate: _mintDate, assetVideoURL: _assetVideoURL, assetImageURL: _assetImageURL, musicURL: _musicURL, artworkURL: _artworkURL, royalties: _royalties))
                ...
                case "Diamond":
                    if RelicContract.diamondSupply < RelicContract.diamondMaxSupply{ 
                        recipient.deposit(token: <-create RelicContract.Relic(initID: RelicContract.totalSupply, rarity: _rarity, category: _category, type: _type, artistName: _artistName, title: _title, description: _description, serialNumber: RelicContract.serialCounter + 1, edition: RelicContract.diamondSupply + 1, editionSize: RelicContract.diamondMaxSupply, mintDate: _mintDate, assetVideoURL: _assetVideoURL, assetImageURL: _assetImageURL, musicURL: _musicURL, artworkURL: _artworkURL, royalties: _royalties))
    ...
    init(){ 
        ...
        self.account.link<&RelicContract.Collection{NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, RelicCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
