...
pub contract LampionsPack: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&LampionsPack.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, LampionsPack.CollectionPublic, MetadataViews.ResolverCollection}>(LampionsPack.CollectionPublicPath, target: LampionsPack.CollectionStoragePath)
