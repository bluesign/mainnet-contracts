...
pub contract BarelyABear: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.HTTPFile>():
                    return MetadataViews.HTTPFile(BarelyABear.getSetMetadata(setId: self.setId).httpFile)
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(self.id)
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(BarelyABear.getSetMetadata(setId: self.setId).externalUrl)
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: BarelyABear.CollectionStoragePath, publicPath: BarelyABear.CollectionPublicPath, providerPath: /private/BarelyABearCollection, publicCollection: Type<&BarelyABear.Collection{BarelyABear.FlickplaySeriesCollectionPublic}>(), publicLinkedType: Type<&BarelyABear.Collection{BarelyABear.FlickplaySeriesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&BarelyABear.Collection{BarelyABear.FlickplaySeriesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Royalties>():
                    let royaltyReceiver: Capability<&{FungibleToken.Receiver}> = getAccount(BarelyABear.royaltyAddress).getCapability<&AnyResource{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath())
                    return MetadataViews.Royalties(royalties: [MetadataViews.Royalty(receiver: royaltyReceiver, cut: BarelyABear.royaltyCut, description: "Flickplay Royalty")])
    ...
    pub fun fetch(_ from: Address, id: UInt64): &BarelyABear.NFT?{ 
        let collection = getAccount(from).getCapability(BarelyABear.CollectionPublicPath).borrow<&BarelyABear.Collection{BarelyABear.FlickplaySeriesCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&BarelyABear.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
