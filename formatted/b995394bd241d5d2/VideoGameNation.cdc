...
pub contract VideoGameNation: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                VideoGameNation.totalSupply = VideoGameNation.totalSupply - self.balance
            }
        }
    }
