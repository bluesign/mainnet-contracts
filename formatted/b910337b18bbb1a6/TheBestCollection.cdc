...
pub contract TheBestCollection: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TheBestCollection.CollectionStoragePath, publicPath: TheBestCollection.CollectionPublicPath, providerPath: /private/TheBestCollectionCollection, publicCollection: Type<&TheBestCollection.Collection{TheBestCollection.TheBestCollectionCollectionPublic}>(), publicLinkedType: Type<&TheBestCollection.Collection{TheBestCollection.TheBestCollectionCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TheBestCollection.Collection{TheBestCollection.TheBestCollectionCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&TheBestCollection.Collection{NonFungibleToken.CollectionPublic, TheBestCollection.TheBestCollectionCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
