...
pub contract Usher: NonFungibleToken{ 
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            case Type<MetadataViews.NFTCollectionData>():
                return MetadataViews.NFTCollectionData(storagePath: Usher.CollectionStoragePath, publicPath: Usher.CollectionPublicPath, providerPath: /private/exampleNFTCollection, publicCollection: Type<&Usher.Collection{Usher.UsherCollectionPublic}>(), publicLinkedType: Type<&Usher.Collection{Usher.UsherCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Usher.Collection{Usher.UsherCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&Usher.Collection{NonFungibleToken.CollectionPublic, Usher.UsherCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
