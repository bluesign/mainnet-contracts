...
pub contract ThaSup: NonFungibleToken{ 
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            case Type<MetadataViews.NFTCollectionData>():
                return MetadataViews.NFTCollectionData(storagePath: ThaSup.CollectionStoragePath, publicPath: ThaSup.CollectionPublicPath, providerPath: /private/exampleNFTCollection, publicCollection: Type<&ThaSup.Collection{ThaSup.ThaSupCollectionPublic}>(), publicLinkedType: Type<&ThaSup.Collection{ThaSup.ThaSupCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ThaSup.Collection{ThaSup.ThaSupCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&ThaSup.Collection{NonFungibleToken.CollectionPublic, ThaSup.ThaSupCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
