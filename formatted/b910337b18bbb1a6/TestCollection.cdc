...
pub contract TestCollection: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TestCollection.CollectionStoragePath, publicPath: TestCollection.CollectionPublicPath, providerPath: /private/TestCollectionCollection, publicCollection: Type<&TestCollection.Collection{TestCollection.TestCollectionCollectionPublic}>(), publicLinkedType: Type<&TestCollection.Collection{TestCollection.TestCollectionCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TestCollection.Collection{TestCollection.TestCollectionCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&TestCollection.Collection{NonFungibleToken.CollectionPublic, TestCollection.TestCollectionCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
