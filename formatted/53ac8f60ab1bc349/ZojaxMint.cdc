...
pub contract ZojaxMint: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&ZojaxMint.Collection{NonFungibleToken.CollectionPublic, ZojaxMint.ZojaxMintCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
