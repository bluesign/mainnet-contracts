...
pub contract ZojaxMintsV2: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ZojaxMintsV2.CollectionStoragePath, publicPath: ZojaxMintsV2.CollectionPublicPath, providerPath: /private/zojaxMintsV2Collection, publicCollection: Type<&ZojaxMintsV2.Collection{ZojaxMintsV2.ZojaxMintsCollectionPublic}>(), publicLinkedType: Type<&ZojaxMintsV2.Collection{ZojaxMintsV2.ZojaxMintsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ZojaxMintsV2.Collection{ZojaxMintsV2.ZojaxMintsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&ZojaxMintsV2.Collection{NonFungibleToken.CollectionPublic, ZojaxMintsV2.ZojaxMintsCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
