...
pub contract ZojaxMints: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ZojaxMints.CollectionStoragePath, publicPath: ZojaxMints.CollectionPublicPath, providerPath: /private/zojaxMintsCollection, publicCollection: Type<&ZojaxMints.Collection{ZojaxMints.ZojaxMintsCollectionPublic}>(), publicLinkedType: Type<&ZojaxMints.Collection{ZojaxMints.ZojaxMintsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ZojaxMints.Collection{ZojaxMints.ZojaxMintsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&ZojaxMints.Collection{NonFungibleToken.CollectionPublic, ZojaxMints.ZojaxMintsCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
