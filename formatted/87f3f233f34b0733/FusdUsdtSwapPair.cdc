...
pub contract FusdUsdtSwapPair: FungibleToken{ 
    ...
    pub fun createEmptyTokenBundle(): @FusdUsdtSwapPair.TokenBundle{ 
        return <-create TokenBundle(fromToken1: <-(FUSD.createEmptyVault() as! @FUSD.Vault), fromToken2: <-(TeleportedTetherToken.createEmptyVault() as! @TeleportedTetherToken.Vault))
    }
