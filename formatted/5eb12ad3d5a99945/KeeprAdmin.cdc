...
pub contract KeeprAdmin{ 
    ...
    pub resource interface AdminStorefrontManagerPublic{ 
        pub fun addCapability(
            _ cap: Capability<&KeeprNFTStorefront.Storefront>,
            owner: Address
        ){} 
    }
    ...
    pub resource AdminStorefront{ 
        ...
        pub let storefrontCapability: Capability<&KeeprNFTStorefront.Storefront>
        
        init(
            account: Address,
            storefrontCapability: Capability<&KeeprNFTStorefront.Storefront>
        ){ 
    ...
    pub resource AdminStorefrontManager: AdminStorefrontManagerPublic{ 
        priv var storefronts: @{Address: AdminStorefront}
