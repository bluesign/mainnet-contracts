...
pub contract KeeprItems: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: KeeprItems.CollectionStoragePath, publicPath: KeeprItems.CollectionPublicPath, providerPath: /private/KittyItemsCollection, publicCollection: Type<&KeeprItems.Collection{KeeprItems.KeeprItemsCollectionPublic}>(), publicLinkedType: Type<&KeeprItems.Collection{KeeprItems.KeeprItemsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&KeeprItems.Collection{KeeprItems.KeeprItemsCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}, cid: String, path: String, thumbCid: String, thumbPath: String, name: String, description: String, docId: String, cardBackCid: String, cardBackPath: String){ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &KeeprItems.NFT?{ 
        let collection = (getAccount(from).getCapability(KeeprItems.CollectionPublicPath)!).borrow<&KeeprItems.Collection{KeeprItems.KeeprItemsCollectionPublic}>() ?? panic("Couldn't get collection")
