...
pub contract GameEngine{ 
    ...
    pub struct GameTickOutput{ 
        ...
        init(
            ...
            gameboard:{ 
                Int:{ 
                    Int: AnyStruct{GameEngine.GameObject}?
                }
            },
            state:{ 
                String: String
    ...
    pub struct GameBoard{ 
        ...
        priv fun updateBoard(_ gameObject:{ GameObject}, _ isRemoval: Bool){ 
    ...
    pub struct interface Level{ 
        ...
        pub fun parseGameObjectsFromMaps(_ map: [{String: String}]): [{
            GameObject}?
        ]{} 
    ...
    pub fun convertGameObjectsToStrMaps(
        _ gameObjects:{ 
            UInt64:{ GameEngine.GameObject}
        }
    ): [{
    ...
    pub fun startLevel(
        ...
        let gameLevels: &GameLevels =
            getAccount(contractAddress).contracts.borrow<&GameLevels>(
                name: contractName
            )
