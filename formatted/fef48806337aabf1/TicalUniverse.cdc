        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TicalUniverse.CollectionStoragePath, publicPath: TicalUniverse.CollectionPublicPath, providerPath: TicalUniverse.CollectionPrivatePath, publicCollection: Type<&TicalUniverse.Collection{TicalUniverse.TicalUniverseCollectionPublic}>(), publicLinkedType: Type<&TicalUniverse.Collection{TicalUniverse.TicalUniverseCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&TicalUniverse.Collection{TicalUniverse.TicalUniverseCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
