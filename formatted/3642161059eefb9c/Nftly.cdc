/** * SPDX-License-Identifier: MIT */import NonFungibleToken from "../0x1d7e57aa55817448/NonFungibleToken.cdc"
...
pub contract Nftly: NonFungibleToken{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &Nftly.NFT?{ 
        let collection = (getAccount(from).getCapability(Nftly.CollectionPublicPath)!).borrow<&Nftly.Collection{Nftly.NftlyCollectionPublic}>() ?? panic("Couldn't get collection")
