...
pub contract Controller{ 
    ...
    pub resource interface SpecialCapability{ 
        ...
        pub fun updateFeeSplitterDetail(
            _ tokenId: String,
            _ feeSplitterDetail:{ 
                Address: FeeStructure
            }
    ...
    pub resource Admin: SpecialCapability{ 
        pub fun registerToken(_ symbol: String, _ maxSupply: UFix64, _ artist: Address, _ tokenStoragePath: StoragePath, _ tokenPublicPath: PublicPath, _ socialMinterStoragePath: StoragePath, _ socialMinterPublicPath: PublicPath, _ socialBurnerStoragePath: StoragePath, _ socialBurnerPublicPath: PublicPath){ 
            pre{ 
                symbol != nil:
    ...
    pub resource SocialTokenResource:
        SocialTokenResourcePublic,
        UserSpecialCapability{
    ...
    init(){ 
        ...
        self
            .SocialTokenResourceStoragePath = /storage/ControllerSocialTokenResource
        self.SpecialCapabilityPrivatePath = /private/ControllerSpecialCapability
        self
            .SocialTokenResourcePrivatePath = /private/ControllerSocialTokenResourcePrivate
