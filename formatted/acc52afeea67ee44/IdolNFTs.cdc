...
pub contract IdolNFTs: NonFungibleToken{ 
    ...
    pub resource interface IdolNFTsCollectionPublic{ 
        ...
        pub fun borrowIdol(id: UInt64): &IdolNFTs.NFT?{ 
        ...
        pub fun notifyPrice(_price: String){} 
    }
    
    // Requirement for the the concrete resource type
    // to be declared in the implementing contract
    //
    pub resource Collection: IdolNFTsCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic{ 
    ...
    pub fun createEmptyCollection(): @IdolNFTs.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{IdolNFTs.IdolNFTsCollectionPublic}, typeID: UInt64, urlData: String, metadata:{ String: String}){ 
    ...
    //
    pub fun fetch(_ from: Address, itemID: UInt64): &IdolNFTs.NFT?{ 
        let collection = getAccount(from).getCapability(IdolNFTs.CollectionPublicPath).borrow<&IdolNFTs.Collection{IdolNFTs.IdolNFTsCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&{IdolNFTs.IdolNFTsCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
