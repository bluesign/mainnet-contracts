...
// NFT for Baseball!
//
pub contract DiamondDreamCards: NonFungibleToken{ 
    ...
    pub resource interface DiamondDreamCardsCollectionPublic{ 
        ...
        pub fun borrowDiamondDreamCard(id: UInt64): &DiamondDreamCards.NFT?{ 
    ...
    //
    pub resource Collection: DiamondDreamCardsCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, initMeta:{ String: String}){ 
    ...
    //
    pub fun fetch(_ from: Address, itemID: UInt64): &DiamondDreamCards.NFT?{ 
        let collection = (getAccount(from).getCapability(DiamondDreamCards.CollectionPublicPath)!).borrow<&DiamondDreamCards.Collection{DiamondDreamCards.DiamondDreamCardsCollectionPublic}>() ?? panic("Couldn't get collection")
