...
pub contract Shard: NonFungibleToken{ 
    ...
    pub resource Admin{ 
        ...
        pub fun mintNFT(recipient: &{Shard.ShardCollectionPublic}, clipID: UInt32){ 
        ...
        pub fun batchMintNFT(recipient: &{Shard.ShardCollectionPublic}, clipID: UInt32, quantity: UInt64){ 
            var i: UInt64 = 0
            while i < quantity{ 
    ...
    init(){ 
        ...
        self.account.link<&{Shard.ShardCollectionPublic}>(/public/EternalShardCollection, target: /storage/EternalShardCollection)
