...
pub contract SpaceTrade{ 
    ...
    pub resource interface BidCollectionPublic{ 
        ...
        pub fun borrowBidDetails(id: UInt64): &SpaceTradeBid.Bid{
            SpaceTradeBid.BidDetails
        }{} 
        
        pub fun borrowBidUsingAccessKey(
            bidKey: &BidAccessKey
        ): &SpaceTradeBid.Bid{
            SpaceTradeBid.BidDetails,
            SpaceTradeBid.BidAccept
        }{} 
