...
pub contract SpaceTradeAssetCatalog{ 
    ...
    pub resource Manager{ 
        pub fun upsertNFT(_ nftCollection: NFTCollectionMetadata){ 
            SpaceTradeAssetCatalog.nfts.insert(
                key: nftCollection.identifier,
                nftCollection
            )
        }
        ...
        pub fun toggleSupportedFT(_ tokenKey: String, _ supported: Bool){ 
            ...
            let ref =
                &SpaceTradeAssetCatalog.fts[tokenKey]!
                as
    ...
    pub fun getNFTCollectionMetadatas(_ offset: Int, _ limit: Int):{ 
        String: NFTCollectionMetadata
    }{ 
    ...
    pub fun getNFTCollectionMetadata(
        _ identifier: String
    ): NFTCollectionMetadata?{ 
        return self.nfts[identifier]
        ?? self.getNFTCollectionMetadataFromOfficialCatalog(identifier)
    }
    ...
    pub fun getNFTCollectionMetadataFromOfficialCatalog(
        _ identifier: String
    ): NFTCollectionMetadata?{ 
        if let collectionFromOfficialCatalog =
            ...
            return NFTCollectionMetadata(
                ...
                publicPath: collectionFromOfficialCatalog.collectionData
                    .publicPath,
                storagePath: collectionFromOfficialCatalog.collectionData
                    .storagePath,
                privatePath: collectionFromOfficialCatalog.collectionData
                    .privatePath,
                nftType: collectionFromOfficialCatalog.nftType,
                publicLinkedType: collectionFromOfficialCatalog.collectionData
                    .publicLinkedType,
                privateLinkedType: collectionFromOfficialCatalog.collectionData
                    .privateLinkedType,
                supported: true
            )
        }
