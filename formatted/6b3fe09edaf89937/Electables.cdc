...
pub contract Electables: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv var attributes:{ String: String}
        
        priv var data:{ String: String}
    ...
    pub resource NFTMinter{ 
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, electableType: String, name: String, description: String, thumbnail: String, attributes:{ String: String}, data:{ String: String}){ 
