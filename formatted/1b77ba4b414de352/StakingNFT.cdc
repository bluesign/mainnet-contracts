...
pub contract StakingNFT{ 
    ...
    init(){ 
        ...
        self
            .CollectionStoragePath = /storage/increment_nft_stakingCollectionStorage
        self
            .CollectionPublicPath = /public/increment_nft_stakingCollectionPublic
        self
            .CollectionPrivatePath = /private/increment_nft_stakingCollectionPrivate
        ...
        self
            .UserCertificateStoragePath = /storage/increment_nft_stakingUserCertificate
        self
            .UserCertificatePrivatePath = /private/increment_nft_stakingUserCertificate
        self.poolCount = 0
    ...
    pub struct interface INFTVerifier{ 
        ...
        pub fun verify(
            nftRef: auth &NonFungibleToken.NFT,
            extraParams:{ 
                String: AnyStruct
            }
        ): Bool{} 
    ...
    pub resource interface PoolPublic{ 
        ...
        pub fun unstake(
            userCertificateCap: Capability<&UserCertificate>,
            tokenId: UInt64
    ...
    pub resource Pool: PoolPublic{ 
        ...
        priv let verifiers: [{INFTVerifier}]
        
        // Collection for NFT staking
        priv let stakingNFTCollection: @NonFungibleToken.Collection
        ...
        priv let extraParams:{ String: AnyStruct}
    ...
    pub fun updatePool(pid: UInt64){ 
        let collectionCap =
            StakingNFT.account.getCapability<
    ...
    pub fun getNFTType(collectionIdentifier: String): String{ 
        return collectionIdentifier.slice(
            from: 0,
            upTo: collectionIdentifier.length - 11
        )
    }
}
