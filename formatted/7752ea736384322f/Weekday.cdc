...
pub contract Weekday:
    ...
    pub resource NFT:
        ...
        pub fun getFullName(): String{ 
            return ((Weekday.nftMetadata[self.nftMetadataId]!).name!).concat(
                " #".concat(self.editionNumber.toString())
            )
        }
        ...
        pub fun getDisplay(): MetadataViews.Display{ 
            return MetadataViews.Display(
                ...
                description: (Weekday.nftMetadata[self.nftMetadataId]!)
                    .description,
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(
                ...
                publicCollection: Type<
                    &Weekday.Collection{
                        Weekday.WeekdayCollectionPublic,
            ...
            switch view{ 
                case Type<TheFabricantMetadataViewsV2.TFNFTIdentifierV1>():
                    return TheFabricantMetadataViewsV2.TFNFTIdentifierV1(
                        ...
                        id: self.id,
                        name: self.getFullName(),
                        collection: (Weekday.nftMetadata[self.nftMetadataId]!)
                            .collection,
                ...
                case Type<TheFabricantMetadataViewsV2.TFNFTSimpleView>():
                    return TheFabricantMetadataViewsV2.TFNFTSimpleView(
                        ...
                        externalURL: (Weekday.nftMetadata[self.id]!)
                            .externalURL,
                        rarity: self.getRarity(),
                        traits: self.getTraits(),
                        characteristics: self.getCharacteristics(),
                        coCreatable: (Weekday.nftMetadata[self.id]!)
                            .coCreatable,
                        ...
                        originalRecipient: self.originalRecipient,
                        royalties: (Weekday.nftMetadata[self.id]!).royalties,
                        royaltiesTFMarketplace: (Weekday.nftMetadata[self.id]!)
    ...
    pub resource Admin{ 
        ...
        pub fun distributeDirectlyViaAccessList(
            ...
            let publicMinterCap =
                getAccount((self.owner!).address).getCapability(publicPath)
                    .borrow<&Weekday.PublicMinter{Weekday.Minter}>()
                ?? panic(
            ...
            emit ItemMintedAndTransferred(
                ...
                description: (Weekday.nftMetadata[nft.nftMetadataId]!)
                    .description,
                collection: (Weekday.nftMetadata[nft.nftMetadataId]!)
                    .collection,
                editionNumber: nft.editionNumber,
        ...
        pub fun createPublicMinter(
            ...
            let publicMinter: @Weekday.PublicMinter <-
                create PublicMinter(
                    name: name,
                    description: description,
                    collection: collection,
            ...
            Weekday.account.link<&PublicMinter{Minter}>(
        ...
        pub fun revealTraits(
            ...
            let nftMetadata =
                Weekday.nftMetadata[nftMetadataId]!
                as!
                Weekday.RevealableMetadata
    ...
    pub resource PublicMinter:
        ...
        init(
            ...
            let pathString =
                "TheFabricantNFTPublicMinter_Weekday_".concat(
                    self.uuid.toString()
                )
    ...
    access(contract) fun createNftMetadata(
        ...
        switch variantId{ 
            case 1:
                ...
                metadata ={ 
                        "mainImage":
                        (Weekday.baseTokenURI!).concat("/DarkStalactite.png"),
                        "video":
                        (Weekday.baseTokenURI!).concat("/DarkStalactite.mp4")
                    }
            case 2:
                ...
                metadata ={ 
                        "mainImage":
                        (Weekday.baseTokenURI!).concat("/LightStalactite.png"),
                        "video":
                        (Weekday.baseTokenURI!).concat("/LightStalactite.mp4")
                    }
        }
        let mD =
            RevealableMetadata(
    ...
    init(){ 
        ...
        self
            .WeekdayCollectionStoragePath = /storage/WeekdayCollectionStoragePath
        ...
        self
            .WeekdayPublicMinterStoragePath = /storage/WeekdayPublicMinterStoragePath
        self
            .WeekdayPublicMinterPublicPath = /public/WeekdayPublicMinterPublicPath
        self.account.save(
            <-create Admin(adminAddress: self.account.address),
            to: self.WeekdayAdminStoragePath
        )
