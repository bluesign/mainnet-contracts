...
pub contract HighsnobietyNotInParis:
    NonFungibleToken,
    ...
    pub let HighsnobietyNotInParisCollectionStoragePath: StoragePath
    
    pub let HighsnobietyNotInParisCollectionPublicPath: PublicPath
    
    pub let HighsnobietyNotInParisProviderStoragePath: PrivatePath
    
    pub let HighsnobietyNotInParisPublicMinterStoragePath: StoragePath
    
    pub let HighsnobietyNotInParisAdminStoragePath: StoragePath
    
    pub let HighsnobietyNotInParisPublicMinterPublicPath: PublicPath
    ...
    pub resource NFT:
        ...
        pub fun getFullName(): String{ 
            return (
                (HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!).name!
            ).concat(" #".concat(self.editionNumber.toString()))
        }
        
        // NOTE: This is important for Edition view
        pub fun getEditionName(): String{ 
            return (HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!)
                .collection
        }
        ...
        pub fun getEditions(): MetadataViews.Editions{ 
            ...
            let edition =
                MetadataViews.Edition(
                    name: (
                        HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!
                    ).collection,
                    number: self.editionNumber,
                    max: HighsnobietyNotInParis.maxSupply
                )
        ...
        pub fun getRevealableTraits():{ String: Bool}?{ 
            return (HighsnobietyNotInParis.nftMetadata[self.id]!)
                .getRevealableTraits()
        }
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(
                storagePath: HighsnobietyNotInParis
                    .HighsnobietyNotInParisCollectionStoragePath,
                publicPath: HighsnobietyNotInParis
                    .HighsnobietyNotInParisCollectionPublicPath,
                providerPath: HighsnobietyNotInParis
                    .HighsnobietyNotInParisProviderStoragePath,
                publicCollection: Type<
                    &HighsnobietyNotInParis.Collection{
                        HighsnobietyNotInParis.HighsnobietyNotInParisCollectionPublic,
                ...
                providerLinkedType: Type<
                    &HighsnobietyNotInParis.Collection{
                        ...
                        NonFungibleToken.CollectionPublic,
                        MetadataViews.ResolverCollection,
                        HighsnobietyNotInParisCollectionPublic
                    }
                >(),
                createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                    return <-HighsnobietyNotInParis.createEmptyCollection()
                }
            )
        }
            ...
            let squareImage =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(
                        url: "https://highsnobiety-collection-display.s3.eu-central-1.amazonaws.com/images/HS_squareImage.png"
                    ),
                    mediaType: "image/png"
                )
            let bannerImage =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(
                        url: "https://highsnobiety-collection-display.s3.eu-central-1.amazonaws.com/images/HS_bannerImage.png"
                    ),
                    mediaType: "image/png"
                )
            return MetadataViews.NFTCollectionDisplay(
                name: self.getEditionName(),
                description: "Not in Paris is the most extensive and impactful flagship event in Highsnobiety\u{2019}s calendar and is a celebration of all things fashion, culture and tech. For the Not in Paris 2023 edition, The Fabricant has created a series of digital fashion collectibles in collaboration with Highsnobiety.",
                externalURL: (HighsnobietyNotInParis.nftMetadata[self.id]!)
                    .externalURL,
        ...
        pub fun getNFTView(): MetadataViews.NFTView{ 
            return MetadataViews.NFTView(
                ...
                royalties: (HighsnobietyNotInParis.nftMetadata[self.id]!)
                    .royalties,
            ...
            switch view{ 
                case Type<TheFabricantMetadataViewsV2.TFNFTIdentifierV1>():
                    return TheFabricantMetadataViewsV2.TFNFTIdentifierV1(
                        ...
                        name: self.getFullName(),
                        collection: (
                            HighsnobietyNotInParis.nftMetadata[
                                self.nftMetadataId
                            ]!
                        ).collection,
                ...
                case Type<TheFabricantMetadataViewsV2.TFNFTSimpleView>():
                    return TheFabricantMetadataViewsV2.TFNFTSimpleView(
                        ...
                        collectionId: HighsnobietyNotInParis.collectionId!,
                        metadata: self.getMetadata(),
                        media: self.getMedias(),
                        images: self.getImages(),
                        videos: self.getVideos(),
                        externalURL: (
                            HighsnobietyNotInParis.nftMetadata[self.id]!
                        ).externalURL,
        ...
        init(originalRecipient: Address, license: MetadataViews.License?){ 
            assert(
                HighsnobietyNotInParis.collectionId != nil,
                message: "Ensure that Admin has set collectionId in the contract"
            )
            HighsnobietyNotInParis.totalSupply = HighsnobietyNotInParis
                    .totalSupply
                + 1
        ...
        destroy(){ 
            emit ItemDestroyed(
                uuid: self.uuid,
                id: self.id,
                name: (HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!)
                    .name,
                description: (
                    HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!
                ).description,
    ...
    pub resource interface HighsnobietyNotInParisCollectionPublic{ 
        pub fun borrowHighsnobietyNotInParis(
            id: UInt64
        ): &HighsnobietyNotInParis.NFT{HighsnobietyNotInParis.PublicNFT}?{} 
    ...
    pub resource Admin{ 
        ...
        pub fun distributeDirectlyViaAccessList(
            ...
            let publicMinterCap =
                getAccount((self.owner!).address).getCapability(publicPath)
                    .borrow<
                    &HighsnobietyNotInParis.PublicMinter{
                        HighsnobietyNotInParis.Minter
                    }
                >()
                ?? panic(
            ...
            HighsnobietyNotInParis.createNftMetadata(
                id: nft.id,
                nftUuid: nft.uuid,
                variantId: variantId,
                name: name!,
            ...
            emit ItemMintedAndTransferred(
                uuid: nft.uuid,
                id: nft.id,
                name: (HighsnobietyNotInParis.nftMetadata[nft.nftMetadataId]!)
                    .name,
                description: (
                    HighsnobietyNotInParis.nftMetadata[nft.nftMetadataId]!
                ).description,
                collection: (
                    HighsnobietyNotInParis.nftMetadata[nft.nftMetadataId]!
                ).collection,
            ...
            if HighsnobietyNotInParis.addressMintCount[
                (receiver.owner!).address
            ]
            != nil{ 
                HighsnobietyNotInParis.addressMintCount[
                    (receiver.owner!).address
                ] = HighsnobietyNotInParis.addressMintCount[
                        (receiver.owner!).address
                    ]!
        ...
        pub fun createPublicMinter(
            ...
            let publicMinter: @HighsnobietyNotInParis.PublicMinter <-
                create PublicMinter(
                    name: name,
                    description: description,
                    collection: collection,
            ...
            HighsnobietyNotInParis.account.save(
                <-publicMinter,
                to: publicMinterStoragePath!
            )
            HighsnobietyNotInParis.account.link<&PublicMinter{Minter}>(
        ...
        pub fun revealTraits(
            ...
            let nftMetadata =
                HighsnobietyNotInParis.nftMetadata[nftMetadataId]!
                as!
                HighsnobietyNotInParis.RevealableMetadata
    ...
    pub resource PublicMinter:
        ...
        pub fun mintUsingAccessList(
            ...
            ((              // Deposit has to occur outside of above if statement as resource must be moved or destroyed
              HighsnobietyNotInParis.paymentReceiverCap!).borrow()!).deposit(
                from: <-payment
            )
            let nft <-
                create NFT(
        ...
        init(
            ...
            let pathString =
                "TheFabricantNFTPublicMinter_HighsnobietyNotInParis_".concat(
                    self.uuid.toString()
                )
    ...
    access(contract) fun createNftMetadata(
        ...
        switch variantId{ 
            case 1:
                ...
                metadata ={ 
                        "mainImage":
                        (HighsnobietyNotInParis.baseTokenURI!).concat(
                            "/EiffelTowerPursuit.png"
                        ),
                        "video":
                        (HighsnobietyNotInParis.baseTokenURI!).concat(
                            "/EiffelTowerPursuit.mp4"
                        )
                    }
            case 2:
    ...
    init(){ 
        ...
        self
            .HighsnobietyNotInParisCollectionStoragePath = /storage/HighsnobietyNotInParisCollectionStoragePath
        self
            .HighsnobietyNotInParisCollectionPublicPath = /public/HighsnobietyNotInParisCollectionPublicPath
        self
            .HighsnobietyNotInParisProviderStoragePath = /private/HighsnobietyNotInParisProviderStoragePath
        self
            .HighsnobietyNotInParisAdminStoragePath = /storage/HighsnobietyNotInParisAdminStoragePath
        self
            .HighsnobietyNotInParisPublicMinterStoragePath = /storage/HighsnobietyNotInParisPublicMinterStoragePath
        self
            .HighsnobietyNotInParisPublicMinterPublicPath = /public/HighsnobietyNotInParisPublicMinterPublicPath
        self.account.save(
            <-create Admin(adminAddress: self.account.address),
            to: self.HighsnobietyNotInParisAdminStoragePath
        )
