...
pub contract TheFabricantXXories:
    NonFungibleToken,
    ...
    access(contract) var nftMetadata:{ 
        UInt64: AnyStruct{Revealable.RevealableMetadata}
    }
    ...
    pub resource NFT:
        ...
        pub fun getFullName(): String{ 
            return (
                (TheFabricantXXories.nftMetadata[self.nftMetadataId]!).name!
            ).concat(" #".concat(self.editionNumber.toString()))
        }
        
        // NOTE: This is important for Edition view
        pub fun getEditionName(): String{ 
            return (TheFabricantXXories.nftMetadata[self.nftMetadataId]!)
                .collection
        }
        ...
        pub fun getEditions(): MetadataViews.Editions{ 
            ...
            let edition =
                MetadataViews.Edition(
                    name: (TheFabricantXXories.nftMetadata[self.nftMetadataId]!)
                        .collection,
        ...
        pub fun getRarity(): MetadataViews.Rarity?{ 
            return MetadataViews.Rarity(
                score: TheFabricantXXories.nftMetadata[self.nftMetadataId]
                    ?.rarity,
                // NOTE: 100.0 means it is represented as a percentage.
                max: 100.0,
                description: TheFabricantXXories.nftMetadata[self.nftMetadataId]
                    ?.rarityDescription
            )
        }
        ...
        pub fun getRevealableTraits():{ String: Bool}?{ 
            return (TheFabricantXXories.nftMetadata[self.id]!)
                .getRevealableTraits()
        }
        ...
        pub fun getDisplay(): MetadataViews.Display{ 
            return MetadataViews.Display(
                ...
                description: (
                    TheFabricantXXories.nftMetadata[self.nftMetadataId]!
                ).description,
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(
                storagePath: TheFabricantXXories
                    .TheFabricantXXoriesCollectionStoragePath,
                publicPath: TheFabricantXXories
                    .TheFabricantXXoriesCollectionPublicPath,
                providerPath: TheFabricantXXories
                    .TheFabricantXXoriesProviderStoragePath,
                publicCollection: Type<
                    &TheFabricantXXories.Collection{
                        TheFabricantXXories.TheFabricantXXoriesCollectionPublic,
                ...
                providerLinkedType: Type<
                    &TheFabricantXXories.Collection{
                        ...
                        NonFungibleToken.CollectionPublic,
                        MetadataViews.ResolverCollection,
                        TheFabricantXXoriesCollectionPublic
                    }
                >(),
        ...
        pub fun getCollectionDisplay(): MetadataViews.NFTCollectionDisplay{ 
            ...
            return MetadataViews.NFTCollectionDisplay(
                ...
                externalURL: (TheFabricantXXories.nftMetadata[self.id]!)
                    .externalURL,
        ...
        pub fun getNFTView(): MetadataViews.NFTView{ 
            return MetadataViews.NFTView(
                ...
                royalties: (TheFabricantXXories.nftMetadata[self.id]!)
                    .royalties,
            ...
            switch view{ 
                ...
                case Type<TheFabricantMetadataViews.TFNFTSimpleView>():
                    return TheFabricantMetadataViews.TFNFTSimpleView(
                        ...
                        coCreatable: (TheFabricantXXories.nftMetadata[self.id]!)
                            .coCreatable,
                        coCreators: (TheFabricantXXories.nftMetadata[self.id]!)
                            .coCreator,
                        isRevealed: (TheFabricantXXories.nftMetadata[self.id]!)
                            .isRevealed,
                        editions: self.getEditions(),
                        originalRecipient: self.originalRecipient,
                        royalties: (TheFabricantXXories.nftMetadata[self.id]!)
                        ...
                        royaltiesTFMarketplace: (
                            TheFabricantXXories.nftMetadata[self.id]!
                        ).royaltiesTFMarketplace,
        ...
        init(originalRecipient: Address, license: MetadataViews.License?){ 
            ...
            TheFabricantXXories.totalSupply = TheFabricantXXories.totalSupply
                + 1
    ...
    pub resource Collection:
        ...
        pub fun borrowTheFabricantXXories(
            id: UInt64
        ): &TheFabricantXXories.NFT?{ 
    ...
    pub resource Admin{ 
        ...
        pub fun distributeDirectlyViaAccessList(
            ...
            let publicMinterCap =
                getAccount((self.owner!).address).getCapability(publicPath)
                    .borrow<
                    &TheFabricantXXories.PublicMinter{
                        TheFabricantXXories.Minter
                    }
                >()
                ?? panic(
            ...
            let royaltiesTFMarketplace =
                ...
                as!
                TheFabricantMetadataViews.Royalties?
            ...
            emit ItemMintedAndTransferred(
                uuid: nft.uuid,
                id: nft.id,
                name: (TheFabricantXXories.nftMetadata[nft.nftMetadataId]!)
                    .name,
                description: (
                    TheFabricantXXories.nftMetadata[nft.nftMetadataId]!
                ).description,
                collection: (
                    TheFabricantXXories.nftMetadata[nft.nftMetadataId]!
                ).collection,
            ...
            if TheFabricantXXories.addressMintCount[(receiver.owner!).address]
            != nil{ 
                TheFabricantXXories.addressMintCount[
        ...
        pub fun distributeDirectlyViaTFNFT(
            ...
            let accessListOnly =
                publicMinterDetails["isAccessListOnly"] as! Bool?
            ...
            let typeRestrictions =
                publicMinterDetails["typeRestrictions"] as! [Type]?
            if !isOpenAccess!{ 
        ...
        pub fun createPublicMinter(
            ...
            let publicMinter: @TheFabricantXXories.PublicMinter <-
                create PublicMinter(
                    name: name,
                    description: description,
                    collection: collection,
            ...
            TheFabricantXXories.account.save(
                <-publicMinter,
                to: publicMinterStoragePath!
            )
            TheFabricantXXories.account.link<&PublicMinter{Minter}>(
        ...
        pub fun revealTraits(
            nftMetadataId: UInt64,
            traits: [{
                Revealable.RevealableTrait}
            ]
        ){ 
            let nftMetadata =
                TheFabricantXXories.nftMetadata[nftMetadataId]!
                as!
                TheFabricantXXories.RevealableMetadata
    ...
    pub resource PublicMinter:
        TheFabricantNFTStandard.TFNFTPublicMinter,
        Minter{
        ...
        pub fun mintUsingAccessList(
            ...
            ((              // Deposit has to occur outside of above if statement as resource must be moved or destroyed
              TheFabricantXXories.paymentReceiverCap!).borrow()!).deposit(
                from: <-payment
            )
            let nft <-
                create NFT(
        ...
        pub fun mintUsingNftRefs(
            ...
            let nftTfIdentifier =
                TheFabricantMetadataViews.TFNFTIdentifierV1(
                    uuid: nft.uuid,
                    id: nft.id,
                    name: self.name,
                    collection: self.collection,
        ...
        init(
            ...
            let pathString =
                "TheFabricantNFTPublicMinter_TheFabricantXXories_".concat(
                    self.uuid.toString()
                )
    ...
    access(contract) fun createNftMetadata(
        ...
        let metadata ={
                ...
                "mainImage":
                "https://leela.mypinata.cloud/ipfs/QmZcQrteej9SYgrVXWR59H2ALWLJSg8wsg2GN8RQFLiJo2/Fruit_Square_png.png",
                "video":
                "https://leela.mypinata.cloud/ipfs/QmZcQrteej9SYgrVXWR59H2ALWLJSg8wsg2GN8RQFLiJo2/Fruit_Square_mp4.mp4"
            }
        let mD =
            RevealableMetadata(
                id: id,
    ...
    init(){ 
        ...
        self
            .TheFabricantXXoriesCollectionStoragePath = /storage/TheFabricantXXoriesCollectionStoragePath
        self
            .TheFabricantXXoriesCollectionPublicPath = /public/TheFabricantXXoriesCollectionPublicPath
        self
            .TheFabricantXXoriesProviderStoragePath = /private/TheFabricantXXoriesProviderStoragePath
        self
            .TheFabricantXXoriesAdminStoragePath = /storage/TheFabricantXXoriesAdminStoragePath
        self
            .TheFabricantXXoriesPublicMinterStoragePath = /storage/TheFabricantXXoriesPublicMinterStoragePath
        self
            .TheFabricantXXoriesPublicMinterPublicPath = /public/TheFabricantXXoriesPublicMinterPublicPath
        self.account.save(
            <-create Admin(adminAddress: self.account.address),
            to: self.TheFabricantXXoriesAdminStoragePath
        )
