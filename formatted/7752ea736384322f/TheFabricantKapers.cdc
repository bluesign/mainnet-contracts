...
pub contract TheFabricantKapers:
    NonFungibleToken,
    ...
    access(contract) var secondaryColors:{ 
    ...
    pub resource NFT:
        ...
        pub fun getFullName(): String{ 
            return ((TheFabricantKapers.nftMetadata[self.nftMetadataId]!).name!)
                .concat(" #".concat(self.editionNumber.toString()))
        }
        
        // NOTE: This is important for Edition view
        pub fun getEditionName(): String{ 
            return (TheFabricantKapers.nftMetadata[self.nftMetadataId]!)
                .collection
        }
        ...
        pub fun getEditions(): MetadataViews.Editions{ 
            ...
            let edition =
                MetadataViews.Edition(
                    name: (TheFabricantKapers.nftMetadata[self.nftMetadataId]!)
                        .collection,
        ...
        pub fun getTraits(): MetadataViews.Traits?{ 
            let characteristics =
                (TheFabricantKapers.nftMetadata[self.id]!).characteristics
            ...
            let primaryColorTraits =
                primaryColorCharacteristic.convertToTraits()
            let secondaryColorsCharacteristic =
                characteristics["secondaryColor"]!
            let secondaryColorTraits =
                secondaryColorsCharacteristic.convertToTraits()
            let concatenatedArrays =
                garmentTraits.concat(materialTraits).concat(primaryColorTraits)
                    .concat(secondaryColorTraits)
        ...
        pub fun getRevealableTraits():{ String: Bool}?{ 
            return (TheFabricantKapers.nftMetadata[self.id]!)
                .getRevealableTraits()
        }
        ...
        pub fun getDisplay(): MetadataViews.Display{ 
            return MetadataViews.Display(
                ...
                description: (
                    TheFabricantKapers.nftMetadata[self.nftMetadataId]!
                ).description,
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(
                storagePath: TheFabricantKapers
                    .TheFabricantKapersCollectionStoragePath,
                publicPath: TheFabricantKapers
                    .TheFabricantKapersCollectionPublicPath,
                providerPath: TheFabricantKapers.TheFabricantKapersProviderPath,
                publicCollection: Type<
                    &TheFabricantKapers.Collection{
                        TheFabricantKapers.TheFabricantKapersCollectionPublic,
        ...
        pub fun getCollectionDisplay(): MetadataViews.NFTCollectionDisplay{ 
            ...
            return MetadataViews.NFTCollectionDisplay(
                ...
                externalURL: (TheFabricantKapers.nftMetadata[self.id]!)
                    .externalURL,
            ...
            switch view{ 
                ...
                case Type<TheFabricantMetadataViewsV2.TFNFTSimpleView>():
                    return TheFabricantMetadataViewsV2.TFNFTSimpleView(
                        ...
                        coCreatable: (TheFabricantKapers.nftMetadata[self.id]!)
                            .coCreatable,
                        coCreators: (TheFabricantKapers.nftMetadata[self.id]!)
                            .coCreator,
                        isRevealed: (TheFabricantKapers.nftMetadata[self.id]!)
                            .isRevealed,
                        editions: self.getEditions(),
                        originalRecipient: self.originalRecipient,
                        royalties: (TheFabricantKapers.nftMetadata[self.id]!)
                            .royalties,
                        royaltiesTFMarketplace: (
                            TheFabricantKapers.nftMetadata[self.id]!
                        ).royaltiesTFMarketplace,
    ...
    pub resource Admin{ 
        ...
        pub fun distributeDirectlyViaAccessList(
            ...
            let publicMinterCap =
                getAccount((self.owner!).address).getCapability(publicPath)
                    .borrow<
                    &TheFabricantKapers.PublicMinter{TheFabricantKapers.Minter}
                >()
                ?? panic(
            ...
            let externalPublicMinterRoyalties =
                publicMinterDetails["royalties"] as! MetadataViews.Royalties?
            let externalRoyaltiesArray =
                (externalPublicMinterRoyalties!).getRoyalties()
            let externalRoyalties =
                MetadataViews.Royalties(cutInfos: externalRoyaltiesArray)
            ...
            let internalPublicMinterRoyaltiesArray =
                (internalPublicMinterRoyalties!).getRoyalties()
            let internalRoyalties =
                TheFabricantMetadataViewsV2.Royalties(
                    cutInfos: internalPublicMinterRoyaltiesArray
                )
            ...
            let characteristics =
                TheFabricantKapers.createCharacteristics(
                    garmentId: garmentId,
            ...
            emit ItemMintedAndTransferred(
                ...
                description: (
                    TheFabricantKapers.nftMetadata[nft.nftMetadataId]!
                ).description,
                collection: (TheFabricantKapers.nftMetadata[nft.nftMetadataId]!)
                    .collection,
                editionNumber: nft.editionNumber,
            ...
            emit DataAllocationCreated(
                ...
                originalRecipient: nft.originalRecipient,
                nftMetadataId: nft.nftMetadataId,
                dataAllocationString: TheFabricantKapers.idsToDataAllocations[
                    nft.nftMetadataId
                ]!
            )
            ...
            if TheFabricantKapers.addressMintCount[(receiver.owner!).address]
            != nil{ 
                TheFabricantKapers.addressMintCount[
        ...
        pub fun createPublicMinter(
            ...
            let publicMinter: @TheFabricantKapers.PublicMinter <-
                create PublicMinter(
                    name: name,
            ...
            TheFabricantKapers.account.save(
                <-publicMinter,
                to: publicMinterStoragePath!
            )
            TheFabricantKapers.account.link<&PublicMinter{Minter}>(
        ...
        pub fun revealTraits(
            ...
            let nftMetadata =
                TheFabricantKapers.nftMetadata[nftMetadataId]!
                as!
                TheFabricantKapers.RevealableMetadata
    ...
    pub resource PublicMinter:
        ...
        pub fun mintUsingAccessList(
            ...
            ((              // Deposit has to occur outside of above if statement as resource must be moved or destroyed
              TheFabricantKapers.paymentReceiverCap!).borrow()!).deposit(
                from: <-payment
            )
            let nft <-
                create NFT(
        ...
        init(
            ...
            let pathString =
                "TheFabricantNFTPublicMinter_TheFabricantKapers_".concat(
                    self.uuid.toString()
                )
    ...
    access(contract) fun createNftMetadata(
        ...
        let metadata ={
                ...
                "mainImage":
                (TheFabricantKapers.baseTokenURI!).concat("/").concat(
                    dataAllocation
                ).concat(".png"),
                "video":
                (TheFabricantKapers.baseTokenURI!).concat("/").concat(
    ...
    access(contract) fun createCharacteristics(
        ...
        let garment =
            TheFabricantKapers.garments[garmentId]
            ?? panic("A garment with this id does not exist")
        dict["garment"] = garment
        let material =
            TheFabricantKapers.materials[materialId]
            ?? panic("A material with this id does not exist")
        dict["material"] = material
        let primaryColor =
            TheFabricantKapers.primaryColors[primaryColorId]
            ?? panic("A primary color with this id does not exist")
        dict["primaryColor"] = primaryColor
        let secondaryColor =
            TheFabricantKapers.secondaryColors[secondaryColorId]
            ?? panic("A secondary color with this id does not exist")
    ...
    access(contract) fun constructDataAllocationString(
        ...
        return "gar".concat(garmentId.toString()).concat("_mat").concat(
            materialId.toString()
        ).concat("_primary").concat(primaryColorId.toString()).concat(
            "_secondary"
    ...
    init(){ 
        ...
        self
            .TheFabricantKapersCollectionStoragePath = /storage/TheFabricantKapersCollectionStoragePath
        self
            .TheFabricantKapersCollectionPublicPath = /public/TheFabricantKapersCollectionPublicPath
        self
            .TheFabricantKapersProviderPath = /private/TheFabricantKapersProviderPath
        self
            .TheFabricantKapersAdminStoragePath = /storage/TheFabricantKapersAdminStoragePath
        self
            .TheFabricantKapersPublicMinterStoragePath = /storage/TheFabricantKapersPublicMinterStoragePath
        self
            .TheFabricantKapersPublicMinterPublicPath = /public/TheFabricantKapersPublicMinterPublicPath
        self.account.save(
            <-create Admin(adminAddress: self.account.address),
            to: self.TheFabricantKapersAdminStoragePath
        )
