...
pub contract CAT_EnterTheEvolution:
    NonFungibleToken,
    ...
    pub let CAT_EnterTheEvolutionCollectionStoragePath: StoragePath
    
    pub let CAT_EnterTheEvolutionCollectionPublicPath: PublicPath
    
    pub let CAT_EnterTheEvolutionProviderPath: PrivatePath
    
    pub let CAT_EnterTheEvolutionPublicMinterStoragePath: StoragePath
    
    pub let CAT_EnterTheEvolutionAdminStoragePath: StoragePath
    
    pub let CAT_EnterTheEvolutionPublicMinterPublicPath: PublicPath
    ...
    access(contract) var shoeShapes:{ UInt64:{ CoCreatableV2.Characteristic}}
    
    access(contract) var materials:{ UInt64:{ CoCreatableV2.Characteristic}}
    
    access(contract) var solidColors:{ UInt64:{ CoCreatableV2.Characteristic}}
    
    access(contract) var textureSets:{ UInt64:{ CoCreatableV2.Characteristic}}
    ...
    pub struct RevealableMetadata: RevealableV2.RevealableMetadata{ 
        ...
        priv fun constructAssetPath(): String{ 
    ...
    pub resource NFT:
        ...
        pub fun getFullName(): String{ 
            return (
                (CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!).name!
            ).concat(" #".concat(self.editionNumber.toString()))
        }
        
        // NOTE: This is important for Edition view
        pub fun getEditionName(): String{ 
            return (CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!)
                .collection
        }
        ...
        pub fun getEditions(): MetadataViews.Editions{ 
            ...
            let edition =
                MetadataViews.Edition(
                    name: (
                        CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!
                    ).collection,
                    number: self.editionNumber,
                    max: CAT_EnterTheEvolution.maxSupply
                )
        ...
        pub fun getTraits(): MetadataViews.Traits?{ 
            let characteristics =
                (CAT_EnterTheEvolution.nftMetadata[self.id]!).characteristics
            log(characteristics)
            ...
            let concatenatedArrays =
                shoeTraits.concat(materialTraits).concat(solidColorTraits)
                    .concat(textureSetTraits)
        ...
        pub fun getRevealableTraits():{ String: Bool}?{ 
            return (CAT_EnterTheEvolution.nftMetadata[self.id]!)
                .getRevealableTraits()
        }
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(
                storagePath: CAT_EnterTheEvolution
                    .CAT_EnterTheEvolutionCollectionStoragePath,
                publicPath: CAT_EnterTheEvolution
                    .CAT_EnterTheEvolutionCollectionPublicPath,
                providerPath: CAT_EnterTheEvolution
                    .CAT_EnterTheEvolutionProviderPath,
                publicCollection: Type<
                    &CAT_EnterTheEvolution.Collection{
                        CAT_EnterTheEvolution.CAT_EnterTheEvolutionCollectionPublic,
                ...
                providerLinkedType: Type<
                    &CAT_EnterTheEvolution.Collection{
                        ...
                        NonFungibleToken.CollectionPublic,
                        MetadataViews.ResolverCollection,
                        CAT_EnterTheEvolutionCollectionPublic
                    }
                >(),
                createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                    return <-CAT_EnterTheEvolution.createEmptyCollection()
                }
            )
        }
        ...
        pub fun getCollectionDisplay(): MetadataViews.NFTCollectionDisplay{ 
            let squareImage =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(
                        url: "https://www.dropbox.com/s/8jgcbkus6rg4v6c/CAT-logo-768x461.png?dl=0"
                    ),
            ...
            let bannerImage =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(
                        url: "https://www.dropbox.com/s/do50ksxr5vpdvsh/Stage02_CloseStill4k_169-US.png?dl=0"
                    ),
                    mediaType: "image/svg+xml"
                )
            return MetadataViews.NFTCollectionDisplay(
                name: self.getEditionName(),
                description: "Example Simple TFNFT",
                externalURL: (CAT_EnterTheEvolution.nftMetadata[self.id]!)
                    .externalURL,
        ...
        pub fun getNFTView(): MetadataViews.NFTView{ 
            return MetadataViews.NFTView(
                ...
                royalties: (CAT_EnterTheEvolution.nftMetadata[self.id]!)
                    .royalties,
            ...
            switch view{ 
                case Type<TheFabricantMetadataViewsV2.TFNFTIdentifierV1>():
                    return TheFabricantMetadataViewsV2.TFNFTIdentifierV1(
                        ...
                        name: self.getFullName(),
                        collection: (
                            CAT_EnterTheEvolution.nftMetadata[
                                self.nftMetadataId
                            ]!
                        ).collection,
                ...
                case Type<TheFabricantMetadataViewsV2.TFNFTSimpleView>():
                    return TheFabricantMetadataViewsV2.TFNFTSimpleView(
                        ...
                        collectionId: CAT_EnterTheEvolution.collectionId!,
                        metadata: self.getMetadata(),
                        media: self.getMedias(),
                        images: self.getImages(),
                        videos: self.getVideos(),
                        externalURL: (
                            CAT_EnterTheEvolution.nftMetadata[self.id]!
                        ).externalURL,
        ...
        init(originalRecipient: Address, license: MetadataViews.License?){ 
            assert(
                CAT_EnterTheEvolution.collectionId != nil,
                message: "Ensure that Admin has set collectionId in the contract"
            )
            CAT_EnterTheEvolution.totalSupply = CAT_EnterTheEvolution
                    .totalSupply
                + 1
        ...
        destroy(){ 
            emit ItemDestroyed(
                uuid: self.uuid,
                id: self.id,
                name: (CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!)
                    .name,
                description: (
                    CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!
                ).description,
    ...
    pub resource interface CAT_EnterTheEvolutionCollectionPublic{ 
        pub fun borrowCAT_EnterTheEvolution(
            id: UInt64
        ): &CAT_EnterTheEvolution.NFT{CAT_EnterTheEvolution.PublicNFT}?{} 
    ...
    pub resource Collection:
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{
            ...
            return CAT_EnterTheEvolution as &AnyResource{MetadataViews.Resolver}
        }
    ...
    pub resource Admin{ 
        ...
        pub fun createPublicMinter(
            ...
            let publicMinter: @CAT_EnterTheEvolution.PublicMinter <-
                create PublicMinter(
                    name: name,
            ...
            CAT_EnterTheEvolution.account.save(
                <-publicMinter,
                to: publicMinterStoragePath!
            )
            CAT_EnterTheEvolution.account.link<&PublicMinter{Minter}>(
        ...
        pub fun revealTraits(
            ...
            let nftMetadata =
                CAT_EnterTheEvolution.nftMetadata[nftMetadataId]!
                as!
                CAT_EnterTheEvolution.RevealableMetadata
        ...
        // NOTE: Customise
        pub fun updateShoeShapes(
            shapes:{ 
                UInt64:{ CoCreatableV2.Characteristic}
            }
        ){ 
            var i: UInt64 = 0
        ...
        // NOTE: Customise
        pub fun emptyShoeShapes(){ 
            CAT_EnterTheEvolution.shoeShapes ={} 
        }
        
        // NOTE: Customise
        pub fun updateMaterials(
            materials:{ 
                UInt64:{ CoCreatableV2.Characteristic}
            }
        ){ 
        ...
        // NOTE: Customise
        pub fun emptySolidColors(){ 
            CAT_EnterTheEvolution.solidColors ={} 
        }
        
        // NOTE: Customise
        pub fun updateTextureSets(
            textureSets:{ 
                UInt64:{ CoCreatableV2.Characteristic}
            }
        ){ 
    ...
    pub resource PublicMinter:
        ...
        pub fun mintUsingAccessList(
            ...
            let coCreatorReceiver =
                getAccount((receiver.owner!).address).getCapability<
                    &FlowToken.Vault{FungibleToken.Receiver}
                >(/public/flowTokenReceiver)
            let coCreatorExternalRoyalty =
                MetadataViews.Royalty(
                    receiver: coCreatorReceiver,
                    cut: 0.01,
                    description: "CoCreator Royalty"
                )
            ...
            let externalRoyalties =
                MetadataViews.Royalties(cutInfos: externalPublicMinterRoyalties)
            ...
            let internalPublicMinterRoyalties =
                self.royaltiesTFMarketplace.getRoyalties()
            internalPublicMinterRoyalties.append(coCreatorInternalRoyalty)
            let internalRoyalties =
                TheFabricantMetadataViewsV2.Royalties(
                    cutInfos: internalPublicMinterRoyalties
                )
            
            // Create Characteristics struct
            let characteristics =
                CAT_EnterTheEvolution.createCharacteristics(
                    shoeShapeId: shoeShapeId,
                    materialId: materialId,
                    solidColorId: solidColorId,
                    textureSetId: textureSetId
                )
            
            //Update data allocation. This prevents people from minting the same combination
            CAT_EnterTheEvolution.updateDataAllocations(
                nftId: nft.id,
                shoeShapeId: shoeShapeId,
                materialId: materialId,
                solidColorId: solidColorId,
            ...
            CAT_EnterTheEvolution.createNftMetadata(
                id: nft.id,
                nftUuid: nft.uuid,
                name: shoeShapeName,
                description: shoeShapeDescription,
                collection: self.collection,
            ...
            emit ItemMintedAndTransferred(
                uuid: nft.uuid,
                id: nft.id,
                name: (CAT_EnterTheEvolution.nftMetadata[nft.nftMetadataId]!)
                    .name,
                description: (
                    CAT_EnterTheEvolution.nftMetadata[nft.nftMetadataId]!
                ).description,
                collection: (
                    CAT_EnterTheEvolution.nftMetadata[nft.nftMetadataId]!
                ).collection,
            ...
            emit DataAllocationCreated(
                ...
                originalRecipient: nft.originalRecipient,
                nftMetadataId: nft.nftMetadataId,
                dataAllocationString: CAT_EnterTheEvolution
                    .idsToDataAllocations[nft.nftMetadataId]!
            )
            receiver.deposit(token: <-nft)
            
            // Increment the number of mints that an address has
            if CAT_EnterTheEvolution.addressMintCount[(receiver.owner!).address]
            != nil{ 
                CAT_EnterTheEvolution.addressMintCount[
        ...
        init(
            ...
            let pathString =
                "TheFabricantNFTPublicMinter_CAT_EnterTheEvolution_".concat(
                    self.uuid.toString()
                )
    ...
    access(contract) fun createNftMetadata(
        ...
        let metadata ={
                ...
                "mainImage":
                (CAT_EnterTheEvolution.baseTokenURI!).concat("/").concat(
                    dataAllocation
                ).concat(".png"),
                "video":
                (CAT_EnterTheEvolution.baseTokenURI!).concat("/").concat(
    ...
    access(contract) fun createCharacteristics(
        ...
        let shoeShape =
            CAT_EnterTheEvolution.shoeShapes[shoeShapeId]
            ?? panic("A shoe shape with this id does not exist")
        dict["shoeShape"] = shoeShape
        let material =
            CAT_EnterTheEvolution.materials[materialId]
            ?? panic("A material with this id does not exist")
        dict["material"] = material
        let solidColor =
            CAT_EnterTheEvolution.solidColors[solidColorId]
            ?? panic("A solid color with this id does not exist")
        dict["solidColor"] = solidColor
        let textureSet =
            CAT_EnterTheEvolution.textureSets[textureSetId]
            ?? panic("A texture set with this id does not exist")
    ...
    priv fun nftsCanBeUsedForMint(
        ...
        assert(
            ...
            message: "There are no typerestrictions for this promotion"
        )
        var i = 0
        while i < refs.length{ 
    ...
    access(contract) fun constructDataAllocationString(
        ...
        return "shoe".concat(shoeShapeId.toString()).concat("_mat").concat(
            materialId.toString()
        ).concat("_tex").concat(textureSetId.toString()).concat("_col").concat(
            solidColorId.toString()
        )
    }
    ...
    access(contract) fun updateDataAllocations(
        ...
        let allocationString =
            self.constructDataAllocationString(
                shoeShapeId: shoeShapeId,
                materialId: materialId,
                solidColorId: solidColorId,
                textureSetId: textureSetId
    ...
    pub fun getAllCharacteristics(): AnyStruct{ 
        let res ={
                ...
                "shoeShapes": CAT_EnterTheEvolution.shoeShapes,
                "materials": CAT_EnterTheEvolution.materials,
                "solidColors": CAT_EnterTheEvolution.solidColors,
                "textureSets": CAT_EnterTheEvolution.textureSets
            }
        return res
    }
    ...
    init(){ 
        ...
        self
            .CAT_EnterTheEvolutionCollectionStoragePath = /storage/CAT_EnterTheEvolutionCollectionStoragePath
        self
            .CAT_EnterTheEvolutionCollectionPublicPath = /public/CAT_EnterTheEvolutionCollectionPublicPath
        self
            .CAT_EnterTheEvolutionProviderPath = /private/CAT_EnterTheEvolutionProviderPath
        self
            .CAT_EnterTheEvolutionAdminStoragePath = /storage/CAT_EnterTheEvolutionAdminStoragePath
        self
            .CAT_EnterTheEvolutionPublicMinterStoragePath = /storage/CAT_EnterTheEvolutionPublicMinterStoragePath
        self
            .CAT_EnterTheEvolutionPublicMinterPublicPath = /public/CAT_EnterTheEvolutionPublicMinterPublicPath
        self.account.save(
            <-create Admin(adminAddress: self.account.address),
            to: self.CAT_EnterTheEvolutionAdminStoragePath
        )
