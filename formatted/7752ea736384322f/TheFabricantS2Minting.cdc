...
pub contract TheFabricantS2Minting{ 
    ...
    pub event PaymentReceiverCapabilityChanged(
        address: Address,
        paymentType: Type
    )
    ...
    priv var eventsDetail:{ String: EventDetail}
    
    access(contract) var itemMinterCapability: Capability<
        &TheFabricantS2ItemNFT.Admin
    >?
    
    access(contract) var garmentMinterCapability: Capability<
        &TheFabricantS2GarmentNFT.Admin
    >?
    
    access(contract) var materialMinterCapability: Capability<
        &TheFabricantS2MaterialNFT.Admin
    >?
    
    access(contract) var paymentReceiverCapability: Capability<
        &{FungibleToken.Receiver}
    >?
    
    pub struct EventDetail{ 
        priv var addressMintCount:{ Address: UInt32}
    ...
    pub fun doesAddressHoldAccessPass(address: Address): Bool{ 
        ...
        if getAccount(address).getCapability<
            ...
            let collectionRef =
                getAccount(address).getCapability(
                    TheFabricantAccessPass
                        .TheFabricantAccessPassCollectionPublicPath
                ).borrow<
                    &{
                        TheFabricantAccessPass.TheFabricantAccessPassCollectionPublic
                    }
    ...
    pub resource Minter{ 
        ...
        pub fun mintAndTransferItem(
            ...
            if (TheFabricantS2Minting.eventsDetail[eventName]!)
                .getAddressMintCount()[(self.owner!).address]
            != nil{ 
                if (TheFabricantS2Minting.eventsDetail[eventName]!)
                    .getAddressMintCount()[(self.owner!).address]!
                >= (TheFabricantS2Minting.eventsDetail[eventName]!)
                    .maxMintAmount{ 
            ...
            let garment <-
                ((TheFabricantS2Minting.garmentMinterCapability!).borrow()!)
                    .mintNFT(garmentDataID: garmentDataID)
            let material <-
                ((TheFabricantS2Minting.materialMinterCapability!).borrow()!)
                    .mintNFT(materialDataID: materialDataID)
            ...
            metadatas["season"] = TheFabricantS2ItemNFT.Metadata(
                    metadataValue: "2",
                    mutable: false
                )
            ...
            ((              
              ...
              TheFabricantS2Minting.itemMinterCapability!).borrow()!)
                .createItemDataWithAllocation(
            ...
            let royalty =
                TheFabricantS2ItemNFT.Royalty(
                    wallet: getAccount((self.owner!).address).getCapability<
            ...
            eventDetails.incrementAddressMintCount(
            ...
            ((              
              ...
              TheFabricantS2Minting.paymentReceiverCapability!).borrow()!)
    ...
    pub resource Admin{ 
        ...
        pub fun changePaymentAmount(
            eventName: String,
            newPaymentAmount: UFix64
        ){ 
            pre{ 
                TheFabricantS2Minting.eventsDetail[eventName] != nil:
                    "eventName doesnt exist"
        ...
        pub fun changeItemMinterCapability(
            minterCapability: Capability<&TheFabricantS2ItemNFT.Admin>
        ){ 
        ...
        pub fun changeGarmentMinterCapability(
            minterCapability: Capability<&TheFabricantS2GarmentNFT.Admin>
        ){ 
            TheFabricantS2Minting.garmentMinterCapability = minterCapability
            emit GarmentMinterCapabilityChanged(
                address: minterCapability.address
            )
        }
        
        pub fun changeMaterialMinterCapability(
            ...
            emit MaterialMinterCapabilityChanged(
                address: minterCapability.address
            )
        }
        
        pub fun changePaymentReceiverCapability(
            paymentReceiverCapability: Capability<&{FungibleToken.Receiver}>
        ){ 
            TheFabricantS2Minting
                .paymentReceiverCapability = paymentReceiverCapability
