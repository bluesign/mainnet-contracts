...
pub contract TheFabricantAccessList{ 
    ...
    priv var accessListDetails:{ UInt64: AccessListDetails}
    
    priv var testingLists:{ UInt64:{ Address: Bool}}
    ...
    pub struct AddressList: AddressListPublic{ 
        priv var addressList:{ Address: Bool}
    ...
    pub struct AccessListDetails{ 
        ...
        priv fun isOpenExternally(): Bool{ 
        ...
        priv fun isOpenInternally(): Bool{ 
            if self.isOpen() && self.onlyUseTestingList{ 
                return true
            }
            return false
        ...
        pub fun getAccessListDetails():{ String: AnyStruct}{ 
            ...
            ret["accessListLength"] = self.borrowAccessList()
                    .getAddressListLength()
            ret["testingListLength"] = self.borrowTestingList()
                    .getAddressListLength()
            return ret
        }
        ...
        pub fun addressIsInList(address: Address):{ String: AnyStruct}{ 
            ...
            ret["isInAccessList"] = self.borrowAccessList().containsAddress(
                    address: address
                )
            ret["isInTestingList"] = self.borrowTestingList().containsAddress(
                    address: address
                )
            ret["isOpenExternally"] = self.isOpenExternally()
            ret["isOpenInternally"] = self.isOpenInternally()
        ...
        priv fun borrowAccessList(): &AddressList{AddressListPublic}{ 
            return TheFabricantAccessList.account.getCapability<
                &AddressList{AddressListPublic}
            >(self.accessListPublicPath).borrow()
            ?? panic(
                "No access list exists in storage for this AccessListDetails"
            )
        }
        
        priv fun borrowTestingList(): &AddressList{AddressListPublic}{ 
            return TheFabricantAccessList.account.getCapability<
                &AddressList{AddressListPublic}
            >(self.testingListPublicPath).borrow()
            ?? panic(
                "No access list exists in storage for this AccessListDetails"
            )
        }
        ...
        init(collection: String, description: String?){ 
            ...
            let masterPathString =
                TheFabricantAccessList.AccessListStoragePath.toString()
            let accessListString = "_accessLists_".concat(self.id.toString())
            let accessListStoragePathString =
                masterPathString.concat(accessListString)
            // Remove /storage/ by slicing
            let accessListPathString =
                accessListStoragePathString.slice(
                    from: 9,
                    upTo: accessListStoragePathString.length
                )
            let testingListString = "_testingLists_".concat(self.id.toString())
            let testingListStoragePathString =
                masterPathString.concat(testingListString)
            // Remove /storage/ by slicing
            ...
            self.accessListStoragePath = StoragePath(
                    identifier: accessListPathString
                )!
            self.testingListStoragePath = StoragePath(
                    identifier: testingListPathString
                )!
            self.accessListPublicPath = PublicPath(
                    identifier: accessListPathString
                )!
            self.testingListPublicPath = PublicPath(
                    identifier: testingListPathString
                )!
            self.isActive = false
    ...
    pub resource Admin{ 
        pub fun setIsActive(accessListDetailsId: UInt64, isActive: Bool){ 
            let accessListDetails =
                ...
                ?? panic(
                    "Can't setIsActive as no AccessListDetail exists with this id!"
                )
            ...
            emit AccessListDetailsIsActiveUpdated(
                ...
                accessListStoragePath: accessListDetails.accessListStoragePath
                    .toString(),
                testingListStoragePath: accessListDetails.testingListStoragePath
                    .toString()
            )
        }
        
        // NOTE: WARNING! Setting this to false will open up the external (public) access list!
        pub fun setOnlyUseInternalTestingList(
            accessListDetailsId: UInt64,
            useTestingList: Bool
        ){ 
            let accessListDetails =
            ...
            accessListDetails.setOnlyUseInternalTestingList(
                useTestingList: useTestingList
            )
            TheFabricantAccessList.accessListDetails[
                accessListDetailsId
            ] = accessListDetails
        ...
        pub fun createAccessListDetails(
            ...
            TheFabricantAccessList.accessListDetails[
                accessListDetails.id
            ] = accessListDetails
            TheFabricantAccessList.nextAccessListId = TheFabricantAccessList
                    .nextAccessListId
                + 1
            ...
            var testingList: TheFabricantAccessList.AddressList =
                TheFabricantAccessList.AddressList()
            TheFabricantAccessList.account.save(
                accessList,
            ...
            TheFabricantAccessList.account.link<
                &AddressList{AddressListPublic}
            >(
        ...
        pub fun updateAccessListDetails(
            ...
            let accessListDetails: AccessListDetails =
                TheFabricantAccessList.accessListDetails[accessListDetailsId]
                ?? panic(
                    "Can't update details of AccessListDetails as no ALD with this id exists!"
                )
        ...
        pub fun deleteAccessListDetails(accessListDetailsId: UInt64){ 
            ...
            let accessListDetails =
                TheFabricantAccessList.accessListDetails[accessListDetailsId]
            TheFabricantAccessList.accessListDetails.remove(
                key: accessListDetailsId
            )
            ...
            let accessList =
                TheFabricantAccessList.account.load<AddressList>(
            ...
            let testingList =
                TheFabricantAccessList.account.load<AddressList>(
                    from: TheFabricantAccessList
                        .constructTestingListStoragePath(
                        accessListDetailsId: accessListDetailsId
                    )
                )
            emit AccessListDetailDeleted(
                ...
                collection: (accessListDetails!).collection,
                description: (accessListDetails!).description,
                accessListStoragePath: (accessListDetails!)
                    .accessListStoragePath.toString(),
                testingListStoragePath: (accessListDetails!)
                    .testingListStoragePath.toString()
            )
        }
        ...
        pub fun addAddressesToTestingList(
            accessListDetailsId: UInt64,
            addresses:{ 
                Address: Bool
            }
        ...
        priv fun borrowAccessList(accessListDetailsId: UInt64): &AddressList{ 
            return TheFabricantAccessList.account.borrow<&AddressList>(
                from: TheFabricantAccessList.constructAccessListStoragePath(
                    accessListDetailsId: accessListDetailsId
                )
            )
        ...
        priv fun borrowTestingList(accessListDetailsId: UInt64): &AddressList{ 
            return TheFabricantAccessList.account.borrow<&AddressList>(
    ...
    pub fun getAccessList(accessListDetailsId: UInt64):{ Address: Bool}?{ 
        if let accessListDetails =
            TheFabricantAccessList.accessListDetails[accessListDetailsId]{ 
            if let addressListRef =
                TheFabricantAccessList.account.getCapability<
                    &AddressList{AddressListPublic}
                >(accessListDetails.accessListPublicPath).borrow(){ 
    ...
    pub fun getTestingList(accessListDetailsId: UInt64):{ Address: Bool}?{ 
        if let accessListDetails =
            ...
            if let addressListRef =
                TheFabricantAccessList.account.getCapability<
                    &AddressList{AddressListPublic}
                >(accessListDetails.testingListPublicPath).borrow(){ 
                return addressListRef.getAddressList()
            }
        }
        return nil
    ...
    pub fun getAccessListDetails(accessListDetailsId: UInt64):{ 
        String: AnyStruct
    }?{ 
    ...
    pub fun getAllAccessListDetails():{ 
        UInt64: TheFabricantAccessList.AccessListDetails
    }{ 
    ...
    // state of the ALD.
    pub fun isAddressInList(accessListDetailsId: UInt64, address: Address):{ 
        String: AnyStruct
    }?{ 
        if let accessListDetail =
            TheFabricantAccessList.accessListDetails[accessListDetailsId]{ 
    ...
    pub fun constructAccessListStoragePath(
        accessListDetailsId: UInt64
    ): StoragePath{ 
        let masterPathString =
            TheFabricantAccessList.AccessListStoragePath.toString()
        let accessListString =
            "_accessLists_".concat(accessListDetailsId.toString())
        let accessListStoragePathString =
            masterPathString.concat(accessListString)
        // Remove /storage/ by slicing
        let accessListPathString =
    ...
    pub fun constructAccessListPublicPath(
        accessListDetailsId: UInt64
    ): PublicPath{ 
        let masterPathString =
            TheFabricantAccessList.AccessListStoragePath.toString()
    ...
    pub fun constructTestingListStoragePath(
        accessListDetailsId: UInt64
    ): StoragePath{ 
        let masterPathString =
            TheFabricantAccessList.AccessListStoragePath.toString()
        let testingListString =
            "_testingLists_".concat(accessListDetailsId.toString())
        let testingListStoragePathString =
            masterPathString.concat(testingListString)
        // Remove /storage/ by slicing
        let testingListPathString =
    ...
    pub fun constructTestingListPublicPath(
        accessListDetailsId: UInt64
    ): PublicPath{ 
        let masterPathString =
            TheFabricantAccessList.AccessListStoragePath.toString()
    ...
    init(){ 
        self
            .AdminStoragePath = /storage/TheFabricantAccessListAdminStoragePath001
        self
            .AccessListStoragePath = /storage/TheFabricantAccessListStoragePath001
