...
pub contract TheFabricantAccessPass: NonFungibleToken{ 
    ...
    pub event TheFabricantAccessPassDestroyed(id: UInt64, campaignName: String, variant: String, description: String, file: String, dateReceived: UFix64, promotionId: UInt64, promotionHost: Address, metadataId: UInt64?, originalRecipient: Address, serial: UInt64, noOfAccessUnits: UInt8, extraMetadata:{ String: String}?)
    
    pub event TheFabricantAccessPassClaimed(id: UInt64, campaignName: String, variant: String, description: String, file: String, dateReceived: UFix64, promotionId: UInt64, promotionHost: Address, metadataId: UInt64?, originalRecipient: Address, serial: UInt64, noOfAccessUnits: UInt8, extraMetadata:{ String: String}?, claimNftUuid: UInt64?)
    
    // Emitted when a TheFabricantAccessPass start date is set
    pub event TheFabricantAccessPassStartDateSet(id: UInt64, startDate: UFix64)
    
    // Emitted when a TheFabricantAccessPass end date is set
    pub event TheFabricantAccessPassEndDateSet(id: UInt64, endDate: UFix64)
    
    // Emitted when the AccessList is updated.
    pub event TheFabricantAccessPassAccessListUpdated(id: UInt64, addresses: [Address])
    
    // Emitted when an Access Unit is spent
    pub event AccessUnitSpent(promotionId: UInt64, accessPassId: UInt64, accessTokenId: UInt64, serial: UInt64, accessUnitsLeft: UInt8, owner: Address, metadataId: UInt64)
    
    pub event TheFabricantAccessPassTransferred(season: String, campaignName: String, promotionName: String, promotionId: UInt64, metadataId: UInt64?, variant: String, id: UInt64, serial: UInt64, from: Address, to: Address)
    
    // -----------------------------------------------------------------------
    // NFT Collection
    
    // Emitted when NFT is withdrawn
    pub event TheFabricantAccessPassWithdraw(id: UInt64, from: Address, promotionId: UInt64, serial: UInt64, accessUnits: UInt64, metadataId: UInt64)
    
    // Emitted when NFT is deposited
    pub event TheFabricantAccessPassDeposit(id: UInt64, to: Address, promotionId: UInt64, serial: UInt64, accessUnits: UInt8, metadataId: UInt64?)
    
    // -----------------------------------------------------------------------
    // Promotion
    
    pub event PromotionCreated(id: UInt64, season: String, campaignName: String, promotionName: String?, host: Address, promotionAccessIds: [UInt64]?, typeRestrictions: [Type]?, active: Bool, dateCreated: UFix64, description: String, image: String?, limited: Limited?, timelock: Timelock?, url: String?)
    
    pub event PromotionDestroyed(id: UInt64, host: Address, campaignName: String)
    
    pub event PromotionActiveChanged(promotionId: UInt64, promotionHost: Address, campaignName: String, active: Bool)
    
    pub event PromotionIsAccessListUsedChanged(promotionId: UInt64, promotionHost: Address, campaignName: String, isAccessListUsed: Bool)
    
    pub event PromotionIsOpenAccessChanged(promotionId: UInt64, promotionHost: Address, campaignName: String, isOpenAccess: Bool)
    
    pub event PromotionOnlyUseAccessListChanged(promotionId: UInt64, promotionHost: Address, campaignName: String, onlyUseAccessList: Bool)
    
    pub event PromotionMetadataAdded(promotionId: UInt64, promotionHost: Address, campaignName: String, active: Bool, metadata:{ UInt64:{ String: String}})
    
    pub event UpdatedAccessList(promotionId: UInt64, promotionHost: Address, campaignName: String, active: Bool, newAddresses: [Address])
    
    pub event AddressRemovedFromAccessList(promotionId: UInt64, promotionHost: Address, campaignName: String, active: Bool, addressRemoved: Address)
    
    pub event AccessListEmptied(promotionId: UInt64, promotionHost: Address, campaignName: String, active: Bool)
    
    pub event UpdatedPromotionAccessIds(promotionId: UInt64, promotionHost: Address, campaignName: String, active: Bool, promotionAccessIds: [UInt64])
    
    // -----------------------------------------------------------------------
    // Promotions
    pub event PublicMinterCreated(id: UInt64, promotionId: UInt64, promotionHost: Address, campaignName: String, variant: String, nftMetadataId: UInt64?, typeRestrictions: [Type]?, promotionAccessIds: [UInt64]?, pathString: String)
    
    pub event PublicMinterDestroyed(path: String)
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv var extraMetadata:{ String: String}?
        ...
        priv let royaltiesTFMarketplace: [TheFabricantMetadataViews.Royalty]
        ...
        init(season: String, campaignName: String, promotionName: String, variant: String, description: String, file: String, promotionId: UInt64, promotionHost: Address, metadataId: UInt64?, originalRecipient: Address, serial: UInt64, accessUnits: UInt8, extraMetadata:{ String: String}?, royalties: [MetadataViews.Royalty], royaltiesTFMarketplace: [TheFabricantMetadataViews.Royalty]){ 
            ...
            self.promotionsCap = getAccount(promotionHost).getCapability<&TheFabricantAccessPass.Promotions{TheFabricantAccessPass.PromotionsAccountAccess, TheFabricantAccessPass.PromotionsPublic, MetadataViews.ResolverCollection}>(TheFabricantAccessPass.PromotionsPublicPath)
        ...
        destroy(){ 
            ...
            emit TheFabricantAccessPassDestroyed(id: self.id, campaignName: self.campaignName, variant: self.variant, description: self.description, file: self.file, dateReceived: self.dateReceived, promotionId: self.promotionId, promotionHost: self.promotionHost, metadataId: self.metadataId, originalRecipient: self.originalRecipient, serial: self.serial, noOfAccessUnits: self.accessUnits, extraMetadata: self.extraMetadata)
        }
    }
    ...
    pub resource Promotion: PromotionAdminAccess, PromotionPublic, PromotionPublicAccessList, MetadataViews.Resolver{ 
        ...
        priv var typeRestrictions: [Type]?
        ...
        priv var promotionAccessIds: [UInt64]?
        ...
        priv var nftsUsedForClaim:{ UInt64: TheFabricantMetadataViews.Identifier}
        ...
        priv var addressesClaimed:{ Address: [TheFabricantMetadataViews.Identifier]}
        ...
        priv var currentHolders:{ UInt64: TheFabricantMetadataViews.Identifier}
        ...
        priv let spentAccessUnits:{ UInt64: [TheFabricantMetadataViews.SpentAccessUnitView]}
        ...
        access(account) fun transferred(season: String, campaignName: String, promotionName: String, promotionId: UInt64, variant: String, id: UInt64, serial: UInt64, to: Address, dateReceived: UFix64, originalRecipient: Address, accessUnits: UInt8, initialAccessUnits: UInt8, metadataId: UInt64?){ 
        ...
        access(account) fun acceptAccessUnit(from: Address, season: String, campaignName: String, promotionName: String, promotionId: UInt64, variant: String?, accessPassId: UInt64, accessPassSerial: UInt64, accessTokenId: UInt64){ 
        ...
        access(account) fun mint(recipient: Address, variant: String, numberOfAccessUnits: UInt8, file: String, metadataId: UInt64?, claimNftUuid: UInt64?): @NFT{ 
            pre{ 
                self.isOpen():
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties(cutInfos: self.getStandardRoyalties())
                case Type<TheFabricantMetadataViews.Royalties>():
                    return TheFabricantMetadataViews.Royalties(cutInfos: self.getTFRoyalties())
            }
            return nil
        }
        ...
        destroy(){ 
            ...
            emit PromotionDestroyed(id: self.id, host: self.host, campaignName: self.campaignName)
        }
    }
    ...
    pub resource Promotions: PromotionsPublic, PromotionsAccountAccess, MetadataViews.ResolverCollection{ 
        ...
        pub fun createPublicMinter(nftFile: String, nftNumberOfAccessUnits: UInt8, promotionId: UInt64, metadataId: UInt64?, variant: String){ 
            // This is passed into the PublicMinter
            let promotionsCap = getAccount((self.owner!).address).getCapability<&Promotions{PromotionsAccountAccess, PromotionsPublic, MetadataViews.ResolverCollection}>(TheFabricantAccessPass.PromotionsPublicPath)
        ...
        pub fun distributeDirectly(promotionId: UInt64, variant: String, recipient: &{TheFabricantAccessPass.TheFabricantAccessPassCollectionPublic}, numberOfAccessUnits: UInt8, file: String, metadataId: UInt64?){ 
    ...
    pub resource interface IPublicMinter{ 
        ...
        pub fun mintUsingNftRefs(receiver: &{TheFabricantAccessPass.TheFabricantAccessPassCollectionPublic}, refs: [&AnyResource{NonFungibleToken.INFT}]?){} 
        
        pub fun mintUsingAccessToken(receiver: &{TheFabricantAccessPass.TheFabricantAccessPassCollectionPublic}, accessToken: @AccessToken){} 
    }
    ...
    pub resource PublicMinter: IPublicMinter{ 
        ...
        priv var numberOfMints: UInt64
        
        // Used to pull all the metadata down from the promotion
        priv let promotionsCap: Capability<&Promotions{PromotionsAccountAccess, PromotionsPublic, MetadataViews.ResolverCollection}>
        ...
        priv fun nftHasBeenUsedForClaim(uuid: UInt64): Bool{ 
        ...
        priv fun nftsCanBeUsedForMint(receiver: &{TheFabricantAccessPass.TheFabricantAccessPassCollectionPublic}, refs: [&AnyResource{NonFungibleToken.INFT}], promotion: &Promotion): Bool{ 
        ...
        priv fun addressHasClaimedMaxTheFabricantAccessPassLimit(address: Address): Bool{ 
        ...
        priv fun accessTokenIsValid(receiver: &{TheFabricantAccessPass.TheFabricantAccessPassCollectionPublic}, accessTokenOwner: Address, accessTokenPromoId: UInt64, promotion: &Promotion): Bool{ 
        ...
        priv var claimingNftUuid: UInt64?
        ...
        priv fun mintAccessPass(receiver: &{TheFabricantAccessPass.TheFabricantAccessPassCollectionPublic}){ 
            pre{ 
            ...
            promotion.updateAddressesClaimed(key: (receiver.owner!).address, TheFabricantMetadataViews.Identifier(campaignName: nft.campaignName, season: nft.season, promotionName: nft.promotionName, promotionId: nft.promotionId, variant: nft.variant, id: nft.id, serial: nft.serial, address: (receiver.owner!).address, dateReceived: nft.dateReceived, originalRecipient: nft.originalRecipient, accessUnits: nft.accessUnits, initialAccessUnits: nft.initialAccessUnits, metadataId: nft.metadataId))
        ...
        init(nftFile: String, nftNumberOfAccessUnits: UInt8, promotionId: UInt64, variant: String, nftMetadataId: UInt64?, promoCap: Capability<&Promotions{PromotionsAccountAccess, PromotionsPublic, MetadataViews.ResolverCollection}>){ 
            self.id = self.uuid
