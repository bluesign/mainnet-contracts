...
pub contract TheFabricantS2ItemNFT: NonFungibleToken{ 
    ...
    pub struct ItemData{ 
        ...
        // other metadata
        priv let metadatas:{ String: TheFabricantS2ItemNFT.Metadata}
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        priv var garment: @TheFabricantS2GarmentNFT.NFT?
        
        // this is where the material nft is stored, it cannot be moved out
        priv var material: @TheFabricantS2MaterialNFT.NFT?
    ...
    pub resource Admin{ 
        ...
        pub fun createItemDataWithAllocation(garmentDataID: UInt32, materialDataID: UInt32, primaryColor: String, secondaryColor: String, metadatas:{ String: TheFabricantS2ItemNFT.Metadata}, coCreator: Address): UInt32{ 
