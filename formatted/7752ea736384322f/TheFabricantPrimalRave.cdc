...
pub contract TheFabricantPrimalRave:
    NonFungibleToken,
    TheFabricantNFTStandardV2,
    RevealableV2{
    ...
    pub let TheFabricantPrimalRaveCollectionStoragePath: StoragePath
    
    pub let TheFabricantPrimalRaveCollectionPublicPath: PublicPath
    
    pub let TheFabricantPrimalRaveProviderStoragePath: PrivatePath
    
    pub let TheFabricantPrimalRavePublicMinterStoragePath: StoragePath
    
    pub let TheFabricantPrimalRaveAdminStoragePath: StoragePath
    
    pub let TheFabricantPrimalRavePublicMinterPublicPath: PublicPath
    ...
    pub event TraitRevealed(nftUuid: UInt64, id: UInt64, trait: String)
    ...
    pub event AdminResourceCreated(uuid: UInt64, adminAddress: Address)
    ...
    pub event AdminSetMaxSupply(maxSupply: UInt64)
    
    pub event AdminSetVariantSupply(
        variantId: UInt64,
        name: String,
        supply: UInt64
    )
    
    pub event AdminSetVariantPaymentAmount(
        variantId: UInt64,
        name: String,
        paymentAmount: UFix64
    )
    
    pub event AdminSetMintableVariants(mintableVariants: [UInt64])
    
    pub event AdminSetAddressMintLimit(addressMintLimit: UInt64)
    
    pub event AdminSetCollectionId(collectionId: String)
    ...
    access(contract) var paymentReceiverCap: Capability<
        &{FungibleToken.Receiver}
    >?
    
    access(contract) var nftMetadata:{ 
        UInt64: AnyStruct{RevealableV2.RevealableMetadata}
    }
    ...
    access(contract) var variants:{ UInt64: VariantInfo}
    
    // The variants that this contract is able to mint
    access(contract) var mintableVariants: [UInt64]
    ...
    pub struct VariantInfo{ 
        ...
        pub fun canMintSupply(): Bool{ 
            return self.totalSupply <= self.supply
        }
        
        pub fun setPaymentAmount(paymentAmount: UFix64){ 
            self.paymentAmount = paymentAmount
        }
        
        pub fun setSupply(supply: UInt64){ 
            self.supply = supply
        }
    }
    ...
    pub resource NFT:
        TheFabricantNFTStandardV2.TFNFT,
        ...
        pub fun getFullName(): String{ 
            return (
                (TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!).name!
            ).concat(" #".concat(self.editionNumber.toString()))
        }
        
        // NOTE: This is important for Edition view
        pub fun getEditionName(): String{ 
            return (TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!)
                .collection
        }
        ...
        pub fun getEditions(): MetadataViews.Editions{ 
            ...
            let edition =
                MetadataViews.Edition(
                    name: (
                        TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!
                    ).collection,
                    number: self.editionNumber,
                    max: self.maxEditionNumber
                )
            return MetadataViews.Editions(infoList: [edition])
        }
        ...
        pub fun getMedias(): MetadataViews.Medias{ 
            ...
            return MetadataViews.Medias(items: [mainImageMedia, videoMedia])
        }
        ...
        pub fun getRevealableTraits():{ String: Bool}?{ 
            return (TheFabricantPrimalRave.nftMetadata[self.id]!)
                .getRevealableTraits()
        }
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(
                storagePath: TheFabricantPrimalRave
                    .TheFabricantPrimalRaveCollectionStoragePath,
                publicPath: TheFabricantPrimalRave
                    .TheFabricantPrimalRaveCollectionPublicPath,
                providerPath: TheFabricantPrimalRave
                    .TheFabricantPrimalRaveProviderStoragePath,
                publicCollection: Type<
                    &TheFabricantPrimalRave.Collection{
                        TheFabricantPrimalRave.TheFabricantPrimalRaveCollectionPublic,
                ...
                providerLinkedType: Type<
                    &TheFabricantPrimalRave.Collection{
                        ...
                        NonFungibleToken.CollectionPublic,
                        MetadataViews.ResolverCollection,
                        TheFabricantPrimalRaveCollectionPublic
                    }
                >(),
                createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                    return <-TheFabricantPrimalRave.createEmptyCollection()
                }
            )
        }
            ...
            let squareImage =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(
                        url: "https://primalrave-collection-display.s3.eu-central-1.amazonaws.com/images/primalrave_square.png"
                    ),
                    mediaType: "image/png"
                )
            let bannerImage =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(
                        url: "https://primalrave-collection-display.s3.eu-central-1.amazonaws.com/images/primalrave_banner.png"
                    ),
                    mediaType: "image/png"
                )
            return MetadataViews.NFTCollectionDisplay(
                name: self.getEditionName(),
                description: "An exploration of the self through a club night, this collection takes inspiration from a secret rave in the forest. Elements of Dutch traditional dress in combination with 90s gabber aesthetic create a fresh narrative on what it means to explore your identity in a club night. ",
                externalURL: (TheFabricantPrimalRave.nftMetadata[self.id]!)
                    .externalURL,
                ...
                socials:{ 
                    ...
                    MetadataViews.ExternalURL(
                        "https://twitter.com/thefabricant"
                    ),
                    "instagram":
                    MetadataViews.ExternalURL(
                        "https://www.instagram.com/the_fab_ric_ant/"
                    ),
                    "facebook":
                    MetadataViews.ExternalURL(
                        "https://www.facebook.com/thefabricantdesign/"
                    ),
                    "artstation":
                    MetadataViews.ExternalURL(
                        "https://www.artstation.com/thefabricant"
                    ),
                    "behance":
                    MetadataViews.ExternalURL(
                        "https://www.behance.net/thefabricant"
                    ),
                    "linkedin":
                    MetadataViews.ExternalURL(
                        "https://www.linkedin.com/company/the-fabricant"
                    ),
                    "sketchfab":
                    MetadataViews.ExternalURL(
                        "https://sketchfab.com/thefabricant"
                    ),
                    "clolab":
                    MetadataViews.ExternalURL(
                        "https://www.clo3d.com/en/clollab/thefabricant"
                    ),
        ...
        pub fun getNFTView(): MetadataViews.NFTView{ 
            return MetadataViews.NFTView(
                ...
                royalties: (TheFabricantPrimalRave.nftMetadata[self.id]!)
                    .royalties,
            ...
            switch view{ 
                case Type<TheFabricantMetadataViewsV2.TFNFTIdentifierV1>():
                    return TheFabricantMetadataViewsV2.TFNFTIdentifierV1(
                        ...
                        name: self.getFullName(),
                        collection: (
                            TheFabricantPrimalRave.nftMetadata[
                                self.nftMetadataId
                            ]!
                        ).collection,
                ...
                case Type<TheFabricantMetadataViewsV2.TFNFTSimpleView>():
                    return TheFabricantMetadataViewsV2.TFNFTSimpleView(
                        ...
                        collectionId: TheFabricantPrimalRave.collectionId!,
                        metadata: self.getMetadata(),
                        media: self.getMedias(),
                        images: self.getImages(),
                        videos: self.getVideos(),
                        externalURL: (
                            TheFabricantPrimalRave.nftMetadata[self.id]!
                        ).externalURL,
        ...
        init(
            ...
            self.editionNumber = (TheFabricantPrimalRave.variants[variantId]!)
                    .totalSupply
            // max edition number is specific to the variant
            self.maxEditionNumber = (
                    TheFabricantPrimalRave.variants[variantId]!
                ).supply
        ...
        destroy(){ 
            emit ItemDestroyed(
                uuid: self.uuid,
                id: self.id,
                name: (TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!)
                    .name,
                description: (
                    TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!
                ).description,
    ...
    pub resource interface TheFabricantPrimalRaveCollectionPublic{ 
        pub fun borrowTheFabricantPrimalRave(
            id: UInt64
        ): &TheFabricantPrimalRave.NFT{TheFabricantPrimalRave.PublicNFT}?{} 
    ...
    pub resource Admin{ 
        ...
        pub fun setVariantSupply(supplyDict:{ UInt64: UInt64}){ 
        ...
        pub fun setVariantPaymentAmount(priceDict:{ UInt64: UFix64}){ 
        ...
        pub fun setMintableVariants(mintableVariants: [UInt64]){ 
        ...
        pub fun distributeDirectlyViaAccessList(
            ...
            assert(
                PrimalRaveVariantMintLimits.checkAddressCanMintVariant(
                    address: (receiver.owner!).address,
                    variantId: variantId
                ),
                message: "Address has already minted the maximum for this variant"
            )
            ...
            let publicPath =
                PublicPath(identifier: publicMinterPathString)
                ?? panic(
                    "Failed to construct public path from path string: ".concat(
                        publicMinterPathString
                    )
                )
            let publicMinterCap =
                getAccount((self.owner!).address).getCapability(publicPath)
                    .borrow<
                    &TheFabricantPrimalRave.PublicMinter{
                        TheFabricantPrimalRave.Minter
                    }
                >()
                ?? panic(
                    "Couldn't get publicMinter ref or pathString is wrong: "
                        .concat(publicMinterPathString)
                )
            ...
            // Create the NFT
            let license =
                publicMinterDetails["license"] as! MetadataViews.License?
            let nft <-
                create NFT(
                    variantId: variantId,
            ...
            let externalURL =
                publicMinterDetails["externalURL"]
                as!
                MetadataViews.ExternalURL?
            let coCreatable = publicMinterDetails["coCreatable"] as! Bool?
            let revealableTraits =
                publicMinterDetails["revealableTraits"] as!{ String: Bool}?
            let royalties =
                publicMinterDetails["royalties"] as! MetadataViews.Royalties?
            let royaltiesTFMarketplace =
                publicMinterDetails["royaltiesTFMarketplace"]
                as!
                TheFabricantMetadataViewsV2.Royalties?
            
            //Create the nftMetadata
            TheFabricantPrimalRave.createNftMetadata(
                id: nft.id,
                nftUuid: nft.uuid,
                variantId: variantId,
            ...
            emit ItemMintedAndTransferred(
                uuid: nft.uuid,
                id: nft.id,
                name: (TheFabricantPrimalRave.nftMetadata[nft.nftMetadataId]!)
                    .name,
                description: (
                    TheFabricantPrimalRave.nftMetadata[nft.nftMetadataId]!
                ).description,
                collection: (
                    TheFabricantPrimalRave.nftMetadata[nft.nftMetadataId]!
                ).collection,
            ...
            if TheFabricantPrimalRave.addressMintCount[
                (receiver.owner!).address
            ]
            != nil{ 
                TheFabricantPrimalRave.addressMintCount[
                    (receiver.owner!).address
                ] = TheFabricantPrimalRave.addressMintCount[
                        (receiver.owner!).address
                    ]!
            ...
            PrimalRaveVariantMintLimits.incrementVariantMintsForAddress(
                address: (receiver.owner!).address,
                variantId: variantId
            )
        }
        ...
        pub fun createPublicMinter(
            ...
            let publicMinter: @TheFabricantPrimalRave.PublicMinter <-
                create PublicMinter(
                    name: name,
            ...
            let publicMinterStoragePath =
                StoragePath(identifier: publicMinter.path)
            let publicMinterPublicPath =
                PublicPath(identifier: publicMinter.path)
            TheFabricantPrimalRave.account.save(
                <-publicMinter,
                to: publicMinterStoragePath!
            )
            TheFabricantPrimalRave.account.link<&PublicMinter{Minter}>(
                publicMinterPublicPath!,
                target: publicMinterStoragePath!
            )
        }
        
        pub fun revealTraits(
            nftMetadataId: UInt64,
            traits: [{
                RevealableV2.RevealableTrait}
            ]
        ){ 
            let nftMetadata =
                TheFabricantPrimalRave.nftMetadata[nftMetadataId]!
                as!
                TheFabricantPrimalRave.RevealableMetadata
    ...
    pub resource PublicMinter:
        TheFabricantNFTStandardV2.TFNFTPublicMinter,
        Minter{
        ...
        pub fun mintUsingAccessList(
            ...
            assert(
                payment.balance
                == (TheFabricantPrimalRave.variants[variantId]!).paymentAmount,
            ...
            if (TheFabricantPrimalRave.variants[variantId]!).paymentAmount
            != 0.0{ 
            ...
            ((              // Deposit has to occur outside of above if statement as resource must be moved or destroyed
              TheFabricantPrimalRave.paymentReceiverCap!).borrow()!).deposit(
                from: <-payment
            )
            let nft <-
                create NFT(
        ...
        init(
            ...
            let pathString =
                "TheFabricantNFTPublicMinter_TheFabricantPrimalRave_".concat(
                    self.uuid.toString()
                )
    ...
    access(contract) fun createNftMetadata(
        ...
        assert(
            TheFabricantPrimalRave.mintableVariants.contains(variantId),
            message: "Variant is not mintable"
        )
        assert(
            (TheFabricantPrimalRave.variants[variantId]!).canMintSupply(),
            message: "Variant has hit max supply for variant"
        )
        
        // Get variant specific metadata
        let name: String = (TheFabricantPrimalRave.variants[variantId]!).name
        let description: String =
            (TheFabricantPrimalRave.variants[variantId]!).description
        var metadata:{ String: String} ={
            
                "mainImage":
                (TheFabricantPrimalRave.baseTokenURI!).concat("/").concat(
                    variantId.toString()
                ).concat(".png"),
                "video":
                (TheFabricantPrimalRave.baseTokenURI!).concat("/").concat(
    ...
    priv fun nftsCanBeUsedForMint(
        receiver: &{NonFungibleToken.CollectionPublic},
        refs: [
            &AnyResource{NonFungibleToken.INFT}
        ],
        typeRestrictions: [
            Type
        ]
        ...
        assert(
            ...
            message: "There are no type restrictions for this promotion"
        )
        var i = 0
        while i < refs.length{ 
    ...
    pub fun getNftMetadatas():{ 
        UInt64: AnyStruct{RevealableV2.RevealableMetadata}
    }{ 
        return self.nftMetadata
    }
    
    pub fun getVariantInfo(variantId: UInt64): VariantInfo?{ 
        return TheFabricantPrimalRave.variants[variantId]
    }
    
    pub fun getVariants():{ UInt64: VariantInfo}{ 
        return TheFabricantPrimalRave.variants
    }
    
    pub fun getVariantSupplies():{ UInt64:{ String: UInt64}}{ 
    ...
    pub fun getMintableVariants(): [UInt64]{ 
    ...
    init(){ 
        ...
        self.maxSupply = v1Supply + v2Supply + v3Supply + v4Supply + v5Supply
            + v6Supply
            + v7Supply
            + v8Supply
        self.variants ={ 
                ...
                VariantInfo(
                    id: 3,
                    name: "Skullfck",
                    description: "Take a good look at yourself in the mirror. Are you accepting all of you? Or does your darkness catch you off guard? Does it scare you, or can you fully accept it? We all have parts of ourselves we hide, but to embrace them is key to becoming whole.",
                    paymentAmount: 30.0,
                    supply: v3Supply
                ),
                4:
                VariantInfo(
                    id: 4,
                    name: "Pump Boots",
                    description: "Dance from dusk till dawn in these platform pumps, emblazoned with the iconic acid house smiley and sad face. Featuring neon detailing across the vamp and heel, lighting the way on even the darkest dance floors.",
                    paymentAmount: 0.0,
                    supply: v4Supply
                ),
                5:
                ...
                VariantInfo(
                    ...
                    description: "Your core is shaking. Foundations are melting. When you accept your whole self, the ground will melt away under your feet first. If you let yourself melt, accept it fully, only then can you rise from the dark waters.",
                    paymentAmount: 50.0,
                    supply: v6Supply
                ),
                7:
                ...
                VariantInfo(
                    id: 8,
                    name: "Lace Boots",
                    description: "Extended version of the pumps boots reaching knee high with fitted fluorescent backs and open front laced up. Neon detailing across the vamp and heel, lighting the way on the darkest dance floors.",
                    paymentAmount: 0.0,
                    supply: v8Supply
                )
            }
        ...
        self
            .TheFabricantPrimalRaveCollectionStoragePath = /storage/TheFabricantPrimalRaveCollectionStoragePath
        self
            .TheFabricantPrimalRaveCollectionPublicPath = /public/TheFabricantPrimalRaveCollectionPublicPath
        self
            .TheFabricantPrimalRaveProviderStoragePath = /private/TheFabricantPrimalRaveProviderStoragePath
        self
            .TheFabricantPrimalRaveAdminStoragePath = /storage/TheFabricantPrimalRaveAdminStoragePath
        self
            .TheFabricantPrimalRavePublicMinterStoragePath = /storage/TheFabricantPrimalRavePublicMinterStoragePath
        self
            .TheFabricantPrimalRavePublicMinterPublicPath = /public/TheFabricantPrimalRavePublicMinterPublicPath
        self.account.save(
            <-create Admin(adminAddress: self.account.address),
            to: self.TheFabricantPrimalRaveAdminStoragePath
        )
