...
pub contract StudentsofTheGame: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                StudentsofTheGame.totalSupply = StudentsofTheGame.totalSupply - self.balance
            }
        }
    }
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(storagePath: StudentsofTheGame.VaultStoragePath, receiverPath: StudentsofTheGame.ReceiverPublicPath, metadataPath: StudentsofTheGame.VaultPublicPath, providerPath: /private/StudentsofTheGameVault, receiverLinkedType: Type<&Vault{FungibleToken.Receiver}>(), metadataLinkedType: Type<&Vault{FungibleToken.Balance, MetadataViews.Resolver}>(), providerLinkedType: Type<&Vault{FungibleToken.Provider}>(), createEmptyVaultFunction: fun (): @Vault{ 
                        return <-StudentsofTheGame.createEmptyVault()
                    })
        }
        return nil
    }
