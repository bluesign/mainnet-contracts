...
pub contract SwoleDoge: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                SwoleDoge.totalSupply = SwoleDoge.totalSupply - self.balance
            }
        }
    }
