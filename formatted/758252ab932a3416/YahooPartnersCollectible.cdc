...
pub contract YahooPartnersCollectible: NonFungibleToken{ 
    ...
    pub struct Metadata{ 
        ...
        // additional metadata
        priv let additional:{ String: String}
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: YahooPartnersCollectible.CollectionStoragePath, publicPath: YahooPartnersCollectible.CollectionPublicPath, providerPath: /private/yahooPartnersCollectibleCollection, publicCollection: Type<&YahooPartnersCollectible.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, YahooPartnersCollectible.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&YahooPartnersCollectible.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, YahooPartnersCollectible.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&YahooPartnersCollectible.Collection>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &YahooPartnersCollectible.NFT?{ 
        let collection = (getAccount(from).getCapability(YahooPartnersCollectible.CollectionPublicPath)!).borrow<&YahooPartnersCollectible.Collection>() ?? panic("Couldn't get collection")
