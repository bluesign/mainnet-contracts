...
pub contract YahooCollectible: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: YahooCollectible.CollectionStoragePath, publicPath: YahooCollectible.CollectionPublicPath, providerPath: /private/yahooCollectibleCollection, publicCollection: Type<&YahooCollectible.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, YahooCollectible.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&YahooCollectible.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, YahooCollectible.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&YahooCollectible.Collection>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &YahooCollectible.NFT?{ 
        let collection = (getAccount(from).getCapability(YahooCollectible.CollectionPublicPath)!).borrow<&YahooCollectible.Collection>() ?? panic("Couldn't get collection")
