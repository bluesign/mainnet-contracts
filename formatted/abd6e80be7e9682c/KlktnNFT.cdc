...
pub contract KlktnNFT: NonFungibleToken{ 
    ...
    priv var klktnNFTTypeSet:{ UInt64: KlktnNFTMetadata}
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &KlktnNFT.NFT?{ 
        let collection = getAccount(from).getCapability(KlktnNFT.CollectionPublicPath).borrow<&KlktnNFT.Collection{KlktnNFT.KlktnNFTCollectionPublic}>() ?? panic("Couldn't get collection")
