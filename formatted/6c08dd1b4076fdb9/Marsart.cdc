...
pub contract Marsart: NonFungibleToken{ 
    ...
    pub event Minted(id: UInt64, name: String, artist: String, artistIntroduction: String, artworkIntroduction: String, typeId: UInt64, type: String, description: String, ipfsLink: String, MD5Hash: String, serialNumber: UInt32, totalNumber: UInt32)
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, artist: String, artistIntroduction: String, artworkIntroduction: String, typeId: UInt64, type: String, description: String, ipfsLink: String, MD5Hash: String, serialNumber: UInt32, totalNumber: UInt32){ 
            ...
            recipient.deposit(token: <-create Marsart.NFT(initID: Marsart.totalSupply, data: NFTData(name: name, artist: artist, artistIntroduction: artistIntroduction, artworkIntroduction: artworkIntroduction, typeId: typeId, type: type, description: description, ipfsLink: ipfsLink, MD5Hash: MD5Hash, serialNumber: serialNumber, totalNumber: totalNumber)))
        }
    }
