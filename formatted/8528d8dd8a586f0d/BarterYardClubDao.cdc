...
pub contract BarterYardClubDao: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                BarterYardClubDao.totalSupply = BarterYardClubDao.totalSupply - self.balance
            }
        }
    }
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(storagePath: BarterYardClubDao.VaultStoragePath, receiverPath: BarterYardClubDao.ReceiverPublicPath, metadataPath: BarterYardClubDao.VaultPublicPath, providerPath: /private/BarterYardClubDaoVault, receiverLinkedType: Type<&Vault{FungibleToken.Receiver}>(), metadataLinkedType: Type<&Vault{FungibleToken.Balance, MetadataViews.Resolver}>(), providerLinkedType: Type<&Vault{FungibleToken.Provider}>(), createEmptyVaultFunction: fun (): @Vault{ 
                        return <-BarterYardClubDao.createEmptyVault()
                    })
        }
        return nil
    }
