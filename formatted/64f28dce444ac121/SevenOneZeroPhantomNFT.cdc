...
pub contract SevenOneZeroPhantomNFT: NonFungibleToken{ 
    ...
    priv var externalURL: String
    
    priv var maxAmount: UInt64
    
    // Variable size dictonary of PhantomData structs
    priv var phantomData:{ UInt64: PhantomData}
    ...
    pub struct PhantomData{ 
        ...
        priv let ipfsMetadataHash: String
        
        priv let traits:{ PhantomTrait: String}
    ...
    pub resource Admin{ 
        ...
        priv fun updatePhantomData(nftID: UInt64, ipfsMetadataHash: String, metadata:{ String: String}, traits:{ SevenOneZeroPhantomNFT.PhantomTrait: String}){ 
