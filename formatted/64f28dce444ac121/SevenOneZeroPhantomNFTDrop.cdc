...
pub contract SevenOneZeroPhantomNFTDrop{ 
    ...
    priv var accessSupply: UInt32
    
    priv let maxAccessSupply: UInt32
    
    priv var accessSaleSupply: UInt32
    
    priv let maxAccessSaleSupply: UInt32
    
    priv var regularSupply: UInt32
    
    priv let maxRegularSupply: UInt32
    
    priv var regularSaleSupply: UInt32
    
    priv let maxRegularSaleSupply: UInt32
    
    priv var sessionIDsMinted:{ String: Bool}
    
    priv var accessPhantomIDs:{ UInt64: UInt32}
    
    priv var regularPhantomIDs:{ UInt64: UInt32}
    
    priv fun incrementRegularPhantomCount(
    ...
    priv fun incrementAccessPhantomCount(
        adminRef: &SevenOneZeroPhantomNFT.Admin,
        nftID: UInt64,
        isFromSale: Bool
    ): UInt32{ 
    ...
    pub fun batchIncrementRegularPhantomCount(
        adminRef: &SevenOneZeroPhantomNFT.Admin,
        nftIDs: [
            UInt64
        ],
    ...
    pub fun batchIncrementAccessPhantomCount(
        adminRef: &SevenOneZeroPhantomNFT.Admin,
        nftIDs: [
            UInt64
        ],
