...
pub contract LCubeTicket: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: LCubeTicket.CollectionStoragePath, publicPath: LCubeTicket.CollectionPublicPath, providerPath: /private/LCubeNFTCollection, publicCollection: Type<&LCubeTicket.Collection{LCubeTicketCollectionPublic}>(), publicLinkedType: Type<&LCubeTicket.Collection{LCubeTicket.LCubeTicketCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&LCubeTicket.Collection{LCubeTicket.LCubeTicketCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource TicketMinter{ 
        priv let eventID: UInt64
        
        init(eventID: UInt64){ 
            self.eventID = eventID
        }
        
        priv fun createTicket(creatorAddress: Address, startOfUse: UFix64, metadata:{ String: String}, royalties: [MetadataViews.Royalty], itemCount: UInt8): @LCubeTicket.NFT{ 
