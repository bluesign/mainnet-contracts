...
pub contract LCubePack: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: LCubePack.CollectionStoragePath, publicPath: LCubePack.CollectionPublicPath, providerPath: /private/LCubeNFTCollection, publicCollection: Type<&LCubePack.Collection{LCubePackCollectionPublic}>(), publicLinkedType: Type<&LCubePack.Collection{LCubePack.LCubePackCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&LCubePack.Collection{LCubePack.LCubePackCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource PackMinter{ 
        priv let gameID: UInt64
        
        init(gameID: UInt64){ 
            self.gameID = gameID
        }
        
        priv fun createPack(creatorAddress: Address, startOfUse: UFix64, metadata:{ String: String}, royalties: [MetadataViews.Royalty], itemCount: UInt8): @LCubePack.NFT{ 
