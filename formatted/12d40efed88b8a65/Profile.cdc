...
pub contract Profile{ 
    ...
    pub resource User: Public, Owner{ 
        ...
        priv var coverPhoto: String
        
        priv var links:{ String: String}
        ...
        pub fun setLinks(_ val:{ String: String}){ 
            self.links = val
        }
    }
