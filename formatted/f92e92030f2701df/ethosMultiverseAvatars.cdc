...
pub contract ethosMultiverseAvatars: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ethosMultiverseAvatars.CollectionStoragePath, publicPath: ethosMultiverseAvatars.CollectionPublicPath, providerPath: ethosMultiverseAvatars.CollectionPrivatePath, publicCollection: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, NonFungibleToken.Provider}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-ethosMultiverseAvatars.createEmptyCollection()
                        })
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowEntireNFT(id: UInt64): &ethosMultiverseAvatars.NFT?{} 
    }
    ...
    init(_collectionName: String, _description: String, _imagePath: String, _bannerImagePath: String?, _minting: Bool, _ipfsCID: String){ 
        ...
        self.account.link<&ethosMultiverseAvatars.Collection{NonFungibleToken.CollectionPublic, ethosMultiverseAvatars.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
        
        // Create a private capability fot the admin resource
        self.account.link<&ethosMultiverseAvatars.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get Admin capability")
