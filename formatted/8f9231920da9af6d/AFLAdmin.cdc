...
pub contract AFLAdmin{ 
    ...
    pub resource Admin{ 
        pub fun createTemplate(
            ...
            return AFLNFT.createTemplate(
                maxSupply: maxSupply,
                immutableData: immutableData
            )
        }
        
        pub fun updateImmutableData(
            templateID: UInt64,
            immutableData:{ 
                String: AnyStruct
            }
            ...
            let templateRef =
                &AFLNFT.allTemplates[templateID] as &AFLNFT.Template?
            templateRef?.updateImmutableData(immutableData)
        ...
        pub fun withdrawTokenFromBurnExchange(
            nftId: UInt64
