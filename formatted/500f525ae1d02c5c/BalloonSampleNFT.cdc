...
pub contract BalloonSampleNFT: NonFungibleToken{ 
    ...
    pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, rgbColor: String, inflation: UInt64){ 
    ...
    init(){ 
        ...
        self.account.link<&BalloonSampleNFT.Collection{NonFungibleToken.CollectionPublic, BalloonSampleNFT.BalloonSampleNFTCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
