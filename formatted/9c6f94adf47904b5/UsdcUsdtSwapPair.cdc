...
pub contract UsdcUsdtSwapPair: FungibleToken{ 
    ...
    pub fun createEmptyTokenBundle(): @UsdcUsdtSwapPair.TokenBundle{ 
        return <-create TokenBundle(fromToken1: <-(FiatToken.createEmptyVault() as! @FiatToken.Vault), fromToken2: <-(TeleportedTetherToken.createEmptyVault() as! @TeleportedTetherToken.Vault))
    }
