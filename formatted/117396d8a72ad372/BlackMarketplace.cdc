...
pub contract BlackMarketplace{ 
    ...
    pub resource interface SalePublic{ 
        pub fun purchaseWithWhitelist(
            tokenID: UInt64,
            recipientCap: Capability<
                &{NFTDayTreasureChest.NFTDayTreasureChestCollectionPublic}
            >,
            buyTokens: @FungibleToken.Vault
        ){} 
        
        pub fun purchaseWithTreasureChest(
            tokenID: UInt64,
            recipientCap: Capability<
                &{NFTDayTreasureChest.NFTDayTreasureChestCollectionPublic}
            >,
    ...
    pub resource SaleCollection: SalePublic{ 
        priv var forSale: @{UInt64: NFTDayTreasureChest.NFT}
