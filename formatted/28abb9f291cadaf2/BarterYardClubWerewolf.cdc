...
pub contract BarterYardClubWerewolf: NonFungibleToken{ 
    ...
    /**********//* TRAITS *//**********//// NftTrait is the trait struct meant to be set into NFTs
    pub struct NftTrait{ 
        pub let id: UInt8
    ...
    /*******//* NFT *//*******//// ImageType is an enum to manage the different types of image the NFT holds
    ...
    pub resource interface Werewolf{ 
        /*******************//* NFT information *//*******************/        pub let id: UInt64 // eg: 1
        ...
        /********************//* Image management *//********************//// All images IPFS files
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: BarterYardClubWerewolf.CollectionStoragePath, publicPath: BarterYardClubWerewolf.CollectionPublicPath, providerPath: BarterYardClubWerewolf.CollectionPrivatePath, publicCollection: Type<&BarterYardClubWerewolf.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&BarterYardClubWerewolf.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&BarterYardClubWerewolf.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-BarterYardClubWerewolf.createEmptyCollection()
                        })
    ...
    /**************//* COLLECTION *//**************/    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
    ...
    priv fun burnNFT(){ 
        self            // Check NFT ownership from caller?
            .totalSupply = self.totalSupply - 1
    }
    ...
    pub resource Admin{ 
        ...
        pub fun mintNFT(name: String, description: String, attributes: [NftTrait; 8], dayImage: MetadataViews.IPFSFile, nightImage: MetadataViews.IPFSFile, animation: MetadataViews.IPFSFile): @BarterYardClubWerewolf.NFT{ 
            // create a new NFT
    ...
    init(){ 
        ...
        self.account.link<&BarterYardClubWerewolf.Collection{NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
