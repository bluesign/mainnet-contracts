...
pub contract FriendsOfFlow_NFT: NonFungibleToken{ 
    
    // FriendsOfFlow_NFT Events
    //
    // Emitted when the FriendsOfFlow_NFT contract is created
    ...
    // totalSupply
    // The total number of FriendsOfFlow_NFT that have been minted
    //
    ...
    // A Series is special resource type that contains functions to mint FriendsOfFlow_NFT NFTs, 
    ...
    pub resource Series{ 
        ...
        init(seriesId: UInt32, metadata:{ String: String}){ 
            ...
            self.setIds = []
            self.setSealedState ={} 
            FriendsOfFlow_NFT.seriesData[seriesId] = SeriesData(seriesId: seriesId, metadata: metadata)
        ...
        pub fun addNftSet(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            ...
            FriendsOfFlow_NFT.setData[setId] = newNFTSet
        ...
        pub fun updateSeriesMetadata(metadata:{ String: String}){ 
            ...
            FriendsOfFlow_NFT.seriesData[self.seriesId] = newSeriesMetadata
        ...
        pub fun updateSetMetadata(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            ...
            FriendsOfFlow_NFT.setData[setId] = newSetMetadata
            emit SetMetadataUpdated(seriesId: self.seriesId, setId: setId)
        }
        
        // mintFriendsOfFlow_NFT
        // Mints a new NFT with a new ID
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintFriendsOfFlow_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= FriendsOfFlow_NFT.getSetMaxEditions(setId: setId)!:
            ...
            recipient.deposit(token: <-create FriendsOfFlow_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: editionNum))
            
            // Increment the count of global NFTs 
            FriendsOfFlow_NFT.totalSupply = FriendsOfFlow_NFT.totalSupply + 1 as UInt64
            
            // Update the count of Editions minted in the set
            self.numberEditionsMintedPerSet[setId] = editionNum
        }
        
        // mintEditionFriendsOfFlow_NFT
        // Mints a new NFT with a new ID and specific edition Num (random open edition)
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintEditionFriendsOfFlow_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32, edition: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= FriendsOfFlow_NFT.getSetMaxEditions(setId: setId)!:
            ...
            // deposit it in the recipient's account using their reference
            recipient.deposit(token: <-create FriendsOfFlow_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: edition))
        ...
        // batchMintFriendsOfFlow_NFT
        // Mints multiple new NFTs given and deposits the NFTs
        // into the recipients collection using their collection reference
        pub fun batchMintFriendsOfFlow_NFT(recipient: &{NonFungibleToken.CollectionPublic}, setId: UInt32, tokenIds: [UInt64]){ 
            pre{ 
                tokenIds.length > 0:
                    "Number of token Ids must be > 0"
            }
            for tokenId in tokenIds{ 
                self.mintFriendsOfFlow_NFT(recipient: recipient, tokenId: tokenId, setId: setId)
            }
        }
    ...
    // A resource that represents the FriendsOfFlow_NFT NFT
    //
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(tokenId: UInt64, setId: UInt32, editionNum: UInt32){ 
            ...
            let seriesId = FriendsOfFlow_NFT.getSetSeriesId(setId: setId)!
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "name")!, description: FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "description")!, thumbnail: MetadataViews.HTTPFile(url: FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!))
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(self.id)
                case Type<MetadataViews.Editions>():
                    let maxEditions = FriendsOfFlow_NFT.setData[self.setId]?.maxEditions ?? 0
                    let editionName = FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "name")!
                ...
                case Type<MetadataViews.ExternalURL>():
                    if let externalBaseURL = FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "external_token_base_url"){ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    for metadataKey in (FriendsOfFlow_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 13{ 
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_"{ 
                                ...
                                let royaltyAddress = FriendsOfFlow_NFT.convertStringToAddress(FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_addr_".concat(royaltyName))!)!
                                let royaltyReceiver: PublicPath = PublicPath(identifier: FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_rcv_".concat(royaltyName))!)!
                                let royaltyCut = FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_cut_".concat(royaltyName))!
                                let cutValue: UFix64 = FriendsOfFlow_NFT.royaltyCutStringToUFix64(royaltyCut)
                                if cutValue != 0.0{ 
                                    royalties.append(MetadataViews.Royalty(receiver: getAccount(royaltyAddress).getCapability<&FungibleToken.Vault{FungibleToken.Receiver}>(royaltyReceiver), cut: cutValue, description: FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!))
                                }
                            }
                        }
                    }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FriendsOfFlow_NFT.CollectionStoragePath, publicPath: FriendsOfFlow_NFT.CollectionPublicPath, providerPath: /private/FriendsOfFlow_NFT, publicCollection: Type<&FriendsOfFlow_NFT.Collection{FriendsOfFlow_NFT.FriendsOfFlow_NFTCollectionPublic, NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&FriendsOfFlow_NFT.Collection{FriendsOfFlow_NFT.FriendsOfFlow_NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FriendsOfFlow_NFT.Collection{FriendsOfFlow_NFT.FriendsOfFlow_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-FriendsOfFlow_NFT.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.gigantik.io/friendsofflow/square.png"), mediaType: "image/png")
                    let bannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.gigantik.io/friendsofflow/banner.png"), mediaType: "image/png")
                    ...
                    for metadataKey in (FriendsOfFlow_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 18{ 
                            if metadataKey.slice(from: 0, upTo: 18) == "collection_social_"{ 
                                ...
                                socials.insert(key: metadataKey.slice(from: 18, upTo: metadataKey.length), MetadataViews.ExternalURL(FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!))
                            }
                        }
                    }
                    return MetadataViews.NFTCollectionDisplay(name: FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "", description: FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "", externalURL: MetadataViews.ExternalURL(FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""), squareImage: squareImage, bannerImage: bannerImage, socials: socials)
                    ...
                    for metadataKey in (FriendsOfFlow_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 6{ 
                            if metadataKey.slice(from: 0, upTo: 6) == "trait_"{ 
                                ...
                                traitDictionary.insert(key: metadataKey.slice(from: 6, upTo: metadataKey.length), FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!)
                            }
                        }
                    }
                    return MetadataViews.dictToTraits(dict: traitDictionary, excludedNames: [])
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: MetadataViews.HTTPFile(url: FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "image")!), mediaType: self.getMimeType())])
            }
            return nil
        }
        
        pub fun getMimeType(): String{ 
            var metadataFileType = (FriendsOfFlow_NFT.getSetMetadataByField(setId: self.setId, field: "image_file_type")!).toLower()
    ...
    pub resource Admin{ 
        pub fun addSeries(seriesId: UInt32, metadata:{ String: String}){ 
            pre{ 
                FriendsOfFlow_NFT.series[seriesId] == nil:
            ...
            FriendsOfFlow_NFT.series[seriesId] <-! newSeries
        }
        ...
        pub fun borrowSeries(seriesId: UInt32): &Series{ 
            ...
            return (&FriendsOfFlow_NFT.series[seriesId] as &Series?)!
        }
    ...
    // to allow others to deposit FriendsOfFlow_NFT into their Collection. It also allows for reading
    // the details of FriendsOfFlow_NFT in the Collection.
    pub resource interface FriendsOfFlow_NFTCollectionPublic{ 
        ...
        pub fun borrowFriendsOfFlow_NFT(id: UInt64): &FriendsOfFlow_NFT.NFT?{ 
            // If the result isn't nil, the id of the returned reference
            // should be the same as the argument to the function
            post{ 
                result == nil || result?.id == id:
                    "Cannot borrow FriendsOfFlow_NFT reference: The ID of the returned reference is incorrect"
            }
        }
    }
    
    // Collection
    // A collection of FriendsOfFlow_NFT NFTs owned by an account
    //
    pub resource Collection: FriendsOfFlow_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        //
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let token <- token as! @FriendsOfFlow_NFT.NFT
        ...
        // borrowFriendsOfFlow_NFT
        // Gets a reference to an NFT in the collection as a FriendsOfFlow_NFT,
        // exposing all of its fields.
        // This is safe as there are no functions that can be called on the FriendsOfFlow_NFT.
        //
        pub fun borrowFriendsOfFlow_NFT(id: UInt64): &FriendsOfFlow_NFT.NFT?{ 
            let ref = &self.ownedNFTs[id] as auth &NonFungibleToken.NFT?
            return ref as! &FriendsOfFlow_NFT.NFT?
        }
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            let FriendsOfFlow_NFTNft = nft as! &FriendsOfFlow_NFT.NFT
            return FriendsOfFlow_NFTNft as &AnyResource{MetadataViews.Resolver}
        }
    ...
    // fetch
    // Get a reference to a FriendsOfFlow_NFT from an account's Collection, if available.
    // If an account does not have a FriendsOfFlow_NFT.Collection, panic.
    ...
    //
    pub fun fetch(_ from: Address, id: UInt64): &FriendsOfFlow_NFT.NFT?{ 
        let collection = getAccount(from).getCapability(FriendsOfFlow_NFT.CollectionPublicPath).borrow<&FriendsOfFlow_NFT.Collection{FriendsOfFlow_NFT.FriendsOfFlow_NFTCollectionPublic}>() ?? panic("Couldn't get collection")
        // We trust FriendsOfFlow_NFT.Collection.borrowFriendsOfFlow_NFT to get the correct id
        // (it checks it before returning it).
        return collection.borrowFriendsOfFlow_NFT(id: id)
    }
    
    // getAllSeries returns all the sets
    //
    // Returns: An array of all the series that have been created
    pub fun getAllSeries(): [FriendsOfFlow_NFT.SeriesData]{ 
        return FriendsOfFlow_NFT.seriesData.values
    }
    
    // getAllSets returns all the sets
    //
    // Returns: An array of all the sets that have been created
    pub fun getAllSets(): [FriendsOfFlow_NFT.NFTSetData]{ 
        return FriendsOfFlow_NFT.setData.values
    }
    ...
    pub fun getSeriesMetadata(seriesId: UInt32):{ String: String}?{ 
        return FriendsOfFlow_NFT.seriesData[seriesId]?.getMetadata()
    }
    ...
    pub fun getSetMaxEditions(setId: UInt32): UInt32?{ 
        return FriendsOfFlow_NFT.setData[setId]?.maxEditions
    }
    ...
    pub fun getSetMetadata(setId: UInt32):{ String: String}?{ 
        return FriendsOfFlow_NFT.setData[setId]?.getMetadata()
    }
    ...
    pub fun getSetSeriesId(setId: UInt32): UInt32?{ 
        return FriendsOfFlow_NFT.setData[setId]?.seriesId
    }
    ...
    pub fun getIpfsMetadataHashByNftEdition(setId: UInt32, editionNum: UInt32): String?{ 
        ...
        if let set = FriendsOfFlow_NFT.setData[setId]{ 
    ...
    init(){ 
        // Set named paths
        self.CollectionStoragePath = /storage/FriendsOfFlow_NFTCollection
        self.CollectionPublicPath = /public/FriendsOfFlow_NFTCollection
        self.AdminStoragePath = /storage/FriendsOfFlow_NFTAdmin
        self.AdminPrivatePath = /private/FriendsOfFlow_NFTAdminUpgrade
        ...
        self.account.link<&FriendsOfFlow_NFT.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
