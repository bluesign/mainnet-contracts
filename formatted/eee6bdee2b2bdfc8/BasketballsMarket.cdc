...
pub contract BasketballsMarket{ 
    ...
    pub resource SaleOffer: SaleOfferPublicView{ 
        ...
        priv let sellerItemProvider: Capability<&Basketballs.Collection{NonFungibleToken.Provider}>
        ...
        //
        pub fun accept(buyerCollection: &Basketballs.Collection{NonFungibleToken.Receiver}, buyerPayment: @FungibleToken.Vault){ 
            pre{ 
        ...
        //
        init(sellerItemProvider: Capability<&Basketballs.Collection{NonFungibleToken.Provider}>, saleItemID: UInt64, sellerPaymentReceiver: Capability<&{FungibleToken.Receiver}>, salePrice: UFix64){ 
            pre{ 
    ...
    pub fun createSaleOffer(
        sellerItemProvider: Capability<
            &Basketballs.Collection{NonFungibleToken.Provider}
        >,
        saleItemID: UInt64,
