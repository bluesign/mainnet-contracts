        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(recipient: getAccount(0x6349b46b05716b13).getCapability<&AnyResource{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath()), cut: 0.05, // just in case somebody put the NFT for "secondary sale" description: "FridgeMagnet takes 5% secondary sales royalty")])
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FridgeMagnet.CollectionStoragePath, publicPath: FridgeMagnet.CollectionPublicPath, providerPath: /private/CollectionPrivatePath, publicCollection: Type<&FridgeMagnet.Collection{FridgeMagnet.NFTCollectionPublic}>(), publicLinkedType: Type<&FridgeMagnet.Collection{FridgeMagnet.NFTCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FridgeMagnet.Collection{FridgeMagnet.NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
