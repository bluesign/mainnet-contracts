...
pub contract DisruptArt: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv fun getFlowRoyaltyReceiverPublicPath(): PublicPath{ 
            return /public/flowTokenReceiver
        }
        
        // fn to get the royality details
        priv fun genRoyalities(): [MetadataViews.Royalty]{ 
            var royalties: [MetadataViews.Royalty] = []
            
            // Creator Royalty
            royalties.append(MetadataViews.Royalty(receiver: getAccount(self.creator!).getCapability<&FungibleToken.Vault{FungibleToken.Receiver}>(self.getFlowRoyaltyReceiverPublicPath()), cut: UFix64(0.1), description: "Creator Royalty"))
            return royalties
        }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: DisruptArt.disruptArtStoragePath, publicPath: DisruptArt.disruptArtPublicPath, providerPath: /private/DisruptArtNFTCollection, publicCollection: Type<&DisruptArt.Collection{DisruptArt.DisruptArtCollectionPublic}>(), publicLinkedType: Type<&DisruptArt.Collection{DisruptArt.DisruptArtCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&DisruptArt.Collection{DisruptArt.DisruptArtCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
