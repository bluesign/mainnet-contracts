...
pub contract Shard: NonFungibleToken{ 
    ...
    priv var moments:{ UInt32: Moment}
    
    // Variable size dictionary of Clip structs
    priv var clips:{ UInt32: Clip}
    ...
    pub resource Admin{ 
        ...
        pub fun createClip(momentID: UInt32, sequence: UInt8, metadata:{ String: String}): UInt32{ 
            // Create the new Clip
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, clipID: UInt32){ 
        ...
        pub fun batchMintNFT(recipient: &{NonFungibleToken.CollectionPublic}, clipID: UInt32, quantity: UInt64){ 
            var i: UInt64 = 0
            while i < quantity{ 
    ...
    init(){ 
        ...
        self.account.link<&{NonFungibleToken.CollectionPublic}>(/public/EternalShardCollection, target: /storage/EternalShardCollection)
