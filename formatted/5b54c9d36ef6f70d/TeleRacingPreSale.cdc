...
pub contract TeleRacingPreSale: NonFungibleToken{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, thumbnail: String, editionNumber: UInt64, maxEdition: UInt64){ 
    ...
    init(){ 
        ...
        self.account.link<&TeleRacingPreSale.Collection{NonFungibleToken.CollectionPublic, TeleRacingPreSale.TeleRacingPreSaleCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
