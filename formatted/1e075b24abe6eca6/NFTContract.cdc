...
pub contract NFTContract: NonFungibleToken{ 
    ...
    pub resource AdminResource: UserSpecialCapability, NFTMethodsCapability{ 
        ...
        pub fun mintNFT(templateId: UInt64, account: Address){ 
            ...
            let recipientCollection = receiptAccount.getCapability(NFTContract.CollectionPublicPath).borrow<&{NonFungibleToken.CollectionPublic}>() ?? panic("Could not get receiver reference to the NFT Collection")
