...
pub contract FEHVAsset: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        priv let traits: [MetadataViews.Trait]
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FEHVAsset.CollectionStoragePath, publicPath: FEHVAsset.CollectionPublicPath, providerPath: /private/FEHVAssetCollection, publicCollection: Type<&FEHVAsset.Collection{FEHVAsset.AssetCollectionPublic}>(), publicLinkedType: Type<&FEHVAsset.Collection{FEHVAsset.AssetCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FEHVAsset.Collection{FEHVAsset.AssetCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, metadataId: String, free: Bool, name: String, description: String, thumbnail: String, externalUrl: String, video: String, jsonData: String, traits: [MetadataViews.Trait]){ 
            pre{ 
                FEHVAsset.minted[metadataId] != true:
                    "Already minted"
            }
