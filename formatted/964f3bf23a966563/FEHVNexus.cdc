...
pub contract FEHVNexus: NonFungibleToken{ 
    ...
    pub struct Category{ 
        ...
        access(contract) fun setData(name: String, description: String, thumbnail: String, externalUrl: String, video: String, traits: [MetadataViews.Trait]){ 
            self.name = name
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: FEHVNexus.CollectionStoragePath, publicPath: FEHVNexus.CollectionPublicPath, providerPath: /private/NexusCollection, publicCollection: Type<&FEHVNexus.Collection{FEHVNexus.NexusCollectionPublic}>(), publicLinkedType: Type<&FEHVNexus.Collection{FEHVNexus.NexusCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&FEHVNexus.Collection{FEHVNexus.NexusCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, externalUuid: String, category: Int){ 
            pre{ 
    ...
    pub resource Admin{ 
        ...
        pub fun setMetadata(category: Int, name: String, description: String, thumbnail: String, externalUrl: String, video: String, traits: [MetadataViews.Trait]){ 
