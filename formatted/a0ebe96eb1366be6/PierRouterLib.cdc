...
pub contract PierRouterLib{ 
    ...
    pub fun quote(amountA: UFix64, reserveA: UFix64, reserveB: UFix64): UFix64{ 
        ...
        let amountB =
            PierMath.UFix64ToRawUInt256(amountA)
            * PierMath.UFix64ToRawUInt256(reserveB)
    ...
    pub fun getAmountOut(
        ...
        let numerator =
            amountInWithFee * PierMath.UFix64ToRawUInt256(reserveOut)
        
        // denominator = reserveIn * 1000 + amountInWithFee
        let denominator =
            PierMath.UFix64ToRawUInt256(reserveIn) * 1000 + amountInWithFee
    ...
    pub fun getAmountIn(
        ...
        let numerator =
            PierMath.UFix64ToRawUInt256(reserveIn)
            * PierMath.UFix64ToRawUInt256(amountOut)
            * 1000
