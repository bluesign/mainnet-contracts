...
pub contract RujianNFT: NonFungibleToken{ 
    ...
    pub event Minted(id: UInt64, resourceId: String, resourceName: String, ownerId: String, resourceHash: String, timeStamp: String)
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: RujianNFT.CollectionStoragePath, publicPath: RujianNFT.CollectionPublicPath, providerPath: /private/KittyItemsCollection, publicCollection: Type<&RujianNFT.Collection{RujianNFT.RujianNFTCollectionPublic}>(), publicLinkedType: Type<&RujianNFT.Collection{RujianNFT.RujianNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&RujianNFT.Collection{RujianNFT.RujianNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, resourceId: String, resourceName: String, ownerId: String, resourceHash: String, timeStamp: String, royalties: [MetadataViews.Royalty]){ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &RujianNFT.NFT?{ 
        let collection = (getAccount(from).getCapability(RujianNFT.CollectionPublicPath)!).borrow<&RujianNFT.Collection{RujianNFT.RujianNFTCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&RujianNFT.Collection{NonFungibleToken.CollectionPublic, RujianNFT.RujianNFTCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
