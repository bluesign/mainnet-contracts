...
pub contract Flowty{ 
    ...
    pub event RoyaltyAdded(collectionIdentifier: String, rate: UFix64)
    ...
    pub struct ListingDetails{ 
        ...
        pub fun getTotalPayment(): UFix64{ 
            return self.amount
            * (1.0 + self.interestRate * Flowty.FundingFee + self.royaltyRate)
        }
    ...
    pub resource Listing: ListingPublic, FlowtyListingCallback.Listing{ 
        ...
        // initializer
        //
        init(nftProviderCapability: Capability<&{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>, nftPublicCollectionCapability: Capability<&AnyResource{NonFungibleToken.CollectionPublic}>, fusdProviderCapability: Capability<&{FungibleToken.Provider}>?, nftType: Type, nftID: UInt64, amount: UFix64, interestRate: UFix64, term: UFix64, paymentVaultType: Type, paymentCuts: [PaymentCut], flowtyStorefrontID: UInt64, expiresAfter: UFix64, royaltyRate: UFix64){ 
        ...
        destroy(){ 
            ...
            emit ListingCompleted(listingResourceID: self.uuid, flowtyStorefrontID: self.details.flowtyStorefrontID, funded: self.details.funded, nftID: self.details.nftID, nftType: self.details.nftType.identifier, flowtyStorefrontAddress: self.nftPublicCollectionCapability.address)
        }
    }
    ...
    // Funding
    // 
    pub resource Funding: FundingPublic, FlowtyListingCallback.Listing{ 
        // The simple (non-Capability, non-complex) details of the listing
        ...
        access(contract) fun borrowNFT(): &NonFungibleToken.NFT?{ 
        ...
        pub fun repay(payment: @FungibleToken.Vault){ 
            ...
            let depositor = Flowty.account.borrow<&LostAndFound.Depositor>(from: LostAndFound.DepositorStoragePath)!
        ...
        // initializer
        //
        init(flowtyStorefrontID: UInt64, listingResourceID: UInt64, ownerNFTCollection: Capability<&AnyResource{NonFungibleToken.CollectionPublic}>, lenderNFTCollection: Capability<&AnyResource{NonFungibleToken.CollectionPublic}>, NFT: @NonFungibleToken.NFT, paymentVaultType: Type, repaymentAmount: UFix64, lenderFungibleTokenReceiver: Capability<&{FungibleToken.Receiver}>, term: UFix64, fusdProviderCapability: Capability<&{FungibleToken.Provider}>?, royaltyVault: @FungibleToken.Vault?, listingDetails: ListingDetails){ 
    ...
    pub resource FlowtyMarketplace:
        ...
        //
        destroy(){ 
            destroy self                        // The dictionary of Listing uuids to Listing resources.
        ...
        init(){ 
            self.fundings                          // We don't allow all tokens to be used as payment. Check that the provided one is supported.
            ...
            payment                   
                   ...
                   :                     
                     ...
                     @FungibleToken.Vault                                         
                                         ...
                                         //
                                         ,
            nftProviderCapability: Capability                                             // The UFix64 type covers a negative numbers
                                             <
                &{NonFungibleToken.Provider // Fixed FUSD // Percentage of the interest, a number between 0 and 1. // Period in seconds, NonFungibleToken.CollectionPublic                                                                              // create a public capability for the .Marketplace
                                                                              }
            >,
    ...
    pub fun borrowMarketplacePublic(): &Flowty.FlowtyMarketplace{
        FlowtyMarketplacePublic
    }{ 
        let mp =
            self.account.getCapability<
                &Flowty.FlowtyMarketplace{Flowty.FlowtyMarketplacePublic}
            >(Flowty.FlowtyMarketplacePublicPath).borrow()
    ...
    pub fun settleFunding(fundingResourceID: UInt64){ 
        let marketplace = Flowty.borrowMarketplace()
        let funding =
            marketplace.borrowFunding(fundingResourceID: fundingResourceID)
    ...
    init(){ 
        ...
        self.ListingFee = 0.0
        self.FundingFee = 0.1
        self.SuspendedFundingPeriod = 1.0
        self.Royalties ={} 
