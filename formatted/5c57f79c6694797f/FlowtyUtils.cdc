...
pub contract FlowtyUtils{ 
    ...
    access(account) fun depositToLostAndFound(
        ...
        let depositor =
            FlowtyUtils.account.borrow<&LostAndFound.Depositor>(
    ...
    access(account) fun trySendFungibleTokenVault(
    ...
    pub fun getTokenBalance(address: Address, vaultType: Type): UFix64{ 
        ...
        let vaultCap =
            user.getCapability<&{FungibleToken.Balance}>(balancePath!)
