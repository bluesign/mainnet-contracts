...
pub contract SeedsTestingTst: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: SeedsTestingTst.CollectionStoragePath, publicPath: SeedsTestingTst.CollectionPublicPath, providerPath: SeedsTestingTst.CollectionPrivatePath, publicCollection: Type<&SeedsTestingTst.Collection{SeedsTestingTst.SeedsTestingTstCollectionPublic}>(), publicLinkedType: Type<&SeedsTestingTst.Collection{SeedsTestingTst.SeedsTestingTstCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&SeedsTestingTst.Collection{SeedsTestingTst.SeedsTestingTstCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
