...
pub contract DimensionXComicsPrimarySaleMinter{ 
    ...
    pub resource interface MinterCapSetter{ 
        pub fun setMinterCap(
            minterCap: Capability<&DimensionXComics.NFTMinter>
        ){} 
    }
    ...
    pub fun createMinter(maxMints: Int): @Minter{ 
        return <-create Minter(maxMints: maxMints)
    }
    
    init(){ 
        self
            .MinterPrivatePath = /private/DimensionXComicsPrimarySaleMinterPrivatePath001
        self
            .MinterStoragePath = /storage/DimensionXComicsPrimarySaleMinterStoragePath001
        self
            .MinterPublicPath = /public/DimensionXComicsPrimarySaleMinterPublicPath001
