...
pub contract TouchstoneHalloweencreatedbyAi: NonFungibleToken{ 
    ...
    pub struct NFTMetadata{ 
        ...
        init(_name: String, _description: String, _image: MetadataViews.IPFSFile, _thumbnail: MetadataViews.IPFSFile?, _price: UFix64?, _extra:{ String: AnyStruct}, _supply: UInt64){ 
            self.metadataId = TouchstoneHalloweencreatedbyAi.nextMetadataId
            self.name = _name
            ...
            self.supply = _supply
            self.purchasers ={} 
            TouchstoneHalloweencreatedbyAi.nextMetadataId = TouchstoneHalloweencreatedbyAi.nextMetadataId + 1
        }
    }
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun getMetadata(): NFTMetadata{ 
            return TouchstoneHalloweencreatedbyAi.getNFTMetadata(self.metadataId)!
        }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TouchstoneHalloweencreatedbyAi.CollectionStoragePath, publicPath: TouchstoneHalloweencreatedbyAi.CollectionPublicPath, providerPath: TouchstoneHalloweencreatedbyAi.CollectionPrivatePath, publicCollection: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, NonFungibleToken.Provider}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-TouchstoneHalloweencreatedbyAi.createEmptyCollection()
                        })
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat((self.owner!).address.toString()).concat("/TouchstoneHalloweencreatedbyAi"))
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareMedia = MetadataViews.Media(file: TouchstoneHalloweencreatedbyAi.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile, mediaType: "image")
                    
                    // If a banner image exists, use it
                    // Otherwise, default to the main square image
                    var bannerMedia: MetadataViews.Media? = nil
                    if let bannerImage = TouchstoneHalloweencreatedbyAi.getOptionalCollectionAttribute(key: "bannerImage") as! MetadataViews.IPFSFile?{ 
                        bannerMedia = MetadataViews.Media(file: bannerImage, mediaType: "image")
                    }
                    return MetadataViews.NFTCollectionDisplay(name: TouchstoneHalloweencreatedbyAi.getCollectionAttribute(key: "name") as! String, description: TouchstoneHalloweencreatedbyAi.getCollectionAttribute(key: "description") as! String, externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat((self.owner!).address.toString()).concat("/TouchstoneHalloweencreatedbyAi")), squareImage: squareMedia, bannerImage: bannerMedia ?? squareMedia, socials: TouchstoneHalloweencreatedbyAi.getCollectionAttribute(key: "socials") as!{ String: MetadataViews.ExternalURL})
        ...
        init(_metadataId: UInt64, _serial: UInt64, _recipient: Address){ 
            pre{ 
                TouchstoneHalloweencreatedbyAi.metadatas[_metadataId] != nil:
                    "This NFT does not exist yet."
                _serial < (TouchstoneHalloweencreatedbyAi.getNFTMetadata(_metadataId)!).supply:
                    "This serial does not exist for this metadataId."
                !(TouchstoneHalloweencreatedbyAi.getNFTMetadata(_metadataId)!).purchasers.containsKey(_serial):
            ...
            if let buyersRef = &TouchstoneHalloweencreatedbyAi.primaryBuyers[_recipient] as &{UInt64: [UInt64]}?{ 
                ...
                TouchstoneHalloweencreatedbyAi.primaryBuyers[_recipient] ={ _metadataId: [_serial]}
            }
            
            // Update who bought this serial inside NFTMetadata so it cannot be purchased again.
            let metadataRef = (&TouchstoneHalloweencreatedbyAi.metadatas[_metadataId] as &NFTMetadata?)!
            metadataRef.purchased(serial: _serial, buyer: _recipient)
            TouchstoneHalloweencreatedbyAi.totalSupply = TouchstoneHalloweencreatedbyAi.totalSupply + 1
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun claim(){ 
            if let storage = &TouchstoneHalloweencreatedbyAi.nftStorage[(self.owner!).address] as &{UInt64: NFT}?{ 
    ...
    pub fun mintNFT(metadataId: UInt64, recipient: &{NonFungibleToken.Receiver}, payment: @FUSD.Vault, serial: UInt64): UInt64{ 
        ...
        let EmeraldCityTreasury = getAccount(0x5643fd47a29770e7).getCapability(/public/fusdReceiver).borrow<&FUSD.Vault{FungibleToken.Receiver}>()!
        let emeraldCityCut: UFix64 = 0.05 * price
        
        // Handle royalty to user that was configured upon creation
        if let royalty = TouchstoneHalloweencreatedbyAi.getOptionalCollectionAttribute(key: "royalty") as! MetadataViews.Royalty?{ 
        ...
        let paymentRecipient = self.account.getCapability(/public/fusdReceiver).borrow<&FUSD.Vault{FungibleToken.Receiver}>()!
    ...
    pub resource Administrator{ 
        pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra:{ String: AnyStruct}, supply: UInt64){ 
            TouchstoneHalloweencreatedbyAi.metadatas[TouchstoneHalloweencreatedbyAi.nextMetadataId] = NFTMetadata(_name: name, _description: description, _image: MetadataViews.IPFSFile(cid: ipfsCID, path: imagePath), _thumbnail: thumbnailPath == nil ? nil : MetadataViews.IPFSFile(cid: ipfsCID, path: thumbnailPath), _price: price, _extra: extra, _supply: supply)
        }
        ...
        pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
            pre{ 
                EmeraldPass.isActive(user: TouchstoneHalloweencreatedbyAi.account.address):
            ...
            if let recipientCollection = getAccount(recipient).getCapability(TouchstoneHalloweencreatedbyAi.CollectionPublicPath).borrow<&TouchstoneHalloweencreatedbyAi.Collection{NonFungibleToken.CollectionPublic}>(){ 
                recipientCollection.deposit(token: <-nft)
            } else if let storage = &TouchstoneHalloweencreatedbyAi.nftStorage[recipient] as &{UInt64: NFT}?{ 
                storage[nft.id] <-! nft
            } else{ 
                TouchstoneHalloweencreatedbyAi.nftStorage[recipient] <-!{ nft.id: <-nft}
            }
        }
        ...
        pub fun changeField(key: String, value: AnyStruct){ 
            TouchstoneHalloweencreatedbyAi.collectionInfo[key] = value
        }
    }
    ...
    pub fun getPriceOfNFT(_ metadataId: UInt64): UFix64?{ 
        if let metadata: TouchstoneHalloweencreatedbyAi.NFTMetadata = self.getNFTMetadata(metadataId){ 
    ...
    pub fun getClaimableNFTs(user: Address):{ UInt64: NFTMetadata}{ 
        ...
        if let storage = &TouchstoneHalloweencreatedbyAi.nftStorage[user] as &{UInt64: NFT}?{ 
            for id in storage.keys{ 
    ...
    init(_name: String, _description: String, _imagePath: String, _bannerImagePath: String?, _minting: Bool, _royalty: MetadataViews.Royalty?, _defaultPrice: UFix64, _paymentType: String, _ipfsCID: String, _lotteryBuying: Bool, _socials:{ String: MetadataViews.ExternalURL}, _mintVerifiers: [{MintVerifiers.IVerifier}]){ 
        ...
        self.CollectionStoragePath = /storage/TouchstoneHalloweencreatedbyAiCollection_0x1c09c3b8d6bf323b
        self.CollectionPublicPath = /public/TouchstoneHalloweencreatedbyAiCollection_0x1c09c3b8d6bf323b
        self.CollectionPrivatePath = /private/TouchstoneHalloweencreatedbyAiCollection_0x1c09c3b8d6bf323b
        self.AdministratorStoragePath = /storage/TouchstoneHalloweencreatedbyAiAdministrator_0x1c09c3b8d6bf323b
