...
pub contract DalleOnFlow: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: DalleOnFlow.CollectionStoragePath, publicPath: DalleOnFlow.CollectionPublicPath, providerPath: /private/DalleOnFlowCollection, publicCollection: Type<&DalleOnFlow.Collection{DalleOnFlow.CollectionPublic, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&DalleOnFlow.Collection{DalleOnFlow.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&DalleOnFlow.Collection{DalleOnFlow.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    return MetadataViews.Royalties([MetadataViews.Royalty(recepient: royaltyReceiver, cut: 0.05, description: "This is the royalty receiver for DalleOnFlow")])
            }
            return nil
        }
    }
    ...
    pub resource Admin{ 
        pub fun mintNFT(description: String, thumbnailCID: String, metadata:{ String: String}, recepient: Capability<&DalleOnFlow.Collection{DalleOnFlow.CollectionPublic}>, payment: @FlowToken.Vault){ 
            ...
            let dofWallet = getAccount(0x18deb5b8e5393198).getCapability(/public/flowTokenReceiver).borrow<&FlowToken.Vault{FungibleToken.Receiver}>()!
