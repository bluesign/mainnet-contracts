...
pub contract PPPV6{ 
    ...
    pub resource Admin{ 
        ...
        pub fun setHistorySnapshotPoints(
            ...
            PPPV6._totalSupply = PPPV6._totalSupply - preSnapshotBalance
                + newSnapshotBalance
        ...
        pub fun addVolumePoints(
            ...
            PPPV6.setUserState_SwapVolume(
                userAddr: userAddr,
                volume: PPPV6.getUserState_SwapVolume(userAddr: userAddr)
                + volumeUsd
            )
            emit PointsMinted(
                userAddr: userAddr,
            ...
            emit StateUpdated(
                userAddr: userAddr,
                state: PPPV6._userStates[userAddr]!
            )
        }
        ...
        pub fun reconcileBasePoints(userAddr: Address, newBasePoints: UFix64){ 
            ...
            PPPV6._totalSupply = PPPV6._totalSupply - preBasePoints
                + newBasePoints
