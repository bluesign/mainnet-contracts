...
pub contract PPPV1{ 
    ...
    pub fun getPointsRatePerDay_stFlowHolding(amount: UFix64): UFix64{ 
        return self.calculateTierRateByAmount(
            amount: amount,
    ...
    pub fun getPointsRatePerDay_SwapLP(amount: UFix64): UFix64{ 
        return self.calculateTierRateByAmount(
            amount: amount,
    ...
    pub resource Admin{ 
        pub            // Set Points Rate
            fun setPointsRatePerDay_stFlowHoldingTier(
            tierRate:{ 
                UFix64: UFix64
            }
        ){ 
            emit PointsTierRateChanged(
                ...
                ori: PPPV1._pointsRatePerDay["stFlowHolding"]!
                as!{
        ...
        pub fun setPointsRatePerDay_LendingSupplyTier(
            ...
            emit PointsTierRateChanged(
                ...
                ori: PPPV1._pointsRatePerDay["LendingSupply"]!
                as!{
        ...
        pub fun setPointsRatePerDay_LendingBorrowTier(
            ...
            emit PointsTierRateChanged(
                ...
                ori: PPPV1._pointsRatePerDay["LendingBorrow"]!
                as!{
        ...
        pub fun setPointsRatePerDay_SwapLPTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                source: "SwapLP",
        ...
        pub fun setHistorySnapshotPointsBalance(
            ...
            PPPV1._totalSupply = PPPV1._totalSupply - preSnapshotBalance
                + newSnapshotBalance
        ...
        pub fun reconcilePoints(userAddr: Address, newBalance: UFix64){ 
