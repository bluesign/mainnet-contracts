...
pub contract IncrementPointsV1{ 
    ...
    priv let _blackList:{ Address: UFix64}
    ...
    priv fun mintPoints(targetAddr: Address, amount: UFix64){ 
        // mint points
    ...
    pub fun updateUserState(userAddr: Address){ 
        ...
        // Mint Points
        if lastMintTimestamp != 0.0
        && currMintTimestamp - lastMintTimestamp > 0.0{ 
            ...
            // Mint
            let mintAmount =
                mintAmountByLendingSupply + mintAmountbyLendingBorrow
            if mintAmount > 0.0{ 
    ...
    pub resource Admin{ 
        pub fun setPointsRatePerDay_LiquidStakingTier(
            ...
            emit PointsTierRateChanged(
                ...
                ori: IncrementPointsV1._pointsRatePerDay["LiquidStaking"]!
                as!{
        ...
        pub fun setPointsRatePerDay_LendingSupplyTier(
            ...
            emit PointsTierRateChanged(
                ...
                ori: IncrementPointsV1._pointsRatePerDay["LendingSupply"]!
                as!{
        ...
        pub fun setPointsRatePerDay_LendingBorrowTier(
            ...
            emit PointsTierRateChanged(
                ...
                ori: IncrementPointsV1._pointsRatePerDay["LendingBorrow"]!
                as!{
        ...
        pub fun setPointsRatePerDay_SwapVolume(rate: UFix64){ 
            emit PointsRateChanged(
                source: "SwapVolume",
                ori: IncrementPointsV1._pointsRatePerDay["SwapVolume"]!
                as!
                UFix64,
                new: rate
            )
