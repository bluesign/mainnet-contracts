...
pub contract PPPV7{ 
    ...
    pub resource Admin{ 
        ...
        pub fun setHistorySnapshotPoints(
            ...
            PPPV7._totalSupply = PPPV7._totalSupply - preSnapshotBalance
                + newSnapshotBalance
        ...
        pub fun addVolumePoints(
            ...
            PPPV7.setUserState_SwapVolume(
                userAddr: userAddr,
                volume: PPPV7.getUserState_SwapVolume(userAddr: userAddr)
                + volumeUsd
            )
            emit PointsMinted(
                userAddr: userAddr,
            ...
            emit StateUpdated(
                userAddr: userAddr,
                state: PPPV7._userStates[userAddr]!
            )
        }
        ...
        pub fun reconcileBasePoints(userAddr: Address, newBasePoints: UFix64){ 
            ...
            PPPV7._totalSupply = PPPV7._totalSupply - preBasePoints
                + newBasePoints
        ...
        // TODO
        pub fun testResetIfSnapshot(userAddr: Address){ 
