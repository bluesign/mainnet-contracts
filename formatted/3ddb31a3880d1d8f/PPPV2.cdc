...
pub contract PPPV2{ 
    ...
    priv fun _mint(targetAddr: Address, amount: UFix64){ 
        ...
        let referrerAddr: Address? =
            RV2.getReferrerByReferee(referee: targetAddr)
        if referrerAddr != nil{ 
            // referee boost
    ...
    pub fun updateUserState(userAddr: Address){ 
        ...
        || totalLpBalanceUsd > 0.0{ 
            ...
            self.setUserState_SwapLP(
                userAddr: userAddr,
                lpAmount: totalLpBalanceUsd
            )
    ...
    pub fun getLatestUserInfo(_ userAddr: Address): [UFix64]{ 
        let userLatestStates: [UFix64] =
            self.fetchOnchainUserStates(userAddr: userAddr)
        return [
            self.balanceOf(userAddr),
            self.getPointsAsReferrer(userAddr),
            self.getUserState_LastUpdateTimestamp(userAddr: userAddr),
    ...
    pub fun getSlicedBalances(from: Int, to: Int):{ Address: UFix64}{ 
    ...
    pub fun getSlicedPointsAndTimestamp(from: Int, to: Int):{ 
        Address: [
            UFix64; 3
        ]
    }{ 
    ...
    pub fun getPointsRate_SwapVolume(): UFix64{ 
    ...
    pub fun getUserState_LendingSupply(userAddr: Address): UFix64{ 
        return (self._userStates[userAddr]!).containsKey(
    ...
    pub fun getUserState_SwapLP(userAddr: Address): UFix64{ 
    ...
    priv fun setUserState_SwapLP(userAddr: Address, lpAmount: UFix64){ 
    ...
    pub resource Admin{ 
        pub            // Set Points Rate
            ...
            emit PointsTierRateChanged(
                ...
                ori: PPPV2._pointsRatePerDay["stFlowHolding"]!
                as!{
        ...
        pub fun setPointsRate_LendingSupplyTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                ...
                ori: PPPV2._pointsRatePerDay["LendingSupply"]!
                as!{
        ...
        pub fun setPointsRate_LendingBorrowTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                ...
                ori: PPPV2._pointsRatePerDay["LendingBorrow"]!
                as!{
        ...
        pub fun setPointsRate_SwapLPTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                source: "SwapLP",
                ori: PPPV2._pointsRatePerDay["SwapLP"]! as!{ UFix64: UFix64},
                new: tierRate
            )
            PPPV2._pointsRatePerDay["SwapLP"] = tierRate
        }
        
        pub fun setPointsRate_SwapVolume(rate: UFix64){ 
            emit PointsRateChanged(
                source: "SwapVolume",
                ori: PPPV2._pointsRatePerDay["SwapVolume"]! as! UFix64,
                new: rate
            )
        ...
        pub fun setPointsRate_ReferrerUp(rate: UFix64){ 
            emit PointsRateChanged(
                source: "ReferrerUp",
                ori: PPPV2._pointsRatePerDay["ReferrerUp"]! as! UFix64,
                new: rate
            )
        ...
        pub fun setPointsRate_RefereeUp(rate: UFix64){ 
            emit PointsRateChanged(
                source: "RefereeUp",
                ori: PPPV2._pointsRatePerDay["RefereeUp"]! as! UFix64,
                new: rate
            )
        ...
        pub fun setHistorySnapshotPoints(
            ...
            PPPV2._totalSupply = PPPV2._totalSupply - preSnapshotBalance
                + newSnapshotBalance
        ...
        pub fun reconcileBasePoints(userAddr: Address, newBasePoints: UFix64){ 
            ...
            PPPV2._totalSupply = PPPV2._totalSupply - preBasePoints
                + newBasePoints
