...
pub contract PPPV4{ 
    ...
    pub fun getPointsRate_SwapVolume(): UFix64{ 
        return self._pointsRate["SwapVolume"]! as! UFix64
    }
    ...
    pub resource Admin{ 
        pub            // Set Points Rate
            ...
            emit PointsTierRateChanged(
                ...
                ori: PPPV4._pointsRate["stFlowHolding"]! as!{ UFix64: UFix64},
                new: tierRate
            )
        ...
        pub fun setPointsRate_LendingSupplyTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                ...
                ori: PPPV4._pointsRate["LendingSupply"]! as!{ UFix64: UFix64},
                new: tierRate
            )
        ...
        pub fun setPointsRate_LendingBorrowTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                ...
                ori: PPPV4._pointsRate["LendingBorrow"]! as!{ UFix64: UFix64},
                new: tierRate
            )
        ...
        pub fun setPointsRate_SwapLPTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                source: "SwapLP",
                ori: PPPV4._pointsRate["SwapLP"]! as!{ UFix64: UFix64},
                new: tierRate
            )
        ...
        pub fun setPointsRate_SwapVolume(rate: UFix64){ 
            emit PointsRateChanged(
                source: "SwapVolume",
                ori: PPPV4._pointsRate["SwapVolume"]! as! UFix64,
                new: rate
            )
        ...
        pub fun setPointsRate_ReferrerUp(rate: UFix64){ 
            emit PointsRateChanged(
                source: "ReferrerUp",
                ori: PPPV4._pointsRate["ReferrerUp"]! as! UFix64,
                new: rate
            )
        ...
        pub fun setPointsRate_RefereeUp(rate: UFix64){ 
            emit PointsRateChanged(
                source: "RefereeUp",
                ori: PPPV4._pointsRate["RefereeUp"]! as! UFix64,
                new: rate
            )
        ...
        pub fun setPointsRate_CoreMember(rate: UFix64){ 
            emit PointsRateChanged(
                source: "CoreMember",
                ori: PPPV4._pointsRate["CoreMember"]! as! UFix64,
                new: rate
            )
        ...
        pub fun setHistorySnapshotPoints(
            ...
            PPPV4._totalSupply = PPPV4._totalSupply - preSnapshotBalance
                + newSnapshotBalance
        ...
        pub fun reconcileBasePoints(userAddr: Address, newBasePoints: UFix64){ 
            ...
            PPPV4._totalSupply = PPPV4._totalSupply - preBasePoints
                + newBasePoints
    ...
    init(){ 
        ...
        self._pointsRate ={ 
                "stFlowHolding":{
                0.0: 0.00003000, 1000.0: 0.00006000, 10000.0: 0.00020000},
                "LendingSupply":{
                0.0: 0.00003000, 1000.0: 0.00005000, 10000.0: 0.00010000},
                "LendingBorrow":{
                0.0: 0.00006000, 1000.0: 0.00010000, 10000.0: 0.00020000},
                "SwapLP":{
                0.0: 0.00003000, 1000.0: 0.00006000, 10000.0: 0.00020000},
