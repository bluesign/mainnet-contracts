...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x2541a589a67f6eb0
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x2541a589a67f6eb0
