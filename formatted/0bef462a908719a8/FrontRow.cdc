...
pub contract FrontRow: NonFungibleToken{ 
    ...
    priv var blueprints:{ UInt32: Blueprint}
    ...
    pub struct Blueprint{ 
        ...
        priv var mintCount: UInt32
        
        priv var nfts:{ UInt32: UInt64} // Map of serial numbers to global NFT IDs
    ...
    pub resource Admin: Minter{ 
        ...
        //
        pub fun printBlueprint(maxQuantity: UInt32, metadata:{ String: String}): UInt32{ 
            post{ 
        ...
        //
        pub fun batchMintNFT(blueprintId: UInt32, quantity: UInt64, receiverRef: &AnyResource{FrontRow.CollectionPublic}){ 
