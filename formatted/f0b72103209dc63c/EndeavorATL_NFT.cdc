...
pub contract EndeavorATL_NFT: NonFungibleToken{ 
    
    // EndeavorATL_NFT Events
    //
    // Emitted when the EndeavorATL_NFT contract is created
    ...
    // totalSupply
    // The total number of EndeavorATL_NFT that have been minted
    //
    ...
    // A Series is special resource type that contains functions to mint EndeavorATL_NFT NFTs, 
    ...
    pub resource Series{ 
        ...
        init(seriesId: UInt32, metadata:{ String: String}){ 
            ...
            self.setIds = []
            self.setSealedState ={} 
            EndeavorATL_NFT.seriesData[seriesId] = SeriesData(seriesId: seriesId, metadata: metadata)
        ...
        pub fun addNftSet(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            ...
            EndeavorATL_NFT.setData[setId] = newNFTSet
        ...
        pub fun updateSeriesMetadata(metadata:{ String: String}){ 
            ...
            EndeavorATL_NFT.seriesData[self.seriesId] = newSeriesMetadata
        ...
        pub fun updateSetMetadata(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            ...
            EndeavorATL_NFT.setData[setId] = newSetMetadata
        ...
        //
        pub fun mintEndeavorATL_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= EndeavorATL_NFT.getSetMaxEditions(setId: setId)!:
            ...
            recipient.deposit(token: <-create EndeavorATL_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: editionNum))
            
            // Increment the count of global NFTs 
            EndeavorATL_NFT.totalSupply = EndeavorATL_NFT.totalSupply + 1 as UInt64
            
            // Update the count of Editions minted in the set
            self.numberEditionsMintedPerSet[setId] = editionNum
        }
        
        // mintEditionEndeavorATL_NFT
        // Mints a new NFT with a new ID and specific edition Num (random open edition)
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintEditionEndeavorATL_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32, edition: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= EndeavorATL_NFT.getSetMaxEditions(setId: setId)!:
            ...
            // deposit it in the recipient's account using their reference
            recipient.deposit(token: <-create EndeavorATL_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: edition))
        ...
        // batchMintEndeavorATL_NFT
        // Mints multiple new NFTs given and deposits the NFTs
        // into the recipients collection using their collection reference
        pub fun batchMintEndeavorATL_NFT(recipient: &{NonFungibleToken.CollectionPublic}, setId: UInt32, tokenIds: [UInt64]){ 
            pre{ 
                tokenIds.length > 0:
                    "Number of token Ids must be > 0"
            }
            for tokenId in tokenIds{ 
                self.mintEndeavorATL_NFT(recipient: recipient, tokenId: tokenId, setId: setId)
            }
        }
    ...
    // A resource that represents the EndeavorATL_NFT NFT
    //
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(tokenId: UInt64, setId: UInt32, editionNum: UInt32){ 
            ...
            let seriesId = EndeavorATL_NFT.getSetSeriesId(setId: setId)!
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "name")!, description: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "description")!, thumbnail: MetadataViews.HTTPFile(url: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!))
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(self.id)
                case Type<MetadataViews.Editions>():
                    let maxEditions = EndeavorATL_NFT.setData[self.setId]?.maxEditions ?? 0
                    let editionName = EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "name")!
                ...
                case Type<MetadataViews.ExternalURL>():
                    if let externalBaseURL = EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "external_token_base_url"){ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    for metadataKey in (EndeavorATL_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 13{ 
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_"{ 
                                ...
                                let royaltyAddress = EndeavorATL_NFT.convertStringToAddress(EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_addr_".concat(royaltyName))!)!
                                let royaltyReceiver: PublicPath = PublicPath(identifier: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_rcv_".concat(royaltyName))!)!
                                let royaltyCut = EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_cut_".concat(royaltyName))!
                                let cutValue: UFix64 = EndeavorATL_NFT.royaltyCutStringToUFix64(royaltyCut)
                                if cutValue != 0.0{ 
                                    royalties.append(MetadataViews.Royalty(receiver: getAccount(royaltyAddress).getCapability<&FungibleToken.Vault{FungibleToken.Receiver}>(royaltyReceiver), cut: cutValue, description: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!))
                                }
                            }
                        }
                    }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: EndeavorATL_NFT.CollectionStoragePath, publicPath: EndeavorATL_NFT.CollectionPublicPath, providerPath: /private/EndeavorATL_NFT, publicCollection: Type<&EndeavorATL_NFT.Collection{EndeavorATL_NFT.EndeavorATL_NFTCollectionPublic, NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&EndeavorATL_NFT.Collection{EndeavorATL_NFT.EndeavorATL_NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&EndeavorATL_NFT.Collection{EndeavorATL_NFT.EndeavorATL_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-EndeavorATL_NFT.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.gigantik.io/endeavoratl/square.png"), mediaType: "image/png")
                    let bannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.gigantik.io/endeavoratl/banner.png"), mediaType: "image/png")
                    ...
                    for metadataKey in (EndeavorATL_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 18{ 
                            if metadataKey.slice(from: 0, upTo: 18) == "collection_social_"{ 
                                ...
                                socials.insert(key: metadataKey.slice(from: 18, upTo: metadataKey.length), MetadataViews.ExternalURL(EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!))
                            }
                        }
                    }
                    return MetadataViews.NFTCollectionDisplay(name: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "", description: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "", externalURL: MetadataViews.ExternalURL(EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""), squareImage: squareImage, bannerImage: bannerImage, socials: socials)
                    ...
                    for metadataKey in (EndeavorATL_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 6{ 
                            if metadataKey.slice(from: 0, upTo: 6) == "trait_"{ 
                                ...
                                traitDictionary.insert(key: metadataKey.slice(from: 6, upTo: metadataKey.length), EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!)
                            }
                        }
                    }
                    return MetadataViews.dictToTraits(dict: traitDictionary, excludedNames: [])
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: MetadataViews.HTTPFile(url: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "image")!), mediaType: self.getMimeType())])
            }
            return nil
        }
        
        pub fun getMimeType(): String{ 
            var metadataFileType = (EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "image_file_type")!).toLower()
    ...
    pub resource Admin{ 
        pub fun addSeries(seriesId: UInt32, metadata:{ String: String}){ 
            pre{ 
                EndeavorATL_NFT.series[seriesId] == nil:
            ...
            EndeavorATL_NFT.series[seriesId] <-! newSeries
        }
        ...
        pub fun borrowSeries(seriesId: UInt32): &Series{ 
            ...
            return (&EndeavorATL_NFT.series[seriesId] as &Series?)!
        }
    ...
    // to allow others to deposit EndeavorATL_NFT into their Collection. It also allows for reading
    // the details of EndeavorATL_NFT in the Collection.
    pub resource interface EndeavorATL_NFTCollectionPublic{ 
        ...
        pub fun borrowEndeavorATL_NFT(id: UInt64): &EndeavorATL_NFT.NFT?{ 
            // If the result isn't nil, the id of the returned reference
            // should be the same as the argument to the function
            post{ 
                result == nil || result?.id == id:
                    "Cannot borrow EndeavorATL_NFT reference: The ID of the returned reference is incorrect"
            }
        }
    }
    
    // Collection
    // A collection of EndeavorATL_NFT NFTs owned by an account
    //
    pub resource Collection: EndeavorATL_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        //
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let token <- token as! @EndeavorATL_NFT.NFT
        ...
        // borrowEndeavorATL_NFT
        // Gets a reference to an NFT in the collection as a EndeavorATL_NFT,
        // exposing all of its fields.
        // This is safe as there are no functions that can be called on the EndeavorATL_NFT.
        //
        pub fun borrowEndeavorATL_NFT(id: UInt64): &EndeavorATL_NFT.NFT?{ 
            let ref = &self.ownedNFTs[id] as auth &NonFungibleToken.NFT?
            return ref as! &EndeavorATL_NFT.NFT?
        }
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            let EndeavorATL_NFTNft = nft as! &EndeavorATL_NFT.NFT
            return EndeavorATL_NFTNft as &AnyResource{MetadataViews.Resolver}
        }
    ...
    // fetch
    // Get a reference to a EndeavorATL_NFT from an account's Collection, if available.
    // If an account does not have a EndeavorATL_NFT.Collection, panic.
    ...
    //
    pub fun fetch(_ from: Address, id: UInt64): &EndeavorATL_NFT.NFT?{ 
        let collection = getAccount(from).getCapability(EndeavorATL_NFT.CollectionPublicPath).borrow<&EndeavorATL_NFT.Collection{EndeavorATL_NFT.EndeavorATL_NFTCollectionPublic}>() ?? panic("Couldn't get collection")
        // We trust EndeavorATL_NFT.Collection.borrowEndeavorATL_NFT to get the correct id
        // (it checks it before returning it).
        return collection.borrowEndeavorATL_NFT(id: id)
    }
    
    // getAllSeries returns all the sets
    //
    // Returns: An array of all the series that have been created
    pub fun getAllSeries(): [EndeavorATL_NFT.SeriesData]{ 
        return EndeavorATL_NFT.seriesData.values
    }
    
    // getAllSets returns all the sets
    //
    // Returns: An array of all the sets that have been created
    pub fun getAllSets(): [EndeavorATL_NFT.NFTSetData]{ 
        return EndeavorATL_NFT.setData.values
    }
    ...
    pub fun getSeriesMetadata(seriesId: UInt32):{ String: String}?{ 
        return EndeavorATL_NFT.seriesData[seriesId]?.getMetadata()
    }
    ...
    pub fun getSetMaxEditions(setId: UInt32): UInt32?{ 
        return EndeavorATL_NFT.setData[setId]?.maxEditions
    }
    ...
    pub fun getSetMetadata(setId: UInt32):{ String: String}?{ 
        return EndeavorATL_NFT.setData[setId]?.getMetadata()
    }
    ...
    pub fun getSetSeriesId(setId: UInt32): UInt32?{ 
        return EndeavorATL_NFT.setData[setId]?.seriesId
    }
    ...
    pub fun getIpfsMetadataHashByNftEdition(setId: UInt32, editionNum: UInt32): String?{ 
        ...
        if let set = EndeavorATL_NFT.setData[setId]{ 
    ...
    init(){ 
        // Set named paths
        self.CollectionStoragePath = /storage/EndeavorATL_NFTCollection
        self.CollectionPublicPath = /public/EndeavorATL_NFTCollection
        self.AdminStoragePath = /storage/EndeavorATL_NFTAdmin
        self.AdminPrivatePath = /private/EndeavorATL_NFTAdminUpgrade
        ...
        self.account.link<&EndeavorATL_NFT.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
