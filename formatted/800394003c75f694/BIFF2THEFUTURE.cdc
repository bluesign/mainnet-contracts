...
pub contract BIFF2THEFUTURE: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                BIFF2THEFUTURE.totalSupply = BIFF2THEFUTURE.totalSupply - self.balance
            }
        }
    }
