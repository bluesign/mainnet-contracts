...
pub contract DefLeppard:
    ...
    pub resource NFT:
        ...
        pub fun externalURL(): MetadataViews.ExternalURL{ 
            return MetadataViews.ExternalURL(
                "https://leppardvault.tibles.com/collection/".concat(
                    self.id.toString()
                )
            )
        }
        ...
        pub fun nftCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(
                ...
                publicCollection: Type<
                    &DefLeppard.Collection{TiblesNFT.CollectionPublic}
                >(),
                publicLinkedType: Type<
                    &DefLeppard.Collection{
        ...
        pub fun nftCollectionDisplay(): MetadataViews.NFTCollectionDisplay{ 
            let squareMedia =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(
                        url: "https://i.tibles.com/m/leppardvault-flow-icon.png"
                    ),
            ...
            let bannerMedia =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(
                        url: "https://i.tibles.com/m/leppardvault-flow-collection-banner.png"
                    ),
                    mediaType: "image/png"
                )
    ...
    access(contract) fun createNewPackMinter(
        id: String,
        contentCapability: Capability,
        acctAddress: Address
    ): @PackMinter{ 
    ...
    init(){ 
        ...
        self
            .description = "Def Leppard officially licensed digital collectibles"
