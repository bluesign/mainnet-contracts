...
pub contract AeraNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: AeraNFT.CollectionStoragePath, publicPath: AeraNFT.CollectionPublicPath, providerPath: AeraNFT.CollectionPrivatePath, publicCollection: Type<&AeraNFT.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, CollectionPublic}>(), publicLinkedType: Type<&AeraNFT.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, CollectionPublic}>(), providerLinkedType: Type<&AeraNFT.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, CollectionPublic}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-AeraNFT.createEmptyCollection()
                        })
    ...
    priv let licenses:{ UInt64: License}
    ...
    priv let playMetadata:{ UInt64: PlayMetadata}
    ...
    priv let players:{ UInt64: Player}
