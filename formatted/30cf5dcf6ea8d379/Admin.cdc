...
pub contract Admin{ 
    ...
    pub resource AdminProxy: AdminProxyClient{ 
        ...
        pub fun mintAeraWithBadges(recipient: &{NonFungibleToken.Receiver}, edition: UInt64, play: AeraNFT.Play, badges: [AeraNFT.Badge]){ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
        ...
        pub fun mintAera(recipient: &{NonFungibleToken.Receiver}, edition: UInt64, play: AeraNFT.Play){ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
        ...
        pub fun mintAeraPanel(recipient: &{NonFungibleToken.Receiver}, edition: UInt64, panelTemplateId: UInt64){ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
        ...
        pub fun mintAeraReward(recipient: &{NonFungibleToken.Receiver}, rewardTemplateId: UInt64, rewardFields:{ UInt64:{ String: String}}): UInt64{ 
            pre{ 
                self.capability != nil:
                    "Cannot create Admin, capability is not set"
            }
