...
pub contract Magnetiq: NonFungibleToken{ 
    ...
    priv var magnetData:{ String: Magnet}
    
    // Variable size dictionary of Memento structs
    priv var mementoData:{ String: Memento}
    
    priv var magnetiqTokenExtraInfo:{ UInt64:{ String: AnyStruct}}
    
    // Variable size dictionary of BrandData structs
    priv var brandData:{ String: BrandData}
    
    // Variable size dictionary of Brand resources
    priv var brands: @{String: Brand}
    
    // Dictionary of sellers allowed to sell non-sellable NFT
    priv var allowedSellersForNonSellableNFT: [Address?]
    ...
    pub struct QueryBrandData{ 
        ...
        priv var magnets: [String]
        
        priv var retired:{ String: Bool}
        
        pub var locked: Bool
        
        priv var numberMintedPerMagnet:{ String: UInt32}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    let royaltyReceiver: Capability<&{FungibleToken.Receiver}> = getAccount(Magnetiq.RoyaltyAddress()).getCapability<&AnyResource{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath())
                    return MetadataViews.Royalties(royalties: [MetadataViews.Royalty(receiver: royaltyReceiver, cut: Magnetiq.royalityPercentage, description: "Magnetiq marketplace royalty")])
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(self.getTokensURL())
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: /storage/MagnetiqTokensCollection, publicPath: /public/MagnetiqTokensCollection, providerPath: /private/MagnetiqTokensCollection, publicCollection: Type<&Magnetiq.Collection{Magnetiq.TokenCollectionPublic}>(), publicLinkedType: Type<&Magnetiq.Collection{Magnetiq.TokenCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Magnetiq.Collection{NonFungibleToken.Provider, Magnetiq.TokenCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: MetadataViews.HTTPFile(url: self.mediumimage()), mediaType: "image/jpeg"), MetadataViews.Media(file: MetadataViews.HTTPFile(url: self.video()), mediaType: "video/mp4")])
            }
            return nil
        }
