...
pub contract IncrementPoints{ 
    ...
    pub event SpecificSwapLpUsdRatioChange(poolAddr: Address, usdRatio: UFix64)
    ...
    priv fun _mint(targetAddr: Address, amount: UFix64){ 
        ...
        let referrerAddr: Address? =
            IncrementReferral.getReferrerByReferee(referee: targetAddr)
        if referrerAddr != nil{ 
    ...
    pub fun getLastestPointsAsReferee(_ userAddr: Address): UFix64{ 
        let referrerAddr =
            IncrementReferral.getReferrerByReferee(referee: userAddr)
    ...
    pub fun getPointsRate_SpecificSwapLPUsdRatio(poolAddr: Address): UFix64{ 
        if IncrementPoints._pointsRate.containsKey("SpecificSwapLpUsdRatio")
        == true
        && (
            IncrementPoints._pointsRate["SpecificSwapLpUsdRatio"]!
            as!{
    ...
    pub resource Admin{ 
        pub            // Set Points Rate
            ...
            emit PointsTierRateChanged(
                ...
                ori: IncrementPoints._pointsRate["stFlowHolding"]!
                as!{
        ...
        pub fun setPointsRate_LendingSupplyTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                ...
                ori: IncrementPoints._pointsRate["LendingSupply"]!
                as!{
        ...
        pub fun setPointsRate_LendingBorrowTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                ...
                ori: IncrementPoints._pointsRate["LendingBorrow"]!
                as!{
        ...
        pub fun setPointsRate_SwapLPTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                source: "SwapLP",
                ori: IncrementPoints._pointsRate["SwapLP"]!
                as!{
        ...
        pub fun setPointsRate_SwapVolumeTier(tierRate:{ UFix64: UFix64}){ 
            emit PointsTierRateChanged(
                source: "SwapVolume",
                ori: IncrementPoints._pointsRate["SwapVolume"]!
                as!{
        ...
        //
        pub fun setPointsRate_SpecificSwapLPUsdRatio(
            poolAddr: Address,
            usdRatio: UFix64
        ){ 
            if IncrementPoints._pointsRate.containsKey("SpecificSwapLpUsdRatio")
            ...
            ).insert(key: poolAddr, usdRatio)
            emit SpecificSwapLpUsdRatioChange(
                poolAddr: poolAddr,
                usdRatio: usdRatio
            )
        }
        ...
        pub fun setHistorySnapshotPoints(
            ...
            if IncrementPoints._pointsHistorySnapshot.containsKey(userAddr)
            == false{ 
            ...
            let preSnapshotBalance =
                IncrementPoints._pointsHistorySnapshot[userAddr]!
            ...
            IncrementPoints._totalSupply = IncrementPoints._totalSupply
                - preSnapshotBalance
                + newSnapshotBalance
            IncrementPoints._pointsHistorySnapshot[
                userAddr
            ] = newSnapshotBalance
        }
        ...
        pub fun addVolumePoints(
            ...
            IncrementPoints.setUserState_SwapVolume(
                userAddr: userAddr,
                volume: IncrementPoints.getUserState_SwapVolume(
                    userAddr: userAddr
                )
                + volumeUsd
            )
            ...
            emit StateUpdated(
                userAddr: userAddr,
                state: IncrementPoints._userStates[userAddr]!
            )
        }
        ...
        pub fun setLastVolumeAndRefereePointsUpdateTimestamp(
            ...
            IncrementPoints
                ._lastVolumeAndRefereePointsUpdateTimestamp = timestamp
        }
