...
pub contract MFLClub: NonFungibleToken{ 
    ...
    pub event ClubFounded(id: UInt64, from: Address?, name: String, description: String, foundationDate: UFix64, foundationLicenseSerialNumber: UInt64?, foundationLicenseCity: String?, foundationLicenseCountry: String?, foundationLicenseSeason: UInt32?)
    ...
    priv let clubsDatas:{ UInt64: ClubData}
    ...
    priv let squadsDatas:{ UInt64: SquadData}
    ...
    pub struct SquadData{ 
        ...
        priv var status: SquadStatus
        
        priv var metadata:{ String: AnyStruct}
        
        priv var competitionsMemberships:{ UInt64: AnyStruct} // {competitionID: AnyStruct}
    ...
    pub struct ClubData{ 
        ...
        priv var status: ClubStatus
        
        priv var squadsIDs: [UInt64]
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MFLClub.CollectionStoragePath, publicPath: MFLClub.CollectionPublicPath, providerPath: MFLClub.CollectionPrivatePath, publicCollection: Type<&MFLClub.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), publicLinked: Type<&MFLClub.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MFLClub.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        priv fun borrowClubRef(id: UInt64): &MFLClub.NFT?{ 
    ...
    pub resource interface ClubAdminClaim{ 
        ...
        pub fun mintClub(id: UInt64, squads: @[Squad], nftMetadata:{ String: AnyStruct}, metadata:{ String: AnyStruct}): @MFLClub.NFT{} 
    ...
    pub resource interface SquadAdminClaim{ 
        ...
        pub fun mintSquad(id: UInt64, clubID: UInt64, type: String, nftMetadata:{ String: AnyStruct}, metadata:{ String: AnyStruct}, competitionsMemberships:{ UInt64: AnyStruct}): @Squad{} 
