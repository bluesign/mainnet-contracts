...
pub contract FlovatarConfrariaToken: FungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&{FungibleToken.Receiver, FungibleToken.Balance}>(self.VaultReceiverPath, target: self.VaultStoragePath)
        self.account.link<&FlovatarConfrariaToken.Vault{FungibleToken.Balance}>(self.VaultBalancePath, target: self.VaultStoragePath)
