...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x114b0a7b4fad41a9
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x114b0a7b4fad41a9
