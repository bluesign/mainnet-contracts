...
pub contract FlovatarMarketplace{ 
    ...
    pub event FlovatarComponentForSale(
        id: UInt64,
        price: UFix64,
        address: Address,
        mint: UInt64
    ...
    pub event FlovatarPriceChanged(
        id: UInt64,
        newPrice: UFix64,
        address: Address
    )
    
    pub event FlovatarComponentPriceChanged(
        id: UInt64,
        newPrice: UFix64,
        address: Address
    )
    ...
    pub event FlovatarComponentPurchased(
        id: UInt64,
        price: UFix64,
        from: Address,
        to: Address
    ...
    pub resource interface SalePublic{ 
        ...
        pub fun getFlovatarComponent(tokenId: UInt64): &{
            FlovatarComponent.Public
        }?{} 
    }
    ...
    pub fun getFlovatarSales(address: Address): [FlovatarSaleData]{ 
        ...
        if let saleCollection =
            ...
            >(){ 
            if !saleCollection.isInstance(
                Type<@FlovatarMarketplace.SaleCollection>()
            ){ 
    ...
    pub fun getFlovatarComponentSales(address: Address): [
        FlovatarComponentSaleData
    ]{ 
    ...
    pub fun getFlovatarComponentSale(
        address: Address,
        id: UInt64
    ): FlovatarComponentSaleData?{ 
        let account = getAccount(address)
        if let saleCollection =
            ...
            if let flovatarComponent =
                saleCollection.getFlovatarComponent(tokenId: id){ 
                let price =
                    saleCollection.getFlovatarComponentPrice(tokenId: id)
