    ...
    pub resource NFT: NonFungibleToken.INFT, Public, MetadataViews.Resolver{ 
        ...
        pub fun resolveView(_ type: Type): AnyStruct?{ 
            ...
            if type == Type<MetadataViews.NFTCollectionData>(){ 
                return MetadataViews.NFTCollectionData(storagePath: FlovatarDustCollectibleAccessory.CollectionStoragePath, publicPath: FlovatarDustCollectibleAccessory.CollectionPublicPath, providerPath: /private/FlovatarComponentCollection, publicCollection: Type<&FlovatarDustCollectibleAccessory.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, FlovatarDustCollectibleAccessory.CollectionPublic}>(), publicLinkedType: Type<&FlovatarDustCollectibleAccessory.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, FlovatarDustCollectibleAccessory.CollectionPublic}>(), providerLinkedType: Type<&FlovatarDustCollectibleAccessory.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, FlovatarDustCollectibleAccessory.CollectionPublic}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                        return <-FlovatarDustCollectibleAccessory.createEmptyCollection()
                    })
            }
            return nil
        }
