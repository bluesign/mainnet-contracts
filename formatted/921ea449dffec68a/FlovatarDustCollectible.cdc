...
import
    FlovatarDustCollectibleTemplate
    from "./FlovatarDustCollectibleTemplate.cdc"

import
    FlovatarDustCollectibleAccessory
    from "./FlovatarDustCollectibleAccessory.cdc"
...
pub contract FlovatarDustCollectible: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, Public, Private, MetadataViews.Resolver{ 
        ...
        priv let accessories: @{UInt32: FlovatarDustCollectibleAccessory.NFT}
        ...
        pub fun resolveView(_ type: Type): AnyStruct?{ 
            ...
            if type == Type<MetadataViews.NFTCollectionData>(){ 
                return MetadataViews.NFTCollectionData(storagePath: FlovatarDustCollectible.CollectionStoragePath, publicPath: FlovatarDustCollectible.CollectionPublicPath, providerPath: /private/FlovatarDustCollectibleCollection, publicCollection: Type<&FlovatarDustCollectible.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, FlovatarDustCollectible.CollectionPublic}>(), publicLinkedType: Type<&FlovatarDustCollectible.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, FlovatarDustCollectible.CollectionPublic}>(), providerLinkedType: Type<&FlovatarDustCollectible.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, FlovatarDustCollectible.CollectionPublic}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                        return <-FlovatarDustCollectible.createEmptyCollection()
                    })
            }
            return nil
        }
    ...
    pub fun createDustCollectible(series: UInt64, layers: [UInt32], templateIds: [UInt64?], address: Address, vault: @FungibleToken.Vault): @FlovatarDustCollectible.NFT{ 
        pre{ 
            vault.isInstance(Type<@FlovatarDustToken.Vault>()):
                "Vault not of the right Token Type"
        }
        ...
        royalties.append(Royalty(wallet: creatorAccount.getCapability<&FlowToken.Vault{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: FlovatarDustCollectible.getRoyaltyCut(), type: RoyaltyType.percentage))
        royalties.append(Royalty(wallet: self.account.getCapability<&FlowToken.Vault{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: FlovatarDustCollectible.getMarketplaceCut(), type: RoyaltyType.percentage))
    ...
    pub resource Admin{ 
        ...
        pub fun createCollectibleSeries(name: String, description: String, svgPrefix: String, svgSuffix: String, priceIncrease: UFix64, layers:{ UInt32: FlovatarDustCollectibleTemplate.Layer}, colors:{ UInt32: String}, metadata:{ String: String}, maxMintable: UInt64): @FlovatarDustCollectibleTemplate.CollectibleSeries{ 
        ...
        // a specific part of the Flovatar (body, hair, eyes, mouth, etc.)
        // More info in the FlovatarComponentTemplate.cdc file
        pub fun createCollectibleTemplate(name: String, description: String, series: UInt64, layer: UInt32, metadata:{ String: String}, rarity: String, basePrice: UFix64, svg: String, maxMintableComponents: UInt64): @FlovatarDustCollectibleTemplate.CollectibleTemplate{ 
