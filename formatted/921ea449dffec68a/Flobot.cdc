...
pub contract Flobot: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, Public, Private, MetadataViews.Resolver{ 
        ...
        pub fun setBackground(component: @FlovatarComponent.NFT): @FlovatarComponent.NFT?{ 
            pre{ 
                ...
                component.getSeries() == self.metadata.series || component.getSeries() == UInt32(1):
        ...
        pub fun resolveView(_ type: Type): AnyStruct?{ 
            ...
            if type == Type<MetadataViews.NFTCollectionData>(){ 
                return MetadataViews.NFTCollectionData(storagePath: Flobot.CollectionStoragePath, publicPath: Flobot.CollectionPublicPath, providerPath: /private/FlobotCollection, publicCollection: Type<&Flobot.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, Flobot.CollectionPublic}>(), publicLinkedType: Type<&Flobot.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, Flobot.CollectionPublic}>(), providerLinkedType: Type<&Flobot.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, Flobot.CollectionPublic}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                        return <-Flobot.createEmptyCollection()
                    })
            }
    ...
    pub fun getCombinationString(body: UInt64, head: UInt64, arms: UInt64, legs: UInt64, face: UInt64): String{ 
    ...
    pub fun checkCombinationAvailable(body: UInt64, head: UInt64, arms: UInt64, legs: UInt64, face: UInt64): Bool{ 
    ...
    pub fun createFlobot(flobotkit: @[FlovatarComponent.NFT], body: UInt64, head: UInt64, arms: UInt64, legs: UInt64, face: UInt64, background: @FlovatarComponent.NFT?, address: Address): @Flobot.NFT{ 
        var i: Int = 0
        ...
        royalties.append(Royalty(wallet: creatorAccount.getCapability<&FlowToken.Vault{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: Flobot.getRoyaltyCut(), type: RoyaltyType.percentage))
        royalties.append(Royalty(wallet: self.account.getCapability<&FlowToken.Vault{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: Flobot.getMarketplaceCut(), type: RoyaltyType.percentage))
