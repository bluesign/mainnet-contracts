...
pub contract Flovatar: NonFungibleToken{ 
    ...
    pub struct Metadata{ 
        ...
        priv let components:{ String: UInt64}
        ...
        pub fun setAccessory(component: @FlovatarComponent.NFT): @FlovatarComponent.NFT?{ 
            pre{ 
                component.getCategory() == "accessory":
                    "The component needs to be an accessory"
                component.getSeries() == self.metadata.series:
        ...
        pub fun setHat(component: @FlovatarComponent.NFT): @FlovatarComponent.NFT?{ 
            pre{ 
                component.getCategory() == "hat":
                    "The component needs to be a hat"
                component.getSeries() == self.metadata.series:
                    "The hat belongs to a different series"
            }
            emit Updated(id: self.id)
        ...
        pub fun setEyeglasses(component: @FlovatarComponent.NFT): @FlovatarComponent.NFT?{ 
            pre{ 
                component.getCategory() == "eyeglasses":
                    "The component needs to be a pair of eyeglasses"
                component.getSeries() == self.metadata.series:
                    "The eyeglasses belongs to a different series"
            }
            emit Updated(id: self.id)
    ...
    pub fun getCombinationString(body: UInt64, hair: UInt64, facialHair: UInt64?, eyes: UInt64, nose: UInt64, mouth: UInt64, clothing: UInt64): String{ 
    ...
    pub fun checkCombinationAvailable(body: UInt64, hair: UInt64, facialHair: UInt64?, eyes: UInt64, nose: UInt64, mouth: UInt64, clothing: UInt64): Bool{ 
    ...
    pub fun createFlovatar(spark: @FlovatarComponent.NFT, body: UInt64, hair: UInt64, facialHair: UInt64?, eyes: UInt64, nose: UInt64, mouth: UInt64, clothing: UInt64, accessory: @FlovatarComponent.NFT?, hat: @FlovatarComponent.NFT?, eyeglasses: @FlovatarComponent.NFT?, background: @FlovatarComponent.NFT?, rareBoost: @[FlovatarComponent.NFT], epicBoost: @[FlovatarComponent.NFT], legendaryBoost: @[FlovatarComponent.NFT], address: Address): @Flovatar.NFT{ 
        pre{ 
            ...
            spark.getCategory() == "spark":
                "The spark component belongs to the wrong category"
        }
        ...
        royalties.append(Royalty(wallet: creatorAccount.getCapability<&FlowToken.Vault{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: Flovatar.getRoyaltyCut(), type: RoyaltyType.percentage))
        royalties.append(Royalty(wallet: self.account.getCapability<&FlowToken.Vault{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: Flovatar.getMarketplaceCut(), type: RoyaltyType.percentage))
    ...
    pub resource Admin{ 
        ...
        pub fun createComponentTemplate(name: String, category: String, color: String, description: String, svg: String, series: UInt32, maxMintableComponents: UInt64, rarity: String): @FlovatarComponentTemplate.ComponentTemplate{ 
        ...
        pub fun createPack(components: @[FlovatarComponent.NFT], randomString: String, price: UFix64, sparkCount: UInt32, series: UInt32, name: String): @FlovatarPack.Pack{ 
