...
pub contract FlovatarDustCollectibleTemplate{ 
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowCollectibleTemplate(id: UInt64): &{
            FlovatarDustCollectibleTemplate.Public
        }?{} 
        
        pub fun borrowCollectibleSeries(id: UInt64): &{
            FlovatarDustCollectibleTemplate.PublicSeries
        }?{} 
    }
    ...
    pub struct CollectibleTemplateData{ 
        ...
        init(
            ...
            self.svg = svg
            self.maxMintableComponents = maxMintableComponents
            self.totalMintedComponents = FlovatarDustCollectibleTemplate
                    .getTotalMintedComponents(id: id)!
            self.currentPrice = FlovatarDustCollectibleTemplate
                    .getTemplateCurrentPrice(id: id)!
            self.lastComponentMintedAt = FlovatarDustCollectibleTemplate
                    .getLastComponentMintedAt(id: id)!
        }
    }
    ...
    pub fun getCollectibleTemplate(id: UInt64): CollectibleTemplateData?{ 
        if let collectibleTemplateCollection =
            ...
            if let collectibleTemplate =
                collectibleTemplateCollection.borrowCollectibleTemplate(
                    id: id
                ){ 
                return CollectibleTemplateData(
                    id: id,
                    ...
                    maxMintableComponents: (collectibleTemplate!)
                        .maxMintableComponents
                )
            }
        }
        return nil
    ...
    pub fun isCollectibleLayerAccessory(layer: UInt32, series: UInt64): Bool{ 
        let series =
            FlovatarDustCollectibleTemplate.getCollectibleSeries(id: series)!
    ...
    access(account) fun increaseTotalMintedComponents(id: UInt64){ 
        let totMintedComponents: UInt64? =
            FlovatarDustCollectibleTemplate.totalMintedComponents[id]
    ...
    access(account) fun setTotalMintedCollectibles(
        series: UInt64,
        value: UInt64
    ){ 
    ...
    access(account) fun increaseTemplatesCurrentPrice(id: UInt64){ 
        let currentPrice: UFix64? =
            FlovatarDustCollectibleTemplate.templatesCurrentPrice[id]
        if currentPrice != nil{ 
    ...
    init(){ 
        self
            .CollectionPublicPath = /public/FlovatarDustCollectibleTemplateCollection
        self
            .CollectionStoragePath = /storage/FlovatarDustCollectibleTemplateCollection
        ...
        self.account.save<@FlovatarDustCollectibleTemplate.Collection>(
            <-FlovatarDustCollectibleTemplate.createEmptyCollection(),
            to: FlovatarDustCollectibleTemplate.CollectionStoragePath
        )
        self.account.link<&{FlovatarDustCollectibleTemplate.CollectionPublic}>(
            FlovatarDustCollectibleTemplate.CollectionPublicPath,
            target: FlovatarDustCollectibleTemplate.CollectionStoragePath
        )
