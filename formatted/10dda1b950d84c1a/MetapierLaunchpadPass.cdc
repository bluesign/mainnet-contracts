...
pub contract MetapierLaunchpadPass: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, PublicPass, PrivatePass{ 
        ...
        priv let fundsVault: @FungibleToken.Vault
        
        priv let launchTokenVault: @FungibleToken.Vault
    ...
    pub resource interface CollectionPublic{ 
        ...
        pub fun borrowPublicPass(id: UInt64): &MetapierLaunchpadPass.NFT{MetapierLaunchpadPass.PublicPass, NonFungibleToken.INFT}{} 
    }
    ...
    pub fun mintNewPass(recipient: Capability<&{NonFungibleToken.CollectionPublic}>, fundsVault: @FungibleToken.Vault, launchTokenVault: @FungibleToken.Vault): UInt64{ 
        let newPass <- create NFT(initID: MetapierLaunchpadPass.totalSupply, // id never repeats originalOwner: recipient.address, fundsVault: <-fundsVault, launchTokenVault: <-launchTokenVault)
