...
pub contract FLOATEventSeries{ 
    ...
    pub event ContractTokenDefintionUpdated(
        identifier: String,
        path: PublicPath,
        isNFT: Bool
    )
    
    pub event FLOATEventSeriesCreated(
        seriesId: UInt64,
        host: Address,
        name: String,
        description: String,
    ...
    pub event FLOATEventSeriesBasicsUpdated(
        seriesId: UInt64,
        host: Address,
        name: String,
        description: String,
    ...
    pub event FLOATEventSeriesSlotUpdated(
        seriesId: UInt64,
        host: Address,
        index: Int,
        eventHost: Address,
    ...
    pub event FLOATEventSeriesGoalAdded(
        seriesId: UInt64,
        host: Address,
        goalTitle: String,
        points: UInt64
    ...
    pub event FLOATEventSeriesTreasuryTokenDeposit(
        seriesId: UInt64,
        host: Address,
        identifier: String,
        amount: UFix64
    ...
    pub event FLOATEventSeriesTreasuryTokenWithdraw(
        seriesId: UInt64,
        host: Address,
        identifier: String,
        amount: UFix64
    ...
    pub event FLOATEventSeriesTreasuryNFTDeposit(
        seriesId: UInt64,
        host: Address,
        identifier: String,
        ids: [
    ...
    pub event FLOATEventSeriesTreasuryNFTWithdraw(
        seriesId: UInt64,
        host: Address,
        identifier: String,
        ids: [
    ...
    pub event FLOATEventSeriesTreasuryUpdateDropReceiver(
        seriesId: UInt64,
        host: Address,
        receiver: Address
    )
    
    pub event FLOATEventSeriesTreasuryDropped(
        seriesId: UInt64,
        host: Address?,
        receiver: Address
    )
    
    pub event FLOATEventSeriesTreasuryStrategyAdded(
        seriesId: UInt64,
        host: Address,
    ...
    pub event FLOATEventSeriesTreasuryStrategyNextStage(
        seriesId: UInt64,
        host: Address,
        strategyIdentifier: String,
        index: Int,
    ...
    pub event FLOATEventSeriesTreasuryClaimed(
        seriesId: UInt64,
        host: Address,
        strategyIdentifier: String,
        index: Int,
    ...
    pub event FLOATEventSeriesGlobalTreasuryStrategyUpdated(
        seriesId: UInt64,
        host: Address
    )
    ...
    pub event FLOATAchievementRecordInitialized(
        seriesId: UInt64,
        host: Address,
        owner: Address
    )
    
    pub event FLOATAchievementGoalAccomplished(
        seriesId: UInt64,
        host: Address,
        owner: Address,
        goalIdx: Int
    ...
    access(account) fun setTokenDefinition(
        token: Type,
        path: PublicPath,
        isNFT: Bool
    ){ 
        ...
        emit ContractTokenDefintionUpdated(
    ...
    pub struct TokenRecipient{ 
        ...
        access(contract) fun isNFT(): Bool{ 
            let tokenInfo =
                FLOATEventSeries.getTokenDefinition(self.identifier)
                ?? panic("Unknown token")
            return tokenInfo.isNFT
        }
        
        // get ft receiver by address and identifier
        access(contract) fun getFungibleTokenReceiver(): &{
            ...
            assert(
                !tokenInfo.isNFT,
                message: "The token should be Fungible Token"
            )
            let receiverVault =
                getAccount(self.address).getCapability(tokenInfo.path).borrow<
                    &{FungibleToken.Receiver}
                >()
                ?? panic(
                    "Could not borrow the &{FungibleToken.Receiver} from "
                        .concat(self.address.toString())
                )
            assert(
        ...
        access(contract) fun getNFTCollectionPublic(): &{
            ...
            assert(
                tokenInfo.isNFT,
                message: "The token should be Non-Fungiable Token"
            )
            let collection =
                getAccount(self.address).getCapability(tokenInfo.path).borrow<
                    &{NonFungibleToken.CollectionPublic}
                >()
                ?? panic(
                    "Could not borrow the &{NonFungibleToken.CollectionPublic} from "
                        .concat(self.address.toString())
                )
    ...
    pub struct EventIdentifier{ 
        ...
        pub fun getEventPublic(): &FLOAT.FLOATEvent{FLOAT.FLOATEventPublic}{ 
            let ownerEvents =
                getAccount(self.host).getCapability(FLOAT.FLOATEventsPublicPath)
        ...
        pub fun toString(): String{ 
            return self.host.toString().concat("#").concat(
                self.eventId.toString()
            )
        }
    }
    ...
    pub struct EventSeriesIdentifier{ 
        ...
        pub fun getEventSeriesPublic(): &FLOATEventSeries.EventSeries{
            EventSeriesPublic
        }{ 
            let ref =
                getAccount(self.host).getCapability(
                    FLOATEventSeries.FLOATEventSeriesBuilderPublicPath
                ).borrow<&EventSeriesBuilder{EventSeriesBuilderPublic}>()
                ?? panic(
                    "Could not borrow the public EventSeriesBuilderPublic."
                )
    ...
    pub struct interface IAchievementGoal{ 
        ...
        access(account) fun verify(
            _ eventSeries: &FLOATEventSeries.EventSeries{EventSeriesPublic},
            user: Address
        ): Bool{} 
    }
    ...
    pub struct interface StrategyDelivery{ 
        ...
        access(contract) fun deliverNFT(
            treasury: &Treasury,
    ...
    pub struct StrategyQueryResultWithUser{ 
        ...
        init(
            ...
            self.userInfo ={} 
            self.userInfo["eligible"] = userEligible != nil
                    ? userEligible!
                    : nil
            self.userInfo["claimable"] = userEligible != nil
                    ? userClaimable!
                    : nil
    ...
    pub resource StrategyController{ 
        // basic info
        priv let info: StrategyInformation
        
        priv let claimed: [Address]
        ...
        access(contract) fun nextStage(): StrategyState{ 
            self.setNextStage(
                next: StrategyState(
                    rawValue: self.info.currentState.rawValue + 1
                )!
            )
            return self.info.currentState
        }
        ...
        // claim one share
        access(contract) fun claimOneShareFromTreasury(
            treasury: &Treasury,
        ...
        access(contract) fun verifyScore(
            user: &Achievement{AchievementPublic}
        ): Bool{ 
    ...
    pub resource interface ITreasuryStrategy{ 
        ...
        access(account) fun isEligible(
            user: &Achievement{AchievementPublic}
        ): Bool{} 
        
        // update user's achievement
        access(account) fun onGoalAccomplished(
            user: &Achievement{AchievementPublic}
        ){ 
            pre{ 
        ...
        access(account) fun verifyClaimable(
            user: &Achievement{AchievementPublic}
        ): Bool{ 
            pre{ 
    ...
    // Treasury Collection
    //
    pub resource TreasuryCollection:
        ...
        pub fun withdraw(withdrawID: UInt64): @NonFungibleToken.NFT{ 
            let token <-
                self.depositedNFTs.remove(key: withdrawID)
                ?? panic("missing NFT")
            return <-token
        }
    ...
    pub resource interface TreasuryPublic{ 
        ...
        pub fun getTreasuryTokenBalance(type: Type): &{
            FungibleToken.Balance
        }?{} 
        
        // get nft collection public 
        pub fun getTreasuryNFTCollection(type: Type): &{
            NonFungibleToken.CollectionPublic
        }?{} 
        
        // get all strategy information
        pub fun getStrategies(
            states: [
                StrategyState
            ]?,
            _ user: &Achievement{AchievementPublic}?
        ): [
        ...
        access(contract) fun borrowStrategyRef(idx: Int): &{
            ITreasuryStrategy
        }{} 
        
        // borrow strategies by state reference
        access(contract) fun borrowStrategiesRef(state: StrategyState?): [
            &{ITreasuryStrategy}
        ]{} 
    }
    ...
    pub resource Treasury: TreasuryPublic{ 
        ...
        priv var receiver: Address
        
        // all treasury strategies
        priv var strategies: @[{ITreasuryStrategy}]
        ...
        // get identifier
        priv fun getParentIdentifier(): EventSeriesIdentifier{ 
    ...
    pub resource EventSeries: EventSeriesPublic, MetadataViews.Resolver{ 
        ...
        // --- data ---
        // FLOAT slots
        priv let slots: [{EventSlot}]
        
        // Achievement goals
        priv let goals: [{IAchievementGoal}]
        
        // nest resource for the EventSeries treasury
        priv var treasury: @Treasury
    ...
    pub resource interface EventSeriesBuilderPublic{ 
        ...
        pub fun borrowEventSeriesPublic(seriesId: UInt64): &EventSeries{
            EventSeriesPublic
        }?{} 
    ...
    pub resource EventSeriesBuilder:
        EventSeriesBuilderPublic,
        MetadataViews.ResolverCollection{
    
        pub let sequence: UInt64
        
        priv var series: @{UInt64: EventSeries}
        
        priv var revoked: @{UInt64: EventSeries}
        ...
        init(){ 
            ...
            FLOATEventSeries.totalEventSeriesBuilder = FLOATEventSeries
                    .totalEventSeriesBuilder
                + 1
        }
        ...
        pub fun borrowViewResolver(id: UInt64): &{MetadataViews.Resolver}{ 
            return &self.series[id] as &{MetadataViews.Resolver}?
            ?? panic("Failed to borrow ViewResolver.")
        }
        ...
        pub fun revokeEventSeries(seriesId: UInt64){ 
            // drop treasury first
            let seriesRef =
                &self.series[seriesId] as &EventSeries?
                ?? panic("The event series does not exist")
            let treasury = seriesRef.borrowTreasury()
            treasury.dropTreasury()
            let one <-
                self.series.remove(key: seriesId)
                ?? panic("The event series does not exist")
        ...
        pub fun recoverEventSeries(seriesId: UInt64){ 
            let one <-
                self.revoked.remove(key: seriesId)
                ?? panic("The event series does not exist")
            self.series[seriesId] <-! one
            emit FLOATEventSeriesRecovered(
                seriesId: seriesId,
    ...
    pub resource interface EventSeriesGlobalPublic{ 
        ...
        access(contract) fun seriesUpdateGoals(
            _ host: Address,
            seriesId: UInt64
        ){} 
        
        // update event series by its treasury strategy
        access(contract) fun seriesUpdateTreasuryStrategy(
            _ host: Address,
            seriesId: UInt64
        ){} 
    ...
    pub resource EventSeriesGlobal: EventSeriesGlobalPublic{ 
        priv var seriesList: [String]
        
        priv var seriesWithTreasuryAvailableList: [String]
        
        priv var seriesMapping:{ String: EventSeriesIdentifier}
    ...
    pub resource interface AchievementBoardPublic{ 
        ...
        pub fun borrowAchievementRecordRef(
            host: Address,
            seriesId: UInt64
    ...
    pub fun borrowEventSeriesGlobal(): &EventSeriesGlobal{
        EventSeriesGlobalPublic
    }{ 
        return self.account.borrow<&EventSeriesGlobal{EventSeriesGlobalPublic}>(
    ...
    init(){ 
        ...
        self
            .FLOATEventSeriesBuilderStoragePath = /storage/FLOATEventSeriesBuilderPathV2
        self
            .FLOATEventSeriesBuilderPublicPath = /public/FLOATEventSeriesBuilderPathV2
        self
            .FLOATAchievementBoardStoragePath = /storage/FLOATAchievementBoardPathV2
        self
            .FLOATAchievementBoardPublicPath = /public/FLOATAchievementBoardPathV2
        self
            .FLOATEventSeriesGlobalStoragePath = /storage/FLOATEventSeriesGlobalPathV2
        self
            .FLOATEventSeriesGlobalPublicPath = /public/FLOATEventSeriesGlobalPathV2
        self.account.save(
