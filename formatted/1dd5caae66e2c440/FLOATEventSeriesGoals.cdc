...
pub contract FLOATEventSeriesGoals{ 
    ...
    pub struct CollectByAmountGoal: FLOATEventSeries.IAchievementGoal{ 
        ...
        // variables
        priv let points: UInt64
        
        priv let amount: UInt64
        
        priv let requiredAmount: UInt64
    ...
    pub struct CollectSpecificFLOATsGoal: FLOATEventSeries.IAchievementGoal{ 
        ...
        priv let floats: [FLOATEventSeries.EventIdentifier]
    ...
    access(contract) fun getFLOATCollection(user: Address): &FLOAT.Collection{
        ...
        return getAccount(user).getCapability(FLOAT.FLOATCollectionPublicPath)
    ...
    access(contract) fun isOwnedFLOAT(user: Address, eventId: UInt64): Bool{ 
        if let collection =
            FLOATEventSeriesGoals.getFLOATCollection(user: user){ 
