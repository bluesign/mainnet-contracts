...
pub contract SA{ 
    ...
    pub fun swapFlowToUsdc_IM(
        ...
        var outVault <-
            (
                getAccount(0xb19436aae4d94622).contracts.borrow<&FungibleToken>(
                    name: "FiatToken"
                )!
            ).createEmptyVault()
        let pool1 =
        ...
        let x =
            (SwapConfig.ScaledUInt256ToUFix64(SwapConfig.sqrt(AA_)) - B)
            / (2.0 * A)
    ...
    pub fun swapUsdcToFlow_IM(
        ...
        var outVault <-
            (
                getAccount(0x1654653399040a61).contracts.borrow<&FungibleToken>(
                    name: "FlowToken"
                )!
            ).createEmptyVault()
        let pool1 =
