...
pub contract OverluPackage: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: OverluPackage.CollectionStoragePath, publicPath: OverluPackage.CollectionPublicPath, providerPath: /private/OverluPackageCollection, publicCollection: Type<&OverluPackage.Collection{OverluPackage.CollectionPublic}>(), publicLinkedType: Type<&OverluPackage.Collection{OverluPackage.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&OverluPackage.Collection{OverluPackage.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter: MinterPublic{ 
        ...
        pub fun mintNFT(typeId: UInt64, recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, thumbnail: String, royalties: [MetadataViews.Royalty]){ 
    ...
    pub fun purchasePackage(userCertificateCap: Capability<&{OverluConfig.IdentityCertificate}>, amount: UInt8, feeToken: @FungibleToken.Vault){ 
        ...
        var idx: UInt8 = 0
        while idx < amount{ 
            minter.mintNFT(typeId: UInt64(1), recipient: getAccount(address).getCapability<&{NonFungibleToken.CollectionPublic}>(OverluPackage.CollectionPublicPath).borrow()!, name: "", description: "", thumbnail: "", royalties: [])
            idx = idx + 1
    ...
    init(){ 
        ...
        self.account.link<&OverluPackage.Collection{NonFungibleToken.CollectionPublic, OverluPackage.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
