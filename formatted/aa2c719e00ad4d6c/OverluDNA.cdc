...
pub contract OverluDNA: NonFungibleToken{ 
    ...
    pub event Minted(id: UInt64, typeId: UInt64, to: Address?)
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: OverluDNA.CollectionStoragePath, publicPath: OverluDNA.CollectionPublicPath, providerPath: /private/OverluDNACollection, publicCollection: Type<&OverluDNA.Collection{OverluDNA.CollectionPublic}>(), publicLinkedType: Type<&OverluDNA.Collection{OverluDNA.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&OverluDNA.Collection{OverluDNA.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&OverluDNA.Collection{NonFungibleToken.CollectionPublic, OverluDNA.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
