...
pub contract OverluModel: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: OverluModel.CollectionStoragePath, publicPath: OverluModel.CollectionPublicPath, providerPath: /private/OverluModelCollection, publicCollection: Type<&OverluModel.Collection{OverluModel.CollectionPublic}>(), publicLinkedType: Type<&OverluModel.Collection{OverluModel.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&OverluModel.Collection{OverluModel.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, thumbnail: String, slotNum: UInt64, royalties: [MetadataViews.Royalty], metadata:{ String: AnyStruct}){ 
    ...
    init(){ 
        ...
        self.account.link<&OverluModel.Collection{NonFungibleToken.CollectionPublic, OverluModel.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
