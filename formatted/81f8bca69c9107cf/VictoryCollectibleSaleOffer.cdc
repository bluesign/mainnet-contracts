...
pub contract VictoryCollectibleSaleOffer{ 
    ...
    pub resource SaleOffer: SaleOfferPublicView{ 
        ...
        priv let sellerItemProvider: Capability<&VictoryCollectible.Collection{NonFungibleToken.Provider}>
        ...
        //
        pub fun accept(buyerCollection: &VictoryCollectible.Collection{NonFungibleToken.Receiver}, buyerPayment: @FungibleToken.Vault, ownerPaymentReceiver: Capability<&{FungibleToken.Receiver}>){ 
            pre{ 
        ...
        //
        init(sellerItemProvider: Capability<&VictoryCollectible.Collection{NonFungibleToken.Provider, VictoryCollectible.VictoryCollectibleCollectionPublic}>, bundleID: UInt64, sellerPaymentReceiver: Capability<&{FungibleToken.Receiver}>, price: UFix64, saleType: UInt8, startTime: UInt32, endTime: UInt32, targetPrice: UFix64, royaltyPaymentReceiver: Capability<&{FungibleToken.Receiver}>, royaltyFactor: UFix64){ 
            pre{ 
        ...
        pub fun createSaleOffer(
            sellerItemProvider: Capability<
                &VictoryCollectible.Collection{
                    ...
                    VictoryCollectible.VictoryCollectibleCollectionPublic
                }
            >,
            bundleID: UInt64,
