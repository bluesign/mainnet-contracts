...
//
pub contract VictoryARCollectible: NonFungibleToken{ 
    ...
    pub resource interface VictoryARCollectibleCollectionPublic{ 
        ...
        pub fun borrowVictoryItem(id: UInt64): &VictoryARCollectible.NFT?{ 
    ...
    pub resource interface VictoryARCollectibleBundle{ 
    ...
    //
    pub resource Collection: VictoryARCollectibleCollectionPublic, VictoryARCollectibleBundle, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic{ 
    ...
    pub resource NFTMinter{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, owner: Address, typeID: UInt64, brandID: UInt64, seriesID: UInt64, dropID: UInt64, contentHash: UInt256, startIssueNum: UInt32, maxIssueNum: UInt32, totalIssueNum: UInt32){ 
            var i: UInt32 = 0
            while i < maxIssueNum{ 
    ...
    //
    pub fun fetch(_ from: Address, itemID: UInt64): &VictoryARCollectible.NFT?{ 
        let collection = (getAccount(from).getCapability(VictoryARCollectible.CollectionPublicPath)!).borrow<&VictoryARCollectible.Collection{VictoryARCollectible.VictoryARCollectibleCollectionPublic}>() ?? panic("Couldn't get collection")
