        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ChainzKey.CollectionStoragePath, publicPath: ChainzKey.CollectionPublicPath, providerPath: /private/ChainzKeyCollection, publicCollection: Type<&ChainzKey.Collection{ChainzKey.CollectionPublic}>(), publicLinkedType: Type<&ChainzKey.Collection{ChainzKey.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ChainzKey.Collection{ChainzKey.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
