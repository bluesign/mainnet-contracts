    ...
    pub resource Admin{ 
        ...
        pub fun openPack(
            ...
            packCollectionRef: &ChainzPack.Collection{
                ChainzPack.AdminAccessible
            },
            cardCollectionRef: &ChainzNFT.Collection{
                ChainzNFT.CollectionPublic
            },
            names: [
                String
            ],
            ...
            let chainzKeyCollection =
                ...
                ?? panic(
                    "This user does not have a ChainzKey Collection set up."
                )
            var i: Int = 0
        ...
        pub fun airdropMoments(
            ...
            let chainzNFTCollection =
                ...
                ?? panic(
                    "This user does not have a ChainzNFT Collection set up."
                )
            var i: Int = 0
        ...
        pub fun reserveMintPack(
            packCollectionRef: &ChainzPack.Collection{
                ChainzPack.CollectionPublic
            },
            packTypeId: UInt64
        ){ 
            ChainzPack.reserveMint(
                packCollectionRef: packCollectionRef,
