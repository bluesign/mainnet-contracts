...
This is the contract for NiftoryDapperMainnet NFTs!
...
import
    ...
    from "../0x7ec1f607f0872a9e/MutableMetadataTemplate.cdc"

import MutableMetadataSet from "../0x7ec1f607f0872a9e/MutableMetadataSet.cdc"

import
    MutableMetadataSetManager
    from "../0x7ec1f607f0872a9e/MutableMetadataSetManager.cdc"

import
    MetadataViewsManager
    from "../0x7ec1f607f0872a9e/MetadataViewsManager.cdc"

import
    NiftoryNonFungibleToken
    from "../0x7ec1f607f0872a9e/NiftoryNonFungibleToken.cdc"

import NiftoryNFTRegistry from "../0x7ec1f607f0872a9e/NiftoryNFTRegistry.cdc"

import
    NiftoryMetadataViewsResolvers
    from "../0x7ec1f607f0872a9e/NiftoryMetadataViewsResolvers.cdc"

import
    NiftoryNonFungibleTokenProxy
    from "../0x7ec1f607f0872a9e/NiftoryNonFungibleTokenProxy.cdc"

pub contract NiftoryDapperMainnet: NonFungibleToken, ViewResolver{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver, NiftoryNonFungibleToken.NFTPublic{ 
        pub let id: UInt64
        ...
        pub fun contract(): &{NiftoryNonFungibleToken.ManagerPublic}{ 
            return NiftoryDapperMainnet.contract()
        }
        
        pub fun set(): &MutableMetadataSet.Set{MutableMetadataSet.Public}{ 
            return self.contract().getSetManagerPublic().getSet(self.setId)
        }
        ...
        pub fun getViews(): [Type]{ 
            return self.contract().getMetadataViewsManagerPublic().getViews()
        }
        
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            let nftRef = &self as &{NiftoryNonFungibleToken.NFTPublic}
            return self.contract().getMetadataViewsManagerPublic().resolveView(view: view, nftRef: nftRef)
        }
        
        init(setId: Int, templateId: Int, serial: UInt64){ 
            self.id = NiftoryDapperMainnet.totalSupply
            NiftoryDapperMainnet.totalSupply = NiftoryDapperMainnet.totalSupply + 1
            self.setId = setId
        ...
        destroy(){ 
            emit NFTBurned(setId: self.setId, templateId: self.templateId, serial: self.serial)
        }
    }
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, NiftoryNonFungibleToken.CollectionPublic, NiftoryNonFungibleToken.CollectionPrivate{ 
        ...
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let token <- token as! @NiftoryDapperMainnet.NFT
        ...
        pub fun depositBulk(tokens: @[NonFungibleToken.NFT]){ 
            while tokens.length > 0{ 
                let token <- tokens.removeLast() as! @NiftoryDapperMainnet.NFT
    ...
    pub resource Manager: NiftoryNonFungibleToken.ManagerPublic, NiftoryNonFungibleToken.ManagerPrivate{ 
        // ========================================================================
        // Public
        // ========================================================================
        
        pub fun metadata(): AnyStruct?{ 
            return NiftoryDapperMainnet.metadata
        }
        
        pub fun getSetManagerPublic(): &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public}{ 
            return NiftoryNFTRegistry.getSetManagerPublic(NiftoryDapperMainnet.REGISTRY_ADDRESS, NiftoryDapperMainnet.REGISTRY_BRAND)
        }
        
        pub fun getMetadataViewsManagerPublic(): &MetadataViewsManager.Manager{MetadataViewsManager.Public}{ 
            return NiftoryNFTRegistry.getMetadataViewsManagerPublic(NiftoryDapperMainnet.REGISTRY_ADDRESS, NiftoryDapperMainnet.REGISTRY_BRAND)
        }
        
        pub fun getNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return NiftoryNFTRegistry.buildNFTCollectionData(NiftoryDapperMainnet.REGISTRY_ADDRESS, NiftoryDapperMainnet.REGISTRY_BRAND, fun (): @NonFungibleToken.Collection{ 
                    return <-NiftoryDapperMainnet.createEmptyCollection()
                })
        }
        ...
        pub fun modifyContractMetadata(): auth &AnyStruct{ 
            ...
            let maybeMetadata = NiftoryDapperMainnet.metadata
            if maybeMetadata == nil{ 
                let blankMetadata:{ String: String} ={} 
                NiftoryDapperMainnet.metadata = blankMetadata
            }
            return (&NiftoryDapperMainnet.metadata as auth &AnyStruct?)!
        }
        
        pub fun replaceContractMetadata(_ metadata: AnyStruct?){ 
            emit ContractMetadataUpdated()
            NiftoryDapperMainnet.metadata = metadata
        }
        ...
        priv fun _getMetadataViewsManagerPrivate(): &MetadataViewsManager.Manager{MetadataViewsManager.Private}{ 
            let record = NiftoryNFTRegistry.getRegistryRecord(NiftoryDapperMainnet.REGISTRY_ADDRESS, NiftoryDapperMainnet.REGISTRY_BRAND)
            let manager = NiftoryDapperMainnet.account.getCapability<&MetadataViewsManager.Manager{MetadataViewsManager.Private}>(record.metadataViewsManager.paths.private).borrow()!
            return manager
        }
        ...
        priv fun _getSetManagerPrivate(): &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}{ 
            let record = NiftoryNFTRegistry.getRegistryRecord(NiftoryDapperMainnet.REGISTRY_ADDRESS, NiftoryDapperMainnet.REGISTRY_BRAND)
            let setManager = NiftoryDapperMainnet.account.getCapability<&MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}>(record.setManager.paths.private).borrow()!
            return setManager
        }
        ...
        priv fun _getSetMutable(_ setId: Int): &MutableMetadataSet.Set{MutableMetadataSet.Private, MutableMetadataSet.Public}{ 
        ...
        priv fun _getTemplateMutable(_ setId: Int, _ templateId: Int): &MutableMetadataTemplate.Template{MutableMetadataTemplate.Public, MutableMetadataTemplate.Private}{ 
        ...
        pub fun mintBulk(setId: Int, templateId: Int, numToMint: UInt64): @[NonFungibleToken.NFT]{ 
            pre{ 
                numToMint > 0:
        ...
        priv fun _getNFTMetadata(_ setId: Int, _ templateId: Int): &MutableMetadata.Metadata{MutableMetadata.Public, MutableMetadata.Private}{ 
    ...
    pub fun contract(): &{NiftoryNonFungibleToken.ManagerPublic}{ 
        return NiftoryNFTRegistry.getNFTManagerPublic(NiftoryDapperMainnet.REGISTRY_ADDRESS, NiftoryDapperMainnet.REGISTRY_BRAND)
    }
        ...
        switch view{ 
            ...
            case Type<MetadataViews.NFTCollectionDisplay>():
                ...
                if view.isInstance(Type<NiftoryMetadataViewsResolvers.NFTCollectionDisplayResolver>()){ 
                    ...
                    // External URL
                    let externalURL = MetadataViews.ExternalURL(url: NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: resolver.defaultExternalURLPrefix, uri: resolver.defaultExternalURL))
                    
                    // Square image
                    let squareImageURL = NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: resolver.defaultSquareImagePrefix, uri: resolver.defaultSquareImage)
                    ...
                    // Banner image
                    let bannerImageURL = NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: resolver.defaultBannerImagePrefix, uri: resolver.defaultBannerImage)
                ...
                if view.isInstance(Type<NiftoryMetadataViewsResolvers.NFTCollectionDisplayResolverWithIpfsGateway>()){ 
                    ...
                    // Square image
                    let squareImageURL = NiftoryMetadataViewsResolvers._useIpfsGateway(ipfsGateway: resolver.ipfsGateway, uri: NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: resolver.defaultSquareImagePrefix, uri: resolver.defaultSquareImage))
                    let squareImageMediaType = resolver.defaultSquareImageMediaType
                    let squareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: squareImageURL), mediaType: squareImageMediaType)
                    
                    // Banner image
                    let bannerImageURL = NiftoryMetadataViewsResolvers._useIpfsGateway(ipfsGateway: resolver.ipfsGateway, uri: NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: resolver.defaultBannerImagePrefix, uri: resolver.defaultBannerImage))
                    let bannerImageMediaType = resolver.defaultBannerImageMediaType
                    let bannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: bannerImageURL), mediaType: bannerImageMediaType)
                    return MetadataViews.NFTCollectionDisplay(name: resolver.defaultName, description: resolver.defaultDescription, externalURL: externalURL, squareImage: squareImage, bannerImage: bannerImage, socials:{} )
                }
            ...
            case Type<MetadataViews.ExternalURL>():
                ...
                if view.isInstance(Type<NiftoryMetadataViewsResolvers.ExternalURLResolver>()){ 
                    ...
                    return MetadataViews.ExternalURL(url: NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: resolver.defaultPrefix, uri: resolver.defaultURL))
                }
                return nil
        }
        return nil
    ...
    init(nftManagerProxy: &{NiftoryNonFungibleTokenProxy.Public, NiftoryNonFungibleTokenProxy.Private}){ 
        let record = NiftoryNFTRegistry.generateRecord(account: self.account.address, project: "clbbadhlr00130flbq4in3lq1_NiftoryDapperMainnet")
        self.REGISTRY_ADDRESS = 0x32d62d5c43ad1038
        self.REGISTRY_BRAND = "clbbadhlr00130flbq4in3lq1_NiftoryDapperMainnet"
        ...
        self.account.save<@MutableMetadataSetManager.Manager>(<-MutableMetadataSetManager.create(name: "NiftoryDapperMainnet", description: "The set manager for NiftoryDapperMainnet."), to: record.setManager.paths.storage)
        
        // MutableMetadataSetManager public
        self.account.link<&MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public}>(record.setManager.paths.public, target: record.setManager.paths.storage)
        
        // MutableMetadataSetManager private
        self.account.link<&MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}>(record.setManager.paths.private, target: record.setManager.paths.storage)
        ...
        self.account.save<@MetadataViewsManager.Manager>(<-MetadataViewsManager.create(), to: record.metadataViewsManager.paths.storage)
        
        // MetadataViewsManager public
        self.account.link<&MetadataViewsManager.Manager{MetadataViewsManager.Public}>(record.metadataViewsManager.paths.public, target: record.metadataViewsManager.paths.storage)
        
        // MetadataViewsManager private
        self.account.link<&MetadataViewsManager.Manager{MetadataViewsManager.Private, MetadataViewsManager.Public}>(record.metadataViewsManager.paths.private, target: record.metadataViewsManager.paths.storage)
        let contractName = "NiftoryDapperMainnet"
        ...
        // Display
        let displayResolver = NiftoryMetadataViewsResolvers.DisplayResolver("title", contractName.concat("NFT"), "description", contractName.concat(" NFT"), "mediaUrl", "ipfs://", "ipfs://bafybeig6la3me5x3veull7jzxmwle4sfuaguou2is3o3z44ayhe7ihlqpa/NiftoryBanner.png")
        nftManager.setMetadataViewsResolver(displayResolver)
        
        // Collection Display
        let collectionResolver = NiftoryMetadataViewsResolvers.NFTCollectionDisplayResolver("title", contractName, "description", contractName.concat(" Collection"), "domainUrl", "https://", "https://niftory.com", "squareImage", "ipfs://", "ipfs://bafybeihc76uodw2at2xi2l5jydpvscj5ophfpqgblbrmsfpeffhcmgdtl4/squareImage.png", "squareImageMediaType", "image/png", "bannerImage", "ipfs://", "ipfs://bafybeig6la3me5x3veull7jzxmwle4sfuaguou2is3o3z44ayhe7ihlqpa/NiftoryBanner.png", "bannerImageMediaType", "image/png", [])
        nftManager.setMetadataViewsResolver(collectionResolver)
        
        // ExternalURL
        let externalURLResolver = NiftoryMetadataViewsResolvers.ExternalURLResolver("domainUrl", "https://", "https://niftory.com")
        nftManager.setMetadataViewsResolver(externalURLResolver)
        
        // Save NFT Manager
        self.account.save<@Manager>(<-nftManager, to: record.nftManager.paths.storage)
        
        // NFT Manager public
        self.account.link<&{NiftoryNonFungibleToken.ManagerPublic}>(record.nftManager.paths.public, target: record.nftManager.paths.storage)
        
        // NFT Manager private
        self.account.link<&Manager{NiftoryNonFungibleToken.ManagerPublic, NiftoryNonFungibleToken.ManagerPrivate}>(record.nftManager.paths.private, target: record.nftManager.paths.storage)
        nftManagerProxy.add(registryAddress: self.REGISTRY_ADDRESS, brand: self.REGISTRY_BRAND, cap: self.account.getCapability<&{NiftoryNonFungibleToken.ManagerPrivate, NiftoryNonFungibleToken.ManagerPublic}>(record.nftManager.paths.private))
    }
}
