...
pub contract RichEntitledFuck: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&RichEntitledFuck.Collection{NonFungibleToken.CollectionPublic, RichEntitledFuck.RichEntitledFuckCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
