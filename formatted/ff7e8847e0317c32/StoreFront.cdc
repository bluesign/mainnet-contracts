...
pub contract StoreFront: NonFungibleToken{ 
    ...
    priv var numberMintedByTemplate:{ UInt64: UInt64}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: StoreFront.collectionStoragePath, publicPath: StoreFront.collectionPublicPath, providerPath: /private/storeFrontNFTCollection, publicCollection: Type<&StoreFront.Collection{StoreFront.CollectionPublic}>(), publicLinkedType: Type<&StoreFront.Collection{StoreFront.CollectionPublic, StoreFront.IRevealNFT, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&StoreFront.Collection{StoreFront.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
