...
pub contract TouchstoneContracts{ 
    ...
    init(){ 
        ...
        self
            .GlobalContractsBookStoragePath = /storage/TouchstoneGlobalContractsBook
        self
            .GlobalContractsBookPublicPath = /public/TouchstoneGlobalContractsBook
        self.account.save(
        ...
        self.account.link<&GlobalContractsBook{GlobalContractsBookPublic}>(
            TouchstoneContracts.GlobalContractsBookPublicPath,
            target: TouchstoneContracts.GlobalContractsBookStoragePath
        )
    }
}
