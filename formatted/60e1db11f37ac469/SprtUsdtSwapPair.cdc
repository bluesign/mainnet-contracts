...
import
    ...
    from "../0x475755d2c9dccc3a/TeleportedSportiumToken.cdc"
...
pub contract SprtUsdtSwapPair: FungibleToken{ 
    ...
    pub fun createEmptyTokenBundle(): @SprtUsdtSwapPair.TokenBundle{ 
        return <-create TokenBundle(fromToken1: <-(TeleportedSportiumToken.createEmptyVault() as! @TeleportedSportiumToken.Vault), fromToken2: <-(TeleportedTetherToken.createEmptyVault() as! @TeleportedTetherToken.Vault))
    }
