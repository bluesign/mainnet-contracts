...
pub contract GrowthAndDevelopmentDao: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                GrowthAndDevelopmentDao.totalSupply = GrowthAndDevelopmentDao.totalSupply - self.balance
            }
        }
    }
