...
pub contract XuniaDao: FungibleToken, ViewResolver{ 
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(storagePath: XuniaDao.VaultStoragePath, receiverPath: XuniaDao.ReceiverPublicPath, metadataPath: XuniaDao.VaultPublicPath, providerPath: /private/XuniaDaoVault, receiverLinkedType: Type<&Vault{FungibleToken.Receiver}>(), metadataLinkedType: Type<&Vault{FungibleToken.Balance, MetadataViews.Resolver}>(), providerLinkedType: Type<&Vault{FungibleToken.Provider}>(), createEmptyVaultFunction: fun (): @Vault{ 
