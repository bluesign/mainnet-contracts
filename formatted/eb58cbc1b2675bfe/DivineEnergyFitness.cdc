...
pub contract DivineEnergyFitness: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        pub fun withdraw(amount: UFix64): @FungibleToken.Vault{ 
            ...
            if let owner: Address = self.owner?.address{ 
                DivineEnergyFitness.setBalance(address: owner, balance: self.balance)
            }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<FungibleTokenMetadataViews.FTView>():
                    return DivineEnergyFitness.resolveView(view)
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                DivineEnergyFitness.totalSupply = DivineEnergyFitness.totalSupply - self.balance
            }
        }
    }
    ...
    pub resource Minter: Toucans.Minter{ 
        pub fun mint(amount: UFix64): @Vault{ 
            post{ 
                DivineEnergyFitness.maxSupply == nil || DivineEnergyFitness.totalSupply <= DivineEnergyFitness.maxSupply!:
                    "Exceeded the max supply of tokens allowd."
            }
            DivineEnergyFitness.totalSupply = DivineEnergyFitness.totalSupply + amount
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(name: "DivineEnergyFitness", symbol: "DVINE", description: "A health and wellness dao ", externalURL: MetadataViews.ExternalURL("instagram.com/divineenergyfitness/"), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL("Divineenergy_"), "discord": MetadataViews.ExternalURL("")})
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(storagePath: DivineEnergyFitness.VaultStoragePath, receiverPath: DivineEnergyFitness.ReceiverPublicPath, metadataPath: DivineEnergyFitness.VaultPublicPath, providerPath: /private/DivineEnergyFitnessVault, receiverLinkedType: Type<&Vault{FungibleToken.Receiver}>(), metadataLinkedType: Type<&Vault{FungibleToken.Balance, MetadataViews.Resolver}>(), providerLinkedType: Type<&Vault{FungibleToken.Provider}>(), createEmptyVaultFunction: fun (): @Vault{ 
                        return <-DivineEnergyFitness.createEmptyVault()
                    })
        }
        return nil
    }
    ...
    init(_paymentTokenInfo: ToucansTokens.TokenInfo, _editDelay: UFix64, _minting: Bool, _initialTreasurySupply: UFix64, _maxSupply: UFix64?, _extra:{ String: AnyStruct}){ 
        ...
        // Paths
        self.VaultStoragePath = /storage/DivineEnergyFitnessVault
        self.ReceiverPublicPath = /public/DivineEnergyFitnessReceiver
        self.VaultPublicPath = /public/DivineEnergyFitnessMetadata
        self.MinterStoragePath = /storage/DivineEnergyFitnessMinter
        self.AdministratorStoragePath = /storage/DivineEnergyFitnessAdmin
