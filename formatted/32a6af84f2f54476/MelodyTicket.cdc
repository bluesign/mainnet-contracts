...
pub contract MelodyTicket: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MelodyTicket.CollectionStoragePath, publicPath: MelodyTicket.CollectionPublicPath, providerPath: /private/MelodyTicketCollection, publicCollection: Type<&MelodyTicket.Collection{MelodyTicket.CollectionPublic}>(), publicLinkedType: Type<&MelodyTicket.Collection{MelodyTicket.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MelodyTicket.Collection{MelodyTicket.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-MelodyTicket.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return MetadataViews.NFTCollectionDisplay(name: "The Melody ticket NFT", description: "This collection is Melody ticket NFT.", externalURL: MetadataViews.ExternalURL(""), // todo squareImage: MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://trello.com/1/cards/62dd12a167854020143ccd01/attachments/631422356f0fe60111e1ed3c/previews/631422366f0fe60111e1ed43/download/image.png"), mediaType: "image/png"), bannerImage: MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://trello.com/1/cards/62dd12a167854020143ccd01/attachments/631423e7c7e6b800d710f2a1/download/image.png") // todo, mediaType: "image/png"), socials:{ "twitter": MetadataViews.ExternalURL("https://twitter.com/lyric_labs"), "website": MetadataViews.ExternalURL("https://lyriclabs.xyz")})
    ...
    pub resource NFTMinter{ 
        ...
        access(account) fun mintNFT(name: String, description: String, metadata:{ String: AnyStruct}): @MelodyTicket.NFT{ 
    ...
    init(){ 
        ...
        self.account.link<&MelodyTicket.Collection{NonFungibleToken.CollectionPublic, MelodyTicket.CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
        // create a public capability for the collection
        self.account.link<&MelodyTicket.Collection{MelodyTicket.CollectionPrivate}>(self.CollectionPrivatePath, target: self.CollectionStoragePath)
