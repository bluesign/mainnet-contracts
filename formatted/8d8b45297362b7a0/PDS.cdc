...
pub contract PDS{ 
    ...
    access(contract) fun releaseEscrow(
        nftIds: [
            UInt64
        ],
        recvCap: &{NonFungibleToken.CollectionPublic},
        ...
        let pdsCollection =
            self.account.getCapability(collectionProviderPath).borrow<
    ...
    pub fun setNextDistId(distId: UInt64){ 
        self.nextDistId = distId
    }
    
    pub fun getNextDistId(): UInt64{ 
        return self.nextDistId
    }
