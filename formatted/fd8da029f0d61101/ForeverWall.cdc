        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ForeverWall.CollectionStoragePath, publicPath: ForeverWall.CollectionPublicPath, providerPath: /private/ForeverWallCollection, publicCollection: Type<&ForeverWall.Collection{ForeverWall.ForeverWallCollectionPublic}>(), publicLinkedType: Type<&ForeverWall.Collection{ForeverWallCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ForeverWall.Collection{ForeverWallCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
