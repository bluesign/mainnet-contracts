...
pub contract MathUtils: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes:{ String: String}, rarity: String){ 
            MathUtils                     // Increment the global Item IDs
                     .totalSupply = MathUtils.totalSupply + 1 as UInt64
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: MathUtils.CollectionStoragePath, publicPath: MathUtils.CollectionPublicPath, providerPath: /private/MathUtilsCollection, publicCollection: Type<&MathUtils.Collection{MathUtils.MathUtilsCollectionPublic}>(), publicLinkedType: Type<&MathUtils.Collection{MathUtilsCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&MathUtils.Collection{MathUtilsCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(name: "MathUtils", description: MathUtils.Description, externalURL: MathUtils.ExternalURL, squareImage: MathUtils.SquareImage, bannerImage: MathUtils.BannerImage, socials: MathUtils.Socials)
