...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xbb85167b7d2e1077
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xbb85167b7d2e1077
