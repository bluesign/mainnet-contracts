...
pub contract AllDaySeasonal: NonFungibleToken{ 
    ...
    pub event EditionCreated(id: UInt64, metadata:{ String: String})
    ...
    //
    pub resource interface AllDaySeasonalCollectionPublic{ 
        ...
        pub fun borrowAllDaySeasonal(id: UInt64): &AllDaySeasonal.NFT?{ 
    ...
    // An NFT Collection
    //
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, AllDaySeasonalCollectionPublic{ 
    ...
    init(){ 
        ...
        self.account.link<&AllDaySeasonal.Admin{AllDaySeasonal.NFTMinter}>(self.MinterPrivatePath, target: self.AdminStoragePath)
