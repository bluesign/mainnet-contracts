...
pub contract Merchandise: CapsuleNFT{ 
    ...
    pub event MerchandiseMinted(id: String, item: String, collection: String, type: String, edition: String, description: String, retailPrice: UFix64, mediaUri: String, mintedTime: String, resourceId: UInt64)
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintMerchandise(recipientCollection: &{CapsuleNFT.CollectionPublic}, id: String, item: String, collection: String, type: String, edition: String, description: String, retailPrice: UFix64, mediaUri: String, mintedTime: String){ 
    ...
    init(){ 
        ...
        self.account.link<&Merchandise.Collection{CapsuleNFT.CollectionPublic, Merchandise.MerchandiseCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
