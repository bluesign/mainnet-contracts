...
pub contract BloctoDAO{ 
    ...
    pub struct Topic{ 
        ...
        init(
            ...
            self.minVoteStakingAmount = minVoteStakingAmount != nil
                    ? minVoteStakingAmount!
                    : 0.0
        ...
        pub fun vote(voterAddr: Address, optionIndex: Int){ 
            ...
            assert(
                voterStaked >= self.minVoteStakingAmount,
    ...
    pub fun getStakedBLT(address: Address): UFix64{ 
        let collectionRef =
            getAccount(address).getCapability(/public/bloctoPassCollection)
                .borrow<
                &{
                    NonFungibleToken.CollectionPublic,
                    BloctoPass.CollectionPublic
                }
            >()
