...
pub contract ZeedzINO: NonFungibleToken{ 
    ...
    pub event Evolved(oldID: UInt64, newID: UInt64, name: String, description: String, typeID: UInt32, serialNumber: String, edition: UInt32, rarity: String, carbonOffset: UInt64)
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ZeedzINO.CollectionStoragePath, publicPath: ZeedzINO.CollectionPublicPath, providerPath: /private/ZeedzINOCollection, publicCollection: Type<&ZeedzINO.Collection{ZeedzINO.ZeedzCollectionPublic}>(), publicLinked: Type<&ZeedzINO.Collection{ZeedzINO.ZeedzCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ZeedzINO.Collection{ZeedzINO.ZeedzCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource interface ZeedzCollectionPublic{ 
        ...
        access(contract) fun retrieve(id: UInt64): @NonFungibleToken.NFT{} 
    }
    ...
    pub resource Administrator{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, typeID: UInt32, serialNumber: String, edition: UInt32, editionCap: UInt32, evolutionStage: UInt32, rarity: String, imageURI: String){ 
            recipient.deposit(token: <-create ZeedzINO.NFT(initID: ZeedzINO.totalSupply, initName: name, initDescription: description, initTypeID: typeID, initSerialNumber: serialNumber, initEdition: edition, initEdition: editionCap, initEvolutionStage: evolutionStage, initRarity: rarity, initImageURI: imageURI, initCarbonOffset: 0))
        ...
        //
        pub fun retrieveNFT(from: &{ZeedzINO.ZeedzCollectionPublic}, id: UInt64): @NonFungibleToken.NFT{ 
        ...
        pub fun evolve(zeedle: @ZeedzINO.NFT?, nextEvolutionMetadata:{ String: String}): @ZeedzINO.NFT{ 
