...
pub contract ZeedzMarketplace{ 
    ...
    pub resource Administrator{ 
        pub fun updateSaleCutRequirement(
            requirements: [
                SaleCutRequirement
            ],
            vaultType: Type
            ...
            ZeedzMarketplace.saleCutRequirements[
                vaultType.identifier
            ] = requirements
        }
    ...
    pub fun addListing(
        ...
        let indexToInsertListingID =
            self.getIndexToAddListingID(item: item, items: self.listingIDs)
        self.addItem(
            item,
            storefrontPublicCapability: storefrontPublicCapability,
    ...
    //
    pub fun getVaultTypeSaleCutRequirements(vaultType: Type): [
        SaleCutRequirement
    ]?{ 
    ...
    access(contract) fun addItem(
        ...
        if let requirements =
            self.saleCutRequirements[
                item.listingDetails.salePaymentVaultType.identifier
            ]{ 
            for requirement in requirements{ 
    ...
    //
    access(contract) fun getIndexToAddListingID(
        item: Item,
        items: [
            UInt64
        ]
    ...
    //
    access(contract) fun getIndexToRemoveListingID(
        item: Item,
        items: [
            UInt64
        ]
