...
pub contract ZeedzDrops{ 
    ...
    pub struct ProductDetails{ 
        ...
        access(contract) fun setStartTime(startTime: UFix64){ 
            assert(
                ...
                message: "startTime should be lesser than endTime"
            )
        ...
        access(contract) fun setEndTime(endTime: UFix64){ 
            assert(
                endTime > self.timeStart,
                message: "endTime should be grater than startTime"
            )
    ...
    pub resource Product: ProductPublic{ 
        ...
        destroy(){ 
            emit ProductRemoved(productID: self.uuid)
        }
    ...
    pub resource DropsAdmin: ProductsManager, DropsManager{ 
        pub fun addProduct(name: String, description: String, id: String, total: UInt64, saleEnabled: Bool, timeStart: UFix64, timeEnd: UFix64, prices:{ String: UFix64}): UInt64{ 
