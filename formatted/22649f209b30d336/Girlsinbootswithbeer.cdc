/*
Girlsinbootswithbeer

This is the contract for Girlsinbootswithbeer NFTs!
...
pub contract Girlsinbootswithbeer: NonFungibleToken, ViewResolver{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver, NiftoryNonFungibleToken.NFTPublic{ 
        ...
        pub fun contract(): &{NiftoryNonFungibleToken.ManagerPublic}{ 
            return Girlsinbootswithbeer.contract()
        }
        ...
        init(setId: Int, templateId: Int, serial: UInt64){ 
            self.id = Girlsinbootswithbeer.totalSupply
            Girlsinbootswithbeer.totalSupply = Girlsinbootswithbeer.totalSupply + 1
            self.setId = setId
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, NiftoryNonFungibleToken.CollectionPublic, NiftoryNonFungibleToken.CollectionPrivate{ 
        ...
        pub fun deposit(token: @NonFungibleToken.NFT){ 
            let token <- token as! @Girlsinbootswithbeer.NFT
        ...
        pub fun depositBulk(tokens: @[NonFungibleToken.NFT]){ 
            while tokens.length > 0{ 
                let token <- tokens.removeLast() as! @Girlsinbootswithbeer.NFT
    ...
    pub resource Manager: NiftoryNonFungibleToken.ManagerPublic, NiftoryNonFungibleToken.ManagerPrivate{ 
        ...
        pub fun metadata(): AnyStruct?{ 
            return Girlsinbootswithbeer.metadata
        }
        
        pub fun getSetManagerPublic(): &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public}{ 
            return NiftoryNFTRegistry.getSetManagerPublic(Girlsinbootswithbeer.REGISTRY_ADDRESS, Girlsinbootswithbeer.REGISTRY_BRAND)
        }
        
        pub fun getMetadataViewsManagerPublic(): &MetadataViewsManager.Manager{MetadataViewsManager.Public}{ 
            return NiftoryNFTRegistry.getMetadataViewsManagerPublic(Girlsinbootswithbeer.REGISTRY_ADDRESS, Girlsinbootswithbeer.REGISTRY_BRAND)
        }
        
        pub fun getNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return NiftoryNFTRegistry.buildNFTCollectionData(Girlsinbootswithbeer.REGISTRY_ADDRESS, Girlsinbootswithbeer.REGISTRY_BRAND, fun (): @NonFungibleToken.Collection{ 
                    return <-Girlsinbootswithbeer.createEmptyCollection()
                })
        }
        ...
        pub fun modifyContractMetadata(): auth &AnyStruct{ 
            ...
            let maybeMetadata = Girlsinbootswithbeer.metadata
            if maybeMetadata == nil{ 
                let blankMetadata:{ String: String} ={} 
                Girlsinbootswithbeer.metadata = blankMetadata
            }
            return (&Girlsinbootswithbeer.metadata as auth &AnyStruct?)!
        }
        
        pub fun replaceContractMetadata(_ metadata: AnyStruct?){ 
            emit ContractMetadataUpdated()
            Girlsinbootswithbeer.metadata = metadata
        }
        ...
        priv fun _getMetadataViewsManagerPrivate(): &MetadataViewsManager.Manager{MetadataViewsManager.Private}{ 
            ...
            let manager = Girlsinbootswithbeer.account.getCapability<&MetadataViewsManager.Manager{MetadataViewsManager.Private}>(record.metadataViewsManager.paths.private).borrow()!
            return manager
        }
        ...
        priv fun _getSetManagerPrivate(): &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}{ 
            let record = NiftoryNFTRegistry.getRegistryRecord(Girlsinbootswithbeer.REGISTRY_ADDRESS, Girlsinbootswithbeer.REGISTRY_BRAND)
            let setManager = Girlsinbootswithbeer.account.getCapability<&MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public, MutableMetadataSetManager.Private}>(record.setManager.paths.private).borrow()!
            return setManager
        }
    ...
    pub fun contract(): &{NiftoryNonFungibleToken.ManagerPublic}{ 
        return NiftoryNFTRegistry.getNFTManagerPublic(Girlsinbootswithbeer.REGISTRY_ADDRESS, Girlsinbootswithbeer.REGISTRY_BRAND)
    }
    ...
    init(nftManagerProxy: &{NiftoryNonFungibleTokenProxy.Public, NiftoryNonFungibleTokenProxy.Private}){ 
        let record = NiftoryNFTRegistry.generateRecord(account: self.account.address, project: "clg8k5ynk0000jm0w2mv5o2a3_Girlsinbootswithbeer")
        self.REGISTRY_ADDRESS = 0x32d62d5c43ad1038
        self.REGISTRY_BRAND = "clg8k5ynk0000jm0w2mv5o2a3_Girlsinbootswithbeer"
        ...
        self.account.save<@MutableMetadataSetManager.Manager>(<-MutableMetadataSetManager.create(name: "Girlsinbootswithbeer", description: "The set manager for Girlsinbootswithbeer."), to: record.setManager.paths.storage)
        ...
        let contractName = "Girlsinbootswithbeer"
