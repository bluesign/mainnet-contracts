...
pub contract GummyBear: FungibleToken{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                GummyBear.totalSupply = GummyBear.totalSupply - self.balance
            }
        }
    }
