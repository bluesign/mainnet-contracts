...
pub contract AlphaNFTV1: NonFungibleToken{ 
    ...
    access(account) fun mintNFT(templateInfo:{ String: UInt64}, account: Address){ 
        ...
        let recipientCollection = receiptAccount.getCapability(AlphaNFTV1.CollectionPublicPath).borrow<&{AlphaNFTV1.AlphaNFTV1CollectionPublic}>() ?? panic("Could not get receiver reference to the NFT Collection")
