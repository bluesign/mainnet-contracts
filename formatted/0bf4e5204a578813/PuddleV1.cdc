...
pub contract PuddleV1: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: PuddleV1.CollectionStoragePath, publicPath: PuddleV1.CollectionPublicPath, providerPath: /private/PuddleV1Collection, publicCollection: Type<&PuddleV1.Collection{PuddleV1.PuddleV1CollectionPublic}>(), publicLinkedType: Type<&PuddleV1.Collection{PuddleV1.PuddleV1CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&PuddleV1.Collection{PuddleV1.PuddleV1CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&PuddleV1.Collection{NonFungibleToken.CollectionPublic, PuddleV1.PuddleV1CollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
