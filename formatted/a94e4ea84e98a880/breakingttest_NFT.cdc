...
pub contract breakingttest_NFT: NonFungibleToken{ 
    ...
    pub resource Series{ 
        ...
        //
        pub fun mintbreakingttest_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32){ 
            pre{ 
        ...
        pub fun batchMintbreakingttest_NFT(recipient: &{NonFungibleToken.CollectionPublic}, setId: UInt32, tokenIds: [UInt64]){ 
            pre{ 
                tokenIds.length > 0:
    ...
    pub resource interface breakingttest_NFTCollectionPublic{ 
        ...
        pub fun borrowbreakingttest_NFT(id: UInt64): &breakingttest_NFT.NFT?{ 
    ...
    //
    pub resource Collection: breakingttest_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic{ 
    ...
    //
    pub fun fetch(_ from: Address, id: UInt64): &breakingttest_NFT.NFT?{ 
        let collection = getAccount(from).getCapability(breakingttest_NFT.CollectionPublicPath).borrow<&breakingttest_NFT.Collection{breakingttest_NFT.breakingttest_NFTCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    pub fun getAllSeries(): [breakingttest_NFT.SeriesData]{ 
    ...
    pub fun getAllSets(): [breakingttest_NFT.NFTSetData]{ 
    ...
    init(){ 
        ...
        self.account.link<&breakingttest_NFT.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
