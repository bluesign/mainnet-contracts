...
pub contract Unleash: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: Unleash.CollectionStoragePath, publicPath: Unleash.CollectionPublicPath, providerPath: Unleash.CollectionPrivatePath, publicCollection: Type<&Unleash.Collection{Unleash.UnleashCollectionPublic}>(), publicLinkedType: Type<&Unleash.Collection{Unleash.UnleashCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Unleash.Collection{Unleash.UnleashCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        self.totalSupply = 0
        self.imageIpfsCids = ["bafkreiecrru5wuz7fbaui3bjc3ywry2itor2pjqywjajtbrmithxgcnvzu", // Unleash Logo "bafkreifj3peaxpqlhyt2plpep4rceulmx3dqajlxdeyvrra2djnorvod7m"] // Unleash Key Visual
        ...
        self.account.link<&Unleash.Collection{NonFungibleToken.CollectionPublic, Unleash.UnleashCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
