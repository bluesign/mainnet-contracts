...
pub contract appstoretest8_NFT: NonFungibleToken{ 
    
    // appstoretest8_NFT Events
    //
    // Emitted when the appstoretest8_NFT contract is created
    ...
    // totalSupply
    // The total number of appstoretest8_NFT that have been minted
    //
    ...
    // A Series is special resource type that contains functions to mint appstoretest8_NFT NFTs, 
    ...
    pub resource Series{ 
        ...
        init(seriesId: UInt32, metadata:{ String: String}){ 
            ...
            self.setIds = []
            self.setSealedState ={} 
            appstoretest8_NFT.seriesData[seriesId] = SeriesData(seriesId: seriesId, metadata: metadata)
        ...
        pub fun addNftSet(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            ...
            appstoretest8_NFT.setData[setId] = newNFTSet
        ...
        pub fun updateSeriesMetadata(metadata:{ String: String}){ 
            ...
            appstoretest8_NFT.seriesData[self.seriesId] = newSeriesMetadata
        ...
        pub fun updateSetMetadata(setId: UInt32, maxEditions: UInt32, ipfsMetadataHashes:{ UInt32: String}, metadata:{ String: String}){ 
            ...
            appstoretest8_NFT.setData[setId] = newSetMetadata
            emit SetMetadataUpdated(seriesId: self.seriesId, setId: setId)
        }
        
        // mintappstoretest8_NFT
        // Mints a new NFT with a new ID
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintappstoretest8_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= appstoretest8_NFT.getSetMaxEditions(setId: setId)!:
            ...
            recipient.deposit(token: <-create appstoretest8_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: editionNum))
            
            // Increment the count of global NFTs 
            appstoretest8_NFT.totalSupply = appstoretest8_NFT.totalSupply + 1 as UInt64
            
            // Update the count of Editions minted in the set
            self.numberEditionsMintedPerSet[setId] = editionNum
        }
        
        // mintEditionappstoretest8_NFT
        // Mints a new NFT with a new ID and specific edition Num (random open edition)
        // and deposits it in the recipients collection using their collection reference
        //
        pub fun mintEditionappstoretest8_NFT(recipient: &{NonFungibleToken.CollectionPublic}, tokenId: UInt64, setId: UInt32, edition: UInt32){ 
            pre{ 
                self.numberEditionsMintedPerSet[setId] != nil:
                    "The Set does not exist."
                self.numberEditionsMintedPerSet[setId]! <= appstoretest8_NFT.getSetMaxEditions(setId: setId)!:
            ...
            // deposit it in the recipient's account using their reference
            recipient.deposit(token: <-create appstoretest8_NFT.NFT(tokenId: tokenId, setId: setId, editionNum: edition))
        ...
        pub fun batchMintappstoretest8_NFT(recipient: &{NonFungibleToken.CollectionPublic}, setId: UInt32, tokenIds: [UInt64]){ 
            pre{ 
                tokenIds.length > 0:
                    "Number of token Ids must be > 0"
            }
            for tokenId in tokenIds{ 
                self.mintappstoretest8_NFT(recipient: recipient, tokenId: tokenId, setId: setId)
            }
        }
    ...
    // A resource that represents the appstoretest8_NFT NFT
    //
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        init(tokenId: UInt64, setId: UInt32, editionNum: UInt32){ 
            ...
            let seriesId = appstoretest8_NFT.getSetSeriesId(setId: setId)!
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(name: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "name")!, description: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "description")!, thumbnail: MetadataViews.HTTPFile(url: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!))
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(self.id)
                case Type<MetadataViews.Editions>():
                    let maxEditions = appstoretest8_NFT.setData[self.setId]?.maxEditions ?? 0
                    let editionName = appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "name")!
                ...
                case Type<MetadataViews.ExternalURL>():
                    if let externalBaseURL = appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "external_token_base_url"){ 
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    for metadataKey in (appstoretest8_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 13{ 
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_"{ 
                                ...
                                let royaltyAddress = appstoretest8_NFT.convertStringToAddress(appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_addr_".concat(royaltyName))!)!
                                let royaltyReceiver: PublicPath = PublicPath(identifier: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_rcv_".concat(royaltyName))!)!
                                let royaltyCut = appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_cut_".concat(royaltyName))!
                                let cutValue: UFix64 = appstoretest8_NFT.royaltyCutStringToUFix64(royaltyCut)
                                if cutValue != 0.0{ 
                                    royalties.append(MetadataViews.Royalty(receiver: getAccount(royaltyAddress).getCapability<&FungibleToken.Vault{FungibleToken.Receiver}>(royaltyReceiver), cut: cutValue, description: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!))
                                }
                            }
                        }
                    }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: appstoretest8_NFT.CollectionStoragePath, publicPath: appstoretest8_NFT.CollectionPublicPath, providerPath: /private/appstoretest8_NFT, publicCollection: Type<&appstoretest8_NFT.Collection{appstoretest8_NFT.appstoretest8_NFTCollectionPublic, NonFungibleToken.CollectionPublic}>(), publicLinkedType: Type<&appstoretest8_NFT.Collection{appstoretest8_NFT.appstoretest8_NFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&appstoretest8_NFT.Collection{appstoretest8_NFT.appstoretest8_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-appstoretest8_NFT.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.gigantik.io/appstoretest8/square.png"), mediaType: "image/png")
                    let bannerImage = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://media.gigantik.io/appstoretest8/banner.png"), mediaType: "image/png")
                    ...
                    for metadataKey in (appstoretest8_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 18{ 
                            if metadataKey.slice(from: 0, upTo: 18) == "collection_social_"{ 
                                ...
                                socials.insert(key: metadataKey.slice(from: 18, upTo: metadataKey.length), MetadataViews.ExternalURL(appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!))
                            }
                        }
                    }
                    return MetadataViews.NFTCollectionDisplay(name: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "", description: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "", externalURL: MetadataViews.ExternalURL(appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""), squareImage: squareImage, bannerImage: bannerImage, socials: socials)
                    ...
                    for metadataKey in (appstoretest8_NFT.getSetMetadata(setId: self.setId)!).keys{ 
                        ...
                        if metadataKey.length >= 6{ 
                            if metadataKey.slice(from: 0, upTo: 6) == "trait_"{ 
                                ...
                                traitDictionary.insert(key: metadataKey.slice(from: 6, upTo: metadataKey.length), appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: metadataKey)!)
                            }
                        }
                    }
                    return MetadataViews.dictToTraits(dict: traitDictionary, excludedNames: [])
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: MetadataViews.HTTPFile(url: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "image")!), mediaType: self.getMimeType())])
            }
            return nil
        }
        
        pub fun getMimeType(): String{ 
            var metadataFileType = (appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "image_file_type")!).toLower()
    ...
    // to allow others to deposit appstoretest8_NFT into their Collection. It also allows for reading
    // the details of appstoretest8_NFT in the Collection.
    pub resource interface appstoretest8_NFTCollectionPublic{ 
        ...
        pub fun borrowappstoretest8_NFT(id: UInt64): &appstoretest8_NFT.NFT?{ 
            // If the result isn't nil, the id of the returned reference
            // should be the same as the argument to the function
            post{ 
                result == nil || result?.id == id:
                    "Cannot borrow appstoretest8_NFT reference: The ID of the returned reference is incorrect"
            }
        }
    }
    
    // Collection
    // A collection of appstoretest8_NFT NFTs owned by an account
    //
    pub resource Collection: appstoretest8_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        // borrowappstoretest8_NFT
        // Gets a reference to an NFT in the collection as a appstoretest8_NFT,
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver}{ 
            ...
            let appstoretest8_NFTNft = nft as! &appstoretest8_NFT.NFT
            return appstoretest8_NFTNft as &AnyResource{MetadataViews.Resolver}
        }
    ...
    // fetch
    // Get a reference to a appstoretest8_NFT from an account's Collection, if available.
    // If an account does not have a appstoretest8_NFT.Collection, panic.
    ...
    //
    pub fun fetch(_ from: Address, id: UInt64): &appstoretest8_NFT.NFT?{ 
        let collection = getAccount(from).getCapability(appstoretest8_NFT.CollectionPublicPath).borrow<&appstoretest8_NFT.Collection{appstoretest8_NFT.appstoretest8_NFTCollectionPublic}>() ?? panic("Couldn't get collection")
        // We trust appstoretest8_NFT.Collection.borrowappstoretest8_NFT to get the correct id
        // (it checks it before returning it).
        return collection.borrowappstoretest8_NFT(id: id)
    }
    
    // getAllSeries returns all the sets
    //
    // Returns: An array of all the series that have been created
    pub fun getAllSeries(): [appstoretest8_NFT.SeriesData]{ 
    ...
    pub fun getAllSets(): [appstoretest8_NFT.NFTSetData]{ 
    ...
    init(){ 
        // Set named paths
        self.CollectionStoragePath = /storage/appstoretest8_NFTCollection
        self.CollectionPublicPath = /public/appstoretest8_NFTCollection
        self.AdminStoragePath = /storage/appstoretest8_NFTAdmin
        self.AdminPrivatePath = /private/appstoretest8_NFTAdminUpgrade
        ...
        self.account.link<&appstoretest8_NFT.Admin>(self.AdminPrivatePath, target: self.AdminStoragePath) ?? panic("Could not get a capability to the admin")
