...
pub contract FURC20FTShared{ 
    ...
    pub resource Change: Balance, Settler{ 
        ...
        ///
        priv fun borrowVault(): &FungibleToken.Vault{ 
    ...
    init(){ 
        // Transaction Hook
        let hookIdentifier =
            "FURC20FTShared_".concat(self.account.address.toString()).concat(
                "_transactionHook"
            )
        ...
        // Shared Store
        let identifier =
            "FURC20SharedStore_".concat(self.account.address.toString())
