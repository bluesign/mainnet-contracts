...
pub contract LockedTokens{ 
    ...
    pub event UnlockLimitIncreased(
        address: Address,
        increaseAmount: UFix64,
        newLimit: UFix64
    )
    
    pub event LockedAccountRegisteredAsNode(address: Address, nodeID: String)
    
    pub event LockedAccountRegisteredAsDelegator(
        address: Address,
        nodeID: String
    )
    ...
    pub resource LockedTokenManager:
        ...
        priv fun depositUnlockedTokens(from: @FungibleToken.Vault){ 
        ...
        priv fun withdrawUnlockedTokens(amount: UFix64): @FungibleToken.Vault{ 
            pre{ 
        ...
        priv fun decreaseUnlockLimit(delta: UFix64){ 
        ...
        pub fun registerNode(nodeInfo: StakingProxy.NodeInfo, amount: UFix64){ 
            ...
            destroy nodeStaker
            emit LockedAccountRegisteredAsNode(
                address: (self.owner!).address,
                nodeID: nodeInfo.id
            )
        }
        ...
        pub fun registerDelegator(nodeID: String, amount: UFix64){ 
            ...
            assert(
                vaultRef.balance
                >= FlowIDTableStaking.getDelegatorMinimumStakeRequirement(),
            ...
            destroy delegator
            emit LockedAccountRegisteredAsDelegator(
                address: (self.owner!).address,
                nodeID: nodeID
            )
        }
    ...
    pub resource TokenHolder:
        ...
        /// as a node operator
        priv var nodeStakerProxy: LockedNodeStakerProxy?
        
        /// Used to perform delegating actions if the user has signed up
        /// as a delegator
        priv var nodeDelegatorProxy: LockedNodeDelegatorProxy?
        ...
        pub fun createNodeStaker(
            nodeInfo: StakingProxy.NodeInfo,
            amount: UFix64
        ){ 
            self.borrowTokenManager().registerNode(
                nodeInfo: nodeInfo,
                amount: amount
            )
    ...
    pub struct LockedNodeStakerProxy: StakingProxy.NodeStakerProxy{ 
        priv var tokenManager: Capability<&LockedTokenManager>
        ...
        priv fun nodeObjectExists(_ managerRef: &LockedTokenManager): Bool{ 
    ...
    pub struct LockedNodeDelegatorProxy: StakingProxy.NodeDelegatorProxy{ 
        ...
        priv fun delegatorObjectExists(_ managerRef: &LockedTokenManager): Bool{ 
    ...
    pub resource TokenAdminCollection: AddAccount{ 
        ...
        priv var accounts:{ Address: Capability<&LockedTokenManager>}
        ...
        /// to the record
        pub fun addAccount(sharedAccountAddress: Address, unlockedAccountAddress: Address, tokenAdmin: Capability<&LockedTokenManager>){ 
    ...
    pub resource LockedAccountCreator: LockedAccountCreatorPublic, AddAccount{ 
        priv var addAccountCapability: Capability<&TokenAdminCollection>?
    ...
    pub fun createLockedTokenManager(
    ...
    pub fun createTokenHolder(
        lockedAddress: Address,
        tokenManager: Capability<&LockedTokenManager>
    ): @TokenHolder{ 
        return <-create TokenHolder(
    ...
    init(admin: AuthAccount){ 
        ...
        self
            .LockedTokenAdminCollectionStoragePath = /storage/lockedTokenAdminCollection
        ...
        admin.save(
            <-create TokenAdminCollection(),
            to: self.LockedTokenAdminCollectionStoragePath
        )
