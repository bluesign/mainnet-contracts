...
pub contract SpaceToursAgency: NonFungibleToken{ 
    ...
    init(){ 
        ...
        self.account.link<&SpaceToursAgency.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, SpaceToursAgency.SpaceToursAgencyCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
