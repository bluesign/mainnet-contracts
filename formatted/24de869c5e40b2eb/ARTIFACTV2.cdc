        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ARTIFACTV2.collectionStoragePath, publicPath: ARTIFACTV2.collectionPublicPath, providerPath: ARTIFACTV2.collectionPrivatePath, publicCollection: Type<&ARTIFACTV2.Collection{ARTIFACTV2.CollectionPublic}>(), publicLinkedType: Type<&ARTIFACTV2.Collection{ARTIFACTV2.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ARTIFACTV2.Collection{ARTIFACTV2.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
