    ...
    pub resource NFT: Interfaces.IPack, NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ARTIFACTPackV3.collectionStoragePath, publicPath: ARTIFACTPackV3.collectionPublicPath, providerPath: /private/ARTIFACTPackV2Collection, publicCollection: Type<&ARTIFACTPackV3.Collection{ARTIFACTPackV3.CollectionPublic}>(), publicLinkedType: Type<&ARTIFACTPackV3.Collection{ARTIFACTPackV3.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ARTIFACTPackV3.Collection{ARTIFACTPackV3.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
        ...
        pub fun open(owner: Address): @[NonFungibleToken.NFT]{ 
            ...
            let packTemplate                             // Dictionary of Pack NFT conforming tokens
                             ...
                             //
                             = ARTIFACTPackV3.getPackTemplate(templateId: userPackRef.templateId)                                                                                                 // withdraw removes an ARTIFACTPackV3 from the Collection and moves it to the caller
                                                                                                 //
                                                                                                 ...
                                                                                                 //
                                                                                                 !
            self.packOption = ARTIFACTPackV3.getTemplateIdsFromPacksAvailable(packTemplate                                                                                          // If a transaction destroys the Collection object,
            ...
            var nfts                    // createPack creates a new Pack NFT used by ARTIFACTAdmin
                    ...
                    : @[NonFungibleToken.NFT] <- (self                                                      // createPackTemplate creates a new Pack NFT template used by ARTIFACTAdmin
                                                      ...
                                                      .adminRef.borrow()!).openPack(userPack: userPackRef, packID: self.id                                                                                                                          // getPackTemplate get a specific templates stored in the contract by id
                                                                                                                          ...
                                                                                                                          //
                                                                                                                          , owner: owner                                                                                                                                        // Paths
                                                                                                                                        , royalties: self.royalties, packOption: self.packOption! as{ Interfaces.IPackOption})
            self.isOpen = true
