...
pub contract ARTIFACTPackV2: NonFungibleToken{ 
    ...
    pub resource NFT: Interfaces.IPack, NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            ...
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: ARTIFACTPackV2.collectionStoragePath, publicPath: ARTIFACTPackV2.collectionPublicPath, providerPath: /private/ARTIFACTPackV2Collection, publicCollection: Type<&ARTIFACTPackV2.Collection{ARTIFACTPackV2.CollectionPublic}>(), publicLinkedType: Type<&ARTIFACTPackV2.Collection{ARTIFACTPackV2.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&ARTIFACTPackV2.Collection{ARTIFACTPackV2.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
        ...
        pub fun open(owner: Address): @[NonFungibleToken.NFT]{ 
            ...
            //
            let packTemplate                             // Dictionary of Pack NFT conforming tokens
                             ...
                             //
                             = ARTIFACTPackV2.getPackTemplate(templateId: userPackRef.templateId)                                                                                                 // withdraw removes an ARTIFACTPackV2 from the Collection and moves it to the caller
                                                                                                 //
                                                                                                 ...
                                                                                                 //
                                                                                                 !
            self.packOption = ARTIFACTPackV2.getTemplateIdsFromPacksAvailable(packTemplate                                                                                          // If a transaction destroys the Collection object,
                                                                                          ...
                                                                                          //
                                                                                          : packTemplate)
            var nfts                    // createPack creates a new Pack NFT used by ARTIFACTAdmin
                    //
                    : @[NonFungibleToken.NFT] <- (self                                                      // createPackTemplate creates a new Pack NFT template used by ARTIFACTAdmin
                                                      //
                                                      .adminRef.borrow()!).openPack(userPack: userPackRef, packID: self.id                                                                                                                          // getPackTemplate get a specific templates stored in the contract by id
                                                                                                                          //
                                                                                                                          // updatePackTemplate update a specific templates stored in the contract by id
                                                                                                                          //
                                                                                                                          // Paths
                                                                                                                          , owner: owner, royalties: self.royalties, packOption: self.packOption! as{ Interfaces.IPackOption})
            self.isOpen = true
