...
pub contract HybridCustody{ 
    ...
    pub resource interface OwnedAccountPrivate{ 
        ...
        pub fun publishToParent(
            ...
            factory: Capability<
                &CapabilityFactory.Manager{CapabilityFactory.Getter}
            >,
        ...
        pub fun setCapabilityFilterForParent(
            parent: Address,
        ...
        pub fun addCapabilityToDelegator(
            parent: Address,
            cap: Capability,
            isPublic: Bool
        ){ 
        ...
        pub fun removeCapabilityFromDelegator(
            parent: Address,
            cap: Capability
        ){} 
    ...
    pub resource interface ManagerPrivate{ 
        pub fun addAccount(
            cap: Capability<
                &{AccountPrivate, AccountPublic, MetadataViews.Resolver}
            >
        ){} 
        
        pub fun borrowAccount(addr: Address): &{
            AccountPrivate,
            AccountPublic,
        ...
        pub fun borrowOwnedAccount(addr: Address): &{
            OwnedAccountPrivate,
            OwnedAccountPublic,
            MetadataViews.Resolver
        }?{} 
        ...
        pub fun setManagerCapabilityFilter(
            cap: Capability<&{CapabilityFilter.Filter}>?,
    ...
    pub resource interface ManagerPublic{ 
        pub fun borrowAccountPublic(addr: Address): &{
            AccountPublic,
            MetadataViews.Resolver
        }?{} 
        ...
        pub fun getChildAccountDisplay(
            address: Address
    ...
    pub resource Manager:
        ...
        ///
        pub fun setChildAccountDisplay(
            address: Address,
            _ d: MetadataViews.Display?
        ){ 
            pre{ 
        ...
        ///
        pub fun setDefaultManagerCapabilityFilter(
            cap: Capability<&{CapabilityFilter.Filter}>?
        ){ 
            pre{ 
                cap == nil || (cap!).check():
        ...
        pub fun setManagerCapabilityFilter(
            ...
            let acct =
                self.borrowAccount(addr: childAddress)
        ...
        pub fun removeChild(addr: Address){ 
            let cap =
                self.childAccounts.remove(key: addr)
                ?? panic("child account not found")
    ...
    pub resource ChildAccount:
        ...
        pub let delegator: Capability<
            &CapabilityDelegator.Delegator{
                CapabilityDelegator.GetterPublic,
                CapabilityDelegator.GetterPrivate
            }
        >
        ...
        pub fun getCapability(path: CapabilityPath, type: Type): Capability?{ 
            ...
            && (
                ...
                || self.getManagerCapabilityFilter()?.allowed(cap: cap) ?? true
                == false
            ){ 
                return nil
            }
        ...
        ///
        pub fun getManagerCapabilityFilter(): &{CapabilityFilter.Filter}?{ 
            return self.managerCapabilityFilter != nil
                ? (self.managerCapabilityFilter!).borrow()
                : nil
        }
        ...
        pub fun borrowCapabilityDelegator(): &CapabilityDelegator.Delegator?{ 
            let path =
                HybridCustody.getCapabilityDelegatorIdentifier(self.parent)
            return (self.childCap.borrow()!).borrowAccount().borrow<
                &CapabilityDelegator.Delegator
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    ...
                    let manager =
                        getAccount(self.parent).getCapability<
                            &HybridCustody.Manager{HybridCustody.ManagerPublic}
                        >(HybridCustody.ManagerPublicPath)
                    if !manager.check(){ 
                        return nil
                    }
                    return ((manager!).borrow()!).getChildAccountDisplay(
        ...
        access(contract) fun parentRemoveChildCallback(parent: Address){ 
            ...
            let child: &AnyResource{HybridCustody.BorrowableAccount} =
                self.childCap.borrow()!
            if !child.check(){ 
                return
            }
    ...
    pub resource OwnedAccount:
        ...
        priv var display: MetadataViews.Display?
        ...
        pub fun publishToParent(
            ...
            let identifier =
                HybridCustody.getChildAccountIdentifier(parentAddress)
            let childAccountStorage = StoragePath(identifier: identifier)!
            let capDelegatorStorage =
                StoragePath(identifier: capDelegatorIdentifier)!
            ...
            if acct.borrow<&CapabilityDelegator.Delegator>(
                from: capDelegatorStorage
            )
            == nil{ 
                let delegator <- CapabilityDelegator.createDelegator()
                acct.save(<-delegator, to: capDelegatorStorage)
            }
            let capDelegatorPublic =
                PublicPath(identifier: capDelegatorIdentifier)!
            let capDelegatorPrivate =
                PrivatePath(identifier: capDelegatorIdentifier)!
            acct.link<
                &CapabilityDelegator.Delegator{CapabilityDelegator.GetterPublic}
            >(capDelegatorPublic, target: capDelegatorStorage)
            acct.link<
                &CapabilityDelegator.Delegator{
                    CapabilityDelegator.GetterPublic,
                    CapabilityDelegator.GetterPrivate
            ...
            >(childAccountPrivatePath, target: childAccountStorage)
            let delegatorCap =
                acct.getCapability<
                    &ChildAccount{
                        AccountPrivate,
                ...
                >(childAccountPrivatePath)
            assert(
                delegatorCap.check(),
                message: "Delegator capability check failed"
            )
            acct.inbox.publish(
                delegatorCap,
                name: identifier,
        ...
        pub fun removeParent(parent: Address): Bool{ 
            ...
            let capDelegatorIdentifier =
                HybridCustody.getCapabilityDelegatorIdentifier(parent)
            let acct = self.borrowAccount()
            ...
            let parentManager =
                getAccount(parent).getCapability<&Manager{ManagerPublic}>(
                    HybridCustody.ManagerPublicPath
                )
        ...
        pub fun rotateAuthAccount(){ 
            ...
            let authAcctPath =
                "HybridCustodyRelinquished_".concat(
                    HybridCustody.account.address.toString()
                ).concat(getCurrentBlock().height.toString()).concat(
                    unsafeRandom().toString()
                ) // ensure that the path is different from the previous one
            let acctCap =
                acct.linkAccount(PrivatePath(identifier: authAcctPath)!)!
            self.acct = acctCap
        ...
        pub fun setCapabilityFactoryForParent(
            ...
            let p =
                self.borrowChildAccount(parent: parent)
                ?? panic("could not find parent address")
        ...
        ///
        pub fun borrowCapabilityDelegatorForParent(
            parent: Address
        ): &CapabilityDelegator.Delegator?{ 
            let identifier =
                HybridCustody.getCapabilityDelegatorIdentifier(parent)
        ...
        pub fun addCapabilityToDelegator(
            ...
            let delegator =
                ...
                ?? panic(
                    "could not borrow capability delegator resource for parent address"
                )
    ...
    pub fun getOwnerIdentifier(_ addr: Address): String{ 
        return "HybridCustodyOwnedAccount_".concat(
            HybridCustody.account.address.toString()
        ).concat(addr.toString())
    }
    
    /// Returns an OwnedAccount wrapping the provided AuthAccount Capability.
    ///
    pub fun createOwnedAccount(acct: Capability<&AuthAccount>): @OwnedAccount{ 
        pre{ 
            acct.check():
                "invalid auth account capability"
        }
        let ownedAcct <- create OwnedAccount(acct)
        emit CreatedOwnedAccount(
            id: ownedAcct.uuid,
            child: (acct.borrow()!).address
        )
        return <-ownedAcct
    }
    ...
    init(){ 
        ...
        let managerIdentifier =
            "HybridCustodyManager_".concat(self.account.address.toString())
