...
pub contract Kicks: NonFungibleToken{ 
    ...
    pub resource Collection: KicksCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub            // Set Storage Locations
            fun borrowViewResolver(id: UInt64):                                                
                                                // Initialize fields
    ...
    init(){ 
        ...
        let setsCapability = self.account.link<auth &{UInt32:{ NFTLX.ISet}}>(self.SneakerSetsPrivatePath, target: NFTLX.SetsStoragePath)!
        self.totalSupply = 0
