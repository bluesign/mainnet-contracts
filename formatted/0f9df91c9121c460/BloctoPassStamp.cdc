...
pub contract BloctoPassStamp: NonFungibleToken{ 
    ...
    pub resource NFT: NonFungibleToken.INFT, BloctoPassPublic{ 
        
        // BloctoPassStamp ID
        pub let id: UInt64
        
        // BloctoPassStamp message
        priv var message: String
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, message: String){ 
