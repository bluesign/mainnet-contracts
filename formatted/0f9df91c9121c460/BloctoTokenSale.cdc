...
pub contract BloctoTokenSale{ 
    ...
    pub fun purchase(from: @TeleportedTetherToken.Vault, address: Address){ 
        ...
        let collectionRef =
            getAccount(address).getCapability(BloctoPass.CollectionPublicPath)
    ...
    pub resource Admin{ 
        ...
        pub fun distribute(address: Address){ 
            ...
            let collectionRef =
                ...
                ?? panic(
                    "Could not borrow blocto pass collection public reference"
                )
            ...
            let minterRef =
                BloctoTokenSale.account.borrow<&BloctoPass.NFTMinter>(
        ...
        pub fun refund(address: Address){ 
            ...
            let purchaseInfo =
                ...
                ?? panic("Count not get purchase info for the address")
            let tusdtVault <-
                BloctoTokenSale.tusdtVault.withdraw(amount: purchaseInfo.amount)
        ...
        pub fun updateLockupScheduleId(lockupScheduleId: Int){ 
            ...
            emit NewLockupSchedule(
                lockupSchedule: BloctoPass.getPredefinedLockupSchedule(
                    id: lockupScheduleId
                )
            )
        }
