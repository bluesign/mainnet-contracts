...
pub contract interface NonFungibleToken{ 
    ...
    pub resource Collection: Provider, Receiver, CollectionPublic{ 
        ...
        pub fun transfer(id: UInt64, recipient: &{NonFungibleToken.CollectionPublic}){ 
            post{ 
                self.ownedRelics[id] == nil:
                    "You didn't transfter the intended Relic."
                recipient.borrowRelic(id: id) != nil:
                    "You didn't transfer the intended Relic."
            }
        }
        ...
        pub fun borrowRelic(id: UInt64): &Relic{ 
            pre{ 
                self.ownedRelics[id] != nil:
                    "Relic does not exist in the collection!"
            }
        }
    }
