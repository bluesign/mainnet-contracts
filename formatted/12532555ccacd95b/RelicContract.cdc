...
pub contract RelicContract: NonFungibleToken{ 
    ...
    priv var creatorRelicMap:{ String: [String]}
    
    // maps all editions by relicId-> relicId : [editions]
    priv var relicEditionMap:{ String: [UInt64]}
    
    // maps all editions by creatorId-> creatorId : [editions]
    priv var creatorEditionMap:{ String: [UInt64]}
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(_name: self.name(), _description: self.description, _thumbnail: self.assetImageURL, _id: self.id, _category: self.category, _rarity: self.rarity, _type: self.type, _creatorName: self.creatorName, _title: self.title, _mintDate: self.mintDate, _assetVideoURL: self.assetVideoURL, _assetImageURL: self.assetImageURL, _musicURL: self.musicURL, _artworkURL: self.artworkURL)
