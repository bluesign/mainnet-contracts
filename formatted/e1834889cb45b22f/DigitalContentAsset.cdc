...
pub contract DigitalContentAsset: NonFungibleToken{ 
    ...
    pub event TokenCreated(id: UInt64, refId: String, serialNumber: UInt32, itemId: String, itemVersion: UInt32)
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        destroy(){ 
            emit DigitalContentAsset.TokenDestroyed(id: self.id, refId: self.refId, serialNumber: self.data.serialNumber, itemId: self.data.itemId, itemVersion: self.data.itemVersion)
        }
    ...
    access(account) fun mintToken(refId: String, itemId: String, itemVersion: UInt32, metadata:{ String: String}): @NFT{ 
        pre{ 
