...
pub contract FrugDAO: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                FrugDAO.totalSupply = FrugDAO.totalSupply - self.balance
            }
        }
    }
