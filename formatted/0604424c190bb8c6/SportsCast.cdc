...
import
    ...
    from "../0x0c82d33d4666f1f7/FreshmintMetadataViews.cdc"
...
pub contract SportsCast: NonFungibleToken{ 
    ...
    ///
    priv let editionsByMintID:{ String: UInt64}
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun resolveNFTCollectionData(): MetadataViews.NFTCollectionData{ 
            return MetadataViews.NFTCollectionData(storagePath: SportsCast.CollectionStoragePath, publicPath: SportsCast.CollectionPublicPath, providerPath: SportsCast.CollectionPrivatePath, publicCollection: Type<&SportsCast.Collection{SportsCast.SportsCastCollectionPublic}>(), publicLinkedType: Type<&SportsCast.Collection{SportsCast.SportsCastCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&SportsCast.Collection{SportsCast.SportsCastCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
