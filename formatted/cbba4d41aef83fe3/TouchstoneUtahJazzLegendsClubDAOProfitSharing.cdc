...
pub contract TouchstoneUtahJazzLegendsClubDAOProfitSharing: NonFungibleToken{ 
    ...
    pub struct NFTMetadata{ 
        ...
        init(_name: String, _description: String, _image: MetadataViews.IPFSFile, _thumbnail: MetadataViews.IPFSFile?, _price: UFix64?, _extra:{ String: AnyStruct}, _supply: UInt64){ 
            self.metadataId = TouchstoneUtahJazzLegendsClubDAOProfitSharing.nextMetadataId
            self.name = _name
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver{ 
        ...
        pub fun getMetadata(): NFTMetadata{ 
            return TouchstoneUtahJazzLegendsClubDAOProfitSharing.getNFTMetadata(self.metadataId)!
        }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: TouchstoneUtahJazzLegendsClubDAOProfitSharing.CollectionStoragePath, publicPath: TouchstoneUtahJazzLegendsClubDAOProfitSharing.CollectionPublicPath, providerPath: TouchstoneUtahJazzLegendsClubDAOProfitSharing.CollectionPrivatePath, publicCollection: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection, NonFungibleToken.Provider}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-TouchstoneUtahJazzLegendsClubDAOProfitSharing.createEmptyCollection()
                        })
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL("https://touchstone.city/discover/".concat((self.owner!).address.toString()).concat("/TouchstoneUtahJazzLegendsClubDAOProfitSharing"))
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareMedia = MetadataViews.Media(file: TouchstoneUtahJazzLegendsClubDAOProfitSharing.getCollectionAttribute(key: "image") as! MetadataViews.IPFSFile, mediaType: "image")
                    
                    // If a banner image exists, use it
                    // Otherwise, default to the main square image
                    var bannerMedia: MetadataViews.Media? = nil
                    if let bannerImage = TouchstoneUtahJazzLegendsClubDAOProfitSharing.getOptionalCollectionAttribute(key: "bannerImage") as! MetadataViews.IPFSFile?{ 
                        bannerMedia = MetadataViews.Media(file: bannerImage, mediaType: "image")
                    }
                    return MetadataViews.NFTCollectionDisplay(name: TouchstoneUtahJazzLegendsClubDAOProfitSharing.getCollectionAttribute(key: "name") as! String, description: TouchstoneUtahJazzLegendsClubDAOProfitSharing.getCollectionAttribute(key: "description") as! String, externalURL: MetadataViews.ExternalURL("https://touchstone.city/discover/".concat((self.owner!).address.toString()).concat("/TouchstoneUtahJazzLegendsClubDAOProfitSharing")), squareImage: squareMedia, bannerImage: bannerMedia ?? squareMedia, socials: TouchstoneUtahJazzLegendsClubDAOProfitSharing.getCollectionAttribute(key: "socials") as!{ String: MetadataViews.ExternalURL})
        ...
        init(_metadataId: UInt64, _serial: UInt64, _recipient: Address){ 
            pre{ 
                TouchstoneUtahJazzLegendsClubDAOProfitSharing.metadatas[_metadataId] != nil:
                    "This NFT does not exist yet."
                _serial < (TouchstoneUtahJazzLegendsClubDAOProfitSharing.getNFTMetadata(_metadataId)!).supply:
                    "This serial does not exist for this metadataId."
                !(TouchstoneUtahJazzLegendsClubDAOProfitSharing.getNFTMetadata(_metadataId)!).purchasers.containsKey(_serial):
            ...
            if let buyersRef = &TouchstoneUtahJazzLegendsClubDAOProfitSharing.primaryBuyers[_recipient] as &{UInt64: [UInt64]}?{ 
                ...
                TouchstoneUtahJazzLegendsClubDAOProfitSharing.primaryBuyers[_recipient] ={ _metadataId: [_serial]}
            }
            
            // Update who bought this serial inside NFTMetadata so it cannot be purchased again.
            let metadataRef = (&TouchstoneUtahJazzLegendsClubDAOProfitSharing.metadatas[_metadataId] as &NFTMetadata?)!
            metadataRef.purchased(serial: _serial, buyer: _recipient)
            TouchstoneUtahJazzLegendsClubDAOProfitSharing.totalSupply = TouchstoneUtahJazzLegendsClubDAOProfitSharing.totalSupply + 1
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection{ 
        ...
        pub fun claim(){ 
            if let storage = &TouchstoneUtahJazzLegendsClubDAOProfitSharing.nftStorage[(self.owner!).address] as &{UInt64: NFT}?{ 
    ...
    pub fun mintNFT(metadataId: UInt64, recipient: &{NonFungibleToken.Receiver}, payment: @FlowToken.Vault, serial: UInt64): UInt64{ 
        ...
        if let royalty = TouchstoneUtahJazzLegendsClubDAOProfitSharing.getOptionalCollectionAttribute(key: "royalty") as! MetadataViews.Royalty?{ 
    ...
    pub resource Administrator{ 
        pub fun createNFTMetadata(name: String, description: String, imagePath: String, thumbnailPath: String?, ipfsCID: String, price: UFix64?, extra:{ String: AnyStruct}, supply: UInt64){ 
            TouchstoneUtahJazzLegendsClubDAOProfitSharing.metadatas[TouchstoneUtahJazzLegendsClubDAOProfitSharing.nextMetadataId] = NFTMetadata(_name: name, _description: description, _image: MetadataViews.IPFSFile(cid: ipfsCID, path: imagePath), _thumbnail: thumbnailPath == nil ? nil : MetadataViews.IPFSFile(cid: ipfsCID, path: thumbnailPath), _price: price, _extra: extra, _supply: supply)
            TouchstoneUtahJazzLegendsClubDAOProfitSharing.nextMetadataId = TouchstoneUtahJazzLegendsClubDAOProfitSharing.nextMetadataId + 1
        }
        ...
        pub fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
            ...
            if let recipientCollection = getAccount(recipient).getCapability(TouchstoneUtahJazzLegendsClubDAOProfitSharing.CollectionPublicPath).borrow<&TouchstoneUtahJazzLegendsClubDAOProfitSharing.Collection{NonFungibleToken.CollectionPublic}>(){ 
                recipientCollection.deposit(token: <-nft)
            } else if let storage = &TouchstoneUtahJazzLegendsClubDAOProfitSharing.nftStorage[recipient] as &{UInt64: NFT}?{ 
                storage[nft.id] <-! nft
            } else{ 
                TouchstoneUtahJazzLegendsClubDAOProfitSharing.nftStorage[recipient] <-!{ nft.id: <-nft}
            }
        }
        ...
        pub fun changeField(key: String, value: AnyStruct){ 
            TouchstoneUtahJazzLegendsClubDAOProfitSharing.collectionInfo[key] = value
        }
    }
    ...
    pub fun getPriceOfNFT(_ metadataId: UInt64): UFix64?{ 
        if let metadata: TouchstoneUtahJazzLegendsClubDAOProfitSharing.NFTMetadata = self.getNFTMetadata(metadataId){ 
    ...
    pub fun getClaimableNFTs(user: Address):{ UInt64: NFTMetadata}{ 
        ...
        if let storage = &TouchstoneUtahJazzLegendsClubDAOProfitSharing.nftStorage[user] as &{UInt64: NFT}?{ 
            for id in storage.keys{ 
    ...
    init(_name: String, _description: String, _imagePath: String, _bannerImagePath: String?, _minting: Bool, _royalty: MetadataViews.Royalty?, _defaultPrice: UFix64, _paymentType: String, _ipfsCID: String, _lotteryBuying: Bool, _socials:{ String: MetadataViews.ExternalURL}, _mintVerifiers: [{MintVerifiers.IVerifier}]){ 
        ...
        self.CollectionStoragePath = /storage/TouchstoneUtahJazzLegendsClubDAOProfitSharingCollection_0xcbba4d41aef83fe3
        self.CollectionPublicPath = /public/TouchstoneUtahJazzLegendsClubDAOProfitSharingCollection_0xcbba4d41aef83fe3
        self.CollectionPrivatePath = /private/TouchstoneUtahJazzLegendsClubDAOProfitSharingCollection_0xcbba4d41aef83fe3
        self.AdministratorStoragePath = /storage/TouchstoneUtahJazzLegendsClubDAOProfitSharingAdministrator_0xcbba4d41aef83fe3
