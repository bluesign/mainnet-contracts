...
pub contract UtahJazzLegendsClub: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        pub fun withdraw(amount: UFix64): @FungibleToken.Vault{ 
            ...
            if let owner: Address = self.owner?.address{ 
                UtahJazzLegendsClub.setBalance(address: owner, balance: self.balance)
            }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<FungibleTokenMetadataViews.FTView>():
                    return UtahJazzLegendsClub.resolveView(view)
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                UtahJazzLegendsClub.totalSupply = UtahJazzLegendsClub.totalSupply - self.balance
            }
        }
    }
    ...
    pub resource Minter: Toucans.Minter{ 
        pub fun mint(amount: UFix64): @Vault{ 
            post{ 
                UtahJazzLegendsClub.maxSupply == nil || UtahJazzLegendsClub.totalSupply <= UtahJazzLegendsClub.maxSupply!:
                    "Exceeded the max supply of tokens allowd."
            }
            UtahJazzLegendsClub.totalSupply = UtahJazzLegendsClub.totalSupply + amount
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreigf26fjxatw4zhf5m36l63sg2ruvdzdujyxhtibfbnphfgmn245mq"), mediaType: "image")
                let bannerMedia = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreie3dpob2lg3bi2rtfhyycrdr5svkqaa2n2fskczejn7q2bm24echy"), mediaType: "image")
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(name: "Utah Jazz Legends Club", symbol: "UJLC", description: "Utah Jazz Legnends Club DAO", externalURL: MetadataViews.ExternalURL(""), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL("UtahJazzLegends"), "discord": MetadataViews.ExternalURL("wGjBcsGjcG")})
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(storagePath: UtahJazzLegendsClub.VaultStoragePath, receiverPath: UtahJazzLegendsClub.ReceiverPublicPath, metadataPath: UtahJazzLegendsClub.VaultPublicPath, providerPath: /private/UtahJazzLegendsClubVault, receiverLinkedType: Type<&Vault{FungibleToken.Receiver}>(), metadataLinkedType: Type<&Vault{FungibleToken.Balance, MetadataViews.Resolver}>(), providerLinkedType: Type<&Vault{FungibleToken.Provider}>(), createEmptyVaultFunction: fun (): @Vault{ 
                        return <-UtahJazzLegendsClub.createEmptyVault()
                    })
        }
        return nil
    }
    ...
    init(_paymentTokenInfo: ToucansTokens.TokenInfo, _editDelay: UFix64, _minting: Bool, _initialTreasurySupply: UFix64, _maxSupply: UFix64?, _extra:{ String: AnyStruct}){ 
        ...
        // Paths
        self.VaultStoragePath = /storage/UtahJazzLegendsClubVault
        self.ReceiverPublicPath = /public/UtahJazzLegendsClubReceiver
        self.VaultPublicPath = /public/UtahJazzLegendsClubMetadata
        self.MinterStoragePath = /storage/UtahJazzLegendsClubMinter
        self.AdministratorStoragePath = /storage/UtahJazzLegendsClubAdmin
