...
pub contract StoreFrontSuperAdmin{ 
    ...
    init(requestedAdress: Address){ 
        // Paths
        self
            .storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x72b7e7647598711f
        self
            .storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x72b7e7647598711f
