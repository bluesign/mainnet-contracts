...
pub contract Market{ 
    ...
    pub resource SaleCollection: SalePublic{ 
        ...
        priv var forSale: @Eternal.Collection
        ...
        priv fun getInfluencerNameFromMoment(moment: &Eternal.NFT): String{ 
