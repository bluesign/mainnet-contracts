        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: /storage/EternalMomentCollection, publicPath: /public/EternalMomentCollection, providerPath: /private/EternalMomentCollection, publicCollection: Type<&Eternal.Collection{Eternal.MomentCollectionPublic}>(), publicLinkedType: Type<&Eternal.Collection{Eternal.MomentCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&Eternal.Collection{NonFungibleToken.Provider, Eternal.MomentCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(items: [MetadataViews.Media(file: MetadataViews.HTTPFile(url: self.thumbnail()), mediaType: "image/png"), MetadataViews.Media(file: MetadataViews.IPFSFile(cid: Eternal.getPlayMetaDataByField(playID: self.data.playID, field: "Hash") ?? "", path: ""), mediaType: "video/mp4")])
            }
            return nil
        }
