...
pub contract FanTopToken: NonFungibleToken{ 
    ...
    pub event TokenCreated(id: UInt64, refId: String, serialNumber: UInt32, itemId: String, itemVersion: UInt32, minter: Address)
    
    pub event TokenDestroyed(id: UInt64, refId: String, serialNumber: UInt32, itemId: String, itemVersion: UInt32)
    ...
    pub struct Item{ 
        ...
        priv let versions:{ UInt32: ItemData}
    ...
    pub resource NFT: NonFungibleToken.INFT{ 
        ...
        destroy(){ 
            emit FanTopToken.TokenDestroyed(id: self.id, refId: self.refId, serialNumber: self.data.serialNumber, itemId: self.data.itemId, itemVersion: self.data.itemVersion)
        }
    ...
    access(account) fun mintToken(refId: String, itemId: String, itemVersion: UInt32, metadata:{ String: String}, minter: Address): @NFT{ 
        pre{ 
            FanTopToken.items.containsKey(itemId):
    ...
    access(account) fun mintTokenWithSerialNumber(refId: String, itemId: String, itemVersion: UInt32, metadata:{ String: String}, serialNumber: UInt32, minter: Address): @NFT{ 
        pre{ 
            FanTopToken.items.containsKey(itemId):
                "That itemId does not exist"
            itemVersion == (FanTopToken.items[itemId]!).version:
