...
pub contract Marketplace{ 
    pub struct Item{ 
        pub let storefrontPublicCapability: Capability<
            &{NFTStorefront.StorefrontPublic}
        >
        ...
        init(
            storefrontPublicCapability: Capability<
                &{NFTStorefront.StorefrontPublic}
            >,
            listingID: UInt64
        ){ 
    ...
    pub resource Administrator{ 
        pub fun updateSaleCutRequirements(
            _ requirements: [
                SaleCutRequirement
            ],
            nftType: Type
            ...
            assert(
                totalRatio <= 1.0,
                message: "total ratio must be less than or equal to 1.0"
            )
    ...
    pub fun getListingID(nftType: Type, nftID: UInt64): UInt64?{ 
        let nftListingIDs =
            self.collectionNFTListingIDs[nftType.identifier] ??{} 
    ...
    pub fun addListing(
        ...
        // all by time
        let indexToInsertListingIDByTime =
            self.getIndexToAddListingIDByTime(
                item: item,
                items: self.listingIDsByTime
            )
        
        // all by price
        let indexToInsertListingIDByPrice =
            self.getIndexToAddListingIDByPrice(
                item: item,
        ...
        var items =
            self.collectionListingIDsByTime[
                item.listingDetails.nftType.identifier
            ]
            ?? []
        let indexToInsertCollectionListingIDByTime =
            self.getIndexToAddListingIDByTime(item: item, items: items)
        
        // collection by price
        items = self.collectionListingIDsByPrice[
                item.listingDetails.nftType.identifier
            ]
            ?? []
        let indexToInsertCollectionListingIDByPrice =
            self.getIndexToAddListingIDByPrice(item: item, items: items)
            ?? panic("could not add duplicate listing")
        self.addItem(
            item,
            storefrontPublicCapability: storefrontPublicCapability,
    ...
    pub fun addListingWithIndexes(
        ...
        self.checkValidIndexToInsertByTime(
            ...
            items: self.collectionListingIDsByTime[
                item.listingDetails.nftType.identifier
            ]
            ?? []
        )
    ...
    pub fun removeListingWithIndexes(
        ...
        pre{ 
            self.listingIDsByTime[indexToRemoveListingIDByTime] == id:
                "invalid indexToRemoveListingIDByTime"
            self.listingIDsByPrice[indexToRemoveListingIDByPrice] == id:
                "invalid indexToRemoveListingIDByPrice"
        }
        if let item = self.listingIDItems[id]{ 
            // Skip if the listing item hasn't been purchased
            if let storefrontPublic = item.storefrontPublicCapability.borrow(){ 
            ...
            self.removeItemWithIndexes(item, indexToRemoveListingIDByTime: indexToRemoveListingIDByTime, indexToRemoveListingIDByPrice: indexToRemoveListingIDByPrice, indexToRemoveCollectionListingIDByTime: indexToRemoveCollectionListingIDByTime, indexToRemoveCollectionListingIDByPrice: indexToRemoveCollectionListingIDByPrice)
        }
    }
    ...
    access(contract) fun addItem(
        ...
        assert(
            item.listingDetails.purchased == false,
        ...
        // all by time
        self.listingIDsByTime.insert(
            at: indexToInsertListingIDByTime,
            item.listingID
        )
        
        // all by price
        self.listingIDsByPrice.insert(
            at: indexToInsertListingIDByPrice,
            item.listingID
        )
        ...
        if let items =
            ...
            items.insert(
                at: indexToInsertCollectionListingIDByTime,
                item.listingID
            )
            self.collectionListingIDsByTime[
                item.listingDetails.nftType.identifier
        ...
        if let items =
            ...
            items.insert(
                at: indexToInsertCollectionListingIDByPrice,
                item.listingID
            )
            self.collectionListingIDsByPrice[
                item.listingDetails.nftType.identifier
    ...
    access(contract) fun removeItem(_ item: Item){ 
        let indexToRemoveListingIDByTime =
            self.getIndexToRemoveListingIDByTime(
                item: item,
                items: self.listingIDsByTime
            )
        let indexToRemoveListingIDByPrice =
            self.getIndexToRemoveListingIDByPrice(
                item: item,
                items: self.listingIDsByPrice
            )
        let indexToRemoveCollectionListingIDByTime =
            self.getIndexToRemoveListingIDByTime(
                item: item,
                items: self.collectionListingIDsByTime[
                    item.listingDetails.nftType.identifier
        ...
        let indexToRemoveCollectionListingIDByPrice =
            self.getIndexToRemoveListingIDByPrice(
                item: item,
                items: self.collectionListingIDsByPrice[
                    item.listingDetails.nftType.identifier
    ...
    access(contract) fun removeItemWithIndexes(
        ...
        if let indexToRemoveCollectionListingIDByTime =
            indexToRemoveCollectionListingIDByTime{ 
            var items =
                self.collectionListingIDsByTime[
                    item.listingDetails.nftType.identifier
                ]
        ...
        if let indexToRemoveCollectionListingIDByPrice =
            indexToRemoveCollectionListingIDByPrice{ 
            var items =
                self.collectionListingIDsByPrice[
                    item.listingDetails.nftType.identifier
                ]
    ...
    access(contract) fun getIndexToAddListingIDByPrice(
        item: Item,
        items: [
            UInt64
        ]
    ...
    access(contract) fun getIndexToAddListingIDByTime(
        item: Item,
        items: [
            UInt64
        ]
    ...
    access(contract) fun getIndexToRemoveListingIDByTime(
        item: Item,
        items: [
            UInt64
        ]
    ...
    // Run binary search to find the listing ID
    access(contract) fun getIndexToRemoveListingIDByPrice(
        item: Item,
        items: [
            UInt64
        ]
    ...
    access(contract) fun checkValidIndexToInsertByTime(
        item: Item,
        index: Int,
        items: [
            UInt64
    ...
    access(contract) fun checkValidIndexToInsertByPrice(
        item: Item,
        index: Int,
        items: [
            UInt64
