...
pub contract DimensionXComics: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(url: DimensionXComics.metadataUrl.concat("comics/").concat(self.id.toString()))
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: DimensionXComics.CollectionStoragePath, publicPath: DimensionXComics.CollectionPublicPath, providerPath: /private/dmxComicsCollection, publicCollection: Type<&DimensionXComics.Collection{DimensionXComics.CollectionPublic}>(), publicLinkedType: Type<&DimensionXComics.Collection{DimensionXComics.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&DimensionXComics.Collection{DimensionXComics.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    init(){ 
        ...
        self.account.link<&DimensionXComics.Collection{NonFungibleToken.CollectionPublic, CollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
