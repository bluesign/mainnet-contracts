...
pub contract DimensionX: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(url: DimensionX.metadataUrl.concat(self.id.toString()))
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: DimensionX.CollectionStoragePath, publicPath: DimensionX.CollectionPublicPath, providerPath: /private/dmxCollection, publicCollection: Type<&DimensionX.Collection{DimensionX.CollectionPublic}>(), publicLinkedType: Type<&DimensionX.Collection{DimensionX.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&DimensionX.Collection{DimensionX.CollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintCustomNFT(recipient: &Collection{NonFungibleToken.CollectionPublic}){ 
        ...
        pub fun mintGenesisNFT(recipient: &Collection{NonFungibleToken.CollectionPublic}){ 
        ...
        pub fun mintNFT(recipient: &Collection{NonFungibleToken.CollectionPublic}){ 
            // Determine the next available ID
        ...
        pub fun mintStakedNFT(recipient: &Collection{NonFungibleToken.CollectionPublic}){ 
            var nextId = self.getNextCommonID()
        ...
        priv fun mint(recipient: &Collection{NonFungibleToken.CollectionPublic}, id: UInt64, type: DimensionX.NFTType){ 
            // create a new NFT
    ...
    pub fun mint(recipient: &Collection{NonFungibleToken.CollectionPublic}, paymentVault: @ThulToken.Vault){ 
        pre{ 
    ...
    init(){ 
        ...
        self.account.link<&DimensionX.Collection{NonFungibleToken.CollectionPublic, CollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
