...
pub contract BaguetteOffer{ 
    ...
    pub resource Offer{ 
        ...
        priv var offerorRCollection: Capability<
            &Record.Collection{Record.CollectionPublic}
        >
        ...
        access(contract) fun acceptOffer(
            ...
            let marketVault =
                (BaguetteOffer.marketVault!).borrow()
        ...
        access(contract) fun acceptAuctionOffer(
            auctionCollection: &BaguetteAuction.Collection{
                BaguetteAuction.Bidder,
                BaguetteAuction.AuctionCreator
            },
            record: @Record.NFT,
            ownerFVault: Capability<&FUSD.Vault{FungibleToken.Receiver}>,
    ...
    pub resource Collection:
        ...
        priv var auctionServer: Capability<
            &BaguetteAuction.Collection{
                BaguetteAuction.Bidder,
                BaguetteAuction.AuctionCreator
            }
        ...
        priv var auctionServerAccepted: UInt64?
        
        // Auction Items, where the key is the recordID
        priv var offerItems: @{UInt64: Offer}
        ...
        access(contract) fun addOffer(
            ...
            destroy old
            emit NewOffer(
                offerID: offerStatus.id,
                admin: self.owner?.address!,
                status: offerStatus
            )
        }
        ...
        access(contract) fun cancelOffer(recordID: UInt64, offerID: UInt64){ 
            ...
            if itemRef.creationTime + self.parameters.timeBeforeCancel
    ...
    pub resource OfferorCollection{ 
        ...
        pub fun cancelOffer(
            ...
            offerCollection.cancelOffer(
                recordID: recordID,
                offerID: self.offers[recordID]!
            )
