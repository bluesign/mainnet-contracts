...
pub contract BlockleteMarket_NFT_V2{ 
    ...
    pub event BlockletePriceChanged(
        id: UInt64,
        newPrice: UFix64,
        seller: Address?
    )
    ...
    pub resource SaleCollection: SalePublic{ 
        ...
        priv var blockletesForSale: @Blockletes_NFT_V2.Collection
        ...
        priv var beneficiaryCapability: Capability<&FUSD.Vault{FungibleToken.Receiver}>
        ...
        init(ownerCapability: Capability<&FUSD.Vault{FungibleToken.Receiver}>, beneficiaryCapability: Capability<&FUSD.Vault{FungibleToken.Receiver}>, cutPercentage: UFix64){ 
            pre{ 
    ...
    init(){ 
        self
            .SaleCollectionStoragePath = /storage/BlockleteMarketCollection_NFT_V2
