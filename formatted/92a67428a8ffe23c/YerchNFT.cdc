        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: YerchNFT.CollectionStoragePath, publicPath: YerchNFT.CollectionPublicPath, providerPath: /private/YerchNFTCollection, publicCollection: Type<&YerchNFT.Collection{YerchNFT.YerchNFTCollectionPublic}>(), publicLinkedType: Type<&YerchNFT.Collection{YerchNFT.YerchNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&YerchNFT.Collection{YerchNFT.YerchNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(recepient: getAccount(YerchNFT.account.address).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: 0.075, description: "This is the royalty receiver for YDY Yerch NFTs")])
            }
            return nil
        }
    }
