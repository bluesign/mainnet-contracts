...
pub contract YDYNFTs: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: YDYNFTs.CollectionStoragePath, publicPath: YDYNFTs.CollectionPublicPath, providerPath: /private/ydyNFTCollection, publicCollection: Type<&YDYNFTs.Collection{YDYNFTs.YDYNFTCollectionPublic}>(), publicLinkedType: Type<&YDYNFTs.Collection{YDYNFTs.YDYNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&YDYNFTs.Collection{YDYNFTs.YDYNFTCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                            return <-YDYNFTs.createEmptyCollection()
                        })
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(recepient: getAccount(YDYNFTs.account.address).getCapability<&{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: 0.075, description: "This is the royalty receiver for YDY NFTs")])
            }
            return nil
        }
    }
    ...
    pub resource interface YDYNFTCollectionPublic{ 
        ...
        pub fun borrowYDYNFT(id: UInt64): &YDYNFTs.NFT?{ 
            post{ 
    ...
    pub fun buy(collectionCapability: Capability<&Collection{YDYNFTs.YDYNFTCollectionPublic}>, payment: @FlowToken.Vault, quantity: UInt64){ 
        pre{ 
        ...
        let ydyWallet = self.account.getCapability(/public/flowTokenReceiver).borrow<&FlowToken.Vault{FungibleToken.Receiver}>()!
        ydyWallet.deposit(from: <-payment)
        let ydyCollection = self.account.getCapability(YDYNFTs.CollectionPublicPath).borrow<&Collection{YDYNFTs.YDYNFTCollectionPublic, YDYNFTs.YDYNFTCollectionPrivate}>() ?? panic("Can't get YDY's collection.")
    ...
    pub resource Admin{ 
        pub fun mintNFT(thumbnailCID: String, background: String, body: String, mouth: String, eyes: String, pants: String, rarity: Rarity, version: String, versionLaunchDate: String){ 
            let accountOwnerCollection = YDYNFTs.account.borrow<&Collection{NonFungibleToken.CollectionPublic}>(from: YDYNFTs.CollectionStoragePath)!
        ...
        pub fun transferNFT(collectionCapability: Capability<&Collection{YDYNFTs.YDYNFTCollectionPublic}>): UInt64{ 
            let ydyCollection = YDYNFTs.account.getCapability(YDYNFTs.CollectionPublicPath).borrow<&Collection{YDYNFTs.YDYNFTCollectionPublic, YDYNFTs.YDYNFTCollectionPrivate}>() ?? panic("Can't get YDY's collection.")
            let availableNFTs = ydyCollection.getIDs()
            if availableNFTs.length > 0{ 
                let receiver = collectionCapability.borrow() ?? panic("Cannot borrow")
                let randomInt = unsafeRandom() % UInt64(availableNFTs.length)
        ...
        pub fun levelUp(id: UInt64, recipientCollectionCapability: Capability<&Collection{YDYNFTs.YDYNFTCollectionPublic}>): &YDYNFTs.NFT?{ 
            post{ 
        ...
        pub fun repair(points: UFix64, id: UInt64, recipientCollectionCapability: Capability<&Collection{YDYNFTs.YDYNFTCollectionPublic}>): &YDYNFTs.NFT?{ 
            let receiver = recipientCollectionCapability.borrow() ?? panic("Cannot borrow")
            let nft = receiver.borrowYDYNFT(id: id) ?? panic("No NFT with this ID exists for user")
        ...
        pub fun reduceStamina(points: UFix64, id: UInt64, recipientCollectionCapability: Capability<&Collection{YDYNFTs.YDYNFTCollectionPublic}>): &YDYNFTs.NFT?{ 
            post{ 
        ...
        pub fun boostEndurance(points: UFix64, id: UInt64, recipientCollectionCapability: Capability<&Collection{YDYNFTs.YDYNFTCollectionPublic}>): &YDYNFTs.NFT?{ 
            let receiver = recipientCollectionCapability.borrow() ?? panic("Cannot borrow")
            let nft = receiver.borrowYDYNFT(id: id) ?? panic("No NFT with this ID exists for user")
        ...
        pub fun boostEfficiency(points: UFix64, id: UInt64, recipientCollectionCapability: Capability<&Collection{YDYNFTs.YDYNFTCollectionPublic}>): &YDYNFTs.NFT?{ 
            let receiver = recipientCollectionCapability.borrow() ?? panic("Cannot borrow")
            let nft = receiver.borrowYDYNFT(id: id) ?? panic("No NFT with this ID exists for user")
        ...
        pub fun boostLuck(points: UFix64, id: UInt64, recipientCollectionCapability: Capability<&Collection{YDYNFTs.YDYNFTCollectionPublic}>): &YDYNFTs.NFT?{ 
            let receiver = recipientCollectionCapability.borrow() ?? panic("Cannot borrow")
            let nft = receiver.borrowYDYNFT(id: id) ?? panic("No NFT with this ID exists for user")
