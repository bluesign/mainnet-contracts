...
pub contract BBxBarbieCard: NonFungibleToken{ 
    ...
    pub event DepositEvent(uuid: UInt64, id: UInt64, seriesId: UInt64, editionId: UInt64, to: Address?)
    
    pub event TransferEvent(uuid: UInt64, id: UInt64, seriesId: UInt64, editionId: UInt64, to: Address?)
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(url: self.metadata["url"] ?? "")
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: BBxBarbieCard.CollectionStoragePath, publicPath: BBxBarbieCard.CollectionPublicPath, providedPath: /private/BBxBarbieCardCollection, publicCollection: Type<&BBxBarbieCard.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, BBxBarbieCard.CardCollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&BBxBarbieCard.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, BBxBarbieCard.CardCollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&BBxBarbieCard.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, BBxBarbieCard.CardCollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-BBxBarbieCard.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let externalURL = MetadataViews.ExternalURL(url: "https://mattel.com/")
                    ...
                    let socialMap:{ String: MetadataViews.ExternalURL} ={ "facebook": MetadataViews.ExternalURL(url: "https://www.facebook.com/mattel"), "instagram": MetadataViews.ExternalURL(url: "https://www.instagram.com/mattel"), "twitter": MetadataViews.ExternalURL(url: "https://www.twitter.com/mattel")}
                ...
                case Type<MetadataViews.Royalties>():
                    ...
                    return MetadataViews.Royalties([MetadataViews.Royalty(recipient: flowReciever, cut: 0.05, description: "Mattel 5% Royalty")])
                ...
                case Type<MetadataViews.Serial>():
                    return MetadataViews.Serial(number: self.uuid)
    ...
    access(account) fun mint(nftID: UInt64, packSeriesID: UInt64, cardEditionID: UInt64, packHash: String, metadata:{ String: String}): @NonFungibleToken.NFT{ 
