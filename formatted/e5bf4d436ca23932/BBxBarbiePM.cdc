...
pub contract BBxBarbiePM{ 
    ...
    pub event AdminAddNewTokenSeries(tokenSeriesID: UInt64)
    ...
    pub event AdminAddNewCardSeries(cardSeriesID: UInt64)
    ...
    // emitted when a new pack series is added
    pub event AdminAddNewPackSeries(packSeriesID: UInt64)
    ...
    priv var BBxBarbieSeriesIdIsLive:{ UInt64: Bool}
    
    /* 
        *   BBxBarbieCard
        */
    
    priv var BBxBarbieTokenSeriesIdIsLive:{ UInt64: Bool}
    
    /* 
        *   BBxBarbieCard
        */
    
    priv var BBxBarbieCardSeriesIdIsLive:{ UInt64: Bool}
    ...
    priv var BBxBarbiePackSeriesIdIsLive:{ UInt64: Bool}
    ...
    pub resource Manager{ 
        ...
        pub fun mintSequentialBBxBarbieToken(
            ...
            let BBxBarbieToken <-
                BBxBarbiePM.mintSequentialToken(
            ...
            emit AirdropRedeemable(
                ...
                OriginalCardSerial: metadata["originalCardSerialNumber"]
                ?? "N/A",
