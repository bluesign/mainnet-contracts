...
pub contract BBxBarbiePack: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: BBxBarbiePack.CollectionStoragePath, publicPath: BBxBarbiePack.CollectionPublicPath, providedPath: /private/BBxBarbiePackCollection, publicCollection: Type<&BBxBarbiePack.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, BBxBarbiePack.PackCollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&BBxBarbiePack.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, BBxBarbiePack.PackCollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&BBxBarbiePack.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, BBxBarbiePack.PackCollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-BBxBarbiePack.createEmptyCollection()
                        })
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let externalURL = MetadataViews.ExternalURL(url: "https://www.mattel.com/")
    ...
    access(account) fun mint(nftID: UInt64, packEditionID: UInt64, packSeriesID: UInt64, packHash: String, metadata:{ String: String}): @NonFungibleToken.NFT{ 
