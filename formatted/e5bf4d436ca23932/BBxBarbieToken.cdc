...
pub contract BBxBarbieToken: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: BBxBarbieToken.CollectionStoragePath, publicPath: BBxBarbieToken.CollectionPublicPath, providedPath: /private/BBxBarbieTokenCollection, publicCollection: Type<&BBxBarbieToken.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, BBxBarbieToken.TokenCollectionPublic, MetadataViews.ResolverCollection}>(), publicLinkedType: Type<&BBxBarbieToken.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, BBxBarbieToken.TokenCollectionPublic, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&BBxBarbieToken.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, BBxBarbieToken.TokenCollectionPublic, MetadataViews.ResolverCollection}>(), createEmptyCollection: fun (): @NonFungibleToken.Collection{ 
                            return <-BBxBarbieToken.createEmptyCollection()
                        })
    ...
    access(account) fun mint(nftID: UInt64, packSeriesID: UInt64, tokenEditionID: UInt64, metadata:{ String: String}): @NonFungibleToken.NFT{ 
