...
pub contract PiratesOfTheMetaverse: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: PiratesOfTheMetaverse.CollectionStoragePath, publicPath: PiratesOfTheMetaverse.CollectionPublicPath, providerPath: /private/piratesOfTheMetaverseCollection, publicCollection: Type<&PiratesOfTheMetaverse.Collection{PiratesOfTheMetaverse.PiratesOfTheMetaverseCollectionPublic}>(), publicLinkedType: Type<&PiratesOfTheMetaverse.Collection{PiratesOfTheMetaverse.PiratesOfTheMetaverseCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&PiratesOfTheMetaverse.Collection{PiratesOfTheMetaverse.PiratesOfTheMetaverseCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(reciever: getAccount(0xc97017ed85e496bf).getCapability<&FlowToken.Vault{FungibleToken.Receiver}>(/public/flowTokenReceiver), cut: 0.05, description: "POTM royalties")])
            }
            return nil
        }
    }
    ...
    pub resource NFTMinter: HasClaims{ 
        ...
        //
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, id: UInt64, imageUrl: String, metadata:{ String: String}){ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &PiratesOfTheMetaverse.NFT?{ 
        let collection = (getAccount(from).getCapability(PiratesOfTheMetaverse.CollectionPublicPath)!).borrow<&PiratesOfTheMetaverse.Collection{PiratesOfTheMetaverse.PiratesOfTheMetaverseCollectionPublic}>() ?? panic("Couldn't get collection")
