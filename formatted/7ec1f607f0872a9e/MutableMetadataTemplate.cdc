...
pub contract MutableMetadataTemplate{ 
    ...
    pub resource Template: Public, Private{ 
        ...
        // Max mint allowed for this metadata. Can be set to nil for unlimited
        priv var _maxMint: UInt64?
        
        // A MutableMetadata instance is used to store the underyling metadata
        priv let _metadata: @MutableMetadata.Metadata
        
        // Number of times registerMint has been called on this template
        priv var _minted: UInt64
        ...
        pub fun metadataMutable(): &MutableMetadata.Metadata{MutableMetadata.Public, MutableMetadata.Private}{ 
            return &self._metadata as &MutableMetadata.Metadata{MutableMetadata.Public, MutableMetadata.Private}
        }
