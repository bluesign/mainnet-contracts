...
pub contract MutableMetadataSet{ 
    ...
    pub resource interface Public{ 
        ...
        pub fun getTemplate(_ id: Int): &MutableMetadataTemplate.Template{
            MutableMetadataTemplate.Public
        }{} 
    }
    ...
    pub resource interface Private{ 
        ...
        pub fun metadataMutable(): &MutableMetadata.Metadata{
            MutableMetadata.Public,
            MutableMetadata.Private
        }{} 
        
        // Retrieve the private version of a particular template given by the
        // Template ID (index into the self._templates array) only if it exists
        pub fun getTemplateMutable(
            _ id: Int
        ): &MutableMetadataTemplate.Template{
            MutableMetadataTemplate.Public,
    ...
    pub resource Set: Public, Private{ 
        ...
        // Is this set locked from more Templates being added?
        priv var _locked: Bool
        
        // Public version of underyling MutableMetadata.Metadata
        priv var _metadata: @MutableMetadata.Metadata
        
        // Templates in this set
        priv var _templates: @[MutableMetadataTemplate.Template]
        ...
        pub fun metadata(): &MutableMetadata.Metadata{MutableMetadata.Public}{ 
            return &self._metadata as &MutableMetadata.Metadata{MutableMetadata.Public}
        }
        
        pub fun getTemplate(_ id: Int): &MutableMetadataTemplate.Template{MutableMetadataTemplate.Public}{ 
            pre{ 
            ...
            return &self._templates[id] as &MutableMetadataTemplate.Template{MutableMetadataTemplate.Public}
        }
        ...
        pub fun metadataMutable(): &MutableMetadata.Metadata{MutableMetadata.Public, MutableMetadata.Private}{ 
            return &self._metadata as &MutableMetadata.Metadata
        }
        
        pub fun getTemplateMutable(_ id: Int): &MutableMetadataTemplate.Template{MutableMetadataTemplate.Public, MutableMetadataTemplate.Private}{ 
            pre{ 
                id >= 0 && id < self._templates.length:
                    id.toString().concat(" is not a valid template ID. Number of templates is ").concat(self._templates.length.toString())
            }
            return &self._templates[id] as &MutableMetadataTemplate.Template{MutableMetadataTemplate.Public, MutableMetadataTemplate.Private}
        }
