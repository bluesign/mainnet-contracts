...
pub contract NiftoryMetadataViewsResolvers{ 
    ...
    pub struct DisplayResolver: MetadataViewsManager.Resolver{ 
        ...
        pub fun resolve(_ nftRef: AnyStruct): AnyStruct?{ 
            ...
            // image
            let url = NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: self.defaultImagePrefix, uri: metadata[self.imageField] ?? self.defaultImage)
    ...
    pub struct DisplayResolverWithIpfsGateway: MetadataViewsManager.Resolver{ 
        ...
        pub fun resolve(_ nftRef: AnyStruct): AnyStruct?{ 
            ...
            // name
            let name = NiftoryMetadataViewsResolvers._firstValueOrElse(metadata: &metadata as &{String: String}, fields: self.nameFields, default: self.defaultName)
            
            // description
            let description = NiftoryMetadataViewsResolvers._firstValueOrElse(metadata: &metadata as &{String: String}, fields: self.descriptionFields, default: self.defaultDescription)
            
            // image
            let uri = NiftoryMetadataViewsResolvers._firstValueOrElse(metadata: &metadata as &{String: String}, fields: self.imageFields, default: self.defaultImage)
            let url = NiftoryMetadataViewsResolvers._useIpfsGateway(ipfsGateway: self.ipfsGateway, uri: NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: self.defaultImagePrefix, uri: uri))
            return MetadataViews.Display(name: name, description: description, thumbnail: MetadataViews.HTTPFile(url: url))
        }
    ...
    pub struct NFTCollectionDisplayResolver: MetadataViewsManager.Resolver{ 
        ...
        pub fun resolve(_ nftRef: AnyStruct): AnyStruct?{ 
            ...
            // external URL
            let externalURL = MetadataViews.ExternalURL(url: NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: self.defaultExternalURLPrefix, uri: metadata[self.externalUrlField] ?? self.defaultExternalURL))
            
            // square image
            let squareImageURL = NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: self.defaultSquareImagePrefix, uri: metadata[self.squareImageField] ?? self.defaultSquareImage)
            ...
            // banner image
            let bannerImageURL = NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: self.defaultBannerImagePrefix, uri: metadata[self.bannerImageField] ?? self.defaultBannerImage)
    ...
    pub struct NFTCollectionDisplayResolverWithIpfsGateway:
        ...
        pub fun resolve(_ nftRef: AnyStruct): AnyStruct?{ 
            let metadata =
                NiftoryMetadataViewsResolvers._extractMetadata(nftRef: nftRef)
            
            // name
            let name =
                NiftoryMetadataViewsResolvers._firstValueOrElse(
            ...
            let externalURL =
                MetadataViews.ExternalURL(
                    url: NiftoryMetadataViewsResolvers._prefixUri(
                        allowedPrefixes: NiftoryMetadataViewsResolvers
                            .DEFAULT_ALLOWED_URI_PREFIXES(),
            ...
            let squareImageURL =
                NiftoryMetadataViewsResolvers._useIpfsGateway(
            ...
            let squareImageMediaType =
                metadata[self.squareImageMediaTypeField]
            ...
            let bannerImageMediaType =
                metadata[self.bannerImageMediaTypeField]
                ?? self.defaultBannerImageMediaType
            let bannerImage =
                MetadataViews.Media(
                    file: MetadataViews.HTTPFile(url: bannerImageURL),
                    mediaType: bannerImageMediaType
                )
            
            // socials
            let socials =
                NiftoryMetadataViewsResolvers._parseUrls(
                    metadata: metadata,
    ...
    pub struct ExternalURLResolver: MetadataViewsManager.Resolver{ 
        ...
        pub fun resolve(_ nftRef: AnyStruct): AnyStruct?{ 
            ...
            // url
            let url = NiftoryMetadataViewsResolvers._prefixUri(allowedPrefixes: NiftoryMetadataViewsResolvers.DEFAULT_ALLOWED_URI_PREFIXES(), default: self.defaultPrefix, uri: metadata[self.field] ?? self.defaultURL)
    ...
    priv fun _extractMetadata(nftRef: AnyStruct):{ String: String}{ 
        let nft = nftRef as! &{NiftoryNonFungibleToken.NFTPublic}
    ...
    priv fun _startsWith(string: String, substring: String): Bool{ 
    ...
    pub fun _useIpfsGateway(ipfsGateway: String, uri: String): String{ 
    ...
    priv fun _parseUrls(metadata:{ String: String}, socialsFields: [String]):{ 
