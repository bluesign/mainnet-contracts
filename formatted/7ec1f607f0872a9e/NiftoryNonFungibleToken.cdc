...
pub contract NiftoryNonFungibleToken{ 
    ...
    pub resource interface ManagerPublic{ 
        ...
        pub fun getSetManagerPublic(): &MutableMetadataSetManager.Manager{
            MutableMetadataSetManager.Public
        }{} 
        
        // For convenience and transparency, return the MetadataViewsManager this
        // contract's NFTs are gettting their metadata from
        pub fun getMetadataViewsManagerPublic(): &MetadataViewsManager.Manager{
    ...
    pub resource interface ManagerPrivate{ 
        ...
        pub fun mintBulk(setId: Int, templateId: Int, numToMint: UInt64): @[
        ...
        pub fun modifyNFTMetadata(
            setId: Int,
            templateId: Int
        ): auth &AnyStruct{} 
        
        // Replace the metadata for a given template
        pub fun replaceNFTMetadata(
            setId: Int,
            templateId: Int,
            new: AnyStruct
        ){} 
