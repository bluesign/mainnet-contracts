...
pub contract MutableMetadataSetManager{ 
    ...
    pub resource interface Public{ 
        ...
        pub fun getSet(_ id: Int): &MutableMetadataSet.Set{
    ...
    pub resource interface Private{ 
        ...
        pub fun getSetMutable(_ id: Int): &MutableMetadataSet.Set{
            MutableMetadataSet.Public,
    ...
    pub resource Manager: Public, Private{ 
        ...
        // Name of this manager
        priv var _name: String
        
        // Description of this manager
        priv var _description: String
        
        // Sets owned by this manager
        priv var _mutableSets: @[MutableMetadataSet.Set]
        ...
        pub fun getSet(_ id: Int): &MutableMetadataSet.Set{MutableMetadataSet.Public}{ 
            ...
            return &self._mutableSets[id] as &MutableMetadataSet.Set{MutableMetadataSet.Public}
        }
        ...
        pub fun getSetMutable(_ id: Int): &MutableMetadataSet.Set{MutableMetadataSet.Public, MutableMetadataSet.Private}{ 
            pre{ 
                id >= 0 && id < self._mutableSets.length:
                    id.toString().concat(" is not a valid set ID. Number of sets is ").concat(self._mutableSets.length.toString())
            }
            return &self._mutableSets[id] as &MutableMetadataSet.Set{MutableMetadataSet.Public, MutableMetadataSet.Private}
        }
