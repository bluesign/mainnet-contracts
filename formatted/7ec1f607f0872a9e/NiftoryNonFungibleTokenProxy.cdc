...
pub contract NiftoryNonFungibleTokenProxy{ 
    ...
    pub resource interface Private{ 
        ...
        pub fun access(registryAddress: Address, brand: String): &{
            NiftoryNonFungibleToken.ManagerPrivate,
            NiftoryNonFungibleToken.ManagerPublic
        }{} 
    }
    ...
    pub resource Proxy: Public, Private{ 
        ...
        priv let _proxies:{ Address:{ String: Capability<&{NiftoryNonFungibleToken.ManagerPrivate, NiftoryNonFungibleToken.ManagerPublic}>}}
        
        pub fun add(registryAddress: Address, brand: String, cap: Capability<&{NiftoryNonFungibleToken.ManagerPrivate, NiftoryNonFungibleToken.ManagerPublic}>){ 
            pre{ 
            ...
            let caps = &self._proxies[registryAddress]! as &{String: Capability<&{NiftoryNonFungibleToken.ManagerPrivate, NiftoryNonFungibleToken.ManagerPublic}>}
            caps[brand] = cap
        }
        
        pub fun replace(registryAddress: Address, brand: String, cap: Capability<&{NiftoryNonFungibleToken.ManagerPrivate, NiftoryNonFungibleToken.ManagerPublic}>){ 
            if self._proxies[registryAddress] == nil{ 
                self._proxies[registryAddress] ={} 
            }
            let caps = &self._proxies[registryAddress]! as &{String: Capability<&{NiftoryNonFungibleToken.ManagerPrivate, NiftoryNonFungibleToken.ManagerPublic}>}
        ...
        pub fun access(registryAddress: Address, brand: String): &{NiftoryNonFungibleToken.ManagerPrivate, NiftoryNonFungibleToken.ManagerPublic}{ 
            pre{ 
                self._proxies[registryAddress] != nil && (self._proxies[registryAddress]!)[brand] != nil:
