pub contract FlowContractAudits{ 
    ...
    pub resource Auditor{ 
        ...
        pub fun addVoucherHashed(
            ...
            let key =
                FlowContractAudits.generateVoucherKey(
                    address: address,
                    codeHash: codeHash
                )
    ...
    pub resource AuditorProxy: AuditorProxyPublic{ 
        priv var auditorCapability: Capability<&Auditor>?
    ...
    pub resource Administrator{ 
        ...
        pub fun useVoucherForDeploy(address: Address, code: String): Bool{ 
            return FlowContractAudits.useVoucherForDeploy(
                address: address,
                code: code
            )
        }
    ...
    access(contract) fun useVoucherForDeploy(
        address: Address,
        code: String
    ): Bool{ 
        let codeHash = FlowContractAudits.hashContractCode(code)
    ...
    init(){ 
        ...
        self
            .AuditorProxyStoragePath = /storage/flowContractAuditVouchersAuditorProxy
        self
            .AuditorProxyPublicPath = /public/flowContractAuditVouchersAuditorProxy
