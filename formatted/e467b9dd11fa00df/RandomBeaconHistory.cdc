...
pub contract RandomBeaconHistory{ 
    access(           
           ...
           contract) var lowestHeight: UInt64?
    ...
    ///
    pub struct RandomSourceHistoryPage{ 
        pub let page: UInt64
        
        pub let perPage: UInt64
        
        pub let totalLength: UInt64
        
        pub let values: [RandomSource]
    ...
    pub fun sourceOfRandomness(
        ...
        return RandomSource(
            ...
            value: self.randomSourceHistory[index]
        )
    }
    ...
    ///
    pub fun getRandomSourceHistoryPage(
        _ page: UInt64,
        perPage: UInt64
    ): RandomSourceHistoryPage{ 
        pre{ 
        ...
        for i, block in self.randomSourceHistory.slice(
            from: Int(startIndex),
            upTo: Int(endIndex)
        ){ 
            values.append(
    ...
    ///
    pub fun getLowestHeight(): UInt64{ 
        return self.lowestHeight
        ?? panic("History has not yet been initialized")
    }
