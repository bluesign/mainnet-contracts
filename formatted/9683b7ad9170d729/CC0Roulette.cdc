...
pub contract CC0Roulette: NonFungibleToken, ViewResolver{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.Royalties>():
                    return MetadataViews.Royalties([MetadataViews.Royalty(receiver: getAccount(CC0Roulette.royaltyAccount).getCapability<&{FungibleToken.Receiver}>(/public/GenericFTReceiver), cut: 0.03, description: "3% cut to contract account")])
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL("https://chat.openai.com/g/g-ldzjWGPdV-cc0-roulette")
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: CC0Roulette.CollectionStoragePath, publicPath: CC0Roulette.CollectionPublicPath, providerPath: /private/CC0RouletteCollection, publicCollection: Type<&CC0Roulette.Collection{CC0Roulette.CC0RouletteCollectionPublic}>(), publicLinkedType: Type<&CC0Roulette.Collection{CC0Roulette.CC0RouletteCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&CC0Roulette.Collection{CC0Roulette.CC0RouletteCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        ...
        pub let mintedUsers:{ String: Bool}
        
        pub fun hasUserMinted(_ userID: String): Bool{ 
            return self.mintedUsers.containsKey(userID)
        }
        
        pub fun markUserMinted(_ userID: String){ 
