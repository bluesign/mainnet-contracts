...
pub contract LCubeNFT: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(id: self.id, ipfsHash: self.ipfsHash, name: self.name, description: self.description, nftType: self.nftType, nftTypeDescription: self.nftTypeDescription, contentType: self.contentType, power: self.power, rarity: self.rarity)
            }
            return nil
        }
    ...
    pub resource NFTMinter{ 
        ...
        pub fun mintNFT(creator: Capability<&{NonFungibleToken.Receiver}>, recipient: &{NonFungibleToken.CollectionPublic}, ipfsHash: String, name: String, description: String, nftType: String, nftTypeDescription: String, contentType: String, power: UFix64, rarity: UFix64): &NonFungibleToken.NFT{ 
            // create a new NFT
