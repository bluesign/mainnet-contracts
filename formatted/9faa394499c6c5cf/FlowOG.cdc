...
pub contract FlowOG: FungibleToken, ViewResolver{ 
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver{ 
        ...
        pub fun withdraw(amount: UFix64): @FungibleToken.Vault{ 
            ...
            if let owner: Address = self.owner?.address{ 
                FlowOG.setBalance(address: owner, balance: self.balance)
            }
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                case Type<FungibleTokenMetadataViews.FTView>():
                    return FlowOG.resolveView(view)
        ...
        destroy(){ 
            if self.balance > 0.0{ 
                ...
                FlowOG.totalSupply = FlowOG.totalSupply - self.balance
            }
        }
    }
    ...
    pub resource Minter: Toucans.Minter{ 
        pub fun mint(amount: UFix64): @Vault{ 
            post{ 
                FlowOG.maxSupply == nil || FlowOG.totalSupply <= FlowOG.maxSupply!:
                    "Exceeded the max supply of tokens allowd."
            }
            FlowOG.totalSupply = FlowOG.totalSupply + amount
    ...
    pub fun resolveView(_ view: Type): AnyStruct?{ 
        switch view{ 
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(name: "Flow OG", symbol: "OGF", description: "Empowering Early Flow Pioneers", externalURL: MetadataViews.ExternalURL(""), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL(""), "discord": MetadataViews.ExternalURL("")})
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(storagePath: FlowOG.VaultStoragePath, receiverPath: FlowOG.ReceiverPublicPath, metadataPath: FlowOG.VaultPublicPath, providerPath: /private/FlowOGVault, receiverLinkedType: Type<&Vault{FungibleToken.Receiver}>(), metadataLinkedType: Type<&Vault{FungibleToken.Balance, MetadataViews.Resolver}>(), providerLinkedType: Type<&Vault{FungibleToken.Provider}>(), createEmptyVaultFunction: fun (): @Vault{ 
                        return <-FlowOG.createEmptyVault()
                    })
        }
        return nil
    }
    ...
    init(_paymentTokenInfo: ToucansTokens.TokenInfo, _editDelay: UFix64, _minting: Bool, _initialTreasurySupply: UFix64, _maxSupply: UFix64?, _extra:{ String: AnyStruct}){ 
        ...
        // Paths
        self.VaultStoragePath = /storage/FlowOGVault
        self.ReceiverPublicPath = /public/FlowOGReceiver
        self.VaultPublicPath = /public/FlowOGMetadata
        self.MinterStoragePath = /storage/FlowOGMinter
        self.AdministratorStoragePath = /storage/FlowOGAdmin
