...
pub contract HelixAuto: NonFungibleToken{ 
        ...
        pub fun resolveView(_ view: Type): AnyStruct?{ 
            switch view{ 
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(storagePath: HelixAuto.CollectionStoragePath, publicPath: HelixAuto.CollectionPublicPath, providerPath: /private/HelixAutoCollection, publicCollection: Type<&HelixAuto.Collection{HelixAuto.HelixAutoCollectionPublic}>(), publicLinkedType: Type<&HelixAuto.Collection{HelixAuto.HelixAutoCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(), providerLinkedType: Type<&HelixAuto.Collection{HelixAuto.HelixAutoCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(), createEmptyCollectionFunction: fun (): @NonFungibleToken.Collection{ 
    ...
    pub resource NFTMinter{ 
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, _traits:{ String: AnyStruct}, _vehicle_type: VehicleType, _glbCID: String, _imageCID: String, royalties: [MetadataViews.Royalty]){ 
    ...
    pub fun fetch(_ from: Address, itemID: UInt64): &HelixAuto.NFT?{ 
        let collection = (getAccount(from).getCapability(HelixAuto.CollectionPublicPath)!).borrow<&HelixAuto.Collection{HelixAuto.HelixAutoCollectionPublic}>() ?? panic("Couldn't get collection")
    ...
    init(){ 
        ...
        self.account.link<&HelixAuto.Collection{NonFungibleToken.CollectionPublic, HelixAuto.HelixAutoCollectionPublic, MetadataViews.ResolverCollection}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
