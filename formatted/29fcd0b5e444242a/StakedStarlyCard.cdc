...
pub contract StakedStarlyCard: NonFungibleToken{ 
    pub event CardStaked(id: UInt64, starlyID: String, beneficiary: Address, stakeTimestamp: UFix64, remainingResourceAtStakeTimestamp: UFix64)
    
    pub event CardUnstaked(id: UInt64, starlyID: String, beneficiary: Address, stakeTimestamp: UFix64, unstakeTimestamp: UFix64, remainingResourceAtUnstakeTimestamp: UFix64)
    ...
    pub resource NFTMinter{ 
        pub fun mintStake(starlyCard: @StarlyCard.NFT, beneficiary: Address, stakeTimestamp: UFix64): @StakedStarlyCard.NFT{ 
            pre{ 
