...
pub contract SGCLDR_cm_2cs_kkdx: NonFungibleToken, Anique {
    // -----------------------------------------------------------------------
    // SGCLDR_cm_2cs_kkdx contract Events
    // -----------------------------------------------------------------------

    // Events for Contract-Related actions
    //
    // Emitted when the SGCLDR_cm_2cs_kkdx contract is created
    ...
    // -----------------------------------------------------------------------
    // SGCLDR_cm_2cs_kkdx contract-level fields.
    ...
    // -----------------------------------------------------------------------
    // SGCLDR_cm_2cs_kkdx contract-level Composite Type definitions
    // -----------------------------------------------------------------------

    // The structure that represents Item
    // each digital content which SGCLDR_cm_2cs_kkdx deal with on Flow
    //
    pub struct ItemData {
        ...
        init(itemID: UInt32) {
            let item = (&SGCLDR_cm_2cs_kkdx.items[itemID] as &Item?)!
    ...
    pub resource Item {
        ...
        init(metadata: {String: String}) {
            ...
            self.itemID = SGCLDR_cm_2cs_kkdx.nextItemID
            self.metadata = metadata
            self.numberMintedPerItem = 0

            // increment the nextItemID so that it isn't used again
            SGCLDR_cm_2cs_kkdx.nextItemID = SGCLDR_cm_2cs_kkdx.nextItemID + 1
    ...
    pub resource NFT: NonFungibleToken.INFT, Anique.INFT {
        ...
        init(serialNumber: UInt32, itemID: UInt32) {
            ...
            SGCLDR_cm_2cs_kkdx.totalSupply = SGCLDR_cm_2cs_kkdx.totalSupply + 1

            // set id
            self.id = SGCLDR_cm_2cs_kkdx.totalSupply
    ...
    // interface that represents SGCLDR_cm_2cs_kkdx collections to public
    ...
    pub resource interface CollectionPublic {
        ...
        // borrow NFT as SGCLDR_cm_2cs_kkdx token
        pub fun borrowSGCLDR_cm_2cs_kkdxCollectible(id: UInt64): auth &NFT
    }
    ...
    pub resource Collection: CollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic {
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            ...
            // Cast the deposited token as an SGCLDR_cm_2cs_kkdx NFT to make sure
            // it is the correct type
            let token <- token as! @SGCLDR_cm_2cs_kkdx.NFT
        ...
        // not any SGCLDR_cm_2cs_kkdx specific data. Please use borrowCollectible to
        ...
        // borrowSGCLDR_cm_2cs_kkdxCollectible returns a borrowed reference
        // to an SGCLDR_cm_2cs_kkdx Collectible
        pub fun borrowSGCLDR_cm_2cs_kkdxCollectible(id: UInt64): auth &NFT {
            pre {
    ...
    pub resource Admin {
        ...
        // and stores it in the Items dictionary field in the SGCLDR_cm_2cs_kkdx smart contract
        //
        ...
        pub fun createItem(metadata: {String: String}): UInt32 {
            ...
            SGCLDR_cm_2cs_kkdx.items[newItem.itemID] <-! newItem

            return itemId
        }

        // borrowItem returns a reference to a Item in the SGCLDR_cm_2cs_kkdx
        ...
        pub fun borrowItem(itemID: UInt32): &Item {
            pre {
                SGCLDR_cm_2cs_kkdx.items[itemID] != nil: "Cannot borrow Item: The Item doesn't exist"
            }

            return (&SGCLDR_cm_2cs_kkdx.items[itemID] as &Item?)!
        }
    ...
    // -----------------------------------------------------------------------
    // SGCLDR_cm_2cs_kkdx contract-level function definitions
    // -----------------------------------------------------------------------
    ...
    pub fun createEmptyCollection(): @NonFungibleToken.Collection {
        return <-create SGCLDR_cm_2cs_kkdx.Collection()
    }
    ...
    // -----------------------------------------------------------------------
    // SGCLDR_cm_2cs_kkdx initialization function
    // -----------------------------------------------------------------------
    //
    init() {
        ...
        self.collectionStoragePath     = /storage/SGCLDR_cm_2cs_kkdxCollection
        self.collectionPublicPath      =  /public/SGCLDR_cm_2cs_kkdxCollection
        self.collectionPrivatePath     = /private/SGCLDR_cm_2cs_kkdxCollection
        self.adminStoragePath          = /storage/SGCLDR_cm_2cs_kkdxAdmin
        self.saleCollectionStoragePath = /storage/SGCLDR_cm_2cs_kkdxSaleCollection
        self.saleCollectionPublicPath  =  /public/SGCLDR_cm_2cs_kkdxSaleCollection
