...
access(all) contract FlowUp {
        ...
        fun resolveView(_ view: Type): AnyStruct? {
            ...
            case Type<MetadataViews.Display>():
                return MetadataViews.Display(
                    name: "FlowUp Inscription #".concat(self.getId().toString()),
                    description: "FlowUp is a decentralized protocol to store and exchange inscriptions.",
                    thumbnail: fileView,
                )
    ...
    access(all) resource interface ArchivedInscriptionsPublic {
        ...
        fun getIDs(): [UInt64]
        access(all) view
        fun borrowInscription(_ id: UInt64): &FlowUp.Inscription{FlowUp.InscriptionPublic}?
    }
    ...
    access(all) resource ArchivedInscriptions {
        ...
        access(all)
        fun borrowInscriptionWritableRef(_ id: UInt64): &FlowUp.Inscription? {
    ...
    ///
    access(all) view
    fun getFlowUpStoragePath(index: UInt64): StoragePath {
    ...
    access(all) view
    fun getArchivedFlowUpStoragePath(): StoragePath {
        let prefix = "FlowUp_".concat(self.account.address.toString())
