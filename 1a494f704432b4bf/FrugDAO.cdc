...
pub contract FrugDAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreibdmuhaiq7dvnzb47avycpzite2i4etsaumzntldtg56wdorsdrp4"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreicwvu34cpznglqyr5kmtqujh7gtmprjnt4fif6evc4tw4vmlmwwsy"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Frug DAO",
                    symbol: "FRUG",
                    description: "A community driven DAO powered by $FRUG",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("frugcoin"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: FrugDAO.VaultStoragePath,
                    receiverPath: FrugDAO.ReceiverPublicPath,
                    metadataPath: FrugDAO.VaultPublicPath,
                    providerPath: /private/FrugDAOVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("FrugDAO", self.account.address, "FRUG", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
