...
pub contract WorldofDiamonds : NonFungibleToken {
    ...
    pub resource NFTMinter {
        ...
        pub fun mintNFT(
            ...
            var newNFT <- create NFT(
                id: WorldofDiamonds.totalSupply,
                creator: creator,
                metadata: metadata
            )
    ...
    init() {
        ...
        self.account.link<&WorldofDiamonds.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, WorldofDiamonds._NFT_NAME_CollectionPublic, MetadataViews.ResolverCollection}>(
