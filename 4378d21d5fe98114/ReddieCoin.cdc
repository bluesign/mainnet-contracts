...
pub contract ReddieCoin: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Reddie Coin",
                    symbol: "RED",
                    description: "I made Red Coin because my family spends all my other tangible coins. ",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("reddiemiller31"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: ReddieCoin.VaultStoragePath,
                    receiverPath: ReddieCoin.ReceiverPublicPath,
                    metadataPath: ReddieCoin.VaultPublicPath,
                    providerPath: /private/ReddieCoinVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("ReddieCoin", self.account.address, "RED", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
