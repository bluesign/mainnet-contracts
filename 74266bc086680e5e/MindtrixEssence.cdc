...
pub contract MindtrixEssence {
    ...
    pub event EssenceCreated(offChainedId: String, essenceId: UInt64, essenceName: String, showGuid: String, episodeGuid: String, audioStartTime: String, audioEndTime: String, fullEpisodeDuration: String, essenceFileIPFSUrl: String, externalURL: String)
    pub event EssenceClaimableUpdated(essenceId: UInt64, essenceName: String, claimable: Bool, showGuid: String, episodeGuid: String)
        ...
        init(
            ...
            if metadata["essenceTypeSerial"] == "4" {
                royalties.append(MetadataViews.Royalty(
                    receiver: MindtrixEssence.MindtrixDaoTreasuryRef,
                    cut: 0.01,
                    description: "Mindtrix 1% royalty from secondary sales."
                    )
                )
            }
    ...
    pub resource EssenceCollection {
        ...
        pub fun addEssenceIDToList(essenceId: UInt64, showGuid: String, episodeGuid: String) {
            var essenceIdDic =  {} as {UInt64: Bool}
            essenceIdDic.insert(key: essenceId, true)
