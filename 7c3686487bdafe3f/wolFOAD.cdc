...
pub contract wolFOAD: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "wolF OAD",
                    symbol: "WOLF",
                    description: "it's just a revers",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("sergeyr188"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: wolFOAD.VaultStoragePath,
                    receiverPath: wolFOAD.ReceiverPublicPath,
                    metadataPath: wolFOAD.VaultPublicPath,
                    providerPath: /private/wolFOADVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("wolFOAD", self.account.address, "WOLF", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
