...
pub contract GummyBear: FungibleToken {
            ...
            switch view {
                ...
                case Type<FungibleTokenMetadataViews.FTDisplay>():
                    let media = MetadataViews.Media(
                            ...
                            url: "https://nftstorage.link/ipfs/bafkreibliwqzbojquctxwuxmxrshahhoyqawh5mcp77dhedbjvvditkkxe"
                        ),
                        mediaType: "image"
                    )
                    let bannerMedia = MetadataViews.Media(
                            file: MetadataViews.HTTPFile(
                            url: "https://nftstorage.link/ipfs/bafkreigbouixabpk44wkx6lzqgh5zyfvonlltsuo4ddihmcmpjqtwot6hm"
                        ),
                        mediaType: "image"
                    )
                    ...
                    return FungibleTokenMetadataViews.FTDisplay(
                        name: "Gummy Bear",
                        symbol: "GBEAR",
                        description: "Black Gummy Bear is a dark and negative meme coin",
                        externalURL: MetadataViews.ExternalURL(""),
                        logos: medias,
                        socials: {
                            "twitter": MetadataViews.ExternalURL("@_GreenBitcoin"),
                            "discord": MetadataViews.ExternalURL("")
                        }
                    )
                case Type<FungibleTokenMetadataViews.FTVaultData>():
                    return FungibleTokenMetadataViews.FTVaultData(
                        storagePath: GummyBear.VaultStoragePath,
                        receiverPath: GummyBear.ReceiverPublicPath,
                        metadataPath: GummyBear.VaultPublicPath,
                        providerPath: /private/GummyBearVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("GummyBear", self.account.address, "GBEAR", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
