...
pub contract VOARJ: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeicpmiywiyskzctsanfk4u2ypwzhfumuv7wndcthywfz5puhmiwrpa"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeic6qhjl32pwgghlkvubcicqp2rkhkjbzwe7zentvt46buydpzfxoi"
                    ),
                    mediaType: "image"
                )
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: VOARJ.VaultStoragePath,
                    receiverPath: VOARJ.ReceiverPublicPath,
                    metadataPath: VOARJ.VaultPublicPath,
                    providerPath: /private/VOARJVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("VOARJ", self.account.address, "VOARJ", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
