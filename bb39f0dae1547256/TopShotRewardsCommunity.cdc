...
pub contract TopShotRewardsCommunity: FungibleToken, ViewResolver {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver {
        ...
        destroy() {
            if (self.balance > 0.0) {
                ...
                TopShotRewardsCommunity.totalSupply = TopShotRewardsCommunity.totalSupply - self.balance
            }
        }
    }
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreid5sova5e3aaratgc2lotv266thsf3xo5cssfj2npknq7wqdm77wq"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeidza2ubipfpilwfffjbp3dh2rzzaz5rbrtahoy4m4shtjf6oua7uu"
                    ),
                    mediaType: "image"
                )
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Top Shot Rewards Community",
                    symbol: "TSR",
                    description: "A DAO for all the collectors of NBA Top Shot and beyond. We Rise together.",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("TopShotRewards"),
                        "discord": MetadataViews.ExternalURL("Eh5c8k2gUu")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: TopShotRewardsCommunity.VaultStoragePath,
                    receiverPath: TopShotRewardsCommunity.ReceiverPublicPath,
                    metadataPath: TopShotRewardsCommunity.VaultPublicPath,
                    providerPath: /private/TopShotRewardsCommunityVault,
                    ...
                    createEmptyVaultFunction: (fun (): @Vault {
                        return <- TopShotRewardsCommunity.createEmptyVault()
                    })
                )
        }
        return nil
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("TopShotRewardsCommunity", self.account.address, "TSR", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
