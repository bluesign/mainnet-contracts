...
pub contract SportsJunkiezDAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreif4l3hxaqm3oblt3gt7sbgaoxkvnvp7fy6fvrcwufddmf4vmiosty"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreicxyz46wzdajd4tpzl5r53j4wpjokmg7nkwyuf52pow5lyksjfxim"
                    ),
                    mediaType: "image"
                )
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Sports Junkiez DAO",
                    symbol: "SJNKZ",
                    description: "A DAO For Sports Junkiez",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("https://twitter.com/JunkiezSports"),
                        "discord": MetadataViews.ExternalURL("SportsJunkiez")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: SportsJunkiezDAO.VaultStoragePath,
                    receiverPath: SportsJunkiezDAO.ReceiverPublicPath,
                    metadataPath: SportsJunkiezDAO.VaultPublicPath,
                    providerPath: /private/SportsJunkiezDAOVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("SportsJunkiezDAO", self.account.address, "SJNKZ", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
