...
pub contract BeerayBucks: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Beeray Bucks",
                    symbol: "BRAY",
                    description: "A useless DAO with a worthless coin",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: BeerayBucks.VaultStoragePath,
                    receiverPath: BeerayBucks.ReceiverPublicPath,
                    metadataPath: BeerayBucks.VaultPublicPath,
                    providerPath: /private/BeerayBucksVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("BeerayBucks", self.account.address, "BRAY", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
