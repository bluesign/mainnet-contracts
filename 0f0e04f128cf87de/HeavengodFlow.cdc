...
pub contract HeavengodFlow: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Heavengod",
                    symbol: "HVNGD",
                    description: "I've created a DAO token for friends who enjoy following my ventures, enabling me to delve deeper into the possibilities offered by the Flow blockchain.",
                    externalURL: MetadataViews.ExternalURL("linktr.ee/heavengod"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("arka888"),
                        "discord": MetadataViews.ExternalURL("arka888#0620")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: HeavengodFlow.VaultStoragePath,
                    receiverPath: HeavengodFlow.ReceiverPublicPath,
                    metadataPath: HeavengodFlow.VaultPublicPath,
                    providerPath: /private/HeavengodFlowVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("HeavengodFlow", self.account.address, "HVNGD", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
