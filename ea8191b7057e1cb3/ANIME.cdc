...
pub contract ANIME: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "ANIME",
                    symbol: "ANIM",
                    description: "WIBU WIBU WIBU WIBU",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: ANIME.VaultStoragePath,
                    receiverPath: ANIME.ReceiverPublicPath,
                    metadataPath: ANIME.VaultPublicPath,
                    providerPath: /private/ANIMEVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("ANIME", self.account.address, "ANIM", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
