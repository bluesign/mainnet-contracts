  ...
  pub resource NFT: NonFungibleToken.INFT, TiblesNFT.INFT, MetadataViews.Resolver {
    ...
    pub fun displayData(): {String: String} {
      ...
      if (metadata.containsKey("pack")) {
        return {
          "name": "Tibles pack",
          "description": "A Tibles pack",
          "imageUrl": "https://i.tibles.com/H65uAeuNyq.png"
        }
      }
    ...
    pub fun nftCollectionData(): MetadataViews.NFTCollectionData {
      return MetadataViews.NFTCollectionData(
        storagePath: Tibles.CollectionStoragePath,
        publicPath: Tibles.PublicCollectionPath,
        providerPath: /private/TiblesCollection,
        publicCollection: Type<&Tibles.Collection{TiblesNFT.CollectionPublic}>(),
        publicLinkedType:   Type<&Tibles.Collection{TiblesNFT.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
        providerLinkedType: Type<&Tibles.Collection{TiblesNFT.CollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,MetadataViews.ResolverCollection}>(),
    ...
    pub fun nftCollectionDisplay(): MetadataViews.NFTCollectionDisplay {
      let squareMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/tibles-flow-icon.png"),
        mediaType: "image/svg+xml"
      )
      let bannerMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/tibles-flow-collection-banner.png"),
        mediaType: "image/png"
      )
      ...
      return MetadataViews.NFTCollectionDisplay(
        name: "Tibles Collection",
        description: "Tibles collectibles",
        externalURL: MetadataViews.ExternalURL("https://app.tibles.com"),
