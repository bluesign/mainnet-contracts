...
pub contract giglabsdemostore_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            giglabsdemostore_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
        ...
        //
	    pub fun mintgiglabsdemostore_NFT(
			...
			recipient.deposit(token: <-create giglabsdemostore_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditiongiglabsdemostore_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
		...
		pub fun batchMintgiglabsdemostore_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: giglabsdemostore_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: giglabsdemostore_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: giglabsdemostore_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: giglabsdemostore_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: giglabsdemostore_NFT.CollectionStoragePath,
                        publicPath: giglabsdemostore_NFT.CollectionPublicPath,
                        providerPath: /private/giglabsdemostore_NFT,
                        publicCollection: Type<&giglabsdemostore_NFT.Collection{giglabsdemostore_NFT.giglabsdemostore_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&giglabsdemostore_NFT.Collection{giglabsdemostore_NFT.giglabsdemostore_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&giglabsdemostore_NFT.Collection{giglabsdemostore_NFT.giglabsdemostore_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/giglabsdemostore/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/giglabsdemostore/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: giglabsdemostore_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: giglabsdemostore_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(giglabsdemostore_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &giglabsdemostore_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(giglabsdemostore_NFT.CollectionPublicPath)
            .borrow<&giglabsdemostore_NFT.Collection{giglabsdemostore_NFT.giglabsdemostore_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&giglabsdemostore_NFT.Admin>(
