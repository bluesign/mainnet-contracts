...
pub contract Awoken : NonFungibleToken {
    ...
    init() {
        ...
        self.account.link<&Awoken.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, Awoken._NFT_NAME_CollectionPublic, MetadataViews.ResolverCollection}>(
