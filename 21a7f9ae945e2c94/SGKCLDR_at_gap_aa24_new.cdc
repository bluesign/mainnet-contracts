...
pub contract SGKCLDR_at_gap_aa24_new: NonFungibleToken, Anique {
    // -----------------------------------------------------------------------
    ...
    pub resource interface CollectionPublic {
        ...
        pub fun borrowSGKCLDR_at_gap_aa24_newCollectible(id: UInt64): auth &NFT
    }
    ...
    pub resource Admin {
        ...
        pub fun borrowItem(itemID: UInt32): &Item {
            pre {
                SGKCLDR_at_gap_aa24_new.items[itemID] != nil: "Cannot borrow Item: The Item doesn't exist"
            }
