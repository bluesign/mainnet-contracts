...
pub contract PandaKingdom: NonFungibleToken {
      ...
      switch view {
        case Type<MetadataViews.Display>():
          return MetadataViews.Display(
            ...
            thumbnail: MetadataViews.HTTPFile(
              url: PandaKingdom.BaseURL.concat(self.metadata["fileURI"] ?? "")
            )
          )
        ...
        case Type<MetadataViews.NFTCollectionData>():
          return MetadataViews.NFTCollectionData(
            storagePath: PandaKingdom.CollectionStoragePath,
            publicPath: PandaKingdom.CollectionPublicPath,
            providerPath: /private/PandaKingdomCollection,
            publicCollection: Type<&PandaKingdom.Collection{NonFungibleToken.CollectionPublic,MetadataViews.ResolverCollection}>(),
            publicLinkedType: Type<&PandaKingdom.Collection{NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
            providerLinkedType: Type<&PandaKingdom.Collection{NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
            createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                return <-PandaKingdom.createEmptyCollection()
            })
          )

        case Type<MetadataViews.NFTCollectionDisplay>():
          let media = MetadataViews.Media(
            file: MetadataViews.HTTPFile(url: PandaKingdom.BaseURL.concat("logo.png")),
            mediaType: "image/svg"
          )
          return MetadataViews.NFTCollectionDisplay(
            name: "PandaKingdom Collection",
            description: "Panda Kingdom begins with a collection of 333 avatars based onpanda characters. This is the key that takes you to the Panda Kingdom, where the righteous always have to find a way to fight the dark plots to protect the peace of this land. Panda Kingdom owners have access to exclusive rewards, programs, and other perks.",
            externalURL: MetadataViews.ExternalURL("https://twitter.com/Pandakingdom_fm"),
            squareImage: media,
            bannerImage: media,
            socials: {
              "twitter": MetadataViews.ExternalURL("https://twitter.com/Pandakingdom_fm")
            }
          )
  ...
  pub resource interface CollectionPublic {
    ...
    pub fun borrowPandaKingdom(id: UInt64): &PandaKingdom.NFT? {
      post {
  ...
  init() {
    ...
    self.account.link<&PandaKingdom.Collection{NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(
