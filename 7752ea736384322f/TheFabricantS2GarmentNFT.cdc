...
pub contract TheFabricantS2GarmentNFT: NonFungibleToken {
    ...
    pub resource Admin {
        ...
        pub fun mintNFT(garmentDataID: UInt32): @NFT {
            let numInGarment = TheFabricantS2GarmentNFT.numberMintedPerGarment[garmentDataID]??
        ...
        pub fun retireGarmentData(garmentDataID: UInt32) {           
            pre {
                TheFabricantS2GarmentNFT.isGarmentDataRetired[garmentDataID] != nil: "Cannot retire Garment: Garment doesn't exist!"
            }
    ...
    pub fun getGarmentNumberMinted(id: UInt32): UInt32 {
        let numberMinted = TheFabricantS2GarmentNFT.numberMintedPerGarment[id]??
    ...
    pub fun getGarmentData(id: UInt32): GarmentData {
        let garmentData = TheFabricantS2GarmentNFT.garmentDatas[id]??
            panic("garmentDataID not found")
        return garmentData
    }
    ...
    pub fun getGarmentDataRetired(garmentDataID: UInt32): Bool { 
        let isGarmentDataRetired = TheFabricantS2GarmentNFT.isGarmentDataRetired[garmentDataID]??
            panic("garmentDataID not found")
