...
pub contract HighsnobietyNotInParis: NonFungibleToken, TheFabricantNFTStandardV2, RevealableV2 {
    ...
    pub resource NFT: TheFabricantNFTStandardV2.TFNFT, NonFungibleToken.INFT, MetadataViews.Resolver, PublicNFT {
        ...
        pub fun getEditions(): MetadataViews.Editions {
            ...
            let edition = MetadataViews.Edition(
                name: HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!.collection,
        ...
        pub fun getDisplay(): MetadataViews.Display {
            return MetadataViews.Display(
                ...
                description: HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!.description,
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData {
            return MetadataViews.NFTCollectionData(
                storagePath: HighsnobietyNotInParis.HighsnobietyNotInParisCollectionStoragePath,
                publicPath: HighsnobietyNotInParis.HighsnobietyNotInParisCollectionPublicPath,
                providerPath: HighsnobietyNotInParis.HighsnobietyNotInParisProviderStoragePath,
                publicCollection: Type<&HighsnobietyNotInParis.Collection{HighsnobietyNotInParis.HighsnobietyNotInParisCollectionPublic, MetadataViews.ResolverCollection}>(),
                publicLinkedType: Type<&HighsnobietyNotInParis.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, HighsnobietyNotInParis.HighsnobietyNotInParisCollectionPublic, MetadataViews.ResolverCollection}>(),
                providerLinkedType: Type<&HighsnobietyNotInParis.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, HighsnobietyNotInParisCollectionPublic}>(),
        ...
        pub fun getCollectionDisplay(): MetadataViews.NFTCollectionDisplay {
            ...
            return MetadataViews.NFTCollectionDisplay(
                        ...
                        description: "Not in Paris is the most extensive and impactful flagship event in Highsnobiety’s calendar and is a celebration of all things fashion, culture and tech. For the Not in Paris 2023 edition, The Fabricant has created a series of digital fashion collectibles in collaboration with Highsnobiety.",
                        externalURL: HighsnobietyNotInParis.nftMetadata[self.id]!.externalURL,
        ...
        pub fun getNFTView(): MetadataViews.NFTView {
            return MetadataViews.NFTView(
                ...
                royalties : HighsnobietyNotInParis.nftMetadata[self.id]!.royalties,
            ...
            switch view {
                case Type<TheFabricantMetadataViewsV2.TFNFTIdentifierV1>():
                    return TheFabricantMetadataViewsV2.TFNFTIdentifierV1(
                        ...
                        id: self.id,
                        name: self.getFullName(),
                        collection: HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!.collection,
                ...
                case Type<TheFabricantMetadataViewsV2.TFNFTSimpleView>():
                    return TheFabricantMetadataViewsV2.TFNFTSimpleView(
                        ...
                        coCreatable: HighsnobietyNotInParis.nftMetadata[self.id]!.coCreatable,
                        coCreators: HighsnobietyNotInParis.nftMetadata[self.id]!.coCreator,
                        isRevealed: HighsnobietyNotInParis.nftMetadata[self.id]!.isRevealed,
                        editions: self.getEditions(),
                        originalRecipient: self.originalRecipient,
                        royalties: HighsnobietyNotInParis.nftMetadata[self.id]!.royalties,
                        royaltiesTFMarketplace: HighsnobietyNotInParis.nftMetadata[self.id]!.royaltiesTFMarketplace,
        ...
        destroy() {
            emit ItemDestroyed(
                uuid: self.uuid,
                id: self.id,
                name: HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!.name,
                description: HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!.description,
                collection: HighsnobietyNotInParis.nftMetadata[self.nftMetadataId]!.collection
            )
        }
    ...
    pub resource interface HighsnobietyNotInParisCollectionPublic {
        pub fun borrowHighsnobietyNotInParis(id: UInt64): &HighsnobietyNotInParis.NFT{HighsnobietyNotInParis.PublicNFT}?
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT        
    }

    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, HighsnobietyNotInParisCollectionPublic, MetadataViews.ResolverCollection {
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver} {
            ...
            return HighsnobietyNotInParis as &AnyResource{MetadataViews.Resolver}
        }
        ...
        pub fun borrowHighsnobietyNotInParis(id: UInt64): &HighsnobietyNotInParis.NFT? {
    ...
    pub resource Admin {
        ...
        pub fun distributeDirectlyViaAccessList(
            ...
            .getCapability(publicPath).borrow<&HighsnobietyNotInParis.PublicMinter{HighsnobietyNotInParis.Minter}>() 
            ...
            emit ItemMintedAndTransferred(
                uuid: nft.uuid,
                id: nft.id,
                name: HighsnobietyNotInParis.nftMetadata[nft.nftMetadataId]!.name,
                description: HighsnobietyNotInParis.nftMetadata[nft.nftMetadataId]!.description,
                collection: HighsnobietyNotInParis.nftMetadata[nft.nftMetadataId]!.collection,
                editionNumber: nft.editionNumber,
        ...
        pub fun createPublicMinter(
            ...
            let publicMinter: @HighsnobietyNotInParis.PublicMinter <- create PublicMinter(
                name: name,
                description: description,
                collection: collection,
                license: license,
            ...
            HighsnobietyNotInParis.account.save(<- publicMinter, to: publicMinterStoragePath!)
            HighsnobietyNotInParis.account.link<&PublicMinter{Minter}>(publicMinterPublicPath!, target: publicMinterStoragePath!)
        }
    ...
    pub resource PublicMinter: TheFabricantNFTStandardV2.TFNFTPublicMinter, Minter {
        ...
        pub fun mintUsingAccessList(
            ...
            pre {
                ...
                HighsnobietyNotInParis.paymentReceiverCap != nil: "Payment Receiver Cap must be set for minting!"
            }
            post {
            ...
            if HighsnobietyNotInParis.addressMintLimit != nil {
                if HighsnobietyNotInParis.addressMintCount[receiver.owner!.address] != nil {
                    assert(HighsnobietyNotInParis.addressMintCount[receiver.owner!.address]! < HighsnobietyNotInParis.addressMintLimit!,
           ...
           if !self.isOpenAccess {
            ...
            if payment.balance != 0.0 || payment.balance == 0.0 {
                // pay rest to TF
                emit MintPaymentSplitDeposited(
                            address: HighsnobietyNotInParis.paymentReceiverCap!.address,
                            price: self.paymentAmount,
    ...
    // -----------------------------------------------------------------------
        ...
        access(contract) fun createNftMetadata(
            ...
            pre {
                HighsnobietyNotInParis.baseTokenURI != nil: "Base URI must be set to mint an NFT!"
                variantId == 1 || variantId == 2 || variantId == 3: "Variant ID must be either 1, 2 or 3"
            }
            var nftName: String = ""
            ...
            switch variantId {
                case 1:
                    ...
                    metadata = {
                        "mainImage": HighsnobietyNotInParis.baseTokenURI!.concat("/EiffelTowerPursuit.png"),
                        "video": HighsnobietyNotInParis.baseTokenURI!.concat("/EiffelTowerPursuit.mp4")
                    }
                case 2: 
                    ...
                    metadata = {
                        "mainImage": HighsnobietyNotInParis.baseTokenURI!.concat("/ParisianMirage.png"),
                        "video": HighsnobietyNotInParis.baseTokenURI!.concat("/ParisianMirage.mp4")
                    }
                case 3: 
                    ...
                    metadata = {
                        "mainImage": HighsnobietyNotInParis.baseTokenURI!.concat("/EchoesOfParis.png"),
                        "video": HighsnobietyNotInParis.baseTokenURI!.concat("/EchoesOfParis.mp4")
                    }
            }
    ...
    init() {
        ...
        self.account.save(<- create Admin(adminAddress: self.account.address), to: self.HighsnobietyNotInParisAdminStoragePath)
