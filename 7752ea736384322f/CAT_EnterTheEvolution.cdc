...
pub contract CAT_EnterTheEvolution: NonFungibleToken, TheFabricantNFTStandardV2, RevealableV2 {
    ...
    pub struct RevealableMetadata: RevealableV2.RevealableMetadata {
        ...
        access(self) fun constructAssetPath(): String {
            ...
            return "/"
                .concat(shoeShapeId.toString())
                .concat("_").concat(materialId.toString())
                .concat("_").concat(solidColorId.toString())
                .concat("_").concat(textureSetId.toString())
        }
    ...
    pub resource NFT: TheFabricantNFTStandardV2.TFNFT, NonFungibleToken.INFT, MetadataViews.Resolver, PublicNFT {
        ...
        pub fun getEditions(): MetadataViews.Editions {
            ...
            let edition = MetadataViews.Edition(
                name: CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!.collection,
        ...
        pub fun getDisplay(): MetadataViews.Display {
            return MetadataViews.Display(
                ...
                description: CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!.description,
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData {
            return MetadataViews.NFTCollectionData(
                storagePath: CAT_EnterTheEvolution.CAT_EnterTheEvolutionCollectionStoragePath,
                publicPath: CAT_EnterTheEvolution.CAT_EnterTheEvolutionCollectionPublicPath,
                providerPath: CAT_EnterTheEvolution.CAT_EnterTheEvolutionProviderPath,
                publicCollection: Type<&CAT_EnterTheEvolution.Collection{CAT_EnterTheEvolution.CAT_EnterTheEvolutionCollectionPublic, MetadataViews.ResolverCollection}>(),
                publicLinkedType: Type<&CAT_EnterTheEvolution.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, CAT_EnterTheEvolution.CAT_EnterTheEvolutionCollectionPublic, MetadataViews.ResolverCollection}>(),
                providerLinkedType: Type<&CAT_EnterTheEvolution.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, CAT_EnterTheEvolutionCollectionPublic}>(),
        ...
        pub fun getCollectionDisplay(): MetadataViews.NFTCollectionDisplay {
            ...
            return MetadataViews.NFTCollectionDisplay(
                        ...
                        externalURL: CAT_EnterTheEvolution.nftMetadata[self.id]!.externalURL,
        ...
        pub fun getNFTView(): MetadataViews.NFTView {
            return MetadataViews.NFTView(
                ...
                royalties : CAT_EnterTheEvolution.nftMetadata[self.id]!.royalties,
            ...
            switch view {
                case Type<TheFabricantMetadataViewsV2.TFNFTIdentifierV1>():
                    return TheFabricantMetadataViewsV2.TFNFTIdentifierV1(
                        ...
                        id: self.id,
                        name: self.getFullName(),
                        collection: CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!.collection,
                ...
                case Type<TheFabricantMetadataViewsV2.TFNFTSimpleView>():
                    return TheFabricantMetadataViewsV2.TFNFTSimpleView(
                        ...
                        coCreatable: CAT_EnterTheEvolution.nftMetadata[self.id]!.coCreatable,
                        coCreators: CAT_EnterTheEvolution.nftMetadata[self.id]!.coCreator,
                        isRevealed: CAT_EnterTheEvolution.nftMetadata[self.id]!.isRevealed,
                        editions: self.getEditions(),
                        originalRecipient: self.originalRecipient,
                        royalties: CAT_EnterTheEvolution.nftMetadata[self.id]!.royalties,
                        royaltiesTFMarketplace: CAT_EnterTheEvolution.nftMetadata[self.id]!.royaltiesTFMarketplace,
        ...
        destroy() {
            emit ItemDestroyed(
                uuid: self.uuid,
                id: self.id,
                name: CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!.name,
                description: CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!.description,
                collection: CAT_EnterTheEvolution.nftMetadata[self.nftMetadataId]!.collection
            )
        }
    ...
    pub resource interface CAT_EnterTheEvolutionCollectionPublic {
        pub fun borrowCAT_EnterTheEvolution(id: UInt64): &CAT_EnterTheEvolution.NFT{CAT_EnterTheEvolution.PublicNFT}?
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT        
    }

    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, CAT_EnterTheEvolutionCollectionPublic, MetadataViews.ResolverCollection {
        ...
        pub fun borrowCAT_EnterTheEvolution(id: UInt64): &CAT_EnterTheEvolution.NFT? {
    ...
    pub resource Admin {
        ...
        pub fun createPublicMinter(
            ...
            pre {
                CAT_EnterTheEvolution.baseTokenURI != nil: "Please set a baseURI before creating a minter"
                CAT_EnterTheEvolution.materials.length != 0: "Please add materials to the contract"
                CAT_EnterTheEvolution.shoeShapes.length != 0: "Please add shoeShapes to the contract"
                CAT_EnterTheEvolution.textureSets.length != 0: "Please add textureSets to the contract"
                CAT_EnterTheEvolution.solidColors.length != 0: "Please add solidColors to the contract"
            }

            let publicMinter: @CAT_EnterTheEvolution.PublicMinter <- create PublicMinter(
                name: name,
            ...
            CAT_EnterTheEvolution.account.save(<- publicMinter, to: publicMinterStoragePath!)
            CAT_EnterTheEvolution.account.link<&PublicMinter{Minter}>(publicMinterPublicPath!, target: publicMinterStoragePath!)
        }
        ...
        // NOTE: Customise
        pub fun updateShoeShapes(shapes: {UInt64: {CoCreatableV2.Characteristic}}) {
            var i: UInt64 = 0
        ...
        // NOTE: Customise
        pub fun updateSolidColors(solidColors: {UInt64: {CoCreatableV2.Characteristic}}) {
            var i: UInt64 = 0
        ...
        // NOTE: Customise
        pub fun updateTextureSets(textureSets: {UInt64: {CoCreatableV2.Characteristic}}) {
            var i: UInt64 = 0
    ...
    pub resource PublicMinter: TheFabricantNFTStandardV2.TFNFTPublicMinter, Minter {
        ...
        pub fun mintUsingAccessList(
            ...
            pre {
                ...
                !CAT_EnterTheEvolution.dataAllocations.containsKey(CAT_EnterTheEvolution.constructDataAllocationString(
            ...
            if CAT_EnterTheEvolution.addressMintLimit != nil {
                if CAT_EnterTheEvolution.addressMintCount[receiver.owner!.address] != nil {
                    assert(CAT_EnterTheEvolution.addressMintCount[receiver.owner!.address]! < CAT_EnterTheEvolution.addressMintLimit!,
            ...
            if CAT_EnterTheEvolution.maxSupply != nil {
                assert(
                    CAT_EnterTheEvolution.totalSupply <= CAT_EnterTheEvolution.maxSupply!, 
                    message: "Cannot mint any more NFTs, max supply has been reached!"
                )   
            }
           ...
           if !self.isOpenAccess {
            ...
            getAccount(receiver.owner!.address).getCapability<&FlowToken.Vault{FungibleToken.Receiver}>
                (/public/flowTokenReceiver)
            let coCreatorExternalRoyalty = MetadataViews.Royalty(
            ...
            let coCreatorInternalRoyalty = TheFabricantMetadataViewsV2.Royalty(
                receiver: coCreatorReceiver,
                initialCut: 0.9,
                cut: 0.03,
                description: "CoCreator Royalty"
            ...
            emit ItemMintedAndTransferred(
                uuid: nft.uuid,
                id: nft.id,
                name: CAT_EnterTheEvolution.nftMetadata[nft.nftMetadataId]!.name,
                description: CAT_EnterTheEvolution.nftMetadata[nft.nftMetadataId]!.description,
                collection: CAT_EnterTheEvolution.nftMetadata[nft.nftMetadataId]!.collection,
                editionNumber: nft.editionNumber,
            ...
            emit DataAllocationCreated(
                ...
                originalRecipient: nft.originalRecipient,
                nftMetadataId: nft.nftMetadataId,
                dataAllocationString: CAT_EnterTheEvolution.idsToDataAllocations[nft.nftMetadataId]!
            )
    ...
    access(contract) fun createNftMetadata(
        ...
        pre {
            CAT_EnterTheEvolution.baseTokenURI != nil: "Ensure baseUri is set before minting!"
        }

        //Instant reveal
        let dataAllocation = CAT_EnterTheEvolution.idsToDataAllocations[id]!
        let metadata = {
            "mainImage": CAT_EnterTheEvolution.baseTokenURI!
                            .concat("/")
                            .concat(dataAllocation)
                            .concat(".png"),
            "video": CAT_EnterTheEvolution.baseTokenURI!
                            .concat("/")
                            .concat(dataAllocation)
                            .concat(".mp4")
        }
    ...
    access(contract) fun constructDataAllocationString(
        ...
        return "shoe".concat(shoeShapeId.toString())
            .concat("_mat")
            .concat(materialId.toString())
            .concat("_tex")
            .concat(textureSetId.toString())
            .concat("_col")
            .concat(solidColorId.toString())
    ...
    init() {
        ...
        self.account.save(<- create Admin(adminAddress: self.account.address), to: self.CAT_EnterTheEvolutionAdminStoragePath)
