...
pub contract TheFabricantPrimalRave: NonFungibleToken, TheFabricantNFTStandardV2, RevealableV2 {
    ...
    pub event AdminSetMintableVariants(
        mintableVariants: [UInt64]
    )
    ...
    pub resource NFT: TheFabricantNFTStandardV2.TFNFT, NonFungibleToken.INFT, MetadataViews.Resolver, PublicNFT {
        ...
        pub fun getEditions(): MetadataViews.Editions {
            ...
            let edition = MetadataViews.Edition(
                name: TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!.collection,
        ...
        pub fun getDisplay(): MetadataViews.Display {
            return MetadataViews.Display(
                ...
                description: TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!.description,
        ...
        pub fun getCollectionData(): MetadataViews.NFTCollectionData {
            return MetadataViews.NFTCollectionData(
                storagePath: TheFabricantPrimalRave.TheFabricantPrimalRaveCollectionStoragePath,
                publicPath: TheFabricantPrimalRave.TheFabricantPrimalRaveCollectionPublicPath,
                providerPath: TheFabricantPrimalRave.TheFabricantPrimalRaveProviderStoragePath,
                publicCollection: Type<&TheFabricantPrimalRave.Collection{TheFabricantPrimalRave.TheFabricantPrimalRaveCollectionPublic, MetadataViews.ResolverCollection}>(),
                publicLinkedType: Type<&TheFabricantPrimalRave.Collection{NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, TheFabricantPrimalRave.TheFabricantPrimalRaveCollectionPublic, MetadataViews.ResolverCollection}>(),
                providerLinkedType: Type<&TheFabricantPrimalRave.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, TheFabricantPrimalRaveCollectionPublic}>(),
        ...
        pub fun getCollectionDisplay(): MetadataViews.NFTCollectionDisplay {
            ...
            return MetadataViews.NFTCollectionDisplay(
                        ...
                        externalURL: TheFabricantPrimalRave.nftMetadata[self.id]!.externalURL,
        ...
        pub fun getNFTView(): MetadataViews.NFTView {
            return MetadataViews.NFTView(
                ...
                royalties : TheFabricantPrimalRave.nftMetadata[self.id]!.royalties,
            ...
            switch view {
                case Type<TheFabricantMetadataViewsV2.TFNFTIdentifierV1>():
                    return TheFabricantMetadataViewsV2.TFNFTIdentifierV1(
                        ...
                        id: self.id,
                        name: self.getFullName(),
                        collection: TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!.collection,
                ...
                case Type<TheFabricantMetadataViewsV2.TFNFTSimpleView>():
                    return TheFabricantMetadataViewsV2.TFNFTSimpleView(
                        ...
                        coCreatable: TheFabricantPrimalRave.nftMetadata[self.id]!.coCreatable,
                        coCreators: TheFabricantPrimalRave.nftMetadata[self.id]!.coCreator,
                        isRevealed: TheFabricantPrimalRave.nftMetadata[self.id]!.isRevealed,
                        editions: self.getEditions(),
                        originalRecipient: self.originalRecipient,
                        royalties: TheFabricantPrimalRave.nftMetadata[self.id]!.royalties,
                        royaltiesTFMarketplace: TheFabricantPrimalRave.nftMetadata[self.id]!.royaltiesTFMarketplace,
        ...
        destroy() {
            emit ItemDestroyed(
                uuid: self.uuid,
                id: self.id,
                name: TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!.name,
                description: TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!.description,
                collection: TheFabricantPrimalRave.nftMetadata[self.nftMetadataId]!.collection
            )
        }
    ...
    pub resource interface TheFabricantPrimalRaveCollectionPublic {
        pub fun borrowTheFabricantPrimalRave(id: UInt64): &TheFabricantPrimalRave.NFT{TheFabricantPrimalRave.PublicNFT}?
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT        
    }

    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, TheFabricantPrimalRaveCollectionPublic, MetadataViews.ResolverCollection {
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver} {
            ...
            return TheFabricantPrimalRave as &AnyResource{MetadataViews.Resolver}
        }
        ...
        pub fun borrowTheFabricantPrimalRave(id: UInt64): &TheFabricantPrimalRave.NFT? {
    ...
    pub resource Admin {
        ...
        pub fun setVariantSupply(
                supplyDict: {UInt64: UInt64}
            ) {
            ...
            while keys.length > 0 {
                ...
                emit AdminSetVariantSupply(
                    variantId: key,
                    name: TheFabricantPrimalRave.variants[key]!.name,
                    supply: value
                )
            }
            // Update maxSupply
        ...
        pub fun setVariantPaymentAmount(priceDict: {UInt64: UFix64}) {
            ...
            while keys.length > 0 {
                ...
                emit AdminSetVariantPaymentAmount(
                    variantId: key,
                    name: TheFabricantPrimalRave.variants[key]!.name,
                    paymentAmount: value
                )
        ...
        pub fun setMintableVariants(mintableVariants: [UInt64]) {
            ...
            emit AdminSetMintableVariants(
                mintableVariants: mintableVariants
            )
        }
        ...
        pub fun distributeDirectlyViaAccessList(
            ...
            emit ItemMintedAndTransferred(
                uuid: nft.uuid,
                id: nft.id,
                name: TheFabricantPrimalRave.nftMetadata[nft.nftMetadataId]!.name,
                description: TheFabricantPrimalRave.nftMetadata[nft.nftMetadataId]!.description,
                collection: TheFabricantPrimalRave.nftMetadata[nft.nftMetadataId]!.collection,
                editionNumber: nft.editionNumber,
        ...
        pub fun createPublicMinter(
            ...
            let publicMinter: @TheFabricantPrimalRave.PublicMinter <- create PublicMinter(
                name: name,
            ...
            TheFabricantPrimalRave.account.save(<- publicMinter, to: publicMinterStoragePath!)
            TheFabricantPrimalRave.account.link<&PublicMinter{Minter}>(publicMinterPublicPath!, target: publicMinterStoragePath!)
        }
    ...
    pub resource PublicMinter: TheFabricantNFTStandardV2.TFNFTPublicMinter, Minter {
        ...
        pub fun mintUsingAccessList(
            ...
            pre {
                ...
                TheFabricantPrimalRave.paymentReceiverCap != nil: "Payment Receiver Cap must be set for minting!"
            }
            post {
            ...
            if TheFabricantPrimalRave.addressMintLimit != nil {
                if TheFabricantPrimalRave.addressMintCount[receiver.owner!.address] != nil {
                    assert(TheFabricantPrimalRave.addressMintCount[receiver.owner!.address]! < TheFabricantPrimalRave.addressMintLimit!,
           ...
           if !self.isOpenAccess {
            ...
            if payment.balance != 0.0 || payment.balance == 0.0 {
                // pay rest to TF
                emit MintPaymentSplitDeposited(
                            address: TheFabricantPrimalRave.paymentReceiverCap!.address,
                            price: self.paymentAmount,
    ...
    // -----------------------------------------------------------------------
        ...
        access(contract) fun createNftMetadata(
            ...
            pre {
                TheFabricantPrimalRave.baseTokenURI != nil: "Base URI must be set to mint an NFT!"
            }
            ...
            var metadata: {String: String} = {
                        "mainImage": TheFabricantPrimalRave.baseTokenURI!.concat("/").concat(variantId.toString()).concat(".png"),
                        "video": TheFabricantPrimalRave.baseTokenURI!.concat("/").concat(variantId.toString()).concat(".mp4")
                    }
    ...
    pub fun getVariantSupplies(): {UInt64: {String: UInt64}} {
        ...
        while i <= UInt64(TheFabricantPrimalRave.variants.length) {
            ret[i] = {
                "maxSupply": TheFabricantPrimalRave.variants[i]!.supply, 
                "totalSupply": TheFabricantPrimalRave.variants[i]!.totalSupply
            }
            i = i + 1
        }
        return ret
    ...
    init() {
        ...
        self.account.save(<- create Admin(adminAddress: self.account.address), to: self.TheFabricantPrimalRaveAdminStoragePath)
