...
pub contract Utopian: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Utopian",
                    symbol: "UTO",
                    description: "A DAO for people who care about truth-seeking technology news",
                    externalURL: MetadataViews.ExternalURL("medium.com/utopian"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("utopianhq"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Utopian.VaultStoragePath,
                    receiverPath: Utopian.ReceiverPublicPath,
                    metadataPath: Utopian.VaultPublicPath,
                    providerPath: /private/UtopianVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Utopian", self.account.address, "UTO", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
