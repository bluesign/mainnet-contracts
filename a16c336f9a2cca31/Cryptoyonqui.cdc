...
pub contract Cryptoyonqui: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeibma5gmus4q4bxiceh23i2xvjydqbuwwexcjytfhuy7gsp7foszqm"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeih4j2ezt7gmtuzrbkus22252yee75xo5tfw5ursugatbkv5zgjjxy"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Cryptoyonqui",
                    symbol: "CYQ",
                    description: "DAO for all the cryptoyonquis",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Cryptoyonqui.VaultStoragePath,
                    receiverPath: Cryptoyonqui.ReceiverPublicPath,
                    metadataPath: Cryptoyonqui.VaultPublicPath,
                    providerPath: /private/CryptoyonquiVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Cryptoyonqui", self.account.address, "CYQ", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
