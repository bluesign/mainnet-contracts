        ...
        for key in ids.keys {
            for id in ids[key]! {
                ...
                switch key {
                    ...
                    case "ChainmonstersRewards": d = self.getChainmonstersRewardNFT(owner: owner, id: id)
                    ...
                    case "MusicBlock": d = self.getMusicBlock(owner: owner, id: id)
                    case "NyatheesOVO": d = self.getNyatheesOVO(owner: owner, id: id)
                    case "RaceDay_NFT": d = self.getRaceDay(owner: owner, id: id)
                    case "Andbox_NFT": d = self.getAndbox_NFT(owner: owner, id: id)
                    case "FantastecNFT": d = self.getFantastecNFT(owner: owner, id: id)
                    case "Everbloom": d = self.getEverbloom(owner: owner, id: id)
                    case "Domains": d = self.getFlownsDomain(owner: owner, id:id)
                    case "EternalMoment": d = self.getEternalMoment(owner: owner, id: id)
                    case "ThingFund": d = self.getCaaPass(owner: owner, id: id)
                    ...
                    case "BiscuitsNGroovy": d = self.getBiscuitsNGroovy(owner: owner, id: id)
                    case "GeniaceNFT": d = self.getGeniaceNFT(owner: owner, id: id)
                    case "Xtingles": d = self.getXtinglesNFT(owner: owner, id: id)
                    case "Beam": d = self.getBeam(owner: owner, id: id)
                    case "KOTD": d = self.getKOTD(owner: owner, id: id)
                    case "KlktnNFT": d = self.getKlktnNFT(owner: owner, id: id)
                    case "KlktnNFT2": d = self.getKlktnNFT2(owner: owner, id: id)
                    ...
                    case "OneFootballCollectible": d = self.getOneFootballCollectible(owner: owner, id: id)
                    ...
                    case "ItemNFT": d = self.getItemNFT(owner: owner, id: id)
                    case "TheFabricantS1ItemNFT": d = self.getTheFabricantS1ItemNFT(owner: owner, id: id)
                    case "ZeedzINO" : d = self.getZeedzINO(owner: owner, id: id)
                    case "Kicks" : d = self.getKicksSneaker(owner: owner, id: id)
                    ...
                    case "RacingTime": d = self.getRacingTimeNFT(owner: owner, id: id)
                    ...
                    case "DropzToken": d = self.getDropzToken(owner: owner, id: id)
