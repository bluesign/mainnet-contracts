...
pub contract EndeavorATL_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            EndeavorATL_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintEndeavorATL_NFT(
			...
			recipient.deposit(token: <-create EndeavorATL_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionEndeavorATL_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
		...
		pub fun batchMintEndeavorATL_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: EndeavorATL_NFT.CollectionStoragePath,
                        publicPath: EndeavorATL_NFT.CollectionPublicPath,
                        providerPath: /private/EndeavorATL_NFT,
                        publicCollection: Type<&EndeavorATL_NFT.Collection{EndeavorATL_NFT.EndeavorATL_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&EndeavorATL_NFT.Collection{EndeavorATL_NFT.EndeavorATL_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&EndeavorATL_NFT.Collection{EndeavorATL_NFT.EndeavorATL_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/endeavoratl/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/endeavoratl/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: EndeavorATL_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &EndeavorATL_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(EndeavorATL_NFT.CollectionPublicPath)
            .borrow<&EndeavorATL_NFT.Collection{EndeavorATL_NFT.EndeavorATL_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&EndeavorATL_NFT.Admin>(
