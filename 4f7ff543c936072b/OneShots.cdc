  ...
  pub resource NFT: NonFungibleToken.INFT, TiblesNFT.INFT, MetadataViews.Resolver {
    ...
    pub fun displayData(): {String: String} {
      ...
      if (metadata.containsKey("pack")) {
        return {
          "name": "OneShots pack",
          "description": "A OneShots pack",
          "imageUrl": "https://i.tibles.com/m/oneshots-flow-icon.png"
        }
      }
    ...
    pub fun nftCollectionData(): MetadataViews.NFTCollectionData {
      return MetadataViews.NFTCollectionData(
        storagePath: OneShots.CollectionStoragePath,
        publicPath: OneShots.PublicCollectionPath,
        providerPath: /private/OneShotsCollection,
        publicCollection: Type<&OneShots.Collection{TiblesNFT.CollectionPublic}>(),
        publicLinkedType:   Type<&OneShots.Collection{TiblesNFT.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
        providerLinkedType: Type<&OneShots.Collection{TiblesNFT.CollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,MetadataViews.ResolverCollection}>(),
        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
            return <-OneShots.createEmptyCollection()
        })
      )
    }
    ...
    pub fun nftCollectionDisplay(): MetadataViews.NFTCollectionDisplay {
      let squareMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/oneshots-flow-icon.png"),
        mediaType: "image/svg+xml"
      )
      let bannerMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/oneshots-flow-collection-banner.png"),
        mediaType: "image/png"
      )
      ...
      return MetadataViews.NFTCollectionDisplay(
        name: "OneShots Comic Book Trading Cards by Tibles",
        description: "OneShots is a digital trading card collecting experience by Tibles, made just for comic book fans, backed by the FLOW blockchain.",
        externalURL: MetadataViews.ExternalURL("https://app.oneshots.com"),
