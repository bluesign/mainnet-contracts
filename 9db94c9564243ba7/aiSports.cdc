...
pub contract aiSports: FungibleToken, ViewResolver {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver {
        ...
        destroy() {
            if (self.balance > 0.0) {
                ...
                aiSports.totalSupply = aiSports.totalSupply - self.balance
            }
        }
    }
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreigrikrk4elp6p73gs6hqwpkxbirvem6wa4pudvvvcs5fnw5o6oitq"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeihtaxncgc4643wu6czkrdsylffm4b7b4y6quyzcdv43vmxkykbwoe"
                    ),
                    mediaType: "image"
                )
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: aiSports.VaultStoragePath,
                    receiverPath: aiSports.ReceiverPublicPath,
                    metadataPath: aiSports.VaultPublicPath,
                    providerPath: /private/aiSportsVault,
                    ...
                    createEmptyVaultFunction: (fun (): @Vault {
                        return <- aiSports.createEmptyVault()
                    })
                )
        }
        return nil
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("aiSports", self.account.address, "JUICE", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
