...
pub contract aiSportsJuice: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    ...
                    providerPath: /private/aiSportsJuiceVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("aiSportsJuice", self.account.address, "JUICE", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
