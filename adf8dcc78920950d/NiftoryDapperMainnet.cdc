...
pub contract NiftoryDapperMainnet: NonFungibleToken, ViewResolver {
    ...
    NiftoryNonFungibleToken.NFTPublic
  {
    ...
    init(setId: Int, templateId: Int, serial: UInt64) {
      ...
      NiftoryDapperMainnet.totalSupply =
        NiftoryDapperMainnet.totalSupply + 1
      self.setId = setId
    ...
    NiftoryNonFungibleToken.ManagerPrivate
  {
      ...
      &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public}
    {
      return NiftoryNFTRegistry
        .getSetManagerPublic(
          NiftoryDapperMainnet.REGISTRY_ADDRESS,
          NiftoryDapperMainnet.REGISTRY_BRAND
        )
    }
  ...
  init(
    ...
    let record = NiftoryNFTRegistry.generateRecord(
      ...
      project: "clbbadhlr00130flbq4in3lq1_NiftoryDapperMainnet"
    )
    ...
    self
      ...
      .save<@MutableMetadataSetManager.Manager>(
        <-MutableMetadataSetManager.create(
          name: "NiftoryDapperMainnet",
          description: "The set manager for NiftoryDapperMainnet."
        ),
