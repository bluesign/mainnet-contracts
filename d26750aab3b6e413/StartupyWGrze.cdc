 ...
 */
pub contract StartupyWGrze: NonFungibleToken, CollecticoStandardNFT, CollectionResolver {
            ...
            switch view {
                case Type<CollecticoStandardViews.ItemView>():
                    return CollecticoStandardViews.ItemView(
                        ...
                        contractInfo: StartupyWGrze.getContractInfo(),
                        collectionDisplay: StartupyWGrze.getCollectionDisplay(),
                        royalties: MetadataViews.getRoyalties(&self as &StartupyWGrze.Item{MetadataViews.Resolver}),
                        display: MetadataViews.getDisplay(&self as &StartupyWGrze.Item{MetadataViews.Resolver}),
                        traits: MetadataViews.getTraits(&self as &StartupyWGrze.Item{MetadataViews.Resolver}),
                        medias: MetadataViews.getMedias(&self as &StartupyWGrze.Item{MetadataViews.Resolver}),
                        license: MetadataViews.getLicense(&self as &StartupyWGrze.Item{MetadataViews.Resolver})
                    )
                case Type<CollecticoStandardViews.ContractInfo>():
            ...
            switch view {
                case Type<CollecticoStandardViews.NFTView>():
                    return CollecticoStandardViews.NFTView(
                        ...
                        contractInfo: StartupyWGrze.getContractInfo(),
                        collectionDisplay: StartupyWGrze.getCollectionDisplay(),
                        royalties: MetadataViews.getRoyalties(&self as &StartupyWGrze.NFT{MetadataViews.Resolver}),
                        display: MetadataViews.getDisplay(&self as &StartupyWGrze.NFT{MetadataViews.Resolver}),
                        traits: MetadataViews.getTraits(&self as &StartupyWGrze.NFT{MetadataViews.Resolver}),
                        editions: MetadataViews.getEditions(&self as &StartupyWGrze.NFT{MetadataViews.Resolver}),
                        medias: MetadataViews.getMedias(&self as &StartupyWGrze.NFT{MetadataViews.Resolver}),
                        license: MetadataViews.getLicense(&self as &StartupyWGrze.NFT{MetadataViews.Resolver})
                    )
                case Type<CollecticoStandardViews.ContractInfo>():
                    return StartupyWGrze.getContractInfo()
                case Type<MetadataViews.Display>():
                ...
                case Type<MetadataViews.License>():
                    return MetadataViews.getLicense(item as &StartupyWGrze.Item{MetadataViews.Resolver})
                case Type<MetadataViews.ExternalURL>():
                    return StartupyWGrze.getExternalURL()
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return StartupyWGrze.getCollectionDisplay()
    ...
    pub resource interface CollectionPublic {
        ...
        pub fun borrowCollecticoNFT(id: UInt64): &StartupyWGrze.NFT? {
            post {
    ...
    pub fun getCollectionData() : MetadataViews.NFTCollectionData {
        return MetadataViews.NFTCollectionData(
            ...
            publicCollection: Type<&StartupyWGrze.Collection{StartupyWGrze.CollectionPublic}>(),
            publicLinkedType: Type<&StartupyWGrze.Collection{StartupyWGrze.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
            providerLinkedType: Type<&StartupyWGrze.Collection{StartupyWGrze.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
            createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                return <-StartupyWGrze.createEmptyCollection()
            })
        )
    }
    ...
    pub resource Admin {
        ...
        pub fun createItem(
            ...
            StartupyWGrze.items[newItemId] <-! create Item(
                id: newItemId,
                name: name,
        ...
        pub fun deleteItem(itemId: UInt64) {
            pre {
                StartupyWGrze.items[itemId] != nil: "Item doesn't exist"
        ...
        pub fun mintNFT(itemId: UInt64, isTransferable: Bool?, metadata: {String: AnyStruct}?): @NFT {
            pre {
                StartupyWGrze.items[itemId] != nil: "Item doesn't exist"
                !StartupyWGrze.isItemLocked(itemId: itemId): "Item is locked and cannot be minted anymore"
            }
            post {
                StartupyWGrze.isItemSupplyValid(itemId: itemId): "Max supply reached- cannot mint more NFTs of this type"
            }
            let item = StartupyWGrze.getItemRef(itemId: itemId)
        ...
        pub fun mintAndClaim(itemId: UInt64, claimId: String, isTransferable: Bool?, metadata: {String: AnyStruct}?): @NFT {
            pre {
                !StartupyWGrze.claims.containsKey(claimId): "Item already claimed"
            }
            post {
                StartupyWGrze.claims.containsKey(claimId): "Claim failed"
            }
    ...
    init() {
        ...
        self.metadata = {
            "name": "Startupy w Grze",
            "description": "Zestaw kart kolekcjonerskich upamiętniających udział w programie 'Startupy w grze' zorganizowanym przez PZPN Invest, Rebels Valley i NASK. Program ten jest skierowany do polskich i międzynarodowych startupów wspierających piłkę nożną przy pomocy tworzonych i rozwijanych przez siebie nowoczesnych technologii. W skład kolekcji wchodzą karty potwierdzające zaaplikowanie i dostanie się do poszczególnych etapów, jak też pamiątkowe karty dla uczestników Demo Days oraz wspierających program osób i organizacji.",
            "externalURL": MetadataViews.ExternalURL("https://startupywgrze.pzpn.pl"),
            "squareImage": MetadataViews.Media(
                file: MetadataViews.IPFSFile(
                    cid: "bafybeiaypf5it2qkvhyzmmkro5oaaclkgmggzcn2rr436yriyr6ame2spa",
                    path: "square.png"
                ),
                mediaType: "image/png"
            ),
            ...
            "socials": {
                "twitter": MetadataViews.ExternalURL("https://twitter.com/LaczyNasPilka")
            }
        }
        ...
        self.account.link<&StartupyWGrze.Collection{NonFungibleToken.CollectionPublic, StartupyWGrze.CollectionPublic, MetadataViews.ResolverCollection}>(
