...
pub contract RTLStoreItem: NonFungibleToken {
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let mediaSquare = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://dkuxa1i6sgo8h.cloudfront.net/sisi/Sisi-square-whitebackground-small.png"
                        ),
                        mediaType: "image/png"
                    )
                    let mediaBanner = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://dkuxa1i6sgo8h.cloudfront.net/sisi/Sisi+banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    let url = "https://wallet.sisi-nft.de/";
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return  MetadataViews.NFTCollectionData(
                        storagePath: RTLStoreItem.CollectionStoragePath,
                        publicPath: RTLStoreItem.CollectionPublicPath,
                        providerPath: /private/RTLStoreItemCollection,
                        publicCollection: Type<&RTLStoreItem.Collection{RTLStoreItem.RTLStoreItemCollectionPublic}>(),
                        publicLinkedType: Type<&RTLStoreItem.Collection{RTLStoreItemCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&RTLStoreItem.Collection{RTLStoreItemCollectionPublic,NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
    ...
    pub resource Admin {
        ...
        pub fun borrowEdition(editionID: UInt32): &Edition {
            pre {
                RTLStoreItem.editions[editionID] != nil: "Cannot borrow Edition: it does not exist"
            }
    ...
    pub resource Collection: RTLStoreItemCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection { 
        ...
        pub fun withdraw(withdrawID: UInt64): @NonFungibleToken.NFT {
            ...
            let token <- self.ownedNFTs.remove(key: withdrawID) 
                ?? panic("Cannot withdraw: RTLStoreItem does not exist in the collection")
