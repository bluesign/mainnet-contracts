...
pub contract Trash: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreifi6y2qbnaq4zm3gz2npgvvunrtbrjxqufav7fyxzxkiws2rfk3wa"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Trash",
                    symbol: "TRASH",
                    description: "Everyone has some trash.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Trash.VaultStoragePath,
                    receiverPath: Trash.ReceiverPublicPath,
                    metadataPath: Trash.VaultPublicPath,
                    providerPath: /private/TrashVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Trash", self.account.address, "TRASH", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
