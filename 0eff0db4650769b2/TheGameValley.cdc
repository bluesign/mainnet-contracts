...
pub contract TheGameValley: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreih4bte65ty7ke6uz4gasx37wpn6qmbrjkpsaa75ef4na3rfe7ildy"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafkreifb43kwtsuylnes47dez7pp6t7pp5zmikaka2damlz6orab6ruywu"
                    ),
                    mediaType: "image"
                )
                let medias = MetadataViews.Medias([media, bannerMedia])
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "The Game Valley",
                    symbol: "GAME",
                    description: "Explore the vast and beautiful game world of The Game Valley using the power of Flow BlockChain",
                    externalURL: MetadataViews.ExternalURL("ecdao.org"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("emerald_dao"),
                        "discord": MetadataViews.ExternalURL("emerald-city")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: TheGameValley.VaultStoragePath,
                    receiverPath: TheGameValley.ReceiverPublicPath,
                    metadataPath: TheGameValley.VaultPublicPath,
                    providerPath: /private/TheGameValleyVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("TheGameValley", self.account.address, "GAME", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
