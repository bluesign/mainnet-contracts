...
pub contract GUACAMOLE: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeidqzlabeeexzcchyfyuy7x7zwoxqfcu3pcwihnjrdfadm3akzaeaa"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeig2n5ibboqhw2u7qhzvaf2pwpa2f2d7hfmm6zogmzly5lzzyggsl4"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "GUACAMOLE",
                    symbol: "GUAC",
                    description: "BUY THE DIP! BUY THE DIP!",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: GUACAMOLE.VaultStoragePath,
                    receiverPath: GUACAMOLE.ReceiverPublicPath,
                    metadataPath: GUACAMOLE.VaultPublicPath,
                    providerPath: /private/GUACAMOLEVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("GUACAMOLE", self.account.address, "GUAC", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
