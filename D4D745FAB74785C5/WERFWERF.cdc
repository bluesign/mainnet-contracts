...
pub contract WERFWERF: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeihppkuy3dhzuqz2ekfxs4jusxf5562vb6hpzrjzokm6rzoifvyymi"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeifkqnfqrerhrgoja62n6yxvgcmdskjrgvjkl6jsqooalo2ragoeuu"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "WERFWERF",
                    symbol: "WERF",
                    description: "Fuck $BEAVER, choose $WERF instead.@werfonflow",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: WERFWERF.VaultStoragePath,
                    receiverPath: WERFWERF.ReceiverPublicPath,
                    metadataPath: WERFWERF.VaultPublicPath,
                    providerPath: /private/WERFWERFVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("WERFWERF", self.account.address, "WERF", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
