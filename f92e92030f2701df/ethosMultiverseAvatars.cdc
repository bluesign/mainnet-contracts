...
pub contract ethosMultiverseAvatars: NonFungibleToken {
      ...
      switch view {
          ...
          case Type<MetadataViews.NFTCollectionData>():
            return MetadataViews.NFTCollectionData(
                storagePath: ethosMultiverseAvatars.CollectionStoragePath,
                publicPath: ethosMultiverseAvatars.CollectionPublicPath,
                providerPath: ethosMultiverseAvatars.CollectionPrivatePath,
          ...
          case Type<MetadataViews.NFTCollectionDisplay>():
            let squareMedia: MetadataViews.Media = MetadataViews.Media(
              file: ethosMultiverseAvatars.getCollectionAttribute(key: "image") as! MetadataViews.HTTPFile,
              mediaType: "image"
            )
            ...
            return MetadataViews.NFTCollectionDisplay(
              name: ethosMultiverseAvatars.getCollectionAttribute(key: "name") as! String,
              description: ethosMultiverseAvatars.getCollectionAttribute(key: "description") as! String,
              externalURL: MetadataViews.ExternalURL("https://jade.ethosnft.com/collections/".concat(self.owner!.address.toString()).concat("/ethosMultiverseAvatars")),
              squareImage: squareMedia,
              bannerImage: bannerMedia ?? squareMedia,
              socials: ethosMultiverseAvatars.getCollectionAttribute(key: "socials") as! {String: MetadataViews.ExternalURL}
            )
          case Type<MetadataViews.Royalties>():
            return MetadataViews.Royalties([
              ...
              MetadataViews.Royalty(
                receiver: getAccount(0xf92e92030f2701df).getCapability<&FlowToken.Vault{FungibleToken.Receiver}>(/public/flowTokenReceiver),
  ...
  init(_collectionName: String, _description: String, _imagePath: String, _bannerImagePath: String?, _minting: Bool, _ipfsCID: String) {
    ...
    self.account.link<&ethosMultiverseAvatars.Collection{NonFungibleToken.CollectionPublic, ethosMultiverseAvatars.CollectionPublic, MetadataViews.ResolverCollection}>(
