...
pub contract art : NonFungibleToken {
    ...
    init() {
        ...
        self.account.link<&art.Collection{NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, art._NFT_NAME_CollectionPublic, MetadataViews.ResolverCollection}>(
