...
pub contract Meowow: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeidmyttrxfeufx7nnix4szbnjpldv3viqw5jk4hlhielcks7m6rfay"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeigsudeidkvy7kx4h36liea7cdu3oav3silh3kbn3uddohsbpxreca"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Meowow",
                    symbol: "MEOW",
                    description: "Welcome to the world of Meowow! Meowow is a unique and playful meme coin on the Flow blockchain",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Meowow.VaultStoragePath,
                    receiverPath: Meowow.ReceiverPublicPath,
                    metadataPath: Meowow.VaultPublicPath,
                    providerPath: /private/MeowowVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Meowow", self.account.address, "MEOW", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
