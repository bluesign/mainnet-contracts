...
pub contract CarClubMainStorefront {
    ...
    pub resource Listing: ListingPublic {
        ...
        pub fun purchase(payment: @FungibleToken.Vault, collection: &NonFungibleToken.Collection{NonFungibleToken.Receiver}) {
            pre {
                self.details.purchased == false: "This listing has already been purchased."
                payment.balance >= self.details.salePrice: "Insufficient funds to purchase the listing."
            }
            ...
            emit ListingCompleted(
                ...
                nftIDs: self.details.nftIDs // Emitting all NFT IDs involved in the listing
            )
        }
