...
pub contract appstoretest8_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            appstoretest8_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintappstoretest8_NFT(
			...
			recipient.deposit(token: <-create appstoretest8_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
		...
		// and deposits it in the recipients collection using their collection reference
        //
	    pub fun mintEditionappstoretest8_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            tokenId: UInt64,
            setId: UInt32,
            edition: UInt32) {
		...
		pub fun batchMintappstoretest8_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: appstoretest8_NFT.CollectionStoragePath,
                        publicPath: appstoretest8_NFT.CollectionPublicPath,
                        providerPath: /private/appstoretest8_NFT,
                        publicCollection: Type<&appstoretest8_NFT.Collection{appstoretest8_NFT.appstoretest8_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&appstoretest8_NFT.Collection{appstoretest8_NFT.appstoretest8_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&appstoretest8_NFT.Collection{appstoretest8_NFT.appstoretest8_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/appstoretest8/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/appstoretest8/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: appstoretest8_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &appstoretest8_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(appstoretest8_NFT.CollectionPublicPath)
            .borrow<&appstoretest8_NFT.Collection{appstoretest8_NFT.appstoretest8_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&appstoretest8_NFT.Admin>(
