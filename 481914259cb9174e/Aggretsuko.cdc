  ...
  pub resource NFT: NonFungibleToken.INFT, TiblesNFT.INFT, MetadataViews.Resolver {
    ...
    pub fun displayData(): {String: String} {
      ...
      if (metadata.containsKey("pack")) {
        return {
          "name": "Aggretsuko pack",
          "description": "A Aggretsuko pack",
          "imageUrl": "https://i.tibles.com/m/aggretsuko-flow-icon.png"
        }
      }
    ...
    pub fun nftCollectionData(): MetadataViews.NFTCollectionData {
      return MetadataViews.NFTCollectionData(
        ...
        publicCollection: Type<&Aggretsuko.Collection{TiblesNFT.CollectionPublic}>(),
        publicLinkedType:   Type<&Aggretsuko.Collection{TiblesNFT.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
        providerLinkedType: Type<&Aggretsuko.Collection{TiblesNFT.CollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,MetadataViews.ResolverCollection}>(),
    ...
    pub fun nftCollectionDisplay(): MetadataViews.NFTCollectionDisplay {
      let squareMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/aggretsuko-flow-icon.png"),
        mediaType: "image/svg+xml"
      )
      let bannerMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/aggretsuko-flow-collection-banner.png"),
        mediaType: "image/png"
      )
      ...
      return MetadataViews.NFTCollectionDisplay(
        ...
        externalURL: MetadataViews.ExternalURL("https://aggretsuko.tibles.com"),
