...
pub contract FastBreak: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeibl6oqxri2bbnfwh7k5ybzjd2spy6yj65qkvzofxins5pp3fxm5be"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeicvc4bffmgp3l3hti2kve23imawtpo37tvnxvs4z3223ztd6hvkfe"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "FastBreak",
                    symbol: "FBRK",
                    description: "This is a DAO for NBA Top Shot Fast Break (unofficial)",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: FastBreak.VaultStoragePath,
                    receiverPath: FastBreak.ReceiverPublicPath,
                    metadataPath: FastBreak.VaultPublicPath,
                    providerPath: /private/FastBreakVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("FastBreak", self.account.address, "FBRK", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
