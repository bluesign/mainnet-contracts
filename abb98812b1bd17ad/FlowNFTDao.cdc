...
pub contract FlowNFTDao: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Flow NFT Dao",
                    symbol: "FNFT",
                    description: "Flow NFT Dao Community",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: FlowNFTDao.VaultStoragePath,
                    receiverPath: FlowNFTDao.ReceiverPublicPath,
                    metadataPath: FlowNFTDao.VaultPublicPath,
                    providerPath: /private/FlowNFTDaoVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("FlowNFTDao", self.account.address, "FNFT", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
