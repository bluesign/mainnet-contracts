...
pub contract space: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "space",
                    symbol: "SPC",
                    description: "for the crypto world",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: space.VaultStoragePath,
                    receiverPath: space.ReceiverPublicPath,
                    metadataPath: space.VaultPublicPath,
                    providerPath: /private/spaceVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("space", self.account.address, "SPC", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
