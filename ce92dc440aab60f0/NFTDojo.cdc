...
pub contract NFTDojo: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafybeihx2ajgenmkdhuywqfeatnblqiwcqbsdi2wfejnk2eepk3noucw2a"
                    ),
                    mediaType: "image"
                )
                let bannerMedia = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                        url: "https://nftstorage.link/ipfs/bafybeigwp3m77fzo6dx3ks5wf3e3t2sa3pxcncfkwipu2m6ojfi5lvm6ci"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "NFT Dojo",
                    symbol: "TBR",
                    description: "NFTや暗号通貨について、勉強します",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: NFTDojo.VaultStoragePath,
                    receiverPath: NFTDojo.ReceiverPublicPath,
                    metadataPath: NFTDojo.VaultPublicPath,
                    providerPath: /private/NFTDojoVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("NFTDojo", self.account.address, "TBR", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
