...
pub contract NFTKred : NonFungibleToken{
            ...
            switch view {
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: NFTKred.CollectionStoragePath,
                        publicPath: NFTKred.CollectionPublicPath,
                        providerPath: /private/NFTKredCollection,
                        publicCollection: Type<&NFTKred.Collection{NFTKred.NFTKredCollectionPublic}>(),
                        publicLinkedType: Type<&NFTKred.Collection{NFTKred.NFTKredCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&NFTKred.Collection{NFTKred.NFTKredCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
	...
	init() {
        ...
        self.account.link<&{NFTKred.NFTKredCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(
