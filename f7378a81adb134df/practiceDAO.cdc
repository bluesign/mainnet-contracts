...
pub contract practiceDAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreieiwk4kdznclh5o25d3dkay2regf6fdqhxwsscssv6jmfdc2ijvuq"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "practiceDAO",
                    symbol: "PDAO",
                    description: "This is just a test DAO",
                    externalURL: MetadataViews.ExternalURL(""),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("inspiredbymamba"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: practiceDAO.VaultStoragePath,
                    receiverPath: practiceDAO.ReceiverPublicPath,
                    metadataPath: practiceDAO.VaultPublicPath,
                    providerPath: /private/practiceDAOVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("practiceDAO", self.account.address, "PDAO", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
