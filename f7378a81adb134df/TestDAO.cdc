...
pub contract TestDAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "TestDAO",
                    symbol: "TSDO",
                    description: "This is a test DAO, feel free to disregard this.",
                    externalURL: MetadataViews.ExternalURL("justatest"),
                    logos: medias,
                    socials: {
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: TestDAO.VaultStoragePath,
                    receiverPath: TestDAO.ReceiverPublicPath,
                    metadataPath: TestDAO.VaultPublicPath,
                    providerPath: /private/TestDAOVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("TestDAO", self.account.address, "TSDO", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
