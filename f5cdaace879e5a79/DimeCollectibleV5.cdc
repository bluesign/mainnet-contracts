...
pub contract DimeCollectibleV5: NonFungibleToken {
			...
			switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: DimeCollectibleV5.CollectionStoragePath,
                        publicPath: DimeCollectibleV5.CollectionPublicPath,
                        providerPath: DimeCollectibleV5.CollectionPrivatePath,
                        publicCollection: Type<&DimeCollectibleV5.Collection{DimeCollectibleV5.DimeCollectionPublic}>(),
                        publicLinkedType: Type<&DimeCollectibleV5.Collection{DimeCollectibleV5.DimeCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&DimeCollectibleV5.Collection{DimeCollectibleV5.DimeCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Provider, MetadataViews.ResolverCollection}>(),
	...
	pub resource NFTMinter {
		...
		pub fun mintNFTs(collection: &{DimeCollectibleV5.DimeCollectionPublic}, name: String,
			...
			while counter <= numCopies {
				...
				collection.deposit(token: <- create DimeCollectibleV5.NFT(
		...
		pub fun mintRoyaltyNFTs(collection: &{DimeCollectibleV5.DimeCollectionPublic}, name: String,
			description: String,blueprintId: UInt64, numCopies: UInt64, creators: [Address],
		...
		pub fun mintReleaseNFTs(collection: &{DimeCollectibleV5.DimeCollectionPublic}, name: String,
			description: String, blueprintId: UInt64, numCopies: UInt64, creators: [Address],
			content: String, hiddenContent: String?, tradeable: Bool,
			previousHistory:[Transaction]?, royalties: MetadataViews.Royalties,
			initialSale: Transaction?) {
