...
pub contract STARS: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreigultlrtfrx64556pqcauvz2rgtusvgglpwwpqbgqwegeur4idpeu"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "STAR$",
                    symbol: "STARS",
                    description: "Forever reaching for the stars",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: STARS.VaultStoragePath,
                    receiverPath: STARS.ReceiverPublicPath,
                    metadataPath: STARS.VaultPublicPath,
                    providerPath: /private/STARSVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("STARS", self.account.address, "STARS", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
