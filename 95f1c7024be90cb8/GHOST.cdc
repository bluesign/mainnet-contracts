...
pub contract GHOST: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                let media = MetadataViews.Media(
                        ...
                        url: "https://nftstorage.link/ipfs/bafkreibx7gmgudp734t6bih3vfrecoryfhuuie4hwz35n44f2kxtghaske"
                    ),
                    mediaType: "image"
                )
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "$GHOST",
                    symbol: "GHOST",
                    description: "The GHOST emerges as a luminous beacon,",
                    externalURL: MetadataViews.ExternalURL("ninjapanda.io/"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("https://twitter.com/N1NJ4P4ND410"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: GHOST.VaultStoragePath,
                    receiverPath: GHOST.ReceiverPublicPath,
                    metadataPath: GHOST.VaultPublicPath,
                    providerPath: /private/GHOSTVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("GHOST", self.account.address, "GHOST", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
