...
pub contract BWAYX_NFT: NonFungibleToken {
	...
	pub resource Series {
        ...
        init(
            ...
            BWAYX_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )
	    ...
	    pub fun mintBWAYX_NFT(
			...
			recipient.deposit(token: <-create BWAYX_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        name: BWAYX_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: BWAYX_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        thumbnail: MetadataViews.HTTPFile(
                            url: BWAYX_NFT.getSetMetadataByField(setId: self.setId, field: "preview")!
                        )
                    )
                            ...
                            if metadataKey.slice(from: 0, upTo: 13) == "royalty_addr_" {
                                ...
                                if cutValue != 0.0 {
                                    royalties.append(MetadataViews.Royalty(
                                        ...
                                        cut: cutValue,
                                        description: BWAYX_NFT.getSetMetadataByField(setId: self.setId, field: "royalty_desc_".concat(royaltyName))!
                                    )
                                    )
                                }
                            }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: BWAYX_NFT.CollectionStoragePath,
                        publicPath: BWAYX_NFT.CollectionPublicPath,
                        providerPath: /private/BWAYX_NFT,
                        publicCollection: Type<&BWAYX_NFT.Collection{BWAYX_NFT.BWAYX_NFTCollectionPublic,NonFungibleToken.CollectionPublic}>(),
                        publicLinkedType: Type<&BWAYX_NFT.Collection{BWAYX_NFT.BWAYX_NFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&BWAYX_NFT.Collection{BWAYX_NFT.BWAYX_NFTCollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/bwayx/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/bwayx/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: BWAYX_NFT.getSetMetadataByField(setId: self.setId, field: "collection_name") ?? "",
                        description: BWAYX_NFT.getSetMetadataByField(setId: self.setId, field: "collection_description") ?? "",
                        externalURL: MetadataViews.ExternalURL(BWAYX_NFT.getSetMetadataByField(setId: self.setId, field: "external_url") ?? ""),
                ...
                case Type<MetadataViews.Medias>():
                    return MetadataViews.Medias(
                        items: [
                            MetadataViews.Media(
                                file: MetadataViews.HTTPFile(
                                    url: BWAYX_NFT.getSetMetadataByField(setId: self.setId, field: "image")!
                                ),
    ...
    pub fun fetch(_ from: Address, id: UInt64): &BWAYX_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(BWAYX_NFT.CollectionPublicPath)
            .borrow<&BWAYX_NFT.Collection{BWAYX_NFT.BWAYX_NFTCollectionPublic}>()
	...
	init() {
        ...
        self.account.link<&BWAYX_NFT.Admin>(
