...
pub contract UntoldPerksNFT: NonFungibleToken, ViewResolver {
    ...
    NiftoryNonFungibleToken.NFTPublic
  {
    ...
    init(setId: Int, templateId: Int, serial: UInt64) {
      ...
      UntoldPerksNFT.totalSupply =
        UntoldPerksNFT.totalSupply + 1
      self.setId = setId
    ...
    NiftoryNonFungibleToken.ManagerPrivate
  {
      ...
      &MutableMetadataSetManager.Manager{MutableMetadataSetManager.Public}
    {
      return NiftoryNFTRegistry
        .getSetManagerPublic(
          UntoldPerksNFT.REGISTRY_ADDRESS,
          UntoldPerksNFT.REGISTRY_BRAND
        )
    }
  ...
  init(
    ...
    let record = NiftoryNFTRegistry.generateRecord(
      ...
      project: "clj2vcxgd0002la0v5tzaibz0_UntoldPerksNFT"
    )
    ...
    self
      ...
      .save<@MutableMetadataSetManager.Manager>(
        <-MutableMetadataSetManager.create(
          name: "UntoldPerksNFT",
          description: "The set manager for UntoldPerksNFT."
        ),
