  ...
  TiblesProducer
{
  ...
  pub resource NFT: NonFungibleToken.INFT, TiblesNFT.INFT, MetadataViews.Resolver {
    ...
    pub fun displayData(): {String: String} {
      ...
      if (metadata.containsKey("pack")) {
        return {
          "name": "FraggleRock pack",
          "description": "A FraggleRock pack",
          "imageUrl": "https://i.tibles.com/m/fragglerock-flow-icon.png"
        }
      }
    ...
    pub fun externalURL(): MetadataViews.ExternalURL {
      return MetadataViews.ExternalURL("https://fragglerock.tibles.com/collection".concat(self.id.toString()))
    }
    ...
    pub fun nftCollectionData(): MetadataViews.NFTCollectionData {
      return MetadataViews.NFTCollectionData(
        ...
        publicCollection: Type<&FraggleRock.Collection{TiblesNFT.CollectionPublic}>(),
        publicLinkedType:   Type<&FraggleRock.Collection{TiblesNFT.CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
        providerLinkedType: Type<&FraggleRock.Collection{TiblesNFT.CollectionPublic,NonFungibleToken.Provider,NonFungibleToken.CollectionPublic,MetadataViews.ResolverCollection}>(),
    ...
    pub fun nftCollectionDisplay(): MetadataViews.NFTCollectionDisplay {
      let squareMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/fragglerock-flow-icon.png"),
        mediaType: "image/svg+xml"
      )
      let bannerMedia = MetadataViews.Media(
        file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/fragglerock-flow-collection-banner.png"),
        mediaType: "image/png"
      )
      ...
      return MetadataViews.NFTCollectionDisplay(
        ...
        externalURL: MetadataViews.ExternalURL("https://fragglerock.tibles.com"),
  ...
  pub resource PackMinter: TiblesProducer.IContent{
    ...
    pub fun createNewPackMinter(id: String, contentCapability: Capability): @PackMinter {
      assert(self.account.address == 0x848d8db862439fc6, message: "wrong address")
  ...
  init() {
    ...
    self.description = "Fraggle Rock officially licensed digital collectibles"
