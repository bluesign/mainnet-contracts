...
pub contract Crayon_Shinchan_2023: NonFungibleToken, Anique {
    // -----------------------------------------------------------------------
    // Crayon_Shinchan_2023 contract Events
    // -----------------------------------------------------------------------

    // Events for Contract-Related actions
    //
    // Emitted when the Crayon_Shinchan_2023 contract is created
    ...
    // -----------------------------------------------------------------------
    // Crayon_Shinchan_2023 contract-level fields.
    ...
    // -----------------------------------------------------------------------
    // Crayon_Shinchan_2023 contract-level Composite Type definitions
    // -----------------------------------------------------------------------

    // The structure that represents Item
    // each digital content which Crayon_Shinchan_2023 deal with on Flow
    //
    pub struct ItemData {
        ...
        init(itemID: UInt32) {
            let item = (&Crayon_Shinchan_2023.items[itemID] as &Item?)!
    ...
    pub resource Item {
        ...
        init(metadata: {String: String}) {
            ...
            self.itemID = Crayon_Shinchan_2023.nextItemID
            self.metadata = metadata
            self.numberMintedPerItem = 0

            // increment the nextItemID so that it isn't used again
            Crayon_Shinchan_2023.nextItemID = Crayon_Shinchan_2023.nextItemID + 1
    ...
    pub resource NFT: NonFungibleToken.INFT, Anique.INFT {
        ...
        init(serialNumber: UInt32, itemID: UInt32) {
            ...
            Crayon_Shinchan_2023.totalSupply = Crayon_Shinchan_2023.totalSupply + 1

            // set id
            self.id = Crayon_Shinchan_2023.totalSupply
    ...
    // interface that represents Crayon_Shinchan_2023 collections to public
    ...
    pub resource interface CollectionPublic {
        ...
        // borrow NFT as Crayon_Shinchan_2023 token
        pub fun borrowCrayon_Shinchan_2023Collectible(id: UInt64): auth &NFT
    }
    ...
    pub resource Collection: CollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.Provider, NonFungibleToken.CollectionPublic {
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            ...
            // Cast the deposited token as an Crayon_Shinchan_2023 NFT to make sure
            // it is the correct type
            let token <- token as! @Crayon_Shinchan_2023.NFT
        ...
        // not any Crayon_Shinchan_2023 specific data. Please use borrowCollectible to
        ...
        // borrowCrayon_Shinchan_2023Collectible returns a borrowed reference
        // to an Crayon_Shinchan_2023 Collectible
        pub fun borrowCrayon_Shinchan_2023Collectible(id: UInt64): auth &NFT {
            pre {
    ...
    pub resource Admin {
        ...
        // and stores it in the Items dictionary field in the Crayon_Shinchan_2023 smart contract
        //
        ...
        pub fun createItem(metadata: {String: String}): UInt32 {
            ...
            Crayon_Shinchan_2023.items[newItem.itemID] <-! newItem

            return itemId
        }

        // borrowItem returns a reference to a Item in the Crayon_Shinchan_2023
        ...
        pub fun borrowItem(itemID: UInt32): &Item {
            pre {
                Crayon_Shinchan_2023.items[itemID] != nil: "Cannot borrow Item: The Item doesn't exist"
            }

            return (&Crayon_Shinchan_2023.items[itemID] as &Item?)!
        }
    ...
    // -----------------------------------------------------------------------
    // Crayon_Shinchan_2023 contract-level function definitions
    // -----------------------------------------------------------------------
    ...
    pub fun createEmptyCollection(): @NonFungibleToken.Collection {
        return <-create Crayon_Shinchan_2023.Collection()
    }
    ...
    // -----------------------------------------------------------------------
    // Crayon_Shinchan_2023 initialization function
    // -----------------------------------------------------------------------
    //
    init() {
        ...
        self.collectionStoragePath     = /storage/Crayon_Shinchan_2023Collection
        self.collectionPublicPath      =  /public/Crayon_Shinchan_2023Collection
        self.collectionPrivatePath     = /private/Crayon_Shinchan_2023Collection
        self.adminStoragePath          = /storage/Crayon_Shinchan_2023Admin
        self.saleCollectionStoragePath = /storage/Crayon_Shinchan_2023SaleCollection
        self.saleCollectionPublicPath  =  /public/Crayon_Shinchan_2023SaleCollection
