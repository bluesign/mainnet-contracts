...
pub contract EcoSeed: FungibleToken, ViewResolver {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance, MetadataViews.Resolver {
        ...
        destroy() {
            if (self.balance > 0.0) {
                ...
                EcoSeed.totalSupply = EcoSeed.totalSupply - self.balance
            }
        }
    }
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "EcoSeed",
                    symbol: "EST",
                    description: " A DAO concentrating on seeding and nurturing eco-friendly initiatives, particularly tree planting and reforestation efforts.",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: EcoSeed.VaultStoragePath,
                    receiverPath: EcoSeed.ReceiverPublicPath,
                    metadataPath: EcoSeed.VaultPublicPath,
                    providerPath: /private/EcoSeedVault,
                    ...
                    createEmptyVaultFunction: (fun (): @Vault {
                        return <- EcoSeed.createEmptyVault()
                    })
                )
        }
        return nil
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("EcoSeed", self.account.address, "EST", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
