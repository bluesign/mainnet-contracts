...
pub contract Mainledger: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Mainledger",
                    symbol: "MLC",
                    description: "A way to reward our followers",
                    externalURL: MetadataViews.ExternalURL("mainledger.net/"),
                    logos: medias,
                    socials: {
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: Mainledger.VaultStoragePath,
                    receiverPath: Mainledger.ReceiverPublicPath,
                    metadataPath: Mainledger.VaultPublicPath,
                    providerPath: /private/MainledgerVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("Mainledger", self.account.address, "MLC", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
