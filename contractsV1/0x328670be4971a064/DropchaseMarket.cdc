...
contract DropchaseMarket{ 
	...
	access(all)
	event creatorCutReceived(name: String, cut: UFix64)
	...
	resource SaleCollection: SalePublic{ 
		...
		access(self)
		var ownerCollection: Capability<&Dropchase.Collection>
		...
		access(self)
		fun getCreatorNameFromItem(item: &Dropchase.NFT): String{ 
