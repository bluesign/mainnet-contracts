...
contract TouchstoneTestGritIron2: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
			...
			if let recipientCollection = (getAccount(recipient).capabilities.get<&TouchstoneTestGritIron2.Collection>(TouchstoneTestGritIron2.CollectionPublicPath)!).borrow(){ 
