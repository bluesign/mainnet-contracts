...
///
access(all)
contract Pinnacle: NonFungibleToken, ViewResolver{ 
	//------------------------------------------------------------
	// Events
	//------------------------------------------------------------
	...
	access(all)
	event SeriesCreated(id: Int, name: String)
	
	/// Emitted when a Series is locked, meaning new Sets cannot be created with the Series anymore
	access(all)
	event SeriesLocked(id: Int, name: String)
	
	/// Emitted when a Series's name is updated
	access(all)
	event SeriesNameUpdated(id: Int, name: String)
	
	// Set Events
	//
	/// Emitted when a new Set has been created, meaning new Shapes can be created with the Set
	access(all)
	event SetCreated(id: Int, renderID: String, name: String, seriesID: Int, editionType: String)
	
	/// Emitted when a Set is locked, meaning new Shapes cannot be created with the Set anymore
	access(all)
	event SetLocked(id: Int, renderID: String, name: String, seriesID: Int, editionType: String)
	
	/// Emitted when a Set's name is updated
	access(all)
	event SetNameUpdated(id: Int, renderID: String, name: String, seriesID: Int, editionType: String)
	
	// Shape Events
	//
	/// Emitted when a new Shape has been created, meaning new Editions can be created with the Shape
	access(all)
	event ShapeCreated(id: Int, renderID: String, setID: Int, name: String, editionType: String, metadata:{ String: [String]})
	
	/// Emitted when a Shape is closed, meaning new Editions cannot be created with the Shape anymore
	access(all)
	event ShapeClosed(id: Int, renderID: String, setID: Int, name: String, currentPrinting: UInt64, editionType: String)
	
	/// Emitted when a Shape's name is updated
	access(all)
	event ShapeNameUpdated(id: Int, renderID: String, setID: Int, name: String, currentPrinting: UInt64, editionType: String)
	
	/// Emitted when a Shape's current printing is incremented
	access(all)
	event ShapeCurrentPrintingIncremented(id: Int, renderID: String, setID: Int, name: String, currentPrinting: UInt64, editionType: String)
	
	// Edition Events
	//
	/// Emitted when a new Edition has been created, meaning new NFTs can be minted with the Edition
	access(all)
	event EditionCreated(id: Int, renderID: String, seriesID: Int, setID: Int, shapeID: Int, variant: String?, printing: UInt64, editionTypeID: Int, description: String, isChaser: Bool, maxMintSize: UInt64?, maturationPeriod: UInt64?, traits:{ String: [String]})
	
	/// Emitted when an Edition is either closed by the Admin or the maximum amount of pins have been minted
	access(all)
	event EditionClosed(id: Int, maxMintSize: UInt64)
	
	/// Emitted when an Edition's description is updated
	access(all)
	event EditionDescriptionUpdated(id: Int, description: String)
	
	/// Emitted when an Edition's renderID is updated
	access(all)
	event EditionRenderIDUpdated(id: Int, renderID: String)
	...
	access(all)
	event EditionRemoved(id: Int)
	
	// Edition Type Events
	//
	/// Emitted when a new Edition Type has been created
	access(all)
	event EditionTypeCreated(id: Int, name: String, isLimited: Bool, isMaturing: Bool)
	
	/// Emitted when an Edition Type has been closed, meaning new Editions cannot be created with the Edition
	/// Type anymore
	access(all)
	event EditionTypeClosed(id: Int, name: String, isLimited: Bool, isMaturing: Bool)
	...
	access(all)
	event PinNFTMinted(id: UInt64, renderID: String, editionID: Int, serialNumber: UInt64?, maturityDate: UInt64?)
	
	/// Emitted when a Pin NFT is destroyed
	access(all)
	event PinNFTBurned(id: UInt64, editionID: Int, serialNumber: UInt64?, xp: UInt64?)
	
	/// Emitted when a Pin NFT's XP is updated
	access(all)
	event NFTXPUpdated(id: UInt64, editionID: Int, xp: UInt64?)
	
	/// Emitted when an Inscription is added to a Pin NFT
	access(all)
	event NFTInscriptionAdded(id: Int, owner: Address, note: String?, nftID: UInt64, editionID: Int)
	
	/// Emitted when an NFT's Inscription is updated
	access(all)
	event NFTInscriptionUpdated(id: Int, owner: Address, note: String?, nftID: UInt64, editionID: Int)
	...
	access(all)
	event NFTInscriptionRemoved(id: Int, owner: Address, nftID: UInt64, editionID: Int)
	...
	access(all)
	event EntityReactivated(entity: String, id: Int, name: String?)
	
	/// Emitted when a new Variant has been inserted
	access(all)
	event VariantInserted(name: String)
	
	/// Emitted when the wrapper emitPurchasedEvent Admin function is called
	access(all)
	event Purchased(purchaseIntentID: String, buyerAddress: Address, countPurchased: UInt64, totalSalePrice: UFix64)
	
	/// Emitted when an Open/Unlimited Edition NFT is destroyed by the Admin
	access(all)
	event OpenEditionNFTBurned(id: UInt64, editionID: Int)
	...
	access(self)
	let seriesIDsByName:{ String: Int}
	
	access(self)
	let setIDsByName:{ String: Int}
	
	access(self)
	let editionTypeIDsByName:{ String: Int}
	...
	access(self)
	let inscriptionsLimits:{ UInt64: Int}
	...
	struct Set{ 
		...
		///
		access(contract)
		fun insertShapeName(_ name: String){ 
		...
		///
		access(contract)
		fun removeShapeName(_ name: String){ 
		...
		///
		access(contract)
		fun shapeNameExistsInSet(_ name: String): Bool{ 
	...
	struct Shape{ 
		...
		access(self)
		let variantPrintingPairsInEditions:{ String: UInt64}
		...
		///
		access(contract)
		fun insertVariantPrintingPair(_ variant: String){ 
		...
		///
		access(contract)
		fun removeVariantPrintingPair(_ variant: String){ 
		...
		///
		access(contract)
		fun variantPrintingPairExistsInEdition(_ variant: String): Bool{ 
		...
		///
		access(contract)
		fun updateName(_ name: String, _ setRef: &Set){ 
			pre{ 
				name != "":
		...
		///
		access(contract)
		fun incrementCurrentPrinting(): UInt64{ 
			pre{ 
				self.closedDate == nil:
	...
	struct Edition{ 
		...
		///
		access(contract)
		fun getNextSerialNumber(): UInt64?{ 
		...
		///
		access(contract)
		fun updateDescription(_ description: String){ 
			self.description = description
		...
		///
		access(contract)
		fun updateRenderID(_ renderID: String){ 
			self.renderID = renderID
	...
	resource NFT: NonFungibleToken.NFT, ViewResolver.Resolver{ 
		...
		access(self)
		let inscriptionIDsByAddress:{ Address: Int}
		...
		///
		access(contract)
		fun addCurrentOwnerInscription(_ currentOwner: Address): Int{ 
			pre{ 
		...
		///
		access(contract)
		fun borrowInscription(id: Int): &Inscription?{ 
			pre{ 
				id > 0:
		...
		///
		access(contract)
		fun removeCurrentOwnerInscription(_ currentOwner: Address){ 
			pre{ 
		...
		///
		access(contract)
		fun updateCurrentOwnerInscriptionNote(currentOwner: Address, note: String){ 
			pre{ 
				self.inscriptionIDsByAddress.containsKey(currentOwner) == true:
		...
		///
		access(contract)
		fun addXP(_ value: UInt64): UInt64{ 
			pre{ 
				self.xp != nil:
		...
		///
		access(contract)
		fun subtractXP(_ value: UInt64): UInt64{ 
			pre{ 
				self.xp != nil:
					"XP must have been previously set by the owner"
				self.xp! >= value:
	...
	///
	access(all)
	resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic, ViewResolver.ResolverCollection, PinNFTCollectionPublic{ 
	...
	resource Admin: NFTMinter{ 
		...
		///
		access(self)
		fun borrowSeries(id: Int): &Series?{ 
			pre{ 
				id > 0:
					"The ID of a Series must be greater than 0"
			}
		...
		///
		access(self)
		fun borrowEdition(id: Int): &Edition?{ 
			pre{ 
				id > 0:
		...
		///
		access(self)
		fun borrowEditionType(id: Int): &EditionType?{ 
			pre{ 
				id > 0:
