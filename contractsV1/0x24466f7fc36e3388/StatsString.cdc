...
contract StatsString{ 
	...
	resource StatsVault: IStatsPrivate{ 
		...
		init(addr: Address, nickname: String, title: String, answer1: String, answer2: String, answer3: String, answer4: String, answer5: String, answer6: String, value1: String, value2: String, value3: String, value4: String, value5: String, value6: String, flow_vault_receiver: Capability<&FlowToken.Vault>){ 
			// TotalSupply
