	...
	fun StorefrontListItemTemplate(
		...
		let lines: [[String]] =
			[
				...
				[
					"			nftType: Type<@",
					TransactionGenerationUtils.createStaticTypeFromType((nftSchema!).type),
					">(),"
				],
				["			nftID: saleItemID,"],
				[
					"			salePaymentVaultType: Type<@",
					TransactionGenerationUtils.createStaticTypeFromType((ftSchema!).type),
					">(),"
				],
		...
		let lines: [[String]] =
			[
				...
				[
					...
					TransactionGenerationUtils.getAddressFromType((ftSchema!).type),
					")"
				],
				[
