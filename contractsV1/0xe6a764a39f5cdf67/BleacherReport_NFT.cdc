...
contract BleacherReport_NFT: NonFungibleToken{ 
	...
	fun fetch(_ from: Address, id: UInt64): &BleacherReport_NFT.NFT?{ 
		let collection = (getAccount(from).capabilities.get<&BleacherReport_NFT.Collection>(BleacherReport_NFT.CollectionPublicPath)!).borrow() ?? panic("Couldn't get collection")
