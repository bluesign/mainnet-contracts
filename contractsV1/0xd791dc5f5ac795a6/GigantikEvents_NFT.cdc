...
contract GigantikEvents_NFT: NonFungibleToken{ 
	...
	fun fetch(_ from: Address, id: UInt64): &GigantikEvents_NFT.NFT?{ 
		let collection = (getAccount(from).capabilities.get<&GigantikEvents_NFT.Collection>(GigantikEvents_NFT.CollectionPublicPath)!).borrow() ?? panic("Couldn't get collection")
