...
access(all)
contract ToucansUSDCoin: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: ToucansUSDCoin.VaultStoragePath, receiverPath: ToucansUSDCoin.ReceiverPublicPath, metadataPath: ToucansUSDCoin.VaultPublicPath, receiverLinkedType: /private/ToucansUSDCoinVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-ToucansUSDCoin.createEmptyVault(vaultType: Type<@ToucansUSDCoin.Vault>())
					})
		}
		return nil
	}
