...
contract TouchstoneProfessorMetasAcademyHackathon2023: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
			...
			if let recipientCollection = (getAccount(recipient).capabilities.get<&TouchstoneProfessorMetasAcademyHackathon2023.Collection>(TouchstoneProfessorMetasAcademyHackathon2023.CollectionPublicPath)!).borrow(){ 
