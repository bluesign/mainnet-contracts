...
access(all)
contract TMB2B: NonFungibleToken{ 
	access(all)
	...
	access(all)
	resource Collection: TMB2BCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic{ 
		access(all)
