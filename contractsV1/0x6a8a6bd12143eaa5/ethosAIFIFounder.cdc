...
access(all)
contract ethosAIFIFounder: NonFungibleToken{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: ethosAIFIFounder.CollectionStoragePath, publicPath: ethosAIFIFounder.CollectionPublicPath, publicCollection: Type<&Collection>(), publicLinkedType: Type<&Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
							return <-ethosAIFIFounder.createEmptyCollection(nftType: Type<@ethosAIFIFounder.Collection>())
						})
	...
	resource interface CollectionPublic{ 
		...
		fun borrowEntireNFT(id: UInt64): &ethosAIFIFounder.NFT?
	}
	...
	resource interface AdminProxyPublic{ 
		access(TMP_ENTITLEMENT_OWNER)
		fun giveAdminRights(cap: Capability<&ethosAIFIFounder.Admin>): Void
	}
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&ethosAIFIFounder.Collection>(self.CollectionStoragePath)
		self.account.capabilities.publish(capability_1, at: self.CollectionPublicPath)
		
		// Create a private capability for the admin resource
		var capability_2 = self.account.capabilities.storage.issue<&ethosAIFIFounder.Admin>(self.AdminStoragePath)
