...
access(all)
contract ethosAIFIIFounder: NonFungibleToken{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: ethosAIFIIFounder.CollectionStoragePath, publicPath: ethosAIFIIFounder.CollectionPublicPath, publicCollection: Type<&Collection>(), publicLinkedType: Type<&Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
							return <-ethosAIFIIFounder.createEmptyCollection(nftType: Type<@ethosAIFIIFounder.Collection>())
						})
	...
	resource interface CollectionPublic{ 
		...
		fun borrowEntireNFT(id: UInt64): &ethosAIFIIFounder.NFT?
	}
	...
	resource interface AdminProxyPublic{ 
		access(TMP_ENTITLEMENT_OWNER)
		fun giveAdminRights(cap: Capability<&ethosAIFIIFounder.Admin>): Void
	}
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&ethosAIFIIFounder.Collection>(self.CollectionStoragePath)
		self.account.capabilities.publish(capability_1, at: self.CollectionPublicPath)
		
		// Create a private capability for the admin resource
		var capability_2 = self.account.capabilities.storage.issue<&ethosAIFIIFounder.Admin>(self.AdminStoragePath)
