...
access(all)
contract ethosAIFIIInvestor: NonFungibleToken{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: ethosAIFIIInvestor.CollectionStoragePath, publicPath: ethosAIFIIInvestor.CollectionPublicPath, publicCollection: Type<&Collection>(), publicLinkedType: Type<&Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
							return <-ethosAIFIIInvestor.createEmptyCollection(nftType: Type<@ethosAIFIIInvestor.Collection>())
						})
	...
	resource interface CollectionPublic{ 
		...
		fun borrowEntireNFT(id: UInt64): &ethosAIFIIInvestor.NFT?
	}
	...
	resource interface AdminProxyPublic{ 
		access(TMP_ENTITLEMENT_OWNER)
		fun giveAdminRights(cap: Capability<&ethosAIFIIInvestor.Admin>): Void
	}
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&ethosAIFIIInvestor.Collection>(self.CollectionStoragePath)
		self.account.capabilities.publish(capability_1, at: self.CollectionPublicPath)
		
		// Create a private capability for the admin resource
		var capability_2 = self.account.capabilities.storage.issue<&ethosAIFIIInvestor.Admin>(self.AdminStoragePath)
