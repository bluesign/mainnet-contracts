...
contract ethosFutureRewardsProgram: NonFungibleToken{ 
	...
	resource interface CollectionPublic{ 
		...
		fun borrowEntireNFT(id: UInt64): &ethosFutureRewardsProgram.NFT?
	}
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&ethosFutureRewardsProgram.Collection>(self.CollectionStoragePath)
