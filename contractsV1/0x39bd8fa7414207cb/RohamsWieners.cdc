...
access(all)
contract RohamsWieners: FungibleToken{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<FungibleTokenMetadataViews.FTDisplay>():
					let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreifecwzpw5xoufaakty4eekxbuobitshs3kbdzjtm7t3pbicbf3v5u"), mediaType: "image")
					let bannerMedia = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreieef4d3di7mz4pdb73mlozwso5ys6nwqmxqs5wbdbqrhbr57zlpda"), mediaType: "image")
					let medias = MetadataViews.Medias([media, bannerMedia])
					return FungibleTokenMetadataViews.FTDisplay(name: "Roham's Wieners", symbol: "ROHAM", description: "Nearly 2 years ago, Dapper CEO Roham Gharegozlou promised that a key perk of being a Top Shot collector would be free hot dogs at NBA arenas. As of today, that promise has yet to be delivered upon. We are here to change that.", externalURL: MetadataViews.ExternalURL(""), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL("RohamsWieners"), "discord": MetadataViews.ExternalURL("")})
				case Type<FungibleTokenMetadataViews.FTVaultData>():
					return FungibleTokenMetadataViews.FTVaultData(storagePath: RohamsWieners.VaultStoragePath, receiverPath: RohamsWieners.ReceiverPublicPath, metadataPath: RohamsWieners.VaultPublicPath, receiverLinkedType: /private/RohamsWienersVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
							return <-RohamsWieners.createEmptyVault(vaultType: Type<@RohamsWieners.Vault>())
						})
			}
			return nil
		}
