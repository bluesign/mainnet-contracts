...
contract TouchstoneRetroDiamondFists284ChampionBelt: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
			...
			if let recipientCollection = (getAccount(recipient).capabilities.get<&TouchstoneRetroDiamondFists284ChampionBelt.Collection>(TouchstoneRetroDiamondFists284ChampionBelt.CollectionPublicPath)!).borrow(){ 
