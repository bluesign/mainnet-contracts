...
contract TouchstoneDFRetroPixelBeltV69: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
			...
			if let recipientCollection = (getAccount(recipient).capabilities.get<&TouchstoneDFRetroPixelBeltV69.Collection>(TouchstoneDFRetroPixelBeltV69.CollectionPublicPath)!).borrow(){ 
