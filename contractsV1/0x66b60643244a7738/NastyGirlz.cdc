...
// import Crypto
access(all)
contract NastyGirlz: NonFungibleToken{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.Royalties>():
					...
					let royaltyReceiverCap = getAccount(NastyGirlz.royaltyAddress()).capabilities.get<&{FungibleToken.Receiver}>(/public/dapperUtilityCoinReceiver)
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: NastyGirlz.CollectionStoragePath, publicPath: NastyGirlz.CollectionPublicPath, publicCollection: Type<@NastyGirlz.Collection>(), publicLinkedType: Type<&NastyGirlz.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
							return <-NastyGirlz.createEmptyCollection(nftType: Type<@NastyGirlz.Collection>())
						})
