...
access(all)
contract TrmAssetV2_1: NonFungibleToken{ 
	// -----------------------------------------------------------------------
	...
	access(all)
	event AssetBatchMinted(startId: UInt64, endId: UInt64, kID: String, assetName: String, assetDescription: String, assetURL: String, assetThumbnailURL: String, assetType: String, assetMetadata:{ String: String}, totalSerialNumbers: UInt64, owner: Address?)
