...
access(all)
contract Marbles: NonFungibleToken, TiblesApp, TiblesNFT, TiblesProducer{ 
	access(all)
	let appId: String
	...
	resource NFT: NonFungibleToken.NFT, TiblesNFT.INFT, ViewResolver.Resolver{ 
		...
		fun nftCollectionData(): MetadataViews.NFTCollectionData{ 
			return MetadataViews.NFTCollectionData(storagePath: Marbles.CollectionStoragePath, publicPath: Marbles.PublicCollectionPath, publicCollection: Type<&Marbles.Collection>(), publicLinkedType: Type<&Marbles.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
					return <-Marbles.createEmptyCollection(nftType: Type<@Marbles.Collection>())
				})
		}
