...
contract NFTLockBox{ 
	...
	access(all)
	let DefaultLockBoxStoragePath: StoragePath
	
	access(all)
	let DefaultLockBoxPublicPath: PublicPath
	...
	resource LockBox: LockBoxPublic{ 
		...
		access(self)
		let collection: Capability<&{NonFungibleToken.Provider, NonFungibleToken.Receiver}>
