...
contract IncrementPointsV1{ 
	...
	access(self)
	let _mintPointPerDayFactor:{ String: UFix64}
	
	// 黑名单
	access(self)
	fun mintPoint(targetAddr: Address, amount: UFix64){ 
		// mint points
	...
	/// Events
	access(all)
	event PointsMinted(userAddr: Address, amount: UFix64, source: String, param: String)
	...
	init(){ 
		...
		self._balances ={} 
		self._mintPointPerDayFactor ={ "LendingSupply": 0.1, "LendingBorrow": 0.3}
		self._userStates ={} 
		self._blackList ={} 
