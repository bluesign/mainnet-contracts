...
access(all)
contract WorldofDiamonds: NonFungibleToken{ 
	access(all)
	...
	resource interface _NFT_NAME_CollectionPublic{ 
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun borrow_NFT_NAME_(id: UInt64): &WorldofDiamonds.NFT?{ 
			post{ 
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&WorldofDiamonds.Collection>(self.CollectionStoragePath)
