...
access(all)
contract SkyLabsMintPotion: NonFungibleToken{ 
	access(all)
	...
	resource interface _NFT_NAME_CollectionPublic{ 
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun borrow_NFT_NAME_(id: UInt64): &SkyLabsMintPotion.NFT?{ 
			post{ 
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&SkyLabsMintPotion.Collection>(self.CollectionStoragePath)
