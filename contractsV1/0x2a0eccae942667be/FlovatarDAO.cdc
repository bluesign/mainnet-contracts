...
access(all)
contract FlovatarDAO: FungibleToken{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<FungibleTokenMetadataViews.FTDisplay>():
					let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreif2crr6a6z4kqs4krkzgcikoof3kmm5yhduy64iupqva4xk35hel4"), mediaType: "image")
					let bannerMedia = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafybeienx7za7vnmewqaztdxwzz5nt4zaqnis3qg6tqv5k3xjgem74lhn4"), mediaType: "image")
					let medias = MetadataViews.Medias([media, bannerMedia])
					return FungibleTokenMetadataViews.FTDisplay(name: "Flovatar DAO", symbol: "FLDAO", description: "This is the official Flovatar DAO managed by all the Flovatar owners.", externalURL: MetadataViews.ExternalURL("flovatar.com"), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL("flovatar"), "discord": MetadataViews.ExternalURL("flovatar")})
				case Type<FungibleTokenMetadataViews.FTVaultData>():
					return FungibleTokenMetadataViews.FTVaultData(storagePath: FlovatarDAO.VaultStoragePath, receiverPath: FlovatarDAO.ReceiverPublicPath, metadataPath: FlovatarDAO.VaultPublicPath, receiverLinkedType: /private/FlovatarDAOVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
							return <-FlovatarDAO.createEmptyVault(vaultType: Type<@FlovatarDAO.Vault>())
						})
			}
			return nil
		}
