...
access(all)
contract HeartFirstAcademy: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTDisplay>():
				...
				return FungibleTokenMetadataViews.FTDisplay(name: "Heart First Academy", symbol: "HEART", description: "A DAO created to empower medical professionals  in the web3 space and help govern the Heart First Academy educational platform. ", externalURL: MetadataViews.ExternalURL(""), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL("HeartFirst_NFT"), "discord": MetadataViews.ExternalURL("https://discord.gg/ct2w5hmxHV")})
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: HeartFirstAcademy.VaultStoragePath, receiverPath: HeartFirstAcademy.ReceiverPublicPath, metadataPath: HeartFirstAcademy.VaultPublicPath, receiverLinkedType: /private/HeartFirstAcademyVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-HeartFirstAcademy.createEmptyVault(vaultType: Type<@HeartFirstAcademy.Vault>())
					})
		}
		return nil
	}
