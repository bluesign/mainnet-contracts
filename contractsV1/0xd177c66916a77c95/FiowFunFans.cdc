...
access(all)
contract FiowFunFans: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: FiowFunFans.VaultStoragePath, receiverPath: FiowFunFans.ReceiverPublicPath, metadataPath: FiowFunFans.VaultPublicPath, receiverLinkedType: /private/FiowFunFansVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-FiowFunFans.createEmptyVault(vaultType: Type<@FiowFunFans.Vault>())
					})
		}
		return nil
	}
