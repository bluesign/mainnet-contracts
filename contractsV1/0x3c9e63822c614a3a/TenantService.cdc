...
contract TenantService: NonFungibleToken{ 
	...
	access(all)
	let PUBLIC_NFT_COLLECTION_PATH_CUSTOM: PublicPath
	...
	init(tenantId: String, tenantName: String, tenantDescription: String, ADMIN_OBJECT_PATH: StoragePath, PRIVATE_NFT_COLLECTION_PATH: StoragePath, PUBLIC_NFT_COLLECTION_PATH: PublicPath, PUBLIC_NFT_COLLECTION_PATH_CUSTOM: PublicPath){ 
		...
		var capability_2 = self.account.capabilities.storage.issue<&{CollectionPublic}>(TenantService.PRIVATE_NFT_COLLECTION_PATH)
		self.account.capabilities.publish(capability_2, at: TenantService.PUBLIC_NFT_COLLECTION_PATH_CUSTOM)
