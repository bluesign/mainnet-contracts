...
access(all)
contract TheFabricantMetadataViews{ 
	...
	struct TFNFTSimpleView{ 
		...
		access(all)
		let characteristics:{ String:{ CoCreatable.Characteristic}}?
	...
	struct AccessPassMetadataViewV2{ 
		...
		init(
			...
			royaltiesTFMarketplace: [
				TheFabricantMetadataViews.Royalty
			],
			owner: Address
		){ 
			self.id = id
	...
	struct PromotionMetadataViewV2{ 
		...
		access(all)
		var nftsUsedForClaim:{ UInt64: TheFabricantMetadataViews.IdentifierV2}
		
		access(all)
		var addressesClaimed:{ Address: [TheFabricantMetadataViews.IdentifierV2]}
		...
		init(
			...
			nftsUsedForClaim:{ 
				UInt64: TheFabricantMetadataViews.IdentifierV2
			},
			addressesClaimed:{ 
				Address: [
					TheFabricantMetadataViews.IdentifierV2
				]
			},
			dateCreated: UFix64,
			description: String,
			...
			spentAccessUnits:{ 
				UInt64: [
					TheFabricantMetadataViews.SpentAccessUnitView
				]
			},
			capacity: UInt64?,
			startTime: UFix64?,
	...
	struct PromotionAccessPassHoldersV2{ 
		...
		access(all)
		let currentHolders:{ UInt64: TheFabricantMetadataViews.IdentifierV2}
	...
	struct PromotionMetadataView{ 
		...
		init(
			...
			nftsUsedForClaim:{ 
				UInt64: TheFabricantMetadataViews.Identifier
			},
			addressesClaimed:{ 
				Address: [
	...
	struct PromotionAccessPassHolders{ 
		...
		access(all)
		let currentHolders:{ UInt64: TheFabricantMetadataViews.Identifier}
