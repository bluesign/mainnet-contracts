...
access(all)
contract EmeraldCity: FungibleToken{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<FungibleTokenMetadataViews.FTDisplay>():
					let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreiffwe2iw27yworzpe3vu4lfwrif64ozwsvrhkktnj6krkjqfz426q"), mediaType: "image")
					let medias = MetadataViews.Medias([media])
					return FungibleTokenMetadataViews.FTDisplay(name: "Emerald City", symbol: "EMLD", description: "The first DAO on the Flow blockchain. The creators of Toucans.", externalURL: MetadataViews.ExternalURL("ecdao.org"), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL("emerald_dao"), "discord": MetadataViews.ExternalURL("emeraldcity")})
				case Type<FungibleTokenMetadataViews.FTVaultData>():
					return FungibleTokenMetadataViews.FTVaultData(storagePath: EmeraldCity.VaultStoragePath, receiverPath: EmeraldCity.ReceiverPublicPath, metadataPath: EmeraldCity.VaultPublicPath, receiverLinkedType: /private/EmeraldCityVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
							return <-EmeraldCity.createEmptyVault(vaultType: Type<@EmeraldCity.Vault>())
						})
			}
			return nil
		}
