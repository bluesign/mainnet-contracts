...
access(all)
contract NextName: NonFungibleToken{ 
			...
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: NextName.CollectionStoragePath, publicPath: NextName.CollectionPublicPath, publicCollection: Type<&NextName.Collection>(), publicLinkedType: Type<&NextName.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
							return <-NextName.createEmptyCollection(nftType: Type<@NextName.Collection>())
						})
				case Type<MetadataViews.NFTCollectionDisplay>():
					return MetadataViews.NFTCollectionDisplay(name: "NextName", description: "NextName NFT Collection. Support Your Players.", externalURL: MetadataViews.ExternalURL("https://nextname.io/"), squareImage: MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://cloudflare-ipfs.com/ipfs/bafybeifbnckgntaaq3oknp4ygidnalwdupmv6fhdiip3cdqoaxekxhvfei/nextname-logo.png"), mediaType: "image/png"), bannerImage: MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://cloudflare-ipfs.com/ipfs/bafybeihyk7jgd2bhkvztqogoilgfc42gbx2mmxnb5pwvijqquaj5gdemmu/banner.jpg"), mediaType: "image/png"), socials:{} )
				case Type<MetadataViews.ExternalURL>():
					return MetadataViews.ExternalURL("https://nextname.io/")
			}
			return nil
		}
	...
	access(all)
	resource interface NextNameCollectionPublic{ 
		access(all)
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun borrowCollectible(id: UInt64): &NextName.NFT?{ 
	...
	access(all)
	resource Collection: NextNameCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic, ViewResolver.ResolverCollection{ 
	...
	access(TMP_ENTITLEMENT_OWNER)
	fun getAllCollectibleItems(): [NextName.CollectibleItem]{ 
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&{NextNameCollectionPublic}>(self.CollectionStoragePath)
