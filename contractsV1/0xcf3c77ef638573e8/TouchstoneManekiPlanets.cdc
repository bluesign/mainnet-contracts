...
contract TouchstoneManekiPlanets: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, recipient: Address){ 
			...
			if let recipientCollection = (getAccount(recipient).capabilities.get<&TouchstoneManekiPlanets.Collection>(TouchstoneManekiPlanets.CollectionPublicPath)!).borrow(){ 
