...
access(all)
contract TraitPacksVouchers: NonFungibleToken{ 
	// -----------------------------------------------------------------------
	...
	access(all)
	resource interface PackVoucherCollectionPublic{ 
		access(all)
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun borrowVoucher(id: UInt64): &TraitPacksVouchers.NFT?{ 
			post{ 
	...
	access(all)
	resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic, PackVoucherCollectionPublic{ 
		access(all)
