...
import CapabilityDelegator from "../0xea86b9b77d95aeea/CapabilityDelegator.cdc"

import CapabilityFilter from "../0xea86b9b77d95aeea/CapabilityFilter.cdc"
...
contract HybridCustody{ 
	...
	resource OwnedAccount:
		...
		fun rotateAuthAccount(){ 
			...
			let authAcctPath =
				"HybridCustodyRelinquished".concat(HybridCustody.account.address.toString()).concat(
					getCurrentBlock().height.toString()
				)
