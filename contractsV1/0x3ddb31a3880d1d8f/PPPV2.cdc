...
contract PPPV2{ 
	...
	access(all)
	view fun getLatestUserInfo(_ userAddr: Address): [UFix64]{ 
	...
	resource Admin{ 
		...
		fun setPointsRate_stFlowHoldingTier(tierRate:{ UFix64: UFix64}){ 
			emit PointsTierRateChanged(
				...
				ori: PPPV2._pointsRatePerDay["stFlowHolding"]! as!{ UFix64: UFix64},
				new: tierRate
			)
		...
		fun setPointsRate_LendingSupplyTier(tierRate:{ UFix64: UFix64}){ 
			emit PointsTierRateChanged(
				...
				ori: PPPV2._pointsRatePerDay["LendingSupply"]! as!{ UFix64: UFix64},
				new: tierRate
			)
		...
		fun setPointsRate_LendingBorrowTier(tierRate:{ UFix64: UFix64}){ 
			emit PointsTierRateChanged(
				...
				ori: PPPV2._pointsRatePerDay["LendingBorrow"]! as!{ UFix64: UFix64},
				new: tierRate
			)
