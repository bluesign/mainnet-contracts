	...
	resource Admin{ 
		...
		fun setPointsRate_stFlowHoldingTier(tierRate:{ UFix64: UFix64}){ 
			emit PointsTierRateChanged(
				...
				ori: PPPV7._pointsRate["stFlowHolding"]! as!{ UFix64: UFix64},
				new: tierRate
			)
		...
		fun setPointsRate_LendingSupplyTier(tierRate:{ UFix64: UFix64}){ 
			emit PointsTierRateChanged(
				...
				ori: PPPV7._pointsRate["LendingSupply"]! as!{ UFix64: UFix64},
				new: tierRate
			)
		...
		fun setPointsRate_LendingBorrowTier(tierRate:{ UFix64: UFix64}){ 
			emit PointsTierRateChanged(
				...
				ori: PPPV7._pointsRate["LendingBorrow"]! as!{ UFix64: UFix64},
				new: tierRate
			)
		...
		fun setPointsRate_SwapLPTier(tierRate:{ UFix64: UFix64}){ 
			emit PointsTierRateChanged(
				source: "SwapLP",
				ori: PPPV7._pointsRate["SwapLP"]! as!{ UFix64: UFix64},
				new: tierRate
			)
		...
		fun setPointsRate_SwapVolumeTier(tierRate:{ UFix64: UFix64}){ 
			emit PointsTierRateChanged(
				source: "SwapVolume",
				ori: PPPV7._pointsRate["SwapVolume"]! as!{ UFix64: UFix64},
				new: tierRate
			)
		...
		fun setPointsRate_ReferrerUp(rate: UFix64){ 
			emit PointsRateChanged(
				source: "ReferrerUp",
				ori: PPPV7._pointsRate["ReferrerUp"]! as! UFix64,
				new: rate
			)
		...
		fun setPointsRate_RefereeUp(rate: UFix64){ 
			emit PointsRateChanged(
				source: "RefereeUp",
				ori: PPPV7._pointsRate["RefereeUp"]! as! UFix64,
				new: rate
			)
		...
		fun setPointsRate_CoreMember(rate: UFix64){ 
			emit PointsRateChanged(
				source: "CoreMember",
				ori: PPPV7._pointsRate["CoreMember"]! as! UFix64,
				new: rate
			)
		...
		fun addVolumePoints(userAddr: Address, volumePoints: UFix64, volumeUsd: UFix64){ 
			...
			PPPV7.setUserState_SwapVolume(
				userAddr: userAddr,
				volume: PPPV7.getUserState_SwapVolume(userAddr: userAddr) + volumeUsd
			)
			emit PointsMinted(
				userAddr: userAddr,
				amount: volumePoints,
		...
		// TODO
		access(all)
		fun testResetIfSnapshot(userAddr: Address){ 
