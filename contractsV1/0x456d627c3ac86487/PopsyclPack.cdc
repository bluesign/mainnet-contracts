...
contract PopsyclPack: NonFungibleToken{ 
	...
	init(){ 
		...
		self.account.storage.save(<-create NFT(id: 1, name: "pack name", royalty: 10.0, creator: 0x456d627c3ac86487, influencer: 0x5dc999f0bb011052), to: self.PopsyclPackMinterPath)
