...
access(all)
contract FraggleRock: NonFungibleToken, TiblesApp, TiblesNFT, TiblesProducer{ 
	access(all)
	let appId: String
	...
	resource NFT: NonFungibleToken.NFT, TiblesNFT.INFT, ViewResolver.Resolver{ 
		...
		fun nftCollectionData(): MetadataViews.NFTCollectionData{ 
			return MetadataViews.NFTCollectionData(storagePath: FraggleRock.CollectionStoragePath, publicPath: FraggleRock.PublicCollectionPath, publicCollection: Type<&FraggleRock.Collection>(), publicLinkedType: Type<&FraggleRock.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
					return <-FraggleRock.createEmptyCollection(nftType: Type<@FraggleRock.Collection>())
				})
		}
		
		access(TMP_ENTITLEMENT_OWNER)
		fun nftCollectionDisplay(): MetadataViews.NFTCollectionDisplay{ 
			let squareMedia = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/fragglerock-flow-icon.png"), mediaType: "image/svg+xml")
			let bannerMedia = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://i.tibles.com/m/fragglerock-flow-collection-banner.png"), mediaType: "image/png")
			...
			return MetadataViews.NFTCollectionDisplay(name: "Fraggle Rock Collection by Tibles", description: "Tibles Fraggle Rock is a digital trading card collecting experience by Tibles, made just for Fraggle Rock fans, backed by the FLOW blockchain.", externalURL: MetadataViews.ExternalURL("https://fragglerock.tibles.com"), squareImage: squareMedia, bannerImage: bannerMedia, socials: socials)
		}
