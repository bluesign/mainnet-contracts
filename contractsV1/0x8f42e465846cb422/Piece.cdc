...
contract Piece: NonFungibleToken, ViewResolver{ 
	...
	resource Administrator{ 
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun createNFTMetadata(channel: String, creatorID: UInt64, creatorUsername: String, creatorAddress: Address, sourceURL: String, description: String, pieceCreationDate: String, contentCreationDate: String, imgUrl: String, embededHTML: String){ 
			let metadatas <- Piece.account.storage.load<@Piece.MetadataStorage>(from: Piece.MetadataStoragePath)!
