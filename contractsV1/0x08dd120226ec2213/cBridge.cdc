...
contract cBridge{ 
	access(all)
	event SignersUpdated(signers:{ String: UInt256})
	...
	access(all)
	struct PbSignerPowerMap{ 
		access(all)
		var blockheight: UInt64
		
		access(all)
		let signerMap:{ String: UInt256}
