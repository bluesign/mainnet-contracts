...
contract TouchstoneWC2022CountryFlags: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, recipient: Address){ 
			...
			if let recipientCollection = (getAccount(recipient).capabilities.get<&TouchstoneWC2022CountryFlags.Collection>(TouchstoneWC2022CountryFlags.CollectionPublicPath)!).borrow(){ 
