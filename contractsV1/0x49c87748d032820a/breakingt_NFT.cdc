...
contract breakingt_NFT: NonFungibleToken{ 
	...
	//
	access(all)
	resource Collection: breakingt_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic{ 
