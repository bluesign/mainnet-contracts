...
access(all)
contract XvsX: NonFungibleToken{ 
	access(all)
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: XvsX.CollectionStoragePath, publicPath: XvsX.CollectionPublicPath, publicCollection: Type<&XvsX.Collection>(), publicLinkedType: Type<&XvsX.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
							return <-XvsX.createEmptyCollection(nftType: Type<@XvsX.Collection>())
						})
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&XvsX.Collection>(self.CollectionStoragePath)
