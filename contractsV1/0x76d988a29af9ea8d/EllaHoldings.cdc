...
access(all)
contract EllaHoldings: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: EllaHoldings.VaultStoragePath, receiverPath: EllaHoldings.ReceiverPublicPath, metadataPath: EllaHoldings.VaultPublicPath, receiverLinkedType: /private/EllaHoldingsVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-EllaHoldings.createEmptyVault(vaultType: Type<@EllaHoldings.Vault>())
					})
		}
		return nil
	}
