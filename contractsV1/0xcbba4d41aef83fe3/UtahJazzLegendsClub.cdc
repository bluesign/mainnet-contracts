...
access(all)
contract UtahJazzLegendsClub: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: UtahJazzLegendsClub.VaultStoragePath, receiverPath: UtahJazzLegendsClub.ReceiverPublicPath, metadataPath: UtahJazzLegendsClub.VaultPublicPath, receiverLinkedType: /private/UtahJazzLegendsClubVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-UtahJazzLegendsClub.createEmptyVault(vaultType: Type<@UtahJazzLegendsClub.Vault>())
					})
		}
		return nil
	}
