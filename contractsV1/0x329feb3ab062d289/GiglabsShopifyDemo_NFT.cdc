...
contract GiglabsShopifyDemo_NFT: NonFungibleToken{ 
	...
	fun fetch(_ from: Address, id: UInt64): &GiglabsShopifyDemo_NFT.NFT?{ 
		let collection = (getAccount(from).capabilities.get<&GiglabsShopifyDemo_NFT.Collection>(GiglabsShopifyDemo_NFT.CollectionPublicPath)!).borrow() ?? panic("Couldn't get collection")
