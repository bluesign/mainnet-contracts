...
contract The_Next_Cartel_NFT: NonFungibleToken{ 
	...
	fun fetch(_ from: Address, id: UInt64): &The_Next_Cartel_NFT.NFT?{ 
		let collection = (getAccount(from).capabilities.get<&The_Next_Cartel_NFT.Collection>(The_Next_Cartel_NFT.CollectionPublicPath)!).borrow() ?? panic("Couldn't get collection")
