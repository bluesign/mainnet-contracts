...
contract KeeprNFTStorefront{ 
	...
	struct ListingDetails{ 
		...
		fun updateDetails(canPurchase: Bool, saleCuts: [SaleCut]){ 
	...
	resource Storefront: StorefrontManager, StorefrontPublic{ 
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun updateListing(listingResourceID: UInt64, canPurchase: Bool, saleCuts: [SaleCut]){ 
