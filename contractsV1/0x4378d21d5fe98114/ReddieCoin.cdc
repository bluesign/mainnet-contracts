...
access(all)
contract ReddieCoin: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: ReddieCoin.VaultStoragePath, receiverPath: ReddieCoin.ReceiverPublicPath, metadataPath: ReddieCoin.VaultPublicPath, receiverLinkedType: /private/ReddieCoinVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-ReddieCoin.createEmptyVault(vaultType: Type<@ReddieCoin.Vault>())
					})
		}
		return nil
	}
