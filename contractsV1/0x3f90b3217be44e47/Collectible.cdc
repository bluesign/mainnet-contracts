		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: /storage/_3f90b3217be44e47_Collectible_Collection, publicPath: /public/_3f90b3217be44e47_Collectible_Collection, publicCollection: Type<&Collectible.Collection>(), publicLinkedType: Type<&Collectible.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
