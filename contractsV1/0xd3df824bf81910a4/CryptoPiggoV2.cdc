...
access(all)
contract CryptoPiggoV2: NonFungibleToken{ 
	access(all)
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: CryptoPiggoV2.CollectionStoragePath, publicPath: CryptoPiggoV2.CollectionPublicPath, publicCollection: Type<&CryptoPiggoV2.Collection>(), publicLinkedType: Type<&CryptoPiggoV2.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
							return <-CryptoPiggoV2.createEmptyCollection(nftType: Type<@CryptoPiggoV2.Collection>())
						})
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&CryptoPiggoV2.Collection>(self.CollectionStoragePath)
