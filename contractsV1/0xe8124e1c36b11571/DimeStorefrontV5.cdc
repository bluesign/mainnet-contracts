...
contract DimeStorefrontV5{ 
	...
	resource SaleOffer: SaleOfferPublic{ 
		...
		access(self)
		let sellerItemProvider: Capability<&DimeCollectibleV5.Collection>
		...
		init(nft: &DimeCollectibleV5.NFT, sellerItemProvider: Capability<&DimeCollectibleV5.Collection>, price: UFix64, saleShares: MetadataViews.Royalties){ 
	...
	resource interface StorefrontManager{ 
		...
		fun createSaleOffers(
			itemProvider: Capability<&DimeCollectibleV5.Collection>,
			items: [
				UInt64
			],
			price: UFix64,
	...
	resource Storefront: StorefrontPublic, StorefrontManager{ 
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun createSaleOffers(itemProvider: Capability<&DimeCollectibleV5.Collection>, items: [UInt64], price: UFix64, saleShares: MetadataViews.Royalties){ 
