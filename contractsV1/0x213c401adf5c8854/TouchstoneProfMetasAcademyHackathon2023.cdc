...
contract TouchstoneProfMetasAcademyHackathon2023: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
			...
			if let recipientCollection = (getAccount(recipient).capabilities.get<&TouchstoneProfMetasAcademyHackathon2023.Collection>(TouchstoneProfMetasAcademyHackathon2023.CollectionPublicPath)!).borrow(){ 
