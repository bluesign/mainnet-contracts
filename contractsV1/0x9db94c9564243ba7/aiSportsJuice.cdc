...
access(all)
contract aiSportsJuice: FungibleToken, ViewResolver{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				case Type<FungibleTokenMetadataViews.FTView>():
					return aiSportsJuice.resolveView(view)
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: aiSportsJuice.VaultStoragePath, receiverPath: aiSportsJuice.ReceiverPublicPath, metadataPath: aiSportsJuice.VaultPublicPath, receiverLinkedType: /private/aiSportsJuiceVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-aiSportsJuice.createEmptyVault(vaultType: Type<@aiSportsJuice.Vault>())
					})
		}
		return nil
	}
