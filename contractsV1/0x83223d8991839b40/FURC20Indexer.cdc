...
contract FURC20Indexer{ 
	...
	resource interface IndexerPublic{ 
		...
		access(all)
		view fun isValidFRC20Inscription(ins: &FlowUp.Inscription): Bool
		...
		/// Mint a FRC20 token
		access(all)
		fun mint(ins: &FlowUp.Inscription)
	...
	resource InscriptionIndexer: IndexerPublic{ 
		...
		///
		access(self)
		fun _buildFRC20SaleCuts(sellerAddress: Address?): [FURC20FTShared.SaleCut]{ 
