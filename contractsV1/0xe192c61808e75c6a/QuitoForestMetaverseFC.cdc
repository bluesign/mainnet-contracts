...
access(all)
contract QuitoForestMetaverseFC: FungibleToken{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<FungibleTokenMetadataViews.FTDisplay>():
					let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreiaec2b3rvq73bwf3vaj2s4k3zeh5jzmgckuexwfenqbdf2kciwvr4"), mediaType: "image")
					let bannerMedia = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreifoj5i5mmcbiydzg4vgypg26tdmlxtahyaswyqfkvam3zvwbefhjm"), mediaType: "image")
					let medias = MetadataViews.Medias([media, bannerMedia])
					return FungibleTokenMetadataViews.FTDisplay(name: "Quito Forest Metaverse FC", symbol: "QFMFC", description: "A DAO for the ownership, investors, management and supporters of Quito Forest Metaverse Football Club, and all assets associated in the MFL platform.", externalURL: MetadataViews.ExternalURL(""), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL("QuitoForestMFC"), "discord": MetadataViews.ExternalURL("Quito Forest MFC#0703")})
				case Type<FungibleTokenMetadataViews.FTVaultData>():
					return FungibleTokenMetadataViews.FTVaultData(storagePath: QuitoForestMetaverseFC.VaultStoragePath, receiverPath: QuitoForestMetaverseFC.ReceiverPublicPath, metadataPath: QuitoForestMetaverseFC.VaultPublicPath, receiverLinkedType: /private/QuitoForestMetaverseFCVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
							return <-QuitoForestMetaverseFC.createEmptyVault(vaultType: Type<@QuitoForestMetaverseFC.Vault>())
						})
			}
			return nil
		}
