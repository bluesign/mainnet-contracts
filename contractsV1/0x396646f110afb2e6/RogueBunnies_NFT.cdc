...
contract RogueBunnies_NFT: NonFungibleToken{ 
	...
	fun fetch(_ from: Address, id: UInt64): &RogueBunnies_NFT.NFT?{ 
		let collection = (getAccount(from).capabilities.get<&RogueBunnies_NFT.Collection>(RogueBunnies_NFT.CollectionPublicPath)!).borrow() ?? panic("Couldn't get collection")
