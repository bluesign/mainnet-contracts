...
contract SwapConfig{ 
	...
	fun getAmountOut(amountIn: UFix64, reserveIn: UFix64, reserveOut: UFix64): UFix64{ 
		...
		let amountInWithFeeScaled =
			SwapConfig.UFix64ToScaledUInt256(0.997) * amountInScaled / SwapConfig.scaleFactor
		let amountOutScaled =
	...
	init(){ 
		...
		self.LpTokenCollectionStoragePath = /storage/star_vault_swap_lptoken_collection
		self.LpTokenCollectionPublicPath = /public/star_vault_swap_lptoken_collection
