...
access(all)
contract ArturTestOrg: NonFungibleToken{ 
			...
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: ArturTestOrg.CollectionStoragePath, publicPath: ArturTestOrg.CollectionPublicPath, publicCollection: Type<&ArturTestOrg.Collection>(), publicLinkedType: Type<&ArturTestOrg.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
							return <-ArturTestOrg.createEmptyCollection(nftType: Type<@ArturTestOrg.Collection>())
						})
			}
			return nil
		}
	...
	access(all)
	resource interface ArturTestOrgCollectionPublic{ 
		access(all)
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun borrowCollectible(id: UInt64): &ArturTestOrg.NFT?{ 
	...
	access(all)
	resource Collection: ArturTestOrgCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic, ViewResolver.ResolverCollection{ 
	...
	access(TMP_ENTITLEMENT_OWNER)
	fun getAllCollectibleItems(): [ArturTestOrg.CollectibleItem]{ 
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&{ArturTestOrgCollectionPublic}>(self.CollectionStoragePath)
