...
contract GrantedAccountAccess{ 
	...
	init(){ 
		self.InfoStoragePath = /storage/MusicPeaksAttendanceTokenGrantedAccountAccessInfo
		self.InfoPublicPath = /public/MusicPeaksAttendanceTokenGrantedAccountAccessInfo
	}
}
