...
contract PierRouter{ 
	...
	fun swapExactTokensAForTokensB(
		...
		let poolsRef = &pools as &[&PierPair.Pool]
		let amounts =
			PierRouterLib.getAmountsByAmountIn(amountIn: amountIn, path: pathRef, pools: poolsRef)
