...
access(all)
contract R1CKY: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: R1CKY.VaultStoragePath, receiverPath: R1CKY.ReceiverPublicPath, metadataPath: R1CKY.VaultPublicPath, receiverLinkedType: /private/R1CKYVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-R1CKY.createEmptyVault(vaultType: Type<@R1CKY.Vault>())
					})
		}
		return nil
	}
