...
contract AddressUtils{ 
	access(self)
	fun withoutPrefix(_ input: String): String{ 
		var address = input
	...
	access(self)
	fun parseUInt64(_ input: AnyStruct): UInt64?{ 
