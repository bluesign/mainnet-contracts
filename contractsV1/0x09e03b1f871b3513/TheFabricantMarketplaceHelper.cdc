...
import TheFabricantS2GarmentNFT from "../0x7752ea736384322f/TheFabricantS2GarmentNFT.cdc"

import TheFabricantS2MaterialNFT from "../0x7752ea736384322f/TheFabricantS2MaterialNFT.cdc"
...
import TheFabricantAccessPass from "../0x7752ea736384322f/TheFabricantAccessPass.cdc"

import TheFabricantXXories from "../0x7752ea736384322f/TheFabricantXXories.cdc"

import TheFabricantNFTStandard from "../0x7752ea736384322f/TheFabricantNFTStandard.cdc"

import TheFabricantNFTStandardV2 from "../0x7752ea736384322f/TheFabricantNFTStandardV2.cdc"

import CAT_EnterTheEvolution from "../0x7752ea736384322f/CAT_EnterTheEvolution.cdc"

import TheFabricantKapers from "../0x7752ea736384322f/TheFabricantKapers.cdc"

access(all)
contract TheFabricantMarketplaceHelper{ 
	...
	access(self)
	var saleCuts:{ String: SaleCutValues}
	
	access(all)
	struct SaleCutValues{ 
		access(all)
		...
		let saleCutArray: [TheFabricantMarketplace.SaleCut] =
			[
				TheFabricantMarketplace.SaleCut(
					...
					receiver: itemCap,
					initialAmount: (TheFabricantMarketplaceHelper.saleCuts["item"]!).initialAmount,
					amount: (TheFabricantMarketplaceHelper.saleCuts["item"]!).amount
				),
				TheFabricantMarketplace.SaleCut(
					name: "Season 0 Garment Creator",
					receiver: garmentCap,
					initialAmount: (TheFabricantMarketplaceHelper.saleCuts["garment"]!)
						.initialAmount,
					amount: (TheFabricantMarketplaceHelper.saleCuts["garment"]!).amount
				),
				TheFabricantMarketplace.SaleCut(
					name: "Season 0 Material Creator",
					receiver: materialCap,
					initialAmount: (TheFabricantMarketplaceHelper.saleCuts["material"]!)
						.initialAmount,
					amount: (TheFabricantMarketplaceHelper.saleCuts["material"]!).amount
				),
				TheFabricantMarketplace.SaleCut(
					name: "Channel Fee Royalty",
					receiver: TheFabricantMarketplace.getChannelFeeCap()!,
					initialAmount: (TheFabricantMarketplaceHelper.saleCuts["channelFee"]!)
						.initialAmount,
	...
	fun s1ListItem(
		...
		let materialRoyalties =
			TheFabricantS1MaterialNFT.getMaterialData(id: materialData).getRoyalty()
	...
	fun s2ListItem(
		...
		images = images.concat([itemImage2, itemImage3, itemImage4])
		let edition =
			itemMetadata["edition"] != nil ? (itemMetadata["edition"]!).metadataValue : nil
		let garmentData = (itemRef.borrowGarment()!).garment.garmentDataID
	...
	fun xxoryListItem(
		...
		let TFSaleCut =
			TheFabricantMarketplace.SaleCut(
				...
				receiver: TheFabricantMarketplace.getChannelFeeCap()!,
				initialAmount: (TheFabricantMarketplaceHelper.saleCuts["TheFabricantXXories"]!)
					.initialAmount,
