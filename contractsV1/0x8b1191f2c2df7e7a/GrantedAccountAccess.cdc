...
contract GrantedAccountAccess{ 
	...
	init(){ 
		self.InfoStoragePath = /storage/MusicPeaksMembershipTokenGrantedAccountAccessInfo
		self.InfoPublicPath = /public/MusicPeaksMembershipTokenGrantedAccountAccessInfo
	}
}
