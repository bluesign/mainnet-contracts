...
access(all)
contract SloppyStakes: FungibleToken{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<FungibleTokenMetadataViews.FTDisplay>():
					let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreiem3taknzwhh33ux5hhsimqytzxjet2lnpfbcbmbs2j7pq35f2uoq"), mediaType: "image")
					let bannerMedia = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreidck2jl36rjwpgu6xwfdcn43xyedrviujd43ux7dnswjmy7yyp5ve"), mediaType: "image")
					let medias = MetadataViews.Medias([media, bannerMedia])
					return FungibleTokenMetadataViews.FTDisplay(name: "Sloppy Stakes", symbol: "LOPPY", description: "A DAO for everyone who used to be a piece of shit", externalURL: MetadataViews.ExternalURL("find.xyz/alxo"), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL("alxocity"), "discord": MetadataViews.ExternalURL("GYV8JRR")})
				case Type<FungibleTokenMetadataViews.FTVaultData>():
					return FungibleTokenMetadataViews.FTVaultData(storagePath: SloppyStakes.VaultStoragePath, receiverPath: SloppyStakes.ReceiverPublicPath, metadataPath: SloppyStakes.VaultPublicPath, receiverLinkedType: /private/SloppyStakesVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
							return <-SloppyStakes.createEmptyVault(vaultType: Type<@SloppyStakes.Vault>())
						})
			}
			return nil
		}
