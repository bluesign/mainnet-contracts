...
access(all)
contract Hexi_Coll_87d15c48_35b5_11ed_9411_4851c5d34c30: NonFungibleToken{ 
	access(all)
	...
	access(all)
	resource interface Hexi_Coll_87d15c48_35b5_11ed_9411_4851c5d34c30CollectionPublic{ 
		access(all)
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun borrowHexi_Coll_87d15c48_35b5_11ed_9411_4851c5d34c30(id: UInt64): &Hexi_Coll_87d15c48_35b5_11ed_9411_4851c5d34c30.NFT?{ 
			post{ 
	...
	access(all)
	resource Collection: Hexi_Coll_87d15c48_35b5_11ed_9411_4851c5d34c30CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic, ViewResolver.ResolverCollection{ 
		access(all)
	...
	resource NFTMinter{ 
		...
		fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, metadata:{ String: String}): &{NonFungibleToken.NFT}{ 
			...
			// create a new NFT
			var newNFT <- create NFT(id: Hexi_Coll_87d15c48_35b5_11ed_9411_4851c5d34c30.totalSupply, creator: creator, metadata: metadata)
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&Hexi_Coll_87d15c48_35b5_11ed_9411_4851c5d34c30.Collection>(self.CollectionStoragePath)
