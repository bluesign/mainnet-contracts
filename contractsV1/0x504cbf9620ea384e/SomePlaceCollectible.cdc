...
contract SomePlaceCollectible: NonFungibleToken{ 
	...
	access(all)
	resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic, CollectibleCollectionPublic{ 
		access(all)
