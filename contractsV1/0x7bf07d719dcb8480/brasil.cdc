		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<FungibleTokenMetadataViews.FTDisplay>():
					let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreihc3newdiaydwjat3hrhhdvup3foa4rcfc6obvshlyno4iibo6are"), mediaType: "image")
					let bannerMedia = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafybeic5wfn62cghy65n4xzp5jws6b2l7kbntfqc33z3hmvj7uwhb7pala"), mediaType: "image")
					let medias = MetadataViews.Medias([media, bannerMedia])
					return FungibleTokenMetadataViews.FTDisplay(name: "brasil", symbol: "BR", description: "Moeda @FlowBrasilChain", externalURL: MetadataViews.ExternalURL("instagram.com/flowbrasilchain"), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL("flowbrasilchain"), "discord": MetadataViews.ExternalURL("emeraldcity")})
				case Type<FungibleTokenMetadataViews.FTVaultData>():
					return FungibleTokenMetadataViews.FTVaultData(storagePath: brasil.VaultStoragePath, receiverPath: brasil.ReceiverPublicPath, metadataPath: brasil.VaultPublicPath, receiverLinkedType: /private/brasilVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
							return <-brasil.createEmptyVault(vaultType: Type<@brasil.Vault>())
						})
			}
			return nil
		}
