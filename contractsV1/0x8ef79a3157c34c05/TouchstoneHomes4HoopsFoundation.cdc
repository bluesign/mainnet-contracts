...
contract TouchstoneHomes4HoopsFoundation: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
			...
			if let recipientCollection = (getAccount(recipient).capabilities.get<&TouchstoneHomes4HoopsFoundation.Collection>(TouchstoneHomes4HoopsFoundation.CollectionPublicPath)!).borrow(){ 
