...
contract TouchstoneMidnightMunchies: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
			...
			if let recipientCollection = (getAccount(recipient).capabilities.get<&TouchstoneMidnightMunchies.Collection>(TouchstoneMidnightMunchies.CollectionPublicPath)!).borrow(){ 
