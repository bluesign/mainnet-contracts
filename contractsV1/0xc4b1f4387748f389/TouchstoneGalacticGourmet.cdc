...
contract TouchstoneGalacticGourmet: NonFungibleToken{ 
	...
	resource Administrator{ 
		...
		fun mintNFT(metadataId: UInt64, serial: UInt64, recipient: Address){ 
			...
			if let recipientCollection = (getAccount(recipient).capabilities.get<&TouchstoneGalacticGourmet.Collection>(TouchstoneGalacticGourmet.CollectionPublicPath)!).borrow(){ 
