...
contract BasketballsMarket{ 
	...
	resource SaleOffer: SaleOfferPublicView{ 
		...
		access(self)
		let sellerItemProvider: Capability<&Basketballs.Collection>
		...
		//
		init(sellerItemProvider: Capability<&Basketballs.Collection>, saleItemID: UInt64, sellerPaymentReceiver: Capability<&{FungibleToken.Receiver}>, salePrice: UFix64){ 
			pre{ 
