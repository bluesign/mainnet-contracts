...
contract CapabilityFilter{ 
	...
	//
	access(all)
	event FilterUpdated(id: UInt64, filterType: Type, type: Type, active: Bool)
	...
	///
	access(all)
	resource DenylistFilter: Filter{ 
	...
	///
	access(all)
	resource AllowlistFilter: Filter{ 
		// allowedTypes
	...
	///
	access(all)
	resource AllowAllFilter: Filter{ 
		/// Determines if a requested capability is allowed by this `Filter`
		///
		/// @param cap: The capability to check
