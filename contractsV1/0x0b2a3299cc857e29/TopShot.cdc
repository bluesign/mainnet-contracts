...
access(all)
contract TopShot: NonFungibleToken{ 
	// -----------------------------------------------------------------------
	...
	fun RoyaltyAddress(): Address{ 
		return 0xfaf0cc52c6e3acaf
	}
	
	// The path to the Subedition Admin resource belonging to the Account
	// which the contract is deployed on
	access(TMP_ENTITLEMENT_OWNER)
	fun SubeditionAdminStoragePath(): StoragePath{ 
		return /storage/TopShotSubeditionAdmin
	}
	...
	access(all)
	event MomentMinted(momentID: UInt64, playID: UInt32, setID: UInt32, serialNumber: UInt32, subeditionID: UInt32)
	...
	access(all)
	event SubeditionCreated(subeditionID: UInt32, name: String, metadata:{ String: String})
	
	// Emitted when a Subedition is linked to the specific Moment
	access(all)
	event SubeditionAddedToMoment(momentID: UInt64, subeditionID: UInt32, setID: UInt32, playID: UInt32)
	...
	struct Play{ 
		...
		access(contract)
		fun updateTagline(tagline: String): UInt32{ 
	...
	resource Set{ 
		...
		fun mintMoment(playID: UInt32): @NFT{ 
			...
			// Mint the new moment
			let newMoment: @NFT <- create NFT(serialNumber: numInPlay + UInt32(1), playID: playID, setID: self.setID, subeditionID: 0)
		...
		//
		access(TMP_ENTITLEMENT_OWNER)
		fun mintMomentWithSubedition(playID: UInt32, subeditionID: UInt32): @NFT{ 
			pre{ 
				self.retired[playID] != nil:
					"Cannot mint the moment: This play doesn't exist."
				!self.retired[playID]!:
			...
			// to use as this Moment's serial number
			let subeditionRef = TopShot.account.storage.borrow<&SubeditionAdmin>(from: TopShot.SubeditionAdminStoragePath()) ?? panic("No subedition admin resource in storage")
			let numInSubedition = subeditionRef.getNumberMintedPerSubedition(setID: self.setID, playID: playID, subeditionID: subeditionID)
			
			// Mint the new moment
			let newMoment: @NFT <- create NFT(serialNumber: numInSubedition + UInt32(1), playID: playID, setID: self.setID, subeditionID: subeditionID)
			
			// Increment the count of Moments minted for this subedition
			subeditionRef.addToNumberMintedPerSubedition(setID: self.setID, playID: playID, subeditionID: subeditionID)
		...
		//
		access(TMP_ENTITLEMENT_OWNER)
		fun batchMintMomentWithSubedition(playID: UInt32, quantity: UInt64, subeditionID: UInt32): @Collection{ 
			let newCollection <- create Collection()
			var i: UInt64 = 0
			while i < quantity{ 
	...
	//
	access(all)
	struct TopShotMomentMetadataView{ 
		access(all)
		let fullName: String?
		...
		access(all)
		let totalYearsExperience: String?
		
		access(all)
		let nbaSeason: String?
		
		access(all)
		let dateOfMoment: String?
		
		access(all)
		let playCategory: String?
		...
		access(all)
		let numMomentsInEdition: UInt32?
		
		init(fullName: String?, firstName: String?, lastName: String?, birthdate: String?, birthplace: String?, jerseyNumber: String?, draftTeam: String?, draftYear: String?, draftSelection: String?, draftRound: String?, teamAtMomentNBAID: String?, teamAtMoment: String?, primaryPosition: String?, height: String?, weight: String?, totalYearsExperience: String?, nbaSeason: String?, dateOfMoment: String?, playCategory: String?, playType: String?, homeTeamName: String?, awayTeamName: String?, homeTeamScore: String?, awayTeamScore: String?, seriesNumber: UInt32?, setName: String?, serialNumber: UInt32, playID: UInt32, setID: UInt32, numMomentsInEdition: UInt32?){ 
	...
	resource NFT: NonFungibleToken.NFT, ViewResolver.Resolver{ 
		...
		init(serialNumber: UInt32, playID: UInt32, setID: UInt32, subeditionID: UInt32){ 
			...
			emit MomentMinted(momentID: self.id, playID: playID, setID: self.data.setID, serialNumber: self.data.serialNumber, subeditionID: subeditionID)
		}
		...
		view fun getViews(): [Type]{ 
			return [Type<MetadataViews.Display>(), Type<TopShotMomentMetadataView>(), Type<MetadataViews.Royalties>(), Type<MetadataViews.Editions>(), Type<MetadataViews.ExternalURL>(), Type<MetadataViews.NFTCollectionData>(), Type<MetadataViews.NFTCollectionDisplay>(), Type<MetadataViews.Serial>(), Type<MetadataViews.Traits>(), Type<MetadataViews.Medias>()]
		}
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<TopShotMomentMetadataView>():
					return TopShotMomentMetadataView(fullName: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "FullName"), firstName: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "FirstName"), lastName: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "LastName"), birthdate: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "Birthdate"), birthplace: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "Birthplace"), jerseyNumber: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "JerseyNumber"), draftTeam: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "DraftTeam"), draftYear: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "DraftYear"), draftSelection: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "DraftSelection"), draftRound: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "DraftRound"), teamAtMomentNBAID: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "TeamAtMomentNBAID"), teamAtMoment: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "TeamAtMoment"), primaryPosition: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "PrimaryPosition"), height: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "Height"), weight: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "Weight"), totalYearsExperience: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "TotalYearsExperience"), nbaSeason: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "NbaSeason"), dateOfMoment: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "DateOfMoment"), playCategory: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "PlayCategory"), playType: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "PlayType"), homeTeamName: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "HomeTeamName"), awayTeamName: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "AwayTeamName"), homeTeamScore: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "HomeTeamScore"), awayTeamScore: TopShot.getPlayMetaDataByField(playID: self.data.playID, field: "AwayTeamScore"), seriesNumber: TopShot.getSetSeries(setID: self.data.setID), setName: TopShot.getSetName(setID: self.data.setID), serialNumber: self.data.serialNumber, playID: self.data.playID, setID: self.data.setID, numMomentsInEdition: TopShot.getNumMomentsInEdition(setID: self.data.setID, playID: self.data.playID))
				...
				case Type<MetadataViews.Royalties>():
					let royaltyReceiver: Capability<&{FungibleToken.Receiver}> = getAccount(TopShot.RoyaltyAddress()).capabilities.get<&{FungibleToken.Receiver}>(MetadataViews.getRoyaltyReceiverPublicPath())!
					return MetadataViews.Royalties([MetadataViews.Royalty(receiver: royaltyReceiver, cut: 0.05, description: "NBATopShot marketplace royalty")])
				case Type<MetadataViews.ExternalURL>():
					return MetadataViews.ExternalURL(self.getMomentURL())
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: /storage/MomentCollection, publicPath: /public/MomentCollection, publicCollection: Type<&TopShot.Collection>(), publicLinkedType: Type<&TopShot.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
							return <-TopShot.createEmptyCollection(nftType: Type<@TopShot.Collection>())
						})
				...
				case Type<MetadataViews.Medias>():
					return MetadataViews.Medias([MetadataViews.Media(file: MetadataViews.HTTPFile(url: self.mediumimage()), mediaType: "image/jpeg"), MetadataViews.Media(file: MetadataViews.HTTPFile(url: self.video()), mediaType: "video/mp4")])
			}
			return nil
		}
	...
	resource Admin{ 
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun updatePlayTagline(playID: UInt32, tagline: String): UInt32{ 
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun createSubeditionAdminResource(){ 
		...
		//
		access(TMP_ENTITLEMENT_OWNER)
		fun setMomentsSubedition(nftID: UInt64, subeditionID: UInt32, setID: UInt32, playID: UInt32){ 
			let subeditionAdmin = TopShot.account.storage.borrow<&SubeditionAdmin>(from: TopShot.SubeditionAdminStoragePath()) ?? panic("No subedition admin resource in storage")
		...
		//
		access(TMP_ENTITLEMENT_OWNER)
		fun createSubedition(name: String, metadata:{ String: String}): UInt32{ 
			let subeditionAdmin = TopShot.account.storage.borrow<&SubeditionAdmin>(from: TopShot.SubeditionAdminStoragePath()) ?? panic("No subedition admin resource in storage")
	...
	resource Collection: MomentCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic, ViewResolver.ResolverCollection{ 
		...
		fun lock(id: UInt64, duration: UFix64){ 
			// Remove the nft from the Collection
			let token <- self.ownedNFTs.remove(key: id) ?? panic("Cannot lock: Moment does not exist in the collection")
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun destroyMoments(ids: [UInt64]){ 
			let topShotLockingAdmin = TopShot.account.storage.borrow<&TopShotLocking.Admin>(from: TopShotLocking.AdminStoragePath()) ?? panic("No TopShotLocking admin resource in storage")
			for id in ids{ 
				// Remove the nft from the Collection
				let token <- self.ownedNFTs.remove(key: id) ?? panic("Cannot destroy: Moment does not exist in collection: ".concat(id.toString()))
	...
	//
	access(TMP_ENTITLEMENT_OWNER)
	fun getMomentsSubedition(nftID: UInt64): UInt32?{ 
		let subeditionAdmin = self.account.storage.borrow<&SubeditionAdmin>(from: TopShot.SubeditionAdminStoragePath()) ?? panic("No subedition admin resource in storage")
	...
	access(TMP_ENTITLEMENT_OWNER)
	fun getAllSubeditions(): [TopShot.Subedition]{ 
		let subeditionAdmin = self.account.storage.borrow<&SubeditionAdmin>(from: TopShot.SubeditionAdminStoragePath()) ?? panic("No subedition admin resource in storage")
	...
	access(TMP_ENTITLEMENT_OWNER)
	fun getSubeditionByID(subeditionID: UInt32): TopShot.Subedition{ 
		let subeditionAdmin = self.account.storage.borrow<&SubeditionAdmin>(from: TopShot.SubeditionAdminStoragePath()) ?? panic("No subedition admin resource in storage")
	...
	access(TMP_ENTITLEMENT_OWNER)
	fun getNextSubeditionID(): UInt32{ 
		let subeditionAdmin = self.account.storage.borrow<&SubeditionAdmin>(from: TopShot.SubeditionAdminStoragePath()) ?? panic("No subedition admin resource in storage")
	...
	struct Subedition{ 
		...
		init(subeditionID: UInt32, name: String, metadata:{ String: String}){ 
			pre{ 
				name.length != 0:
					"New Subedition name cannot be empty"
			}
	...
	resource SubeditionAdmin{ 
		...
		access(contract)
		var nextSubeditionID: UInt32
		
		// Variable size dictionary of Subedition structs
		access(contract)
		let subeditionDatas:{ UInt32: Subedition}
		...
		//
		access(TMP_ENTITLEMENT_OWNER)
		fun getNumberMintedPerSubedition(setID: UInt32, playID: UInt32, subeditionID: UInt32): UInt32{ 
		...
		//
		access(TMP_ENTITLEMENT_OWNER)
		fun addToNumberMintedPerSubedition(setID: UInt32, playID: UInt32, subeditionID: UInt32){ 
			let setPlaySubedition = setID.toString().concat(playID.toString()).concat(subeditionID.toString())
			if !self.numberMintedPerSubedition.containsKey(setPlaySubedition){ 
		...
		fun setMomentsSubedition(nftID: UInt64, subeditionID: UInt32, setID: UInt32, playID: UInt32){ 
			pre{ 
				!self.momentsSubedition.containsKey(nftID):
					"Subedition for this moment already exists!"
			}
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&{MomentCollectionPublic}>(/storage/MomentCollection)
