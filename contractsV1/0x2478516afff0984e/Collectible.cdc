		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: /storage/_2478516afff0984e_Collectible_Collection, publicPath: /public/_2478516afff0984e_Collectible_Collection, publicCollection: Type<&Collectible.Collection>(), publicLinkedType: Type<&Collectible.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
