...
access(all)
contract Konfide: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTDisplay>():
				let media = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreidh2djmod6vkwkebg3vkr7fkroin6v2ymdkhnambdcbhi7kcbuaoy"), mediaType: "image")
				let bannerMedia = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://nftstorage.link/ipfs/bafkreigzxr4itutpqpdaosu7iflx2aoxssyy2wyz47fv4lhiuy5woqsoe4"), mediaType: "image")
				let medias = MetadataViews.Medias([media, bannerMedia])
				return FungibleTokenMetadataViews.FTDisplay(name: "Konfide", symbol: "KFD", description: "Konfide - Rede de Confian\u{e7}a ", externalURL: MetadataViews.ExternalURL("www.konfide.com.br"), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL(""), "discord": MetadataViews.ExternalURL("2MpTRytNB3")})
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: Konfide.VaultStoragePath, receiverPath: Konfide.ReceiverPublicPath, metadataPath: Konfide.VaultPublicPath, receiverLinkedType: /private/KonfideVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-Konfide.createEmptyVault(vaultType: Type<@Konfide.Vault>())
					})
		}
		return nil
	}
