...
access(all)
contract TheGameValley: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: TheGameValley.VaultStoragePath, receiverPath: TheGameValley.ReceiverPublicPath, metadataPath: TheGameValley.VaultPublicPath, receiverLinkedType: /private/TheGameValleyVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-TheGameValley.createEmptyVault(vaultType: Type<@TheGameValley.Vault>())
					})
		}
		return nil
	}
