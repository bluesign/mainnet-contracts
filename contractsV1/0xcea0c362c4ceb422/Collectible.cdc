		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: /storage/cea0c362c4ceb422_Collectible_Collection, publicPath: /public/cea0c362c4ceb422_Collectible_Collection, publicCollection: Type<&Collectible.Collection>(), publicLinkedType: Type<&Collectible.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
