...
contract FRC20TradingRecord{ 
	...
	struct TradingStatus{ 
		...
		access(contract)
		fun updateByNewRecord(_ recordRef: &TransactionRecord){ 
	...
	///
	access(all)
	resource interface TradingStatusViewer{ 
		access(all)
	...
	///
	access(all)
	resource BasicRecord: TradingStatusViewer{ 
		access(all)
	...
	///
	access(all)
	resource interface DailyRecordsPublic{ 
	...
	//
	access(all)
	resource DailyRecords: DailyRecordsPublic, TradingStatusViewer{ 
	...
	access(all)
	resource interface TradingRecordsPublic{ 
		// ---- Public Methods ----
		access(all)
		...
		access(all)
		fun borrowDailyRecords(_ date: UInt64): &DailyRecords?
