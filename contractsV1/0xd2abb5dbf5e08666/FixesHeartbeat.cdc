...
contract FixesHeartbeat{ 
	...
	access(all)
	event HookAdded(scope: String, hookAddr: Address, hookType: Type)
	
	/// Event emitted when a hook is removed
	access(all)
	event HookRemoved(scope: String, hookAddr: Address)
	
	/// Event emitted when the heartbeat time is updated
	access(all)
	event HeartbeatExecuted(scope: String, lastHeartbeatTime: UFix64, deltaTime: UFix64)
	...
	///
	access(all)
	resource interface IHeartbeatHook{ 
