...
contract FixesTraits{ 
	...
	enum Season0SecretPlaces: UInt8{ 
		access(all)
		case HeartOfTheAzureOcean // 蔚蓝海洋之心
		
		
		access(all)
		case HeartOfTheDarkForest // 黑暗森林之心
		
		
		access(all)
		case GardenofVenus // 维纳斯的花园
		
		
		access(all)
		case CityOfTheDead // 亡者之城
		
		
		access(all)
		case DragonboneWasteland // 龙骨荒原
		
		
		access(all)
		case MysticForest // 神秘森林
		
		
		access(all)
		case SoulWaterfall // 灵魂瀑布
		
		
		access(all)
		case AbyssalHollow // 深渊之穴
		
		
		access(all)
		case SilentGlacier // 静寂冰川
		
		
		access(all)
		case FrostWasteland // 霜冻荒原
		
		
		access(all)
		case DesolateGround // 荒芜之地
		
		
		access(all)
		case MirageCity // 海市蜃楼
		
		
		access(all)
		case ScorpionGorge // 蛇蝎峡谷
		
		
		access(all)
		case MysteriousIceLake // 神秘冰湖
		
		
		access(all)
		case NightShadowForest // 夜影密林
		
		
		access(all)
		case SpiritualValley // 灵犀山谷
		
		
		access(all)
		case RavensPerch // 乌鸦栖息地
		
		
		access(all)
		case RainbowFalls // 彩虹瀑布
		
		
		access(all)
		case TwilightValley // 暮色谷地
		
		
		access(all)
		case RuggedHill // 乱石山岗
	
	}
	
	access(all)
	view fun getSeason0SecretPlacesDefs(): [Definition]{ 
		return [Definition(5, 100), // 1% chance, rarity 2									
	...
	///
	access(all)
	enum Season0Ability: UInt8{ 
		access(all)
		case Omniscience // 全知全能
		
		
		access(all)
		case ElementalMastery // 全元素掌控
		...
		access(all)
		case MillenniumFreeze // 千年冰封
		
		
		access(all)
		case FossilResurgence // 化石重生
		
		
		access(all)
		case MysticVision // 神秘视界
		
		
		access(all)
		case PhoenixRebirth // 凤凰复生
		...
		access(all)
		case DragonsBreath // 龙焰吐息
		
		
		access(all)
		case PsychicSense // 心灵感应
		
		
		access(all)
		case MindControl // 心灵控制
		
		
		access(all)
		case EndlessTorment // 无尽痛苦
		
		
		access(all)
		case MeditationInDespair // 绝境冥思
		
		
		access(all)
		case SilenceFear // 沉默恐惧
		
		
		access(all)
		case GloryChallenge // 荣耀挑战
		
		
		access(all)
		case ShieldWall // 防御罩墙
		...
		access(all)
		case FountainOfLife // 生命之泉
		
		
		access(all)
		case PsychicInteraction // 精神互动
		
		
		access(all)
		case PlagueTransmission // 疫病传染
		
		
		access(all)
		case NinjaStealth // 忍者潜行
		
		
		access(all)
		case BattleRoar // 战斗吼叫
		
		
		access(all)
		case CongestiveStrike // 充血打击
		
		
		access(all)
		case HolyGuidance // 圣光指引
		
		
		access(all)
		case EmpoweredBarrier // 强化结界
		
		
		access(all)
		case PerpetualLife // 生生不息
		
		
		access(all)
		case CombatEvade // 战斗闪避
		
		
		access(all)
		case AbyssArrow // 深渊之箭
		...
		access(all)
		case ArcaneBlink // 魔力闪现
		
		
		access(all)
		case ArcaneExplosion // 魔力爆炸
		
		
		access(all)
		case ShadowStep // 暗黑影步
		
		
		access(all)
		case JadeStoneSpell // 玉石咒语
		
		
		access(all)
		case PhantomDodge // 鬼魅闪避
		
		
		access(all)
		case KissOfDeath // 死亡之吻
		
		
		access(all)
		case PhantomSummoning // 幻影召唤
		
		
		access(all)
		case EyeOfTheRaven // 乌鸦之眼
		
		
		access(all)
		case RatSwarmSurge // 鼠群涌动
		
		
		access(all)
		case FlameShock // 烈焰冲击
		
		
		access(all)
		case GaleSpeedBlade // 疾风快剑
		
		
		access(all)
		case InterstellarFlight // 星界飞行
		
		
		access(all)
		case WraithSeal // 怨灵封印
		
		
		access(all)
		case DivineRestoration // 神力恢复
		...
		access(all)
		case MightyBlow // 强力打击
		
		
		access(all)
		case PhysicalTraining // 锻炼体魄
	
	}
	
	access(all)
	view fun getSeason0AbilityDefs(): [Definition]{ 
		return [Definition(5, 20), // 0.2% chance, rarity 3								   
	...
	access(all)
	enum Season0Weapons: UInt8{ 
		access(all)
		case Starstaff // 星辰法杖
		
		
		access(all)
		case BowOfTheMysteriousBird // 九天玄鸟之弓
		
		
		access(all)
		case VoidSpiritWand // 虚空灵杖
		...
		access(all)
		case SunriseHolySword // 旭日圣剑
		
		
		access(all)
		case DeepSeaTrident // 深海三叉戟
		
		
		access(all)
		case DragonboneBow // 龙骨弓
		
		
		access(all)
		case RainbowHolySword // 虹光圣剑
		
		
		access(all)
		case MysticalGrimoire // 神秘法书
		
		
		access(all)
		case SaintsStaff // 圣者圣杖
		
		
		access(all)
		case FirePhoenixWhip // 火凤长鞭
		...
		access(all)
		case LightningSpear // 闪电长矛
		
		
		access(all)
		case DarkScepter // 黑暗权杖
		...
		access(all)
		case RedLotusRocket // 红莲火箭
		
		
		access(all)
		case DemonBoneSpike // 恶魔骨刺
		
		
		access(all)
		case EvilStarCatapult // 魔星投石器
		
		
		access(all)
		case SwordOfTenderness // 温柔之剑
		
		
		access(all)
		case WindWarriorLongbow // 风战者长弓
		
		
		access(all)
		case NightDagger // 黑夜匕首
		
		
		access(all)
		case GalaxyHalberd // 银河双戟
		
		
		access(all)
		case MoonshadowScimitar // 影月弯刀
		
		
		access(all)
		case IceCrownDagger // 冰冠短剑
		
		
		access(all)
		case StormBattleAxe // 风暴战斧
		
		
		access(all)
		case ArcaneStaff // 奥术长杖
		
		
		access(all)
		case AxeOfInferno // 烈火之斧
		
		
		access(all)
		case SkybreakerDualBlade // 破空双刃
		
		
		access(all)
		case IceGiantSword // 寒冰巨剑
		
		
		access(all)
		case TrollsHammer // 巨魔之锤
	...
	struct Definition{ 
		...
		view init(_ threshold: UInt8, _ weight: UInt64){ 
	...
	///
	access(all)
	resource Entry: ViewResolver.Resolver{ 
		access(self)
