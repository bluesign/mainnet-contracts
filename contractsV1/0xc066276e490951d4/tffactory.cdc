...
access(all)
contract tffactory: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: tffactory.VaultStoragePath, receiverPath: tffactory.ReceiverPublicPath, metadataPath: tffactory.VaultPublicPath, receiverLinkedType: /private/tffactoryVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-tffactory.createEmptyVault(vaultType: Type<@tffactory.Vault>())
					})
		}
		return nil
	}
