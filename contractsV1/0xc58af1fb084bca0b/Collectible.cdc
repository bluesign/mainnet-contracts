		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: /storage/c58af1fb084bca0b_Collectible_Collection, publicPath: /public/c58af1fb084bca0b_Collectible_Collection, publicCollection: Type<&Collectible.Collection>(), publicLinkedType: Type<&Collectible.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
