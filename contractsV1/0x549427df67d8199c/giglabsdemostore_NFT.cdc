...
contract giglabsdemostore_NFT: NonFungibleToken{ 
	...
	//
	access(all)
	resource Collection: giglabsdemostore_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic{ 
