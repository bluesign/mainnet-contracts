...
contract PonsNftContract_v1: PonsNftContractInterface, NonFungibleToken{ 
	...
	access(all)
	resource Collection: PonsNftContractInterface.PonsCollection, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic{ 
