...
access(all)
contract XGStudio: NonFungibleToken{ 
	...
	resource NFT: NonFungibleToken.NFT, ViewResolver.Resolver{ 
		...
		view fun getViews(): [Type]{ 
			return [Type<MetadataViews.Display>(), Type<MetadataViews.Editions>(), Type<MetadataViews.NFTCollectionDisplay>(), Type<MetadataViews.ExternalURL>(), Type<MetadataViews.NFTCollectionData>(), Type<MetadataViews.Royalties>(), Type<MetadataViews.Serial>(), Type<MetadataViews.Medias>(), Type<MetadataViews.Traits>()]
		}
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			...
			switch view{ 
				case Type<MetadataViews.Display>():
					return MetadataViews.Display(name: templateData["title"] as! String? ?? "", description: self.getAssetDescription(), thumbnail: self.getThumbnailFile())
				case Type<MetadataViews.Editions>():
					return MetadataViews.Editions(self.getEditions())
				case Type<MetadataViews.NFTCollectionDisplay>():
					return MetadataViews.NFTCollectionDisplay(name: brand.data["name"] ?? "", description: brand.data["description"] ?? "", externalURL: MetadataViews.ExternalURL(brand.data["websiteUrl"] ?? "https://xgstudios.io"), squareImage: MetadataViews.Media(file: MetadataViews.HTTPFile(url: brand.data["squareUrl"] ?? ""), mediaType: "image/png"), bannerImage: MetadataViews.Media(file: MetadataViews.HTTPFile(url: brand.data["bannerUrl"] ?? ""), mediaType: "image/png"), socials:{ "twitter": MetadataViews.ExternalURL(brand.data["twitter"] ?? ""), "instagram": MetadataViews.ExternalURL(brand.data["instagram"] ?? ""), "discord": MetadataViews.ExternalURL(brand.data["discord"] ?? ""), "tiktok": MetadataViews.ExternalURL(brand.data["tiktok"] ?? "")})
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: XGStudio.CollectionStoragePath, publicPath: XGStudio.CollectionPublicPath, publicCollection: Type<&XGStudio.Collection>(), publicLinkedType: Type<&XGStudio.Collection>(), createEmptyCollectionFunction: fun (): @XGStudio.Collection{ 
							return <-(XGStudio.createEmptyCollection(nftType: Type<@XGStudio.Collection>()) as! @XGStudio.Collection)
						})
				...
				case Type<MetadataViews.Medias>():
					...
					return MetadataViews.Medias([MetadataViews.Media(file: contentFile!, mediaType: contentType == "mp4" ? "video/mp4" : contentType)])
				case Type<MetadataViews.Traits>():
					...
					let excludedTraits = ["nftType", "xGRewardType", "contentUrl", "contentType", "title", "description", "thumbnail", "royalties"]
		...
		fun getThumbnailFile():{ MetadataViews.File}{ 
			...
			if templateData["thumbnail"] != nil{ 
				...
				return MetadataViews.IPFSFile(cid: cid, path: "")
			}
			if templateData["raceName"] as! String? == "Hackney Half Marathon 2022"{ 
				switch templateData["nftType"] as! String? ?? ""{ 
					case "Finish LE":
						return MetadataViews.IPFSFile(cid: "QmUAoUBy4xPRDqH7BKx5ZpVYcFzums9scZu83ccefLrFkr", path: "FINISH_LE.png")
					case "Finish":
						return MetadataViews.IPFSFile(cid: "QmUAoUBy4xPRDqH7BKx5ZpVYcFzums9scZu83ccefLrFkr", path: "FINISH.png")
				}
				switch templateData["title"] as! String? ?? ""{ 
					case "1st Place - HACKNEY HALF 2022":
						return MetadataViews.IPFSFile(cid: "QmUAoUBy4xPRDqH7BKx5ZpVYcFzums9scZu83ccefLrFkr", path: "1ST.png")
					case "2nd Place - HACKNEY HALF 2022":
						return MetadataViews.IPFSFile(cid: "QmUAoUBy4xPRDqH7BKx5ZpVYcFzums9scZu83ccefLrFkr", path: "2ND.png")
					case "3rd Place - HACKNEY HALF 2022":
						return MetadataViews.IPFSFile(cid: "QmUAoUBy4xPRDqH7BKx5ZpVYcFzums9scZu83ccefLrFkr", path: "3RD.png")
				}
			}
			if templateData["raceName"] as! String? == "ASICS London 10K 2022"{ 
				switch templateData["nftType"] as! String? ?? ""{ 
					case "Finish LE":
						return MetadataViews.IPFSFile(cid: "Qmdu543z9kvSgX5fS54rpF8sFcX4t5ZbaFBk7YhZFQcn5Y", path: "FINISH_LE.png")
					case "Finish":
						return MetadataViews.IPFSFile(cid: "Qmdu543z9kvSgX5fS54rpF8sFcX4t5ZbaFBk7YhZFQcn5Y", path: "FINISH.png")
				}
				switch templateData["title"] as! String? ?? ""{ 
					case "1st - ASICS LONDON 10K":
						return MetadataViews.IPFSFile(cid: "Qmdu543z9kvSgX5fS54rpF8sFcX4t5ZbaFBk7YhZFQcn5Y", path: "1ST.png")
					case "2nd - ASICS LONDON 10K":
						return MetadataViews.IPFSFile(cid: "Qmdu543z9kvSgX5fS54rpF8sFcX4t5ZbaFBk7YhZFQcn5Y", path: "2ND.png")
					case "3rd - ASICS LONDON 10K":
						return MetadataViews.IPFSFile(cid: "Qmdu543z9kvSgX5fS54rpF8sFcX4t5ZbaFBk7YhZFQcn5Y", path: "3RD.png")
				}
			}
			if templateData["raceName"] as! String? == "London Triathlon 2022"{ 
				return MetadataViews.IPFSFile(cid: "QmSr56aRWEDtD9fEHQrQw9gZjZwYuVK68YUDnHyF1vWcqj", path: "TRIATHLON.png")
			}
			if templateData["raceName"] as! String? == "London Duathlon 2022"{ 
				return MetadataViews.IPFSFile(cid: "QmSr56aRWEDtD9fEHQrQw9gZjZwYuVK68YUDnHyF1vWcqj", path: "DUATHLON.png")
			}
			if templateData["raceName"] as! String? == "London Duathlon 2022"{ 
				return MetadataViews.IPFSFile(cid: "QmPYTarYVgKMXQ4wHxGKLURpUKGzWkdUuyY1AkrKXxHDvn", path: "xG_GENESIS_FINISH_GNR_THUMB.png")
			}
			if templateData["activityType"] as! String? == "Football"{ 
				switch templateData["xGRewardType"] as! String? ?? ""{ 
					case "Team Clean Sheet":
						return MetadataViews.IPFSFile(cid: "QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", path: "TEAM_CLEANSHEET.png")
					case "Goal Scored":
						return MetadataViews.IPFSFile(cid: "QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", path: "GOAL_SCORED.png")
					case "Team Goals":
						return MetadataViews.IPFSFile(cid: "QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", path: "TEAM_GOAL.png")
					case "Win":
						return MetadataViews.IPFSFile(cid: "QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", path: "WIN.png")
					case "Appearance":
						return MetadataViews.IPFSFile(cid: "QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", path: "APPEARANCE.png")
					case "GK Clean Sheet":
						return MetadataViews.IPFSFile(cid: "QmSPFN7uaUaW1H9GsET9HHKudMCLvB5JyFDPxyQ4FoGd5k", path: "CLEANSHEET.png")
					case "Hat Trick":
						return MetadataViews.IPFSFile(cid: "QmbB8panH4gg4A3WpzVdoawHtYcXySLKbEphrEoYs9rZC6", path: "HAT_TRICK_THUMB.png")
				}
			}
		...
		fun getContentFile():{ MetadataViews.File}?{ 
			...
			if protocol == "http"{ 
				return MetadataViews.HTTPFile(url: contentUrl!)
			}
			...
			if fileType == "mp4"{ 
				return MetadataViews.HTTPFile(url: "https://xgstudios.mypinata.cloud/ipfs/".concat(contentUrl!))
			}
		...
		fun getEditions(): [MetadataViews.Edition]{ 
			...
			let template = XGStudio.getTemplateById(templateId: token.templateID)
			let templateData = template.getImmutableData()
			let editions = [							// Title Edition
							MetadataViews.Edition(name: templateData["title"] as! String? ?? "", number: self.data.mintNumber, max: template.maxSupply)]
			...
			if templateData["activityType"] as! String? == "Football" && templateData["season"] != nil{ 
				...
				editions.append(								// Football Season Edition
								MetadataViews.Edition(name: season, number: earlierSeasonSupply + self.data.mintNumber, max: seasonMaxSupply))
			}
			return editions
		}
	...
	//
	access(all)
	resource Collection: XGStudioCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.Collection, NonFungibleToken.CollectionPublic, ViewResolver.ResolverCollection{ 
		access(all)
	...
	resource AdminResource: UserSpecialCapability, NFTMethodsCapability{ 
		...
		fun removeTemplateById(templateId: UInt64): Bool{ 
			pre{ 
				...
				(XGStudio.allTemplates[templateId]!).issuedSupply == 0:
