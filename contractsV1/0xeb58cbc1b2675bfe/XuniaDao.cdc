...
access(all)
contract XuniaDao: FungibleToken, ViewResolver{ 
	...
	fun resolveView(_ view: Type): AnyStruct?{ 
		switch view{ 
			...
			case Type<FungibleTokenMetadataViews.FTDisplay>():
				...
				return FungibleTokenMetadataViews.FTDisplay(name: "Xunia Dao", symbol: "XUNIA", description: "The creator economy coin", externalURL: MetadataViews.ExternalURL("xunia.unicornplatform.page"), logos: medias, socials:{ "twitter": MetadataViews.ExternalURL("_xunia"), "discord": MetadataViews.ExternalURL("")})
			case Type<FungibleTokenMetadataViews.FTVaultData>():
				return FungibleTokenMetadataViews.FTVaultData(storagePath: XuniaDao.VaultStoragePath, receiverPath: XuniaDao.ReceiverPublicPath, metadataPath: XuniaDao.VaultPublicPath, receiverLinkedType: /private/XuniaDaoVault, metadataLinkedType: Type<&Vault>(), createEmptyVaultFunction: Type<&Vault>(), providerLinkedType: Type<&Vault>(), createEmptyVaultFunction: fun (): @Vault{ 
						return <-XuniaDao.createEmptyVault(vaultType: Type<@XuniaDao.Vault>())
					})
		}
		return nil
	}
