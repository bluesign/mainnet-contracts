...
access(all)
contract OKG: NonFungibleToken, NonFungibleTokenMinter{ 
	access(all)
	...
	resource interface CollectionPublic{ 
		...
		access(TMP_ENTITLEMENT_OWNER)
		fun borrowNFTOKG(id: UInt64): &OKG.NFT?{ 
			post{ 
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&OKG.Collection>(self.CollectionStoragePath)
