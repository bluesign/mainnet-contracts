...
import Blockletes_NFT from "./Blockletes_NFT.cdc"
...
contract BlockleteMarket_NFT{ 
	...
	resource SaleCollection: SalePublic{ 
		...
		access(self)
		var blockletesForSale: @Blockletes_NFT.Collection
		...
		init(ownerCapability: Capability<&FUSD.Vault>, beneficiaryCapability: Capability<&FUSD.Vault>, cutPercentage: UFix64){ 
			...
			self.blockletesForSale <- Blockletes_NFT.createEmptyCollection(nftType: Type<@Blockletes_NFT.Collection>()) as! @Blockletes_NFT.Collection
