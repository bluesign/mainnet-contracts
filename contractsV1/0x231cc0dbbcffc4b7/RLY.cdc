...
contract RLY: FungibleToken, FTMinterBurner{ 
	...
	resource Minter: FTMinterBurner.IMinter{ 
		...
		fun mintTokens(amount: UFix64): @{FungibleToken.Vault}{ 
			...
			RLY.totalSupply = RLY.totalSupply + amount
	...
	init(){ 
		...
		self.AdminPath = /storage/RLYAdmin
