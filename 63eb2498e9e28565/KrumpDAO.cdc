...
pub contract KrumpDAO: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Krump DAO",
                    symbol: "BUCK",
                    description: "Pioneering Decentralized Dance Worldwide",
            ...
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: KrumpDAO.VaultStoragePath,
                    receiverPath: KrumpDAO.ReceiverPublicPath,
                    metadataPath: KrumpDAO.VaultPublicPath,
                    providerPath: /private/KrumpDAOVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("KrumpDAO", self.account.address, "BUCK", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
