...
pub contract KrumpKommunity: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "Krump Kommunity",
                    symbol: "KRUMP",
                    description: "Pioneering Krump Ownership Economy Worldwide",
                    externalURL: MetadataViews.ExternalURL("bit.ly/DeDan"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("krumpverse"),
                        "discord": MetadataViews.ExternalURL("")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: KrumpKommunity.VaultStoragePath,
                    receiverPath: KrumpKommunity.ReceiverPublicPath,
                    metadataPath: KrumpKommunity.VaultPublicPath,
                    providerPath: /private/KrumpKommunityVault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("KrumpKommunity", self.account.address, "KRUMP", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
