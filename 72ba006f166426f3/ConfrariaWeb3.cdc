...
pub contract ConfrariaWeb3: FungibleToken, ViewResolver {
        ...
        switch view {
            ...
            case Type<FungibleTokenMetadataViews.FTDisplay>():
                ...
                return FungibleTokenMetadataViews.FTDisplay(
                    name: "ConfrariaWeb3",
                    symbol: "EGGS",
                    description: "Comer, beber e Conectar",
                    externalURL: MetadataViews.ExternalURL("www.confrariaweb3.com.br"),
                    logos: medias,
                    socials: {
                        "twitter": MetadataViews.ExternalURL("confrariaweb3"),
                        "discord": MetadataViews.ExternalURL("xPAeS77uXa")
                    }
                )
            case Type<FungibleTokenMetadataViews.FTVaultData>():
                return FungibleTokenMetadataViews.FTVaultData(
                    storagePath: ConfrariaWeb3.VaultStoragePath,
                    receiverPath: ConfrariaWeb3.ReceiverPublicPath,
                    metadataPath: ConfrariaWeb3.VaultPublicPath,
                    providerPath: /private/ConfrariaWeb3Vault,
    ...
    init(
      ...
      toucansProjectCollection.createProject(
        projectTokenInfo: ToucansTokens.TokenInfo("ConfrariaWeb3", self.account.address, "EGGS", self.ReceiverPublicPath, self.VaultPublicPath, self.VaultStoragePath), 
